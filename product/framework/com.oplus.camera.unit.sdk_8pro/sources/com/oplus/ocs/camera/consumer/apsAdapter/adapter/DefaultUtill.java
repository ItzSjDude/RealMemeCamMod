...
public class DefaultUtill {
    ...
    public static void setDefaultVendorTagConfigure(HashMap<String, String> hashMap) {
        hashMap.put(KEY_COMMON_AUTO_NIGHT_SCENCE, "1");
        hashMap.put(KEY_VIDEO_EIS, "1");
        hashMap.put(KEY_VIDEO_EIS_FPS, "60");
        hashMap.put(KEY_VIDEO_EIS_FPS_SETTING_SUPPORT, "1");
        ...
        hashMap.put(KEY_DISABLE_EXPORT_FRONT_DEFAULT_BEAUTY, "1");
        hashMap.put(KEY_SUPER_TEXT_CPU_PROCESS, "0");
        hashMap.put(KEY_SUPER_TEXT_SCANNER_SUPPORT, "0");
        hashMap.put(KEY_SAVE_JPG_AFTER_PAUSE, "1");
        ...
        hashMap.put(KEY_SINGLE_CAMERA_USE_COMMOM_PORTRAIT_PREVIEW_SIZE, "1");
        hashMap.put(KEY_BACK_PORTRAIT_NORMAL_MODE_PIC_SIZE, "4608x3456");
        hashMap.put(KEY_HIGH_TEMPERATURE_ULTIMATE_LIMIT, "480");
        hashMap.put(KEY_PORTRAIT_NEW_STYLE, "1");
        hashMap.put(KEY_BEAUTY3D, "1");
        hashMap.put(KEY_PI, "0");
        hashMap.put(KEY_PI_AI, "0");
        hashMap.put(KEY_PI_AI_ULTRA_WIDE_SUPPORT, "1");
        hashMap.put(KEY_HIGH_DEFINITION_QUICK_JPEG_SUPPORT, "1");
        ...
        hashMap.put(KEY_SUPPORT_SCREEN_BRIGHTNESS, "1");
        hashMap.put(KEY_SUPPORT_SCREEN_BRIGHTNESS_PORTRAIT, "0");
        hashMap.put(KEY_SUPPORT_SCREEN_BRIGHTNESS_VIDEO, "1");
        ...
        hashMap.put(KEY_VIDEO_SIZE_4K, "1");
        hashMap.put(KEY_VIDEO_SIZE_8K, "0");
        hashMap.put(KEY_VIDEO_LOW_FPS_PREVIEW_PROCESS_BY_APS, "1");
        hashMap.put(KEY_VIDEO_STABILIZATION_BY_APS, "1");
        hashMap.put(KEY_VIDEO_STABILIZATION_FRONT_BY_APS, "1");
        hashMap.put(KEY_ULTRA_NIGHT_VIDEO, "0");
        hashMap.put(KEY_ULTRA_NIGHT_VIDEO_ZOOM, "1");
        ...
        hashMap.put(KEY_CUSTOM_BEAUTY_FRONT_VIDEO_OPEN_DEFAULT_SUPPORT, "1");
        hashMap.put(KEY_CUSTOM_MAKEUP_FRONT, "0");
        hashMap.put(KEY_CUSTOM_MAKEUP_WATERMARK_FRONT, "0");
        hashMap.put(KEY_CUSTOM_MAKEUP_TYPE_SNOW, "1");
        hashMap.put(KEY_CUSTOM_MAKEUP_TYPE_DREAM, "1");
        hashMap.put(KEY_REQUEST_ZSL_MODE, "1");
        ...
        hashMap.put(KEY_SUPPORT_VIDEO_THUMBNAIL_SIMULTANEOUS_4K, "1");
        hashMap.put(KEY_SUPPORT_VIDEO_DYNAMIC_FPS_RANGE, "0");
        ...
        hashMap.put(KEY_RAW_HDR_CAPTURE_NEED_PREVIEWSURFACE_SUPPORT, "1");
        hashMap.put(KEY_BURST_CAPTURE_NEED_PREVIEWSURFACE_SUPPORT, "1");
        ...
        hashMap.put(KEY_SUPPORT_PORTRAIT, "1");
        ...
        hashMap.put(KEY_SUPPORT_CAPTURE_RAW, "1");
        hashMap.put(KEY_SUPPORT_SLOW_VIDEO, "1");
        hashMap.put(KEY_SUPPORT_MOVIE_MODE, "0");
        hashMap.put(KEY_SUPPORT_MOVIE_MODE_V2, "0");
        hashMap.put(KEY_PORTRAIT_TURBO_RAW_SUPPORT, "0");
        hashMap.put(KEY_SUPPORT_MOVIE_MODE_HDR_LOG, "1");
        hashMap.put(KEY_SUPPORT_MOVIE_MODE_HDR, "1");
        hashMap.put(KEY_SUPPORT_MOVIE_MODE_LOG, "1");
        ...
        hashMap.put(KEY_SUPPORT_FRONT_720P_SLOW_VIDEO, "1");
        hashMap.put(KEY_SUPPORT_FRONT_1080P_SLOW_VIDEO, "1");
        hashMap.put(KEY_SUPPORT_SLOW_VIDEO_ZOOM, "0");
        hashMap.put(KEY_SUPPORT_FAST_VIDEO_SAT, "0");
        hashMap.put(KEY_SUPPORT_FAST_VIDEO_BEAUTY, "1");
        ...
        hashMap.put(KEY_FRONT_SUPER_EIS_AND_AI_VIDEO_ENHANCE_COEXIST, "1");
        hashMap.put(KEY_SUPPORT_VIDEO_FRONT_EIS_FORCE_ULTRA_WIDE, "0");
        hashMap.put(KEY_SUPPORT_VIDEO_FRONT_EIS, "0");
        hashMap.put(KEY_SUPPORT_VIDEO_SUPER_EIS_WIDE_60_FPS, "1");
        hashMap.put(KEY_SUPPORT_VIDEO_SUPER_EIS_4K, "0");
        hashMap.put(KEY_SUPPORT_VIDEO_BLUR_1080P, "1");
        ...
        hashMap.put(KEY_SUPPORT_END_VIDEO_EIS_STREAM, "0");
        ...
        hashMap.put(KEY_NEED_SET_FACEINFO_TO_APS, Util.isQcomPlatform() ? "0" : "1");
        ...
        hashMap.put(KEY_SAT_TELE_SUPPORT, "1");
        ...
        hashMap.put(KEY_ULTRA_WIDE_BUBBLE_TIPS_SUPPORT, "1");
        hashMap.put(KEY_VIDEO_ULTRA_WIDE_ANGLE_SUPPORT, "1");
        hashMap.put(KEY_MOVIE_ULTRA_WIDE_ANGLE_SUPPORT, "1");
        ...
        hashMap.put(KEY_NIGHT_TRIPOD_SUPPORT, "1");
        ...
        hashMap.put(KEY_SLOGAN_LOCATION_SUPPORT, "1");
        ...
        hashMap.put(KEY_REMOSAIC_SUPPORT_DEFAULT_VALUE, "1");
        hashMap.put(KEY_PORTRAIT_FRONT_MAX_SIZE_SUPPORT, "1");
        ...
        hashMap.put(KEY_SUPPORT_EIS_PRO_LOW_LIGHT_HINT, "1");
        hashMap.put(KEY_AF_HYPERFOCALDISTANCE_SUPPORT, "1");
        ...
        hashMap.put(KEY_SLOW_MOTION_H265_SUPPORT, "1");
        hashMap.put(KEY_FRONT_INVERSE_COLOR, DEFAULT_FRONT_INVERSE_COLOR);
        hashMap.put(KEY_APS_SUPPORT_VIDEO_SUPER_EIS, "1");
        ...
        hashMap.put(KEY_PORTRAIT_FRONT_RETENTION_SUPPORT, "1");
        hashMap.put(KEY_PORTRAIT_BACK_RETENTION_SUPPORT, "1");
        ...
        hashMap.put(KEY_MICROSCOPE_FILTER_SUPPORT, "1");
        ...
        hashMap.put(KEY_TIME_LAPSE_RATE_SUPPORT, "1");
        hashMap.put(KEY_PORTRAIT_BLUR_LEVEL_ENABLE, "1");
        hashMap.put(KEY_PORTRAIT_SINGLE_BLUR_OPERATING, "0");
        hashMap.put(KEY_PORTRAIT_IS_NEED_ATHENA, "1");
        ...
        hashMap.put(KEY_VIDEO_FUSION_APP_LOAD_SO_TYPE, "1");
        hashMap.put(KEY_HW_MANUFACTURER_QUALCOMM, "0");
        hashMap.put(KEY_NIGHT_SENSOR_MASK_SUPPORT, "1");
        hashMap.put(KEY_CUSTOM_CAMERA_REAR_NUM, "1");
        hashMap.put(KEY_PORTRAIT_ZOOM_VALUE_DEFAULT, "1.0");
        hashMap.put(KEY_MOVIE_ULTRA_WIDE_FLASH_EIS_SUPPORT, "1");
        hashMap.put(KEY_MOVIE_SUPER_EIS_SUPPORT, "1");
        ...
        hashMap.put(KEY_VIDEO_4K_TRACK_FOCUS_SUPPORT, "1");
        hashMap.put(KEY_VIDEO_AI_ENHANCEMENT_TRACK_FOCUS_SUPPORT, "1");
        hashMap.put(KEY_VIDEO_60FPS_TRACK_FOCUS_SUPPORT, "1");
        hashMap.put(KEY_TRACK_FOCUS_ULTRA_WIDE_SUPPORT, "0");
        hashMap.put(KEY_NIGHT_FRONT_ZSL_DISABLE, "0");
        ...
        hashMap.put(KEY_SUPPORT_ULTAR_WIDE_VIDEO_4K_OR_60FPS, "1");
        ...
        hashMap.put(KEY_SUPPORT_FAST_VIDEO_LOCK_AF_4_FPS, "1");
        hashMap.put(KEY_SUPPORT_HYPERLAPSE_VIDEO_OIS_CONFIG, "1");
        hashMap.put(KEY_SUPPORT_MEDIA_RECORDER_CUSTOM_FOCUS_SECTOR_WIDTH, "0");
        hashMap.put(KEY_SUPPORT_PANORAMA_REAR_PROCESS_IMAGE, "0");
        hashMap.put(KEY_SUPPORT_TEMPERATURE_PROTECTION, "1");
        hashMap.put(KEY_PROFESSIONAL_MUTEX_ZOOM_SUPPORT, "0");
        hashMap.put(KEY_ONLY_HIGH_PICTURE_SIZE_HEIF_IN_APS, "0");
        hashMap.put(KEY_FRONT_SUPERNIGHT_SUPPORT, "1");
        hashMap.put(KEY_FRONT_PANORAMA_SUPPORT, "1");
        ...
        hashMap.put(KEY_LOCK_AE_BEFORE_CAPTURE_SUPPORT, "1");
        hashMap.put(KEY_LOCK_AWB_BEFORE_CAPTURE_REAR_SUPPORT, "0");
        hashMap.put(KEY_DOUBLE_EXPOSURE_SUPPORT, "0");
        hashMap.put(KEY_STOP_REPEATING_BEFORE_END_OF_STREAM, "1");
        ...
        hashMap.put(KEY_NIGHT_INSENSOR_ZOOM_POINT_2X_SUPPORT, "1");
        ...
        hashMap.put(KEY_PREVIEW_BUFFER_CACHE_SUPPORT, "1");
        ...
        hashMap.put(KEY_THERMAL_PAUSE_VIDEO_PREVIEW_BLACK_SUPPORT, "1");
        hashMap.put(KEY_CAMERA_VIDEO_BRIGHTNESS_SECOND_EXPLORER, "150");
        hashMap.put(KEY_FACE_BEAUTY_CUSTOM_MENU_SUPPORT, "1");
        hashMap.put(KEY_CACHE_CLICK_CAPTURE_SUPPORT, "1");
        hashMap.put(KEY_QUICK_JPEG, "1");
        hashMap.put(KEY_MONO_FILTER_SUPPORT, "1");
        hashMap.put(KEY_SAT_ULTRAWIDE_FOCUS_SUPPORT, "1");
        hashMap.put(KEY_MONO_FILTER_MODE_PLACE, "1");
        ...
        hashMap.put(KEY_ROM_PLATFORM_VERSION, "1");
        ...
        hashMap.put(KEY_SUPPORT_STREET_RAW, "1");
        hashMap.put(KEY_STREET_FIX_FOCUS, "1");
        hashMap.put(KEY_EDGE_FILTER_LINE_SIZE, "2");
        ...
        hashMap.put(KEY_SUPPORT_HASSELBLAD_WATERMARK, "1");
        hashMap.put(KEY_SUPPORT_OUT_PREVIEW, "1");
        hashMap.put(KEY_SUPPORT_OUT_CAPTURE, "1");
        ...
        hashMap.put(KEY_PHOTO_USE_OFFLINE_R2Y, "1");
        ...
        hashMap.put(KEY_SUPPORT_SD_CARD_STORAGE_SAVE, "1");
        ...
        hashMap.put(KEY_ATHENA_NEW_SUPPORT, Util.isAfterAndroidS() ? "1" : "0");
        ...
        hashMap.put(KEY_SUPPORT_WCG2, "0");
        hashMap.put(KEY_FAST_SHOT_SUPPORT, "0");
        hashMap.put(KEY_SUPPORT_CONTINUOUS_SHOT_GALLERY_PRE_DECODE_ENABLE, "1");
    }
}
