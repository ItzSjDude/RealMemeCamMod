...
public interface IOplusProject extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IOplusProject {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-22, -16, -25, 59, 23, 24, -34, -64, 121, 113, 8, 111, 120, -33, -58, 72, 5, 104, 39, -93, -43, 86, -68, 24, 16, -103, -83, 67, 60, -103, -5, 45}, new byte[]{-20, 127, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                ...
                case 32:
                    _hidl_request.enforceInterface(IOplusProject.kInterfaceName);
                    String _hidl_out_result24 = get_pmic_info();
                    _hidl_reply.writeStatus(0);
