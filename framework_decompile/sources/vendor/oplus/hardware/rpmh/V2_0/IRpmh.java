...
public interface IRpmh extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IRpmh {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-36, -55, -105, -81, -61, -17, 37, 47, -53, MidiConstants.STATUS_SONG_SELECT, -106, 124, -22, 88, 48, -74, -44, 100, 112, 77, -17, 40, 23, -30, 119, 73, -121, 111, -63, 37, -35, 85}, new byte[]{-20, 127, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
