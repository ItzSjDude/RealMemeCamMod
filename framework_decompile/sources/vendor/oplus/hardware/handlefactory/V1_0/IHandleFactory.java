...
public interface IHandleFactory extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IHandleFactory {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{40, GsmAlphabet.GSM_EXTENDED_ESCAPE, 51, -100, -46, -4, 67, -73, 30, 82, 6, -105, -41, -126, 121, 127, -78, 30, -86, -109, 63, -34, 90, -94, 110, -92, 125, -42, -120, 77, 79, -30}, new byte[]{-20, 127, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
