...
public abstract class Uri implements Parcelable, Comparable<Uri> {
    ...
    private static class HierarchicalUri extends AbstractHierarchicalUri {
        ...
        private void appendSspTo(StringBuilder builder) throws UnsupportedEncodingException {
    ...
    public List<String> getQueryParameters(String key) throws UnsupportedEncodingException {
        if (isOpaque()) {
            throw new UnsupportedOperationException(NOT_HIERARCHICAL);
        }
        if (key == null) {
    ...
    public String getQueryParameter(String key) throws UnsupportedEncodingException {
        if (isOpaque()) {
            throw new UnsupportedOperationException(NOT_HIERARCHICAL);
        }
        if (key == null) {
    ...
    public boolean getBooleanQueryParameter(String key, boolean defaultValue) throws UnsupportedEncodingException {
    ...
    public static String encode(String s, String allow) throws UnsupportedEncodingException {
        if (s == null) {
            return null;
        }
    ...
    static class PathPart extends AbstractPart {
        ...
        static PathPart appendEncodedSegment(PathPart oldPart, String newSegment) throws UnsupportedEncodingException {
            String newPath;
            if (oldPart == null) {
