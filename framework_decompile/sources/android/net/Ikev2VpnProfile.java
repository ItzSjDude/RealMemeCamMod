...
public final class Ikev2VpnProfile extends PlatformVpnProfile {
    ...
    public VpnProfile toVpnProfile() throws GeneralSecurityException, IOException {
        VpnProfile profile = new VpnProfile("", this.mIsRestrictedToTestNetworks, this.mExcludeLocalRoutes, this.mRequiresInternetValidation, this.mIkeTunConnParams);
    ...
    private static PrivateKey getPrivateKeyFromAndroidKeystore(String alias) throws NoSuchAlgorithmException, UnrecoverableKeyException, IOException, KeyStoreException, CertificateException {
        try {
    ...
    public static Ikev2VpnProfile fromVpnProfile(VpnProfile profile) throws GeneralSecurityException, IOException {
        Builder builder;
        PrivateKey key;
