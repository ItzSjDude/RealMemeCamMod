...
public final class DhcpResults implements Parcelable {
    ...
    public String toString() {
        ...
        if (this.captivePortalApiUrl != null) {
            str.append(" CaptivePortalApiUrl ").append(this.captivePortalApiUrl);
        }
        return str.toString();
    }
    ...
    public int hashCode() {
        return Objects.hash(this.ipAddress, this.gateway, this.dnsServers, this.domains, this.serverAddress, this.vendorInfo, this.serverHostName, this.captivePortalApiUrl) + (this.leaseDuration * 43) + (this.mtu * 67);
    }
