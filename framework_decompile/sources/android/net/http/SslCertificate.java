...
public class SslCertificate {
    ...
    public static SslCertificate restoreState(Bundle bundle) throws CertificateException {
    ...
    private static String getDigest(X509Certificate x509Certificate, String algorithm) throws NoSuchAlgorithmException {
        if (x509Certificate == null) {
            return "";
        }
        try {
