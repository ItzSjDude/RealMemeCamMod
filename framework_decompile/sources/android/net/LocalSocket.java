...
public class LocalSocket implements Closeable {
    ...
    public LocalSocket(FileDescriptor fd) throws ErrnoException {
        this(new LocalSocketImpl(fd), 0);
        checkConnected();
    }

    static LocalSocket createLocalSocketForAccept(LocalSocketImpl impl) throws ErrnoException {
    ...
    public void setReceiveBufferSize(int size) throws IOException, ErrnoException {
    ...
    public void setSoTimeout(int n) throws IOException, ErrnoException {
    ...
    public void setSendBufferSize(int n) throws IOException, ErrnoException {
