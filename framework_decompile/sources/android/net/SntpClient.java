...
public class SntpClient {
    ...
    public boolean requestTime(String host, int port, int timeout, Network network) throws UnknownHostException {
    ...
    private static Random defaultRandom() throws NoSuchAlgorithmException {
        try {
