...
public class LowpanManager {
    ...
    class AnonymousClass2 extends ILowpanManagerListener.Stub {
        ...
        public void onInterfaceAdded(final ILowpanInterface ifaceService) {
            ...
            Runnable runnable = new Runnable() { // from class: android.net.lowpan.LowpanManager$2$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m2988lambda$onInterfaceAdded$0$androidnetlowpanLowpanManager$2(ifaceService, callback);
                }
            };
        ...
        /* synthetic */ void m2988lambda$onInterfaceAdded$0$androidnetlowpanLowpanManager$2(ILowpanInterface ifaceService, Callback cb) {
        ...
        public void onInterfaceRemoved(final ILowpanInterface ifaceService) {
            ...
            Runnable runnable = new Runnable() { // from class: android.net.lowpan.LowpanManager$2$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m2989lambda$onInterfaceRemoved$1$androidnetlowpanLowpanManager$2(ifaceService, callback);
                }
            };
            this.mHandler.post(runnable);
        }
        ...
        /* synthetic */ void m2989lambda$onInterfaceRemoved$1$androidnetlowpanLowpanManager$2(ILowpanInterface ifaceService, Callback cb) {
