...
public class WifiNl80211Manager {
    ...
    private static final int WPA_CIPHER_SMS4 = 24253440;
    ...
    class ApInterfaceEventCallback extends IApInterfaceEventCallback.Stub {
        ...
        public void onConnectedClientsChanged(final NativeWifiClient client, final boolean isConnected) {
            try {
                Log.i(WifiNl80211Manager.TAG, "Callback from wificond for Connected Clients is " + isConnected);
                if (this.mSoftApListener != null) {
                    this.mExecutor.execute(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$ApInterfaceEventCallback$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m3036x21eb4ab7(client, isConnected);
                        }
                    });
                }
            } catch (IllegalArgumentException e) {
                Log.e(WifiNl80211Manager.TAG, "IllegalArgumentException");
            }
        }
        ...
        /* synthetic */ void m3036x21eb4ab7(NativeWifiClient client, boolean isConnected) {
        ...
        public void onSoftApChannelSwitched(final int frequency, final int bandwidth) {
            ...
            try {
                this.mExecutor.execute(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$ApInterfaceEventCallback$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m3037xe4dbde8e(frequency, bandwidth);
                    }
                });
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        /* synthetic */ void m3037xe4dbde8e(int frequency, int bandwidth) {
    ...
    class SendMgmtFrameEvent extends ISendMgmtFrameEvent.Stub {
        ...
        SendMgmtFrameEvent(Executor executor, SendMgmtFrameCallback callback) throws Throwable {
            this.mExecutor = executor;
            this.mCallback = callback;
        ...
        /* synthetic */ void m3043x6eb65de0(final int elapsedTimeMs) {
            ...
            try {
                this.mExecutor.execute(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m3042xf0555a01(elapsedTimeMs);
                    }
                });
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        /* synthetic */ void m3042xf0555a01(int elapsedTimeMs) {
        ...
        public void OnFailure(final int reason) {
            WifiNl80211Manager.this.mEventHandler.post(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m3047x51c3ee7b(reason);
                }
            });
        }
        ...
        /* synthetic */ void m3047x51c3ee7b(final int reason) {
            runIfFirstCall(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m3046xd362ea9c(reason);
                }
            });
        }
        ...
        /* synthetic */ void m3046xd362ea9c(final int reason) {
            WifiNl80211Manager.this.mAlarmManager.cancel(this.mTimeoutCallback);
            long token = Binder.clearCallingIdentity();
            try {
                this.mExecutor.execute(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m3045x5501e6bd(reason);
                    }
                });
            } finally {
                Binder.restoreCallingIdentity(token);
    ...
    private boolean retrieveWificondAndRegisterForDeath() {
        ...
        IWificond iWificondAsInterface = IWificond.Stub.asInterface(binder);
        this.mWificond = iWificondAsInterface;
        if (iWificondAsInterface != null) {
            try {
                iWificondAsInterface.asBinder().linkToDeath(new IBinder.DeathRecipient() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$$ExternalSyntheticLambda6
                    @Override // android.os.IBinder.DeathRecipient
                    public final void binderDied() {
                        this.f$0.m3035x449b629f();
                    }
                }, 0);
