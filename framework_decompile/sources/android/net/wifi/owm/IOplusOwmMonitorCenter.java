...
public interface IOplusOwmMonitorCenter extends IOplusCommonFeature {
    ...
    public static final int OPLUS_WIFI_BANDWIDTH = 9;
    ...
    default void addOplusFeatureActivedRecord(String ifname, int featureId, int actState) {
    }

    default void notifyVideoStutterToWifi(String msg, String pkgName) {
    }

    default void addOplusWifiSelfCureOngoingRecord(boolean isOngoing) {
    }

    default void addWifiAssistantSwitchRecord(String ifName, boolean isSwitched) {
    }
