...
public final class EapSessionConfigUtils {
    ...
    public static EapSessionConfig fromPersistableBundle(PersistableBundle in) throws CertificateException {
    ...
    private static final class EapTtlsConfigUtils extends EapMethodConfigUtils {
        ...
        public static void setBuilderByReadingPersistableBundle(PersistableBundle in, EapSessionConfig.Builder builder) throws CertificateException {
            Objects.requireNonNull(in, "PersistableBundle was null");
