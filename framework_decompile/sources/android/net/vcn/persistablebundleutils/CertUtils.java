...
public class CertUtils {
    ...
    public static X509Certificate certificateFromByteArray(byte[] derEncoded) throws CertificateException {
    ...
    public static RSAPrivateKey privateKeyFromByteArray(byte[] pkcs8Encoded) throws NoSuchAlgorithmException {
