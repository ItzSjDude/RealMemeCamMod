...
public final class IkeSessionParamsUtils {
    ...
    private static final class AuthConfigUtils {
        ...
        public static void setBuilderByReadingPersistableBundle(PersistableBundle localAuthBundle, PersistableBundle remoteAuthBundle, IkeSessionParams.Builder builder) throws NoSuchAlgorithmException, CertificateException {
    ...
    private static final class IkeAuthEapConfigUtils {
        ...
        public static void setBuilderByReadingPersistableBundle(PersistableBundle localAuthBundle, PersistableBundle remoteAuthBundle, IkeSessionParams.Builder builder) throws CertificateException {
