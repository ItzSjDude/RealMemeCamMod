...
public class VcnManager {
    ...
    public static final String[] VCN_RELATED_CARRIER_CONFIG_KEYS = {VCN_NETWORK_SELECTION_WIFI_ENTRY_RSSI_THRESHOLD_KEY, VCN_NETWORK_SELECTION_WIFI_EXIT_RSSI_THRESHOLD_KEY};
        ...
        public void onPolicyChanged() {
            Binder.withCleanCallingIdentity(new FunctionalUtils.ThrowingRunnable() { // from class: android.net.vcn.VcnManager$VcnUnderlyingNetworkPolicyListenerBinder$$ExternalSyntheticLambda0
                ...
                public final void runOrThrow() throws Exception {
                    this.f$0.m3007x4d50874d();
                }
            });
        }

        /* renamed from: lambda$onPolicyChanged$0$android-net-vcn-VcnManager$VcnUnderlyingNetworkPolicyListenerBinder, reason: not valid java name */
        /* synthetic */ void m3006x5bfef7cc() {
            this.mListener.onPolicyChanged();
        }

        /* renamed from: lambda$onPolicyChanged$1$android-net-vcn-VcnManager$VcnUnderlyingNetworkPolicyListenerBinder, reason: not valid java name */
        /* synthetic */ void m3007x4d50874d() throws Exception {
    ...
    public static class VcnStatusCallbackBinder extends IVcnStatusCallback.Stub {
        ...
        public void onVcnStatusChanged(final int statusCode) {
            Binder.withCleanCallingIdentity(new FunctionalUtils.ThrowingRunnable() { // from class: android.net.vcn.VcnManager$VcnStatusCallbackBinder$$ExternalSyntheticLambda2
                @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
                public final void runOrThrow() throws Exception {
                    this.f$0.m3005x3527af9e(statusCode);
                }
            });
        }

        /* renamed from: lambda$onVcnStatusChanged$0$android-net-vcn-VcnManager$VcnStatusCallbackBinder, reason: not valid java name */
        /* synthetic */ void m3004x74f153f(int statusCode) {
            this.mCallback.onStatusChanged(statusCode);
        }

        /* renamed from: lambda$onVcnStatusChanged$1$android-net-vcn-VcnManager$VcnStatusCallbackBinder, reason: not valid java name */
        /* synthetic */ void m3005x3527af9e(final int statusCode) throws Exception {
            this.mExecutor.execute(new Runnable() { // from class: android.net.vcn.VcnManager$VcnStatusCallbackBinder$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m3004x74f153f(statusCode);
                }
            });
        }

        @Override // android.net.vcn.IVcnStatusCallback
        public void onGatewayConnectionError(final String gatewayConnectionName, final int errorCode, String exceptionClass, String exceptionMessage) throws ClassNotFoundException {
            ...
            Binder.withCleanCallingIdentity(new FunctionalUtils.ThrowingRunnable() { // from class: android.net.vcn.VcnManager$VcnStatusCallbackBinder$$ExternalSyntheticLambda3
                @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
                public final void runOrThrow() throws Exception {
                    this.f$0.m3003x81772c17(gatewayConnectionName, errorCode, cause);
                }
            });
        }

        /* renamed from: lambda$onGatewayConnectionError$3$android-net-vcn-VcnManager$VcnStatusCallbackBinder, reason: not valid java name */
        /* synthetic */ void m3003x81772c17(final String gatewayConnectionName, final int errorCode, final Throwable cause) throws Exception {
            this.mExecutor.execute(new Runnable() { // from class: android.net.vcn.VcnManager$VcnStatusCallbackBinder$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m3002x539e91b8(gatewayConnectionName, errorCode, cause);
                }
            });
        }

        /* renamed from: lambda$onGatewayConnectionError$2$android-net-vcn-VcnManager$VcnStatusCallbackBinder, reason: not valid java name */
        /* synthetic */ void m3002x539e91b8(String gatewayConnectionName, int errorCode, Throwable cause) {
            this.mCallback.onGatewayConnectionError(gatewayConnectionName, errorCode, cause);
        }

        private static Throwable createThrowableByClassName(String className, String message) throws ClassNotFoundException {
            if (className == null) {
                return null;
            }
            try {
