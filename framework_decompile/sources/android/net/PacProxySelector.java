...
public class PacProxySelector extends ProxySelector {
    ...
    public List<java.net.Proxy> select(URI uri) throws RemoteException {
        String urlString;
    ...
    private static List<java.net.Proxy> parseResponse(String response) throws NumberFormatException {
    ...
    private static java.net.Proxy proxyFromHostPort(Proxy.Type type, String hostPortString) throws NumberFormatException {
        try {
