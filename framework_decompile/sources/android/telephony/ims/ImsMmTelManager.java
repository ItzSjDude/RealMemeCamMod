...
public class ImsMmTelManager implements RegistrationManager {
    ...
    public static class CapabilityCallback {
        ...
        static class CapabilityBinder extends IImsCapabilityCallback.Stub {
                ...
                try {
                    this.mExecutor.execute(new Runnable() { // from class: android.telephony.ims.ImsMmTelManager$CapabilityCallback$CapabilityBinder$$ExternalSyntheticLambda0
                        ...
                        public final void run() {
                            this.f$0.m4445xe499d24d(config);
                        }
                    });
                } finally {
            ...
            /* renamed from: lambda$onCapabilitiesStatusChanged$0$android-telephony-ims-ImsMmTelManager$CapabilityCallback$CapabilityBinder, reason: not valid java name */
            /* synthetic */ void m4445xe499d24d(int config) {
    ...
    public static ImsMmTelManager createForSubscriptionId(int subId) {
        ...
        return new ImsMmTelManager(subId, new BinderCacheManager(new BinderCacheManager.BinderInterfaceFactory() { // from class: android.telephony.ims.ImsMmTelManager$$ExternalSyntheticLambda1
        ...
        public void accept(final int result) {
            ...
            try {
                ...
                executor.execute(new Runnable() { // from class: android.telephony.ims.ImsMmTelManager$3$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        consumer.accept(Boolean.valueOf(result == 1));
                    }
                });
            } finally {
                Binder.restoreCallingIdentity(identity);
    ...
    public void registerImsStateCallback(Executor executor, ImsStateCallback callback) throws ImsException {
        ...
        ITelephony telephony = (ITelephony) binderCacheManager.listenOnBinder(callback, new ImsMmTelManager$$ExternalSyntheticLambda3(callback));
        if (telephony == null) {
    ...
    public void unregisterImsStateCallback(ImsStateCallback callback) {
        Objects.requireNonNull(callback, "Must include a non-null ImsStateCallback.");
        ITelephony telephony = (ITelephony) this.mBinderCache.removeRunnable(callback);
        if (telephony != null) {
            try {
