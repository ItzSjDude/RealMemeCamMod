...
public class ProvisioningManager {
    ...
    public static class Callback {
        ...
        static class CallbackBinder extends IImsConfigCallback.Stub {
                ...
                try {
                    this.mExecutor.execute(new Runnable() { // from class: android.telephony.ims.ProvisioningManager$Callback$CallbackBinder$$ExternalSyntheticLambda0
                        ...
                        public final void run() {
                            this.f$0.m4481x42991d00(item, value);
                        }
                    });
                } finally {
            ...
            /* renamed from: lambda$onIntConfigChanged$0$android-telephony-ims-ProvisioningManager$Callback$CallbackBinder, reason: not valid java name */
            /* synthetic */ void m4481x42991d00(int item, int value) {
            ...
            public final void onStringConfigChanged(final int item, final String value) {
                ...
                try {
                    this.mExecutor.execute(new Runnable() { // from class: android.telephony.ims.ProvisioningManager$Callback$CallbackBinder$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m4482xe4810b67(item, value);
                        }
                    });
                } finally {
                    restoreCallingIdentity(callingIdentity);
            ...
            /* renamed from: lambda$onStringConfigChanged$1$android-telephony-ims-ProvisioningManager$Callback$CallbackBinder, reason: not valid java name */
            /* synthetic */ void m4482xe4810b67(int item, String value) {
    ...
    public static abstract class FeatureProvisioningCallback {
        ...
        static class CallbackBinder extends IFeatureProvisioningCallback.Stub {
            ...
            public final void onFeatureProvisioningChanged(final int capability, final int tech, final boolean isProvisioned) {
                ...
                try {
                    this.mExecutor.execute(new Runnable() { // from class: android.telephony.ims.ProvisioningManager$FeatureProvisioningCallback$CallbackBinder$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m4484xa236cb0b(capability, tech, isProvisioned);
                        }
                    });
                } finally {
                    restoreCallingIdentity(callingIdentity);
            ...
            /* renamed from: lambda$onFeatureProvisioningChanged$0$android-telephony-ims-ProvisioningManager$FeatureProvisioningCallback$CallbackBinder, reason: not valid java name */
            /* synthetic */ void m4484xa236cb0b(int capability, int tech, boolean isProvisioned) {
            ...
            public final void onRcsFeatureProvisioningChanged(final int capability, final int tech, final boolean isProvisioned) {
                ...
                try {
                    this.mExecutor.execute(new Runnable() { // from class: android.telephony.ims.ProvisioningManager$FeatureProvisioningCallback$CallbackBinder$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m4485xb6c407e0(capability, tech, isProvisioned);
                        }
                    });
                } finally {
                    restoreCallingIdentity(callingIdentity);
            ...
            /* renamed from: lambda$onRcsFeatureProvisioningChanged$1$android-telephony-ims-ProvisioningManager$FeatureProvisioningCallback$CallbackBinder, reason: not valid java name */
            /* synthetic */ void m4485xb6c407e0(int capability, int tech, boolean isProvisioned) {
    ...
    public static class RcsProvisioningCallback {
        ...
        static class CallbackBinder extends IRcsConfigCallback.Stub {
            ...
            public void onConfigurationChanged(final byte[] configXml) {
                ...
                try {
                    this.mExecutor.execute(new Runnable() { // from class: android.telephony.ims.ProvisioningManager$RcsProvisioningCallback$CallbackBinder$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m4488xd452bb52(configXml);
                        }
                    });
                } finally {
            ...
            /* renamed from: lambda$onConfigurationChanged$0$android-telephony-ims-ProvisioningManager$RcsProvisioningCallback$CallbackBinder, reason: not valid java name */
            /* synthetic */ void m4488xd452bb52(byte[] configXml) {
            ...
            public void onAutoConfigurationErrorReceived(final int errorCode, final String errorString) {
                ...
                try {
                    this.mExecutor.execute(new Runnable() { // from class: android.telephony.ims.ProvisioningManager$RcsProvisioningCallback$CallbackBinder$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m4487x8c25030d(errorCode, errorString);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(identity);
            ...
            /* renamed from: lambda$onAutoConfigurationErrorReceived$1$android-telephony-ims-ProvisioningManager$RcsProvisioningCallback$CallbackBinder, reason: not valid java name */
            /* synthetic */ void m4487x8c25030d(int errorCode, String errorString) {
            ...
            /* renamed from: lambda$onConfigurationReset$2$android-telephony-ims-ProvisioningManager$RcsProvisioningCallback$CallbackBinder, reason: not valid java name */
            /* synthetic */ void m4489xa367795() {
            ...
            /* renamed from: lambda$onRemoved$3$android-telephony-ims-ProvisioningManager$RcsProvisioningCallback$CallbackBinder, reason: not valid java name */
            /* synthetic */ void m4491x12680b65() {
            ...
            public void onPreProvisioningReceived(final byte[] configXml) {
                ...
                try {
                    this.mExecutor.execute(new Runnable() { // from class: android.telephony.ims.ProvisioningManager$RcsProvisioningCallback$CallbackBinder$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m4490x38e7c713(configXml);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(identity);
            ...
            /* renamed from: lambda$onPreProvisioningReceived$4$android-telephony-ims-ProvisioningManager$RcsProvisioningCallback$CallbackBinder, reason: not valid java name */
            /* synthetic */ void m4490x38e7c713(byte[] configXml) {
