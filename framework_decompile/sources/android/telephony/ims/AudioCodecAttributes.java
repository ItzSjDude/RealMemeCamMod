...
public final class AudioCodecAttributes implements Parcelable {
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeFloat(((Float) this.mBitrateRangeKbps.getLower()).floatValue());
        out.writeFloat(((Float) this.mBitrateRangeKbps.getUpper()).floatValue());
        out.writeFloat(this.mBandwidthKhz);
        out.writeFloat(((Float) this.mBandwidthRangeKhz.getLower()).floatValue());
        out.writeFloat(((Float) this.mBandwidthRangeKhz.getUpper()).floatValue());
    }
