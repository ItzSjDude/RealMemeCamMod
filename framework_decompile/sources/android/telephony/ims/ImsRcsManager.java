...
public class ImsRcsManager {
    ...
    static class AvailabilityCallbackAdapter {
        ...
        static class CapabilityBinder extends IImsCapabilityCallback.Stub {
            ...
            /* renamed from: lambda$onCapabilitiesStatusChanged$0$android-telephony-ims-ImsRcsManager$AvailabilityCallbackAdapter$CapabilityBinder, reason: not valid java name */
            /* synthetic */ void m4446xd294b1a(int config) {
    ...
    private AvailabilityCallbackAdapter removeAvailabilityChangedListenerFromCollection(OnAvailabilityChangedListener listener) {
        ...
        synchronized (this.mAvailabilityChangedCallbacks) {
            availabilityCallbackAdapterRemove = this.mAvailabilityChangedCallbacks.remove(listener);
        }
