...
public final class DataProfile implements Parcelable {
    ...
    private DataProfile(Builder builder) {
        ...
        if (apnSetting != null) {
            ...
            String operator = apnSetting.getOperatorNumeric();
            if (networkTypes == 0 || (operator != null && "45507".equals(operator) && ServiceState.bearerBitmapHasCdma(networkTypes) && ServiceState.bearerBitmapHasGsm(networkTypes))) {
                this.mType = 0;
                return;
            }
            if ((networkTypes & TelephonyManager.NETWORK_STANDARDS_FAMILY_BITMASK_3GPP2) == networkTypes) {
                this.mType = 2;
                return;
