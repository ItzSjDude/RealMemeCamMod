...
public class ApnSetting implements Parcelable {
    ...
    private static IApnSettingExt mApnSetting;
    ...
    static {
        ...
        arrayMap.put(TYPE_RCS_STRING, 32768);
        ...
        arrayMap2.put(32768, TYPE_RCS_STRING);
        ...
        mApnSetting = (IApnSettingExt) ExtLoader.type(IApnSettingExt.class).base(null).create();
    ...
    public static ApnSetting makeApnSetting(Cursor cursor) {
        int apnTypesBitmask;
        boolean isQcom = OplusTelephonyUtils.isQcomPlatform;
        if (isQcom) {
            String numeric = cursor.getString(cursor.getColumnIndexOrThrow(Telephony.Carriers.NUMERIC));
            apnTypesBitmask = mApnSetting.oemGetApnTypesBitmaskFromString(cursor.getString(cursor.getColumnIndexOrThrow("type")), numeric);
        } else {
            apnTypesBitmask = getApnTypesBitmaskFromString(cursor.getString(cursor.getColumnIndexOrThrow("type")));
        }
    ...
    public String toString() {
        ...
        sbAppend.append(map.get(Integer.valueOf(this.mProtocol)));
    ...
    public boolean similar(ApnSetting other) {
        boolean isQcom = OplusTelephonyUtils.isQcomPlatform;
        return isQcom ? !canHandleType(8) && !other.canHandleType(8) && Objects.equals(this.mApnName, other.mApnName) && xorEqualsString(this.mProxyAddress, other.mProxyAddress) && xorEqualsInt(this.mProxyPort, other.mProxyPort) && xorEquals(this.mMmsc, other.mMmsc) && xorEqualsString(this.mMmsProxyAddress, other.mMmsProxyAddress) && xorEqualsInt(this.mMmsProxyPort, other.mMmsProxyPort) && mApnSetting.oemMergeApnIgnoreUserPasswordAuthType(this, other) && !typeSameAny(this, other) && Objects.equals(this.mOperatorNumeric, other.mOperatorNumeric) && mApnSetting.oemMergeApnIgnoreProtocolType(this, other) && mtuUnsetOrEquals(this.mMtuV4, other.mMtuV4) && mtuUnsetOrEquals(this.mMtuV6, other.mMtuV6) && Objects.equals(Boolean.valueOf(this.mCarrierEnabled), Boolean.valueOf(other.mCarrierEnabled)) && Objects.equals(Integer.valueOf(this.mNetworkTypeBitmask), Integer.valueOf(other.mNetworkTypeBitmask)) && Objects.equals(Long.valueOf(this.mLingeringNetworkTypeBitmask), Long.valueOf(other.mLingeringNetworkTypeBitmask)) && Objects.equals(Integer.valueOf(this.mProfileId), Integer.valueOf(other.mProfileId)) && Objects.equals(Boolean.valueOf(this.mPersistent), Boolean.valueOf(other.mPersistent)) && Objects.equals(Integer.valueOf(this.mMvnoType), Integer.valueOf(other.mMvnoType)) && Objects.equals(this.mMvnoMatchData, other.mMvnoMatchData) && Objects.equals(Integer.valueOf(this.mApnSetId), Integer.valueOf(other.mApnSetId)) && Objects.equals(Integer.valueOf(this.mCarrierId), Integer.valueOf(other.mCarrierId)) && Objects.equals(Integer.valueOf(this.mSkip464Xlat), Integer.valueOf(other.mSkip464Xlat)) && Objects.equals(Boolean.valueOf(this.mAlwaysOn), Boolean.valueOf(other.mAlwaysOn)) : !canHandleType(8) && !other.canHandleType(8) && Objects.equals(this.mApnName, other.mApnName) && xorEqualsString(this.mProxyAddress, other.mProxyAddress) && xorEqualsInt(this.mProxyPort, other.mProxyPort) && xorEquals(this.mMmsc, other.mMmsc) && xorEqualsString(this.mMmsProxyAddress, other.mMmsProxyAddress) && xorEqualsInt(this.mMmsProxyPort, other.mMmsProxyPort) && mApnSetting.oemMergeApnIgnoreUserPasswordAuthType(this, other) && !typeSameAny(this, other) && Objects.equals(this.mOperatorNumeric, other.mOperatorNumeric) && Objects.equals(Integer.valueOf(this.mProtocol), Integer.valueOf(other.mProtocol)) && Objects.equals(Integer.valueOf(this.mRoamingProtocol), Integer.valueOf(other.mRoamingProtocol)) && mtuUnsetOrEquals(this.mMtuV4, other.mMtuV4) && mtuUnsetOrEquals(this.mMtuV6, other.mMtuV6) && Objects.equals(Boolean.valueOf(this.mCarrierEnabled), Boolean.valueOf(other.mCarrierEnabled)) && Objects.equals(Integer.valueOf(this.mNetworkTypeBitmask), Integer.valueOf(other.mNetworkTypeBitmask)) && Objects.equals(Long.valueOf(this.mLingeringNetworkTypeBitmask), Long.valueOf(other.mLingeringNetworkTypeBitmask)) && mApnSetting.oemEqualsProfileId(this.mProfileId, other.mProfileId) && Objects.equals(Boolean.valueOf(this.mPersistent), Boolean.valueOf(other.mPersistent)) && Objects.equals(Integer.valueOf(this.mMvnoType), Integer.valueOf(other.mMvnoType)) && Objects.equals(this.mMvnoMatchData, other.mMvnoMatchData) && Objects.equals(Integer.valueOf(this.mApnSetId), Integer.valueOf(other.mApnSetId)) && Objects.equals(Integer.valueOf(this.mCarrierId), Integer.valueOf(other.mCarrierId)) && Objects.equals(Integer.valueOf(this.mSkip464Xlat), Integer.valueOf(other.mSkip464Xlat)) && Objects.equals(Boolean.valueOf(this.mAlwaysOn), Boolean.valueOf(other.mAlwaysOn));
    }
    ...
    private static int portFromString(String strPort) throws NumberFormatException {
        ...
        public ApnSetting build() {
            ...
            if ((this.mApnTypeBitmask & 2) != 0 && !TextUtils.isEmpty(this.mMmsProxyAddress) && this.mMmsProxyAddress.startsWith(IntentFilter.SCHEME_HTTP)) {
                if (Build.IS_DEBUGGABLE) {
                    throw new IllegalArgumentException("mms proxy(" + this.mMmsProxyAddress + ") should be a hostname, not a url");
                }
                return null;
            }
