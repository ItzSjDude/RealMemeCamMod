...
public class SubscriptionManager {
    ...
    static {
        ...
        sDefaultDataSubIdCache = new VoidPropertyInvalidatedCache<>(new FunctionalUtils.ThrowingFunction() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda4
            @Override // com.android.internal.util.FunctionalUtils.ThrowingFunction
            public final Object applyOrThrow(Object obj) {
                return Integer.valueOf(((ISub) obj).getDefaultDataSubId());
            }
        }, CACHE_KEY_DEFAULT_DATA_SUB_ID_PROPERTY, -1);
        sDefaultSmsSubIdCache = new VoidPropertyInvalidatedCache<>(new FunctionalUtils.ThrowingFunction() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda5
            @Override // com.android.internal.util.FunctionalUtils.ThrowingFunction
            public final Object applyOrThrow(Object obj) {
                return Integer.valueOf(((ISub) obj).getDefaultSmsSubId());
            }
        }, CACHE_KEY_DEFAULT_SMS_SUB_ID_PROPERTY, -1);
        sActiveDataSubIdCache = new VoidPropertyInvalidatedCache<>(new FunctionalUtils.ThrowingFunction() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda6
            @Override // com.android.internal.util.FunctionalUtils.ThrowingFunction
            public final Object applyOrThrow(Object obj) {
                return Integer.valueOf(((ISub) obj).getActiveDataSubscriptionId());
            }
        }, CACHE_KEY_ACTIVE_DATA_SUB_ID_PROPERTY, -1);
        sSlotIndexCache = new IntegerPropertyInvalidatedCache<>(new FunctionalUtils.ThrowingBiFunction() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda7
        ...
        sPhoneIdCache = new IntegerPropertyInvalidatedCache<>(new FunctionalUtils.ThrowingBiFunction() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda8
            @Override // com.android.internal.util.FunctionalUtils.ThrowingBiFunction
            public final Object applyOrThrow(Object obj, Object obj2) {
    ...
    public List<SubscriptionInfo> getCompleteActiveSubscriptionInfoList() throws RemoteException {
    ...
    public List<SubscriptionInfo> getActiveSubscriptionInfoList(boolean userVisibleOnly) throws RemoteException {
        ...
        return (List) activeList.stream().filter(new Predicate() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda16
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return this.f$0.m4271xe0664b6e((SubscriptionInfo) obj);
            }
    ...
    public int setIconTint(final int tint, final int subId) {
        return setSubscriptionPropertyHelper(subId, "setIconTint", new CallISubMethodHelper() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda13
    ...
    public int setDisplayName(final String displayName, final int subId, final int nameSource) {
        return setSubscriptionPropertyHelper(subId, "setDisplayName", new CallISubMethodHelper() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda14
            @Override // android.telephony.SubscriptionManager.CallISubMethodHelper
            public final int callMethod(ISub iSub) {
    ...
    public int setDisplayNumber(final String number, final int subId) {
        ...
        return setSubscriptionPropertyHelper(subId, "setDisplayNumber", new CallISubMethodHelper() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda17
            @Override // android.telephony.SubscriptionManager.CallISubMethodHelper
            public final int callMethod(ISub iSub) {
    ...
    public static String serializeUriLists(List<Uri> uris) throws IOException {
    ...
    private static String getSubscriptionProperty(int subId, String propKey, Context context) {
        try {
            ...
            loge("getSubscriptionProperty(" + subId + "," + propKey + ") RemoteException, return null!");
            return null;
        }
    }
    ...
    public boolean setOpportunistic(final boolean opportunistic, final int subId) {
        return setSubscriptionPropertyHelper(subId, "setOpportunistic", new CallISubMethodHelper() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda12
            @Override // android.telephony.SubscriptionManager.CallISubMethodHelper
            public final int callMethod(ISub iSub) {
                return this.f$0.m4272lambda$setOpportunistic$6$androidtelephonySubscriptionManager(opportunistic, subId, iSub);
            }
        }) == 1;
    }

    /* renamed from: lambda$setOpportunistic$6$android-telephony-SubscriptionManager, reason: not valid java name */
    /* synthetic */ int m4272lambda$setOpportunistic$6$androidtelephonySubscriptionManager(boolean opportunistic, int subId, ISub iSub) throws RemoteException {
    ...
    public ParcelUuid createSubscriptionGroup(List<Integer> subIdList) {
        ...
        int[] subIdArray = subIdList.stream().mapToInt(new ToIntFunction() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda15
    ...
    public void removeSubscriptionsFromGroup(List<Integer> subIdList, ParcelUuid groupUuid) {
        ...
        Context context = this.mContext;
        String pkgForDebug = context != null ? context.getOpPackageName() : "<unknown>";
        int[] subIdArray = subIdList.stream().mapToInt(new ToIntFunction() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda9
            @Override // java.util.function.ToIntFunction
            public final int applyAsInt(Object obj) {
                return ((Integer) obj).intValue();
            }
    ...
    public boolean m4271xe0664b6e(SubscriptionInfo info) {
        if (info == null) {
            return false;
        }
    ...
    public void setDeviceToDeviceStatusSharingPreference(final int subscriptionId, final int sharing) {
        setSubscriptionPropertyHelper(subscriptionId, "setDeviceToDeviceSharingStatus", new CallISubMethodHelper() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda18
            @Override // android.telephony.SubscriptionManager.CallISubMethodHelper
            public final int callMethod(ISub iSub) {
                return iSub.setDeviceToDeviceStatusSharing(sharing, subscriptionId);
            }
        });
    }
    ...
    public void setDeviceToDeviceStatusSharingContacts(final int subscriptionId, final List<Uri> contacts) throws IOException {
        serializeUriLists(contacts);
        setSubscriptionPropertyHelper(subscriptionId, "setDeviceToDeviceSharingStatus", new CallISubMethodHelper() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda10
            @Override // android.telephony.SubscriptionManager.CallISubMethodHelper
            public final int callMethod(ISub iSub) {
                return iSub.setDeviceToDeviceStatusSharingContacts(SubscriptionManager.serializeUriLists(contacts), subscriptionId);
            }
        });
    }
    ...
    void setUsageSetting(final int subscriptionId, final int usageSetting) {
        setSubscriptionPropertyHelper(subscriptionId, "setUsageSetting", new CallISubMethodHelper() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda2
            @Override // android.telephony.SubscriptionManager.CallISubMethodHelper
            public final int callMethod(ISub iSub) {
                return this.f$0.m4273lambda$setUsageSetting$12$androidtelephonySubscriptionManager(usageSetting, subscriptionId, iSub);
            }
        });
    }

    /* renamed from: lambda$setUsageSetting$12$android-telephony-SubscriptionManager, reason: not valid java name */
    /* synthetic */ int m4273lambda$setUsageSetting$12$androidtelephonySubscriptionManager(int usageSetting, int subscriptionId, ISub iSub) throws RemoteException {
