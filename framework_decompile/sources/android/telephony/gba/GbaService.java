...
public class GbaService extends Service {
    ...
    public void onAuthenticationRequest(int subscriptionId, int token, int appType, Uri nafUrl, byte[] securityProtocol, boolean forceBootStrapping) throws RuntimeException {
