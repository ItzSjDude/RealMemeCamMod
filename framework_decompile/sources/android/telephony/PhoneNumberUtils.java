...
public class PhoneNumberUtils {
    ...
    public static IPhoneNumberUtilsExt sUtilsExt = (IPhoneNumberUtilsExt) ExtLoader.type(IPhoneNumberUtilsExt.class).base(null).create();
    ...
    public static String getNumberFromIntent(Intent intent, Context context) {
        String scheme;
        String number = sUtilsExt.getNumberFromIntent(intent, context, null);
        if (number != null) {
            return number;
        }
        ...
        String phoneColumn = Contacts.AUTHORITY.equals(authority) ? "number" : ContactsContract.AUTHORITY.equals(authority) ? "data1" : null;
        Cursor c = null;
        try {
            try {
    ...
    @Deprecated
    public static boolean compare(Context context, String a, String b) throws Resources.NotFoundException {
    ...
    public static byte[] numberToCalledPartyBCD(String number, int bcdExtType) {
        String number2 = sUtilsExt.stripSeparators(number);
        if (number2 == null) {
            return null;
        }
        ...
        while (true) {
            ...
            if (i < number.length()) {
                if (is12Key(number.charAt(i))) {
                    objValueOf = Character.valueOf(number.charAt(i));
                }
