...
public class SignalStrength implements Parcelable {
    ...
    public static SignalStrength makeSignalStrength(Parcel in) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
    ...
    private class SignalStrengthWrapper implements ISignalStrengthWrapper {
        ...
        @Override // android.telephony.ISignalStrengthWrapper
        public void setOemLevel(int oemLevel0, int oemLevel1) {
            if (-1 != oemLevel0) {
                SignalStrength.this.mOEMLevel_0 = oemLevel0;
            }
            if (-1 != oemLevel1) {
                SignalStrength.this.mOEMLevel_1 = oemLevel1;
            }
        }

        @Override // android.telephony.ISignalStrengthWrapper
        public void setFake(boolean isFake) {
            SignalStrength.this.mIsFake = isFake;
        }
        ...
        public void copyFrom(SignalStrength s) {
            SignalStrength.this.copyFrom(s);
        }
