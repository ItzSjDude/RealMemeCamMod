...
public final class SmsManager {
    ...
    public void sendTextMessage(String destinationAddress, String scAddress, String text, PendingIntent sentIntent, PendingIntent deliveryIntent) throws NoSuchMethodException, RemoteException, ClassNotFoundException, SecurityException {
    ...
    public void sendTextMessage(String destinationAddress, String scAddress, String text, PendingIntent sentIntent, PendingIntent deliveryIntent, long messageId) throws NoSuchMethodException, RemoteException, ClassNotFoundException, SecurityException {
    ...
    public void sendTextMessage(String destinationAddress, String scAddress, String text, PendingIntent sentIntent, PendingIntent deliveryIntent, int priority, boolean expectMore, int validityPeriod) throws NoSuchMethodException, RemoteException, ClassNotFoundException, SecurityException {
    ...
    private void sendTextMessageInternal(final String destinationAddress, final String scAddress, final String text, final PendingIntent sentIntent, final PendingIntent deliveryIntent, final boolean persistMessage, final String packageName, final String attributionTag, final long messageId) throws NoSuchMethodException, RemoteException, ClassNotFoundException, SecurityException {
    ...
    public void sendTextMessageWithoutPersisting(String destinationAddress, String scAddress, String text, PendingIntent sentIntent, PendingIntent deliveryIntent) throws NoSuchMethodException, RemoteException, ClassNotFoundException, SecurityException {
    ...
    private void sendTextMessageInternal(final String destinationAddress, final String scAddress, final String text, final PendingIntent sentIntent, final PendingIntent deliveryIntent, final boolean persistMessage, int priority, final boolean expectMore, int validityPeriod) throws NoSuchMethodException, RemoteException, ClassNotFoundException, SecurityException {
        int priority2;
    ...
    public void sendMultipartTextMessage(String destinationAddress, String scAddress, ArrayList<String> parts, ArrayList<PendingIntent> sentIntents, ArrayList<PendingIntent> deliveryIntents) throws NoSuchMethodException, RemoteException, ClassNotFoundException, SecurityException {
    ...
    public void sendMultipartTextMessage(String destinationAddress, String scAddress, List<String> parts, List<PendingIntent> sentIntents, List<PendingIntent> deliveryIntents, long messageId) throws NoSuchMethodException, RemoteException, ClassNotFoundException, SecurityException {
    ...
    public void sendMultipartTextMessage(String destinationAddress, String scAddress, List<String> parts, List<PendingIntent> sentIntents, List<PendingIntent> deliveryIntents, String packageName, String attributionTag) throws NoSuchMethodException, RemoteException, ClassNotFoundException, SecurityException {
    ...
    @SystemApi
    public void sendMultipartTextMessageWithoutPersisting(String destinationAddress, String scAddress, List<String> parts, List<PendingIntent> sentIntents, List<PendingIntent> deliveryIntents) throws NoSuchMethodException, RemoteException, ClassNotFoundException, SecurityException {
    ...
    public void sendDataMessage(final String destinationAddress, final String scAddress, final short destinationPort, final byte[] data, final PendingIntent sentIntent, final PendingIntent deliveryIntent) throws NoSuchMethodException, RemoteException, ClassNotFoundException, SecurityException {
        if (TextUtils.isEmpty(destinationAddress)) {
            throw new IllegalArgumentException("Invalid destinationAddress");
        }
    ...
    private void resolveSubscriptionForOperation(final SubscriptionResolverResult resolverResult) throws NoSuchMethodException, RemoteException, ClassNotFoundException, SecurityException {
    ...
    public void sendMultimediaMessage(Context context, Uri contentUri, String locationUrl, Bundle configOverrides, PendingIntent sentIntent) throws NoSuchMethodException, RemoteException, ClassNotFoundException, SecurityException {
        sendMultimediaMessage(context, contentUri, locationUrl, configOverrides, sentIntent, 0L);
    }

    public void sendMultimediaMessage(Context context, final Uri contentUri, final String locationUrl, final Bundle configOverrides, final PendingIntent sentIntent, final long messageId) throws NoSuchMethodException, RemoteException, ClassNotFoundException, SecurityException {
        if (contentUri == null) {
    ...
    public void downloadMultimediaMessage(Context context, String locationUrl, Uri contentUri, Bundle configOverrides, PendingIntent downloadedIntent) throws NoSuchMethodException, RemoteException, ClassNotFoundException, SecurityException {
        downloadMultimediaMessage(context, locationUrl, contentUri, configOverrides, downloadedIntent, 0L);
    }

    public void downloadMultimediaMessage(Context context, final String locationUrl, final Uri contentUri, final Bundle configOverrides, final PendingIntent downloadedIntent, final long messageId) throws NoSuchMethodException, RemoteException, ClassNotFoundException, SecurityException {
    ...
    private boolean checkSimPickActivityNeeded(boolean needed) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        ...
        if (SystemProperties.get("ro.vendor.mtk_telephony_add_on_policy", "0").equals("0")) {
            try {
                ...
                if (clazz == null) {
                    com.android.telephony.Rlog.e(TAG, "MtkSmsManager does not exist!");
                } else {
                    Method clazzMethod = clazz.getDeclaredMethod("checkSimPickActivityNeeded", Boolean.TYPE);
                    if (clazzMethod == null) {
                        com.android.telephony.Rlog.e(TAG, "checkSimPickActivityNeeded() does not exist!");
                    } else {
                        result = ((Boolean) clazzMethod.invoke(null, Boolean.valueOf(result))).booleanValue();
                    }
                }
            } catch (Exception e) {
                com.android.telephony.Rlog.e(TAG, "checkSimPickActivityNeeded() does not exist! " + e);
            }
        }
        return result;
    }
