...
public final class UiccAccessRule implements Parcelable {
    ...
    public static byte[] encodeRules(UiccAccessRule[] accessRules) throws IOException {
        if (accessRules == null) {
            return null;
        }
        try {
    ...
    public int getCarrierPrivilegeStatus(PackageInfo packageInfo) throws NoSuchAlgorithmException {
    ...
    public int getCarrierPrivilegeStatus(Signature signature, String packageName) throws NoSuchAlgorithmException {
    ...
    public static byte[] getCertHash(Signature signature, String algo) throws NoSuchAlgorithmException {
        try {
