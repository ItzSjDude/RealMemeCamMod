...
public final class NetworkRegistrationInfo implements Parcelable {
    ...
    public NetworkRegistrationInfo(int domain, int transportType, int registrationState, int accessNetworkTechnology, int rejectCause, boolean emergencyOnly, List<Integer> availableServices, CellIdentity cellIdentity, String rplmn, int maxDataCalls, boolean isDcNrRestricted, boolean isNrAvailable, boolean isEndcAvailable, VopsSupportInfo vopsSupportInfo) {
        this(domain, transportType, registrationState, accessNetworkTechnology, rejectCause, emergencyOnly, availableServices, cellIdentity, rplmn, null, new DataSpecificRegistrationInfo(maxDataCalls, isDcNrRestricted, isNrAvailable, isEndcAvailable, vopsSupportInfo));
    }
    ...
    public String toString() {
        StringBuilder sbAppend = new StringBuilder("NetworkRegistrationInfo{").append(" domain=").append(domainToString(this.mDomain)).append(" transportType=").append(AccessNetworkConstants.transportTypeToString(this.mTransportType)).append(" registrationState=").append(registrationStateToString(this.mRegistrationState)).append(" roamingType=").append(ServiceState.roamingTypeToString(this.mRoamingType)).append(" accessNetworkTechnology=").append(TelephonyManager.getNetworkTypeName(this.mAccessNetworkTechnology)).append(" rejectCause=").append(this.mRejectCause).append(" emergencyEnabled=").append(this.mEmergencyOnly).append(" availableServices=");
        StringBuilder sbAppend2 = new StringBuilder().append(NavigationBarInflaterView.SIZE_MOD_START);
        ArrayList<Integer> arrayList = this.mAvailableServices;
        return sbAppend.append(sbAppend2.append(arrayList != null ? (String) arrayList.stream().map(new Function() { // from class: android.telephony.NetworkRegistrationInfo$$ExternalSyntheticLambda0
    ...
    public static final class Builder {
        ...
        public NetworkRegistrationInfo build() {
            return new NetworkRegistrationInfo(this.mDomain, this.mTransportType, this.mRegistrationState, this.mAccessNetworkTechnology, this.mRejectCause, this.mEmergencyOnly, this.mAvailableServices, this.mCellIdentity, this.mRplmn, this.mVoiceSpecificRegistrationInfo, this.mDataSpecificRegistrationInfo);
        }
    }
}
