...
public class AccessNetworkUtils {
    ...
    public static int getOperatingBandForUarfcn(int uarfcn) {
        int[] addlBand2 = {412, FrameworkStatsLog.BOOT_COMPLETED_BROADCAST_COMPLETION_LATENCY_REPORTED, MetricsProto.MetricsEvent.ACTION_DELETION_SELECTION_APP_ON, MetricsProto.MetricsEvent.ACTION_SUPPORT_DIAL_TOLLED, 512, MetricsProto.MetricsEvent.DIALOG_NO_HOME, 562, 587, MetricsProto.MetricsEvent.PROVISIONING_EXTRA, MetricsProto.MetricsEvent.ACTION_PERMISSION_REVOKE_READ_CALENDAR, MetricsProto.MetricsEvent.ACTION_PERMISSION_REQUEST_ACCESS_COARSE_LOCATION, MetricsProto.MetricsEvent.ACTION_PERMISSION_GRANT_ADD_VOICEMAIL};
        int[] addlBand4 = {SettingsEnums.SECURITY_WARNINGS, SettingsEnums.ACCESSIBILITY_TEXT_READING_OPTIONS, 1937, 1962, 1987, 2012, 2037, 2062, 2087};
    ...
    public static int getFrequencyFromNrArfcn(int nrArfcn) {
        ...
        while (true) {
            ...
            AccessNetworkConstants.NgranArfcnFrequency nrArfcnFrequency = ngranArfcnFrequencyArrValues[i];
    ...
    */
    ...
    public static int getFrequencyFromUarfcn(int band, int uarfcn, boolean isUplink) {
        ...
        while (true) {
            ...
            AccessNetworkConstants.UtranBandArfcnFrequency uarfcnFrequency = utranBandArfcnFrequencyArrValues[i];
    ...
    public static int getFrequencyFromArfcn(int band, int arfcn, boolean isUplink) {
        ...
        while (true) {
            ...
            AccessNetworkConstants.GeranBandArfcnFrequency arfcnFrequency = geranBandArfcnFrequencyArrValues[i];
