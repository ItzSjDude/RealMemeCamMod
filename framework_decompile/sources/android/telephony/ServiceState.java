...
public class ServiceState implements Parcelable {
    ...
    public static int getBitmaskFromString(String bearerList) throws NumberFormatException {
    ...
    public static boolean bearerBitmapHasGsm(int networkTypeBitmask) {
        return (convertNetworkTypeBitmaskToBearerBitmask(networkTypeBitmask) & RIL_RADIO_GSM_TECHNOLOGY_BITMASK) != 0;
    }
}
