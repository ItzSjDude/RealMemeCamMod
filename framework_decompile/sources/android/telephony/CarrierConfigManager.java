...
public class CarrierConfigManager {
    ...
    public static final String KEY_5G_NR_SSRSRP_THRESHOLDS_INT_ARRAY_OPLUS = "5g_nr_ssrsrp_thresholds_int_array_oplus";
    ...
    public static final String KEY_NR_ULTRA_WIDEBAND_ICON_MIN_BANDWIDTH_MODE = "5g_ultra_wideband_icon_min_bandwidth_mode";
    public static final String KEY_NR_ULTRA_WIDEBAND_ICON_MIN_BANDWIDTH_VALUE = "5g_ultra_wideband_icon_min_bandwidth_value";
    public static final String KEY_NR_ULTRA_WIDEBAND_ICON_NSA_BAND_ARRAY = "5g_ultra_wideband_icon_nsa_band_array";
    public static final String KEY_NR_ULTRA_WIDEBAND_ICON_NSA_BAND_MODE = "5g_ultra_wideband_icon_nsa_band_mode";
    public static final String KEY_NR_ULTRA_WIDEBAND_ICON_REFRESH_TIMER_MAP = "5g_ultra_wideband_icon_refresh_timer_map";
    public static final String KEY_NR_ULTRA_WIDEBAND_ICON_SA_BAND_ARRAY = "5g_ultra_wideband_icon_sa_band_array";
    public static final String KEY_NR_ULTRA_WIDEBAND_ICON_SA_BAND_MODE = "5g_ultra_wideband_icon_sa_band_mode";
    public static final String KEY_NR_ULTRA_WIDEBAND_ICON_SIB2_VALUE = "5g_ultra_wideband_icon_sib2_value";
    ...
    public static final class ImsSs {
        ...
        public static PersistableBundle getDefaults() {
            ...
            defaults.putIntArray(KEY_XCAP_OVER_UT_SUPPORTED_RATS_INT_ARRAY, new int[]{3, 5});
    ...
    static {
        ...
        persistableBundle.putBoolean(KEY_CALL_FORWARDING_WHEN_NOT_LOGGED_IN_SUPPORTED_BOOL, false);
        ...
        persistableBundle.putBoolean(KEY_IGNORE_SIM_NETWORK_LOCKED_EVENTS_BOOL, true);
        ...
        persistableBundle.putBoolean(KEY_GSM_CDMA_CALLS_CAN_BE_HD_AUDIO, true);
        ...
        persistableBundle.putIntArray(KEY_5G_NR_SSRSRP_THRESHOLDS_INT_ARRAY_OPLUS, new int[]{-128, PackageManager.INSTALL_FAILED_BAD_SIGNATURE, PackageManager.INSTALL_PARSE_FAILED_MANIFEST_MALFORMED, -98});
        ...
        persistableBundle.putInt(KEY_NR_ULTRA_WIDEBAND_ICON_SIB2_VALUE, -1);
        persistableBundle.putInt(KEY_NR_ULTRA_WIDEBAND_ICON_MIN_BANDWIDTH_VALUE, 0);
        persistableBundle.putInt(KEY_NR_ULTRA_WIDEBAND_ICON_MIN_BANDWIDTH_MODE, 0);
        persistableBundle.putPersistableBundle(KEY_NR_ULTRA_WIDEBAND_ICON_REFRESH_TIMER_MAP, PersistableBundle.EMPTY);
        persistableBundle.putInt(KEY_NR_ULTRA_WIDEBAND_ICON_NSA_BAND_MODE, 0);
        persistableBundle.putIntArray(KEY_NR_ULTRA_WIDEBAND_ICON_SA_BAND_ARRAY, new int[0]);
        persistableBundle.putInt(KEY_NR_ULTRA_WIDEBAND_ICON_SA_BAND_MODE, 0);
        persistableBundle.putIntArray(KEY_NR_ULTRA_WIDEBAND_ICON_NSA_BAND_ARRAY, new int[0]);
        ...
        persistableBundle.putStringArray(KEY_TELEPHONY_DATA_SETUP_RETRY_RULES_STRING_ARRAY, new String[]{"capabilities=eims, retry_interval=1000, maximum_retries=20", "fail_causes=8|27|28|29|30|32|33|35|50|51|111|-5|-6|65537|65538|-3|2252|2253|2254, maximum_retries=0", "capabilities=mms|supl|cbs, retry_interval=2000", "capabilities=internet|enterprise|dun|ims|fota, retry_interval=2500|3000|5000|10000|15000|20000|40000|60000|120000|240000|600000|1200000|1800000, maximum_retries=20"});
        ...
        persistableBundle.putBoolean(KEY_CARRIER_SUPPORTS_MULTIANCHOR_CONFERENCE, false);
        ...
        ICarrierConfigManagerExt configManagerExt = (ICarrierConfigManagerExt) ExtLoader.type(ICarrierConfigManagerExt.class).base(null).create();
        configManagerExt.putDefault(persistableBundle);
        persistableBundle.putBoolean(KEY_VONR_SETTING_VISIBILITY_BOOL, true);
        persistableBundle.putBoolean(KEY_VONR_ENABLED_BOOL, false);
        persistableBundle.putStringArray(KEY_IWLAN_HANDOVER_POLICY_STRING_ARRAY, new String[]{"source=GERAN|UTRAN|EUTRAN|NGRAN|IWLAN, target=GERAN|UTRAN|EUTRAN|NGRAN|IWLAN, type=allowed"});
        ...
        try {
            ...
            com.android.telephony.Rlog.w(TAG, "No MtkCarrierConfigManager! Do nothing. - " + e);
        }
    }
