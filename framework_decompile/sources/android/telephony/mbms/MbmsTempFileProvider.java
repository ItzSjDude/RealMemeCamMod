...
public class MbmsTempFileProvider extends ContentProvider {
    ...
    public static Uri getUriForFile(Context context, String authority, File file) throws IOException {
        String pathFragment;
        try {
    ...
    public static File getFileForUri(Context context, String authority, Uri uri) throws IOException {
