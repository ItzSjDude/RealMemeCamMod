...
public class TextUtils {
    ...
    */
    public static java.lang.CharSequence ellipsize(java.lang.CharSequence r25, android.text.TextPaint r26, float r27, android.text.TextUtils.TruncateAt r28, boolean r29, android.text.TextUtils.EllipsizeCallback r30, android.text.TextDirectionHeuristic r31, java.lang.String r32) throws java.lang.Throwable {
        /*
    ...
    public static CharSequence listEllipsize(Context context, List<CharSequence> elements, String separator, TextPaint paint, float avail, int moreId) throws Resources.NotFoundException {
        int totalLen;
        Resources res;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static java.lang.CharSequence commaEllipsize(java.lang.CharSequence r22, android.text.TextPaint r23, float r24, java.lang.String r25, java.lang.String r26, android.text.TextDirectionHeuristic r27) throws java.lang.Throwable {
        /*
    ...
    public static boolean delimitedStringContains(String delimitedString, char delimiter, String item) {
        ...
        while (true) {
            int iIndexOf = delimitedString.indexOf(item, pos + 1);
            pos = iIndexOf;
            if (iIndexOf == -1) {
                return false;
            }
