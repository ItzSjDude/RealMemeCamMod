...
public class TextShaper {
    ...
    public static void shapeText(CharSequence text, int start, int count, TextDirectionHeuristic dir, TextPaint paint, GlyphsConsumer consumer) throws Throwable {
        TextLine tl;
