...
public final class Formatter {
    ...
    public static String formatFileSize(Context context, long sizeBytes, int flags) throws Resources.NotFoundException {
        if (context == null) {
            return "";
        }
    ...
    public static String formatShortFileSize(Context context, long sizeBytes) throws Resources.NotFoundException {
        if (context == null) {
            return "";
        }
    ...
    public static BytesResult formatBytes(Resources res, long sizeBytes, int flags) throws Resources.NotFoundException {
        int roundFactor;
        String roundFormat;
