...
public class DynamicLayout extends Layout {
    ...
    private DynamicLayout(Builder b) throws Throwable {
    ...
    private void generate(Builder b) throws Throwable {
        int[] start;
        this.mBase = b.mBase;
    ...
    public void reflow(CharSequence s, int where, int before, int after) throws Throwable {
        int find;
        int look;
        int where2;
        int endline;
    ...
    private void addBlockAtOffset(int offset) {
        ...
        if (iArr == null) {
            ...
            iArrNewUnpaddedIntArray[i] = line;
    ...
    private static class ChangeWatcher implements TextWatcher, SpanWatcher {
        ...
        private void reflow(CharSequence s, int where, int before, int after) throws Throwable {
        ...
        @Override // android.text.TextWatcher
        public void onTextChanged(CharSequence s, int where, int before, int after) throws Throwable {
        ...
        public void onSpanAdded(Spannable s, Object o, int start, int end) throws Throwable {
        ...
        @Override // android.text.SpanWatcher
        public void onSpanRemoved(Spannable s, Object o, int start, int end) throws Throwable {
            if (o instanceof UpdateLayout) {
                reflow(s, start, end - start, end - start);
            }
        }
        ...
        @Override // android.text.SpanWatcher
        public void onSpanChanged(Spannable s, Object o, int start, int end, int nstart, int nend) throws Throwable {
            if (o instanceof UpdateLayout) {
                if (start > end) {
                    start = 0;
                }
