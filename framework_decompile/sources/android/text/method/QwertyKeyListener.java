...
public class QwertyKeyListener extends BaseKeyListener {
    ...
    public boolean onKeyDown(View view, Editable content, int keyCode, KeyEvent event) throws NumberFormatException {
        int pref;
        int selStart;
        int selEnd;
        int i;
        ...
        if (this.mFullKeyboard || (count = event.getRepeatCount()) <= 0 || selStart != selEnd || selStart <= 0) {
            i = i3;
            activeEnd = activeEnd2;
        } else {
            char c = content.charAt(selStart - 1);
            if ((c == i3 || c == Character.toUpperCase(i3)) && view != null) {
                i = i3;
                activeEnd = activeEnd2;
        ...
        if (i2 != 0) {
            ...
            if ((pref & 2) != 0 && this.mAutoText) {
                if ((i2 != 32 && i2 != 9 && i2 != 10 && i2 != 44 && i2 != 46 && i2 != 33 && i2 != 63 && i2 != 34 && Character.getType(i2) != 22) || content.getSpanEnd(TextKeyListener.INHIBIT_REPLACEMENT) == oldStart) {
                    selEnd2 = selEnd4;
                } else {
                    int x = oldStart;
                    while (x > 0) {
        ...
        if (keyCode == 67 && (event.hasNoModifiers() || event.hasModifiers(2))) {
            if (selStart == selEnd) {
                int consider = 1;
