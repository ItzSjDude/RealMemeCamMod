...
public class SpannableStringBuilder implements CharSequence, GetChars, Spannable, Editable, Appendable, GraphicsOperations {
    ...
    public SpannableStringBuilder(CharSequence text, int start, int end) {
        ...
        char[] cArrNewUnpaddedCharArray = ArrayUtils.newUnpaddedCharArray(GrowingArrayUtils.growSize(srclen));
        this.mText = cArrNewUnpaddedCharArray;
        this.mGapStart = srclen;
        this.mGapLength = cArrNewUnpaddedCharArray.length - srclen;
        TextUtils.getChars(text, start, end, cArrNewUnpaddedCharArray, 0);
        this.mSpanCount = 0;
