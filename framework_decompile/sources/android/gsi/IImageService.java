...
public interface IImageService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IImageService {
        ...
        static final int TRANSACTION_getMappedImageDevice = 13;
        static final int TRANSACTION_isImageDisabled = 12;
                ...
                default:
                    switch (code) {
                        ...
                        case 12:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result5 = isImageDisabled(_arg09);
                            reply.writeNoException();
                        ...
                        case 13:
                            ...
                            data.enforceNoDataAvail();
                            String _result6 = getMappedImageDevice(_arg010);
                            reply.writeNoException();
