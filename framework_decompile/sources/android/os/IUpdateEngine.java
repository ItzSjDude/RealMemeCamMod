...
public interface IUpdateEngine extends IInterface {
    ...
    boolean applyPostInstall() throws RemoteException;
    ...
    public static class Default implements IUpdateEngine {
        ...
        @Override // android.os.IUpdateEngine
        public boolean applyPostInstall() throws RemoteException {
            return false;
        }
    ...
    public static abstract class Stub extends Binder implements IUpdateEngine {
        ...
        static final int TRANSACTION_applyPostInstall = 15;
        ...
        static final int TRANSACTION_switchSlot = 14;
                ...
                default:
                    switch (code) {
                        ...
                        case 14:
                            ...
                            return true;
                        case 15:
                            boolean _result5 = applyPostInstall();
                            reply.writeNoException();
