...
public final class IncrementalManager {
    ...
    public void linkCodePath(File beforeCodeFile, File afterCodeFile) throws Exception {
    ...
    private static class LoadingProgressCallbacks extends IStorageLoadingProgressListener.Stub {
        ...
        public void onStorageLoadingProgressChanged(int storageId, float progress) {
            ...
            for (int i = 0; i < n; i++) {
                IPackageLoadingProgressCallback callback = (IPackageLoadingProgressCallback) callbacksForStorage.getBroadcastItem(i);
                try {
