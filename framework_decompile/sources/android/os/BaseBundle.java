...
public class BaseBundle {
    ...
    final <T> T getValueAt(int i, Class<T> cls, Class<?>... clsArr) {
        ...
        if (objValueAt instanceof BiFunction) {
            try {
                objValueAt = ((BiFunction) objValueAt).apply(cls, clsArr);
                this.mMap.setValueAt(i, objValueAt);
        ...
        return cls != null ? cls.cast(objValueAt) : (T) objValueAt;
    }
    ...
    private void initializeFromParcelLocked(Parcel parcelledData, boolean recycleParcel, boolean parcelledByNative) {
        ...
        try {
            try {
                recycleParcel2 = recycleParcel & parcelledData.readArrayMap(map, count, !parcelledByNative, recycleParcel, this.mClassLoader);
                this.mMap = map;
            } catch (BadParcelableException e) {
                if (!sShouldDefuse) {
                    throw e;
    ...
    void writeToParcelInner(Parcel parcel, int flags) throws IOException {
    ...
    public static void dumpStats(IndentingPrintWriter pw, String key, Object value) throws IOException {
    ...
    public static void dumpStats(IndentingPrintWriter pw, SparseArray array) throws IOException {
        pw.increaseIndent();
        if (array == null) {
            pw.println("[null]");
            return;
    ...
    public static void dumpStats(IndentingPrintWriter pw, BaseBundle bundle) throws IOException {
        pw.increaseIndent();
        if (bundle == null) {
            pw.println("[null]");
            return;
