...
public final class StrictMode {
    ...
    static {
        ...
        VM_ANDROID_POLICY = new BlockGuard.VmPolicy() { // from class: android.os.StrictMode.5
            public void onPathAccess(String path) throws Throwable {
                if (path == null) {
                    return;
                }
        ...
        void handleViolationWithTimingAttempt(ViolationInfo info) {
            ...
            ((Handler) StrictMode.THREAD_HANDLER.get()).postAtFrontOfQueue(new Runnable() { // from class: android.os.StrictMode$AndroidBlockGuardPolicy$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    this.f$0.m3220x9f2643d1(windowManager, records);
                }
            });
        }

        /* renamed from: lambda$handleViolationWithTimingAttempt$0$android-os-StrictMode$AndroidBlockGuardPolicy, reason: not valid java name */
        /* synthetic */ void m3220x9f2643d1(IWindowManager windowManager, ArrayList records) {
            ...
            if (listener != null && executor != null) {
                try {
                    executor.execute(new Runnable() { // from class: android.os.StrictMode$AndroidBlockGuardPolicy$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            StrictMode.AndroidBlockGuardPolicy.lambda$onThreadPolicyViolation$1(listener, violation);
                        }
                    });
    ...
    private static class AndroidCloseGuardReporter implements CloseGuard.Reporter {
        ...
        public void report(String message, Throwable allocationSite) throws Throwable {
            StrictMode.onVmPolicyViolation(new LeakedClosableViolation(message, allocationSite));
        }

        public void report(String message) throws Throwable {
    ...
    public static void conditionallyCheckInstanceCounts() throws Throwable {
    ...
    public static void onSqliteObjectLeaked(String message, Throwable originStack) throws Throwable {
        onVmPolicyViolation(new SqliteObjectLeakedViolation(message, originStack));
    }

    public static void onWebViewMethodCalledOnWrongThread(Throwable originStack) throws Throwable {
        onVmPolicyViolation(new WebViewMethodCalledOnWrongThreadViolation(originStack));
    }

    public static void onIntentReceiverLeaked(Throwable originStack) throws Throwable {
        onVmPolicyViolation(new IntentReceiverLeakedViolation(originStack));
    }

    public static void onServiceConnectionLeaked(Throwable originStack) throws Throwable {
    ...
    public static void onUntaggedSocket() throws Throwable {
        onVmPolicyViolation(new UntaggedSocketViolation());
    }

    public static void onImplicitDirectBoot() throws Throwable {
        onVmPolicyViolation(new ImplicitDirectBootViolation());
    }

    public static void onIncorrectContextUsed(String message, Throwable originStack) throws Throwable {
    ...
    public static void assertUiContext(Context context, String methodName) throws Throwable {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void onCredentialProtectedPathAccess(String path, int userId) throws Throwable {
    ...
    public static void onVmPolicyViolation(Violation originStack) throws Throwable {
        onVmPolicyViolation(originStack, false);
    }

    public static void onVmPolicyViolation(final Violation violation, boolean forceDeath) throws Throwable {
        boolean penaltyLog;
        ...
        if (sVmPolicy.mListener != null && sVmPolicy.mCallbackExecutor != null) {
            ...
            try {
                sVmPolicy.mCallbackExecutor.execute(new Runnable() { // from class: android.os.StrictMode$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        StrictMode.lambda$onVmPolicyViolation$3(listener, violation);
                    }
                });
            } catch (RejectedExecutionException e) {
    ...
    public static void noteUntaggedSocket() throws Throwable {
    ...
    public static void decrementExpectedActivityCount(Class klass) {
        ...
        synchronized (StrictMode.class) {
            ...
            if (newExpected == 0) {
                ...
                map.put(klass, Integer.valueOf(newExpected));
            }
    ...
    public static final class ViolationInfo implements Parcelable {
        ...
        public void writeToParcel(Parcel dest, int flags) throws IOException {
            ...
            int iDataPosition = dest.dataPosition() - start;
        }
    ...
    private static final class InstanceTracker {
        ...
        public InstanceTracker(Object instance) {
            ...
            synchronized (map) {
                Integer value = map.get(cls);
                int newValue = value != null ? 1 + value.intValue() : 1;
                map.put(cls, Integer.valueOf(newValue));
            }
        }
        ...
        protected void finalize() throws Throwable {
            try {
                HashMap<Class<?>, Integer> map = sInstanceCounts;
                synchronized (map) {
                    Integer value = map.get(this.mKlass);
                    if (value != null) {
                        int newValue = value.intValue() - 1;
                        if (newValue > 0) {
                            map.put(this.mKlass, Integer.valueOf(newValue));
                        } else {
