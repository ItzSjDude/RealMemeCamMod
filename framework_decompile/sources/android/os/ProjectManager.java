...
public class ProjectManager {
            ...
            if (service2 != null) {
                ...
                while (pmicid >= 0 && pmicid <= 7) {
                    ...
                    if ("NULL".equals(mPoffStr)) {
                        ...
                        service = service2;
                        mPmicStatusMap.put(mPMICId + "_poff", mPMICPoffStr);
    ...
    public static Map<String, String> getPmicStatusforMTK() {
        Map<String, String> pmicStatusMap = new HashMap<>();
        try {
            IOplusProject service = getProjectService();
            if (service != null) {
                String pmicMonitorStr = service.get_pmic_info();
                String[] spiltPmicMonitor = pmicMonitorStr.split("\\r?\\n");
                for (String pmicMonitorLine : spiltPmicMonitor) {
                    if (pmicMonitorLine.indexOf("pon_reason") != -1 || pmicMonitorLine.indexOf("poff_reason") != -1 || pmicMonitorLine.indexOf("poff_reason2") != -1) {
                        String[] mtkPmicMonitorInfo = pmicMonitorLine.split("\\|");
                        String mtkPmicType = mtkPmicMonitorInfo[0];
                        String mtkPmicTypeTime = mtkPmicMonitorInfo[1];
                        String mtkPmicTypeValue = mtkPmicMonitorInfo[2];
                        pmicStatusMap.put(mtkPmicType + Session.SESSION_SEPARATION_CHAR_CHILD + mtkPmicTypeTime, mtkPmicTypeValue);
                    } else if (pmicMonitorLine.indexOf("pg_sdn_sts0") != -1 || pmicMonitorLine.indexOf("pg_sdn_sts1") != -1) {
                        String[] mtkPmicMonitorInfo2 = pmicMonitorLine.split("\\|");
                        String mtkPmicType2 = mtkPmicMonitorInfo2[0];
                        String mtkPmicTypeTime2 = mtkPmicMonitorInfo2[1];
                        String mtkPmicTypeValue2 = mtkPmicMonitorInfo2[2];
                        pmicStatusMap.put(mtkPmicType2 + Session.SESSION_SEPARATION_CHAR_CHILD + mtkPmicTypeTime2, mtkPmicTypeValue2);
                    } else if (pmicMonitorLine.indexOf("oc_sdn_sts0") != -1 || pmicMonitorLine.indexOf("oc_sdn_sts1") != -1) {
                        String[] mtkPmicMonitorInfo3 = pmicMonitorLine.split("\\|");
                        String mtkPmicType3 = mtkPmicMonitorInfo3[0];
                        String mtkPmicTypeTime3 = mtkPmicMonitorInfo3[1];
                        String mtkPmicTypeValue3 = mtkPmicMonitorInfo3[2];
                        pmicStatusMap.put(mtkPmicType3 + Session.SESSION_SEPARATION_CHAR_CHILD + mtkPmicTypeTime3, mtkPmicTypeValue3);
                    }
                }
            }
        } catch (RemoteException e) {
