...
public final class BatteryUsageStats implements Parcelable, Closeable {
    ...
    private BatteryUsageStats(Parcel source) {
        ...
        String[] stringArray = source.readStringArray();
        this.mCustomPowerComponentNames = stringArray;
        boolean z = source.readBoolean();
        this.mIncludesPowerModels = z;
        boolean z2 = source.readBoolean();
        this.mIncludesProcessStateData = z2;
        this.mBatteryConsumersCursorWindow = CursorWindow.newFromParcel(source);
        BatteryConsumer.BatteryConsumerDataLayout dataLayout = BatteryConsumer.createBatteryConsumerDataLayout(stringArray, z, z2);
    ...
    public void dump(PrintWriter pw, String prefix) {
        ...
        PowerCalculator.printPowerMah(pw, ((Double) dischargedPowerRange2.getLower()).doubleValue());
        if (!((Double) dischargedPowerRange2.getLower()).equals(dischargedPowerRange2.getUpper())) {
            pw.print(NativeLibraryHelper.CLEAR_ABI_OVERRIDE);
            PowerCalculator.printPowerMah(pw, ((Double) dischargedPowerRange2.getUpper()).doubleValue());
        }
        pw.println();
        pw.println("    Global");
        int i3 = 0;
    ...
    */
    public static android.os.BatteryUsageStats createFromXml(android.util.TypedXmlPullParser r14) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            Method dump skipped, instructions count: 308
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: android.os.BatteryUsageStats.createFromXml(android.util.TypedXmlPullParser):android.os.BatteryUsageStats");
    }
    ...
    public static final class Builder {
        ...
        public Builder(String[] customPowerComponentNames, boolean includePowerModels, boolean includeProcessStateData) {
            ...
            BatteryConsumer.BatteryConsumerDataLayout batteryConsumerDataLayoutCreateBatteryConsumerDataLayout = BatteryConsumer.createBatteryConsumerDataLayout(customPowerComponentNames, includePowerModels, includeProcessStateData);
