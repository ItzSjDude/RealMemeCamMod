...
public class VolumeInfo implements Parcelable {
    ...
    public StorageVolume buildStorageVolume(Context context, int userId, boolean reportUnmounted) {
        ...
        return new StorageVolume(this.id, userPath, internalPath, description, isPrimary(), removable, emulated, externallyManaged, false, maxFileSize, new UserHandle(userId), uuid, derivedFsUuid, envState);
    }
