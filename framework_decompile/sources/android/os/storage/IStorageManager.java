...
public interface IStorageManager extends IInterface {
    ...
    void addUserKeyAuth(int i, int i2, byte[] bArr) throws RemoteException;
    ...
    void clearUserKeyAuth(int i, int i2, byte[] bArr) throws RemoteException;
    ...
    long mountTime() throws RemoteException;
    ...
    void startserviceAppFuse() throws RemoteException;

    void stopserviceAppFuse() throws RemoteException;
    ...
    public static class Default implements IStorageManager {
        ...
        @Override // android.os.storage.IStorageManager
        public void startserviceAppFuse() throws RemoteException {
        }

        @Override // android.os.storage.IStorageManager
        public void stopserviceAppFuse() throws RemoteException {
        }
        ...
        @Override // android.os.storage.IStorageManager
        public long mountTime() throws RemoteException {
            return 0L;
        }
    ...
    public static abstract class Stub extends Binder implements IStorageManager {
        ...
        static final int TRANSACTION_clearCache = 101;
        ...
        static final int TRANSACTION_mountTime = 103;
        ...
        static final int TRANSACTION_startserviceAppFuse = 99;
        static final int TRANSACTION_stopserviceAppFuse = 100;
                ...
                default:
                    switch (code) {
                        ...
                        case 71:
                            ...
                            data.enforceNoDataAvail();
                            addUserKeyAuth(_arg031, _arg115, _arg29);
                            reply.writeNoException();
                            return true;
                        case 72:
                            int _arg032 = data.readInt();
                            data.enforceNoDataAvail();
                            fixateNewestUserKeyAuth(_arg032);
                            reply.writeNoException();
                            return true;
                        case 73:
                        ...
                        case 75:
                            ...
                            data.enforceNoDataAvail();
                            ParcelFileDescriptor _result11 = openProxyFileDescriptor(_arg034, _arg117, _arg210);
                            reply.writeNoException();
                        ...
                        case 76:
                            ...
                            data.enforceNoDataAvail();
                            long _result12 = getCacheQuotaBytes(_arg035, _arg118);
                            reply.writeNoException();
                        ...
                        case 77:
                            ...
                            data.enforceNoDataAvail();
                            long _result13 = getCacheSizeBytes(_arg036, _arg119);
                            reply.writeNoException();
                        ...
                        case 78:
                            ...
                            data.enforceNoDataAvail();
                            long _result14 = getAllocatableBytes(_arg037, _arg120, _arg211);
                            reply.writeNoException();
                        ...
                        case 79:
                            ...
                            data.enforceNoDataAvail();
                            allocateBytes(_arg038, _arg121, _arg212, _arg34);
                            reply.writeNoException();
                            return true;
                        case 80:
                            runIdleMaintenance();
                        ...
                        case 89:
                            ...
                            data.enforceNoDataAvail();
                            clearUserKeyAuth(_arg041, _arg123, _arg213);
                            reply.writeNoException();
                            return true;
                        case 90:
                        ...
                        case 91:
                            ...
                            data.enforceNoDataAvail();
                            disableAppDataIsolation(_arg043, _arg124, _arg214);
                            reply.writeNoException();
                            return true;
                        case 92:
                            ...
                            data.enforceNoDataAvail();
                            PendingIntent _result17 = getManageSpaceActivityIntent(_arg044, _arg125);
                            reply.writeNoException();
                        ...
                        case 93:
                            ...
                            data.enforceNoDataAvail();
                            notifyAppIoBlocked(_arg045, _arg126, _arg215, _arg35);
                            reply.writeNoException();
                            return true;
                        case 94:
                            ...
                            data.enforceNoDataAvail();
                            notifyAppIoResumed(_arg046, _arg127, _arg216, _arg36);
                            reply.writeNoException();
                            return true;
                        case 95:
                            ...
                            data.enforceNoDataAvail();
                            int _result18 = getExternalStorageMountMode(_arg047, _arg128);
                            reply.writeNoException();
                        ...
                        case 96:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result19 = isAppIoBlocked(_arg048, _arg129, _arg217, _arg37);
                            reply.writeNoException();
