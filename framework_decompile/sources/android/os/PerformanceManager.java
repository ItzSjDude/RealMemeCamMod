...
public class PerformanceManager {
    ...
    private static IHwBinder.DeathRecipient sPerfServiceDeathRecipient = new IHwBinder.DeathRecipient() { // from class: android.os.PerformanceManager.1
        ...
        public void serviceDied(long cookie) {
            ...
            PerformanceManager.mPerformanceService = null;
        }
    };
    ...
    public static String readClmEnable() {
        try {
            ...
            String result = service.readClmEnable();
            return result;
        } catch (RemoteException e) {
    ...
    public static void writeClmEnable(String buffer) {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                service.writeClmEnable(buffer);
            }
        } catch (RemoteException e) {
    ...
    public static String readFgFreqsThreshold() {
        try {
            ...
            String result = service.readFgFreqsThreshold();
            return result;
        } catch (RemoteException e) {
    ...
    public static void writeFgFreqsThreshold(String buffer) {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                service.writeFgFreqsThreshold(buffer);
            }
        } catch (RemoteException e) {
    ...
    public static String readClmHighLoadAll() {
        try {
            ...
            String result = service.readClmHighLoadAll();
            return result;
        } catch (RemoteException e) {
    ...
    public static void writeClmHighLoadAll(String buffer) {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                service.writeClmHighLoadAll(buffer);
            }
        } catch (RemoteException e) {
    ...
    public static String readClmHighLoadGrp() {
        try {
            ...
            String result = service.readClmHighLoadGrp();
            return result;
        } catch (RemoteException e) {
    ...
    public static void writeClmHighLoadGrp(String buffer) {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                service.writeClmHighLoadGrp(buffer);
            }
        } catch (RemoteException e) {
    ...
    public static String readClmLowLoadGrp() {
        try {
            ...
            String result = service.readClmLowLoadGrp();
            return result;
        } catch (RemoteException e) {
    ...
    public static void writeClmLowLoadGrp(String buffer) {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                service.writeClmLowLoadGrp(buffer);
            }
        } catch (RemoteException e) {
    ...
    public static String readCallStack() {
        try {
            ...
            String result = service.readCallStack();
            return result;
        } catch (RemoteException e) {
    ...
    public static void setDamonReclaimWmarks(int metric, int high, int mid, int low) {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                service.setDamonReclaimWmarks(metric, high, mid, low);
    ...
    public static void setDamonReclaimColdTime(int time) {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                service.setDamonReclaimColdTime(time);
                Log.e(TAG, "setDamonReclaimColdTime succeed.");
            }
        } catch (RemoteException e) {
    ...
    public static void setDamonReclaimQuota(int ms, int sz, int reset) {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                service.setDamonReclaimQuota(ms, sz, reset);
                Log.e(TAG, "setDamonReclaimQuota succeed.");
            }
        } catch (RemoteException e) {
    ...
    public static void setDamonReclaimMonitoring(int sample, int aggr) {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                service.setDamonReclaimMonitoring(sample, aggr);
                Log.e(TAG, "setDamonReclaimMonitoring succeed.");
            }
        } catch (RemoteException e) {
    ...
    public static int getUfsplusTwStatus() {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                return service.getUfsplusTwStatus();
            }
            return 0;
        } catch (RemoteException e) {
    ...
    public static int getUfsplusHpbStatus() {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                return service.getUfsplusHpbStatus();
            }
            return 0;
        } catch (RemoteException e) {
    ...
    public static String getDevinfoUfsInfo() {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                return service.getDevinfoUfsInfo();
            }
            return null;
        } catch (RemoteException e) {
    ...
    public static String getDevinfoUfsVersionInfo() {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                return service.getDevinfoUfsVersionInfo();
            }
            return null;
        } catch (RemoteException e) {
    ...
    public static String getDdrResidency() {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                return service.getDdrResidency();
            }
            return null;
        } catch (RemoteException e) {
    ...
    public static String readOplusReserve3(int offset, int len) {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                return service.readOplusReserve3(offset, len);
            }
            return null;
        } catch (RemoteException e) {
            Log.e(TAG, "get Ddr Residency failed.", e);
    ...
    public static int writeOplusReserve3(int offset, int len, String info) {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                return service.writeOplusReserve3(offset, len, info);
            }
            return 0;
        } catch (RemoteException e) {
    ...
    public static String getUfsSignalRecordUpload() {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                return service.getUfsSignalRecordUpload();
            }
            return null;
        } catch (RemoteException e) {
    ...
    public static String readStorageFeature(String name, String addr, String isMulti) {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                return service.readStorageFeature(name, addr, isMulti);
            }
            return null;
        } catch (RemoteException e) {
    ...
    public static int writeStorageFeature(String name, String addr, String isMulti, String cmd) {
        try {
            IPerformance service = getPerformanceService();
            if (service != null) {
                return service.writeStorageFeature(name, addr, isMulti, cmd);
            }
            return 0;
        } catch (RemoteException e) {
