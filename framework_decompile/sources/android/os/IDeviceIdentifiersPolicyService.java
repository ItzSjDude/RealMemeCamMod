...
public interface IDeviceIdentifiersPolicyService extends IInterface {
    String getPhoneSerialForPackage(String str, String str2) throws RemoteException;
    ...
    public static class Default implements IDeviceIdentifiersPolicyService {
        ...
        @Override // android.os.IDeviceIdentifiersPolicyService
        public String getPhoneSerialForPackage(String callingPackage, String callingFeatureId) throws RemoteException {
            return null;
        }
    ...
    public static abstract class Stub extends Binder implements IDeviceIdentifiersPolicyService {
        ...
        static final int TRANSACTION_getPhoneSerialForPackage = 3;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 3:
                    return "getPhoneSerialForPackage";
                default:
                    return null;
            }
        }
                ...
                default:
                    switch (code) {
                        ...
                        case 3:
                            ...
                            data.enforceNoDataAvail();
                            String _result3 = getPhoneSerialForPackage(_arg02, _arg12);
                            reply.writeNoException();
