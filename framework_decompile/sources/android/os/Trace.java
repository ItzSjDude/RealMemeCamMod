...
public final class Trace {
    ...
    @FastNative
    private static native void nativeAsyncTraceForTrackEnd(long j, String str, String str2, int i);
    ...
    public static boolean isTagEnabled(long traceTag) {
        return isTagEnabledInternal(traceTag) || ONETRACE_EXT.isEnable(traceTag);
    }
    ...
    public static void traceBegin(long traceTag, String methodName) {
        ...
        ONETRACE_EXT.begin(traceTag, methodName);
    }
    ...
    public static void asyncTraceBegin(long traceTag, String methodName, int cookie) {
        ...
        ONETRACE_EXT.beginAsync(traceTag, methodName, cookie);
    }
    ...
    public static void asyncTraceEnd(long traceTag, String methodName, int cookie) {
        ...
        ONETRACE_EXT.endAsync(traceTag, methodName, cookie);
    }
    ...
    public static void beginSection(String sectionName) {
        ...
        ONETRACE_EXT.begin(4096L, sectionName);
    }
