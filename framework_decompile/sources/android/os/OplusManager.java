...
public final class OplusManager {
    ...
    public static final boolean init() {
        ...
        do {
            ...
            IOplusService iOplusServiceAsInterface = IOplusService.Stub.asInterface(ServiceManager.getService(SERVICE_NAME));
            sService = iOplusServiceAsInterface;
            if (iOplusServiceAsInterface != null) {
                return true;
            }
            times--;
        } while (times > 0);
    ...
    private static boolean initStampService() {
        ...
        do {
            ...
            IOplusStampService iOplusStampServiceAsInterface = IOplusStampService.Stub.asInterface(ServiceManager.getService("stamp_service"));
            sStampService = iOplusStampServiceAsInterface;
            if (iOplusStampServiceAsInterface != null) {
                return true;
            }
            times--;
        } while (times > 0);
    ...
    public static void recordEventForLog(int event, String log) throws NumberFormatException {
        switch (event) {
            case 1004:
    ...
    public static int writeLogToPartition(int type, String logstring, String tagString, String issue, String desc) throws NumberFormatException {
        int res;
        if (logstring == null) {
            res = 0;
    ...
    private static int updateLogReference(int type, String desc, boolean isBackup) throws NumberFormatException {
        String ref;
        String ref2;
        int res;
        String str = "catch e = ";
    ...
    public static boolean isEmmcLimit(int type) throws NumberFormatException {
        try {
