...
public interface IPowerManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPowerManager {
        ...
        static final int TRANSACTION_getDefaultScreenBrightnessSetting = 58;
        ...
        static final int TRANSACTION_getMaximumScreenBrightnessSetting = 57;
        static final int TRANSACTION_getMinimumScreenBrightnessSetting = 56;
        ...
        static final int TRANSACTION_setFlashing = 59;
                ...
                default:
                    switch (code) {
                        ...
                        case 55:
                            ...
                            return true;
                        case 56:
                            int _result28 = getMinimumScreenBrightnessSetting();
                            reply.writeNoException();
                            reply.writeInt(_result28);
                            return true;
                        case 57:
                            int _result29 = getMaximumScreenBrightnessSetting();
                            reply.writeNoException();
                            reply.writeInt(_result29);
                            return true;
                        case 58:
                            int _result30 = getDefaultScreenBrightnessSetting();
                            reply.writeNoException();
                        ...
                        case 59:
                            ...
                            data.enforceNoDataAvail();
                            setFlashing(_arg040, _arg124, _arg210, _arg36, _arg44);
                            reply.writeNoException();
                            return true;
                        default:
