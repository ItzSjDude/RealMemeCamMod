...
public final class PersistableBundle extends BaseBundle implements Cloneable, Parcelable, XmlUtils.WriteMapCallback {
    ...
    public void saveToXml(TypedXmlSerializer out) throws XmlPullParserException, IOException {
        unparcel();
    ...
    public static PersistableBundle restoreFromXml(TypedXmlPullParser in) throws XmlPullParserException, IOException {
        int event;
