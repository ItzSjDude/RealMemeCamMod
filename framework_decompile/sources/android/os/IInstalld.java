...
public interface IInstalld extends IInterface {
    ...
    public static class Default implements IInstalld {
        ...
        @Override // android.os.IInstalld
        public void oplusCustomizeInterface(String funName, PersistableBundle args, ICustomizePmsCallback callback) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IInstalld {
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 51:
                    return "oplusCustomizeInterface";
                case 52:
                ...
                default:
                    switch (code) {
                        ...
                        case 50:
                            ...
                            PersistableBundle _arg141 = (PersistableBundle) data.readTypedObject(PersistableBundle.CREATOR);
                            data.enforceNoDataAvail();
                            PersistableBundle _result20 = oplusCommonInterface(_arg047, _arg141);
                            reply.writeNoException();
                            reply.writeTypedObject(_result20, 1);
                            return true;
                        case 51:
                            String _arg048 = data.readString();
                            PersistableBundle _arg143 = (PersistableBundle) data.readTypedObject(PersistableBundle.CREATOR);
                            ICustomizePmsCallback _arg232 = ICustomizePmsCallback.Stub.asInterface(data.readStrongBinder());
                            data.enforceNoDataAvail();
                            oplusCustomizeInterface(_arg048, _arg143, _arg232);
                            reply.writeNoException();
                            return true;
                        case 52:
                            ...
                            data.enforceNoDataAvail();
                            cleanupInvalidPackageDirs(_arg049, _arg144, _arg233);
                            reply.writeNoException();
                            return true;
                        case 53:
                            ...
                            data.enforceNoDataAvail();
                            int _result21 = getOdexVisibility(_arg050, _arg145, _arg234, _arg326);
                            reply.writeNoException();
        ...
        private static class Proxy implements IInstalld {
            ...
            @Override // android.os.IInstalld
            public boolean dexopt(String apkPath, int uid, String packageName, String instructionSet, int dexoptNeeded, String outputPath, int dexFlags, String compilerFilter, String uuid, String sharedLibraries, String seInfo, boolean downgrade, int targetSdkVersion, String profileName, String dexMetadataPath, String compilationReason) throws Throwable {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
