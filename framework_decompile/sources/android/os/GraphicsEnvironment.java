...
public class GraphicsEnvironment {
    ...
    public void setup(Context context, Bundle coreSettings) {
        ...
        if (setupAngle(context, coreSettings, pm, packageName2) && shouldUseAngle(context, coreSettings, packageName2)) {
            j = 2;
            ...
            Trace.traceEnd(j);
            j2 = j;
            Trace.traceBegin(j2, "chooseDriver");
            ...
            Trace.traceEnd(j3);
            Trace.traceBegin(j3, "notifyGraphicsEnvironmentSetup");
        ...
        Trace.traceBegin(j2, "chooseDriver");
        appInfoWithMetaData2 = appInfoWithMetaData;
        if (chooseDriver(context, coreSettings, pm, packageName, appInfoWithMetaData2) || useAngle) {
            appInfoWithMetaData3 = appInfoWithMetaData2;
            j3 = j2;
        } else {
            appInfoWithMetaData3 = appInfoWithMetaData2;
    ...
    private boolean setupAngle(Context context, Bundle bundle, PackageManager pm, String packageName) throws PackageManager.NameNotFoundException {
        String devOptIn;
    ...
    private boolean chooseDriver(Context context, Bundle coreSettings, PackageManager pm, String packageName, ApplicationInfo ai) throws IOException {
        String abi;
    ...
    private String getSphalLibraries(Context context, String driverPackageName) throws IOException {
        try {
