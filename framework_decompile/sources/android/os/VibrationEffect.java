...
public abstract class VibrationEffect implements Parcelable {
    ...
    public static final Parcelable.Creator<VibrationEffect> CREATOR = new Parcelable.Creator<VibrationEffect>() { // from class: android.os.VibrationEffect.1
        ...
        public VibrationEffect createFromParcel(Parcel in) {
            IVibrationEffectExt vibrationEffectExt = (IVibrationEffectExt) ExtLoader.type(IVibrationEffectExt.class).create();
            VibrationEffect customizeVibrationEffect = vibrationEffectExt.createExtendedEffect(in);
