...
public class UpdateEngine {
    private static final String OPLUS_OTADEXOPT_SERVICE = "oplusotadexopt";
    ...
    private IOplusOtaDexopt mOplusOtaDexopt;
    ...
    public void switchSlot() {
        try {
            IOplusOtaDexopt iOplusOtaDexoptAsInterface = IOplusOtaDexopt.Stub.asInterface(ServiceManager.getService(OPLUS_OTADEXOPT_SERVICE));
            this.mOplusOtaDexopt = iOplusOtaDexoptAsInterface;
            if (iOplusOtaDexoptAsInterface != null) {
                iOplusOtaDexoptAsInterface.interruptOtaDexopt();
            }
    ...
    public boolean applyPostInstall() {
        try {
            return this.mUpdateEngine.applyPostInstall();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
