...
public class TransactionTracker {
    private final boolean mTraceThread = IOplusUIFirstManager.APP_START_ANIMATION.equals(SystemProperties.get("persist.sys.traceipc.thread", "0"));
    ...
    public void addTrace(Throwable tr) {
        ...
        if (this.mTraceThread) {
            trace = "Caller: " + Thread.currentThread().getName() + "\n" + trace;
        }
        synchronized (this) {
