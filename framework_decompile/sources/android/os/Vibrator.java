...
public abstract class Vibrator {
    ...
    public void vibrate(VibrationEffect vibe) {
        if (this.mVibratorExt.vibrate(vibe)) {
            return;
        }
    ...
    public void vibrate(VibrationEffect vibe, AudioAttributes attributes) {
        ...
        if (this.mVibratorExt.vibrate(vibe, attributes)) {
            return;
        }
        if (attributes == null) {
            vibrationAttributesBuild = new VibrationAttributes.Builder().build();
        } else {
            vibrationAttributesBuild = new VibrationAttributes.Builder(attributes).build();
        }
        vibrate(vibe, vibrationAttributesBuild);
    }
