...
public class AppZygote {
    ...
    private void connectToZygoteIfNeededLocked() throws Throwable {
        ...
        try {
            ...
            ChildZygoteProcess childZygoteProcessStartChildZygote = zygoteProcess.startChildZygote("com.android.internal.os.AppZygoteInit", str, i, i, null, runtimeFlags, "app_zygote", abi, abi, VMRuntime.getInstructionSet(abi), this.mZygoteUidGidMin, this.mZygoteUidGidMax);
