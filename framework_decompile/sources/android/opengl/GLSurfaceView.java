...
public class GLSurfaceView extends SurfaceView implements SurfaceHolder.Callback2 {
    ...
    static class GLThread extends Thread {
        ...
        /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
            jadx.core.utils.exceptions.JadxRuntimeException: Can't find top splitter block for handler:B:291:0x05c8
        ...
        */
        ...
        public void requestRenderAndNotify(Runnable finishDrawing) {
            synchronized (GLSurfaceView.sGLThreadManager) {
                ...
                Runnable tmpRunnable = this.mFinishDrawingRunnable;
                if (tmpRunnable != null && tmpRunnable != finishDrawing) {
                    try {
                        Log.i(GLSurfaceView.TAG, "requestRenderAndNotify ==> run previous finish runnable mFinishDrawingRunnable =:" + this.mFinishDrawingRunnable + ",tmpRunnable =:" + tmpRunnable);
                        if (tmpRunnable != null) {
                            tmpRunnable.run();
                        }
                    } catch (Exception e) {
