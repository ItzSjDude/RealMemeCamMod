...
public final class EuiccProfileInfo implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder(EuiccProfileInfo baseProfile) {
            ...
            if (baseProfile.mAccessRules == null) {
                ...
                listAsList = Arrays.asList(baseProfile.mAccessRules);
            }
    ...
    public String toString() {
        return "EuiccProfileInfo (nickname=" + this.mNickname + ", serviceProviderName=" + this.mServiceProviderName + ", profileName=" + this.mProfileName + ", profileClass=" + this.mProfileClass + ", state=" + this.mState + ", CarrierIdentifier=" + this.mCarrierIdentifier + ", policyRules=" + this.mPolicyRules + ", accessRules=" + Arrays.toString(this.mAccessRules) + NavigationBarInflaterView.KEY_CODE_END;
    }
}
