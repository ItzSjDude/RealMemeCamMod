...
public interface IDreamOverlay extends IInterface {
    ...
    void startDream(WindowManager.LayoutParams layoutParams, IDreamOverlayCallback iDreamOverlayCallback) throws RemoteException;

    public static class Default implements IDreamOverlay {
        @Override // android.service.dreams.IDreamOverlay
        public void startDream(WindowManager.LayoutParams params, IDreamOverlayCallback callback) throws RemoteException {
        }
