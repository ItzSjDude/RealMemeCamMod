...
public abstract class SmartspaceService extends Service {
        ...
        if (wrapper == null) {
            callbacks.add(new CallbackWrapper(callback, new Consumer() { // from class: android.service.smartspace.SmartspaceService$$ExternalSyntheticLambda1
                ...
                public final void accept(Object obj) {
                    this.f$0.m3823xe7e5ae13(callbacks, (SmartspaceService.CallbackWrapper) obj);
                }
            }));
        }
    }

    /* renamed from: lambda$doRegisterSmartspaceUpdates$1$android-service-smartspace-SmartspaceService, reason: not valid java name */
    /* synthetic */ void m3823xe7e5ae13(final ArrayList callbacks, final CallbackWrapper callbackWrapper) {
        this.mHandler.post(new Runnable() { // from class: android.service.smartspace.SmartspaceService$$ExternalSyntheticLambda2
            ...
            public final void run() {
                this.f$0.m3822x2e6e2074(callbacks, callbackWrapper);
            }
        });
    }
    ...
    public void doUnregisterSmartspaceUpdates(SmartspaceSessionId sessionId, ISmartspaceCallback callback) {
        ...
        if (callbacks == null) {
            ...
            CallbackWrapper wrapper = findCallbackWrapper(callbacks, callback);
            m3822x2e6e2074(callbacks, wrapper);
        }
    }
    ...
    public void m3822x2e6e2074(ArrayList<CallbackWrapper> callbacks, CallbackWrapper wrapper) {
