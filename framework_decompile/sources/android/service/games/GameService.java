...
public class GameService extends Service {
    ...
    private final IBinder.DeathRecipient mGameManagerServiceDeathRecipient = new IBinder.DeathRecipient() { // from class: android.service.games.GameService$$ExternalSyntheticLambda0
        ...
        public final void binderDied() {
            this.f$0.m3714lambda$new$0$androidservicegamesGameService();
        }
    };
    ...
    /* synthetic */ void m3714lambda$new$0$androidservicegamesGameService() {
    ...
    public void doOnConnected(IGameServiceController gameServiceController) {
        IGameManagerService iGameManagerServiceAsInterface = IGameManagerService.Stub.asInterface(ServiceManager.getService(Context.GAME_SERVICE));
