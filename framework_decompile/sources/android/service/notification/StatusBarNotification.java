...
public class StatusBarNotification implements Parcelable {
    ...
    public static int getUidFromKey(String key) throws NumberFormatException {
    ...
    public StatusBarNotification m3740clone() {
        return cloneShallow(this.notification.m363clone());
    }
