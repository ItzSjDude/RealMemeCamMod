...
public class VoiceInteractionSession implements KeyEvent.Callback, ComponentCallbacks2 {
        ...
        public void executeMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 108:
                    ...
                    break;
                case 109:
                    VoiceInteractionSession.this.doUpdateVisibleActivityInfo((VisibleActivityInfo) msg.obj, msg.arg1);
                    break;
                case 110:
                    args = (SomeArgs) msg.obj;
    ...
    public void doUpdateVisibleActivityInfo(VisibleActivityInfo visibleActivityInfo, int type) {
        ...
        for (int i = 0; i < this.mVisibleActivityInfos.size(); i++) {
            ...
            executor.execute(new Runnable() { // from class: android.service.voice.VoiceInteractionSession$$ExternalSyntheticLambda6
                ...
                public final void run() {
                    callback.onVisible(visibleActivityInfo);
                }
            });
        }
    }
    ...
    private void informVisibleActivityChanged(final VisibleActivityInfo visibleActivityInfo, int type) {
                ...
                case 1:
                    Binder.withCleanCallingIdentity(new FunctionalUtils.ThrowingRunnable() { // from class: android.service.voice.VoiceInteractionSession$$ExternalSyntheticLambda4
                        ...
                        public final void runOrThrow() {
                            executor.execute(new Runnable() { // from class: android.service.voice.VoiceInteractionSession$$ExternalSyntheticLambda10
                                @Override // java.lang.Runnable
                                public final void run() {
                    ...
                    break;
                case 2:
                    Binder.withCleanCallingIdentity(new FunctionalUtils.ThrowingRunnable() { // from class: android.service.voice.VoiceInteractionSession$$ExternalSyntheticLambda5
                        @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
                        public final void runOrThrow() {
    ...
    public final void performDirectAction(DirectAction action, Bundle extras, final CancellationSignal cancellationSignal, final Executor resultExecutor, final Consumer<Bundle> resultListener) {
        ...
        if (cancellationSignal != null) {
            cancellationCallback = new RemoteCallback(createSafeResultListener(new Consumer() { // from class: android.service.voice.VoiceInteractionSession$$ExternalSyntheticLambda8
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
        ...
        RemoteCallback resultCallback = new RemoteCallback(createSafeResultListener(new Consumer() { // from class: android.service.voice.VoiceInteractionSession$$ExternalSyntheticLambda9
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public Consumer<Bundle> removeSafeResultListener(SafeResultListener listener) {
        ...
        synchronized (this) {
            consumerRemove = this.mRemoteCallbacks.remove(listener);
        }
