...
public interface IVoiceInteractionSession extends IInterface {
    ...
    void updateVisibleActivityInfo(VisibleActivityInfo visibleActivityInfo, int i) throws RemoteException;
    ...
    public static class Default implements IVoiceInteractionSession {
        ...
        @Override // android.service.voice.IVoiceInteractionSession
        public void updateVisibleActivityInfo(VisibleActivityInfo visibleActivityInfo, int type) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IVoiceInteractionSession {
        ...
        static final int TRANSACTION_updateVisibleActivityInfo = 10;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 9:
                    return "destroy";
                case 10:
                    return "updateVisibleActivityInfo";
                default:
                    return null;
            }
        }
                ...
                default:
                    switch (code) {
                        ...
                        case 10:
                            ...
                            data.enforceNoDataAvail();
                            updateVisibleActivityInfo(_arg06, _arg15);
                            return true;
                        default:
