...
abstract class AbstractHotwordDetector implements HotwordDetector {
    ...
    AbstractHotwordDetector(IVoiceInteractionManagerService managerService, HotwordDetector.Callback callback, int detectorType) {
    ...
    protected void updateStateLocked(PersistableBundle options, SharedMemory sharedMemory, IHotwordRecognitionStatusCallback callback, int detectorType) {
