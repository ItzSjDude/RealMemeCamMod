...
public final class CustomDescription implements Parcelable {
    ...
    public String toString() {
        ...
        StringBuilder sbAppend = new StringBuilder("CustomDescription: [presentation=").append(this.mPresentation).append(", transformations=");
        ArrayList<Pair<Integer, InternalTransformation>> arrayList = this.mTransformations;
        StringBuilder sbAppend2 = sbAppend.append(arrayList == null ? "N/A" : Integer.valueOf(arrayList.size())).append(", updates=");
        ArrayList<Pair<InternalValidator, BatchUpdates>> arrayList2 = this.mUpdates;
        StringBuilder sbAppend3 = sbAppend2.append(arrayList2 == null ? "N/A" : Integer.valueOf(arrayList2.size())).append(", actions=");
        SparseArray<InternalOnClickAction> sparseArray = this.mActions;
        return sbAppend3.append(sparseArray != null ? Integer.valueOf(sparseArray.size()) : "N/A").append(NavigationBarInflaterView.SIZE_MOD_END).toString();
    }
