...
public final class BatchUpdates implements Parcelable {
    ...
    public String toString() {
        ...
        StringBuilder sbAppend = new StringBuilder("BatchUpdates: [").append(", transformations=");
        ArrayList<Pair<Integer, InternalTransformation>> arrayList = this.mTransformations;
        return sbAppend.append(arrayList == null ? "N/A" : Integer.valueOf(arrayList.size())).append(", updates=").append(this.mUpdates).append(NavigationBarInflaterView.SIZE_MOD_END).toString();
    }
