...
public final class AutofillServiceInfo {
    ...
    private ArrayMap<String, Long> parseCompatibilityPackages(XmlPullParser parser, Resources resources) throws Throwable {
        Long maxVersionCode;
    ...
    public String toString() {
        ...
        StringBuilder sbAppend = builder.append(", hasCompatPckgs:");
        ArrayMap<String, Long> arrayMap = this.mCompatibilityPackages;
        sbAppend.append((arrayMap == null || arrayMap.isEmpty()) ? false : true).append(NavigationBarInflaterView.SIZE_MOD_END);
