            ...
            switch (event) {
                case 1:
                    ...
                    if (this.mFirstOnSuccessTime == 0) {
                        ...
                        duration = jElapsedRealtime - this.mFirstRequestTime;
                        if (AugmentedAutofillService.sDebug) {
                ...
                case 2:
                    ...
                    if (this.mUiFirstShownTime == 0) {
                        ...
                        this.mUiFirstShownTime = jElapsedRealtime2;
                        duration = jElapsedRealtime2 - this.mFirstRequestTime;
                        if (AugmentedAutofillService.sDebug) {
                ...
                case 3:
                    ...
                    if (this.mUiFirstDestroyedTime == 0) {
                        ...
                        this.mUiFirstDestroyedTime = jElapsedRealtime3;
                        duration = jElapsedRealtime3 - this.mFirstRequestTime;
                        if (AugmentedAutofillService.sDebug) {
                ...
                case 4:
                    if (this.mFirstOnSuccessTime == 0) {
                        ...
                        duration = jElapsedRealtime4 - this.mFirstRequestTime;
                        if (AugmentedAutofillService.sDebug) {
