...
public final class FillWindow implements AutoCloseable {
        ...
        synchronized (this.mLock) {
            ...
            rootView.setOnTouchListener(new View.OnTouchListener() { // from class: android.service.autofill.augmented.FillWindow$$ExternalSyntheticLambda0
                ...
                public final boolean onTouch(View view, MotionEvent motionEvent) {
                    return this.f$0.m3630lambda$update$0$androidserviceautofillaugmentedFillWindow(view, motionEvent);
                }
            });
            this.mShowing = false;
    ...
    /* renamed from: lambda$update$0$android-service-autofill-augmented-FillWindow, reason: not valid java name */
    /* synthetic */ boolean m3630lambda$update$0$androidserviceautofillaugmentedFillWindow(View view, MotionEvent motionEvent) {
