    ...
    public static final Parcelable.Creator<FillEventHistory> CREATOR = new Parcelable.Creator<FillEventHistory>() { // from class: android.service.autofill.FillEventHistory.1
        ...
        public FillEventHistory createFromParcel(Parcel parcel) {
            ...
            while (i < numEvents) {
                ...
                FieldClassification[] arrayFromParcel = null;
                ArraySet<? extends Object> arraySet = parcel2.readArraySet(null);
                ...
                FieldClassification[] detectedFieldClassifications = arrayFromParcel;
                int saveDialogNotShowReason = parcel.readInt();
                int uiType = parcel.readInt();
                selection.addEvent(new Event(eventType, datasetId, clientState, selectedDatasetIds, arraySet, changedFieldIds, changedDatasetIds, manuallyFilledFieldIds, manuallyFilledDatasetIds, detectedFieldIds, detectedFieldClassifications, saveDialogNotShowReason, uiType));
                i++;
                parcel2 = parcel;
            }
            return selection;
