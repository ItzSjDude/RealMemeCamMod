...
public class TrustAgentService extends Service {
        ...
        synchronized (this.mLock) {
            ...
            future.thenAccept(new Consumer() { // from class: android.service.trust.TrustAgentService$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    this.f$0.m3866lambda$grantTrust$1$androidservicetrustTrustAgentService(resultCallback, (GrantTrustResult) obj);
                }
            });
    ...
    /* renamed from: lambda$grantTrust$1$android-service-trust-TrustAgentService, reason: not valid java name */
    /* synthetic */ void m3866lambda$grantTrust$1$androidservicetrustTrustAgentService(final Consumer resultCallback, final GrantTrustResult result) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:12:0x0017 A[Catch: all -> 0x0019, DONT_GENERATE, TryCatch #1 {, blocks: (B:4:0x0003, B:6:0x0007, B:8:0x000d, B:11:0x0012, B:12:0x0017), top: B:19:0x0003, inners: #0 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public final void setManagingTrust(boolean r4) {
        /*
            r3 = this;
            java.lang.Object r0 = r3.mLock
            monitor-enter(r0)
            boolean r1 = r3.mManagingTrust     // Catch: java.lang.Throwable -> L19
            if (r1 == r4) goto L17
            r3.mManagingTrust = r4     // Catch: java.lang.Throwable -> L19
            android.service.trust.ITrustAgentServiceCallback r1 = r3.mCallback     // Catch: java.lang.Throwable -> L19
            if (r1 == 0) goto L17
            r1.setManagingTrust(r4)     // Catch: android.os.RemoteException -> L11 java.lang.Throwable -> L19
            goto L17
        L11:
            r1 = move-exception
            java.lang.String r2 = "calling setManagingTrust()"
            r3.onError(r2)     // Catch: java.lang.Throwable -> L19
        L17:
    ...
    private final class TrustAgentServiceWrapper extends ITrustAgentService.Stub {
        ...
        /* JADX WARN: Removed duplicated region for block: B:12:0x0034 A[Catch: all -> 0x0045, TryCatch #0 {, blocks: (B:4:0x0007, B:6:0x0014, B:10:0x002c, B:12:0x0034, B:13:0x0043, B:9:0x0025), top: B:18:0x0007, inners: #1 }] */
        @Override // android.service.trust.ITrustAgentService
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct add '--show-bad-code' argument
        */
        public void setCallback(android.service.trust.ITrustAgentServiceCallback r5) {
            /*
                r4 = this;
                android.service.trust.TrustAgentService r0 = android.service.trust.TrustAgentService.this
                java.lang.Object r0 = android.service.trust.TrustAgentService.m3860$$Nest$fgetmLock(r0)
                monitor-enter(r0)
                android.service.trust.TrustAgentService r1 = android.service.trust.TrustAgentService.this     // Catch: java.lang.Throwable -> L45
                android.service.trust.TrustAgentService.m3863$$Nest$fputmCallback(r1, r5)     // Catch: java.lang.Throwable -> L45
                android.service.trust.TrustAgentService r1 = android.service.trust.TrustAgentService.this     // Catch: java.lang.Throwable -> L45
                boolean r1 = android.service.trust.TrustAgentService.m3861$$Nest$fgetmManagingTrust(r1)     // Catch: java.lang.Throwable -> L45
                if (r1 == 0) goto L2c
                android.service.trust.TrustAgentService r1 = android.service.trust.TrustAgentService.this     // Catch: android.os.RemoteException -> L24 java.lang.Throwable -> L45
                android.service.trust.ITrustAgentServiceCallback r1 = android.service.trust.TrustAgentService.m3858$$Nest$fgetmCallback(r1)     // Catch: android.os.RemoteException -> L24 java.lang.Throwable -> L45
                android.service.trust.TrustAgentService r2 = android.service.trust.TrustAgentService.this     // Catch: android.os.RemoteException -> L24 java.lang.Throwable -> L45
                boolean r2 = android.service.trust.TrustAgentService.m3861$$Nest$fgetmManagingTrust(r2)     // Catch: android.os.RemoteException -> L24 java.lang.Throwable -> L45
                r1.setManagingTrust(r2)     // Catch: android.os.RemoteException -> L24 java.lang.Throwable -> L45
                goto L2c
            L24:
                r1 = move-exception
                android.service.trust.TrustAgentService r2 = android.service.trust.TrustAgentService.this     // Catch: java.lang.Throwable -> L45
                java.lang.String r3 = "calling setManagingTrust()"
                android.service.trust.TrustAgentService.m3865$$Nest$monError(r2, r3)     // Catch: java.lang.Throwable -> L45
            L2c:
                android.service.trust.TrustAgentService r1 = android.service.trust.TrustAgentService.this     // Catch: java.lang.Throwable -> L45
                java.lang.Runnable r1 = android.service.trust.TrustAgentService.m3862$$Nest$fgetmPendingGrantTrustTask(r1)     // Catch: java.lang.Throwable -> L45
                if (r1 == 0) goto L43
                android.service.trust.TrustAgentService r1 = android.service.trust.TrustAgentService.this     // Catch: java.lang.Throwable -> L45
                java.lang.Runnable r1 = android.service.trust.TrustAgentService.m3862$$Nest$fgetmPendingGrantTrustTask(r1)     // Catch: java.lang.Throwable -> L45
                r1.run()     // Catch: java.lang.Throwable -> L45
                android.service.trust.TrustAgentService r1 = android.service.trust.TrustAgentService.this     // Catch: java.lang.Throwable -> L45
                r2 = 0
                android.service.trust.TrustAgentService.m3864$$Nest$fputmPendingGrantTrustTask(r1, r2)     // Catch: java.lang.Throwable -> L45
            L43:
