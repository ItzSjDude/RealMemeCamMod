...
public abstract class AppPredictionService extends Service {
        ...
        if (wrapper == null) {
            callbacks.add(new CallbackWrapper(callback, new Consumer() { // from class: android.service.appprediction.AppPredictionService$$ExternalSyntheticLambda2
                ...
                public final void accept(Object obj) {
                    this.f$0.m3513x4eddf3df(callbacks, (AppPredictionService.CallbackWrapper) obj);
                }
            }));
            if (callbacks.size() == 1) {
    ...
    /* renamed from: lambda$doRegisterPredictionUpdates$1$android-service-appprediction-AppPredictionService, reason: not valid java name */
    /* synthetic */ void m3513x4eddf3df(final ArrayList callbacks, final CallbackWrapper callbackWrapper) {
        this.mHandler.post(new Runnable() { // from class: android.service.appprediction.AppPredictionService$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m3512x21055980(callbacks, callbackWrapper);
            }
        });
    }
    ...
    public void doUnregisterPredictionUpdates(AppPredictionSessionId sessionId, IPredictionCallback callback) {
        ...
        if (callbacks == null) {
            ...
            CallbackWrapper wrapper = findCallbackWrapper(callbacks, callback);
            m3512x21055980(callbacks, wrapper);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: removeCallbackWrapper, reason: merged with bridge method [inline-methods] */
    public void m3512x21055980(ArrayList<CallbackWrapper> callbacks, CallbackWrapper wrapper) {
