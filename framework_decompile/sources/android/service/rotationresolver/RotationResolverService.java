...
public abstract class RotationResolverService extends Service {
    ...
    public void resolveRotation(IRotationResolverCallback callback, RotationResolutionRequest request, ICancellationSignal transport) {
        ...
        CancellationSignal cancellationSignalFromTransport = CancellationSignal.fromTransport(transport);
        this.mCancellationSignal = cancellationSignalFromTransport;
        onResolveRotation(request, cancellationSignalFromTransport, this.mPendingCallback);
    }
