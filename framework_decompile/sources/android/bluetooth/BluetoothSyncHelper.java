...
public final class BluetoothSyncHelper implements BluetoothProfile {
    ...
    boolean startScanOffload(BluetoothDevice device, boolean isGroupOp) {
        log("startScanOffload(" + device + ", isGroupOp: " + isGroupOp + NavigationBarInflaterView.KEY_CODE_END);
        IBluetoothSyncHelper service = getService();
        if (service != null) {
            try {
                if (isEnabled() && isValidDevice(device)) {
    ...
    boolean stopScanOffload(BluetoothDevice device, boolean isGroupOp) {
        log("stopScanOffload(" + device + ", isGroupOp: " + isGroupOp + NavigationBarInflaterView.KEY_CODE_END);
        IBluetoothSyncHelper service = getService();
        if (service != null) {
            try {
                if (isEnabled() && isValidDevice(device)) {
    ...
    boolean searchforLeAudioBroadcasters(BluetoothDevice device, AttributionSource aAttributionSource) {
        log("searchforLeAudioBroadcasters(" + device + NavigationBarInflaterView.KEY_CODE_END);
        IBluetoothSyncHelper service = getService();
        if (service != null) {
            try {
                if (isEnabled() && isValidDevice(device)) {
    ...
    boolean stopSearchforLeAudioBroadcasters(BluetoothDevice device, AttributionSource aAttributionSource) {
        log("stopSearchforLeAudioBroadcasters(" + device + NavigationBarInflaterView.KEY_CODE_END);
        IBluetoothSyncHelper service = getService();
        if (service != null) {
            try {
                if (isEnabled() && isValidDevice(device)) {
    ...
    boolean selectBroadcastSource(BluetoothDevice device, ScanResult scanRes, boolean isGroupOp, AttributionSource aAttributionSource) {
        log("selectBroadcastSource(" + device + ": groupop" + isGroupOp + NavigationBarInflaterView.KEY_CODE_END);
        IBluetoothSyncHelper service = getService();
        if (service != null) {
            try {
                if (isEnabled() && isValidDevice(device)) {
    ...
    boolean addBroadcastSource(BluetoothDevice sinkDevice, BleBroadcastSourceInfo srcInfo, boolean isGroupOp, AttributionSource aAttributionSource) {
    ...
    boolean updateBroadcastSource(BluetoothDevice device, BleBroadcastSourceInfo srcInfo, boolean isGroupOp, AttributionSource aAttributionSource) {
    ...
    boolean setBroadcastCode(BluetoothDevice device, BleBroadcastSourceInfo srcInfo, boolean isGroupOp, AttributionSource aAttributionSource) {
    ...
    boolean removeBroadcastSource(BluetoothDevice device, byte sourceId, boolean isGroupOp, AttributionSource aAttributionSource) {
    ...
    List<BleBroadcastSourceInfo> getAllBroadcastSourceInformation(BluetoothDevice device, AttributionSource aAttributionSource) {
