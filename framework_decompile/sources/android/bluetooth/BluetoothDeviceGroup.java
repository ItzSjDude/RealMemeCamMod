...
public final class BluetoothDeviceGroup implements BluetoothProfile {
    ...
    BluetoothDeviceGroup(Context context, BluetoothProfile.ServiceListener listener) {
        BluetoothProfileConnector<IBluetoothDeviceGroup> bluetoothProfileConnector = new BluetoothProfileConnector(this, 32, TAG, IBluetoothDeviceGroup.class.getName()) { // from class: android.bluetooth.BluetoothDeviceGroup.1
        ...
        this.mBluetoothGroupCallback = new IBluetoothGroupCallback.Stub() { // from class: android.bluetooth.BluetoothDeviceGroup.3
            ...
            public void onGroupDeviceFound(final int groupId, final BluetoothDevice device) {
                Log.d(BluetoothDeviceGroup.TAG, "onGroupDeviceFound() - appId = " + BluetoothDeviceGroup.this.mAppId);
