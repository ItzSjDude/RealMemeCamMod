...
public interface IBluetoothLeAudio extends IInterface {
    ...
    void getAllBroadcastMetadata(AttributionSource attributionSource, SynchronousResultReceiver synchronousResultReceiver) throws RemoteException;

    void getAudioLocation(BluetoothDevice bluetoothDevice, AttributionSource attributionSource, SynchronousResultReceiver synchronousResultReceiver) throws RemoteException;

    void getCodecStatus(int i, AttributionSource attributionSource, SynchronousResultReceiver synchronousResultReceiver) throws RemoteException;
    ...
    void getConnectedGroupLeadDevice(int i, AttributionSource attributionSource, SynchronousResultReceiver synchronousResultReceiver) throws RemoteException;
    ...
    void getGroupId(BluetoothDevice bluetoothDevice, AttributionSource attributionSource, SynchronousResultReceiver synchronousResultReceiver) throws RemoteException;

    void getMaximumNumberOfBroadcasts(AttributionSource attributionSource, SynchronousResultReceiver synchronousResultReceiver) throws RemoteException;

    void groupAddNode(int i, BluetoothDevice bluetoothDevice, AttributionSource attributionSource, SynchronousResultReceiver synchronousResultReceiver) throws RemoteException;

    void groupRemoveNode(int i, BluetoothDevice bluetoothDevice, AttributionSource attributionSource, SynchronousResultReceiver synchronousResultReceiver) throws RemoteException;

    void isPlaying(int i, AttributionSource attributionSource, SynchronousResultReceiver synchronousResultReceiver) throws RemoteException;

    void registerCallback(IBluetoothLeAudioCallback iBluetoothLeAudioCallback, AttributionSource attributionSource, SynchronousResultReceiver synchronousResultReceiver) throws RemoteException;

    void registerLeBroadcastCallback(IBluetoothLeBroadcastCallback iBluetoothLeBroadcastCallback, AttributionSource attributionSource, SynchronousResultReceiver synchronousResultReceiver) throws RemoteException;
    ...
    void setCcidInformation(ParcelUuid parcelUuid, int i, int i2, AttributionSource attributionSource, SynchronousResultReceiver synchronousResultReceiver) throws RemoteException;

    void setCodecConfigPreference(int i, BluetoothLeAudioCodecConfig bluetoothLeAudioCodecConfig, BluetoothLeAudioCodecConfig bluetoothLeAudioCodecConfig2, AttributionSource attributionSource) throws RemoteException;
    ...
    void startBroadcast(BluetoothLeAudioContentMetadata bluetoothLeAudioContentMetadata, byte[] bArr, AttributionSource attributionSource) throws RemoteException;

    void stopBroadcast(int i, AttributionSource attributionSource) throws RemoteException;

    void unregisterCallback(IBluetoothLeAudioCallback iBluetoothLeAudioCallback, AttributionSource attributionSource, SynchronousResultReceiver synchronousResultReceiver) throws RemoteException;

    void unregisterLeBroadcastCallback(IBluetoothLeBroadcastCallback iBluetoothLeBroadcastCallback, AttributionSource attributionSource, SynchronousResultReceiver synchronousResultReceiver) throws RemoteException;

    void updateBroadcast(int i, BluetoothLeAudioContentMetadata bluetoothLeAudioContentMetadata, AttributionSource attributionSource) throws RemoteException;
    ...
    public static class Default implements IBluetoothLeAudio {
        ...
        @Override // android.bluetooth.IBluetoothLeAudio
        public void getConnectedGroupLeadDevice(int groupId, AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothLeAudio
        public void getCodecStatus(int groupId, AttributionSource source, SynchronousResultReceiver receiver) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothLeAudio
        public void setCodecConfigPreference(int groupId, BluetoothLeAudioCodecConfig inputCodecConfig, BluetoothLeAudioCodecConfig outputCodecConfig, AttributionSource source) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothLeAudio
        public void registerCallback(IBluetoothLeAudioCallback callback, AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothLeAudio
        public void unregisterCallback(IBluetoothLeAudioCallback callback, AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothLeAudio
        public void setCcidInformation(ParcelUuid userUuid, int ccid, int contextType, AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothLeAudio
        public void getGroupId(BluetoothDevice device, AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
        }
        ...
        @Override // android.bluetooth.IBluetoothLeAudio
        public void groupAddNode(int group_id, BluetoothDevice device, AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothLeAudio
        public void groupRemoveNode(int group_id, BluetoothDevice device, AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothLeAudio
        public void getAudioLocation(BluetoothDevice device, AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothLeAudio
        public void registerLeBroadcastCallback(IBluetoothLeBroadcastCallback callback, AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothLeAudio
        public void unregisterLeBroadcastCallback(IBluetoothLeBroadcastCallback callback, AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothLeAudio
        public void startBroadcast(BluetoothLeAudioContentMetadata contentMetadata, byte[] broadcastCode, AttributionSource attributionSource) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothLeAudio
        public void stopBroadcast(int broadcastId, AttributionSource attributionSource) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothLeAudio
        public void updateBroadcast(int broadcastId, BluetoothLeAudioContentMetadata contentMetadata, AttributionSource attributionSource) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothLeAudio
        public void isPlaying(int broadcastId, AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothLeAudio
        public void getAllBroadcastMetadata(AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothLeAudio
        public void getMaximumNumberOfBroadcasts(AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IBluetoothLeAudio {
        ...
        static final int TRANSACTION_getAllBroadcastMetadata = 27;
        static final int TRANSACTION_getAudioLocation = 20;
        static final int TRANSACTION_getCodecStatus = 11;
        static final int TRANSACTION_getConnectedDevices = 3;
        static final int TRANSACTION_getConnectedGroupLeadDevice = 10;
        static final int TRANSACTION_getConnectionPolicy = 9;
        static final int TRANSACTION_getConnectionState = 5;
        static final int TRANSACTION_getDevicesMatchingConnectionStates = 4;
        static final int TRANSACTION_getGroupId = 16;
        static final int TRANSACTION_getMaximumNumberOfBroadcasts = 28;
        static final int TRANSACTION_groupAddNode = 18;
        static final int TRANSACTION_groupRemoveNode = 19;
        static final int TRANSACTION_isPlaying = 26;
        static final int TRANSACTION_registerCallback = 13;
        static final int TRANSACTION_registerLeBroadcastCallback = 21;
        static final int TRANSACTION_setActiveDevice = 6;
        static final int TRANSACTION_setCcidInformation = 15;
        static final int TRANSACTION_setCodecConfigPreference = 12;
        static final int TRANSACTION_setConnectionPolicy = 8;
        static final int TRANSACTION_setVolume = 17;
        static final int TRANSACTION_startBroadcast = 23;
        static final int TRANSACTION_stopBroadcast = 24;
        static final int TRANSACTION_unregisterCallback = 14;
        static final int TRANSACTION_unregisterLeBroadcastCallback = 22;
        static final int TRANSACTION_updateBroadcast = 25;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 10:
                    return "getConnectedGroupLeadDevice";
                case 11:
                ...
                case 20:
                    return "getAudioLocation";
                case 21:
                    return "registerLeBroadcastCallback";
                case 22:
                    return "unregisterLeBroadcastCallback";
                case 23:
                ...
                case 26:
                    return "isPlaying";
                case 27:
                    return "getAllBroadcastMetadata";
                case 28:
                    return "getMaximumNumberOfBroadcasts";
                default:
                    return null;
            }
        }
                ...
                default:
                    switch (code) {
                        ...
                        case 10:
                            ...
                            data.enforceNoDataAvail();
                            getConnectedGroupLeadDevice(_arg010, _arg110, _arg28);
                            return true;
                        case 11:
                            ...
                            data.enforceNoDataAvail();
                            getCodecStatus(_arg011, _arg111, _arg29);
                            return true;
                        case 12:
                            int _arg012 = data.readInt();
                            BluetoothLeAudioCodecConfig _arg112 = (BluetoothLeAudioCodecConfig) data.readTypedObject(BluetoothLeAudioCodecConfig.CREATOR);
                            BluetoothLeAudioCodecConfig _arg210 = (BluetoothLeAudioCodecConfig) data.readTypedObject(BluetoothLeAudioCodecConfig.CREATOR);
                            AttributionSource _arg32 = (AttributionSource) data.readTypedObject(AttributionSource.CREATOR);
                            data.enforceNoDataAvail();
                            setCodecConfigPreference(_arg012, _arg112, _arg210, _arg32);
                            return true;
                        case 13:
                            IBluetoothLeAudioCallback _arg013 = IBluetoothLeAudioCallback.Stub.asInterface(data.readStrongBinder());
                            ...
                            data.enforceNoDataAvail();
                            registerCallback(_arg013, _arg113, _arg211);
                            return true;
                        case 14:
                            IBluetoothLeAudioCallback _arg014 = IBluetoothLeAudioCallback.Stub.asInterface(data.readStrongBinder());
                            ...
                            data.enforceNoDataAvail();
                            unregisterCallback(_arg014, _arg114, _arg212);
                            return true;
                        case 15:
                            ...
                            data.enforceNoDataAvail();
                            setCcidInformation(_arg015, _arg115, _arg213, _arg33, _arg4);
                            return true;
                        case 16:
                            ...
                            data.enforceNoDataAvail();
                            getGroupId(_arg016, _arg116, _arg214);
                            return true;
                        case 17:
                            ...
                            data.enforceNoDataAvail();
                            setVolume(_arg017, _arg117, _arg215);
                            return true;
                        case 18:
                            int _arg018 = data.readInt();
                            BluetoothDevice _arg118 = (BluetoothDevice) data.readTypedObject(BluetoothDevice.CREATOR);
                            ...
                            data.enforceNoDataAvail();
                            groupAddNode(_arg018, _arg118, _arg216, _arg34);
                            return true;
                        case 19:
                            int _arg019 = data.readInt();
                            BluetoothDevice _arg119 = (BluetoothDevice) data.readTypedObject(BluetoothDevice.CREATOR);
                            ...
                            data.enforceNoDataAvail();
                            groupRemoveNode(_arg019, _arg119, _arg217, _arg35);
                            return true;
                        case 20:
                            ...
                            data.enforceNoDataAvail();
                            getAudioLocation(_arg020, _arg120, _arg218);
                            return true;
                        case 21:
                            IBluetoothLeBroadcastCallback _arg021 = IBluetoothLeBroadcastCallback.Stub.asInterface(data.readStrongBinder());
                            ...
                            data.enforceNoDataAvail();
                            registerLeBroadcastCallback(_arg021, _arg121, _arg219);
                            return true;
                        case 22:
                            IBluetoothLeBroadcastCallback _arg022 = IBluetoothLeBroadcastCallback.Stub.asInterface(data.readStrongBinder());
                            ...
                            data.enforceNoDataAvail();
                            unregisterLeBroadcastCallback(_arg022, _arg122, _arg220);
                            return true;
                        case 23:
                            BluetoothLeAudioContentMetadata _arg023 = (BluetoothLeAudioContentMetadata) data.readTypedObject(BluetoothLeAudioContentMetadata.CREATOR);
                            ...
                            data.enforceNoDataAvail();
                            startBroadcast(_arg023, _arg123, _arg221);
                            return true;
                        case 24:
                            int _arg024 = data.readInt();
                            AttributionSource _arg124 = (AttributionSource) data.readTypedObject(AttributionSource.CREATOR);
                            data.enforceNoDataAvail();
                            stopBroadcast(_arg024, _arg124);
                            return true;
                        case 25:
                            int _arg025 = data.readInt();
                            BluetoothLeAudioContentMetadata _arg125 = (BluetoothLeAudioContentMetadata) data.readTypedObject(BluetoothLeAudioContentMetadata.CREATOR);
                            AttributionSource _arg222 = (AttributionSource) data.readTypedObject(AttributionSource.CREATOR);
                            data.enforceNoDataAvail();
                            updateBroadcast(_arg025, _arg125, _arg222);
                            return true;
                        case 26:
                            int _arg026 = data.readInt();
                            AttributionSource _arg126 = (AttributionSource) data.readTypedObject(AttributionSource.CREATOR);
                            SynchronousResultReceiver _arg223 = (SynchronousResultReceiver) data.readTypedObject(SynchronousResultReceiver.CREATOR);
                            data.enforceNoDataAvail();
                            isPlaying(_arg026, _arg126, _arg223);
                            return true;
                        case 27:
                            AttributionSource _arg027 = (AttributionSource) data.readTypedObject(AttributionSource.CREATOR);
                            SynchronousResultReceiver _arg127 = (SynchronousResultReceiver) data.readTypedObject(SynchronousResultReceiver.CREATOR);
                            data.enforceNoDataAvail();
                            getAllBroadcastMetadata(_arg027, _arg127);
                            return true;
                        case 28:
                            AttributionSource _arg028 = (AttributionSource) data.readTypedObject(AttributionSource.CREATOR);
                            SynchronousResultReceiver _arg128 = (SynchronousResultReceiver) data.readTypedObject(SynchronousResultReceiver.CREATOR);
                            data.enforceNoDataAvail();
                            getMaximumNumberOfBroadcasts(_arg028, _arg128);
                            return true;
                        default:
        ...
        private static class Proxy implements IBluetoothLeAudio {
            ...
            public void setCodecConfigPreference(int groupId, BluetoothLeAudioCodecConfig inputCodecConfig, BluetoothLeAudioCodecConfig outputCodecConfig, AttributionSource source) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(IBluetoothLeAudio.DESCRIPTOR);
                    _data.writeInt(groupId);
                    _data.writeTypedObject(inputCodecConfig, 0);
                    _data.writeTypedObject(outputCodecConfig, 0);
                    _data.writeTypedObject(source, 0);
            ...
            public void setCcidInformation(ParcelUuid userUuid, int ccid, int contextType, AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(IBluetoothLeAudio.DESCRIPTOR);
                    _data.writeTypedObject(userUuid, 0);
                    _data.writeInt(ccid);
                    _data.writeInt(contextType);
                    _data.writeTypedObject(attributionSource, 0);
                    _data.writeTypedObject(receiver, 0);
            ...
            public void startBroadcast(BluetoothLeAudioContentMetadata contentMetadata, byte[] broadcastCode, AttributionSource attributionSource) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(IBluetoothLeAudio.DESCRIPTOR);
                    _data.writeTypedObject(contentMetadata, 0);
                    _data.writeByteArray(broadcastCode);
                    _data.writeTypedObject(attributionSource, 0);
