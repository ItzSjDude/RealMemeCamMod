...
public final class AdvertiseSettings implements Parcelable {
    ...
    private AdvertiseSettings(int advertiseMode, int advertiseTxPowerLevel, boolean advertiseConnectable, int advertiseTimeout, int ownAddressType) {
    ...
    public String toString() {
        return "Settings [mAdvertiseMode=" + this.mAdvertiseMode + ", mAdvertiseTxPowerLevel=" + this.mAdvertiseTxPowerLevel + ", mAdvertiseConnectable=" + this.mAdvertiseConnectable + ", mAdvertiseTimeoutMillis=" + this.mAdvertiseTimeoutMillis + ", mOwnAddressType=" + this.mOwnAddressType + NavigationBarInflaterView.SIZE_MOD_END;
    }
    ...
    public static final class Builder {
        ...
        public AdvertiseSettings build() {
            return new AdvertiseSettings(this.mMode, this.mTxPowerLevel, this.mConnectable, this.mTimeoutMillis, this.mOwnAddressType);
        }
    }
}
