...
public interface IBluetoothAvrcpController extends IInterface {
    ...
    void getPlayerSettings(BluetoothDevice bluetoothDevice, AttributionSource attributionSource, SynchronousResultReceiver synchronousResultReceiver) throws RemoteException;

    void sendGroupNavigationCmd(BluetoothDevice bluetoothDevice, int i, int i2, AttributionSource attributionSource, SynchronousResultReceiver synchronousResultReceiver) throws RemoteException;

    void setPlayerApplicationSetting(BluetoothAvrcpPlayerSettings bluetoothAvrcpPlayerSettings, AttributionSource attributionSource, SynchronousResultReceiver synchronousResultReceiver) throws RemoteException;
    ...
    public static class Default implements IBluetoothAvrcpController {
        ...
        @Override // android.bluetooth.IBluetoothAvrcpController
        public void getPlayerSettings(BluetoothDevice device, AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothAvrcpController
        public void setPlayerApplicationSetting(BluetoothAvrcpPlayerSettings plAppSetting, AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
        }

        @Override // android.bluetooth.IBluetoothAvrcpController
        public void sendGroupNavigationCmd(BluetoothDevice device, int keyCode, int keyState, AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IBluetoothAvrcpController {
                ...
                default:
                    switch (code) {
                        ...
                        case 4:
                            ...
                            data.enforceNoDataAvail();
                            getPlayerSettings(_arg04, _arg14, _arg23);
                            return true;
                        case 5:
                            BluetoothAvrcpPlayerSettings _arg05 = (BluetoothAvrcpPlayerSettings) data.readTypedObject(BluetoothAvrcpPlayerSettings.CREATOR);
                            ...
                            data.enforceNoDataAvail();
                            setPlayerApplicationSetting(_arg05, _arg15, _arg24);
                            return true;
                        case 6:
                            ...
                            data.enforceNoDataAvail();
                            sendGroupNavigationCmd(_arg06, _arg16, _arg25, _arg3, _arg4);
                            return true;
                        default:
        ...
        private static class Proxy implements IBluetoothAvrcpController {
            ...
            public void setPlayerApplicationSetting(BluetoothAvrcpPlayerSettings plAppSetting, AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeTypedObject(plAppSetting, 0);
                    _data.writeTypedObject(attributionSource, 0);
                    _data.writeTypedObject(receiver, 0);
