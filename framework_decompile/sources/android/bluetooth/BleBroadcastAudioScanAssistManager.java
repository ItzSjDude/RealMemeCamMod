...
public final class BleBroadcastAudioScanAssistManager {
    ...
    BleBroadcastAudioScanAssistManager(BluetoothSyncHelper scanOffloader, BluetoothDevice device, BleBroadcastAudioScanAssistCallback callback) {
        this.mBluetoothSyncHelper = null;
