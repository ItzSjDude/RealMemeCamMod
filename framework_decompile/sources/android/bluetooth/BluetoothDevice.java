...
public final class BluetoothDevice implements Parcelable, Attributable {
    ...
    private final IpcDataCache.QueryHandler<Pair<IBluetooth, BluetoothDevice>, Integer> mBluetoothBondQuery;
    ...
    BluetoothDevice(String address, int addressType) {
        IpcDataCache.QueryHandler<Pair<IBluetooth, BluetoothDevice>, Integer> queryHandler = new IpcDataCache.QueryHandler<Pair<IBluetooth, BluetoothDevice>, Integer>() { // from class: android.bluetooth.BluetoothDevice.3
            ...
            public Integer apply(Pair<IBluetooth, BluetoothDevice> pairQuery) {
                try {
                    ...
                    pairQuery.first.getBondState(pairQuery.second, BluetoothDevice.this.mAttributionSource, recv);
        ...
        this.mBluetoothBondQuery = queryHandler;
        this.mBluetoothBondCache = new BluetoothCache<>(GET_BOND_STATE_API, queryHandler);
        getService();
    ...
    public String getName() {
        ...
        if (service == null) {
            ...
            try {
                ...
                String name = recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(null);
                if (name != null) {
    ...
    public String getAlias() {
        ...
        if (service == null) {
            ...
            try {
                ...
                String alias = recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(null);
                if (alias == null) {
                    return getName();
                }
    ...
    public int getBatteryLevel() {
        ...
        if (service == null || !isBluetoothEnabled()) {
            ...
            try {
                ...
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(-100).intValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
        }
    ...
    public int getBondState() {
        ...
        try {
            return this.mBluetoothBondCache.query(new Pair(service, this)).intValue();
    ...
    public boolean isEncrypted() {
        ...
        if (service == null || !isBluetoothEnabled()) {
            ...
            try {
                SynchronousResultReceiver<Integer> recv = SynchronousResultReceiver.get();
                service.getConnectionStateWithAttribution(this, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(0).intValue() > 1;
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
        }
    ...
    public BluetoothClass getBluetoothClass() {
        ...
        if (service == null || !isBluetoothEnabled()) {
            ...
            try {
                ...
                int classInt = recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(0).intValue();
    ...
    public ParcelUuid[] getUuids() {
        ...
        if (service == null || !isBluetoothEnabled()) {
            ...
            try {
                ...
                List<ParcelUuid> parcels = recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(null);
                if (parcels != null) {
    ...
    public boolean isTwsPlusDevice() {
        Log.e(TAG, "not support twsplus devices");
        return false;
    }
    ...
    @SystemApi
    public boolean setPin(String pin) throws UnsupportedEncodingException {
    ...
    public static byte[] convertPinToBytes(String pin) throws UnsupportedEncodingException {
        if (pin == null) {
            return null;
        }
        try {
    ...
    public byte[] getMetadata(int key) {
        ...
        if (service == null || !isBluetoothEnabled()) {
            ...
            try {
                SynchronousResultReceiver<byte[]> recv = SynchronousResultReceiver.get();
