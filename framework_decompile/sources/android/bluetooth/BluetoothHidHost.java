...
public final class BluetoothHidHost implements BluetoothProfile {
    ...
    BluetoothHidHost(Context context, BluetoothProfile.ServiceListener listener, BluetoothAdapter adapter) {
    ...
    public boolean virtualUnplug(BluetoothDevice device) {
        log("virtualUnplug(" + device + NavigationBarInflaterView.KEY_CODE_END);
        IBluetoothHidHost service = getService();
        if (service == null) {
            Log.w(TAG, "Proxy not attached to service");
            log(Log.getStackTraceString(new Throwable()));
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.virtualUnplug(device, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public boolean getProtocolMode(BluetoothDevice device) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.getProtocolMode(device, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public boolean setProtocolMode(BluetoothDevice device, int protocolMode) {
        log("setProtocolMode(" + device + NavigationBarInflaterView.KEY_CODE_END);
        IBluetoothHidHost service = getService();
        if (service == null) {
            Log.w(TAG, "Proxy not attached to service");
            log(Log.getStackTraceString(new Throwable()));
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.setProtocolMode(device, protocolMode, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public boolean getReport(BluetoothDevice device, byte reportType, byte reportId, int bufferSize) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                try {
                    service.getReport(device, reportType, reportId, bufferSize, this.mAttributionSource, recv);
                    return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
                } catch (RemoteException | TimeoutException e) {
                    e = e;
                    Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
    ...
    public boolean setReport(BluetoothDevice device, byte reportType, String report) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.setReport(device, reportType, report, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public boolean sendData(BluetoothDevice device, String report) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.sendData(device, report, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public boolean getIdleTime(BluetoothDevice device) {
        log("getIdletime(" + device + NavigationBarInflaterView.KEY_CODE_END);
        IBluetoothHidHost service = getService();
        if (service == null) {
            Log.w(TAG, "Proxy not attached to service");
            log(Log.getStackTraceString(new Throwable()));
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.getIdleTime(device, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public boolean setIdleTime(BluetoothDevice device, byte idleTime) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.setIdleTime(device, idleTime, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
