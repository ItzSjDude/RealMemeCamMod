...
public final class BluetoothVcp implements BluetoothProfile {
    ...
    BluetoothVcp(Context context, BluetoothProfile.ServiceListener listener) {
    ...
    public int getConnectionMode(BluetoothDevice device) {
        log("getConnectionMode(" + device + NavigationBarInflaterView.KEY_CODE_END);
        IBluetoothVcp service = getService();
        if (service != null && isEnabled() && isValidDevice(device)) {
            try {
    ...
    public void setAbsoluteVolume(BluetoothDevice device, int volume) {
        log("setAbsoluteVolume(" + device + NavigationBarInflaterView.KEY_CODE_END);
        IBluetoothVcp service = getService();
        if (service != null && isEnabled() && isValidDevice(device)) {
            try {
    ...
    public int getAbsoluteVolume(BluetoothDevice device) {
        log("getAbsoluteVolume(" + device + NavigationBarInflaterView.KEY_CODE_END);
        IBluetoothVcp service = getService();
        if (service != null && isEnabled() && isValidDevice(device)) {
            try {
    ...
    public boolean isMute(BluetoothDevice device) {
        log("isMute(" + device + NavigationBarInflaterView.KEY_CODE_END);
        IBluetoothVcp service = getService();
        if (service != null && isEnabled() && isValidDevice(device)) {
            try {
    ...
    public boolean setActiveProfile(BluetoothDevice device, int audioType, int profile) {
        log("setActiveProfile(" + device + NavigationBarInflaterView.KEY_CODE_END);
        IBluetoothVcp service = getService();
        if (service != null && isEnabled() && isValidDevice(device)) {
            try {
    ...
    public int getActiveProfile(int audioType) {
        log("getActiveProfile(" + audioType + NavigationBarInflaterView.KEY_CODE_END);
        IBluetoothVcp service = getService();
