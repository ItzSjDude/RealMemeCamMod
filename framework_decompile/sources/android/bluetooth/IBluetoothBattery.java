...
public interface IBluetoothBattery extends IInterface {
    public static final String DESCRIPTOR = "android.bluetooth.IBluetoothBattery";
    ...
    public static class Default implements IBluetoothBattery {
        @Override // android.bluetooth.IBluetoothBattery
    ...
    public static abstract class Stub extends Binder implements IBluetoothBattery {
        ...
        public Stub() {
            attachInterface(this, IBluetoothBattery.DESCRIPTOR);
        }

        public static IBluetoothBattery asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(IBluetoothBattery.DESCRIPTOR);
            if (iin != null && (iin instanceof IBluetoothBattery)) {
                return (IBluetoothBattery) iin;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code >= 1 && code <= 16777215) {
                data.enforceInterface(IBluetoothBattery.DESCRIPTOR);
            }
            switch (code) {
                case IBinder.INTERFACE_TRANSACTION /* 1598968902 */:
                    reply.writeString(IBluetoothBattery.DESCRIPTOR);
                    return true;
                default:
                    switch (code) {
                        case 1:
        ...
        private static class Proxy implements IBluetoothBattery {
            ...
            public String getInterfaceDescriptor() {
                return IBluetoothBattery.DESCRIPTOR;
            }
            ...
            public void connect(BluetoothDevice device, AttributionSource attributionSource, SynchronousResultReceiver receiver) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(IBluetoothBattery.DESCRIPTOR);
