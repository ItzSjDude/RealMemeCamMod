...
public interface IBluetoothPanCallback extends IInterface {
    ...
    public static class Default implements IBluetoothPanCallback {
    ...
    public static abstract class Stub extends Binder implements IBluetoothPanCallback {
        static final int TRANSACTION_onAvailable = 1;
        static final int TRANSACTION_onUnavailable = 2;

        public Stub() {
            attachInterface(this, IBluetoothPanCallback.DESCRIPTOR);
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code >= 1 && code <= 16777215) {
                data.enforceInterface(IBluetoothPanCallback.DESCRIPTOR);
            }
            switch (code) {
                case IBinder.INTERFACE_TRANSACTION /* 1598968902 */:
                    reply.writeString(IBluetoothPanCallback.DESCRIPTOR);
                    return true;
                default:
                    switch (code) {
                        case 1:
        ...
        private static class Proxy implements IBluetoothPanCallback {
