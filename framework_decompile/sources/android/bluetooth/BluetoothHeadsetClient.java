...
public final class BluetoothHeadsetClient implements BluetoothProfile, AutoCloseable {
    ...
    BluetoothHeadsetClient(Context context, BluetoothProfile.ServiceListener listener, BluetoothAdapter adapter) {
    ...
    public boolean sendVendorAtCommand(BluetoothDevice device, int vendorId, String atCommand) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.sendVendorAtCommand(device, vendorId, atCommand, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public List<BluetoothHeadsetClientCall> getCurrentCalls(BluetoothDevice device) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<List<BluetoothHeadsetClientCall>> recv = SynchronousResultReceiver.get();
                service.getCurrentCalls(device, this.mAttributionSource, recv);
                return Attributable.setAttributionSource(recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(null), this.mAttributionSource);
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
        }
    ...
    public Bundle getCurrentAgEvents(BluetoothDevice device) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Bundle> recv = SynchronousResultReceiver.get();
                service.getCurrentAgEvents(device, this.mAttributionSource, recv);
    ...
    public boolean acceptCall(BluetoothDevice device, int flag) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.acceptCall(device, flag, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public boolean holdCall(BluetoothDevice device) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.holdCall(device, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public boolean rejectCall(BluetoothDevice device) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.rejectCall(device, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public boolean terminateCall(BluetoothDevice device, BluetoothHeadsetClientCall call) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.terminateCall(device, call, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public boolean enterPrivateMode(BluetoothDevice device, int index) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.enterPrivateMode(device, index, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public boolean explicitCallTransfer(BluetoothDevice device) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.explicitCallTransfer(device, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public BluetoothHeadsetClientCall dial(BluetoothDevice device, String number) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<BluetoothHeadsetClientCall> recv = SynchronousResultReceiver.get();
                service.dial(device, number, this.mAttributionSource, recv);
                return (BluetoothHeadsetClientCall) Attributable.setAttributionSource(recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(null), this.mAttributionSource);
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
        }
    ...
    public boolean sendDTMF(BluetoothDevice device, byte code) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.sendDTMF(device, code, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public boolean getLastVoiceTagNumber(BluetoothDevice device) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.getLastVoiceTagNumber(device, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public void setAudioRouteAllowed(BluetoothDevice device, boolean allowed) {
        ...
        if (service == null) {
            ...
            try {
                ...
                service.setAudioRouteAllowed(device, allowed, this.mAttributionSource, recv);
    ...
    public boolean getAudioRouteAllowed(BluetoothDevice device) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.getAudioRouteAllowed(device, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public boolean connectAudio(BluetoothDevice device) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.connectAudio(device, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public boolean disconnectAudio(BluetoothDevice device) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Boolean> recv = SynchronousResultReceiver.get();
                service.disconnectAudio(device, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(false).booleanValue();
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public Bundle getCurrentAgFeatures(BluetoothDevice device) {
        ...
        if (service == null) {
            ...
            try {
                SynchronousResultReceiver<Bundle> recv = SynchronousResultReceiver.get();
                service.getCurrentAgFeatures(device, this.mAttributionSource, recv);
                return recv.awaitResultNoInterrupt(BluetoothUtils.getSyncTimeout()).getValue(null);
            } catch (RemoteException | TimeoutException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
    ...
    public static final class NetworkServiceState implements Parcelable {
        public static final Parcelable.Creator<NetworkServiceState> CREATOR = new Parcelable.Creator<NetworkServiceState>() { // from class: android.bluetooth.BluetoothHeadsetClient.NetworkServiceState.1
            ...
            public NetworkServiceState createFromParcel(Parcel in) {
                return new NetworkServiceState((BluetoothDevice) in.readParcelable(null), in.readInt() == 1, in.readString(), in.readInt(), in.readInt() == 1);
            }

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public NetworkServiceState[] newArray(int size) {
        ...
        public NetworkServiceState(BluetoothDevice device, boolean isServiceAvailable, String operatorName, int signalStrength, boolean isRoaming) {
            this.mDevice = device;
            this.mIsServiceAvailable = isServiceAvailable;
    ...
    @SystemApi
    public NetworkServiceState getNetworkServiceState(BluetoothDevice device) {
        Bundle agEvents;
        if (device == null || (agEvents = getCurrentAgEvents(device)) == null) {
            return null;
        }
        ...
        return new NetworkServiceState(device, isServiceAvailable, operatorName, signalStrength, isRoaming);
    }
