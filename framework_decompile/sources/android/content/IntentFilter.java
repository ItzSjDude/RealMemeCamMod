...
public class IntentFilter implements Parcelable {
    ...
    public final void addDataType(String type) throws MalformedMimeTypeException {
        processMimeType(type, new BiConsumer() { // from class: android.content.IntentFilter$$ExternalSyntheticLambda0
            ...
            public final void accept(Object obj, Object obj2) {
                this.f$0.m882lambda$addDataType$0$androidcontentIntentFilter((String) obj, (Boolean) obj2);
            }
        });
    }

    /* renamed from: lambda$addDataType$0$android-content-IntentFilter, reason: not valid java name */
    /* synthetic */ void m882lambda$addDataType$0$androidcontentIntentFilter(String internalType, Boolean isPartial) {
    ...
    public final void addDynamicDataType(String type) throws MalformedMimeTypeException {
        processMimeType(type, new BiConsumer() { // from class: android.content.IntentFilter$$ExternalSyntheticLambda1
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
                this.f$0.m883lambda$addDynamicDataType$1$androidcontentIntentFilter((String) obj, (Boolean) obj2);
            }
        });
    }

    /* renamed from: lambda$addDynamicDataType$1$android-content-IntentFilter, reason: not valid java name */
    /* synthetic */ void m883lambda$addDynamicDataType$1$androidcontentIntentFilter(String internalType, Boolean isPartial) {
        if (this.mDataTypes == null) {
            this.mDataTypes = new ArrayList<>();
        }
        if (!this.mDataTypes.contains(internalType)) {
    ...
    public Predicate<Intent> asPredicate() {
        return new Predicate() { // from class: android.content.IntentFilter$$ExternalSyntheticLambda2
            ...
            public final boolean test(Object obj) {
                return this.f$0.m884lambda$asPredicate$2$androidcontentIntentFilter((Intent) obj);
            }
        };
    }

    /* renamed from: lambda$asPredicate$2$android-content-IntentFilter, reason: not valid java name */
    /* synthetic */ boolean m884lambda$asPredicate$2$androidcontentIntentFilter(Intent i) {
    ...
    public Predicate<Intent> asPredicateWithTypeResolution(final ContentResolver resolver) {
        ...
        return new Predicate() { // from class: android.content.IntentFilter$$ExternalSyntheticLambda3
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return this.f$0.m885xfc9fa7e7(resolver, (Intent) obj);
            }
        };
    }

    /* renamed from: lambda$asPredicateWithTypeResolution$3$android-content-IntentFilter, reason: not valid java name */
    /* synthetic */ boolean m885xfc9fa7e7(ContentResolver resolver, Intent i) {
    ...
    public void writeToXml(XmlSerializer serializer) throws IllegalStateException, IOException, IllegalArgumentException {
        if (getAutoVerify()) {
    ...
    private void writeDataTypesToXml(XmlSerializer serializer) throws IllegalStateException, IOException, IllegalArgumentException {
        ArrayList<String> arrayList = this.mStaticDataTypes;
        if (arrayList == null) {
            return;
        }
    ...
    private void writeDataTypeToXml(XmlSerializer serializer, String type, String tag) throws IllegalStateException, IOException, IllegalArgumentException {
