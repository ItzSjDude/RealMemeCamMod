...
public abstract class ContentProvider implements ContentInterface, ComponentCallbacks2 {
    ...
    public IContentProviderExt mContentProviderExt;
    ...
    public static boolean isAuthorityRedirectedForCloneProfile(String authority) {
        return DeviceConfig.NAMESPACE_MEDIA.equals(authority);
    }

    public ContentProvider() {
        this.mContext = null;
        this.mUsersRedirectedToOwner = new SparseBooleanArray();
        this.mContentProviderExt = (IContentProviderExt) ExtLoader.type(IContentProviderExt.class).create();
    ...
    class Transport extends ContentProviderNative {
        ...
        public Cursor query(AttributionSource attributionSource, Uri uri, String[] projection, Bundle queryArgs, ICancellationSignal cancellationSignal) throws SecurityException {
        ...
        @Override // android.content.IContentProvider
        public String getType(Uri uri) throws SecurityException {
            Uri uri2 = ContentProvider.this.maybeGetUriWithoutUserId(ContentProvider.this.validateIncomingUri(uri));
        ...
        @Override // android.content.IContentProvider
        public Uri insert(AttributionSource attributionSource, Uri uri, ContentValues initialValues, Bundle extras) throws SecurityException {
        ...
        @Override // android.content.IContentProvider
        public int bulkInsert(AttributionSource attributionSource, Uri uri, ContentValues[] initialValues) throws SecurityException {
            Uri uri2 = ContentProvider.this.maybeGetUriWithoutUserId(ContentProvider.this.validateIncomingUri(uri));
        ...
        @Override // android.content.IContentProvider
        public ContentProviderResult[] applyBatch(AttributionSource attributionSource, String authority, ArrayList<ContentProviderOperation> operations) throws SecurityException, OperationApplicationException {
        ...
        @Override // android.content.IContentProvider
        public int delete(AttributionSource attributionSource, Uri uri, Bundle extras) throws SecurityException {
            Uri uri2 = ContentProvider.this.maybeGetUriWithoutUserId(ContentProvider.this.validateIncomingUri(uri));
            if (enforceWritePermission(attributionSource, uri2) != 0) {
                return 0;
            }
        ...
        @Override // android.content.IContentProvider
        public int update(AttributionSource attributionSource, Uri uri, ContentValues values, Bundle extras) throws SecurityException {
            Uri uri2 = ContentProvider.this.maybeGetUriWithoutUserId(ContentProvider.this.validateIncomingUri(uri));
            if (enforceWritePermission(attributionSource, uri2) != 0) {
                return 0;
            }
        ...
        @Override // android.content.IContentProvider
        public ParcelFileDescriptor openFile(AttributionSource attributionSource, Uri uri, String mode, ICancellationSignal cancellationSignal) throws SecurityException, FileNotFoundException {
            Uri uri2 = ContentProvider.this.maybeGetUriWithoutUserId(ContentProvider.this.validateIncomingUri(uri));
        ...
        @Override // android.content.IContentProvider
        public AssetFileDescriptor openAssetFile(AttributionSource attributionSource, Uri uri, String mode, ICancellationSignal cancellationSignal) throws SecurityException, FileNotFoundException {
            Uri uri2 = ContentProvider.this.maybeGetUriWithoutUserId(ContentProvider.this.validateIncomingUri(uri));
            enforceFilePermission(attributionSource, uri2, mode);
        ...
        @Override // android.content.IContentProvider
        public Bundle call(AttributionSource attributionSource, String authority, String method, String arg, Bundle extras) throws SecurityException {
            ContentProvider.this.validateIncomingAuthority(authority);
        ...
        @Override // android.content.IContentProvider
        public String[] getStreamTypes(Uri uri, String mimeTypeFilter) throws SecurityException {
            Uri uri2 = ContentProvider.this.maybeGetUriWithoutUserId(ContentProvider.this.validateIncomingUri(uri));
        ...
        @Override // android.content.IContentProvider
        public AssetFileDescriptor openTypedAssetFile(AttributionSource attributionSource, Uri uri, String mimeType, Bundle opts, ICancellationSignal cancellationSignal) throws SecurityException, FileNotFoundException {
        ...
        @Override // android.content.IContentProvider
        public int checkUriPermission(AttributionSource attributionSource, Uri uri, int uid, int modeFlags) throws SecurityException {
            Uri uri2 = ContentProvider.this.maybeGetUriWithoutUserId(ContentProvider.this.validateIncomingUri(uri));
        ...
        private void enforceFilePermission(AttributionSource attributionSource, Uri uri, String mode) throws SecurityException, FileNotFoundException {
    ...
    boolean checkUser(int pid, int uid, Context context) {
        ...
        if (callingUserId == context.getUserId() || this.mSingleUser || context.checkPermission(Manifest.permission.INTERACT_ACROSS_USERS, pid, uid) == 0 || context.checkPermission(Manifest.permission.INTERACT_ACROSS_USERS_FULL, pid, uid) == 0) {
            return true;
        }
    ...
    public final String getCallingPackage() {
        ...
        IContentProviderExt iContentProviderExt = this.mContentProviderExt;
        if (iContentProviderExt != null && (adjustPkg = iContentProviderExt.adjustCallingPkg(this, callingAttributionSource)) != null) {
            return adjustPkg;
        }
    ...
    public final String getCallingPackageUnchecked() {
        ...
        AttributionSource attributionSource = this.mCallingAttributionSource.get();
        IContentProviderExt iContentProviderExt = this.mContentProviderExt;
        if (iContentProviderExt != null && (adjustPkg = iContentProviderExt.adjustCallingPkg(this, attributionSource)) != null) {
            return adjustPkg;
        }
        if (attributionSource != null) {
    ...
    private void attachInfo(Context context, ProviderInfo info, boolean testing) {
        ...
        if (this.mContext == null) {
            ...
            onCreate();
            IContentProviderExt iContentProviderExt = this.mContentProviderExt;
            if (iContentProviderExt != null) {
                iContentProviderExt.init(this);
            }
        }
    }
