...
public class LoggingContentInterface implements ContentInterface {
    ...
    public boolean refresh(Uri uri, Bundle args, CancellationSignal cancellationSignal) throws RemoteException {
        ...
        try {
            try {
                boolean zBooleanValue = ((Boolean) l.setResult(Boolean.valueOf(this.delegate.refresh(uri, args, cancellationSignal)))).booleanValue();
                l.close();
    ...
    public int checkUriPermission(Uri uri, int uid, int modeFlags) throws RemoteException {
        ...
        try {
            try {
                int iIntValue = ((Integer) l.setResult(Integer.valueOf(this.delegate.checkUriPermission(uri, uid, modeFlags)))).intValue();
                l.close();
                return iIntValue;
            } catch (Exception res) {
                l.setResult(res);
    ...
    public int bulkInsert(Uri uri, ContentValues[] initialValues) throws RemoteException {
        ...
        try {
            try {
                int iIntValue = ((Integer) l.setResult(Integer.valueOf(this.delegate.bulkInsert(uri, initialValues)))).intValue();
                l.close();
                return iIntValue;
            } catch (Exception res) {
                l.setResult(res);
    ...
    public int delete(Uri uri, Bundle extras) throws RemoteException {
        ...
        try {
            try {
                int iIntValue = ((Integer) l.setResult(Integer.valueOf(this.delegate.delete(uri, extras)))).intValue();
                l.close();
                return iIntValue;
            } catch (Exception res) {
                l.setResult(res);
    ...
    public int update(Uri uri, ContentValues values, Bundle extras) throws RemoteException {
        ...
        try {
            try {
                int iIntValue = ((Integer) l.setResult(Integer.valueOf(this.delegate.update(uri, values, extras)))).intValue();
                l.close();
                return iIntValue;
            } catch (Exception res) {
                l.setResult(res);
