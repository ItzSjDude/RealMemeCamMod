...
public class Resources {
    ...
    public Resources(AssetManager assets, DisplayMetrics metrics, Configuration config) {
        this(null);
        ResourcesImpl resourcesImpl = new ResourcesImpl(assets, metrics, config, new DisplayAdjustments());
        this.mResourcesImpl = resourcesImpl;
        this.mResourcesExt.setResourceImplExt(resourcesImpl.mResourcesImplExt);
    }
    ...
    public Resources(ClassLoader classLoader) {
        ...
        this.mResourcesExt = (IResourcesExt) ExtLoader.type(IResourcesExt.class).base(this).create();
    ...
    private Resources() {
        ...
        ResourcesImpl resourcesImpl = new ResourcesImpl(AssetManager.getSystem(), metrics, config, new DisplayAdjustments());
        this.mResourcesImpl = resourcesImpl;
        this.mResourcesExt.setResourceImplExt(resourcesImpl.mResourcesImplExt);
    }
    ...
    public void setImpl(ResourcesImpl impl) {
        ...
        this.mResourcesExt.setResourceImplExt(impl.mResourcesImplExt);
    }
    ...
    public CharSequence getText(int id) throws NotFoundException {
        ...
        this.mResourcesImpl.mResourcesImplExt.debuglogApkAssets();
    ...
    public void preloadFonts(int id) throws NotFoundException {
    ...
    @Deprecated
    public Movie getMovie(int id) throws NotFoundException, IOException {
    ...
    public final class Theme {
        ...
        public TypedArray obtainStyledAttributes(int[] attrs) {
            ...
            synchronized (this.mLock) {
                typedArrayObtainStyledAttributes = this.mThemeImpl.obtainStyledAttributes(this, null, attrs, 0, 0);
            }
        ...
        public TypedArray obtainStyledAttributes(int resId, int[] attrs) throws NotFoundException {
            TypedArray typedArrayObtainStyledAttributes;
            synchronized (this.mLock) {
                typedArrayObtainStyledAttributes = this.mThemeImpl.obtainStyledAttributes(this, null, attrs, 0, resId);
            }
            return typedArrayObtainStyledAttributes;
        }
        ...
        public TypedArray obtainStyledAttributes(AttributeSet set, int[] attrs, int defStyleAttr, int defStyleRes) {
            TypedArray typedArrayObtainStyledAttributes;
            synchronized (this.mLock) {
                typedArrayObtainStyledAttributes = this.mThemeImpl.obtainStyledAttributes(this, set, attrs, defStyleAttr, defStyleRes);
            }
            return typedArrayObtainStyledAttributes;
        }
        ...
        public TypedArray resolveAttributes(int[] values, int[] attrs) {
            ...
            synchronized (this.mLock) {
                typedArrayResolveAttributes = this.mThemeImpl.resolveAttributes(this, values, attrs);
            }
        ...
        public boolean resolveAttribute(int resid, TypedValue outValue, boolean resolveRefs) {
            ...
            synchronized (this.mLock) {
                zResolveAttribute = this.mThemeImpl.resolveAttribute(resid, outValue, resolveRefs);
            }
        ...
        public void encode(ViewHierarchyEncoder encoder) throws IOException {
        ...
        public int getExplicitStyle(AttributeSet set) throws NotFoundException {
            int styleAttr;
    ...
    public static void dumpHistory(PrintWriter pw, String prefix) {
        ...
        sResourcesHistory.forEach(new Consumer() { // from class: android.content.res.Resources$$ExternalSyntheticLambda1
            ...
            public final void accept(Object obj) {
                ...
                history.put(Arrays.asList(resources.mResourcesImpl.mAssets.getApkAssets()), resources);
            }
        });
        int i = 0;
