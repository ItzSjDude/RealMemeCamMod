...
public final class XmlBlock implements AutoCloseable {
    ...
    public XmlBlock(byte[] data) {
        ...
        this.mOpenCount = 1;
        this.mAssets = null;
        long jNativeCreate = nativeCreate(data, 0, data.length);
        this.mNative = jNativeCreate;
        this.mStrings = new StringBlock(nativeGetStringBlock(jNativeCreate), false);
    }
    ...
    public XmlBlock(byte[] data, int offset, int size) {
        ...
        this.mOpenCount = 1;
        this.mAssets = null;
        long jNativeCreate = nativeCreate(data, offset, size);
        this.mNative = jNativeCreate;
        this.mStrings = new StringBlock(nativeGetStringBlock(jNativeCreate), false);
    }
