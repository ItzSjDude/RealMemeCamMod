...
public final class Configuration extends OplusBaseConfiguration implements Parcelable, Comparable<Configuration> {
    ...
    private IConfigurationExt mConfigurationExt;
    ...
    public Configuration() {
        ...
        this.mConfigurationExt = (IConfigurationExt) ExtLoader.type(IConfigurationExt.class).base(this).create();
    ...
    public void setTo(Configuration o) {
        ...
        this.mConfigurationExt.hookSetTo(this);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:110:0x035a A[Catch: IllformedLocaleException -> 0x0385, all -> 0x03b8, TRY_ENTER, TryCatch #5 {IllformedLocaleException -> 0x0385, blocks: (B:110:0x035a, B:111:0x0381), top: B:157:0x0358 }] */
    /* JADX WARN: Removed duplicated region for block: B:111:0x0381 A[Catch: IllformedLocaleException -> 0x0385, all -> 0x03b8, TRY_LEAVE, TryCatch #5 {IllformedLocaleException -> 0x0385, blocks: (B:110:0x035a, B:111:0x0381), top: B:157:0x0358 }] */
    /* JADX WARN: Removed duplicated region for block: B:147:0x0437  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public void readFromProto(android.util.proto.ProtoInputStream r27, long r28) throws java.lang.Throwable {
        /*
    ...
    public int updateFrom(Configuration delta) {
        ...
        int changed2 = changed | this.mOplusExtraConfiguration.updateFrom(delta.mOplusExtraConfiguration);
        this.mConfigurationExt.hookUpdateFrom(this);
        return changed2;
    }
    ...
    public static void readXmlAttrs(XmlPullParser parser, Configuration configOut) throws XmlPullParserException, IOException {
        ...
        LocaleList localeListForLanguageTags = LocaleList.forLanguageTags(localesStr);
        configOut.mLocaleList = localeListForLanguageTags;
        configOut.locale = localeListForLanguageTags.get(0);
