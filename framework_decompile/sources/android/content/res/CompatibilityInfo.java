    ...
    public CompatibilityInfo(ApplicationInfo appInfo, int screenLayout, int sw, boolean forceCompat, float overrideScale) {
        ...
        if (appInfo.requiresSmallestWidthDp != 0 || appInfo.compatibleWidthLimitDp != 0 || appInfo.largestWidthLimitDp != 0) {
            ...
            if (overrideScale != 1.0f && this.mCompatInfoExt != null) {
                ...
                float f2 = 1.0f / overrideScale;
                this.applicationInvertedScale = f2;
                int appdensity = (int) ((DisplayMetrics.DENSITY_DEVICE_STABLE * f2) + 0.5f);
                this.applicationDensity = this.mCompatInfoExt.getCompatDensity(appInfo, appdensity);
                ...
                float f3 = DisplayMetrics.DENSITY_DEVICE / 160.0f;
                this.applicationScale = f3;
                this.applicationInvertedScale = 1.0f / f3;
                compatFlags |= 1;
            } else if (density2 != 0 || overrideScale != 1.0f) {
                this.applicationScale = overrideScale;
                float f4 = 1.0f / overrideScale;
                this.applicationInvertedScale = f4;
                this.applicationDensity = (int) ((DisplayMetrics.DENSITY_DEVICE_STABLE * f4) + 0.5f);
                compatFlags |= 32;
            } else {
                this.applicationDensity = DisplayMetrics.DENSITY_DEVICE;
                this.applicationScale = 1.0f;
