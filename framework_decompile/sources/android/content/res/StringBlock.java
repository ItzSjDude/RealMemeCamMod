...
public final class StringBlock implements Closeable {
    ...
    private CharSequence applyStyles(String str, int[] style, StyleIDs ids) throws NumberFormatException {
        if (style.length == 0) {
            return str;
        }
    ...
    private static CharacterStyle getColor(String color, boolean foreground) throws Resources.NotFoundException, NumberFormatException {
        int c = -16777216;
