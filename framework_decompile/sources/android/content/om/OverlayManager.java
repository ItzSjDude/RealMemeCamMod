...
public class OverlayManager {
    ...
    @SystemApi
    public void setEnabledExclusiveInCategory(String packageName, UserHandle user) throws IllegalStateException, SecurityException {
        try {
    ...
    @SystemApi
    public void setEnabled(String packageName, boolean enable, UserHandle user) throws IllegalStateException, SecurityException {
        try {
