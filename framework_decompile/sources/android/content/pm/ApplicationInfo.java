...
public class ApplicationInfo extends PackageItemInfo implements Parcelable {
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeInt(this.overrideRes);
        parcel.writeInt(this.overrideDensity);
        ...
        this.mApplicationInfoExt.writeToParcel(parcel, i);
    }
    ...
    class AnonymousClass1 implements Parcelable.Creator<ApplicationInfo> {
        ...
        static /* synthetic */ ApplicationInfo lambda$createFromParcel$0(Parcel x$0) {
            return new ApplicationInfo(x$0);
        }
        ...
        public ApplicationInfo createFromParcel(Parcel source) {
            return (ApplicationInfo) source.readSquashed(new Parcel.SquashReadHelper() { // from class: android.content.pm.ApplicationInfo$1$$ExternalSyntheticLambda0
                ...
                public final Object readRawParceled(Parcel parcel) {
                    return ApplicationInfo.AnonymousClass1.lambda$createFromParcel$0(parcel);
                }
            });
        }
    ...
    private ApplicationInfo(Parcel source) {
        ...
        this.nativeHeapZeroInitialized = -1;
        this.mHiddenApiPolicy = -1;
        this.mApplicationInfoExt = (IApplicationInfoExt) ExtLoader.type(IApplicationInfoExt.class).base(this).create();
        ...
        this.mApplicationInfoExt.init(this, source);
    }
