...
public class ActivityInfo extends ComponentInfo implements Parcelable {
    ...
    public static final int COLOR_MODE_DEFAULT_SURFACE10BIT = 9;
    public static final int COLOR_MODE_HDR = 2;
    public static final int COLOR_MODE_WIDECOLORGAMUT_SURFACE10BIT = 10;
    ...
    public boolean hasFixedAspectRatio(int orientation) {
        return (getMaxAspectRatio() == 0.0f && getMinAspectRatio(orientation) == 0.0f) ? false : true;
    }
    ...
    public float getMinAspectRatio(int orientation) {
        if (this.applicationInfo == null || !isChangeEnabled(OVERRIDE_MIN_ASPECT_RATIO) || (isChangeEnabled(OVERRIDE_MIN_ASPECT_RATIO_PORTRAIT_ONLY) && !isFixedOrientationPortrait(orientation))) {
            float minAspectRatio = this.mActivityInfoExt.getOverrideMinAspectRatioForCompatMode();
    ...
    private ActivityInfo(Parcel source) {
        ...
        Set<String> setUnparcel = sForStringSet.unparcel(source);
