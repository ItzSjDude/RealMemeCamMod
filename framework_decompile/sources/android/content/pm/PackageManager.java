...
public abstract class PackageManager {
    ...
    static {
        ...
        sApplicationInfoCache = new PropertyInvalidatedCache<ApplicationInfoQuery, ApplicationInfo>(16, str, "getApplicationInfo") { // from class: android.content.pm.PackageManager.1
        ...
        sPackageInfoCache = new PropertyInvalidatedCache<PackageInfoQuery, PackageInfo>(32, str, "getPackageInfo") { // from class: android.content.pm.PackageManager.2
            @Override // android.app.PropertyInvalidatedCache
    ...
    public void requestChecksums(String packageName, boolean includeSplits, int required, List<Certificate> trustedInstallers, OnChecksumsReadyListener onChecksumsReadyListener) throws NameNotFoundException, CertificateEncodingException {
    ...
    public boolean isDefaultApplicationIcon(Drawable drawable) {
        ...
        return resId == 17301651 || resId == 17303703;
    }
