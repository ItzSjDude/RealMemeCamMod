...
public class OplusPackageManager {
    ...
    public boolean setInterceptRuleInfos(List<OplusRuleInfo> infos) throws RemoteException {
        if (getService() != null) {
            return getService().setInterceptRuleInfos(infos);
        }
        Log.e(TAG, "setInterceptRuleInfos failed because service has not been created");
        return false;
    }

    public List<OplusRuleInfo> getInterceptRuleInfos() throws RemoteException {
        if (getService() != null) {
            return getService().getInterceptRuleInfos();
        }
        Log.e(TAG, "getInterceptRuleInfos failed because service has not been created");
        return null;
    }
