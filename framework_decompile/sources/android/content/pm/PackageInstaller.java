...
public class PackageInstaller {
    ...
    public int createSession(SessionParams params) throws Throwable {
        try {
    ...
    public Session openSession(int sessionId) throws Throwable {
        try {
            try {
    ...
    public static class Session implements Closeable {
        ...
        public OutputStream openWrite(String name, long offsetBytes, long lengthBytes) throws Throwable {
            try {
        ...
        public void write(String name, long offsetBytes, long lengthBytes, ParcelFileDescriptor fd) throws Throwable {
            try {
        ...
        public void stageViaHardLink(String target) throws Throwable {
            try {
        ...
        public void fsync(OutputStream out) throws IOException, ErrnoException {
            if (PackageInstaller.ENABLE_REVOCABLE_FD) {
        ...
        public InputStream openRead(String name) throws Throwable {
            try {
        ...
        public void removeSplit(String splitName) throws Throwable {
            try {
        ...
        @Deprecated
        public void setChecksums(String name, List<Checksum> checksums, byte[] signature) throws Throwable {
        ...
        public void requestChecksums(String name, int required, List<Certificate> trustedInstallers, Executor executor, PackageManager.OnChecksumsReadyListener onChecksumsReadyListener) throws Throwable {
            Objects.requireNonNull(name);
        ...
        public void transfer(String packageName) throws Throwable {
    ...
    public static class SessionParams implements Parcelable {
        ...
        public SessionParams(int mode) {
            ...
            this.mode = mode;
            this.mSessionParamsExt = (ISessionParamsExt) ExtLoader.type(ISessionParamsExt.class).create();
        }
        ...
        public SessionParams(Parcel source) {
            ...
            ISessionParamsExt iSessionParamsExt = (ISessionParamsExt) ExtLoader.type(ISessionParamsExt.class).create();
            this.mSessionParamsExt = iSessionParamsExt;
            iSessionParamsExt.initFromParcel(source);
        }
    ...
    public static class SessionInfo implements Parcelable {
        ...
        public SessionInfo(Parcel source) {
            ...
            int[] iArrCreateIntArray = source.createIntArray();
