...
public final class InstantAppResolveInfo implements Parcelable {
    ...
    public static final class InstantAppDigest implements Parcelable {
        ...
        public InstantAppDigest(String hostName, int maxDigests) throws NoSuchAlgorithmException {
            if (hostName == null) {
                throw new IllegalArgumentException();
            }
            byte[][] bArrGenerateDigest = generateDigest(hostName.toLowerCase(Locale.ENGLISH), maxDigests);
        ...
        private static byte[][] generateDigest(String hostName, int maxDigests) throws NoSuchAlgorithmException {
