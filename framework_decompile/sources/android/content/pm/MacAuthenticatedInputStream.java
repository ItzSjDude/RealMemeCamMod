...
public class MacAuthenticatedInputStream extends FilterInputStream {
    ...
    public boolean isTagEqual(byte[] tag) throws IllegalStateException {
    ...
    @Override // java.io.FilterInputStream, java.io.InputStream
    public int read(byte[] buffer, int offset, int count) throws IllegalStateException, IOException {
