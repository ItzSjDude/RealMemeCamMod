...
public interface IOplusPackageManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IOplusPackageManager {
        ...
        static final int TRANSACTION_setMarketRecommendPause = 70;
                ...
                default:
                    switch (code) {
                        ...
                        case 15:
                            ...
                            return true;
                        case 16:
                            List<OplusRuleInfo> _arg014 = data.createTypedArrayList(OplusRuleInfo.CREATOR);
                            data.enforceNoDataAvail();
                            boolean _result16 = setInterceptRuleInfos(_arg014);
                            reply.writeNoException();
                            reply.writeBoolean(_result16);
                            return true;
                        case 17:
                            List<OplusRuleInfo> _result17 = getInterceptRuleInfos();
                            reply.writeNoException();
                        ...
                        case 18:
                            ...
                            return true;
                        case 19:
                            List<OplusRemovableAppInfo> _result19 = getRemovedAppInfos();
                            reply.writeNoException();
                            reply.writeTypedList(_result19);
                            return true;
                        case 20:
                            List<OplusRemovableAppInfo> _result20 = getRemovableAppInfos();
                            reply.writeNoException();
                        ...
                        case 21:
                            ...
                            data.enforceNoDataAvail();
                            OplusRemovableAppInfo _result21 = getRemovableAppInfo(_arg015);
                            reply.writeNoException();
                        ...
                        case 28:
                            ...
                            return true;
                        case 29:
                            OplusAppDynamicFeatureData _arg021 = (OplusAppDynamicFeatureData) data.readTypedObject(OplusAppDynamicFeatureData.CREATOR);
                            data.enforceNoDataAvail();
                            dynamicDetectApp(_arg021);
                            return true;
                        case 30:
                        ...
                        case 59:
                            ...
                            return true;
                        case 60:
                            List<String> _arg046 = data.createStringArrayList();
                            IOplusFeatureObserver _arg126 = IOplusFeatureObserver.Stub.asInterface(data.readStrongBinder());
                            data.enforceNoDataAvail();
                            boolean _result51 = registerFeatureObserverInner(_arg046, _arg126);
                            reply.writeNoException();
                            reply.writeBoolean(_result51);
                            return true;
                        case 61:
                            IOplusFeatureObserver _arg047 = IOplusFeatureObserver.Stub.asInterface(data.readStrongBinder());
                            data.enforceNoDataAvail();
                            boolean _result52 = unregisterFeatureObserverInner(_arg047);
                            reply.writeNoException();
                        ...
                        case 62:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result53 = registerFeatureMapObserverInner(_arg048, _arg127, _arg212);
                            reply.writeNoException();
                        ...
                        case 63:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result54 = unregisterFeatureMapObserverInner(_arg049, _arg128);
                            reply.writeNoException();
                        ...
                        case 64:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result55 = registerFeatureActionObserverInner(_arg050);
                            reply.writeNoException();
                            reply.writeBoolean(_result55);
                            return true;
                        case 65:
                            IOplusFeatureActionObserver _arg051 = IOplusFeatureActionObserver.Stub.asInterface(data.readStrongBinder());
                            data.enforceNoDataAvail();
                            boolean _result56 = unregisterFeatureActionObserverInner(_arg051);
                            reply.writeNoException();
                        ...
                        case 70:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result61 = setMarketRecommendPause(_arg055);
                            reply.writeNoException();
