...
abstract class BaseParceledListSlice<T> implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, final int flags) {
        ...
        if (N > 0) {
            ...
            if (i < N) {
                dest.writeInt(0);
                Binder retriever = new Binder() { // from class: android.content.pm.BaseParceledListSlice.1
                    ...
                    protected boolean onTransact(int code, Parcel data, Parcel reply, int flags2) throws RemoteException {
                        ...
                        if (BaseParceledListSlice.DEBUG) {
                            Log.d(BaseParceledListSlice.TAG, "Writing more @" + i2 + " of " + N + " to " + Binder.getCallingPid() + ", sender=" + this);
                        }
                        ...
                        if (i2 < N) {
                            ...
                            if (BaseParceledListSlice.DEBUG) {
                                Log.d(BaseParceledListSlice.TAG, "Transfer complete, clearing mList reference");
                            }
