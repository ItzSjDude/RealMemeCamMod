...
public class RollbackManagerFrameworkInitializer {
    ...
    public static void initialize() {
        SystemServiceRegistry.registerContextAwareService("rollback", RollbackManager.class, new SystemServiceRegistry.ContextAwareServiceProducerWithBinder() { // from class: android.content.rollback.RollbackManagerFrameworkInitializer$$ExternalSyntheticLambda0
