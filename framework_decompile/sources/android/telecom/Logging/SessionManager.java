...
public class SessionManager {
    ...
    public java.lang.Runnable mCleanStaleSessions = new java.lang.Runnable() { // from class: android.telecom.Logging.SessionManager$$ExternalSyntheticLambda0
        ...
        public final void run() {
            this.f$0.m4092lambda$new$0$androidtelecomLoggingSessionManager();
        }
    };
    ...
    private ISessionCleanupTimeoutMs mSessionCleanupTimeoutMs = new ISessionCleanupTimeoutMs() { // from class: android.telecom.Logging.SessionManager$$ExternalSyntheticLambda2
        ...
        public final long get() {
            return this.f$0.m4093lambda$new$1$androidtelecomLoggingSessionManager();
        }
    };
    ...
    /* renamed from: lambda$new$0$android-telecom-Logging-SessionManager, reason: not valid java name */
    /* synthetic */ void m4092lambda$new$0$androidtelecomLoggingSessionManager() {
        cleanupStaleSessions(getSessionCleanupTimeoutMs());
    }

    /* renamed from: lambda$new$1$android-telecom-Logging-SessionManager, reason: not valid java name */
    /* synthetic */ long m4093lambda$new$1$androidtelecomLoggingSessionManager() {
