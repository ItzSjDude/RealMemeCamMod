...
public class UserPackage {
    ...
    public static List<UserPackage> getPackageInfosAllUsers(Context context, String packageName, int packageFlags) throws PackageManager.NameNotFoundException {
