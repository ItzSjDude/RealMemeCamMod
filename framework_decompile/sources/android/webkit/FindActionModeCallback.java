...
public class FindActionModeCallback implements ActionMode.Callback, TextWatcher, View.OnClickListener, WebView.FindListener {
    ...
    public void setWebView(WebView webView) throws Throwable {
        if (webView == null) {
    ...
    private void findNext(boolean next) throws Throwable {
    ...
    @Override // android.view.ActionMode.Callback
    public void onDestroyActionMode(ActionMode mode) throws Throwable {
    ...
    @Override // android.view.ActionMode.Callback
    public boolean onActionItemClicked(ActionMode mode, MenuItem item) throws Throwable {
        WebView webView = this.mWebView;
        if (webView == null) {
        ...
        switch (item.getItemId()) {
            case R.id.find_next /* 16909011 */:
                findNext(true);
                return true;
            case R.id.find_prev /* 16909012 */:
                findNext(false);
                return true;
            default:
                return false;
    ...
    @Override // android.text.TextWatcher
    public void onTextChanged(CharSequence s, int start, int before, int count) throws Throwable {
        findAll();
    }
