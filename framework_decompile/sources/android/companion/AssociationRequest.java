...
public final class AssociationRequest implements Parcelable {
    ...
    AssociationRequest(Parcel in) {
        ...
        boolean selfManaged = (flg & 16) != 0;
        boolean forceConfirmation = (flg & 32) != 0;
        boolean skipPrompt = (flg & 1024) != 0;
        ...
        String packageName = (flg & 64) == 0 ? null : in.readString();
        int userId = in.readInt();
        String deviceProfilePrivilegesDescription = (flg & 256) == 0 ? null : in.readString();
        long creationTime = in.readLong();
        this.mSingleDevice = singleDevice;
        this.mDeviceFilters = arrayList;
        AnnotationValidations.validate((Class<NonNull>) NonNull.class, (NonNull) null, (Object) arrayList);
        this.mDeviceProfile = deviceProfile;
        AnnotationValidations.validate((Class<? extends Annotation>) DeviceProfile.class, (Annotation) null, deviceProfile);
        this.mDisplayName = displayName;
        this.mSelfManaged = selfManaged;
        this.mForceConfirmation = forceConfirmation;
        this.mPackageName = packageName;
