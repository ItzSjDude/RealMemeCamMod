    ...
    static final class Impl implements Callback, Window.DecorCallback {
        ...
        private void scheduleRelayout() {
            ...
            frame.post(new Runnable() { // from class: android.inputmethodservice.NavigationBarController$Impl$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    this.f$0.m1907xa332f227(frame);
                }
            });
        }

        /* renamed from: lambda$scheduleRelayout$0$android-inputmethodservice-NavigationBarController$Impl, reason: not valid java name */
        /* synthetic */ void m1907xa332f227(NavigationBarFrame frame) {
            Window window;
            View decor;
        ...
        public void onWindowShown() {
            ...
            if (!this.mDestroyed && this.mImeDrawsImeNavBar && this.mNavigationBarFrame != null && (systemInsets = getSystemInsets()) != null) {
                ...
                this.mService.getWrapper().getExtImpl().updateNavigationBarOnShown(this.mNavigationBarFrame);
            }
        }
        ...
        public void onNavButtonFlagsChanged(int navButtonFlags) {
            ...
            int navButtonFlags2 = this.mService.getWrapper().getExtImpl().updateNavButtonFlags(navButtonFlags);
            boolean imeDrawsImeNavBar = (navButtonFlags2 & 1) != 0;
            boolean shouldShowImeSwitcherWhenImeIsShown = (navButtonFlags2 & 2) != 0;
        ...
        public void onSystemBarAppearanceChanged(int appearance) {
            ...
            ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(this.mDarkIntensity, targetDarkIntensity);
            this.mTintAnimator = valueAnimatorOfFloat;
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: android.inputmethodservice.NavigationBarController$Impl$$ExternalSyntheticLambda1
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    this.f$0.m1906xb8f3d1ff(valueAnimator2);
                }
            });
        ...
        /* renamed from: lambda$onSystemBarAppearanceChanged$1$android-inputmethodservice-NavigationBarController$Impl, reason: not valid java name */
        /* synthetic */ void m1906xb8f3d1ff(ValueAnimator animation) {
