...
class IInputMethodSessionWrapper extends IInputMethodSession.Stub implements HandlerCaller.Callback {
    ...
    public void executeMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case 150:
                args = (SomeArgs) msg.obj;
                try {
                    this.mInputMethodSession.invalidateInputInternal((EditorInfo) args.arg1, (IInputContext) args.arg2, msg.arg1);
                    return;
                } finally {
                    args.recycle();
                }
    ...
    public void invalidateInput(EditorInfo editorInfo, IInputContext inputContext, int sessionId) {
        HandlerCaller handlerCaller = this.mCaller;
        handlerCaller.executeOrSendMessage(handlerCaller.obtainMessageIOO(150, sessionId, editorInfo, inputContext));
    }
