...
class IInputMethodWrapper extends IInputMethod.Stub implements HandlerCaller.Callback {
    ...
    @Override // com.android.internal.view.IInputMethod
    public void startInput(IBinder iBinder, IInputContext iInputContext, EditorInfo editorInfo, boolean z, int i, ImeOnBackInvokedDispatcher imeOnBackInvokedDispatcher) {
        if (this.mCancellationGroup == null) {
            Log.e(TAG, "startInput must be called after bindInput.");
            this.mCancellationGroup = new CancellationGroup();
        }
        SomeArgs someArgsObtain = SomeArgs.obtain();
        someArgsObtain.arg1 = iInputContext;
        someArgsObtain.arg2 = imeOnBackInvokedDispatcher;
        HandlerCaller handlerCaller = this.mCaller;
        handlerCaller.executeOrSendMessage(handlerCaller.obtainMessageOOOOII(32, iBinder, someArgsObtain, editorInfo, this.mCancellationGroup, z ? 1 : 0, i));
    }
