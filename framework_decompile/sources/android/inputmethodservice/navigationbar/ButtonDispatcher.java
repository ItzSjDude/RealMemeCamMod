...
final class ButtonDispatcher {
    ...
    private final ValueAnimator.AnimatorUpdateListener mAlphaListener = new ValueAnimator.AnimatorUpdateListener() { // from class: android.inputmethodservice.navigationbar.ButtonDispatcher$$ExternalSyntheticLambda0
        ...
        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
            this.f$0.m1909xe3b78bf7(valueAnimator);
        }
    };
    ...
    /* renamed from: lambda$new$0$android-inputmethodservice-navigationbar-ButtonDispatcher, reason: not valid java name */
    /* synthetic */ void m1909xe3b78bf7(ValueAnimator animation) {
    ...
    public void setAlpha(float alpha, boolean animate, long duration, boolean cancelAnimator) {
        ...
        if (animate) {
            setVisibility(0);
            ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(getAlpha(), alpha);
    ...
    public void setCurrentView(View currentView) {
        View viewFindViewById = currentView.findViewById(this.mId);
