...
public final class NavigationBarInflaterView extends FrameLayout {
    ...
    protected void inflateLayout(String newLayout) throws Resources.NotFoundException, NumberFormatException {
        if (newLayout == null) {
    ...
    private void inflateButtons(String[] buttons, ViewGroup parent, boolean landscape, boolean start) throws Resources.NotFoundException, NumberFormatException {
    ...
    protected View inflateButton(String buttonSpec, ViewGroup parent, boolean landscape, boolean start) throws Resources.NotFoundException, NumberFormatException {
    ...
    private View applySize(View v, String buttonSpec, boolean landscape, boolean start) throws NumberFormatException {
        int gravity;
    ...
    View createView(String buttonSpec, ViewGroup parent, LayoutInflater inflater) throws Resources.NotFoundException {
