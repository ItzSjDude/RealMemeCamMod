...
public class SoundTriggerModule {
    ...
    SoundTriggerModule(ISoundTriggerMiddlewareService service, int moduleId, SoundTrigger.StatusListener listener, Looper looper, Identity originatorIdentity) throws RemoteException {
        this.mId = moduleId;
    ...
    SoundTriggerModule(ISoundTriggerMiddlewareService service, int moduleId, SoundTrigger.StatusListener listener, Looper looper, Identity middlemanIdentity, Identity originatorIdentity) throws RemoteException {
        this.mId = moduleId;
        this.mEventHandlerDelegate = new EventHandlerDelegate(listener, looper);
        SafeCloseable ignored = ClearCallingIdentityContext.create();
        try {
