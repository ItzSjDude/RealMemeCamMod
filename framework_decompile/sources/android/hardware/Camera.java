...
public class Camera {
    ...
    private static ICameraSocExt mExt = (ICameraSocExt) ExtLoader.type(ICameraSocExt.class).base(null).create();
    ...
    public static int getNumberOfCameras() {
        boolean exposeAuxCamera = mExt.needExposeAuxCamera();
        int numberOfCameras = _getNumberOfCameras();
        if (!exposeAuxCamera) {
            int numberOfCameras2 = CameraExtPlugin.getInstance.call(new Object[0]).getNumPhysicalCameras(ActivityThread.currentOpPackageName());
    ...
    public static Camera openLegacy(int cameraId, int halVersion) {
        ...
        if (CameraExtPlugin.interceptOpenLegacy.call(new Object[0]).booleanValue()) {
            throw new RuntimeException("Open camera denied");
        }
        return new Camera(cameraId);
    }
    ...
    public int getWBCurrentCCT() throws NumberFormatException {
        Parameters p = new Parameters();
        String s = native_getParameters();
        p.unflatten(s);
    ...
    public int getCurrentFocusPosition() throws NumberFormatException {
        Parameters p = new Parameters();
        String s = native_getParameters();
        p.unflatten(s);
    ...
    public class Parameters {
        ...
        private Coordinate strToCoordinate(String str) {
            ...
            if (pos != -1) {
                ...
                return Camera.this.new Coordinate(Integer.parseInt(x), Integer.parseInt(y));
            }
