...
public final class BrightnessCorrection implements Parcelable {
    ...
    public static BrightnessCorrection loadFromXml(TypedXmlPullParser parser) throws XmlPullParserException, IOException {
    ...
    private static class ScaleAndTranslateLog implements BrightnessCorrectionImplementation {
        ...
        ScaleAndTranslateLog(float scale, float translate) {
            ...
            this.mScale = MathUtils.constrain(scale, 0.5f, MAX_SCALE);
        ...
        static BrightnessCorrection loadFromXml(TypedXmlPullParser parser) throws XmlPullParserException, IOException {
