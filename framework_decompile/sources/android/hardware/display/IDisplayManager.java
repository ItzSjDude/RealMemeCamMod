...
public interface IDisplayManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IDisplayManager {
        ...
        static final int TRANSACTION_getDisplayDecorationSupport = 49;
        ...
        static final int TRANSACTION_setSpecBrightness = 48;
                ...
                default:
                    switch (code) {
                        ...
                        case 48:
                            ...
                            data.enforceNoDataAvail();
                            setSpecBrightness(_arg033, _arg115, _arg25);
                            reply.writeNoException();
                            return true;
                        case 49:
                            int _arg034 = data.readInt();
                            data.enforceNoDataAvail();
                            DisplayDecorationSupport _result23 = getDisplayDecorationSupport(_arg034);
                            reply.writeNoException();
