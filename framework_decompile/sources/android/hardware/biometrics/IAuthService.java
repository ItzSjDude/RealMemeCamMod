                ...
                default:
                    switch (code) {
                        ...
                        case 12:
                            ...
                            data.enforceNoDataAvail();
                            CharSequence _result8 = getButtonLabel(_arg011, _arg18, _arg27);
                            reply.writeNoException();
                            if (_result8 != null) {
                                reply.writeInt(1);
                        ...
                        case 13:
                            ...
                            data.enforceNoDataAvail();
                            CharSequence _result9 = getPromptMessage(_arg012, _arg19, _arg28);
                            reply.writeNoException();
                            if (_result9 != null) {
                                reply.writeInt(1);
                        ...
                        case 14:
                            ...
                            data.enforceNoDataAvail();
                            CharSequence _result10 = getSettingName(_arg013, _arg110, _arg29);
                            reply.writeNoException();
                            if (_result10 != null) {
                                reply.writeInt(1);
