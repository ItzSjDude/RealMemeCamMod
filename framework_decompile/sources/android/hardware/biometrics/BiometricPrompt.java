...
public class BiometricPrompt implements BiometricAuthenticator, BiometricConstants {
    ...
    class AnonymousClass1 extends IBiometricServiceReceiver.Stub {
        ...
        public void onError(int modality, final int error, int vendorCode) throws Resources.NotFoundException {
            ...
            BiometricPrompt.this.mExecutor.execute(new Runnable() { // from class: android.hardware.biometrics.BiometricPrompt$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m1429lambda$onError$2$androidhardwarebiometricsBiometricPrompt$1(error, stringToSend);
                }
            });
        }

        /* renamed from: lambda$onError$2$android-hardware-biometrics-BiometricPrompt$1, reason: not valid java name */
        /* synthetic */ void m1429lambda$onError$2$androidhardwarebiometricsBiometricPrompt$1(int error, String stringToSend) {
                ...
                try {
                    ...
                    try {
                        ...
                        this.mExecutor.execute(new Runnable() { // from class: android.hardware.biometrics.BiometricPrompt$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f$0.m1424x18619ec8(callback);
                            }
                        });
                        return -1L;
                    }
    ...
    /* synthetic */ void m1424x18619ec8(AuthenticationCallback callback) {
