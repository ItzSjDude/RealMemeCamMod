...
public class BiometricManager {
        ...
        try {
            return new BiometricTestSession(this.mContext, sensorId, new BiometricTestSession.TestSessionProvider() { // from class: android.hardware.biometrics.BiometricManager$$ExternalSyntheticLambda0
                ...
                public final ITestSession createTestSession(Context context, int i, ITestSessionCallback iTestSessionCallback) {
                    return this.f$0.m1416xe4a2654d(context, i, iTestSessionCallback);
                }
            });
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
    ...
    /* renamed from: lambda$createTestSession$0$android-hardware-biometrics-BiometricManager, reason: not valid java name */
    /* synthetic */ ITestSession m1416xe4a2654d(Context context, int sensorId1, ITestSessionCallback callback) throws RemoteException {
