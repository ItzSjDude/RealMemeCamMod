...
public final class SyncFence implements AutoCloseable, Parcelable {
    ...
    private SyncFence(ParcelFileDescriptor wrapped) {
        long jNCreate = nCreate(wrapped.detachFd());
    ...
    private SyncFence(Parcel parcel) {
        ...
        if (fileDescriptor != null) {
            long jNCreate = nCreate(fileDescriptor.getInt$());
            this.mNativePtr = jNCreate;
            this.mCloser = sRegistry.registerNativeAllocation(this, jNCreate);
            return;
        }
    ...
    public ParcelFileDescriptor getFdDup() throws IOException {
        ...
        synchronized (this.mCloser) {
            ...
            parcelFileDescriptorFromFd = ParcelFileDescriptor.fromFd(fd);
        }
