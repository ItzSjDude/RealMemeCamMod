...
public interface IGnssGeofence extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGnssGeofence {
        ...
        private static class Proxy implements IGnssGeofence {
            ...
            @Override // android.hardware.gnss.IGnssGeofence
            public void addGeofence(int geofenceId, double latitudeDegrees, double longitudeDegrees, double radiusMeters, int lastTransition, int monitorTransitions, int notificationResponsivenessMs, int unknownTimerMs) throws Throwable {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
