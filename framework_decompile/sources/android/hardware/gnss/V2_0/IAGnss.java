...
public interface IAGnss extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IAGnss {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{127, 70, BluetoothHidDevice.ERROR_RSP_UNKNOWN, 121, 95, 93, 30, -43, -29, 120, -109, 95, -104, -58, -37, 77, 57, 73, 125, -23, -120, -82, MidiConstants.STATUS_MIDI_TIME_CODE, -76, -62, -92, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, 122, 108, 64, 3, -110}, new byte[]{-20, 127, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
