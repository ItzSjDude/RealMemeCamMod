...
public class RadioManager {
    ...
    public void addAnnouncementListener(Set<Integer> enabledAnnouncementTypes, Announcement.OnListUpdatedListener listener) throws RemoteException {
    ...
    public void addAnnouncementListener(Executor executor, Set<Integer> enabledAnnouncementTypes, Announcement.OnListUpdatedListener listener) throws RemoteException {
        ...
        public void onListUpdated(final List<Announcement> activeAnnouncements) {
            ...
            executor.execute(new Runnable() { // from class: android.hardware.radio.RadioManager$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    onListUpdatedListener.onListUpdated(activeAnnouncements);
                }
            });
        }
    }
