...
public final class ProgramList implements AutoCloseable {
    ...
    void apply(Chunk chunk) {
        synchronized (this.mLock) {
            ...
            if (chunk.isPurge()) {
                new HashSet(this.mPrograms.keySet()).stream().forEach(new Consumer() { // from class: android.hardware.radio.ProgramList$$ExternalSyntheticLambda4
                    ...
                    public final void accept(Object obj) {
                        this.f$0.m1812lambda$apply$1$androidhardwareradioProgramList((ProgramSelector.Identifier) obj);
                    }
                });
            }
            chunk.getRemoved().stream().forEach(new Consumer() { // from class: android.hardware.radio.ProgramList$$ExternalSyntheticLambda5
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    this.f$0.m1813lambda$apply$2$androidhardwareradioProgramList((ProgramSelector.Identifier) obj);
                }
            });
            chunk.getModified().stream().forEach(new Consumer() { // from class: android.hardware.radio.ProgramList$$ExternalSyntheticLambda6
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    this.f$0.m1814lambda$apply$3$androidhardwareradioProgramList((RadioManager.ProgramInfo) obj);
                }
            });
            if (chunk.isComplete()) {
    ...
    public void m1814lambda$apply$3$androidhardwareradioProgramList(RadioManager.ProgramInfo value) {
        ...
        this.mListCallbacks.forEach(new Consumer() { // from class: android.hardware.radio.ProgramList$$ExternalSyntheticLambda3
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                ((ProgramList.ListCallback) obj).onItemChanged(sel);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: removeLocked, reason: merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public void m1813lambda$apply$2$androidhardwareradioProgramList(ProgramSelector.Identifier key) {
        ...
        this.mListCallbacks.forEach(new Consumer() { // from class: android.hardware.radio.ProgramList$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                ((ProgramList.ListCallback) obj).onItemRemoved(sel);
            }
        });
    }
