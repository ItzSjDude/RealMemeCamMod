...
public interface IndicationFilter$$ {
    static String toString(int _aidl_v) {
        return _aidl_v == 0 ? KeyProperties.DIGEST_NONE : _aidl_v == -1 ? "ALL" : _aidl_v == 1 ? "SIGNAL_STRENGTH" : _aidl_v == 2 ? "FULL_NETWORK_STATE" : _aidl_v == 4 ? "DATA_CALL_DORMANCY_CHANGED" : _aidl_v == 8 ? "LINK_CAPACITY_ESTIMATE" : _aidl_v == 16 ? "PHYSICAL_CHANNEL_CONFIG" : _aidl_v == 32 ? "REGISTRATION_FAILURE" : _aidl_v == 64 ? "BARRING_INFO" : Integer.toString(_aidl_v);
    }
