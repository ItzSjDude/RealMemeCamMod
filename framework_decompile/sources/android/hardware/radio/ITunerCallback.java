            ...
            switch (code) {
                ...
                default:
                    switch (code) {
                        ...
                        case 12:
                            int N = data.readInt();
                            final Map<String, String> _arg010 = N < 0 ? null : new HashMap<>();
                            IntStream.range(0, N).forEach(new IntConsumer() { // from class: android.hardware.radio.ITunerCallback$Stub$$ExternalSyntheticLambda0
                                ...
                                public final void accept(int i) {
                                    ITunerCallback.Stub.lambda$onTransact$0(data, _arg010, i);
                                }
                            });
                            data.enforceNoDataAvail();
                            onParametersUpdated(_arg010);
                            return true;
                        default:
                    ...
                    if (parameters == null) {
                        ...
                        parameters.forEach(new BiConsumer() { // from class: android.hardware.radio.ITunerCallback$Stub$Proxy$$ExternalSyntheticLambda0
                            ...
                            public final void accept(Object obj, Object obj2) {
                                ITunerCallback.Stub.Proxy.lambda$onParametersUpdated$0(_data, (String) obj, (String) obj2);
                            }
                        });
                    }
