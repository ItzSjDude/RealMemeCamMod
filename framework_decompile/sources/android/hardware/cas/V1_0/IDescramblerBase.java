...
public interface IDescramblerBase extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IDescramblerBase {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-92, 50, -42, -39, NetworkStackConstants.TCPHDR_URG, 2, 72, -36, 33, 38, -126, 123, -51, 108, -34, -93, 29, -42, 94, -1, 57, -71, 57, -10, 69, -123, -46, 125, -111, 90, 88, 87}, new byte[]{-20, 127, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
