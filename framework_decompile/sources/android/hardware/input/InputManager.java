...
public final class InputManager {
    ...
    */
    public android.view.InputDevice getInputDeviceByDescriptor(java.lang.String r8) throws android.os.RemoteException {
        /*
            r7 = this;
            if (r8 == 0) goto L4d
            java.lang.Object r0 = r7.mInputDevicesLock
            monitor-enter(r0)
            r7.populateInputDevicesLocked()     // Catch: java.lang.Throwable -> L4a
            android.util.SparseArray<android.view.InputDevice> r1 = r7.mInputDevices     // Catch: java.lang.Throwable -> L4a
            int r1 = r1.size()     // Catch: java.lang.Throwable -> L4a
            r2 = 0
        Lf:
            if (r2 >= r1) goto L47
            android.util.SparseArray<android.view.InputDevice> r3 = r7.mInputDevices     // Catch: java.lang.Throwable -> L4a
            java.lang.Object r3 = r3.valueAt(r2)     // Catch: java.lang.Throwable -> L4a
            android.view.InputDevice r3 = (android.view.InputDevice) r3     // Catch: java.lang.Throwable -> L4a
            if (r3 != 0) goto L38
            android.util.SparseArray<android.view.InputDevice> r4 = r7.mInputDevices     // Catch: java.lang.Throwable -> L4a
            int r4 = r4.keyAt(r2)     // Catch: java.lang.Throwable -> L4a
            android.hardware.input.IInputManager r5 = r7.mIm     // Catch: android.os.RemoteException -> L32 java.lang.Throwable -> L4a
            android.view.InputDevice r5 = r5.getInputDevice(r4)     // Catch: android.os.RemoteException -> L32 java.lang.Throwable -> L4a
            r3 = r5
            if (r3 != 0) goto L2c
            goto L44
        L2c:
            android.util.SparseArray<android.view.InputDevice> r5 = r7.mInputDevices     // Catch: java.lang.Throwable -> L4a
            r5.setValueAt(r2, r3)     // Catch: java.lang.Throwable -> L4a
            goto L38
        L32:
            r5 = move-exception
            java.lang.RuntimeException r6 = r5.rethrowFromSystemServer()     // Catch: java.lang.Throwable -> L4a
            throw r6     // Catch: java.lang.Throwable -> L4a
        L38:
            java.lang.String r4 = r3.getDescriptor()     // Catch: java.lang.Throwable -> L4a
            boolean r4 = r8.equals(r4)     // Catch: java.lang.Throwable -> L4a
            if (r4 == 0) goto L44
        ...
        L4d:
            ...
            java.lang.String r1 = "descriptor must not be null."
            r0.<init>(r1)
            throw r0
        */
