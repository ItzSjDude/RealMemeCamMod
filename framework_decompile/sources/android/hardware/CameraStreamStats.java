...
public class CameraStreamStats implements Parcelable {
    ...
    public CameraStreamStats(int width, int height, int format, float maxPreviewFps, int dataSpace, long usage, long requestCount, long errorCount, int startLatencyMs, int maxHalBuffers, int maxAppBuffers, long dynamicRangeProfile, long streamUseCase) {
        this.mWidth = width;
        this.mHeight = height;
        this.mFormat = format;
