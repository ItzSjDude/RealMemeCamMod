...
public interface IRequestProcessorImpl extends IInterface {
    ...
    boolean setRepeating(Request request, IRequestCallback iRequestCallback) throws RemoteException;

    void stopRepeating() throws RemoteException;

    boolean submit(Request request, IRequestCallback iRequestCallback) throws RemoteException;

    boolean submitBurst(List<Request> list, IRequestCallback iRequestCallback) throws RemoteException;
    ...
    public static class Default implements IRequestProcessorImpl {
        ...
        @Override // android.hardware.camera2.extension.IRequestProcessorImpl
        public boolean submit(Request request, IRequestCallback callback) throws RemoteException {
            return false;
        }

        @Override // android.hardware.camera2.extension.IRequestProcessorImpl
        public boolean submitBurst(List<Request> requests, IRequestCallback callback) throws RemoteException {
            return false;
        }

        @Override // android.hardware.camera2.extension.IRequestProcessorImpl
        public boolean setRepeating(Request request, IRequestCallback callback) throws RemoteException {
            return false;
        }
                ...
                default:
                    switch (code) {
                        ...
                        case 2:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result = submit(_arg02, _arg12);
                            reply.writeNoException();
                        ...
                        case 3:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result2 = submitBurst(_arg03, _arg13);
                            reply.writeNoException();
                        ...
                        case 4:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result3 = setRepeating(_arg04, _arg14);
                            reply.writeNoException();
