...
public interface ISessionProcessorImpl extends IInterface {
    ...
    int startCapture(ICaptureCallback iCaptureCallback) throws RemoteException;
                ...
                default:
                    switch (code) {
                        ...
                        case 7:
                            ...
                            data.enforceNoDataAvail();
                            int _result3 = startCapture(_arg04);
                            reply.writeNoException();
                        ...
                        case 9:
                            ...
                            ICaptureCallback _arg12 = ICaptureCallback.Stub.asInterface(data.readStrongBinder());
                            data.enforceNoDataAvail();
                            int _result4 = startTrigger(_arg06, _arg12);
                            reply.writeNoException();
