                ...
                default:
                    switch (code) {
                        ...
                        case 8:
                            ...
                            return true;
                        case 9:
                            int _result6 = getProcessorType();
                            reply.writeNoException();
                            reply.writeInt(_result6);
                            return true;
                        case 10:
                            IPreviewImageProcessorImpl _result7 = getPreviewImageProcessor();
                            reply.writeNoException();
                            reply.writeStrongInterface(_result7);
                            return true;
                        case 11:
                            IRequestUpdateProcessorImpl _result8 = getRequestUpdateProcessor();
                            reply.writeNoException();
