...
public final class OutputConfiguration implements Parcelable {
    ...
    public void setStreamUseCase(long streamUseCase) {
        if (streamUseCase > 5 && streamUseCase < 65536) {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.mRotation != other.mRotation || !this.mConfiguredSize.equals(other.mConfiguredSize) || (i = this.mConfiguredFormat) != (i2 = other.mConfiguredFormat) || this.mSurfaceGroupId != other.mSurfaceGroupId || this.mSurfaceType != other.mSurfaceType || this.mIsDeferredConfig != other.mIsDeferredConfig || this.mIsShared != other.mIsShared || i != i2 || this.mConfiguredDataspace != other.mConfiguredDataspace || this.mConfiguredGenerationId != other.mConfiguredGenerationId || !Objects.equals(this.mPhysicalCameraId, other.mPhysicalCameraId) || this.mIsMultiResolution != other.mIsMultiResolution || this.mStreamUseCase != other.mStreamUseCase || this.mTimestampBase != other.mTimestampBase || this.mMirrorMode != other.mMirrorMode || this.mSensorPixelModesUsed.size() != other.mSensorPixelModesUsed.size()) {
            return false;
        }
        ...
        if (this.mDynamicRangeProfile != other.mDynamicRangeProfile) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        if (this.mIsDeferredConfig) {
            ...
            fArr[7] = this.mPhysicalCameraId == null ? 0.0f : r8.hashCode();
            fArr[8] = this.mIsMultiResolution ? 1.0f : 0.0f;
            fArr[9] = this.mSensorPixelModesUsed.hashCode();
            fArr[10] = this.mDynamicRangeProfile;
            fArr[11] = this.mStreamUseCase;
            fArr[12] = this.mTimestampBase;
            fArr[13] = this.mMirrorMode;
        ...
        fArr2[8] = this.mPhysicalCameraId == null ? 0.0f : r8.hashCode();
        fArr2[9] = this.mIsMultiResolution ? 1.0f : 0.0f;
        fArr2[10] = this.mSensorPixelModesUsed.hashCode();
        fArr2[11] = this.mDynamicRangeProfile;
        fArr2[12] = this.mStreamUseCase;
        fArr2[13] = this.mTimestampBase;
        fArr2[14] = this.mMirrorMode;
