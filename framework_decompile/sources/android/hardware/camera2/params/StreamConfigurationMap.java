...
public final class StreamConfigurationMap {
    ...
    */
    public StreamConfigurationMap(android.hardware.camera2.params.StreamConfiguration[] r27, android.hardware.camera2.params.StreamConfigurationDuration[] r28, android.hardware.camera2.params.StreamConfigurationDuration[] r29, android.hardware.camera2.params.StreamConfiguration[] r30, android.hardware.camera2.params.StreamConfigurationDuration[] r31, android.hardware.camera2.params.StreamConfigurationDuration[] r32, android.hardware.camera2.params.StreamConfiguration[] r33, android.hardware.camera2.params.StreamConfigurationDuration[] r34, android.hardware.camera2.params.StreamConfigurationDuration[] r35, android.hardware.camera2.params.StreamConfiguration[] r36, android.hardware.camera2.params.StreamConfigurationDuration[] r37, android.hardware.camera2.params.StreamConfigurationDuration[] r38, android.hardware.camera2.params.HighSpeedVideoConfiguration[] r39, android.hardware.camera2.params.ReprocessFormatsMap r40, boolean r41, boolean r42) {
        /*
            Method dump skipped, instructions count: 743
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: android.hardware.camera2.params.StreamConfigurationMap.<init>(android.hardware.camera2.params.StreamConfiguration[], android.hardware.camera2.params.StreamConfigurationDuration[], android.hardware.camera2.params.StreamConfigurationDuration[], android.hardware.camera2.params.StreamConfiguration[], android.hardware.camera2.params.StreamConfigurationDuration[], android.hardware.camera2.params.StreamConfigurationDuration[], android.hardware.camera2.params.StreamConfiguration[], android.hardware.camera2.params.StreamConfigurationDuration[], android.hardware.camera2.params.StreamConfigurationDuration[], android.hardware.camera2.params.StreamConfiguration[], android.hardware.camera2.params.StreamConfigurationDuration[], android.hardware.camera2.params.StreamConfigurationDuration[], android.hardware.camera2.params.HighSpeedVideoConfiguration[], android.hardware.camera2.params.ReprocessFormatsMap, boolean, boolean):void");
    }
