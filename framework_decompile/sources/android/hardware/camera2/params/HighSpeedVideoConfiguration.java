...
public final class HighSpeedVideoConfiguration {
    ...
    public HighSpeedVideoConfiguration(int width, int height, int fpsMin, int fpsMax, int batchSizeMax) {
        ...
        this.mFpsMax = fpsMax;
        int iCheckArgumentPositive = Preconditions.checkArgumentPositive(width, "width must be positive");
        this.mWidth = iCheckArgumentPositive;
        int iCheckArgumentPositive2 = Preconditions.checkArgumentPositive(height, "height must be positive");
        this.mHeight = iCheckArgumentPositive2;
        int iCheckArgumentPositive3 = Preconditions.checkArgumentPositive(fpsMin, "fpsMin must be positive");
        ...
        this.mFpsRange = new Range<>(Integer.valueOf(iCheckArgumentPositive3), Integer.valueOf(fpsMax));
    }
