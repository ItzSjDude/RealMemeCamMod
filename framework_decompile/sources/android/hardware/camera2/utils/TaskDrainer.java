    ...
    private void postDrained() {
        this.mExecutor.execute(new Runnable() { // from class: android.hardware.camera2.utils.TaskDrainer$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m1670lambda$postDrained$0$androidhardwarecamera2utilsTaskDrainer();
            }
        });
    }

    /* renamed from: lambda$postDrained$0$android-hardware-camera2-utils-TaskDrainer, reason: not valid java name */
    /* synthetic */ void m1670lambda$postDrained$0$androidhardwarecamera2utilsTaskDrainer() {
