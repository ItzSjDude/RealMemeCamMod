...
public class SurfaceUtils {
    ...
    public static void checkConstrainedHighSpeedSurfaces(Collection<Surface> surfaces, Range<Integer> fpsRange, StreamConfigurationMap config) {
        ...
        ISurfaceUtilsExt mSurfaceUtilsExt = SurfaceUtilsExtPlugin.getInstance.call(new Object[0]);
        String packageName = ActivityThread.currentOpPackageName();
        if (isPrivilegedApp() || mSurfaceUtilsExt.extendSession() || mSurfaceUtilsExt.isPrivilegedApp(packageName)) {
            return;
        }
        if (fpsRange == null) {
