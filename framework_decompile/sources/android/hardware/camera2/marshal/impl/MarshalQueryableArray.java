...
public class MarshalQueryableArray<T> implements MarshalQueryable<T> {
        ...
        static PrimitiveArrayFiller getPrimitiveArrayFiller(Class<?> componentType) {
            if (componentType == Integer.TYPE) {
                return new PrimitiveArrayFiller() { // from class: android.hardware.camera2.marshal.impl.MarshalQueryableArray.PrimitiveArrayFiller.1
                    ...
                    public void fillPosition(Object arr, int index, ByteBuffer buffer) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
                        int i = buffer.getInt();
    ...
    private class MarshalerArray extends Marshaler<T> {
        ...
        @Override // android.hardware.camera2.marshal.Marshaler
        public T unmarshal(ByteBuffer buffer) throws ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
            Object array;
        ...
        /* JADX WARN: Multi-variable type inference failed */
        private <TElem> int calculateElementMarshalSize(Marshaler<TElem> marshaler, Object array, int index) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
