...
public class CameraOfflineSessionImpl extends CameraOfflineSession implements IBinder.DeathRecipient {
    ...
    public class CameraDeviceCallbacks extends ICameraDeviceCallbacks.Stub {
        ...
        public void onCaptureStarted(final CaptureResultExtras resultExtras, final long timestamp) throws Throwable {
            ...
            Object obj = CameraOfflineSessionImpl.this.mInterfaceLock;
            synchronized (obj) {
                try {
                    try {
                                        ...
                                        if (!CameraOfflineSessionImpl.this.isClosed() && callback != null) {
                                            ...
                                            if (holder.hasBatchedOutputs()) {
                                                ...
                                                for (int i = 0; i < holder.getRequestCount(); i++) {
                                                    ...
                                                    long cbTimestamp = timestamp - (((subsequenceId - i) * 1000000000) / ((Integer) fpsRange.getUpper()).intValue());
        ...
        @Override // android.hardware.camera2.ICameraDeviceCallbacks
        public void onResultReceived(CameraMetadataNative result, final CaptureResultExtras resultExtras, PhysicalCaptureResultInfo[] physicalResults) throws Throwable {
            Object obj;
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:57:? -> B:47:0x00cd). Please report as a decompilation issue!!! */
