...
public class CameraMetadataNative implements Parcelable {
    ...
    public static class Key<T> {
        ...
        public Key(String name, Class<T> type, long vendorId) {
            ...
            TypeReference<T> typeReferenceCreateSpecializedTypeReference = TypeReference.createSpecializedTypeReference((Class) type);
            this.mTypeReference = typeReferenceCreateSpecializedTypeReference;
            this.mHash = typeReferenceCreateSpecializedTypeReference.hashCode() ^ name.hashCode();
        }
    ...
    public CameraMetadataNative(CameraMetadataNative other) throws NullPointerException {
        long jNativeAllocateCopy = nativeAllocateCopy(other.mMetadataPtr);
    ...
    static {
        ...
        map.put(CaptureResult.STATISTICS_OIS_SAMPLES.getNativeKey(), new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.24
            /* JADX WARN: Multi-variable type inference failed */
            @Override // android.hardware.camera2.impl.GetCommand
            public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
        ...
        map.put(CameraCharacteristics.CONTROL_AVAILABLE_EXTENDED_SCENE_MODE_CAPABILITIES.getNativeKey(), new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.25
            /* JADX WARN: Multi-variable type inference failed */
            @Override // android.hardware.camera2.impl.GetCommand
            public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
        ...
        map.put(CameraCharacteristics.SCALER_MULTI_RESOLUTION_STREAM_CONFIGURATION_MAP.getNativeKey(), new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.26
            @Override // android.hardware.camera2.impl.GetCommand
            public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
        ...
        sSetCommandMap = map2;
        map2.put(CameraCharacteristics.SCALER_AVAILABLE_FORMATS.getNativeKey(), new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.27
            /* JADX WARN: Multi-variable type inference failed */
            @Override // android.hardware.camera2.impl.SetCommand
            public <T> void setValue(CameraMetadataNative metadata, T t) throws IllegalArgumentException {
                metadata.setAvailableFormats((int[]) t);
            }
        });
        map2.put(CaptureResult.STATISTICS_FACE_RECTANGLES.getNativeKey(), new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.28
            /* JADX WARN: Multi-variable type inference failed */
            @Override // android.hardware.camera2.impl.SetCommand
            public <T> void setValue(CameraMetadataNative metadata, T t) throws IllegalArgumentException {
        ...
        map2.put(CaptureResult.STATISTICS_FACES.getNativeKey(), new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.29
            /* JADX WARN: Multi-variable type inference failed */
            @Override // android.hardware.camera2.impl.SetCommand
            public <T> void setValue(CameraMetadataNative metadata, T t) throws IllegalArgumentException {
        ...
        map2.put(CaptureRequest.TONEMAP_CURVE.getNativeKey(), new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.30
            /* JADX WARN: Multi-variable type inference failed */
            @Override // android.hardware.camera2.impl.SetCommand
            public <T> void setValue(CameraMetadataNative metadata, T t) throws IllegalArgumentException {
        ...
        map2.put(CaptureResult.JPEG_GPS_LOCATION.getNativeKey(), new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.31
            /* JADX WARN: Multi-variable type inference failed */
            @Override // android.hardware.camera2.impl.SetCommand
            public <T> void setValue(CameraMetadataNative metadata, T t) throws IllegalArgumentException {
        ...
        map2.put(CaptureRequest.SCALER_CROP_REGION.getNativeKey(), new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.32
            /* JADX WARN: Multi-variable type inference failed */
            @Override // android.hardware.camera2.impl.SetCommand
            public <T> void setValue(CameraMetadataNative metadata, T t) throws IllegalArgumentException {
        ...
        map2.put(CaptureRequest.CONTROL_AWB_REGIONS.getNativeKey(), new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.33
            @Override // android.hardware.camera2.impl.SetCommand
            public <T> void setValue(CameraMetadataNative metadata, T value) throws IllegalArgumentException {
                metadata.setAWBRegions(value);
            }
        });
        map2.put(CaptureRequest.CONTROL_AF_REGIONS.getNativeKey(), new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.34
            @Override // android.hardware.camera2.impl.SetCommand
            public <T> void setValue(CameraMetadataNative metadata, T value) throws IllegalArgumentException {
                metadata.setAFRegions(value);
            }
        });
        map2.put(CaptureRequest.CONTROL_AE_REGIONS.getNativeKey(), new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.35
            @Override // android.hardware.camera2.impl.SetCommand
            public <T> void setValue(CameraMetadataNative metadata, T value) throws IllegalArgumentException {
    ...
    public <T> void set(Key<T> key, T value) throws IllegalArgumentException {
    ...
    public <T> void set(CaptureResult.Key<T> key, T value) throws IllegalArgumentException {
        set((Key<Key<T>>) key.getNativeKey(), (Key<T>) value);
    }

    public <T> void set(CameraCharacteristics.Key<T> key, T value) throws IllegalArgumentException {
        set((Key<Key<T>>) key.getNativeKey(), (Key<T>) value);
    }
    ...
    private <T> T getBase(Key<T> key) throws IllegalArgumentException {
        int tag;
        if (key.hasTag()) {
            tag = key.getTag();
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean setFaces(Face[] faces) throws IllegalArgumentException {
        if (faces == null) {
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean setGpsLocation(Location l) throws IllegalArgumentException {
        if (l == null) {
            return false;
        }
    ...
    private MandatoryStreamCombination[] getMandatoryStreamCombinationsHelper(int mandatoryStreamsType) {
        ...
        MandatoryStreamCombination.Builder build = new MandatoryStreamCombination.Builder(this.mCameraId, hwLevel, this.mDisplaySize, caps, getStreamConfigurationMap(), getStreamConfigurationMapMaximumResolution(), isPreviewStabilizationSupported());
    ...
    public Capability[] getExtendedSceneModeCapabilities() {
        ...
        if (zoomRange != null) {
            modeOffMinZoomRatio = ((Float) zoomRange.getLower()).floatValue();
            modeOffMaxZoomRatio = ((Float) zoomRange.getUpper()).floatValue();
        }
    ...
    private <T> void setBase(CameraCharacteristics.Key<T> key, T value) throws IllegalArgumentException {
        setBase((Key<Key<T>>) key.getNativeKey(), (Key<T>) value);
    }

    private <T> void setBase(CaptureResult.Key<T> key, T value) throws IllegalArgumentException {
        setBase((Key<Key<T>>) key.getNativeKey(), (Key<T>) value);
    }

    private <T> void setBase(CaptureRequest.Key<T> key, T value) throws IllegalArgumentException {
        setBase((Key<Key<T>>) key.getNativeKey(), (Key<T>) value);
    }

    private <T> void setBase(Key<T> key, T value) throws IllegalArgumentException {
        int tag;
        if (key.hasTag()) {
            tag = key.getTag();
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean setAvailableFormats(int[] value) throws IllegalArgumentException {
        if (value == null) {
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean setFaceRectangles(Rect[] faceRects) throws IllegalArgumentException {
        if (faceRects == null) {
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public <T> boolean setTonemapCurve(TonemapCurve tc) throws IllegalArgumentException {
        if (tc == null) {
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public <T> boolean setScalerCropRegion(Rect cropRegion) throws IllegalArgumentException {
        if (cropRegion == null) {
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public <T> boolean setAFRegions(T afRegions) throws IllegalArgumentException {
        if (afRegions == null) {
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public <T> boolean setAERegions(T aeRegions) throws IllegalArgumentException {
        if (aeRegions == null) {
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public <T> boolean setAWBRegions(T awbRegions) throws IllegalArgumentException {
        if (awbRegions == null) {
            return false;
        }
    ...
    public void swap(CameraMetadataNative other) throws NullPointerException {
