...
public interface IUdfpsHbmListener extends IInterface {
    ...
    void onHbmDisabled(int i) throws RemoteException;

    void onHbmEnabled(int i) throws RemoteException;

    public static class Default implements IUdfpsHbmListener {
        @Override // android.hardware.fingerprint.IUdfpsHbmListener
        public void onHbmEnabled(int displayId) throws RemoteException {
        }

        @Override // android.hardware.fingerprint.IUdfpsHbmListener
        public void onHbmDisabled(int displayId) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IUdfpsHbmListener {
        ...
        private static class Proxy implements IUdfpsHbmListener {
