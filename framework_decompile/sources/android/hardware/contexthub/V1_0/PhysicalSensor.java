...
public final class PhysicalSensor {
    ...
    public String f4vendor = new String();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.sensorType == other.sensorType && HidlSupport.deepEquals(this.type, other.type) && HidlSupport.deepEquals(this.name, other.name) && HidlSupport.deepEquals(this.f4vendor, other.f4vendor) && this.version == other.version && this.fifoReservedCount == other.fifoReservedCount && this.fifoMaxCount == other.fifoMaxCount && this.minDelayMs == other.minDelayMs && this.maxDelayMs == other.maxDelayMs && this.peakPowerMw == other.peakPowerMw) {
            return true;
        }
        return false;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.f4vendor = _hidl_blob.getString(_hidl_offset + 40);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putString(40 + _hidl_offset, this.f4vendor);
