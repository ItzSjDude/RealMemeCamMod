...
public class DeviceFilter {
    ...
    public static DeviceFilter read(XmlPullParser parser) throws XmlPullParserException, NumberFormatException, IOException {
        int radix;
        String value;
        int count;
    ...
    public void write(XmlSerializer serializer) throws IllegalStateException, IOException, IllegalArgumentException {
