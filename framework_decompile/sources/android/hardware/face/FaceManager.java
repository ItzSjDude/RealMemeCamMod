...
public class FaceManager implements BiometricAuthenticator, BiometricFaceConstants {
    ...
    private final IFaceServiceReceiver mServiceReceiver = new IFaceServiceReceiver.Stub() { // from class: android.hardware.face.FaceManager.1
        ...
        public void onAuthenticationSucceeded(Face face, int i, boolean z) {
            ...
            if ("com.android.systemui".equals(FaceManager.this.mContext.getOpPackageName())) {
                FaceManager.this.sendAuthenticatedSucceeded(face, i, z);
            } else {
            ...
            try {
                ...
                handler.post(new Runnable() { // from class: android.hardware.face.FaceManager$2$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        FaceManager.AnonymousClass2.lambda$onLockoutReset$0(lockoutResetCallback, sensorId, wakeLock);
                    }
                });
            } finally {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void sendAuthenticationFrame(FaceAuthenticationFrame frame) throws Resources.NotFoundException {
        if (frame == null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void sendEnrollmentFrame(FaceEnrollFrame frame) throws Resources.NotFoundException {
        if (frame == null) {
    ...
    public static String getAuthHelpMessage(Context context, int acquireInfo, int vendorCode) throws Resources.NotFoundException {
        switch (acquireInfo) {
            case 0:
            case 20:
                return null;
    ...
    public static String getEnrollHelpMessage(Context context, int acquireInfo, int vendorCode) throws Resources.NotFoundException {
        switch (acquireInfo) {
            case 0:
            case 20:
                return null;
