...
public class SystemSensorManager extends SensorManager {
    ...
    protected boolean registerListenerImpl(SensorEventListener listener, Sensor sensor, int delayUs, Handler handler, int maxBatchReportLatencyUs, int reservedFlags) {
        ...
        if (mSystemSensorManagerExt.registerListenerImplHook(this.mContext, listener, sensor, delayUs)) {
            return false;
        }
    ...
    static final class SensorEventQueue extends BaseEventQueue {
        ...
        @Override // android.hardware.SystemSensorManager.BaseEventQueue
        protected void dispatchSensorEvent(int handle, float[] values, int inAccuracy, long timestamp) throws Throwable {
        ...
        @Override // android.hardware.SystemSensorManager.BaseEventQueue
        protected int dispatchSensorEvent(int handle, float[] values, int inAccuracy, long timestamp, int cmdArgs) throws Throwable {
            Sensor sensor = (Sensor) this.mManager.mHandleToSensor.get(Integer.valueOf(handle));
            if (sensor == null) {
                return -1;
            }
    ...
    @Override // android.hardware.SensorManager
    public void sensorServiceCommonInterface(String funcName, int flag, int state) {
