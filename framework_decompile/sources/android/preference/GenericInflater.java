...
abstract class GenericInflater<T, P extends Parent> {
    ...
    public T inflate(int resource, P root, boolean attachToRoot) throws Resources.NotFoundException {
    ...
    public final T createItem(String name, String prefix, AttributeSet attrs) throws InflateException, NoSuchMethodException, ClassNotFoundException, SecurityException {
        HashMap map = sConstructorMap;
        Constructor constructor = (Constructor) map.get(name);
        if (constructor == null) {
            try {
