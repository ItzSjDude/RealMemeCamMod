...
public abstract class PreferenceActivity extends ListActivity implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceFragment.OnPreferenceStartFragmentCallback {
    ...
    private Handler mHandler = new Handler() { // from class: android.preference.PreferenceActivity.1
        ...
        public void handleMessage(Message msg) throws Resources.NotFoundException, ClassNotFoundException {
    ...
    @Override // android.app.Activity
    protected void onCreate(Bundle savedInstanceState) throws Resources.NotFoundException, ClassNotFoundException {
        Header header;
    ...
    public boolean onIsMultiPane() throws Resources.NotFoundException {
    ...
    */
    public void loadHeadersFromResource(int r20, java.util.List<android.preference.PreferenceActivity.Header> r21) throws org.xmlpull.v1.XmlPullParserException {
        /*
    ...
    @Override // android.app.ListActivity, android.app.Activity
    protected void onRestoreInstanceState(Bundle state) throws Resources.NotFoundException {
        Header header;
        Bundle container;
        PreferenceScreen preferenceScreen;
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) throws Resources.NotFoundException, ClassNotFoundException {
        if (!isResumed()) {
            return;
        }
    ...
    public void onHeaderClick(Header header, int position) throws Resources.NotFoundException, ClassNotFoundException {
    ...
    public void showBreadCrumbs(CharSequence title, CharSequence shortTitle) throws Resources.NotFoundException {
    ...
    public void setParentTitle(CharSequence title, CharSequence shortTitle, View.OnClickListener listener) throws Resources.NotFoundException {
    ...
    private void switchToHeaderInner(String fragmentName, Bundle args) throws ClassNotFoundException {
        int i;
    ...
    public void switchToHeader(String fragmentName, Bundle args) throws Resources.NotFoundException, ClassNotFoundException {
    ...
    public void startPreferencePanel(String fragmentClass, Bundle args, int titleRes, CharSequence titleText, Fragment resultTo, int resultRequestCode) throws ClassNotFoundException {
    ...
    public void finishPreferencePanel(Fragment caller, int resultCode, Intent resultData) throws Resources.NotFoundException {
        onBackPressed();
    ...
    public boolean onPreferenceStartFragment(PreferenceFragment caller, Preference pref) throws ClassNotFoundException {
