...
public class PreferenceGroupAdapter extends BaseAdapter implements Preference.OnPreferenceChangeInternalListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) throws Resources.NotFoundException {
        ...
        PreferenceLayout preferenceLayoutCreatePreferenceLayout = createPreferenceLayout(preference, this.mTempPreferenceLayout);
        this.mTempPreferenceLayout = preferenceLayoutCreatePreferenceLayout;
        if (Collections.binarySearch(this.mPreferenceLayouts, preferenceLayoutCreatePreferenceLayout) < 0 || getItemViewType(position) == getHighlightItemViewType()) {
            convertView = null;
        }
    ...
    public int getItemViewType(int position) {
        ...
        PreferenceLayout preferenceLayoutCreatePreferenceLayout = createPreferenceLayout(preference, this.mTempPreferenceLayout);
        this.mTempPreferenceLayout = preferenceLayoutCreatePreferenceLayout;
        int viewType = Collections.binarySearch(this.mPreferenceLayouts, preferenceLayoutCreatePreferenceLayout);
        if (viewType < 0) {
            return -1;
        }
        return viewType;
