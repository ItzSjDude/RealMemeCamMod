...
public class Preference implements Comparable<Preference> {
    ...
    public View getView(View convertView, ViewGroup parent) throws Resources.NotFoundException {
        if (convertView == null) {
    ...
    protected View onCreateView(ViewGroup parent) throws Resources.NotFoundException {
