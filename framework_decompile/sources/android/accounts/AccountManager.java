...
public class AccountManager {
    ...
    public AccountManager(Context context, IAccountManager service) {
        int i = 4;
        this.mAccountsForUserCache = new PropertyInvalidatedCache<UserIdPackage, Account[]>(i, CACHE_KEY_ACCOUNTS_DATA_PROPERTY) { // from class: android.accounts.AccountManager.1
