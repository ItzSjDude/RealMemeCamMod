...
public class Contacts {
    ...
    public static final class ContactMethods implements BaseColumns, ContactMethodsColumns, PeopleColumns {
        ...
        @Deprecated
        public static final CharSequence getDisplayLabel(Context context, int kind, int type, CharSequence label) throws Resources.NotFoundException {
            switch (kind) {
                case 1:
                    if (type != 0) {
    ...
    public static final class Organizations implements BaseColumns, OrganizationColumns {
        ...
        @Deprecated
        public static final CharSequence getDisplayLabel(Context context, int type, CharSequence label) throws Resources.NotFoundException {
            if (type != 0) {
