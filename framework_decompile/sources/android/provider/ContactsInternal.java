...
public class ContactsInternal {
    ...
    private static boolean maybeStartManagedQuickContact(Context context, Intent originalIntent) throws NumberFormatException, UnsupportedEncodingException {
        long id;
        long j;
        ...
        if (directoryIdStr == null) {
            ...
            j = Long.parseLong(directoryIdStr);
        }
        long directoryId = j;
