...
public final class DocumentsContract {
    ...
    public static Bitmap getDocumentThumbnail(ContentResolver content, Uri documentUri, Point size, CancellationSignal signal) throws Throwable {
        try {
    ...
    public static Uri createDocument(ContentResolver content, Uri parentDocumentUri, String mimeType, String displayName) throws Throwable {
        try {
    ...
    public static boolean isChildDocument(ContentResolver content, Uri parentDocumentUri, Uri childDocumentUri) throws Throwable {
    ...
    public static Uri renameDocument(ContentResolver content, Uri documentUri, String displayName) throws Throwable {
        try {
            Bundle in = new Bundle();
    ...
    public static boolean deleteDocument(ContentResolver content, Uri documentUri) throws Throwable {
        try {
            Bundle in = new Bundle();
            in.putParcelable("uri", documentUri);
    ...
    public static Uri copyDocument(ContentResolver content, Uri sourceDocumentUri, Uri targetParentDocumentUri) throws Throwable {
        try {
            Bundle in = new Bundle();
    ...
    public static Uri moveDocument(ContentResolver content, Uri sourceDocumentUri, Uri sourceParentDocumentUri, Uri targetParentDocumentUri) throws Throwable {
        try {
            Bundle in = new Bundle();
            in.putParcelable("uri", sourceDocumentUri);
    ...
    public static boolean removeDocument(ContentResolver content, Uri documentUri, Uri parentDocumentUri) throws Throwable {
        try {
            Bundle in = new Bundle();
            in.putParcelable("uri", documentUri);
    ...
    public static Bundle getDocumentMetadata(ContentResolver content, Uri documentUri) throws Throwable {
        Preconditions.checkNotNull(content, "content can not be null");
    ...
    public static Path findDocumentPath(ContentResolver content, Uri treeUri) throws Throwable {
        try {
            Bundle in = new Bundle();
    ...
    public static IntentSender createWebLinkIntent(ContentResolver content, Uri uri, Bundle options) throws Throwable {
        try {
            Bundle in = new Bundle();
    ...
    private static void rethrowIfNecessary(Exception e) throws Throwable {
