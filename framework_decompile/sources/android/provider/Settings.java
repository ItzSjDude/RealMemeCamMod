...
public final class Settings {
    ...
    static class NameValueCache {
        ...
        private <T extends NameValueTable> NameValueCache(Uri uri, String getCommand, String setCommand, String deleteCommand, String listCommand, String setAllCommand, ContentProviderHolder providerHolder, Class<T> callerClass) throws IllegalAccessException, IllegalArgumentException {
        ...
        public String getStringForUser(ContentResolver cr, String name, int userHandle) throws Throwable {
                ...
                synchronized (this) {
                    ...
                    if (generationTracker != null) {
                        try {
                            ...
                            Log.d(Settings.TAG, "Setting: getStringForUser FD closed by unknown reason, " + e.getMessage());
            ...
            if (this.mCallGetCommand != null) {
                ...
                synchronized (this) {
                    try {
                        if (isSelf && this.mGenerationTracker == null) {
                            if (args == null) {
                                args = new Bundle();
                            }
            ...
            try {
                ...
                String value2 = c.moveToNext() ? c.getString(0) : null;
                synchronized (this) {
        ...
        /* renamed from: lambda$getStringForUser$0$android-provider-Settings$NameValueCache, reason: not valid java name */
        /* synthetic */ void m3440xf1f1dc4d() {
            synchronized (this) {
        ...
        /* JADX WARN: Removed duplicated region for block: B:80:0x0154 A[Catch: RemoteException -> 0x01f8, TryCatch #7 {RemoteException -> 0x01f8, blocks: (B:45:0x00c6, B:46:0x00d2, B:56:0x00ea, B:58:0x00f2, B:60:0x00f8, B:62:0x0102, B:67:0x0120, B:80:0x0154, B:82:0x0164, B:83:0x016c, B:85:0x0172, B:72:0x012b, B:73:0x012f, B:77:0x0138), top: B:145:0x00c6 }] */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct add '--show-bad-code' argument
        */
        public android.util.ArrayMap<java.lang.String, java.lang.String> getStringsForPrefix(android.content.ContentResolver r21, java.lang.String r22, java.util.List<java.lang.String> r23) throws java.lang.Throwable {
            /*
        ...
        /* renamed from: lambda$getStringsForPrefix$1$android-provider-Settings$NameValueCache, reason: not valid java name */
        /* synthetic */ void m3441xa3977f64() {
            synchronized (this) {
                Log.e(Settings.TAG, "Error accessing generation tracker - removing");
                GenerationTracker generationTracker = this.mGenerationTracker;
                if (generationTracker != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static <T extends NameValueTable> void getPublicSettingsForClass(Class<T> callerClass, Set<String> allKeys, Set<String> readableKeys, ArrayMap<String, Integer> keysWithMaxTargetSdk) throws IllegalAccessException, IllegalArgumentException {
    ...
    public static final class System extends NameValueTable {
        ...
        static {
            ...
            ((ISettingsExt) ExtLoader.type(ISettingsExt.class).create()).addKeyToPublicSettings(arraySet);
        ...
        public static void getPublicSettings(Set<String> allKeys, Set<String> readableKeys, ArrayMap<String, Integer> readableKeysWithMaxTargetSdk) throws IllegalAccessException, IllegalArgumentException {
            Settings.getPublicSettingsForClass(System.class, allKeys, readableKeys, readableKeysWithMaxTargetSdk);
        }

        public static String getString(ContentResolver resolver, String name) {
            if (SCREEN_BRIGHTNESS.equals(name) && resolver != null && resolver.getPackageName() != null && resolver.getPackageName().contains("testdpc")) {
                String v = getStringForUser(resolver, name, resolver.getUserId());
                int result = ((ISettingsExt) ExtLoader.type(ISettingsExt.class).create()).getAutoBrightnessValueForUser(resolver, name, v);
        ...
        public static int getIntForUser(ContentResolver cr, String name, int def, int userHandle) {
            ...
            int result = ((ISettingsExt) ExtLoader.type(ISettingsExt.class).create()).getAutoBrightnessValueForUserWithDef(name, v, def);
            return result != Integer.MIN_VALUE ? result : Settings.parseIntSettingWithDefault(v, def);
        }
        ...
        public static int getIntForUser(ContentResolver cr, String name, int userHandle) throws SettingNotFoundException {
            String v = getStringForUser(cr, name, userHandle);
            int result = ((ISettingsExt) ExtLoader.type(ISettingsExt.class).create()).getAutoBrightnessValueForUser(cr, name, v);
            return result != Integer.MIN_VALUE ? result : Settings.parseIntSetting(v, name);
        }
        ...
        public static boolean putIntForUser(ContentResolver cr, String name, int value, int userHandle) {
            return putStringForUser(cr, name, Integer.toString(((ISettingsExt) ExtLoader.type(ISettingsExt.class).create()).putAutoBrightnessValueForUser(cr, cr.getPackageName(), name, value)), userHandle);
        }
    ...
    public static final class Secure extends NameValueTable {
        ...
        public static final String SCREENSAVER_ENABLED_COMPLICATIONS = "screensaver_enabled_complications";
        ...
        public static String getStringForUser(ContentResolver resolver, String name, int userHandle) {
            int userHandle2 = ((ISettingsExt) ExtLoader.type(ISettingsExt.class).create()).redirectUserIfNeeded(userHandle, name);
    ...
    public static final class Config extends NameValueTable {
        ...
        static {
            ...
            sProviderHolder = contentProviderHolder;
            sNameValueCache = new NameValueCache(DeviceConfig.CONTENT_URI, Settings.CALL_METHOD_GET_CONFIG, Settings.CALL_METHOD_PUT_CONFIG, Settings.CALL_METHOD_DELETE_CONFIG, Settings.CALL_METHOD_LIST_CONFIG, Settings.CALL_METHOD_SET_ALL_CONFIG, contentProviderHolder, Config.class);
        }
        ...
        public static Map<String, String> getStrings(ContentResolver resolver, String namespace, List<String> names) throws Throwable {
        ...
        static boolean putString(ContentResolver resolver, String namespace, String name, String value, boolean makeDefault) {
        ...
        static boolean deleteString(ContentResolver resolver, String namespace, String name) {
            return sNameValueCache.deleteStringForUser(resolver, createCompositeName(namespace, name), resolver.getUserId());
        }

        static void resetToDefaults(ContentResolver resolver, int resetMode, String namespace) {
            try {
                Bundle arg = new Bundle();
        ...
        static void setSyncDisabledMode(ContentResolver resolver, int disableSyncMode) {
            try {
                Bundle args = new Bundle();
                ...
                Log.w(Settings.TAG, "Can't set sync disabled mode " + DeviceConfig.CONTENT_URI, e);
            }
        }

        static int getSyncDisabledMode(ContentResolver resolver) {
            try {
                ...
                Log.w(Settings.TAG, "Can't query sync disabled mode " + DeviceConfig.CONTENT_URI, e);
                return -1;
            }
        }
    ...
    public static final class Bookmarks implements BaseColumns {
        ...
        public static Intent getIntentForShortcut(ContentResolver cr, char shortcut) throws URISyntaxException {
            Intent intent = null;
