...
public class ImeOnBackInvokedDispatcher implements OnBackInvokedDispatcher, Parcelable {
    ...
    public void registerOnBackInvokedCallback(int priority, OnBackInvokedCallback callback) {
        ...
        IOnBackInvokedCallback iCallback = new WindowOnBackInvokedDispatcher.OnBackInvokedCallbackWrapper(callback);
    ...
    public void receive(int resultCode, Bundle resultData, OnBackInvokedDispatcher receivingDispatcher) {
    ...
    private void registerReceivedCallback(IOnBackInvokedCallback iCallback, int priority, int callbackId, OnBackInvokedDispatcher receivingDispatcher) {
    ...
    public void switchRootView(ViewRootImpl previous, ViewRootImpl current) {
        ...
        while (it.hasNext()) {
            ...
            if (current != null) {
                current.getOnBackInvokedDispatcher().registerOnBackInvokedCallback(imeCallback.mPriority, imeCallback);
            }
        }
    }
}
