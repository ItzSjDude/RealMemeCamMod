...
public final class SplashScreenView extends FrameLayout {
    ...
    public static class Builder {
                ...
                if (consumer != null) {
                    consumer.accept(new Runnable() { // from class: android.window.SplashScreenView$Builder$$ExternalSyntheticLambda0
                        ...
                        public final void run() {
                            this.f$0.m6410lambda$build$0$androidwindowSplashScreenView$Builder(view);
                        }
                    });
                } else {
        ...
        /* renamed from: lambda$build$0$android-window-SplashScreenView$Builder, reason: not valid java name */
        /* synthetic */ void m6410lambda$build$0$androidwindowSplashScreenView$Builder(SplashScreenView view) {
            view.mIconView = createSurfaceView(view);
        }
