                ...
                default:
                    switch (code) {
                        ...
                        case 3:
                            ...
                            WindowContainerTransaction _arg2 = (WindowContainerTransaction) data.readTypedObject(WindowContainerTransaction.CREATOR);
                            data.enforceNoDataAvail();
                            IBinder _result2 = startTransition(_arg03, _arg12, _arg2);
                            reply.writeNoException();
                            reply.writeStrongBinder(_result2);
                            return true;
                        case 4:
                            int _arg04 = data.readInt();
                            RemoteAnimationAdapter _arg13 = (RemoteAnimationAdapter) data.readTypedObject(RemoteAnimationAdapter.CREATOR);
                            ...
                            data.enforceNoDataAvail();
                            int _result3 = startLegacyTransition(_arg04, _arg13, _arg22, _arg3);
                            reply.writeNoException();
                            reply.writeInt(_result3);
                            return true;
                        case 5:
                            IBinder _arg05 = data.readStrongBinder();
                            WindowContainerTransaction _arg14 = (WindowContainerTransaction) data.readTypedObject(WindowContainerTransaction.CREATOR);
                            IWindowContainerTransactionCallback _arg23 = IWindowContainerTransactionCallback.Stub.asInterface(data.readStrongBinder());
                            data.enforceNoDataAvail();
                            int _result4 = finishTransition(_arg05, _arg14, _arg23);
                            reply.writeNoException();
                        ...
                        case 8:
                            ...
                            return true;
                        case 9:
                            ITransitionPlayer _arg06 = ITransitionPlayer.Stub.asInterface(data.readStrongBinder());
                            data.enforceNoDataAvail();
                            registerTransitionPlayer(_arg06);
                            reply.writeNoException();
                            return true;
                        case 10:
