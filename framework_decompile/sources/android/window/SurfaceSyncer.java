...
public class SurfaceSyncer {
    ...
    static /* synthetic */ void lambda$setupSync$0(Runnable onComplete, Handler handler, SurfaceControl.Transaction transaction) {
        transaction.apply();
        if (onComplete != null) {
    ...
    public int setupSync(final Consumer<SurfaceControl.Transaction> syncRequestComplete) {
        ...
        synchronized (this.mSyncSetLock) {
            ...
            SyncSet syncSet = new SyncSet(syncId, new Consumer() { // from class: android.window.SurfaceSyncer$$ExternalSyntheticLambda1
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    this.f$0.m6421lambda$setupSync$1$androidwindowSurfaceSyncer(syncId, syncRequestComplete, (SurfaceControl.Transaction) obj);
                }
            });
    ...
    /* synthetic */ void m6421lambda$setupSync$1$androidwindowSurfaceSyncer(int syncId, Consumer syncRequestComplete, SurfaceControl.Transaction transaction) {
        synchronized (this.mSyncSetLock) {
    ...
    static class SyncSet {
        ...
        static /* synthetic */ void lambda$updateCallback$0(Consumer oldCallback, Consumer transactionConsumer, SurfaceControl.Transaction transaction) {
        ...
        public void merge(final SyncSet otherSyncSet) {
            ...
            otherSyncSet.updateCallback(new Consumer() { // from class: android.window.SurfaceSyncer$SyncSet$$ExternalSyntheticLambda0
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    this.f$0.m6427lambda$merge$1$androidwindowSurfaceSyncer$SyncSet(otherSyncSet, (SurfaceControl.Transaction) obj);
                }
            });
        }

        /* renamed from: lambda$merge$1$android-window-SurfaceSyncer$SyncSet, reason: not valid java name */
        /* synthetic */ void m6427lambda$merge$1$androidwindowSurfaceSyncer$SyncSet(SyncSet otherSyncSet, SurfaceControl.Transaction transaction) {
            synchronized (this.mLock) {
