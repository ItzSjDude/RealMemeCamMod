    ...
    public static final class Builder {
        ...
        public Builder setHasImeSurface(boolean hasImeSurface) {
            if (ProtoLogGroup.WM_DEBUG_ADD_REMOVE.isLogToLogcat()) {
                StringBuilder sbAppend = new StringBuilder().append("setHasImeSurface mHasImeSurface:").append(hasImeSurface).append(" ");
                ComponentName componentName = this.mTopActivity;
                Slog.i(TaskSnapshot.TAG, sbAppend.append(componentName != null ? componentName.getPackageName() : null).toString());
            }
            this.mHasImeSurface = hasImeSurface;
            return this;
        }
