...
public class ProxyOnBackInvokedDispatcher implements OnBackInvokedDispatcher {
    ...
    public ProxyOnBackInvokedDispatcher(boolean applicationCallBackEnabled) {
        this.mChecker = new WindowOnBackInvokedDispatcher.Checker(applicationCallBackEnabled);
    }
        ...
        synchronized (this.mLock) {
            this.mCallbacks.removeIf(new Predicate() { // from class: android.window.ProxyOnBackInvokedDispatcher$$ExternalSyntheticLambda0
                ...
                public final boolean test(Object obj) {
                    return ((OnBackInvokedCallback) ((Pair) obj).first).equals(callback);
                }
            });
    ...
    public void setActualDispatcher(OnBackInvokedDispatcher actualDispatcher) {
        synchronized (this.mLock) {
            ...
            if (actualDispatcher instanceof ProxyOnBackInvokedDispatcher) {
                this.mActualDispatcher = ((ProxyOnBackInvokedDispatcher) actualDispatcher).mActualDispatcher;
            } else {
