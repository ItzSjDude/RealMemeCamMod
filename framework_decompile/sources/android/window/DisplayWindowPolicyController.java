...
public abstract class DisplayWindowPolicyController {
    ...
    public abstract boolean canActivityBeLaunched(ActivityInfo activityInfo, int i, int i2, boolean z);
    ...
    public final boolean isWindowingModeSupported(int windowingMode) {
        ...
        synchronized (this.mSupportedWindowingModes) {
            zContains = this.mSupportedWindowingModes.contains(Integer.valueOf(windowingMode));
        }
        return zContains;
    }
