        ...
        */
        boolean matches(android.window.TransitionInfo r8) {
            ...
            La:
                ...
                boolean r3 = r7.mMustBeIndependent
                if (r3 == 0) goto L21
                boolean r3 = android.window.TransitionInfo.isIndependent(r2, r8)
                if (r3 != 0) goto L21
                goto L7a
            L21:
                int r3 = r7.mOrder
            ...
            L3f:
                android.app.ActivityManager$RunningTaskInfo r3 = r2.getTaskInfo()
                boolean r3 = r7.matchesTopActivity(r3)
                if (r3 != 0) goto L4a
                goto L7a
            L4a:
                int[] r3 = r7.mModes
        ...
        public String toString() {
            ...
            out.append(NavigationBarInflaterView.SIZE_MOD_END).toString();
