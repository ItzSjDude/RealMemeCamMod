...
public class PropertyValuesHolder implements Cloneable {
    ...
    public void setObjectValues(Object... values) {
        ...
        KeyframeSet keyframeSetOfObject = KeyframeSet.ofObject(values);
    ...
    private Method getPropertyFunction(Class cls, String prefix, Class valueType) throws NoSuchMethodException, SecurityException {
        Class[] typeVariants;
    ...
    static class IntPropertyValuesHolder extends PropertyValuesHolder {
        ...
        @Override // android.animation.PropertyValuesHolder
        /* renamed from: clone */
        public IntPropertyValuesHolder mo99clone() {
            IntPropertyValuesHolder newPVH = (IntPropertyValuesHolder) super.mo99clone();
            newPVH.mIntKeyframes = (Keyframes.IntKeyframes) newPVH.mKeyframes;
            return newPVH;
        }

        @Override // android.animation.PropertyValuesHolder
        void setAnimatedValue(Object target) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        void setupSetter(Class targetClass) {
            ...
            synchronized (map) {
                HashMap<String, Long> propertyMap = map.get(targetClass);
                boolean wasInMap = false;
    ...
    static class FloatPropertyValuesHolder extends PropertyValuesHolder {
        ...
        public FloatPropertyValuesHolder mo99clone() {
            FloatPropertyValuesHolder newPVH = (FloatPropertyValuesHolder) super.mo99clone();
