...
public final class AnimatorSet extends Animator implements AnimationHandler.AnimationFrameCallback {
    ...
    @Override // android.animation.Animator
    /* renamed from: clone */
    public AnimatorSet mo54clone() {
        final AnimatorSet anim = (AnimatorSet) super.mo54clone();
        int nodeCount = this.mNodes.size();
        anim.mStarted = false;
    ...
    private static class Node implements Cloneable {
        ...
        public Node m60clone() {
            try {
                Node node = (Node) super.clone();
                node.mAnimation = this.mAnimation.mo54clone();
