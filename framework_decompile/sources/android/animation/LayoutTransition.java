...
public class LayoutTransition {
    ...
    public LayoutTransition() {
        ...
        if (defaultChangeIn == null) {
            ...
            ObjectAnimator objectAnimatorOfPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(null, pvhLeft, pvhTop, pvhRight, pvhBottom, pvhScrollX, pvhScrollY);
            ...
            ObjectAnimator objectAnimatorMo54clone = defaultChangeIn.mo54clone();
            defaultChangeOut = objectAnimatorMo54clone;
            objectAnimatorMo54clone.setStartDelay(this.mChangingDisappearingDelay);
            defaultChangeOut.setInterpolator(this.mChangingDisappearingInterpolator);
            ObjectAnimator objectAnimatorMo54clone2 = defaultChangeIn.mo54clone();
            defaultChange = objectAnimatorMo54clone2;
            objectAnimatorMo54clone2.setStartDelay(this.mChangingDelay);
    ...
    private void setupChangeAnimation(final ViewGroup parent, final int changeReason, Animator baseAnimator, final long duration, final View child) {
        ...
        final Animator anim = baseAnimator.mo54clone();
    ...
    private void runAppearingTransition(final ViewGroup parent, final View child) {
        ...
        Animator anim = animator.mo54clone();
        anim.setTarget(child);
