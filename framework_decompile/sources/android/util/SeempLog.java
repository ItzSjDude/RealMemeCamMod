...
public final class SeempLog {
    ...
    public static int seemp_println_native(int api, String msg) {
        return -1;
    }

    static {
        HashMap map = new HashMap(198);
        value_to_get_map = map;
        map.put(Settings.System.NOTIFICATION_SOUND, 170);
        map.put(Settings.System.DTMF_TONE_WHEN_DIALING, 132);
        map.put("lock_pattern_autolock", 138);
        map.put("wifi_max_dhcp_retry_count", 172);
        map.put("auto_time", 123);
        map.put(Settings.System.SETUP_WIZARD_HAS_RUN, 131);
        map.put("wifi_watchdog_background_check_timeout_ms", 192);
        map.put("location_providers_allowed", 137);
        map.put(Settings.System.ALARM_ALERT, 103);
        map.put(Settings.System.VIBRATE_ON, 158);
        map.put("usb_mass_storage_enabled", 157);
        map.put("wifi_watchdog_ping_delay_ms", 197);
        map.put(Settings.System.FONT_SCALE, 109);
        map.put("wifi_watchdog_ap_count", 189);
        map.put("always_finish_activities", 105);
        map.put(Settings.System.ACCELEROMETER_ROTATION, 96);
        map.put("wifi_watchdog_ping_timeout_ms", 198);
        map.put(Settings.System.VOLUME_NOTIFICATION, 163);
        map.put("airplane_mode_on", 101);
        map.put("wifi_watchdog_background_check_delay_ms", 190);
        map.put(Settings.System.WIFI_STATIC_IP, 185);
        map.put("bluetooth", 147);
        map.put(Settings.System.BLUETOOTH_DISCOVERABILITY_TIMEOUT, 128);
        map.put(Settings.System.VOLUME_RING, 164);
        map.put(Settings.System.MODE_RINGER_STREAMS_AFFECTED, 168);
        map.put(Settings.System.VOLUME_SYSTEM, 165);
        map.put(Settings.System.SCREEN_OFF_TIMEOUT, 114);
        map.put("wifi", 150);
        map.put("auto_time_zone", 124);
        map.put(Settings.System.TEXT_AUTO_CAPS, 153);
        map.put(Settings.System.WALLPAPER_ACTIVITY, 118);
        map.put("animator_duration_scale", 107);
        map.put("wifi_num_open_networks_kept", 176);
        map.put("lock_pattern_visible_pattern", 140);
        map.put(Settings.System.VOLUME_VOICE, 166);
        map.put("debug_app", 99);
        map.put("wifi_on", 177);
        map.put(Settings.System.TEXT_SHOW_PASSWORD, 156);
        map.put("wifi_networks_available_repeat_delay", 175);
        map.put("wifi_sleep_policy", 178);
        map.put(Settings.System.VOLUME_MUSIC, 162);
        map.put("parental_control_last_update", 145);
        map.put("device_provisioned", 130);
        map.put("http_proxy", 143);
        map.put("android_id", 7);
        map.put("wifi_watchdog_max_ap_checks", 194);
        map.put(Settings.System.END_BUTTON_BEHAVIOR, 133);
        map.put(Settings.System.NEXT_ALARM_FORMATTED, 104);
        map.put("cell", 148);
        map.put("parental_control_enabled", 144);
        map.put("bluetooth_on", 129);
        map.put("window_animation_scale", 108);
        map.put("wifi_watchdog_background_check_enabled", 191);
        map.put(Settings.System.BLUETOOTH_DISCOVERABILITY, 127);
        map.put(Settings.System.WIFI_STATIC_DNS1, 182);
        map.put(Settings.System.WIFI_STATIC_DNS2, 183);
        map.put(Settings.System.HAPTIC_FEEDBACK_ENABLED, 159);
        map.put(Settings.System.SHOW_WEB_SUGGESTIONS, 120);
        map.put("parental_control_redirect_url", 146);
        map.put(Settings.System.DATE_FORMAT, 125);
        map.put("nfc", 149);
        map.put("airplane_mode_radios", 102);
        map.put("lock_pattern_tactile_feedback_enabled", 139);
        map.put(Settings.System.TIME_12_24, 126);
        map.put("wifi_watchdog_initial_ignored_ping_count", 193);
        map.put(Settings.System.VOLUME_BLUETOOTH_SCO, 161);
        map.put(Settings.System.USER_ROTATION, 97);
        map.put(Settings.System.WIFI_STATIC_GATEWAY, 184);
        map.put("stay_on_while_plugged_in", 117);
        map.put(Settings.System.SOUND_EFFECTS_ENABLED, 167);
        map.put("wifi_watchdog_ping_count", 196);
        map.put("data_roaming", 142);
        map.put("settings_classname", 152);
        map.put("transition_animation_scale", 116);
        map.put("wait_for_debugger", 100);
        map.put("install_non_market_apps", 136);
        map.put("adb_enabled", 98);
        map.put(Settings.System.WIFI_USE_STATIC_IP, 187);
        map.put(Settings.System.DIM_SCREEN, 115);
        map.put(Settings.System.VOLUME_ALARM, 160);
        map.put("wifi_watchdog_on", 195);
        map.put(Settings.System.WIFI_STATIC_NETMASK, 186);
        map.put("network_preference", 141);
        map.put("show_processes", 119);
        map.put(Settings.System.TEXT_AUTO_REPLACE, 155);
        map.put("wifi_networks_available_notification_on", 174);
        map.put(Settings.System.APPEND_FOR_LAST_AUDIBLE, 171);
        map.put(Settings.System.SHOW_GTALK_SERVICE_STATUS, 121);
        map.put(Settings.System.SCREEN_BRIGHTNESS, 110);
        map.put("use_google_mail", 122);
        map.put(Settings.System.RINGTONE, 134);
        map.put("logging_id", 106);
        map.put("mode_ringer", 135);
        map.put(Settings.System.MUTE_STREAMS_AFFECTED, 169);
        map.put("wifi_watchdog_acceptable_packet_loss_percentage", 188);
        map.put(Settings.System.TEXT_AUTO_PUNCTUATE, 154);
        map.put("wifi_mobile_data_transition_wakelock_timeout_ms", 173);
        map.put(Settings.System.SCREEN_BRIGHTNESS_MODE, 111);
        HashMap map2 = new HashMap(198);
        value_to_put_map = map2;
        map2.put(Settings.System.NOTIFICATION_SOUND, 274);
        map2.put(Settings.System.DTMF_TONE_WHEN_DIALING, 236);
        map2.put("lock_pattern_autolock", 242);
        map2.put("wifi_max_dhcp_retry_count", 276);
        map2.put("auto_time", 227);
        map2.put(Settings.System.SETUP_WIZARD_HAS_RUN, 235);
        map2.put("wifi_watchdog_background_check_timeout_ms", 296);
        map2.put("location_providers_allowed", 241);
        map2.put(Settings.System.ALARM_ALERT, 206);
        map2.put(Settings.System.VIBRATE_ON, 262);
        map2.put("usb_mass_storage_enabled", 261);
        map2.put("wifi_watchdog_ping_delay_ms", 301);
        map2.put(Settings.System.FONT_SCALE, 213);
        map2.put("wifi_watchdog_ap_count", 293);
        map2.put("always_finish_activities", 208);
        map2.put(Settings.System.ACCELEROMETER_ROTATION, 199);
        map2.put("wifi_watchdog_ping_timeout_ms", 302);
        map2.put(Settings.System.VOLUME_NOTIFICATION, 267);
        map2.put("airplane_mode_on", 204);
        map2.put("wifi_watchdog_background_check_delay_ms", 294);
        map2.put(Settings.System.WIFI_STATIC_IP, 289);
        map2.put("bluetooth", 251);
        map2.put(Settings.System.BLUETOOTH_DISCOVERABILITY_TIMEOUT, 232);
        map2.put(Settings.System.VOLUME_RING, 268);
        map2.put(Settings.System.MODE_RINGER_STREAMS_AFFECTED, 272);
        map2.put(Settings.System.VOLUME_SYSTEM, 269);
        map2.put(Settings.System.SCREEN_OFF_TIMEOUT, 218);
        map2.put("wifi", 254);
        map2.put("auto_time_zone", 228);
        map2.put(Settings.System.TEXT_AUTO_CAPS, 257);
        map2.put(Settings.System.WALLPAPER_ACTIVITY, 222);
        map2.put("animator_duration_scale", 211);
        map2.put("wifi_num_open_networks_kept", 280);
        map2.put("lock_pattern_visible_pattern", 244);
        map2.put(Settings.System.VOLUME_VOICE, 270);
        map2.put("debug_app", 202);
        map2.put("wifi_on", 281);
        map2.put(Settings.System.TEXT_SHOW_PASSWORD, 260);
        map2.put("wifi_networks_available_repeat_delay", 279);
        map2.put("wifi_sleep_policy", 282);
        map2.put(Settings.System.VOLUME_MUSIC, 266);
        map2.put("parental_control_last_update", 249);
        map2.put("device_provisioned", 234);
        map2.put("http_proxy", 247);
        map2.put("android_id", 209);
        map2.put("wifi_watchdog_max_ap_checks", 298);
        map2.put(Settings.System.END_BUTTON_BEHAVIOR, 237);
        map2.put(Settings.System.NEXT_ALARM_FORMATTED, 207);
        map2.put("cell", 252);
        map2.put("parental_control_enabled", 248);
        map2.put("bluetooth_on", 233);
        map2.put("window_animation_scale", 212);
        map2.put("wifi_watchdog_background_check_enabled", 295);
        map2.put(Settings.System.BLUETOOTH_DISCOVERABILITY, 231);
        map2.put(Settings.System.WIFI_STATIC_DNS1, 286);
        map2.put(Settings.System.WIFI_STATIC_DNS2, 287);
        map2.put(Settings.System.HAPTIC_FEEDBACK_ENABLED, 263);
        map2.put(Settings.System.SHOW_WEB_SUGGESTIONS, 224);
        map2.put("parental_control_redirect_url", 250);
        map2.put(Settings.System.DATE_FORMAT, 229);
        map2.put("nfc", 253);
        map2.put("airplane_mode_radios", 205);
        map2.put("lock_pattern_tactile_feedback_enabled", 243);
        map2.put(Settings.System.TIME_12_24, 230);
        map2.put("wifi_watchdog_initial_ignored_ping_count", 297);
        map2.put(Settings.System.VOLUME_BLUETOOTH_SCO, 265);
        map2.put(Settings.System.USER_ROTATION, 200);
        map2.put(Settings.System.WIFI_STATIC_GATEWAY, 288);
        map2.put("stay_on_while_plugged_in", 221);
        map2.put(Settings.System.SOUND_EFFECTS_ENABLED, 271);
        map2.put("wifi_watchdog_ping_count", 300);
        map2.put("data_roaming", 246);
        map2.put("settings_classname", 256);
        map2.put("transition_animation_scale", 220);
        map2.put("wait_for_debugger", 203);
        map2.put("install_non_market_apps", 240);
        map2.put("adb_enabled", 201);
        map2.put(Settings.System.WIFI_USE_STATIC_IP, 291);
        map2.put(Settings.System.DIM_SCREEN, 219);
        map2.put(Settings.System.VOLUME_ALARM, 264);
        map2.put("wifi_watchdog_on", 299);
        map2.put(Settings.System.WIFI_STATIC_NETMASK, 290);
        map2.put("network_preference", 245);
        map2.put("show_processes", 223);
        map2.put(Settings.System.TEXT_AUTO_REPLACE, 259);
        map2.put("wifi_networks_available_notification_on", 278);
        map2.put(Settings.System.APPEND_FOR_LAST_AUDIBLE, 275);
        map2.put(Settings.System.SHOW_GTALK_SERVICE_STATUS, 225);
        map2.put(Settings.System.SCREEN_BRIGHTNESS, 214);
        map2.put("use_google_mail", 226);
        map2.put(Settings.System.RINGTONE, 238);
        map2.put("logging_id", 210);
        map2.put("mode_ringer", 239);
        map2.put(Settings.System.MUTE_STREAMS_AFFECTED, 273);
        map2.put("wifi_watchdog_acceptable_packet_loss_percentage", 292);
        map2.put(Settings.System.TEXT_AUTO_PUNCTUATE, 258);
        map2.put("wifi_mobile_data_transition_wakelock_timeout_ms", 277);
        map2.put(Settings.System.SCREEN_BRIGHTNESS_MODE, 215);
    }
