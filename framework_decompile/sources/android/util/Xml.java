...
public class Xml {
    ...
    public static void parse(String xml, ContentHandler contentHandler) throws SAXException, IOException {
        try {
    ...
    public static TypedXmlPullParser resolvePullParser(InputStream in) throws IOException, ErrnoException {
    ...
    public static void copy(XmlPullParser in, XmlSerializer out) throws XmlPullParserException, IllegalStateException, IOException, IllegalArgumentException {
