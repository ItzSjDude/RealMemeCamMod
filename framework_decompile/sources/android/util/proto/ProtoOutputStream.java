...
public final class ProtoOutputStream extends ProtoStream {
    ...
    @Deprecated
    public void writeString(long fieldId, String val) throws UnsupportedEncodingException {
        assertNotCompacted();
        int id = checkFieldId(fieldId, 1138166333440L);
        writeStringImpl(id, val);
    }

    private void writeStringImpl(int id, String val) throws UnsupportedEncodingException {
    ...
    @Deprecated
    public void writeRepeatedString(long fieldId, String val) throws UnsupportedEncodingException {
        assertNotCompacted();
        int id = checkFieldId(fieldId, 2237677961216L);
        writeRepeatedStringImpl(id, val);
    }

    private void writeRepeatedStringImpl(int id, String val) throws UnsupportedEncodingException {
        if (val == null || val.length() == 0) {
    ...
    private void writeUtf8String(int id, String val) throws UnsupportedEncodingException {
        try {
    ...
    private long startObjectImpl(int id, boolean repeated) {
        ...
        long jMakeToken = makeToken(getTagSize(id), repeated, this.mDepth, this.mNextObjectId, sizePos);
