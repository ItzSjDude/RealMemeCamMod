...
public final class LauncherIcons {
    ...
    private ILauncherIconsExt mLauncherIconsExt = (ILauncherIconsExt) ExtLoader.type(ILauncherIconsExt.class).base(this).create();
    ...
    public Drawable getBadgedDrawable(Drawable base, Drawable badgeForeground, int backgroundColor) throws Resources.NotFoundException {
        Drawable[] drawables;
        ...
        Drawable oplusBadgeShadow = this.mLauncherIconsExt.getCorpIconBadgeShadow(overlayableRes);
        if (oplusBadgeShadow != null) {
            badgeShadow = oplusBadgeShadow;
        }
        Drawable badgeColor = overlayableRes.getDrawable(R.drawable.ic_corp_icon_badge_color).getConstantState().newDrawable().mutate();
        Drawable oplusBadgeColor = this.mLauncherIconsExt.getCorpIconBadgeColor(overlayableRes);
        if (oplusBadgeColor != null) {
            badgeColor = oplusBadgeColor;
        }
