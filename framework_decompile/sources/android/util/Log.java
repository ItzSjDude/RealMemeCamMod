...
public final class Log {
    ...
    static int wtf(int logId, String tag, String msg, Throwable tr, boolean localStack, boolean system2) {
    ...
    static void wtfQuiet(int logId, String tag, String msg, boolean system2) {
