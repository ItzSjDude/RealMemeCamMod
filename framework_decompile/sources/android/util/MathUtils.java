...
public final class MathUtils {
    ...
    */
    public static float max(int r1, int r2, int r3) {
        /*
            if (r1 <= r2) goto L6
            if (r1 <= r3) goto La
            r0 = r1
        ...
        Lb:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.util.MathUtils.max(int, int, int):float");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static float min(int r1, int r2, int r3) {
        /*
            if (r1 >= r2) goto L6
            if (r1 >= r3) goto La
            r0 = r1
        ...
        Lb:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.util.MathUtils.min(int, int, int):float");
    }
