...
class ReflectiveProperty<T, V> extends Property<T, V> {
    ...
    public ReflectiveProperty(Class<T> propertyHolder, Class<V> valueType, String name) throws NoSuchFieldException {
    ...
    public void set(T object, V value) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
