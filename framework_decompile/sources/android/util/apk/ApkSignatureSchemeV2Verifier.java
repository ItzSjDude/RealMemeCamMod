...
public class ApkSignatureSchemeV2Verifier {
    ...
    public static X509Certificate[][] verify(String apkFile) throws SignatureNotFoundException, IOException, SecurityException {
        VerifiedSigner vSigner = verify(apkFile, true);
        return vSigner.certs;
    }

    public static X509Certificate[][] unsafeGetCertsWithoutVerification(String apkFile) throws SignatureNotFoundException, IOException, SecurityException {
        VerifiedSigner vSigner = verify(apkFile, false);
        return vSigner.certs;
    }

    public static VerifiedSigner verify(String apkFile, boolean verifyIntegrity) throws SignatureNotFoundException, IOException, SecurityException {
        RandomAccessFile apk = new RandomAccessFile(apkFile, "r");
        try {
    ...
    private static VerifiedSigner verify(RandomAccessFile apk, SignatureInfo signatureInfo, boolean doVerifyIntegrity) throws SecurityException, IOException, CertificateException {
        int signerCount = 0;
    ...
    private static X509Certificate[] verifySigner(ByteBuffer signerBlock, Map<Integer, byte[]> contentDigests, CertificateFactory certFactory) throws InvalidKeySpecException, NoSuchAlgorithmException, SignatureException, IOException, InvalidKeyException, SecurityException, InvalidAlgorithmParameterException {
    ...
    private static void verifyAdditionalAttributes(ByteBuffer attrs) throws IOException, SecurityException {
