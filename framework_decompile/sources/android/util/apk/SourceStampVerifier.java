...
public abstract class SourceStampVerifier {
    ...
    public static SourceStampVerificationResult verify(String apkFile) {
        ...
        try {
            ...
            try {
                ...
                SourceStampVerificationResult sourceStampVerificationResultVerify = verify(apk, sourceStampCertificateDigest, manifestBytes);
                apk.close();
    ...
    private static X509Certificate verifySourceStampCertificate(ByteBuffer sourceStampBlockData, byte[] sourceStampCertificateDigest) throws NoSuchAlgorithmException, IOException, CertificateException {
        try {
    ...
    private static void verifySourceStampSignature(byte[] data, X509Certificate sourceStampCertificate, ByteBuffer signatures) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, IOException, InvalidAlgorithmParameterException {
    ...
    private static ApkSigningBlockUtils.VerifiedProofOfRotation verifySourceStampAttributes(ByteBuffer stampAttributeData, X509Certificate sourceStampCertificate) throws NoSuchAlgorithmException, SignatureException, IOException, InvalidKeyException, SecurityException, CertificateException, InvalidAlgorithmParameterException {
        try {
            CertificateFactory certFactory = CertificateFactory.getInstance("X.509");
    ...
    private static byte[] computeSha256Digest(byte[] input) throws NoSuchAlgorithmException {
        try {
