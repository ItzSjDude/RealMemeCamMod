...
public class ApkSignatureSchemeV4Verifier {
    ...
    public static VerifiedSigner verify(String apkFile, V4Signature.HashingInfo hashingInfo, V4Signature.SigningInfos signingInfos, int v3BlockId) throws SignatureNotFoundException, InvalidKeySpecException, NoSuchAlgorithmException, SignatureException, InvalidKeyException, SecurityException, CertificateException, InvalidAlgorithmParameterException {
    ...
    private static Pair<Certificate, byte[]> verifySigner(V4Signature.SigningInfo signingInfo, byte[] signedData) throws InvalidKeySpecException, NoSuchAlgorithmException, SignatureException, InvalidKeyException, SecurityException, CertificateException, InvalidAlgorithmParameterException {
