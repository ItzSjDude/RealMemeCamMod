...
class StrictJarVerifier {
    ...
    private void verifyCertificate(String certFile) throws NumberFormatException {
        byte[] manifestBytes;
    ...
    private boolean verify(Attributes attributes, String entry, byte[] data, int start, int end, boolean ignoreSecondEndline, boolean ignorable) throws NoSuchAlgorithmException {
        int i = 0;
        while (true) {
            String[] strArr = DIGEST_ALGORITHMS;
            if (i < strArr.length) {
