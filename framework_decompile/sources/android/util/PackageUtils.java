...
public final class PackageUtils {
    ...
    public static byte[] computeSha256DigestBytes(byte[] data) throws NoSuchAlgorithmException {
        try {
    ...
    public static String computeSha256Digest(byte[] data, String separator) throws NoSuchAlgorithmException {
    ...
    public static String computeSha256DigestForLargeFile(String filePath, byte[] fileBuffer, String separator) throws NoSuchAlgorithmException {
        try {
            MessageDigest messageDigest = MessageDigest.getInstance("SHA256");
            messageDigest.reset();
