...
public abstract class PermissionControllerService extends Service {
    ...
    class AnonymousClass1 extends IPermissionController.Stub {
            ...
            try {
                ...
                PermissionControllerService.this.onRevokeRuntimePermissions(request, doDryRun, reason, callerPackageName, new Consumer() { // from class: android.permission.PermissionControllerService$1$$ExternalSyntheticLambda9
                    ...
                    public final void accept(Object obj) {
                        PermissionControllerService.AnonymousClass1.lambda$revokeRuntimePermissions$1(callback, (Map) obj);
                    }
                });
        ...
        @Override // android.permission.IPermissionController
        public void getRuntimePermissionBackup(UserHandle user, ParcelFileDescriptor pipe) throws IOException {
        ...
        @Override // android.permission.IPermissionController
        public void stageAndApplyRuntimePermissionsBackup(UserHandle user, ParcelFileDescriptor pipe) throws IOException {
            Preconditions.checkNotNull(user);
            Preconditions.checkNotNull(pipe);
        ...
        @Override // android.permission.IPermissionController
        public void revokeRuntimePermission(String packageName, String permissionName) throws InterruptedException {
            Preconditions.checkNotNull(packageName, "packageName");
