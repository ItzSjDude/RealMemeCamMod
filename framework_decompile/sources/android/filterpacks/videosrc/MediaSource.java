...
public class MediaSource extends Filter {
    ...
    @Override // android.filterfw.core.Filter
    public void process(FilterContext context) throws IllegalStateException, InterruptedException {
        if (this.mLogVerbose) {
    ...
    @Override // android.filterfw.core.Filter
    public void close(FilterContext context) throws IllegalStateException {
    ...
    public void fieldPortValueUpdated(String name, FilterContext context) {
        ...
        if (name.equals(TextToSpeech.Engine.KEY_PARAM_VOLUME)) {
            if (isOpen()) {
