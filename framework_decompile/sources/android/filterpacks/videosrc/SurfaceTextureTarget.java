...
public class SurfaceTextureTarget extends Filter {
    ...
    public void prepare(FilterContext context) {
        ...
        ShaderProgram shaderProgramCreateIdentity = ShaderProgram.createIdentity(context);
    ...
    public synchronized void open(FilterContext context) {
        ...
        int iRegisterSurfaceTexture = context.getGLEnvironment().registerSurfaceTexture(this.mSurfaceTexture, this.mScreenWidth, this.mScreenHeight);
