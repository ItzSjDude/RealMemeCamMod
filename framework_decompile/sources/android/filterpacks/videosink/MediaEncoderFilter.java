...
public class MediaEncoderFilter extends Filter {
    ...
    @Override // android.filterfw.core.Filter
    public void open(FilterContext context) throws IllegalStateException, IllegalArgumentException {
        if (this.mLogVerbose) {
            Log.v(TAG, "Opening");
        }
        updateSourceRegion();
    ...
    private void startRecording(FilterContext context) throws IllegalStateException, IllegalArgumentException {
        int width;
        int height;
        if (this.mLogVerbose) {
    ...
    @Override // android.filterfw.core.Filter
    public void process(FilterContext context) throws IllegalStateException, IllegalArgumentException {
