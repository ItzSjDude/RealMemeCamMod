...
public class AutoFixFilter extends Filter {
    ...
    protected void prepare(FilterContext context) {
        ...
        Frame frameNewFrame = context.getFrameManager().newFrame(densityFormat);
        this.mDensityFrame = frameNewFrame;
        frameNewFrame.setInts(densityTable);
    }
    ...
    private void createHistogramFrame(FilterContext context, int width, int height, int[] data) {
        ...
        Frame frameNewFrame = context.getFrameManager().newFrame(shaderHistFormat);
        this.mHistFrame = frameNewFrame;
        frameNewFrame.setInts(histArray);
    }
}
