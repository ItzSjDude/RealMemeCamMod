...
public interface OtaPackageMetadata {
    ...
    public static final class DeviceState extends MessageNano {
        ...
        public String[] device;
        public String displayOsVersion;
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (!this.displayOsVersion.equals("")) {
                output.writeString(33, this.displayOsVersion);
            }
            super.writeTo(output);
        }
        ...
        protected int computeSerializedSize() {
            ...
            if (!this.buildType.equals("")) {
                size += CodedOutputByteBufferNano.computeStringSize(32, this.buildType);
            }
            if (!this.displayOsVersion.equals("")) {
                return size + CodedOutputByteBufferNano.computeStringSize(33, this.displayOsVersion);
            }
            return size;
        }
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 258:
                        ...
                        break;
                    case 266:
                        this.displayOsVersion = input.readString();
                        break;
                    default:
                        if (!WireFormatNano.parseUnknownField(input, tag)) {
                            return this;
