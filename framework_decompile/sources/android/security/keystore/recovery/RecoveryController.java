...
public class RecoveryController {
    ...
    public void initRecoveryService(String rootCertificateAlias, byte[] certificateFile, byte[] signatureFile) throws InternalRecoveryServiceException, CertificateException {
        try {
    ...
    Key getKeyFromGrant(String grantAlias) throws KeyPermanentlyInvalidatedException, UnrecoverableKeyException {
