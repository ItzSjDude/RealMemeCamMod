...
public class RecoverySession implements AutoCloseable {
    ...
    public byte[] start(String rootCertificateAlias, CertPath verifierCertPath, byte[] vaultParams, byte[] vaultChallenge, List<KeyChainProtectionParams> secrets) throws InternalRecoveryServiceException, CertificateException {
    ...
    public Map<String, Key> recoverKeyChainSnapshot(byte[] recoveryKeyBlob, List<WrappedApplicationKey> applicationKeys) throws SessionExpiredException, InternalRecoveryServiceException, DecryptionFailedException {
        try {
