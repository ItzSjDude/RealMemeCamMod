...
public class AndroidKeyStoreProvider extends Provider {
    ...
    @SystemApi
    public static KeyStore getKeyStoreForUid(int uid) throws NoSuchAlgorithmException, IOException, KeyStoreException, CertificateException, NoSuchProviderException {
