...
public class ConfirmationPrompt {
    ...
    public void presentPrompt(Executor executor, ConfirmationCallback callback) throws ConfirmationNotAvailableException, ConfirmationAlreadyPresentingException {
