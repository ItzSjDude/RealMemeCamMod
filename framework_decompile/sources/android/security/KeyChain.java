...
public final class KeyChain {
    ...
    public static AppUriAuthenticationPolicy getCredentialManagementAppPolicy(Context context) throws RemoteException, SecurityException {
    ...
    public static KeyPair getKeyPair(Context context, String alias) throws InterruptedException, KeyChainException {
        if (alias == null) {
    ...
    public static Collection<X509Certificate> toCertificates(byte[] bytes) throws CertificateException {
        if (bytes == null) {
            throw new IllegalArgumentException("bytes == null");
        }
        try {
    ...
    public static boolean hasWifiKeyGrantAsUser(Context context, UserHandle user, String alias) {
        try {
            try {
                KeyChainConnection keyChainConnection = bindAsUser(context.getApplicationContext(), user);
                try {
                    boolean zHasGrant = keyChainConnection.getService().hasGrant(1010, alias);
                    if (keyChainConnection != null) {
                        keyChainConnection.close();
                    }
                    return zHasGrant;
