...
public class AndroidKeyStoreProvider extends Provider {
    ...
    public static AndroidKeyStorePublicKey loadAndroidKeyStorePublicKeyFromKeystore(KeyStore2 keyStore, String privateKeyAlias, int namespace) throws KeyPermanentlyInvalidatedException, UnrecoverableKeyException {
    ...
    public static KeyPair loadAndroidKeyStoreKeyPairFromKeystore(KeyStore2 keyStore, KeyDescriptor descriptor) throws KeyPermanentlyInvalidatedException, UnrecoverableKeyException {
    ...
    public static AndroidKeyStorePrivateKey loadAndroidKeyStorePrivateKeyFromKeystore(KeyStore2 keyStore, String privateKeyAlias, int namespace) throws KeyPermanentlyInvalidatedException, UnrecoverableKeyException {
        AndroidKeyStoreKey key = loadAndroidKeyStoreKeyFromKeystore(keyStore, privateKeyAlias, namespace);
        if (key instanceof AndroidKeyStorePublicKey) {
    ...
    public static SecretKey loadAndroidKeyStoreSecretKeyFromKeystore(KeyStore2 keyStore, KeyDescriptor descriptor) throws KeyPermanentlyInvalidatedException, UnrecoverableKeyException {
        Key keyLoadAndroidKeyStoreKeyFromKeystore = loadAndroidKeyStoreKeyFromKeystore(keyStore, descriptor);
    ...
    public static AndroidKeyStoreKey loadAndroidKeyStoreKeyFromKeystore(KeyStore2 keyStore, String alias, int namespace) throws KeyPermanentlyInvalidatedException, UnrecoverableKeyException {
    ...
    private static AndroidKeyStoreKey loadAndroidKeyStoreKeyFromKeystore(KeyStore2 keyStore, KeyDescriptor descriptor) throws KeyPermanentlyInvalidatedException, UnrecoverableKeyException {
        try {
