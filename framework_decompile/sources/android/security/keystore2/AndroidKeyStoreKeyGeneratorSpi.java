...
public abstract class AndroidKeyStoreKeyGeneratorSpi extends KeyGeneratorSpi {
    ...
    protected SecretKey engineGenerateKey() throws InterruptedException {
        ...
        ArrayUtils.forEach(this.mKeymasterBlockModes, new Consumer() { // from class: android.security.keystore2.AndroidKeyStoreKeyGeneratorSpi$$ExternalSyntheticLambda1
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                this.f$0.m3501x9a5b20e7(params, (Integer) obj);
            }
        });
    ...
    /* renamed from: lambda$engineGenerateKey$1$android-security-keystore2-AndroidKeyStoreKeyGeneratorSpi, reason: not valid java name */
    /* synthetic */ void m3501x9a5b20e7(List params, Integer blockMode) {
