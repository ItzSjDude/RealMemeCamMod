...
abstract class AndroidKeyStoreCipherSpiBase extends CipherSpi implements KeyStoreCryptoOperation {
    ...
    @Override // javax.crypto.CipherSpi
    protected final void engineInit(int opmode, Key key, SecureRandom random) throws InvalidKeyException, InvalidAlgorithmParameterException {
        resetAll();
    ...
    @Override // javax.crypto.CipherSpi
    protected final void engineInit(int opmode, Key key, AlgorithmParameters params, SecureRandom random) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException {
        resetAll();
        if (!(key instanceof AndroidKeyStorePrivateKey) && ((key instanceof PrivateKey) || (key instanceof PublicKey))) {
            try {
    ...
    @Override // javax.crypto.CipherSpi
    protected final void engineInit(int opmode, Key key, AlgorithmParameterSpec params, SecureRandom random) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException {
        resetAll();
        if (!(key instanceof AndroidKeyStorePrivateKey) && ((key instanceof PrivateKey) || (key instanceof PublicKey))) {
            try {
                Cipher cipher = Cipher.getInstance(getTransform());
    ...
    @Override // javax.crypto.CipherSpi
    protected final byte[] engineWrap(Key key) throws IllegalBlockSizeException, NoSuchAlgorithmException, InvalidKeyException {
        Cipher cipher = this.mCipher;
        if (cipher != null) {
