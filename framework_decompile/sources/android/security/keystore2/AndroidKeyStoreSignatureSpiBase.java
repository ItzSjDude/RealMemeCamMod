...
abstract class AndroidKeyStoreSignatureSpiBase extends SignatureSpi implements KeyStoreCryptoOperation {
    ...
    private void ensureKeystoreOperationInitialized() throws InterruptedException, InvalidKeyException {
        ...
        try {
            KeyStoreOperation keyStoreOperationCreateOperation = this.mKey.getSecurityLevel().createOperation(this.mKey.getKeyIdDescriptor(), parameters);
    ...
    @Override // java.security.SignatureSpi
    protected final void engineUpdate(byte[] b, int off, int len) throws InterruptedException, SignatureException {
    ...
    @Override // java.security.SignatureSpi
    protected final void engineUpdate(ByteBuffer input) throws InterruptedException {
        byte[] b;
        int off;
