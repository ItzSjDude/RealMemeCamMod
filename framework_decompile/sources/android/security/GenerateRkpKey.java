...
public class GenerateRkpKey {
    ...
    private int bindAndSendCommand(int command, int securityLevel) throws InterruptedException, RemoteException {
    ...
    public void notifyKeyGenerated(int securityLevel) throws InterruptedException, RemoteException {
