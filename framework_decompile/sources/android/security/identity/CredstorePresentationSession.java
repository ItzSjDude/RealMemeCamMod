...
class CredstorePresentationSession extends PresentationSession {
    ...
    CredstorePresentationSession(Context context, int cipherSuite, CredstoreIdentityCredentialStore store, ISession binder) {
    ...
    @Override // android.security.identity.PresentationSession
    public CredentialDataResult getCredentialData(String credentialName, CredentialDataRequest request) throws InvalidReaderSignatureException, EphemeralPublicKeyNotFoundException, InvalidRequestMessageException, NoAuthenticationKeyAvailableException {
        try {
            ...
            if (credential == null) {
                ...
                credential = new CredstoreIdentityCredential(this.mContext, credentialName, this.mCipherSuite, credstoreCredential, this);
