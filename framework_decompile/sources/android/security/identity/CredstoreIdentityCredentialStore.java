...
class CredstoreIdentityCredentialStore extends IdentityCredentialStore {
    ...
    @Override // android.security.identity.IdentityCredentialStore
    public WritableIdentityCredential createCredential(String credentialName, String docType) throws InterruptedException, DocTypeNotSupportedException, AlreadyPersonalizedException {
        try {
            try {
    ...
    public IdentityCredential getCredentialByName(String credentialName, int cipherSuite) throws CipherSuiteNotSupportedException {
        try {
            ...
            return new CredstoreIdentityCredential(this.mContext, credentialName, cipherSuite, credstoreCredential, null);
        } catch (RemoteException e) {
            throw new RuntimeException("Unexpected RemoteException ", e);
        } catch (ServiceSpecificException e2) {
            if (e2.errorCode == 3) {
    ...
    @Override // android.security.identity.IdentityCredentialStore
    public byte[] deleteCredentialByName(String credentialName) throws RemoteException {
    ...
    public PresentationSession createPresentationSession(int cipherSuite) throws CipherSuiteNotSupportedException {
        try {
            ...
            return new CredstorePresentationSession(this.mContext, cipherSuite, this, credstoreSession);
        } catch (RemoteException e) {
            throw new RuntimeException("Unexpected RemoteException ", e);
        } catch (ServiceSpecificException e2) {
            if (e2.errorCode == 4) {
