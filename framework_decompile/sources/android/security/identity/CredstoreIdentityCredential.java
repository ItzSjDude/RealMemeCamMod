...
class CredstoreIdentityCredential extends IdentityCredential {
    ...
    CredstoreIdentityCredential(Context context, String credentialName, int cipherSuite, ICredential binder, CredstorePresentationSession session) {
    ...
    @Override // android.security.identity.IdentityCredential
    public void setReaderEphemeralPublicKey(PublicKey readerEphemeralPublicKey) throws IllegalStateException, NoSuchAlgorithmException, IOException, InvalidKeyException, KeyStoreException, CertificateException {
        try {
    ...
    @Override // android.security.identity.IdentityCredential
    public byte[] encryptMessageToReader(byte[] messagePlaintext) throws BadPaddingException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException {
        try {
    ...
    @Override // android.security.identity.IdentityCredential
    public byte[] decryptMessageFromReader(byte[] messageCiphertext) throws BadPaddingException, NoSuchPaddingException, MessageDecryptionException, IllegalBlockSizeException, NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException {
        ByteBuffer iv = ByteBuffer.allocate(12);
        iv.putInt(0, 0);
        iv.putInt(4, 0);
    ...
    @Override // android.security.identity.IdentityCredential
    public ResultData getEntries(byte[] requestMessage, Map<String, Collection<String>> entriesToRequest, byte[] sessionTranscript, byte[] readerSignature) throws InvalidReaderSignatureException, EphemeralPublicKeyNotFoundException, SessionTranscriptMismatchException, InvalidRequestMessageException, NoAuthenticationKeyAvailableException {
