...
public class AppWidgetHost {
    ...
    public void startListening() throws Resources.NotFoundException {
        int[] idsToUpdate;
        if (sService == null) {
            return;
        }
    ...
    public final AppWidgetHostView createView(Context context, int appWidgetId, AppWidgetProviderInfo appWidget) throws Resources.NotFoundException {
        if (sService == null) {
            return null;
        }
    ...
    protected void onProviderChanged(int appWidgetId, AppWidgetProviderInfo appWidget) throws Resources.NotFoundException {
        AppWidgetHostView v;
