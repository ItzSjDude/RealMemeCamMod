...
public class AppWidgetProviderInfo implements Parcelable {
    ...
    public AppWidgetProviderInfo m680clone() {
        AppWidgetProviderInfo that = new AppWidgetProviderInfo();
        ComponentName componentName = this.provider;
        that.provider = componentName == null ? null : componentName.m857clone();
        ...
        that.configure = componentName2 != null ? componentName2.m857clone() : null;
