...
public class AppWidgetHostView extends FrameLayout {
    ...
    public void setAppWidget(int appWidgetId, AppWidgetProviderInfo info) throws Resources.NotFoundException {
    ...
    void resetAppWidget(AppWidgetProviderInfo info) throws Resources.NotFoundException {
    ...
    private RemoteViews.InteractionHandler getHandler(final RemoteViews.InteractionHandler handler) {
        return new RemoteViews.InteractionHandler() { // from class: android.appwidget.AppWidgetHostView$$ExternalSyntheticLambda0
            ...
            public final boolean onInteraction(View view, PendingIntent pendingIntent, RemoteViews.RemoteResponse remoteResponse) {
                return this.f$0.m679lambda$getHandler$1$androidappwidgetAppWidgetHostView(handler, view, pendingIntent, remoteResponse);
            }
        };
    }

    /* renamed from: lambda$getHandler$1$android-appwidget-AppWidgetHostView, reason: not valid java name */
    /* synthetic */ boolean m679lambda$getHandler$1$androidappwidgetAppWidgetHostView(RemoteViews.InteractionHandler handler, View view, PendingIntent pendingIntent, RemoteViews.RemoteResponse response) {
    ...
    public void setColorResources(SparseIntArray colorMapping) {
        ...
        SparseIntArray sparseIntArrayM4856clone = colorMapping.m4856clone();
        this.mColorMapping = sparseIntArrayM4856clone;
        this.mColorResources = RemoteViews.ColorResources.create(this.mContext, sparseIntArrayM4856clone);
