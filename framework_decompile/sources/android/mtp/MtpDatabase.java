...
public class MtpDatabase implements AutoCloseable {
    ...
    public void addStorage(StorageVolume storage) {
        MtpStorage mtpStorage = this.mManager.addMtpStorage(storage, new Supplier() { // from class: android.mtp.MtpDatabase$$ExternalSyntheticLambda0
            ...
            public final Object get() {
                return this.f$0.m2862lambda$addStorage$0$androidmtpMtpDatabase();
            }
        });
    ...
    /* renamed from: lambda$addStorage$0$android-mtp-MtpDatabase, reason: not valid java name */
    /* synthetic */ Boolean m2862lambda$addStorage$0$androidmtpMtpDatabase() {
    ...
    private int renameFile(int handle, String newName) throws ErrnoException {
        MtpStorageManager.MtpObject obj = this.mManager.getObject(handle);
        if (obj == null) {
            return 8201;
        }
                ...
                try {
                    ...
                    if (exif.getThumbnailRange() != null) {
                        if (outLongs[0] == 0 || outLongs[1] == 0 || outLongs[2] == 0) {
                            Log.d(TAG, "getThumbnailInfo: check thumb info:" + thumbOffsetAndSize[0] + "," + thumbOffsetAndSize[1] + "," + outLongs[1] + "," + outLongs[2]);
                        }
                        return true;
                    }
                } catch (IOException e) {
