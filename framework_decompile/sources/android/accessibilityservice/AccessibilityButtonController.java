...
public final class AccessibilityButtonController {
    ...
    /* synthetic */ void m1xbbd1c80e(AccessibilityButtonCallback callback) {
            ...
            if (arrayMap != null && !arrayMap.isEmpty()) {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    handler.post(new Runnable() { // from class: android.accessibilityservice.AccessibilityButtonController$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m0x370b827b(callback, available);
                        }
                    });
                }
                return;
    ...
    /* synthetic */ void m0x370b827b(AccessibilityButtonCallback callback, boolean available) {
