...
public abstract class AccessibilityService extends Service {
    ...
    public static final class MagnificationController {
                        ...
                        if (handler != null) {
                            handler.post(new Runnable() { // from class: android.accessibilityservice.AccessibilityService$MagnificationController$$ExternalSyntheticLambda0
                                ...
                                public final void run() {
                                    this.f$0.m18x3af928da(listener, region, config);
                                }
                            });
                        } else {
        ...
        /* synthetic */ void m18x3af928da(OnMagnificationChangedListener listener, Region region, MagnificationConfig config) {
            listener.onMagnificationChanged(this, region, config);
        }
        ...
        try {
            connection.takeScreenshot(displayId, new RemoteCallback(new RemoteCallback.OnResultListener() { // from class: android.accessibilityservice.AccessibilityService$$ExternalSyntheticLambda2
                ...
                public final void onResult(Bundle bundle) {
                    this.f$0.m17xeab528e1(executor, callback, bundle);
                }
            }));
        } catch (RemoteException re) {
            throw new RuntimeException(re);
    ...
    /* synthetic */ void m17xeab528e1(Executor executor, TakeScreenshotCallback callback, Bundle result) {
    ...
    private static class AccessibilityContext extends ContextWrapper {
        ...
        private AccessibilityContext(Context base, int connectionId) throws RemoteException {
            super(base);
        ...
        private void setDefaultTokenInternal(Context context, int displayId) throws RemoteException {
