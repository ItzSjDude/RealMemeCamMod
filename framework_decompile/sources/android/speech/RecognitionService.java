        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 5:
                    ...
                    RecognitionService.this.dispatchCheckRecognitionSupport(intentAndListener.first, intentAndListener.second);
                    break;
                case 6:
    ...
    public void dispatchStartListening(Intent intent, IRecognitionListener listener, AttributionSource attributionSource) {
        try {
            if (this.mCurrentCallback == null) {
                boolean preflightPermissionCheckPassed = intent.hasExtra(RecognizerIntent.EXTRA_AUDIO_SOURCE) || checkPermissionForPreflightNotHardDenied(attributionSource);
    ...
    private static final class RecognitionServiceBinder extends IRecognitionService.Stub {
        ...
        public void startListening(Intent recognizerIntent, IRecognitionListener listener, AttributionSource attributionSource) {
            ...
            if (service != null) {
                ...
                handler.sendMessage(Message.obtain(handler2, 1, service.new StartListeningArgs(recognizerIntent, listener, attributionSource)));
            }
        }
