...
public class SpeechRecognizer {
    ...
    private synchronized boolean maybeInitializeManagerService() {
        ...
        IRecognitionServiceManager iRecognitionServiceManagerAsInterface = IRecognitionServiceManager.Stub.asInterface(ServiceManager.getService(Context.SPEECH_RECOGNITION_SERVICE));
    ...
    static class InternalSupportCallback extends IRecognitionSupportCallback.Stub {
        ...
        /* synthetic */ void m3951x55988d9e(RecognitionSupport recognitionSupport) {
        ...
        public void onError(final int errorCode) throws RemoteException {
            this.mExecutor.execute(new Runnable() { // from class: android.speech.SpeechRecognizer$InternalSupportCallback$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m3950x84580cdb(errorCode);
                }
            });
        }
    }
