...
public class TextToSpeech {
    ...
    public void dispatchOnInit(final int result) {
        Runnable onInitCommand = new Runnable() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.m3965lambda$dispatchOnInit$0$androidspeechttsTextToSpeech(result);
            }
        };
    ...
    /* renamed from: lambda$dispatchOnInit$0$android-speech-tts-TextToSpeech, reason: not valid java name */
    /* synthetic */ void m3965lambda$dispatchOnInit$0$androidspeechttsTextToSpeech(int result) {
        synchronized (this.mStartLock) {
            ...
            if (connection != null) {
                ...
                runActionNoReconnect(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda15
                    ...
                    public final Object run(ITextToSpeechService iTextToSpeechService) {
                        return this.f$0.m3972lambda$shutdown$1$androidspeechttsTextToSpeech(iTextToSpeechService);
                    }
                }, null, "shutdown", false);
            }
        }
    ...
    /* renamed from: lambda$shutdown$1$android-speech-tts-TextToSpeech, reason: not valid java name */
    /* synthetic */ Object m3972lambda$shutdown$1$androidspeechttsTextToSpeech(ITextToSpeechService service) throws RemoteException {
    ...
    public int speak(final CharSequence text, final int queueMode, final Bundle params, final String utteranceId) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda16
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return this.f$0.m3973lambda$speak$2$androidspeechttsTextToSpeech(text, queueMode, params, utteranceId, iTextToSpeechService);
            }
        }, -1, "speak")).intValue();
    }

    /* renamed from: lambda$speak$2$android-speech-tts-TextToSpeech, reason: not valid java name */
    /* synthetic */ Integer m3973lambda$speak$2$androidspeechttsTextToSpeech(CharSequence text, int queueMode, Bundle params, String utteranceId, ITextToSpeechService service) throws RemoteException {
    ...
    public int playEarcon(final String earcon, final int queueMode, final Bundle params, final String utteranceId) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda3
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return this.f$0.m3968lambda$playEarcon$3$androidspeechttsTextToSpeech(earcon, queueMode, params, utteranceId, iTextToSpeechService);
            }
        }, -1, "playEarcon")).intValue();
    }

    /* renamed from: lambda$playEarcon$3$android-speech-tts-TextToSpeech, reason: not valid java name */
    /* synthetic */ Integer m3968lambda$playEarcon$3$androidspeechttsTextToSpeech(String earcon, int queueMode, Bundle params, String utteranceId, ITextToSpeechService service) throws RemoteException {
    ...
    public int playSilentUtterance(final long durationInMs, final int queueMode, final String utteranceId) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda9
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return this.f$0.m3969lambda$playSilentUtterance$4$androidspeechttsTextToSpeech(durationInMs, queueMode, utteranceId, iTextToSpeechService);
            }
        }, -1, "playSilentUtterance")).intValue();
    }

    /* renamed from: lambda$playSilentUtterance$4$android-speech-tts-TextToSpeech, reason: not valid java name */
    /* synthetic */ Integer m3969lambda$playSilentUtterance$4$androidspeechttsTextToSpeech(long durationInMs, int queueMode, String utteranceId, ITextToSpeechService service) throws RemoteException {
    ...
    public int stop() {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda4
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return this.f$0.m3974lambda$stop$7$androidspeechttsTextToSpeech(iTextToSpeechService);
            }
        }, -1, "stop")).intValue();
    }

    /* renamed from: lambda$stop$7$android-speech-tts-TextToSpeech, reason: not valid java name */
    /* synthetic */ Integer m3974lambda$stop$7$androidspeechttsTextToSpeech(ITextToSpeechService service) throws RemoteException {
    ...
    public int setLanguage(final Locale loc) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda7
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return this.f$0.m3970lambda$setLanguage$9$androidspeechttsTextToSpeech(loc, iTextToSpeechService);
            }
        }, -2, "setLanguage")).intValue();
    }

    /* renamed from: lambda$setLanguage$9$android-speech-tts-TextToSpeech, reason: not valid java name */
    /* synthetic */ Integer m3970lambda$setLanguage$9$androidspeechttsTextToSpeech(Locale loc, ITextToSpeechService service) throws MissingResourceException, RemoteException {
        if (loc == null) {
            return -2;
        }
        try {
    ...
    public Locale getLanguage() {
        return (Locale) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda0
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return this.f$0.m3966lambda$getLanguage$10$androidspeechttsTextToSpeech(iTextToSpeechService);
            }
        }, null, "getLanguage");
    }

    /* renamed from: lambda$getLanguage$10$android-speech-tts-TextToSpeech, reason: not valid java name */
    /* synthetic */ Locale m3966lambda$getLanguage$10$androidspeechttsTextToSpeech(ITextToSpeechService service) throws RemoteException {
    ...
    public int setVoice(final Voice voice) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda8
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return this.f$0.m3971lambda$setVoice$13$androidspeechttsTextToSpeech(voice, iTextToSpeechService);
            }
        }, -2, "setVoice")).intValue();
    }

    /* renamed from: lambda$setVoice$13$android-speech-tts-TextToSpeech, reason: not valid java name */
    /* synthetic */ Integer m3971lambda$setVoice$13$androidspeechttsTextToSpeech(Voice voice, ITextToSpeechService service) throws MissingResourceException, RemoteException {
    ...
    public Voice getVoice() {
        return (Voice) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda10
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return this.f$0.m3967lambda$getVoice$14$androidspeechttsTextToSpeech(iTextToSpeechService);
            }
        }, null, "getVoice");
    }

    /* renamed from: lambda$getVoice$14$android-speech-tts-TextToSpeech, reason: not valid java name */
    /* synthetic */ Voice m3967lambda$getVoice$14$androidspeechttsTextToSpeech(ITextToSpeechService service) throws RemoteException {
    ...
    static /* synthetic */ Integer lambda$isLanguageAvailable$16(Locale loc, ITextToSpeechService service) throws MissingResourceException, RemoteException {
        try {
            String language = loc.getISO3Language();
            try {
                String country = loc.getISO3Country();
    ...
    public int synthesizeToFile(final CharSequence text, final Bundle params, final ParcelFileDescriptor fileDescriptor, final String utteranceId) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda5
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return this.f$0.m3975lambda$synthesizeToFile$17$androidspeechttsTextToSpeech(text, fileDescriptor, params, utteranceId, iTextToSpeechService);
            }
        }, -1, "synthesizeToFile")).intValue();
    }

    /* renamed from: lambda$synthesizeToFile$17$android-speech-tts-TextToSpeech, reason: not valid java name */
    /* synthetic */ Integer m3975lambda$synthesizeToFile$17$androidspeechttsTextToSpeech(CharSequence text, ParcelFileDescriptor fileDescriptor, Bundle params, String utteranceId, ITextToSpeechService service) throws RemoteException {
    ...
    private Bundle convertParamsHashMaptoBundle(HashMap<String, String> params) throws NumberFormatException {
    ...
    private void copyIntParam(Bundle bundle, HashMap<String, String> params, String key) throws NumberFormatException {
    ...
    private void copyFloatParam(Bundle bundle, HashMap<String, String> params, String key) throws NumberFormatException {
        String valueString = params.get(key);
        if (!TextUtils.isEmpty(valueString)) {
            try {
