...
class BlockingAudioTrack {
    ...
    public int write(byte[] data) throws IllegalStateException {
        AudioTrack track;
        synchronized (this.mAudioTrackLock) {
    ...
    private static int writeToAudioTrack(AudioTrack audioTrack, byte[] bytes) throws IllegalStateException {
        int written;
