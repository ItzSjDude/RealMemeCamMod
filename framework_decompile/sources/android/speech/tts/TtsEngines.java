...
public class TtsEngines {
    ...
    public String getHighestRankedEngineName() {
        ...
        if (engines.size() > 0 && engines.get(0).f5system) {
    ...
    private TextToSpeech.EngineInfo getEngineInfo(ResolveInfo resolve, PackageManager pm) {
        ...
        if (service != null) {
            ...
            engine.f5system = isSystemEngine(service);
            return engine;
        }
        return null;
    }
    ...
    private static class EngineInfoComparator implements Comparator<TextToSpeech.EngineInfo> {
        ...
        public int compare(TextToSpeech.EngineInfo lhs, TextToSpeech.EngineInfo rhs) {
            if (lhs.f5system && !rhs.f5system) {
                return -1;
            }
            if (rhs.f5system && !lhs.f5system) {
                return 1;
            }
    ...
    public Locale getLocalePrefForEngine(String engineName, String prefValue) throws MissingResourceException {
    ...
    public Locale parseLocaleString(String localeString) throws MissingResourceException {
        String country;
        String language = "";
        country = "";
        String variant = "";
