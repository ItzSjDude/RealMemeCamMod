...
public class Gains {
    ...
    public static class Gain {
        ...
        static Gain read(XmlPullParser parser) throws XmlPullParserException, DatatypeConfigurationException, NumberFormatException, IOException {
    ...
    static Gains read(XmlPullParser parser) throws XmlPullParserException, DatatypeConfigurationException, IOException, NumberFormatException {
        int type;
