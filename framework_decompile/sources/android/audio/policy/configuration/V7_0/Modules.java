...
public class Modules {
    ...
    public static class Module {
        ...
        static Module read(XmlPullParser parser) throws XmlPullParserException, DatatypeConfigurationException, IOException, NumberFormatException {
            int type;
    ...
    static Modules read(XmlPullParser parser) throws XmlPullParserException, DatatypeConfigurationException, IOException {
        int type;
