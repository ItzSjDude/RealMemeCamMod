...
public class MixPorts {
    ...
    public static class MixPort {
        ...
        static MixPort read(XmlPullParser parser) throws XmlPullParserException, DatatypeConfigurationException, NumberFormatException, IOException {
            int type;
    ...
    static MixPorts read(XmlPullParser parser) throws XmlPullParserException, DatatypeConfigurationException, IOException, NumberFormatException {
        int type;
