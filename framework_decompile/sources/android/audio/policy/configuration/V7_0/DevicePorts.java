...
public class DevicePorts {
    ...
    public static class DevicePort {
        ...
        static DevicePort read(XmlPullParser parser) throws XmlPullParserException, DatatypeConfigurationException, IOException, NumberFormatException {
            int type;
    ...
    static DevicePorts read(XmlPullParser parser) throws XmlPullParserException, DatatypeConfigurationException, IOException, NumberFormatException {
        int type;
