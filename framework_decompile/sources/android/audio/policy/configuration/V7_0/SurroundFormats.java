...
public class SurroundFormats {
    ...
    public static class Format {
        ...
        static Format read(XmlPullParser parser) throws XmlPullParserException, DatatypeConfigurationException, IOException {
    ...
    static SurroundFormats read(XmlPullParser parser) throws XmlPullParserException, DatatypeConfigurationException, IOException {
        int type;
