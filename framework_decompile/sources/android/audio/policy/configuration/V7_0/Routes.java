...
public class Routes {
    ...
    public static class Route {
        ...
        static Route read(XmlPullParser parser) throws XmlPullParserException, DatatypeConfigurationException, IOException {
    ...
    static Routes read(XmlPullParser parser) throws XmlPullParserException, DatatypeConfigurationException, IOException {
        int type;
