...
public class ComposeShader extends Shader {
    private ComposeShaderWrapper mComposeShaderWrapper;
    ...
    private ComposeShader(Shader shaderA, Shader shaderB, int nativeMode) {
        this.mComposeShaderWrapper = new ComposeShaderWrapper();
    ...
    public IComposeShaderWrapper getWrapper() {
        return this.mComposeShaderWrapper;
    }

    private class ComposeShaderWrapper implements IComposeShaderWrapper {
        private ComposeShaderWrapper() {
        }

        @Override // android.graphics.IComposeShaderWrapper
        public Shader getShaderA() {
            return ComposeShader.this.mShaderA;
        }

        @Override // android.graphics.IComposeShaderWrapper
        public Shader getShaderB() {
            return ComposeShader.this.mShaderB;
        }
    }
}
