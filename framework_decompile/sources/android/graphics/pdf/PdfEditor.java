...
public final class PdfEditor {
    ...
    public PdfEditor(ParcelFileDescriptor input) throws IOException, ErrnoException {
        ...
        try {
            ...
            synchronized (PdfRenderer.sPdfiumLock) {
                long jNativeOpen = nativeOpen(this.mInput.getFd(), size);
    ...
    public boolean getPageMediaBox(int pageIndex, Rect outMediaBox) {
        ...
        throwIfPageNotInDocument(pageIndex);
        synchronized (PdfRenderer.sPdfiumLock) {
            zNativeGetPageMediaBox = nativeGetPageMediaBox(this.mNativeDocument, pageIndex, outMediaBox);
        }
    ...
    public boolean getPageCropBox(int pageIndex, Rect outCropBox) {
        ...
        throwIfPageNotInDocument(pageIndex);
        synchronized (PdfRenderer.sPdfiumLock) {
            zNativeGetPageCropBox = nativeGetPageCropBox(this.mNativeDocument, pageIndex, outCropBox);
        }
