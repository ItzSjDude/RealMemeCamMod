...
public final class PdfRenderer implements AutoCloseable {
    ...
    public PdfRenderer(ParcelFileDescriptor input) throws IOException, ErrnoException {
        ...
        try {
            ...
            synchronized (sPdfiumLock) {
                long jNativeCreate = nativeCreate(this.mInput.getFd(), size);
                this.mNativeDocument = jNativeCreate;
                try {
                    this.mPageCount = nativeGetPageCount(jNativeCreate);
                } catch (Throwable t) {
    ...
    public final class Page implements AutoCloseable {
        ...
        public void render(Bitmap destination, Rect destClip, Matrix transform, int renderMode) throws Throwable {
            Matrix transform2;
