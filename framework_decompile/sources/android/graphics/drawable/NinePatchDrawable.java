...
public class NinePatchDrawable extends Drawable {
    ...
    private void updateStateFromTypedArray(TypedArray a) throws XmlPullParserException, Resources.NotFoundException, IOException {
            ...
            try {
                ...
                bitmap = ImageDecoder.decodeBitmap(source, new ImageDecoder.OnHeaderDecodedListener() { // from class: android.graphics.drawable.NinePatchDrawable$$ExternalSyntheticLambda0
                    ...
                    public final void onHeaderDecoded(ImageDecoder imageDecoder, ImageDecoder.ImageInfo imageInfo, ImageDecoder.Source source2) {
                        NinePatchDrawable.lambda$updateStateFromTypedArray$0(padding, imageDecoder, imageInfo, source2);
                    }
                });
                is.close();
            } catch (IOException e) {
