...
public class AnimatedImageDrawable extends Drawable implements Animatable2 {
    ...
    private void updateStateFromTypedArray(TypedArray a, int srcDensityOverride) throws XmlPullParserException, Resources.NotFoundException {
    ...
    private void postOnAnimationStart() {
        ...
        getHandler().post(new Runnable() { // from class: android.graphics.drawable.AnimatedImageDrawable$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m1195xec08e42e();
            }
        });
    }

    /* renamed from: lambda$postOnAnimationStart$1$android-graphics-drawable-AnimatedImageDrawable, reason: not valid java name */
    /* synthetic */ void m1195xec08e42e() {
    ...
    private void postOnAnimationEnd() {
        ...
        getHandler().post(new Runnable() { // from class: android.graphics.drawable.AnimatedImageDrawable$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m1194x2ae8f868();
            }
        });
    }

    /* renamed from: lambda$postOnAnimationEnd$2$android-graphics-drawable-AnimatedImageDrawable, reason: not valid java name */
    /* synthetic */ void m1194x2ae8f868() {
        Iterator<Animatable2.AnimationCallback> it = this.mAnimationCallbacks.iterator();
        while (it.hasNext()) {
            Animatable2.AnimationCallback callback = it.next();
