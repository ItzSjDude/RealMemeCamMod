...
public class LayerDrawable extends Drawable implements Drawable.Callback {
    ...
    LayerDrawable(LayerState state, Resources res) {
        ...
        LayerState layerStateCreateConstantState = createConstantState(state, res);
    ...
    public Drawable mutate() {
        if (!this.mMutated && super.mutate() == this) {
            ...
            this.mLayerState = layerStateCreateConstantState;
            ChildDrawable[] array = layerStateCreateConstantState.mChildren;
            int N = this.mLayerState.mNumChildren;
            for (int i = 0; i < N; i++) {
                Drawable dr = array[i].mDrawable;
                if (dr != null) {
    ...
    static class ChildDrawable {
        ...
        ChildDrawable(ChildDrawable orig, LayerDrawable owner, Resources res) {
            ...
            this.mId = orig.mId;
            int iResolveDensity = Drawable.resolveDensity(res, orig.mDensity);
