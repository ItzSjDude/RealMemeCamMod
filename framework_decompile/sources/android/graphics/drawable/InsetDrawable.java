...
public class InsetDrawable extends DrawableWrapper {
    ...
    static final class InsetState extends DrawableWrapper.DrawableWrapperState {
        ...
        InsetState(InsetState orig, Resources res) {
            super(orig, res);
            if (orig != null) {
                this.mInsetLeft = orig.mInsetLeft.m1237clone();
                this.mInsetTop = orig.mInsetTop.m1237clone();
                this.mInsetRight = orig.mInsetRight.m1237clone();
                this.mInsetBottom = orig.mInsetBottom.m1237clone();
