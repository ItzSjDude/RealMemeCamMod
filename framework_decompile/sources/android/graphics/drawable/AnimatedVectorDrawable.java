...
public class AnimatedVectorDrawable extends Drawable implements Animatable2 {
    ...
    @Override // android.graphics.drawable.Drawable
    public void inflate(Resources res, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, Resources.NotFoundException, IOException {
    ...
    private static class AnimatedVectorDrawableState extends Drawable.ConstantState {
        ...
        private Animator prepareLocalAnimator(int index) {
            ...
            Animator localAnimator = animator.mo54clone();
    ...
    private static class VectorDrawableAnimatorUI implements VectorDrawableAnimator {
        ...
        public void init(AnimatorSet set) {
            ...
            AnimatorSet animatorSetMo54clone = set.mo54clone();
            this.mSet = animatorSetMo54clone;
            long totalDuration = animatorSetMo54clone.getTotalDuration();
    ...
    public static class VectorDrawableAnimatorRT implements VectorDrawableAnimator, NativeVectorDrawableAnimator {
        ...
        VectorDrawableAnimatorRT(AnimatedVectorDrawable drawable) {
            this.mSetPtr = 0L;
            this.mDrawable = drawable;
            long jNCreateAnimatorSet = AnimatedVectorDrawable.nCreateAnimatorSet();
            this.mSetPtr = jNCreateAnimatorSet;
            this.mSetRefBasePtr = new VirtualRefBasePtr(jNCreateAnimatorSet);
        }
