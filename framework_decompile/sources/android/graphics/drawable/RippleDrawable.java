...
public class RippleDrawable extends LayerDrawable {
    ...
    private void startBackgroundAnimation() {
        ...
        this.mBackgroundAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: android.graphics.drawable.RippleDrawable$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m1258x4bcd3680(valueAnimator);
            }
        });
        this.mBackgroundAnimation.start();
    }

    /* renamed from: lambda$startBackgroundAnimation$0$android-graphics-drawable-RippleDrawable, reason: not valid java name */
    /* synthetic */ void m1258x4bcd3680(ValueAnimator update) {
        ...
        if (!addRipple || this.mRunningAnimations.size() > 10) {
            ...
            this.mRunningAnimations.add(new RippleAnimationSession(properties, !useCanvasProps).setOnAnimationUpdated(new Runnable() { // from class: android.graphics.drawable.RippleDrawable$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    this.f$0.m1256lambda$drawPatterned$1$androidgraphicsdrawableRippleDrawable();
                }
            }).setOnSessionEnd(new Consumer() { // from class: android.graphics.drawable.RippleDrawable$$ExternalSyntheticLambda2
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    this.f$0.m1257lambda$drawPatterned$2$androidgraphicsdrawableRippleDrawable((RippleAnimationSession) obj);
                }
    ...
    /* renamed from: lambda$drawPatterned$1$android-graphics-drawable-RippleDrawable, reason: not valid java name */
    /* synthetic */ void m1256lambda$drawPatterned$1$androidgraphicsdrawableRippleDrawable() {
        invalidateSelf(false);
    }

    /* renamed from: lambda$drawPatterned$2$android-graphics-drawable-RippleDrawable, reason: not valid java name */
    /* synthetic */ void m1257lambda$drawPatterned$2$androidgraphicsdrawableRippleDrawable(RippleAnimationSession session) {
    ...
    private void updateMaskShaderIfNeeded() {
        ...
        if (bitmap2 == null || bitmap2.getWidth() != bounds.width() || this.mMaskBuffer.getHeight() != bounds.height()) {
            ...
            Bitmap bitmapCreateBitmap = Bitmap.createBitmap(bounds.width(), bounds.height(), Bitmap.Config.ALPHA_8);
            this.mMaskBuffer = bitmapCreateBitmap;
            this.mMaskShader = new BitmapShader(bitmapCreateBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
