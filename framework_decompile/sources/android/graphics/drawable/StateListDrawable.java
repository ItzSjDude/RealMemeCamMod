...
public class StateListDrawable extends DrawableContainer {
    ...
    private IStateListDrawableExt mStateListDrawable;
    ...
    private StateListDrawable(StateListState state, Resources res) {
        this.mStateListDrawable = (IStateListDrawableExt) ExtLoader.type(IStateListDrawableExt.class).base(this).create();
