...
public class Paint {
    ...
    private IPaintWrapper mPaintWrapper;
    ...
    public Paint(int flags) {
        ...
        this.mPaintWrapper = new PaintWrapper();
    ...
    private void syncTextLocalesWithMinikin() {
        ...
        synchronized (sCacheLock) {
            ...
            Integer minikinLocaleListId = map.get(languageTags);
            if (minikinLocaleListId == null) {
                int newID = nSetTextLocales(this.mNativePaint, languageTags);
                map.put(languageTags, Integer.valueOf(newID));
            } else {
    ...
    public boolean setFontVariationSettings(String fontVariationSettings) throws NumberFormatException {
    ...
    public IPaintWrapper getWrapper() {
        return this.mPaintWrapper;
    }

    private class PaintWrapper implements IPaintWrapper {
        private static final String TAG = "PaintWrapper";

        private PaintWrapper() {
        }

        @Override // android.graphics.IPaintWrapper
        public String getFontVariationSettings() {
            return Paint.this.getFontVariationSettings();
        }

        @Override // android.graphics.IPaintWrapper
        public void setFontVariationSettings(String fontVariationSettings) {
            Paint.this.mFontVariationSettings = fontVariationSettings;
        }

        @Override // android.graphics.IPaintWrapper
        public Typeface getTypeface() {
            return Paint.this.getTypeface();
        }

        @Override // android.graphics.IPaintWrapper
        public void setTypeface(Typeface typeface) {
            Paint.this.mTypeface = typeface;
        }

        @Override // android.graphics.IPaintWrapper
        public void getSetTypeface(long paintStr, long typefaceStr) {
            Paint.nSetTypeface(paintStr, typefaceStr);
        }
    }
}
