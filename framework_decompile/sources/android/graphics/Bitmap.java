...
public final class Bitmap implements Parcelable {
    ...
    public boolean compress(CompressFormat format, int quality, OutputStream stream) {
        ...
        long osenseRequest = this.mBitmapExt.osenseSetSceneAction(5000, this.mWidth, this.mHeight);
        ...
        this.mBitmapExt.osenseClrSceneAction(osenseRequest, this.mWidth, this.mHeight);
        return result;
    }
