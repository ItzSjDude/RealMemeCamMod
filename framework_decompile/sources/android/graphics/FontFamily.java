...
public class FontFamily {
    ...
    public FontFamily(String[] langs, int variant) {
        ...
        long jNInitBuilder = nInitBuilder(langsString, variant);
        this.mBuilderPtr = jNInitBuilder;
        this.mNativeBuilderCleaner = sBuilderRegistry.registerNativeAllocation(this, jNInitBuilder);
    }
    ...
    public boolean addFont(String path, int ttcIndex, FontVariationAxis[] axes, int weight, int italic) throws IOException {
        if (this.mBuilderPtr == 0) {
        ...
        try {
            try {
                ...
                try {
                    ...
                    boolean zNAddFont = nAddFont(this.mBuilderPtr, fontBuffer, ttcIndex, weight, italic);
                    file.close();
                    return zNAddFont;
                } finally {
                }
