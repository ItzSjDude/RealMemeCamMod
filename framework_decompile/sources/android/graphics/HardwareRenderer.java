...
public class HardwareRenderer extends OplusBaseHardwareRenderer {
    ...
    public void setColorMode(int colorMode) {
        ...
        if (colorMode == 9) {
            Log.w(LOG_TAG, "set 10bit format surface, caller=" + Debug.getCallers(5));
        }
        if (colorMode == 10) {
            Log.w(LOG_TAG, "set 10bit format surface with wideColorGamut, caller=" + Debug.getCallers(5));
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    static class ProcessInitializer {
        ...
        enum Dataspace {
            ...
            static Optional<Dataspace> find(final ColorSpace colorSpace) {
                return Stream.of((Object[]) values()).filter(new Predicate() { // from class: android.graphics.HardwareRenderer$ProcessInitializer$Dataspace$$ExternalSyntheticLambda0
                    ...
                    public final boolean test(Object obj) {
                        return ColorSpace.get(((HardwareRenderer.ProcessInitializer.Dataspace) obj).mColorSpace).equals(colorSpace);
                    }
                }).findFirst();
            }
        }
