...
public class Typeface {
    ...
    private static boolean hasFontFamily(String familyName) {
        ...
        synchronized (SYSTEM_FONT_MAP_LOCK) {
            zContainsKey = sSystemFontMap.containsKey(familyName);
        }
        return zContainsKey;
    }
    ...
    public static final class Builder {
        ...
        public Typeface build() {
            ...
            try {
                ...
                int slant2 = slant;
                CustomFallbackBuilder builder2 = new CustomFallbackBuilder(family).setStyle(new FontStyle(weight, slant2));
    ...
    public static Typeface createWeightStyle(Typeface typeface, int i, boolean z) {
        ...
        synchronized (sWeightCacheLock) {
            ...
            typeface3.mTypefaceExt.setSystemTypeface(typeface.mTypefaceExt.isSystemTypeface());
            return typeface3;
        }
    }
    ...
    public static Typeface createFromAsset(AssetManager mgr, String path) throws IOException {
    ...
    public static Typeface getSystemDefaultTypeface(String familyName) {
        Typeface tf = sDefaultTypeface.mTypefaceExt.replaceSysSans(sSystemFontMap.get(familyName), familyName);
    ...
    public static void initSystemDefaultTypefaces(Map<String, android.graphics.fonts.FontFamily[]> fallbacks, List<FontConfig.Alias> aliases, Map<String, Typeface> outSystemFontMap) {
        ...
        for (Map.Entry<String, android.graphics.fonts.FontFamily[]> entry : fallbacks.entrySet()) {
            ...
            if (typeface == null || !typeface.mTypefaceExt.createTypefaceForCustom(outSystemFontMap, entry)) {
        ...
        Typeface typeface2 = sDefaultTypeface;
        if (typeface2 != null) {
            typeface2.mTypefaceExt.createIndividualTypefae();
        }
    }
    ...
    public static void setSystemFontMap(Map<String, Typeface> systemFontMap) {
        synchronized (SYSTEM_FONT_MAP_LOCK) {
            ...
            if (map.containsKey(DEFAULT_FAMILY)) {
                ...
                Log.d(TAG, "sans-serif doesn't exist in system font map");
                setDefault(createFromFile(new File("/system/fonts/Roboto-Regular.ttf")));
            }
