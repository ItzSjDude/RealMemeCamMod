...
public class BitmapShader extends Shader {
    ...
    Bitmap mBitmap;
    private IBitmapShaderWrapper mBitmapShaderWrapper;
    ...
    private BitmapShader(Bitmap bitmap, int tileX, int tileY) {
        this.mBitmapShaderWrapper = new BitmapShaderWrapper();
        if (bitmap == null) {
    ...
    public IBitmapShaderWrapper getWrapper() {
        return this.mBitmapShaderWrapper;
    }

    private class BitmapShaderWrapper implements IBitmapShaderWrapper {
        private BitmapShaderWrapper() {
        }

        @Override // android.graphics.IBitmapShaderWrapper
        public Bitmap getBitmap() {
            return BitmapShader.this.mBitmap;
        }
    }
}
