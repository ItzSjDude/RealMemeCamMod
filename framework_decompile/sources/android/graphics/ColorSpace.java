...
public abstract class ColorSpace {
    ...
    static {
        ...
        float[] fArr7 = null;
        colorSpaceArr[Named.SRGB.ordinal()] = new Rgb("sRGB IEC61966-2.1", fArr5, fArr4, fArr7, transferParameters, Named.SRGB.ordinal());
        ...
        colorSpaceArr[Named.BT709.ordinal()] = new Rgb("Rec. ITU-R BT.709-5", new float[]{0.64f, 0.33f, 0.3f, 0.6f, 0.15f, 0.06f}, fArr4, fArr7, new Rgb.TransferParameters(0.9099181073703367d, 0.09008189262966333d, 0.2222222222222222d, 0.081d, 2.2222222222222223d), Named.BT709.ordinal());
        sparseIntArray.put(281083904, Named.BT709.ordinal());
        colorSpaceArr[Named.BT2020.ordinal()] = new Rgb("Rec. ITU-R BT.2020-1", new float[]{0.708f, 0.292f, 0.17f, 0.797f, 0.131f, 0.046f}, fArr4, fArr7, new Rgb.TransferParameters(0.9096697898662786d, 0.09033021013372146d, 0.2222222222222222d, 0.08145d, 2.2222222222222223d), Named.BT2020.ordinal());
        ...
        colorSpaceArr[Named.DISPLAY_P3.ordinal()] = new Rgb("Display P3", new float[]{0.68f, 0.32f, 0.265f, 0.69f, 0.15f, 0.06f}, fArr4, fArr7, transferParameters, Named.DISPLAY_P3.ordinal());
        ...
        float[] fArr8 = null;
        colorSpaceArr[Named.SMPTE_C.ordinal()] = new Rgb("SMPTE-C RGB", new float[]{0.63f, 0.34f, 0.31f, 0.595f, 0.155f, 0.07f}, fArr4, fArr8, new Rgb.TransferParameters(0.9099181073703367d, 0.09008189262966333d, 0.2222222222222222d, 0.081d, 2.2222222222222223d), Named.SMPTE_C.ordinal());
        ...
        colorSpaceArr[Named.PRO_PHOTO_RGB.ordinal()] = new Rgb("ROMM RGB ISO 22028-2:2013", new float[]{0.7347f, 0.2653f, 0.1596f, 0.8404f, 0.0366f, 1.0E-4f}, fArr2, fArr8, new Rgb.TransferParameters(1.0d, 0.0d, 0.0625d, 0.031248d, 1.8d), Named.PRO_PHOTO_RGB.ordinal());
        double d = 1.0d;
        float f = -65504.0f;
        float f2 = 65504.0f;
    ...
    public static class Rgb extends ColorSpace {
        ...
        private Rgb(String name, float[] primaries, float[] whitePoint, float[] transform, final TransferParameters function, int id) {
            this(name, primaries, whitePoint, transform, (function.e == 0.0d && function.f == 0.0d) ? new DoubleUnaryOperator() { // from class: android.graphics.ColorSpace$Rgb$$ExternalSyntheticLambda1
                @Override // java.util.function.DoubleUnaryOperator
                public final double applyAsDouble(double d) {
                    ColorSpace.Rgb.TransferParameters transferParameters = function;
            ...
            } : new DoubleUnaryOperator() { // from class: android.graphics.ColorSpace$Rgb$$ExternalSyntheticLambda2
                @Override // java.util.function.DoubleUnaryOperator
                public final double applyAsDouble(double d) {
                    ColorSpace.Rgb.TransferParameters transferParameters = function;
            ...
            }, (function.e == 0.0d && function.f == 0.0d) ? new DoubleUnaryOperator() { // from class: android.graphics.ColorSpace$Rgb$$ExternalSyntheticLambda3
                @Override // java.util.function.DoubleUnaryOperator
                public final double applyAsDouble(double d) {
                    ColorSpace.Rgb.TransferParameters transferParameters = function;
            ...
            } : new DoubleUnaryOperator() { // from class: android.graphics.ColorSpace$Rgb$$ExternalSyntheticLambda4
                @Override // java.util.function.DoubleUnaryOperator
                public final double applyAsDouble(double d) {
                    ColorSpace.Rgb.TransferParameters transferParameters = function;
        ...
        private Rgb(String name, float[] primaries, float[] whitePoint, float[] transform, DoubleUnaryOperator oetf, DoubleUnaryOperator eotf, float min, float max, TransferParameters transferParameters, int id) {
            ...
            float[] fArrXyWhitePoint = xyWhitePoint(whitePoint);
            this.mWhitePoint = fArrXyWhitePoint;
            float[] fArrXyPrimaries = xyPrimaries(primaries);
            ...
            this.mIsWideGamut = isWideGamut(fArrXyPrimaries, min, max);
            this.mIsSrgb = isSrgb(fArrXyPrimaries, fArrXyWhitePoint, oetf, eotf, min, max, id);
            if (transferParameters == null) {
                this.mNativePtr = 0L;
                return;
            }
            if (fArrXyWhitePoint == null || (fArr = this.mTransform) == null) {
                throw new IllegalStateException("ColorSpace (" + this + ") cannot create native object! mWhitePoint: " + fArrXyWhitePoint + " mTransform: " + this.mTransform);
            }
            float[] nativeTransform = ColorSpace.adaptToIlluminantD50(fArrXyWhitePoint, fArr);
            long jNativeCreate = nativeCreate((float) transferParameters.a, (float) transferParameters.b, (float) transferParameters.c, (float) transferParameters.d, (float) transferParameters.e, (float) transferParameters.f, (float) transferParameters.g, nativeTransform);
