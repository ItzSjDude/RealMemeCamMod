...
public class Path {
    ...
    private IPathWrapper mPathWrapper;
    public Region rects;
    ...
    public Path() {
        ...
        this.mPathWrapper = new PathWrapper();
        long jNInit = nInit();
        this.mNativePath = jNInit;
        sRegistry.registerNativeAllocation(this, jNInit);
    }
    ...
    public void set(Path src) {
        ...
        if (region2 != null && src.rects == null) {
            region2.setEmpty();
    ...
    public IPathWrapper getWrapper() {
        return this.mPathWrapper;
    }

    private class PathWrapper implements IPathWrapper {
        private PathWrapper() {
        }

        @Override // android.graphics.IPathWrapper
        public IPathExt getPathExt() {
            return Path.this.mPathExt;
        }
    }
}
