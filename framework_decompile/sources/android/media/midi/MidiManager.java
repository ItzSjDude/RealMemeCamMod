...
public final class MidiManager {
    ...
    class DeviceListener extends IMidiDeviceListener.Stub {
                ...
                if (executor != null) {
                    executor.execute(new Runnable() { // from class: android.media.midi.MidiManager$DeviceListener$$ExternalSyntheticLambda0
                        ...
                        public final void run() {
                            this.f$0.m2598xfc6857dd(device);
                        }
                    });
                } else {
        ...
        /* renamed from: lambda$onDeviceAdded$0$android-media-midi-MidiManager$DeviceListener, reason: not valid java name */
        /* synthetic */ void m2598xfc6857dd(MidiDeviceInfo device) {
            this.mCallback.onDeviceAdded(device);
        }
            ...
            if (shouldInvokeCallback(device)) {
                ...
                if (executor != null) {
                    executor.execute(new Runnable() { // from class: android.media.midi.MidiManager$DeviceListener$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m2599x42eb39fe(device);
                        }
                    });
                } else {
        ...
        /* renamed from: lambda$onDeviceRemoved$1$android-media-midi-MidiManager$DeviceListener, reason: not valid java name */
        /* synthetic */ void m2599x42eb39fe(MidiDeviceInfo device) {
            this.mCallback.onDeviceRemoved(device);
        }
        ...
        public void onDeviceStatusChanged(final MidiDeviceStatus status) {
            ...
            if (executor != null) {
                executor.execute(new Runnable() { // from class: android.media.midi.MidiManager$DeviceListener$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2600xb231bfc1(status);
                    }
                });
            } else {
        ...
        /* renamed from: lambda$onDeviceStatusChanged$2$android-media-midi-MidiManager$DeviceListener, reason: not valid java name */
        /* synthetic */ void m2600xb231bfc1(MidiDeviceStatus status) {
            this.mCallback.onDeviceStatusChanged(status);
        }
