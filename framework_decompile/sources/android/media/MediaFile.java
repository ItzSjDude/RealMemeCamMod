...
public class MediaFile {
    ...
    private static void addFileType(int mtpFormatCode, String mimeType) {
        ...
        if (!map.containsKey(mimeType)) {
            map.put(mimeType, Integer.valueOf(mtpFormatCode));
        }
        HashMap<Integer, String> map2 = sFormatToMimeTypeMap;
        if (!map2.containsKey(Integer.valueOf(mtpFormatCode))) {
            map2.put(Integer.valueOf(mtpFormatCode), mimeType);
        }
    }
    ...
    */
    public static boolean isPlayListMimeType(java.lang.String r4) {
        /*
            ...
            r3 = 1
            switch(r1) {
                case -1165508903: goto L40;
                case -979095690: goto L36;
                case -622808459: goto L2c;
                case -432766831: goto L22;
                case 264230524: goto L18;
                case 1872259501: goto Le;
                default: goto Ld;
            }
        Ld:
            goto L4a
    ...
    public static int getFormatCodeForMimeType(String mimeType) {
        ...
        HashMap<String, Integer> map = sMimeTypeToFormatMap;
        Integer value = map.get(mimeType);
        if (value != null) {
            return value.intValue();
        }
        String mimeType2 = normalizeMimeType(mimeType);
        Integer value2 = map.get(mimeType2);
        if (value2 != null) {
