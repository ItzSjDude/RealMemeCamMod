...
public class AudioEffect {
    ...
    private AudioEffect(UUID type, UUID uuid, int priority, int audioSession, AudioDeviceAttributes device) throws RuntimeException {
        this(type, uuid, priority, audioSession, device, false);
    }

    private AudioEffect(UUID type, UUID uuid, int priority, int audioSession, AudioDeviceAttributes device, boolean probe) throws Throwable {
        int deviceType;
