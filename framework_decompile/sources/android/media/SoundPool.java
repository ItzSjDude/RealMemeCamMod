...
public class SoundPool extends PlayerBase {
    ...
    public SoundPool(int maxStreams, int streamType, int srcQuality) throws IllegalArgumentException {
    ...
    public int load(Context context, int resId, int priority) throws Resources.NotFoundException {
    ...
    public int load(AssetFileDescriptor afd, int priority) throws ErrnoException {
        if (afd != null) {
