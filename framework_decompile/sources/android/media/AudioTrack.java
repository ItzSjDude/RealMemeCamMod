...
public class AudioTrack extends PlayerBase implements AudioRouting, VolumeAutomation {
    ...
    private static final HashMap<String, Integer> CHANNEL_PAIR_MAP = new HashMap<String, Integer>() { // from class: android.media.AudioTrack.1
        {
            put("front", 12);
            put(NavigationBarInflaterView.BACK, 192);
            put("front of center", 768);
            put("side", Integer.valueOf(GLES30.GL_COLOR));
            put("top front", 81920);
            put("top back", 655360);
            put("top side", Integer.valueOf(IntentFilter.MATCH_CATEGORY_HOST));
            put("bottom front", 20971520);
            put("front wide", Integer.valueOf(android.media.audio.Enums.AUDIO_FORMAT_DTS_HD));
        }
    };
    ...
    AudioTrack(long nativeTrackInJavaObj) {
        ...
        this.mInitializationLooper = looperMyLooper == null ? Looper.getMainLooper() : looper;
    ...
    public void addOnCodecFormatChangedListener(Executor executor, final OnCodecFormatChangedListener listener) {
        this.mCodecFormatChangedListeners.add(listener, executor, new Utils.ListenerList.Listener() { // from class: android.media.AudioTrack$$ExternalSyntheticLambda0
            ...
            public final void onEvent(int i, Object obj) {
                this.f$0.m2219xd7bbccf6(listener, i, (AudioMetadataReadMap) obj);
            }
        });
    }

    /* renamed from: lambda$addOnCodecFormatChangedListener$0$android-media-AudioTrack, reason: not valid java name */
    /* synthetic */ void m2219xd7bbccf6(OnCodecFormatChangedListener listener, int eventCode, AudioMetadataReadMap readMap) {
    ...
    class StreamEventHandler extends Handler {
                        ...
                        switch (msg.what) {
                            ...
                            case 9:
                                cbi.mStreamEventExec.execute(new Runnable() { // from class: android.media.AudioTrack$StreamEventHandler$$ExternalSyntheticLambda0
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        this.f$0.m2220x992cc762(cbi, msg);
                                    }
                                });
                                break;
                        }
        ...
        /* renamed from: lambda$handleMessage$0$android-media-AudioTrack$StreamEventHandler, reason: not valid java name */
        /* synthetic */ void m2220x992cc762(StreamEventCbInfo cbi, Message msg) {
            cbi.mStreamEventCb.onDataRequest(AudioTrack.this, msg.arg1);
        }

        /* renamed from: lambda$handleMessage$1$android-media-AudioTrack$StreamEventHandler, reason: not valid java name */
        /* synthetic */ void m2221x33cd89e3(StreamEventCbInfo cbi) {
            cbi.mStreamEventCb.onTearDown(AudioTrack.this);
        }

        /* renamed from: lambda$handleMessage$2$android-media-AudioTrack$StreamEventHandler, reason: not valid java name */
        /* synthetic */ void m2222xce6e4c64(StreamEventCbInfo cbi) {
