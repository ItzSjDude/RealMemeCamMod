...
public class EffectFactory {
    ...
    public Effect createEffect(String effectName) throws ClassNotFoundException {
    ...
    private static Class getEffectClassByName(String className) throws ClassNotFoundException {
    ...
    private Effect instantiateEffect(Class effectClass, String name) throws NoSuchMethodException, SecurityException {
        try {
