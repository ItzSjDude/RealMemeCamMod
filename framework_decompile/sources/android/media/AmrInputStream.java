...
public final class AmrInputStream extends InputStream {
    ...
    public int read() throws MediaCodec.CryptoException, IOException {
    ...
    @Override // java.io.InputStream
    public int read(byte[] b, int offset, int length) throws MediaCodec.CryptoException, IOException {
        int length2;
        int index;
        if (this.mCodec == null) {
