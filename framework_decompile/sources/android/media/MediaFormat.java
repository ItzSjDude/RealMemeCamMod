            ...
            public KeyIterator() {
                this.mIterator = ((List) FilteredMappedKeySet.this.mKeys.stream().filter(new Predicate() { // from class: android.media.MediaFormat$FilteredMappedKeySet$KeyIterator$$ExternalSyntheticLambda0
                    ...
                    public final boolean test(Object obj) {
                        return this.f$0.m2320x5bfe93db((String) obj);
                    }
                }).collect(Collectors.toList())).iterator();
            }

            /* renamed from: lambda$new$0$android-media-MediaFormat$FilteredMappedKeySet$KeyIterator, reason: not valid java name */
            /* synthetic */ boolean m2320x5bfe93db(String k) {
