                        ...
                        while (it.hasNext()) {
                            ...
                            info.mExecutor.execute(new Runnable() { // from class: android.media.CallbackUtil$$ExternalSyntheticLambda0
                                ...
                                public final void run() {
                                    callback.callbackMethod(info.mListener);
                                }
                            });
                        }
                        if (ignored != null) {
    ...
    static class LazyListenerManager<T> {
        ...
        void addListener(Executor executor, T t, String str, Supplier<DispatcherStub> supplier) {
            synchronized (this.mListenerLock) {
                Pair pairAddListener = CallbackUtil.addListener(str, executor, t, this.mListeners, this.mDispatcherStub, supplier, new Consumer() { // from class: android.media.CallbackUtil$LazyListenerManager$$ExternalSyntheticLambda0
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        ((CallbackUtil.DispatcherStub) obj).register(true);
                    }
                });
                this.mListeners = (ArrayList<ListenerInfo<T>>) pairAddListener.first;
        ...
        void removeListener(T t, String str) {
            synchronized (this.mListenerLock) {
                Pair pairRemoveListener = CallbackUtil.removeListener(str, t, this.mListeners, this.mDispatcherStub, new Consumer() { // from class: android.media.CallbackUtil$LazyListenerManager$$ExternalSyntheticLambda1
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        ((CallbackUtil.DispatcherStub) obj).register(false);
                    }
                });
                this.mListeners = (ArrayList<ListenerInfo<T>>) pairRemoveListener.first;
