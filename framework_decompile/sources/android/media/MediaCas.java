            ...
            try {
                ...
                if (serviceV12 == null) {
                    ...
                    if (serviceV11 == null) {
                        ...
                        android.hardware.cas.V1_1.ICas iCasCreatePluginExt = serviceV11.createPluginExt(casSystemId, this.mBinder);
                        this.mICasV11 = iCasCreatePluginExt;
                        this.mICas = iCasCreatePluginExt;
                    }
                } else {
                    Log.d(TAG, "Used cas@1.2 interface to create plugin");
                    android.hardware.cas.V1_2.ICas iCasCastFrom = android.hardware.cas.V1_2.ICas.castFrom((IHwInterface) serviceV12.createPluginExt(casSystemId, this.mBinder));
                    this.mICasV12 = iCasCastFrom;
                    this.mICasV11 = iCasCastFrom;
                    this.mICas = iCasCastFrom;
                }
                if (this.mICas == null) {
