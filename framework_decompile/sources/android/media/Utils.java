            ...
            public void onEvent(final int eventCode, final V info) {
                ...
                executor.execute(new Runnable() { // from class: android.media.Utils$ListenerList$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m2487lambda$onEvent$0$androidmediaUtils$ListenerList$1(listener, eventCode, info);
                    }
                });
            }

            /* renamed from: lambda$onEvent$0$android-media-Utils$ListenerList$1, reason: not valid java name */
            /* synthetic */ void m2487lambda$onEvent$0$androidmediaUtils$ListenerList$1(Listener listener, int eventCode, Object info) {
