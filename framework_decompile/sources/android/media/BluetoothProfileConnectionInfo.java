...
public final class BluetoothProfileConnectionInfo implements Parcelable {
    ...
    public static BluetoothProfileConnectionInfo createLeAudioInfo(boolean suppressNoisyIntent, boolean isLeOutput, int volume) {
        return new BluetoothProfileConnectionInfo(22, suppressNoisyIntent, volume, isLeOutput);
    }
