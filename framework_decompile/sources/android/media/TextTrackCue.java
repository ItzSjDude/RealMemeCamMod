...
class TextTrackCue extends SubtitleTrack.Cue {
    ...
    public String toString() {
        ...
        StringBuilder sbAppend2 = sbAppend.append(str).append(", regionId:\"").append(this.mRegionId).append("\", snapToLines:").append(this.mSnapToLines).append(", linePosition:").append(this.mAutoLinePosition ? "auto" : this.mLinePosition).append(", textPosition:").append(this.mTextPosition).append(", size:").append(this.mSize).append(", alignment:");
        ...
        sbAppend2.append(str2).append(", text:");
