...
public final class MediaSessionManager {
            ...
            try {
                ...
                executor.execute(new Runnable() { // from class: android.media.session.MediaSessionManager$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m2636xaab35c33(listener);
                    }
                });
            } catch (RemoteException e) {
    ...
    /* renamed from: lambda$addOnMediaKeyEventSessionChangedListener$0$android-media-session-MediaSessionManager, reason: not valid java name */
    /* synthetic */ void m2636xaab35c33(OnMediaKeyEventSessionChangedListener listener) {
            ...
            public void onActiveSessionsChanged(final List<MediaSession.Token> tokens) {
                if (SessionsChangedWrapper.this.mExecutor != null) {
                    ...
                    executor.execute(new Runnable() { // from class: android.media.session.MediaSessionManager$SessionsChangedWrapper$1$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m2646x8126afd3(tokens);
                        }
                    });
                }
            }

            /* renamed from: lambda$onActiveSessionsChanged$0$android-media-session-MediaSessionManager$SessionsChangedWrapper$1, reason: not valid java name */
            /* synthetic */ void m2646x8126afd3(List tokens) {
    ...
    static final class Session2TokensChangedWrapper {
        ...
        class AnonymousClass1 extends ISession2TokensListener.Stub {
            ...
            /* renamed from: lambda$onSession2TokensChanged$0$android-media-session-MediaSessionManager$Session2TokensChangedWrapper$1, reason: not valid java name */
            /* synthetic */ void m2641xe76b035f(List tokens) {
            ...
            public void onSession2TokensChanged(final List<Session2Token> tokens) {
                Session2TokensChangedWrapper.this.mExecutor.execute(new Runnable() { // from class: android.media.session.MediaSessionManager$Session2TokensChangedWrapper$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2641xe76b035f(tokens);
                    }
                });
            }
        }
        ...
        public void onMediaKey(final KeyEvent event, final ResultReceiver result) {
            ...
            if (this.mListener == null || (handler = this.mHandler) == null) {
                ...
                handler.post(new Runnable() { // from class: android.media.session.MediaSessionManager.OnMediaKeyListenerImpl.1
                    @Override // java.lang.Runnable
                    public void run() {
                        boolean zOnMediaKey = OnMediaKeyListenerImpl.this.mListener.onMediaKey(event);
