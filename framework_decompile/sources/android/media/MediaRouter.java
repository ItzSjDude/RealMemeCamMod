...
public class MediaRouter {
    ...
    static class Static implements DisplayManager.DisplayListener {
        ...
        void startMonitoringRoutes(Context appContext) throws RemoteException {
        ...
        final class Client extends IMediaRouterClient.Stub {
            ...
            public void onRestoreRoute() {
                Static.this.mHandler.post(new Runnable() { // from class: android.media.MediaRouter$Static$Client$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        this.f$0.m2394lambda$onRestoreRoute$0$androidmediaMediaRouter$Static$Client();
                    }
                });
            }

            /* renamed from: lambda$onRestoreRoute$0$android-media-MediaRouter$Static$Client, reason: not valid java name */
            /* synthetic */ void m2394lambda$onRestoreRoute$0$androidmediaMediaRouter$Static$Client() {
            ...
            public void onGroupRouteSelected(final String groupRouteId) {
                Static.this.mHandler.post(new Runnable() { // from class: android.media.MediaRouter$Static$Client$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2393xc47b08ed(groupRouteId);
                    }
                });
            }

            /* renamed from: lambda$onGroupRouteSelected$1$android-media-MediaRouter$Static$Client, reason: not valid java name */
            /* synthetic */ void m2393xc47b08ed(String groupRouteId) {
    ...
    static void selectRouteStatic(int types, RouteInfo route, boolean explicit) {
        ...
        if (sStatic.isPlaybackActive() && sStatic.mBluetoothA2dpRoute != null && (types & 1) != 0 && ((route.isBluetooth() || route.isDefault()) && Process.myUid() < 10000)) {
            try {
