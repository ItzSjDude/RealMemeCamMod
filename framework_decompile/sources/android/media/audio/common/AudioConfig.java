...
public class AudioConfig implements Parcelable {
    ...
    public boolean equals(Object other) {
        ...
        if (Objects.deepEquals(this.base, that.base) && Objects.deepEquals(this.offloadInfo, that.offloadInfo) && Objects.deepEquals(Long.valueOf(this.frameCount), Long.valueOf(that.frameCount))) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Arrays.deepHashCode(Arrays.asList(this.base, this.offloadInfo, Long.valueOf(this.frameCount)).toArray());
    }
