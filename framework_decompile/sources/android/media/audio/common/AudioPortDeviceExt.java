...
public class AudioPortDeviceExt implements Parcelable {
    ...
    public boolean equals(Object other) {
        ...
        if (Objects.deepEquals(this.device, that.device) && Objects.deepEquals(Integer.valueOf(this.flags), Integer.valueOf(that.flags)) && Objects.deepEquals(this.encodedFormats, that.encodedFormats)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Arrays.deepHashCode(Arrays.asList(this.device, Integer.valueOf(this.flags), this.encodedFormats).toArray());
    }
