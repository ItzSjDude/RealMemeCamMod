...
public class AudioOffloadInfo implements Parcelable {
    ...
    public boolean equals(Object other) {
        ...
        if (Objects.deepEquals(this.base, that.base) && Objects.deepEquals(Integer.valueOf(this.streamType), Integer.valueOf(that.streamType)) && Objects.deepEquals(Integer.valueOf(this.bitRatePerSecond), Integer.valueOf(that.bitRatePerSecond)) && Objects.deepEquals(Long.valueOf(this.durationUs), Long.valueOf(that.durationUs)) && Objects.deepEquals(Boolean.valueOf(this.hasVideo), Boolean.valueOf(that.hasVideo)) && Objects.deepEquals(Boolean.valueOf(this.isStreaming), Boolean.valueOf(that.isStreaming)) && Objects.deepEquals(Integer.valueOf(this.bitWidth), Integer.valueOf(that.bitWidth)) && Objects.deepEquals(Integer.valueOf(this.offloadBufferSize), Integer.valueOf(that.offloadBufferSize)) && Objects.deepEquals(Integer.valueOf(this.usage), Integer.valueOf(that.usage)) && Objects.deepEquals(Byte.valueOf(this.encapsulationMode), Byte.valueOf(that.encapsulationMode)) && Objects.deepEquals(Integer.valueOf(this.contentId), Integer.valueOf(that.contentId)) && Objects.deepEquals(Integer.valueOf(this.syncId), Integer.valueOf(that.syncId))) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Arrays.deepHashCode(Arrays.asList(this.base, Integer.valueOf(this.streamType), Integer.valueOf(this.bitRatePerSecond), Long.valueOf(this.durationUs), Boolean.valueOf(this.hasVideo), Boolean.valueOf(this.isStreaming), Integer.valueOf(this.bitWidth), Integer.valueOf(this.offloadBufferSize), Integer.valueOf(this.usage), Byte.valueOf(this.encapsulationMode), Integer.valueOf(this.contentId), Integer.valueOf(this.syncId)).toArray());
    }
