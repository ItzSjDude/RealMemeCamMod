...
public class MediaMetadataRetriever implements AutoCloseable {
    ...
    private String convertGenreTag(String meta) throws NumberFormatException {
    ...
    private List<Bitmap> getFramesAtIndexInternal(int frameIndex, int numFrames, BitmapParams params) throws NumberFormatException {
