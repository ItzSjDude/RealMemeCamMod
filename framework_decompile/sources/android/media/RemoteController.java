            ...
            synchronized (RemoteController.mInfoLock) {
                try {
                    if (RemoteController.this.mCurrentSession != null) {
                        try {
                            if (this.mEditorMetadata.containsKey(String.valueOf(MediaMetadataEditor.RATING_KEY_BY_USER)) && (rating = (Rating) getObject(MediaMetadataEditor.RATING_KEY_BY_USER, null)) != null) {
