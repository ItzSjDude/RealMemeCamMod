...
public class Tuner implements AutoCloseable {
    ...
    class EventHandler extends Handler {
                        ...
                        if (Tuner.this.mOnResourceLostListener != null && Tuner.this.mOnResourceLostListenerExecutor != null) {
                            Tuner.this.mOnResourceLostListenerExecutor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$EventHandler$$ExternalSyntheticLambda0
                                ...
                                public final void run() {
                                    this.f$0.m2848lambda$handleMessage$0$androidmediatvtunerTuner$EventHandler();
                                }
                            });
                        }
                    }
        ...
        /* synthetic */ void m2848lambda$handleMessage$0$androidmediatvtunerTuner$EventHandler() {
            synchronized (Tuner.this.mOnResourceLostListenerLock) {
    ...
    private boolean requestFrontend() {
        ...
        if (granted) {
            Integer numValueOf = Integer.valueOf(feHandle[0]);
            this.mFrontendHandle = numValueOf;
            this.mFrontend = nativeOpenFrontendByHandle(numValueOf.intValue());
        }
        ...
        synchronized (this.mOnTuneEventLock) {
            ...
            if (executor != null && this.mOnTuneEventListener != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2835lambda$onFrontendEvent$1$androidmediatvtunerTuner(eventType);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2835lambda$onFrontendEvent$1$androidmediatvtunerTuner(int eventType) {
        synchronized (this.mOnTuneEventLock) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda14
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2839lambda$onLocked$2$androidmediatvtunerTuner();
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2839lambda$onLocked$2$androidmediatvtunerTuner() {
        synchronized (this.mScanCallbackLock) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda15
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2847lambda$onUnlocked$3$androidmediatvtunerTuner();
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2847lambda$onUnlocked$3$androidmediatvtunerTuner() {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda4
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2844lambda$onScanStopped$4$androidmediatvtunerTuner();
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2844lambda$onScanStopped$4$androidmediatvtunerTuner() {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda12
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2843lambda$onProgress$5$androidmediatvtunerTuner(percent);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2843lambda$onProgress$5$androidmediatvtunerTuner(int percent) {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2834lambda$onFrequenciesReport$6$androidmediatvtunerTuner(frequencies);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2834lambda$onFrequenciesReport$6$androidmediatvtunerTuner(long[] frequencies) {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda11
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2846lambda$onSymbolRates$7$androidmediatvtunerTuner(rate);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2846lambda$onSymbolRates$7$androidmediatvtunerTuner(int[] rate) {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda16
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2837lambda$onHierarchy$8$androidmediatvtunerTuner(hierarchy);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2837lambda$onHierarchy$8$androidmediatvtunerTuner(int hierarchy) {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda8
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2845lambda$onSignalType$9$androidmediatvtunerTuner(signalType);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2845lambda$onSignalType$9$androidmediatvtunerTuner(int signalType) {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2841lambda$onPlpIds$10$androidmediatvtunerTuner(plpIds);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2841lambda$onPlpIds$10$androidmediatvtunerTuner(int[] plpIds) {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda21
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2836lambda$onGroupIds$11$androidmediatvtunerTuner(groupIds);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2836lambda$onGroupIds$11$androidmediatvtunerTuner(int[] groupIds) {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda19
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2838lambda$onInputStreamIds$12$androidmediatvtunerTuner(inputStreamIds);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2838lambda$onInputStreamIds$12$androidmediatvtunerTuner(int[] inputStreamIds) {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda18
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2831lambda$onDvbsStandard$13$androidmediatvtunerTuner(dvbsStandandard);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2831lambda$onDvbsStandard$13$androidmediatvtunerTuner(int dvbsStandandard) {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2833lambda$onDvbtStandard$14$androidmediatvtunerTuner(dvbtStandard);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2833lambda$onDvbtStandard$14$androidmediatvtunerTuner(int dvbtStandard) {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda13
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2828lambda$onAnalogSifStandard$15$androidmediatvtunerTuner(sif);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2828lambda$onAnalogSifStandard$15$androidmediatvtunerTuner(int sif) {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2829lambda$onAtsc3PlpInfos$16$androidmediatvtunerTuner(atsc3PlpInfos);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2829lambda$onAtsc3PlpInfos$16$androidmediatvtunerTuner(Atsc3PlpInfo[] atsc3PlpInfos) {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda20
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2840lambda$onModulationReported$17$androidmediatvtunerTuner(modulation);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2840lambda$onModulationReported$17$androidmediatvtunerTuner(int modulation) {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2842lambda$onPriorityReported$18$androidmediatvtunerTuner(isHighPriority);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2842lambda$onPriorityReported$18$androidmediatvtunerTuner(boolean isHighPriority) {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2830lambda$onDvbcAnnexReported$19$androidmediatvtunerTuner(dvbcAnnex);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2830lambda$onDvbcAnnexReported$19$androidmediatvtunerTuner(int dvbcAnnex) {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
        ...
        synchronized (this.mScanCallbackLock) {
            ...
            if (executor != null && this.mScanCallback != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.Tuner$$ExternalSyntheticLambda17
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2832lambda$onDvbtCellIdsReported$20$androidmediatvtunerTuner(dvbtCellIds);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m2832lambda$onDvbtCellIdsReported$20$androidmediatvtunerTuner(int[] dvbtCellIds) {
        synchronized (this.mScanCallbackLock) {
            ScanCallback scanCallback = this.mScanCallback;
            if (scanCallback != null) {
    ...
    private boolean requestLnb() {
        ...
        if (granted) {
            Integer numValueOf = Integer.valueOf(lnbHandle[0]);
            this.mLnbHandle = numValueOf;
            this.mLnb = nativeOpenLnbByHandle(numValueOf.intValue());
        }
        return granted;
    }
    ...
    private boolean requestDemux() {
        ...
        if (granted) {
            Integer numValueOf = Integer.valueOf(demuxHandle[0]);
            this.mDemuxHandle = numValueOf;
            nativeOpenDemuxByhandle(numValueOf.intValue());
        }
        return granted;
    }
