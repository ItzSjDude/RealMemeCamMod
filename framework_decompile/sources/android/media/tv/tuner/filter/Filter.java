...
public class Filter implements AutoCloseable {
            ...
            if (this.mCallback != null && (executor = this.mExecutor) != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.filter.Filter$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        this.f$0.m2853lambda$onFilterStatus$0$androidmediatvtunerfilterFilter(status);
                    }
                });
            }
        }
    ...
    /* renamed from: lambda$onFilterStatus$0$android-media-tv-tuner-filter-Filter, reason: not valid java name */
    /* synthetic */ void m2853lambda$onFilterStatus$0$androidmediatvtunerfilterFilter(int status) {
        synchronized (this.mCallbackLock) {
        ...
        synchronized (this.mCallbackLock) {
            if (this.mCallback == null || (executor = this.mExecutor) == null) {
                ...
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.filter.Filter$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m2852lambda$onFilterEvent$1$androidmediatvtunerfilterFilter(events);
                    }
                });
            }
        }
    ...
    /* renamed from: lambda$onFilterEvent$1$android-media-tv-tuner-filter-Filter, reason: not valid java name */
    /* synthetic */ void m2852lambda$onFilterEvent$1$androidmediatvtunerfilterFilter(FilterEvent[] events) {
        synchronized (this.mCallbackLock) {
            FilterCallback filterCallback = this.mCallback;
            if (filterCallback != null) {
    ...
    public int delayCallbackForDurationMillis(long durationInMs) {
        ...
        if (durationInMs >= 0 && durationInMs <= 2147483647L) {
            synchronized (this.mLock) {
                iNativeSetTimeDelayHint = nativeSetTimeDelayHint((int) durationInMs);
            }
    ...
    public int delayCallbackUntilBytesAccumulated(int bytesAccumulated) {
        ...
        synchronized (this.mLock) {
            iNativeSetDataSizeDelayHint = nativeSetDataSizeDelayHint(bytesAccumulated);
        }
