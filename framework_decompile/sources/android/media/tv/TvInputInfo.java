...
public final class TvInputInfo implements Parcelable {
    ...
    public Drawable loadIcon(Context context) throws NumberFormatException, IOException {
    ...
    public static final class Builder {
        ...
        public Builder(Context context, ComponentName component) {
            ...
            ResolveInfo resolveInfoResolveService = context.getPackageManager().resolveService(intent, 132);
        ...
        public TvInputInfo build() {
            ...
            return new TvInputInfo(resolveInfo, id, type, isHardwareInput, charSequence, i, icon, icon2, icon3, str, zBooleanValue, zBooleanValue2, num != null ? num.intValue() : 0, this.mHdmiDeviceInfo, isConnectedToHdmiSwitch, hdmiConnectionRelativePosition, this.mParentId, this.mExtras);
        }
