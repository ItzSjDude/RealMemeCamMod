...
public final class MediaCodecList {
    ...
    private static final IMediaCodecListExt mMediaCodecListExt = (IMediaCodecListExt) ExtLoader.type(IMediaCodecListExt.class).create();
    ...
    private static final void initCodecList() {
        IMediaCodecListExt iMediaCodecListExt;
        synchronized (sInitLock) {
            if (sRegularCodecInfos == null) {
                ...
                for (int index = 0; index < count; index++) {
                    try {
                        ...
                        if ("c2.mtk.av1.decoder".equals(info.getName()) && (iMediaCodecListExt = mMediaCodecListExt) != null && iMediaCodecListExt.isNeedDisableAv1()) {
