...
public class MediaHTTPConnection extends IMediaHTTPConnection.Stub {
    ...
    private IMediaHTTPConnectionExt mMediaHTTPConnectionExt = (IMediaHTTPConnectionExt) ExtLoader.type(IMediaHTTPConnectionExt.class).base(this).create();
    private IMediaHTTPConnectionWrapper mMediaHTTPConnectionWrapper = new MediaHTTPConnectionWrapper();
    ...
    public synchronized void seekTo(long offset) throws IOException {
        ...
        try {
            ...
            while (this.mNumDisconnectingThreads.get() <= 0) {
                ...
                IMediaHTTPConnectionExt iMediaHTTPConnectionExt = this.mMediaHTTPConnectionExt;
                if (iMediaHTTPConnectionExt != null && iMediaHTTPConnectionExt.isNeedSetTimeout()) {
                    Log.i(TAG, "app setTimout");
    ...
    @Override // android.media.IMediaHTTPConnection
    public long getSize() {
        Log.d(TAG, "getSize " + (this.mConnection == null ? "mConnection == null" : "mTotalSize=" + this.mTotalSize));
        if (this.mConnection == null) {
            try {
                IMediaHTTPConnectionExt iMediaHTTPConnectionExt = this.mMediaHTTPConnectionExt;
                if (iMediaHTTPConnectionExt != null && iMediaHTTPConnectionExt.isNeedSetTimeout()) {
                    this.mMediaHTTPConnectionExt.asyncSeekTo(0L);
                } else {
                    seekTo(0L);
                }
            } catch (Exception e) {
    ...
    public IMediaHTTPConnectionWrapper getWrapper() {
        return this.mMediaHTTPConnectionWrapper;
    }

    private class MediaHTTPConnectionWrapper implements IMediaHTTPConnectionWrapper {
        private MediaHTTPConnectionWrapper() {
        }

        @Override // android.media.IMediaHTTPConnectionWrapper
        public IMediaHTTPConnectionExt getExtImpl() {
            return MediaHTTPConnection.this.mMediaHTTPConnectionExt;
        }

        @Override // android.media.IMediaHTTPConnectionWrapper
        public long getCurrentOffset() {
            return MediaHTTPConnection.this.mCurrentOffset;
        }

        @Override // android.media.IMediaHTTPConnectionWrapper
        public void setCurrentOffset(long offset) {
            MediaHTTPConnection.this.mCurrentOffset = offset;
        }

        @Override // android.media.IMediaHTTPConnectionWrapper
        public InputStream getInputStream() {
            return MediaHTTPConnection.this.mInputStream;
        }

        @Override // android.media.IMediaHTTPConnectionWrapper
        public void seekTo(long offset) {
            try {
                MediaHTTPConnection.this.seekTo(offset);
            } catch (IOException e) {
            }
        }
    }
