...
class TtmlParser {
    ...
    public void parse(String ttmlText, long runId) throws XmlPullParserException, IOException, NumberFormatException {
        this.mParser = null;
    ...
    private TtmlNode parseNode(TtmlNode parent) throws XmlPullParserException, NumberFormatException, IOException {
        long start;
        long end;
        int eventType = this.mParser.getEventType();
        if (eventType != 2) {
