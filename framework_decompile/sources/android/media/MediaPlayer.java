...
public class MediaPlayer extends PlayerBase implements SubtitleController.Listener, VolumeAutomation, AudioRouting {
    ...
    public static MediaPlayer create(Context context, int resid, AudioAttributes audioAttributes, int audioSessionId) throws IllegalStateException, Resources.NotFoundException {
        try {
    ...
    public void setDataSource(Context context, Uri uri, Map<String, String> headers, List<HttpCookie> cookies) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException {
    ...
    private void setDataSource(String path, Map<String, String> headers, List<HttpCookie> cookies) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException {
        String[] keys = null;
        String[] values = null;
        if (headers != null) {
    ...
    private void setDataSource(String path, String[] keys, String[] values, List<HttpCookie> cookies) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException {
        Uri uri = Uri.parse(path);
        String scheme = uri.getScheme();
        if ("file".equals(scheme)) {
            path = uri.getPath();
        } else if (scheme != null && (!path.startsWith("/storage/") || path.contains("://"))) {
    ...
    public void setWakeMode(Context context, int mode) {
        ...
        PowerManager.WakeLock wakeLockNewWakeLock = pm.newWakeLock(536870912 | mode, MediaPlayer.class.getName());
    ...
    public void setAudioSessionId(int sessionId) throws IllegalStateException, IllegalArgumentException {
    ...
    public static class TrackInfo implements Parcelable {
        ...
        TrackInfo(Parcel in) {
            ...
            MediaFormat mediaFormatCreateSubtitleFormat = MediaFormat.createSubtitleFormat(mime, language);
            this.mFormat = mediaFormatCreateSubtitleFormat;
            if (i == 4) {
                mediaFormatCreateSubtitleFormat.setInteger(MediaFormat.KEY_IS_AUTOSELECT, in.readInt());
                mediaFormatCreateSubtitleFormat.setInteger(MediaFormat.KEY_IS_DEFAULT, in.readInt());
                mediaFormatCreateSubtitleFormat.setInteger(MediaFormat.KEY_IS_FORCED_SUBTITLE, in.readInt());
            }
        }
    ...
    public void addTimedTextSource(FileDescriptor fd, String mimeType) throws IllegalStateException, ErrnoException, IllegalArgumentException {
        addTimedTextSource(fd, 0L, 576460752303423487L, mimeType);
    }

    public void addTimedTextSource(FileDescriptor fd, final long offset, final long length, String mime) throws IllegalStateException, ErrnoException, IllegalArgumentException {
    ...
    class EventHandler extends Handler {
                        ...
                        try {
                            ...
                            MediaPlayer.this.mOnRtpRxNoticeExecutor.execute(new Runnable() { // from class: android.media.MediaPlayer$EventHandler$$ExternalSyntheticLambda0
                                ...
                                public final void run() {
                                    this.f$0.m2373lambda$handleMessage$0$androidmediaMediaPlayer$EventHandler(rtpRxNoticeListener, noticeType, data3);
                                }
                            });
                            return;
                        } catch (Throwable th) {
        ...
        /* renamed from: lambda$handleMessage$0$android-media-MediaPlayer$EventHandler, reason: not valid java name */
        /* synthetic */ void m2373lambda$handleMessage$0$androidmediaMediaPlayer$EventHandler(OnRtpRxNoticeListener rtpRxNoticeListener, int noticeType, int[] data) {
    ...
    public byte[] provideKeyResponse(byte[] keySetId, byte[] response) throws DeniedByServerException, NoDrmSchemeException {
        byte[] scope;
        byte[] keySetResult;
    ...
    private int HandleProvisioninig(UUID uuid) {
        ...
        ProvisioningThread provisioningThreadInitialize = new ProvisioningThread().initialize(provReq, uuid, this);
    ...
    static class TimeProvider implements OnSeekCompleteListener, MediaTimeProvider {
        ...
        /* JADX WARN: Removed duplicated region for block: B:31:0x0074 A[Catch: all -> 0x00b7, TryCatch #0 {, blocks: (B:3:0x0001, B:6:0x0007, B:7:0x0009, B:10:0x000d, B:12:0x0021, B:17:0x0029, B:19:0x002f, B:23:0x003f, B:26:0x0059, B:28:0x0061, B:30:0x0069, B:32:0x0078, B:33:0x007a, B:31:0x0074, B:36:0x007d, B:38:0x0081, B:40:0x0085, B:43:0x0091, B:45:0x0097, B:46:0x00b1, B:47:0x00b3, B:42:0x008d, B:50:0x00b6), top: B:54:0x0001, inners: #1 }] */
        @Override // android.media.MediaTimeProvider
        /*
        ...
        private class EventHandler extends Handler {
            ...
            public void handleMessage(Message msg) {
                if (TimeProvider.this.DEBUG) {
                    Log.d(TimeProvider.TAG, "handleMessage_notify msg:(" + msg.what + ", " + msg.arg1 + ", " + msg.arg2 + NavigationBarInflaterView.KEY_CODE_END);
                }
                if (msg.what == 1) {
                    switch (msg.arg1) {
                        case 0:
