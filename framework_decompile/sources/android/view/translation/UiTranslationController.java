...
public class UiTranslationController implements Dumpable {
    ...
    public void updateUiTranslationState(int state, TranslationSpec sourceSpec, TranslationSpec targetSpec, List<AutofillId> views, UiTranslationSpec uiTranslationSpec) {
        ...
        Log.i("UiTranslationController", "updateUiTranslationState state: " + stateToString(state) + (DEBUG ? ", views: " + views + ", spec: " + uiTranslationSpec : ""));
    ...
    public void onTranslationCompleted(TranslationResponse response) {
        ...
        if (response == null || response.getTranslationStatus() != 0) {
            StringBuilder sbAppend = new StringBuilder().append("Fail result from TranslationService, status=");
            if (response == null) {
                objValueOf = "null";
            } else {
                objValueOf = Integer.valueOf(response.getTranslationStatus());
            }
            Log.w("UiTranslationController", sbAppend.append(objValueOf).toString());
            return;
        }
                        ...
                        if (this.mCurrentState == 1) {
                            ...
                            this.mActivity.runOnUiThread(new Runnable() { // from class: android.view.translation.UiTranslationController$$ExternalSyntheticLambda8
                                ...
                                public final void run() {
                                    UiTranslationController.lambda$onVirtualViewTranslationCompleted$3(view);
                                }
                            });
                        }
                    }
    ...
    static /* synthetic */ void lambda$onVirtualViewTranslationCompleted$3(View view) {
                    ...
                    if (viewRef != null) {
                        ...
                        if (view == null) {
                            ...
                            this.mActivity.runOnUiThread(new Runnable() { // from class: android.view.translation.UiTranslationController$$ExternalSyntheticLambda2
                                @Override // java.lang.Runnable
                                public final void run() {
                                    this.f$0.m5632x2413d371(view, response, autofillId, currentState);
                                }
                            });
                        }
                    }
    ...
    /* synthetic */ void m5632x2413d371(View view, ViewTranslationResponse response, AutofillId autofillId, int currentState) {
    ...
    private void onUiTranslationStarted(final Translator translator, List<AutofillId> views) {
        ...
        synchronized (this.mLock) {
            ...
            this.mActivity.runOnUiThread(new Runnable() { // from class: android.view.translation.UiTranslationController$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m5633xef0563c5(roots, viewIds, supportedFormats, capability, requests, translator);
                }
            });
        }
    }
    ...
    /* synthetic */ void m5633xef0563c5(ArrayList roots, Map viewIds, int[] supportedFormats, TranslationCapability capability, ArrayList requests, Translator translator) {
        for (int rootNum = 0; rootNum < roots.size(); rootNum++) {
    ...
    private void runForEachView(final BiConsumer<View, ViewTranslationCallback> action) {
        synchronized (this.mLock) {
            ...
            this.mActivity.runOnUiThread(new Runnable() { // from class: android.view.translation.UiTranslationController$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    UiTranslationController.lambda$runForEachView$7(views, action);
                }
            });
        }
    }

    static /* synthetic */ void lambda$runForEachView$7(ArrayMap views, BiConsumer action) {
    ...
    private static String sanitizedViewTranslationRequest(ViewTranslationRequest request) {
        ...
        for (String key : request.getKeys()) {
            ...
            StringBuilder sbAppend = msg.append("{text=");
