...
public final class TranslationManager {
                ...
                if (translatorId != 0 && this.mTranslatorIds.indexOf(translatorId) < 0) {
                    new Translator(this.mContext, translationContext, translatorId, this, this.mHandler, this.mService, new Consumer() { // from class: android.view.translation.TranslationManager$$ExternalSyntheticLambda3
                        ...
                        public final void accept(Object obj) {
                            this.f$0.m5616xc87cb596(executor, callback, translatorId, (Translator) obj);
                        }
                    });
                }
            }
    ...
    /* renamed from: lambda$createOnDeviceTranslator$4$android-view-translation-TranslationManager, reason: not valid java name */
    /* synthetic */ void m5616xc87cb596(final Executor executor, final Consumer callback, int tId, final Translator translator) {
        if (translator == null) {
    ...
    public Set<TranslationCapability> getOnDeviceTranslationCapabilities(int sourceFormat, int targetFormat) {
        try {
            ...
            ParceledListSlice<TranslationCapability> listSlice = (ParceledListSlice) result.bundle.getParcelable(EXTRA_CAPABILITIES);
    ...
    static class TranslationCapabilityRemoteCallback extends IRemoteCallback.Stub {
        ...
        public void sendResult(final Bundle bundle) {
            Binder.withCleanCallingIdentity(new FunctionalUtils.ThrowingRunnable() { // from class: android.view.translation.TranslationManager$TranslationCapabilityRemoteCallback$$ExternalSyntheticLambda1
                ...
                public final void runOrThrow() throws Exception {
                    this.f$0.m5618x1bae665d(bundle);
                }
            });
        }

        /* renamed from: lambda$sendResult$1$android-view-translation-TranslationManager$TranslationCapabilityRemoteCallback, reason: not valid java name */
        /* synthetic */ void m5618x1bae665d(final Bundle bundle) throws Exception {
            this.mExecutor.execute(new Runnable() { // from class: android.view.translation.TranslationManager$TranslationCapabilityRemoteCallback$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m5617x3b35105c(bundle);
                }
            });
        }
        ...
        public void m5617x3b35105c(Bundle bundle) {
