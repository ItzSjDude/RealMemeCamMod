...
public final class SurfaceControl implements Parcelable {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static native void nativeSetBlurColor(long j, long j2, float f, float f2, float f3, float f4);
    ...
    private static native boolean nativeSetDisplayBrightnessWithColor(IBinder iBinder, float f, float f2, float f3, float f4, float f5);
    ...
    static {
        boolean z = !"0".equals(SystemProperties.get("persist.sys.agingtest", "0"));
        DEBUG_EGINGTEST = z;
        DEBUG_SFC = !z && SystemProperties.getBoolean("persist.sys.assert.panic", false);
    ...
    public boolean addOnReparentListener(OnReparentListener listener) {
        ...
        synchronized (this.mLock) {
            ...
            zAdd = this.mReparentListeners.add(listener);
        }
        return zAdd;
    }
    ...
    private static class SyncScreenCaptureListener implements ScreenCaptureListener {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public ScreenshotHardwareBuffer waitForScreenshot() throws InterruptedException {
            try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static abstract class CaptureArgs {
    ...
    public static class DisplayCaptureArgs extends CaptureArgs {
        ...
        public static class Builder extends CaptureArgs.Builder<Builder> {
            ...
            public /* bridge */ /* synthetic */ CaptureArgs.Builder setAllowProtected(boolean z) {
                return super.setAllowProtected(z);
            }

            @Override // android.view.SurfaceControl.CaptureArgs.Builder
            public /* bridge */ /* synthetic */ CaptureArgs.Builder setCaptureSecureLayers(boolean z) {
                return super.setCaptureSecureLayers(z);
            }

            @Override // android.view.SurfaceControl.CaptureArgs.Builder
            public /* bridge */ /* synthetic */ CaptureArgs.Builder setFrameScale(float f) {
                return super.setFrameScale(f);
            }

            @Override // android.view.SurfaceControl.CaptureArgs.Builder
            public /* bridge */ /* synthetic */ CaptureArgs.Builder setFrameScale(float f, float f2) {
                return super.setFrameScale(f, f2);
            }

            @Override // android.view.SurfaceControl.CaptureArgs.Builder
            public /* bridge */ /* synthetic */ CaptureArgs.Builder setGrayscale(boolean z) {
                return super.setGrayscale(z);
            }

            @Override // android.view.SurfaceControl.CaptureArgs.Builder
            public /* bridge */ /* synthetic */ CaptureArgs.Builder setPixelFormat(int i) {
                return super.setPixelFormat(i);
            }

            @Override // android.view.SurfaceControl.CaptureArgs.Builder
            public /* bridge */ /* synthetic */ CaptureArgs.Builder setSourceCrop(Rect rect) {
                return super.setSourceCrop(rect);
            }

            @Override // android.view.SurfaceControl.CaptureArgs.Builder
            public /* bridge */ /* synthetic */ CaptureArgs.Builder setUid(long j) {
    ...
    public static class Builder {
        ...
        public Builder setBufferSize(int width, int height) {
            ...
            if (width > 16384 || height > 16384) {
                Log.d(SurfaceControl.TAG, this + " mSurfaceWidth = " + width + " mSurfaceHeight = " + height);
    ...
    private SurfaceControl(SurfaceSession session, String name, int w, int h, int format, int flags, SurfaceControl parent, SparseIntArray metadata, WeakReference<View> localOwnerView, String callsite) throws Throwable {
        Parcel metaParcel;
    ...
    public static boolean setDisplayBrightness(IBinder displayToken, float brightness, float color) {
        return setDisplayBrightness(displayToken, brightness, -1.0f, brightness, -1.0f, color);
    }

    public static boolean setDisplayBrightness(IBinder displayToken, float sdrBrightness, float sdrBrightnessNits, float displayBrightness, float displayBrightnessNits, float color) {
        Objects.requireNonNull(displayToken);
        if (Float.isNaN(displayBrightness) || displayBrightness > 1.0f || (displayBrightness < 0.0f && displayBrightness != -1.0f)) {
            throw new IllegalArgumentException("displayBrightness must be a number between 0.0f  and 1.0f, or -1 to turn the backlight off: " + displayBrightness);
        }
        ...
        return nativeSetDisplayBrightnessWithColor(displayToken, sdrBrightness, sdrBrightnessNits, displayBrightness, displayBrightnessNits, color);
    }
    ...
    public static class Transaction implements Closeable, Parcelable {
        ...
        public void close() {
            if (SurfaceControl.DEBUG_SFC || SurfaceControl.DEBUG_ALL || SurfaceControl.DEBUG_EGINGTEST) {
        ...
        public Transaction setAodFlags(SurfaceControl sc, int flags) {
            checkPreconditions(sc);
            SurfaceControl.nativeSetFlags(this.mNativeObject, sc.mNativeObject, flags == 1 ? 2097152 : 0, 2097152);
            return this;
        }
        ...
        public Transaction setBufferSize(SurfaceControl sc, int w, int h) {
            ...
            if (w > 16384 || h > 16384) {
                Log.d(SurfaceControl.TAG, this + " mSurfaceWidth = " + w + " mSurfaceHeight = " + h);
                throw new IllegalStateException("SurfaceView width and height must be smaller than 16384");
            }
            checkPreconditions(sc);
        ...
        public Transaction setRelativeLayer(SurfaceControl sc, SurfaceControl relativeTo, int z) {
            checkPreconditions(sc);
            if (SurfaceControl.DEBUG_SFC || SurfaceControl.DEBUG_ALL || SurfaceControl.DEBUG_EGINGTEST) {
                Log.v(SurfaceControl.TAG, " setRelativeLayer:  sc " + sc + " relativeTo=" + relativeTo + " z=" + z + " caller=" + Debug.getCallers(SurfaceControl.DEBUG_DEPTH * 2));
            }
        ...
        public Transaction syncInputWindows() {
            if (Trace.isTagEnabled(32L)) {
                Trace.traceBegin(32L, "syncInputWindows:" + this.mNativeObject);
            }
        ...
        public Transaction setBlurColor(SurfaceControl sc, float r, float g, float b, float a) {
            checkPreconditions(sc);
            SurfaceControl.nativeSetBlurColor(this.mNativeObject, sc.mNativeObject, r, g, b, a);
            return this;
        }
        ...
        private void readFromParcel(Parcel in) {
            this.mNativeObject = 0L;
            if (in.readInt() != 0) {
                long jNativeReadTransactionFromParcel = SurfaceControl.nativeReadTransactionFromParcel(in);
