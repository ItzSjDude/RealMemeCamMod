...
public final class ScrollCaptureTarget {
    ...
    public void setScrollBounds(Rect scrollBounds) {
        Rect rectCopyOrNull = Rect.copyOrNull(scrollBounds);
    ...
    void dump(PrintWriter writer) {
        ...
        StringBuilder sbAppend = new StringBuilder().append("scrollBounds: ");
        Rect rect = this.mScrollBounds;
        writer.println(sbAppend.append(rect == null ? "null" : rect.toShortString()).toString());
