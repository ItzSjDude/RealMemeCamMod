...
public class InsetsController implements WindowInsetsController, InsetsAnimationControlCallbacks {
    ...
    private static TypeEvaluator<Insets> sEvaluator = new TypeEvaluator() { // from class: android.view.InsetsController$$ExternalSyntheticLambda1
        ...
        public final Object evaluate(float f, Object obj, Object obj2) {
            ...
            return Insets.of((int) (insets.left + ((insets2.left - insets.left) * f)), (int) (insets.top + ((insets2.top - insets.top) * f)), (int) (insets.right + ((insets2.right - insets.right) * f)), (int) (insets.bottom + ((insets2.bottom - insets.bottom) * f)));
        }
    };
    ...
    public static class InternalAnimationControlListener implements WindowInsetsAnimationControlListener {
        ...
        public void onReady(final WindowInsetsAnimationController controller, int types) {
            ...
            valueAnimatorOfFloat.setDuration(this.mDurationMs);
            this.mAnimator.setInterpolator(new LinearInterpolator());
            Insets hiddenInsets = controller.getHiddenStateInsets();
            if (controller.hasZeroInsetsIme()) {
                insetsOf = Insets.of(hiddenInsets.left, hiddenInsets.top, hiddenInsets.right, this.mFloatingImeBottomInset);
            } else {
                insetsOf = hiddenInsets;
            }
            Insets hiddenInsets2 = insetsOf;
            if (this.mShow) {
                start = hiddenInsets2;
            } else {
            ...
            this.mAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: android.view.InsetsController$InternalAnimationControlListener$$ExternalSyntheticLambda0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    this.f$0.m4998x674928e3(insetsInterpolator, controller, start, end, alphaInterpolator, valueAnimator);
                }
            });
        ...
        /* synthetic */ void m4998x674928e3(Interpolator insetsInterpolator, WindowInsetsAnimationController controller, Insets start, Insets end, Interpolator alphaInterpolator, ValueAnimator animation) {
            float alphaFraction;
        ...
        protected Interpolator getInsetsInterpolator() {
            if ((this.mRequestedTypes & WindowInsets.Type.ime()) != 0) {
                ...
                if (this.mShow) {
                    return this.mInsetsControllerExt.replaceIMEInterpolator(InsetsController.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
                }
            ...
            return new Interpolator() { // from class: android.view.InsetsController$InternalAnimationControlListener$$ExternalSyntheticLambda1
                @Override // android.animation.TimeInterpolator
                public final float getInterpolation(float f) {
                    return this.f$0.m4997x553b5e13(f);
                }
            };
        }
        ...
        /* synthetic */ float m4997x553b5e13(float input) {
        ...
        static /* synthetic */ float lambda$getAlphaInterpolator$4(float input) {
            return 1.0f;
        }
    ...
    static /* synthetic */ InsetsSourceConsumer lambda$new$2(InsetsController controller, Integer type) {
        if (type.intValue() == 19) {
    ...
    public InsetsController(Host host, BiFunction<InsetsController, Integer, InsetsSourceConsumer> consumerCreator, Handler handler) {
        ...
        this.mInvokeControllableInsetsChangedListeners = new Runnable() { // from class: android.view.InsetsController$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.invokeControllableInsetsChangedListeners();
            }
        };
        this.mHost = host;
        ...
        this.mAnimCallback = new Runnable() { // from class: android.view.InsetsController$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m4994lambda$new$3$androidviewInsetsController();
            }
        };
    }

    /* renamed from: lambda$new$3$android-view-InsetsController, reason: not valid java name */
    /* synthetic */ void m4994lambda$new$3$androidviewInsetsController() {
    ...
    private void updateState(InsetsState newState) {
        ...
        if (cancelledUserAnimationTypes[0] != 0) {
            this.mHandler.post(new Runnable() { // from class: android.view.InsetsController$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m4996lambda$updateState$4$androidviewInsetsController(cancelledUserAnimationTypes);
                }
            });
        }
    }
    ...
    /* synthetic */ void m4996lambda$updateState$4$androidviewInsetsController(int[] cancelledUserAnimationTypes) {
    ...
    public WindowInsets calculateInsets(boolean isScreenRound, boolean alwaysConsumeSystemBars, int windowType, int windowingMode, int legacySoftInputMode, int legacyWindowFlags, int legacySystemUiFlags) {
        ...
        WindowInsets windowInsetsCalculateInsets = this.mState.calculateInsets(this.mFrame, null, isScreenRound, alwaysConsumeSystemBars, legacySoftInputMode, legacyWindowFlags, legacySystemUiFlags, windowType, windowingMode, null);
    ...
    private void controlAnimationUnchecked(int types, CancellationSignal cancellationSignal, WindowInsetsAnimationControlListener listener, Rect frame, boolean fromIme, long durationMs, Interpolator interpolator, int animationType, int layoutInsetsDuringAnimation, boolean useInsetsAnimationThread) {
        ...
        if (animationType != 2) {
            ...
            int types3 = types & (~this.mDisabledUserAnimationInsetsTypes);
            ...
            if (cancellationSignal != null) {
                cancellationSignal.setOnCancelListener(new CancellationSignal.OnCancelListener() { // from class: android.view.InsetsController$$ExternalSyntheticLambda6
                    ...
                    public final void onCancel() {
                        this.f$0.m4992lambda$controlAnimationUnchecked$5$androidviewInsetsController(request);
                    }
                });
            }
            updateRequestedVisibilities();
        ...
        if (useInsetsAnimationThread) {
            ...
            bArr = null;
            str = TAG;
            insetsAnimationControlImpl = new InsetsAnimationThreadControlRunner(controls, frame, insetsState, listener, typesReady, this, durationMs, interpolator, animationType, layoutInsetsDuringAnimation, translator, handler);
        } else {
            bArr = null;
            str = TAG;
        ...
        if (cancellationSignal != null) {
            cancellationSignal.setOnCancelListener(new CancellationSignal.OnCancelListener() { // from class: android.view.InsetsController$$ExternalSyntheticLambda7
                @Override // android.os.CancellationSignal.OnCancelListener
                public final void onCancel() {
                    this.f$0.m4993lambda$controlAnimationUnchecked$6$androidviewInsetsController(runner);
                }
            });
            z = false;
        } else {
        ...
        if (layoutInsetsDuringAnimation == 0) {
            showDirectly(types4, fromIme);
        } else {
            hideDirectly(types4, z, animationType, fromIme);
        }
        updateRequestedVisibilities();
    }

    /* renamed from: lambda$controlAnimationUnchecked$5$android-view-InsetsController, reason: not valid java name */
    /* synthetic */ void m4992lambda$controlAnimationUnchecked$5$androidviewInsetsController(PendingControlRequest request) {
    ...
    /* synthetic */ void m4993lambda$controlAnimationUnchecked$6$androidviewInsetsController(InsetsAnimationControlRunner runner) {
    ...
    public void notifyFinished(InsetsAnimationControlRunner runner, boolean shown) {
        ...
        while (true) {
            ...
            if (this.mRunningAnimations.get(i).runner != runner) {
                i--;
            } else {
                isRunning = true;
                break;
    ...
    private void cancelAnimation(InsetsAnimationControlRunner control, boolean invokeCallback) {
        if (DEBUG) {
            Log.d(TAG, String.format("cancelAnimation of types: %d, animType: %d, host: %s", Integer.valueOf(control.getTypes()), Integer.valueOf(control.getAnimationType()), this.mHost.getRootViewTitle()));
        }
        if (invokeCallback) {
            control.cancel();
        }
    ...
    public void applyAnimation(int i, boolean z, boolean z2, boolean z3) {
        if (i == 0) {
            ...
            InternalAnimationControlListener internalAnimationControlListener = new InternalAnimationControlListener(z, zHasAnimationCallbacks, i, this.mHost.getSystemBarsBehavior(), z3 || this.mAnimationsDisabled, this.mHost.dipToPx(-80));
            controlAnimationUnchecked(i, null, internalAnimationControlListener, null, z2, internalAnimationControlListener.getDurationMs(), internalAnimationControlListener.getInsetsInterpolator(), !z ? 1 : 0, !z ? 1 : 0, !zHasAnimationCallbacks);
        }
    }
    ...
    public <T extends InsetsAnimationControlRunner & InternalInsetsAnimationController> void startAnimation(final T runner, final WindowInsetsAnimationControlListener listener, final int types, final WindowInsetsAnimation animation, final WindowInsetsAnimation.Bounds bounds) {
        ...
        this.mHost.addOnPreDrawRunnable(new Runnable() { // from class: android.view.InsetsController$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m4995lambda$startAnimation$7$androidviewInsetsController(runner, types, animation, bounds, listener);
            }
        });
    }

    /* renamed from: lambda$startAnimation$7$android-view-InsetsController, reason: not valid java name */
    /* synthetic */ void m4995lambda$startAnimation$7$androidviewInsetsController(InsetsAnimationControlRunner runner, int types, WindowInsetsAnimation animation, WindowInsetsAnimation.Bounds bounds, WindowInsetsAnimationControlListener listener) {
