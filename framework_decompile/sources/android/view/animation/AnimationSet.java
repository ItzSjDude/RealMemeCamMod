...
public class AnimationSet extends Animation {
    ...
    /* renamed from: clone */
    public AnimationSet mo5389clone() throws CloneNotSupportedException {
        AnimationSet animation = (AnimationSet) super.mo5389clone();
        ...
        for (int i = 0; i < count; i++) {
            animation.mAnimations.add(animations.get(i).mo5389clone());
        }
        return animation;
    }
    ...
    public void addAnimation(Animation a) {
        ...
        if ((this.mFlags & 32) == 32) {
            ...
            long jMax = Math.max(this.mLastEnd, this.mStartOffset + a.getStartOffset() + a.getDuration());
            this.mLastEnd = jMax;
