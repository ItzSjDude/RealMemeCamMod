    ...
    */
    private static android.view.animation.Animation createAnimationFromXml(android.content.Context r7, org.xmlpull.v1.XmlPullParser r8, android.view.animation.AnimationSet r9, android.util.AttributeSet r10) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L7e:
            ...
            boolean r4 = r2.equals(r4)
            if (r4 == 0) goto L93
            android.view.animation.ExtendAnimation r4 = new android.view.animation.ExtendAnimation
            r4.<init>(r7, r10)
            r0 = r4
        L8c:
            if (r9 == 0) goto L91
    ...
    */
    private static android.view.animation.LayoutAnimationController createLayoutAnimationFromXml(android.content.Context r7, org.xmlpull.v1.XmlPullParser r8, android.util.AttributeSet r9) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L1a:
            ...
            if (r4 == 0) goto L2d
            android.view.animation.LayoutAnimationController r4 = new android.view.animation.LayoutAnimationController
            r4.<init>(r7, r9)
            r0 = r4
            goto L3b
        L2d:
            ...
            boolean r4 = r4.equals(r2)
            if (r4 == 0) goto L3c
            android.view.animation.GridLayoutAnimationController r4 = new android.view.animation.GridLayoutAnimationController
            r4.<init>(r7, r9)
            r0 = r4
        L3b:
            goto L5
    ...
    public static Animation makeInAnimation(Context c, boolean fromLeft) throws Resources.NotFoundException {
        Animation a;
        if (fromLeft) {
    ...
    public static Animation makeOutAnimation(Context c, boolean toRight) throws Resources.NotFoundException {
        Animation a;
        if (toRight) {
    ...
    public static Animation makeInChildBottomAnimation(Context c) throws Resources.NotFoundException {
