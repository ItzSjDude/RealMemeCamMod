...
public final class InputMethodInfo implements Parcelable {
     ...
     */
    /* JADX WARN: Not initialized variable reg: 18, insn: 0x02c9: MOVE (r6 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY]) = (r18 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY] A[D('supportsSwitchingToNextInputMethod' boolean)]), block:B:91:0x02c9 */
    /* JADX WARN: Not initialized variable reg: 18, insn: 0x02d1: MOVE (r6 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY]) = (r18 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY] A[D('supportsSwitchingToNextInputMethod' boolean)]), block:B:93:0x02d1 */
    /* JADX WARN: Not initialized variable reg: 19, insn: 0x02cb: MOVE (r5 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY]) = (r19 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY] A[D('isAuxIme' boolean)]), block:B:91:0x02c9 */
    /* JADX WARN: Not initialized variable reg: 19, insn: 0x02d3: MOVE (r5 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY]) = (r19 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY] A[D('isAuxIme' boolean)]), block:B:93:0x02d1 */
    /* JADX WARN: Not initialized variable reg: 22, insn: 0x02cd: MOVE (r7 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY]) = (r22 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY] A[D('inlineSuggestionsEnabled' boolean)]), block:B:91:0x02c9 */
    /* JADX WARN: Not initialized variable reg: 22, insn: 0x02d5: MOVE (r7 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY]) = (r22 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY] A[D('inlineSuggestionsEnabled' boolean)]), block:B:93:0x02d1 */
    public InputMethodInfo(android.content.Context r30, android.content.pm.ResolveInfo r31, java.util.List<android.view.inputmethod.InputMethodSubtype> r32) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
