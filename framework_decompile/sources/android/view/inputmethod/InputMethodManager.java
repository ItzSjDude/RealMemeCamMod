...
public final class InputMethodManager {
    ...
    public final class DelegateImpl implements ImeFocusController.InputMethodManagerDelegate {
        ...
        @Override // android.view.ImeFocusController.InputMethodManagerDelegate
        public void startInputAsyncOnWindowFocusGain(View focusedView, int softInputMode, int windowFlags, boolean forceNewFocus) throws RemoteException {
            boolean z = false;
            ...
            switch (msg.what) {
                ...
                case 4:
                    ...
                    synchronized (InputMethodManager.this.mH) {
                        ...
                        if (controller != null && rootView != null && InputMethodManager.this.mImmWrapper.getExtImpl().updateReportToImeController(rootView.getContext(), InputMethodManager.this.mDisplayId, reportToImeController)) {
                            rootView.post(new Runnable() { // from class: android.view.inputmethod.InputMethodManager$H$$ExternalSyntheticLambda0
                                @Override // java.lang.Runnable
                                public final void run() {
                                    controller.onInteractiveChanged(active);
                                }
                            });
                            return;
                        }
    ...
    private boolean showSoftInput(View view, int flags, ResultReceiver resultReceiver, int reason) {
        ...
        this.mImmWrapper.getExtImpl().onCallShowBeforeCheckFocus();
        checkFocus();
        synchronized (this.mH) {
            ...
            if (view != null) {
                try {
                    if (view.getViewRootImpl() != null && view.getContext() != null) {
    ...
    public boolean doInvalidateInput(RemoteInputConnectionImpl inputConnection, TextSnapshot textSnapshot, final int sessionId) {
        ...
        synchronized (this.mH) {
            if (this.mServedInputConnection == inputConnection && (editorInfo = this.mCurrentTextBoxAttribute) != null) {
                ...
                this.mImmWrapper.getExtImpl().invalidateInputToSynergy(editorInfo2, this.mServedInputConnection, sessionId);
                ...
                forAccessibilitySessionsLocked(new Consumer() { // from class: android.view.inputmethod.InputMethodManager$$ExternalSyntheticLambda4
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        ((IAccessibilityInputMethodSessionInvoker) obj).invalidateInput(editorInfo2, accessibilityInputConnection, sessionId);
                    }
                });
                return true;
            }
    ...
    */
    boolean startInputInner(final int r28, android.os.IBinder r29, int r30, int r31, int r32) throws java.lang.Throwable {
        /*
    ...
    /* synthetic */ void m5551x308d22a9(int startInputReason) {
    ...
    public void checkFocus() {
        ...
        if (controller != null) {
            if (this.mImmWrapper.getExtImpl().needForceNewFocus()) {
    ...
    public void viewClicked(View view) {
        ...
        this.mImmWrapper.getExtImpl().onCallClickBeforeCheckFocus();
        checkFocus();
        synchronized (this.mH) {
            if (hasServedByInputMethodLocked(view) && this.mCurrentTextBoxAttribute != null && this.mCurrentInputMethodSession != null) {
                if (DEBUG) {
    ...
    void doDump(FileDescriptor fd, PrintWriter fout, String[] args) {
        ...
        if (this.mImmWrapper.getExtImpl().configDebug(args) && this.mCurId == null) {
            return;
        }
    ...
    private boolean processDump(FileDescriptor fd, String[] args) throws IOException {
        if (args == null) {
            return false;
        }
        for (String arg : args) {
    ...
    private class InputMethodManagerWrapper implements IInputMethodManagerWrapper {
