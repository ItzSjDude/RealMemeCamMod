...
public final class WindowManagerGlobal {
    ...
    /* JADX WARN: Removed duplicated region for block: B:25:0x0056 A[Catch: all -> 0x0066, TryCatch #0 {, blocks: (B:4:0x0008, B:6:0x0011, B:26:0x0061, B:9:0x001e, B:11:0x0022, B:13:0x0029, B:17:0x0032, B:19:0x004a, B:22:0x0050, B:25:0x0056, B:27:0x0064), top: B:32:0x0008 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public java.util.ArrayList<android.view.ViewRootImpl> getRootViews(android.os.IBinder r12) {
        /*
            r11 = this;
            ...
            monitor-enter(r1)
            java.util.ArrayList<android.view.ViewRootImpl> r2 = r11.mRoots     // Catch: java.lang.Throwable -> L66
            int r2 = r2.size()     // Catch: java.lang.Throwable -> L66
            r3 = 0
        Lf:
            if (r3 >= r2) goto L64
            java.util.ArrayList<android.view.WindowManager$LayoutParams> r4 = r11.mParams     // Catch: java.lang.Throwable -> L66
            java.lang.Object r4 = r4.get(r3)     // Catch: java.lang.Throwable -> L66
            android.view.WindowManager$LayoutParams r4 = (android.view.WindowManager.LayoutParams) r4     // Catch: java.lang.Throwable -> L66
            android.os.IBinder r5 = r4.token     // Catch: java.lang.Throwable -> L66
            if (r5 != 0) goto L1e
            goto L61
        L1e:
            android.os.IBinder r5 = r4.token     // Catch: java.lang.Throwable -> L66
            if (r5 == r12) goto L56
            r5 = 0
            int r6 = r4.type     // Catch: java.lang.Throwable -> L66
        ...
        L30:
            if (r6 >= r2) goto L53
            java.util.ArrayList<android.view.View> r7 = r11.mViews     // Catch: java.lang.Throwable -> L66
            java.lang.Object r7 = r7.get(r6)     // Catch: java.lang.Throwable -> L66
            android.view.View r7 = (android.view.View) r7     // Catch: java.lang.Throwable -> L66
            java.util.ArrayList<android.view.WindowManager$LayoutParams> r8 = r11.mParams     // Catch: java.lang.Throwable -> L66
            java.lang.Object r8 = r8.get(r6)     // Catch: java.lang.Throwable -> L66
            android.view.WindowManager$LayoutParams r8 = (android.view.WindowManager.LayoutParams) r8     // Catch: java.lang.Throwable -> L66
            android.os.IBinder r9 = r4.token     // Catch: java.lang.Throwable -> L66
            android.os.IBinder r10 = r7.getWindowToken()     // Catch: java.lang.Throwable -> L66
            if (r9 != r10) goto L50
            android.os.IBinder r9 = r8.token     // Catch: java.lang.Throwable -> L66
            if (r9 != r12) goto L50
            r5 = 1
            goto L53
        L50:
        ...
        L53:
            ...
            goto L61
        L56:
            java.util.ArrayList<android.view.ViewRootImpl> r5 = r11.mRoots     // Catch: java.lang.Throwable -> L66
            java.lang.Object r5 = r5.get(r3)     // Catch: java.lang.Throwable -> L66
            android.view.ViewRootImpl r5 = (android.view.ViewRootImpl) r5     // Catch: java.lang.Throwable -> L66
        ...
        L66:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: android.view.WindowManagerGlobal.getRootViews(android.os.IBinder):java.util.ArrayList");
    }
    ...
    public void dumpGfxInfo(FileDescriptor fd, String[] args) throws Throwable {
        char c;
        char c2;
            ...
            for (int i2 = nonCurrentThreadRoots.size() - 1; i2 >= 0; i2--) {
                ...
                root2.mHandler.runWithScissors(new Runnable() { // from class: android.view.WindowManagerGlobal$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        root2.setWindowStopped(stopped);
                    }
                }, 0L);
            }
        }
    ...
    private class WindowManagerGlobalWrapper implements IWindowManagerGlobalWrapper {
        ...
        public boolean trimMemoryIfAllowed(int level) {
            ...
            synchronized (WindowManagerGlobal.this.mLock) {
                for (int i = WindowManagerGlobal.this.mRoots.size() - 1; i >= 0; i--) {
                    ViewRootImpl root = (ViewRootImpl) WindowManagerGlobal.this.mRoots.get(i);
