...
public class RoundedCorners implements Parcelable {
    ...
    private static Pair<Integer, Integer> loadRoundedCornerRadii(Resources res, String displayUniqueId) throws Resources.NotFoundException {
    ...
    public static int getRoundedCornerRadius(Resources res, String displayUniqueId) throws Resources.NotFoundException {
        int radius;
    ...
    public static int getRoundedCornerTopRadius(Resources res, String displayUniqueId) throws Resources.NotFoundException {
        int radius;
        int index = DisplayUtils.getDisplayUniqueIdConfigIndex(res, displayUniqueId);
    ...
    public static int getRoundedCornerBottomRadius(Resources res, String displayUniqueId) throws Resources.NotFoundException {
        int radius;
        int index = DisplayUtils.getDisplayUniqueIdConfigIndex(res, displayUniqueId);
    ...
    public static int getRoundedCornerRadiusAdjustment(Resources res, String displayUniqueId) throws Resources.NotFoundException {
        int radius;
        int index = DisplayUtils.getDisplayUniqueIdConfigIndex(res, displayUniqueId);
    ...
    public static int getRoundedCornerRadiusTopAdjustment(Resources res, String displayUniqueId) throws Resources.NotFoundException {
        int radius;
        int index = DisplayUtils.getDisplayUniqueIdConfigIndex(res, displayUniqueId);
    ...
    public static int getRoundedCornerRadiusBottomAdjustment(Resources res, String displayUniqueId) throws Resources.NotFoundException {
        int radius;
        int index = DisplayUtils.getDisplayUniqueIdConfigIndex(res, displayUniqueId);
    ...
    public static boolean getBuiltInDisplayIsRound(Resources res, String displayUniqueId) throws Resources.NotFoundException {
        boolean isRound;
        int index = DisplayUtils.getDisplayUniqueIdConfigIndex(res, displayUniqueId);
