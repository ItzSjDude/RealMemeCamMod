...
public class WindowlessWindowManager implements IWindowSession {
    ...
    */
    public int relayout(android.view.IWindow r24, android.view.WindowManager.LayoutParams r25, int r26, int r27, int r28, int r29, android.window.ClientWindowFrames r30, android.util.MergedConfiguration r31, android.view.SurfaceControl r32, android.view.InsetsState r33, android.view.InsetsSourceControl[] r34, android.os.Bundle r35) throws java.lang.Throwable {
        /*
            Method dump skipped, instructions count: 222
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: android.view.WindowlessWindowManager.relayout(android.view.IWindow, android.view.WindowManager$LayoutParams, int, int, int, int, android.window.ClientWindowFrames, android.util.MergedConfiguration, android.view.SurfaceControl, android.view.InsetsState, android.view.InsetsSourceControl[], android.os.Bundle):int");
    }
