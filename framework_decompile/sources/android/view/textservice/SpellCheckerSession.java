...
public class SpellCheckerSession {
    ...
    void handleOnGetSuggestionsMultiple(final SuggestionsInfo[] suggestionsInfos) {
        this.mExecutor.execute(new Runnable() { // from class: android.view.textservice.SpellCheckerSession$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.m5612x803f0c65(suggestionsInfos);
            }
        });
    }

    /* renamed from: lambda$handleOnGetSuggestionsMultiple$0$android-view-textservice-SpellCheckerSession, reason: not valid java name */
    /* synthetic */ void m5612x803f0c65(SuggestionsInfo[] suggestionsInfos) {
    ...
    void handleOnGetSentenceSuggestionsMultiple(final SentenceSuggestionsInfo[] suggestionsInfos) {
        this.mExecutor.execute(new Runnable() { // from class: android.view.textservice.SpellCheckerSession$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m5611xf0aab5c7(suggestionsInfos);
            }
        });
    }

    /* renamed from: lambda$handleOnGetSentenceSuggestionsMultiple$1$android-view-textservice-SpellCheckerSession, reason: not valid java name */
    /* synthetic */ void m5611xf0aab5c7(SentenceSuggestionsInfo[] suggestionsInfos) {
