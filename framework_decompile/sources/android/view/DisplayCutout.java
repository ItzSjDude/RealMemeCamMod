...
public final class DisplayCutout {
    ...
    private static String getDisplayCutoutPath(Resources res, String displayUniqueId) throws Resources.NotFoundException {
    ...
    private static String getDisplayCutoutApproximationRect(Resources res, String displayUniqueId) throws Resources.NotFoundException {
        int index = DisplayUtils.getDisplayUniqueIdConfigIndex(res, displayUniqueId);
    ...
    public static boolean getMaskBuiltInDisplayCutout(Resources res, String displayUniqueId) throws Resources.NotFoundException {
        boolean maskCutout;
        int index = DisplayUtils.getDisplayUniqueIdConfigIndex(res, displayUniqueId);
    ...
    public static boolean getFillBuiltInDisplayCutout(Resources res, String displayUniqueId) throws Resources.NotFoundException {
        boolean fillCutout;
        int index = DisplayUtils.getDisplayUniqueIdConfigIndex(res, displayUniqueId);
    ...
    private static Insets getWaterfallInsets(Resources res, String displayUniqueId) throws Resources.NotFoundException {
        Insets insets;
        int index = DisplayUtils.getDisplayUniqueIdConfigIndex(res, displayUniqueId);
