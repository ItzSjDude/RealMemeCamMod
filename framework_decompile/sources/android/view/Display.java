...
public final class Display {
    ...
    public int[] getSupportedColorModes() {
        ...
        synchronized (this.mLock) {
            ...
            iArrCopyOf = Arrays.copyOf(colorModes, colorModes.length);
        }
        return iArrCopyOf;
    }
    ...
    public static final class Mode implements Parcelable {
        ...
        public Mode(int width, int height, float refreshRate) {
            this(-1, width, height, refreshRate, new float[0]);
        }
        ...
        public Mode(int modeId, int width, int height, float refreshRate, float[] alternativeRefreshRates) {
            ...
            float[] fArrCopyOf = Arrays.copyOf(alternativeRefreshRates, alternativeRefreshRates.length);
