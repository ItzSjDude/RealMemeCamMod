...
public class TextureView extends View {
    ...
    public TextureView(Context context) {
        ...
        this.mUpdateListener = new SurfaceTexture.OnFrameAvailableListener() { // from class: android.view.TextureView$$ExternalSyntheticLambda0
            ...
            public final void onFrameAvailable(SurfaceTexture surfaceTexture) {
                this.f$0.m5163lambda$new$0$androidviewTextureView(surfaceTexture);
            }
        };
    }
    ...
    /* renamed from: lambda$new$0$android-view-TextureView, reason: not valid java name */
    /* synthetic */ void m5163lambda$new$0$androidviewTextureView(SurfaceTexture surfaceTexture) {
        updateLayer();
        invalidate();
    }
}
