...
public final class PointerIcon implements Parcelable {
    ...
    public static PointerIcon getSystemIcon(Context context, int type) throws Resources.NotFoundException {
        if (context == null) {
    ...
    public static PointerIcon load(Resources resources, int resourceId) throws Resources.NotFoundException {
        if (resources == null) {
    ...
    public PointerIcon load(Context context) throws Resources.NotFoundException {
        if (context == null) {
            throw new IllegalArgumentException("context must not be null");
        }
    ...
    private void loadResource(Context context, Resources resources, int resourceId) throws Resources.NotFoundException {
        Drawable drawable;
        Drawable drawable2;
