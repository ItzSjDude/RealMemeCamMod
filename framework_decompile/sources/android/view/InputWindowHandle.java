...
public final class InputWindowHandle {
    ...
    public String toString() {
        ...
        return str + ", frame=[" + this.frameLeft + "," + this.frameTop + "," + this.frameRight + "," + this.frameBottom + NavigationBarInflaterView.SIZE_MOD_END + ", touchableRegion=" + this.touchableRegion + ", scaleFactor=" + this.scaleFactor + ", transform=" + this.transform + ", windowToken=" + this.windowToken + ", isClone=" + this.isClone;
    }
    ...
    public IWindow getWindow() {
        ...
        IWindow iWindowAsInterface = IWindow.Stub.asInterface(this.windowToken);
        this.window = iWindowAsInterface;
        return iWindowAsInterface;
    }
