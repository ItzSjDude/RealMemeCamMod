...
public final class TextClassification implements Parcelable {
    ...
    private TextClassification(Parcel in) {
        ...
        ArrayList arrayListCreateTypedArrayList = in.createTypedArrayList(RemoteAction.CREATOR);
        this.mActions = arrayListCreateTypedArrayList;
        if (!arrayListCreateTypedArrayList.isEmpty()) {
            RemoteAction action = (RemoteAction) arrayListCreateTypedArrayList.get(0);
