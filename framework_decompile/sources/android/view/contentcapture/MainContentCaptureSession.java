...
public final class MainContentCaptureSession extends ContentCaptureSession {
    ...
    public void onSessionStarted(int resultCode, IBinder binder) {
        ...
        if (ContentCaptureHelper.sVerbose) {
            String str = TAG;
            StringBuilder sbAppend = new StringBuilder().append("handleSessionStarted() result: id=").append(this.mId).append(" resultCode=").append(resultCode).append(", state=").append(getStateAsString(this.mState)).append(", disabled=").append(this.mDisabled.get()).append(", binder=").append(binder).append(", events=");
            ArrayList<ContentCaptureEvent> arrayList = this.mEvents;
            Log.v(str, sbAppend.append(arrayList != null ? arrayList.size() : 0).toString());
        }
    }

    /* renamed from: lambda$onSessionStarted$1$android-view-contentcapture-MainContentCaptureSession, reason: not valid java name */
    /* synthetic */ void m5454xcc88ed4a() {
    ...
    private void scheduleFlush(final int reason, boolean checkExisting) {
        ...
        if (this.mDisabled.get()) {
            String str = TAG;
            StringBuilder sbAppend = new StringBuilder().append("handleScheduleFlush(").append(getDebugState(reason)).append("): should not be called when disabled. events=");
            ArrayList<ContentCaptureEvent> arrayList = this.mEvents;
            Log.e(str, sbAppend.append(arrayList == null ? null : Integer.valueOf(arrayList.size())).toString());
            return;
        }
    ...
    public void m5455xd6bc414(int reason) {
        ArrayList<ContentCaptureEvent> arrayList = this.mEvents;
    ...
    private void destroySession() {
        if (ContentCaptureHelper.sDebug) {
            String str = TAG;
            StringBuilder sbAppend = new StringBuilder().append("Destroying session (ctx=").append(this.mContext).append(", id=").append(this.mId).append(") with ");
            ArrayList<ContentCaptureEvent> arrayList = this.mEvents;
            Log.d(str, sbAppend.append(arrayList == null ? 0 : arrayList.size()).append(" event(s) for ").append(getDebugState()).toString());
        }
        try {
    ...
    /* synthetic */ void m5443x9f4a2a66(int childSessionId, int parentSessionId, ContentCaptureContext clientContext) {
    ...
    void notifyChildSessionStarted(final int parentSessionId, final int childSessionId, final ContentCaptureContext clientContext) {
        this.mHandler.post(new Runnable() { // from class: android.view.contentcapture.MainContentCaptureSession$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m5443x9f4a2a66(childSessionId, parentSessionId, clientContext);
            }
        });
    }
    ...
    /* synthetic */ void m5442x4a58c458(int childSessionId, int parentSessionId) {
    ...
    void notifyChildSessionFinished(final int parentSessionId, final int childSessionId) {
        this.mHandler.post(new Runnable() { // from class: android.view.contentcapture.MainContentCaptureSession$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m5442x4a58c458(childSessionId, parentSessionId);
            }
        });
    }
    ...
    /* synthetic */ void m5447xe902eee6(int sessionId, ViewNode.ViewStructureImpl node) {
    ...
    void notifyViewAppeared(final int sessionId, final ViewNode.ViewStructureImpl node) {
        this.mHandler.post(new Runnable() { // from class: android.view.contentcapture.MainContentCaptureSession$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m5447xe902eee6(sessionId, node);
            }
        });
    }
    ...
    /* synthetic */ void m5448xa71e8f7f(int sessionId, AutofillId id) {
    ...
    public void notifyViewDisappeared(final int sessionId, final AutofillId id) {
        this.mHandler.post(new Runnable() { // from class: android.view.contentcapture.MainContentCaptureSession$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m5448xa71e8f7f(sessionId, id);
            }
        });
    }
    ...
    void notifyViewTextChanged(final int sessionId, final AutofillId id, CharSequence text) {
        ...
        this.mHandler.post(new Runnable() { // from class: android.view.contentcapture.MainContentCaptureSession$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m5450x41a6b05(sessionId, id, eventText, i, i2, startIndex, endIndex);
            }
        });
    }
    ...
    /* synthetic */ void m5450x41a6b05(int sessionId, AutofillId id, CharSequence eventText, int composingStart, int composingEnd, int startIndex, int endIndex) {
    ...
    /* synthetic */ void m5449xf4241d(int sessionId, Insets viewInsets) {
    ...
    public void notifyViewInsetsChanged(final int sessionId, final Insets viewInsets) {
        this.mHandler.post(new Runnable() { // from class: android.view.contentcapture.MainContentCaptureSession$$ExternalSyntheticLambda13
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m5449xf4241d(sessionId, viewInsets);
            }
        });
    }
    ...
    public void notifyViewTreeEvent(final int sessionId, boolean started) {
        ...
        this.mHandler.post(new Runnable() { // from class: android.view.contentcapture.MainContentCaptureSession$$ExternalSyntheticLambda12
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m5451xc78149c(sessionId, type);
            }
        });
    }
    ...
    /* synthetic */ void m5451xc78149c(int sessionId, int type) {
    ...
    /* synthetic */ void m5446xb0350592(int sessionId) {
    ...
    void notifySessionResumed(final int sessionId) {
        this.mHandler.post(new Runnable() { // from class: android.view.contentcapture.MainContentCaptureSession$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m5446xb0350592(sessionId);
            }
        });
    }
    ...
    /* synthetic */ void m5445x3828e73c(int sessionId) {
    ...
    void notifySessionPaused(final int sessionId) {
        this.mHandler.post(new Runnable() { // from class: android.view.contentcapture.MainContentCaptureSession$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m5445x3828e73c(sessionId);
            }
        });
    }
    ...
    /* synthetic */ void m5444xe96e50c9(int sessionId, ContentCaptureContext context) {
    ...
    void notifyContextUpdated(final int sessionId, final ContentCaptureContext context) {
        this.mHandler.post(new Runnable() { // from class: android.view.contentcapture.MainContentCaptureSession$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m5444xe96e50c9(sessionId, context);
            }
        });
    }
    ...
    /* synthetic */ void m5452x94070ad3(int sessionId, Rect bounds) {
    ...
    public void notifyWindowBoundsChanged(final int sessionId, final Rect bounds) {
        this.mHandler.post(new Runnable() { // from class: android.view.contentcapture.MainContentCaptureSession$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m5452x94070ad3(sessionId, bounds);
            }
        });
    }
