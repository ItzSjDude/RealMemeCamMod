...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int LAST_KEYCODE = 304;
    ...
    public KeyEvent(long time, String characters, int deviceId, int flags) {
        this.mId = nativeNextId();
        this.mDownTime = TimeUnit.NANOSECONDS.convert(time, TimeUnit.MILLISECONDS);
        this.mEventTime = TimeUnit.NANOSECONDS.convert(time, TimeUnit.MILLISECONDS);
    ...
    public static int keyCodeFromString(String symbolicName) throws NumberFormatException {
        try {
