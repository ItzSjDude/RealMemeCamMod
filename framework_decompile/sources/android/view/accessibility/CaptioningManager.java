...
public class CaptioningManager {
    ...
    private class MyContentObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (Settings.Secure.ACCESSIBILITY_CAPTIONING_FONT_SCALE.equals(name)) {
    ...
    public static final class CaptionStyle {
        ...
        private CaptionStyle(int foregroundColor, int backgroundColor, int edgeType, int edgeColor, int windowColor, String rawTypeface) {
            boolean zHasColor = hasColor(foregroundColor);
            this.mHasForegroundColor = zHasColor;
            boolean zHasColor2 = hasColor(backgroundColor);
            this.mHasBackgroundColor = zHasColor2;
            boolean z = edgeType != -1;
            this.mHasEdgeType = z;
            boolean zHasColor3 = hasColor(edgeColor);
            this.mHasEdgeColor = zHasColor3;
            boolean zHasColor4 = hasColor(windowColor);
            this.mHasWindowColor = zHasColor4;
            this.foregroundColor = zHasColor ? foregroundColor : -1;
            this.backgroundColor = zHasColor2 ? backgroundColor : -16777216;
            this.edgeType = z ? edgeType : 0;
            this.edgeColor = zHasColor3 ? edgeColor : -16777216;
            this.windowColor = zHasColor4 ? windowColor : 255;
