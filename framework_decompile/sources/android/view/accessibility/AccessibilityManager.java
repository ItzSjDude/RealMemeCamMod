...
public final class AccessibilityManager {
    ...
    class AnonymousClass1 extends IAccessibilityManagerClient.Stub {
                ...
                for (int i = 0; i < numListeners; i++) {
                    ...
                    ((Executor) AccessibilityManager.this.mServicesStateChangeListeners.valueAt(i)).execute(new Runnable() { // from class: android.view.accessibility.AccessibilityManager$1$$ExternalSyntheticLambda0
                        ...
                        public final void run() {
                            this.f$0.m5344x44c47c4(listener);
                        }
                    });
                }
            }
        ...
        /* renamed from: lambda$notifyServicesStateChanged$0$android-view-accessibility-AccessibilityManager$1, reason: not valid java name */
        /* synthetic */ void m5344x44c47c4(AccessibilityServicesStateChangeListener listener) {
    ...
    public boolean isEnabled() {
        ...
        synchronized (this.mLock) {
            ...
            z = z2 || ((accessibilityPolicy = this.mAccessibilityPolicy) != null && accessibilityPolicy.isEnabled(z2));
        }
        return z;
    }
        ...
        synchronized (this.mLock) {
            ...
            for (int i = 0; i < numListeners; i++) {
                ...
                listeners.valueAt(i).execute(new Runnable() { // from class: android.view.accessibility.AccessibilityManager$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        listener.onAudioDescriptionRequestedChanged(isAudioDescriptionByDefaultRequested);
                    }
                });
            }
        }
