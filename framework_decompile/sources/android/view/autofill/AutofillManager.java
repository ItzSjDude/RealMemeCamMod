...
public final class AutofillManager {
    ...
    public AutofillManager(Context context, IAutoFillManager service) {
        ...
        boolean z = DeviceConfig.getBoolean("autofill", DEVICE_CONFIG_AUTOFILL_DIALOG_ENABLED, false);
        this.mIsFillDialogEnabled = z;
        String[] fillDialogEnabledHints = getFillDialogEnabledHints();
        this.mFillDialogEnabledHints = fillDialogEnabledHints;
        if (Helper.sDebug) {
            Log.d("AutofillManager", "Fill dialog is enabled:" + z + ", hints=" + Arrays.toString(fillDialogEnabledHints));
        }
    ...
    private String[] getFillDialogEnabledHints() {
        ...
        return (String[]) ArrayUtils.filter(dialogHints.split(":"), new IntFunction() { // from class: android.view.autofill.AutofillManager$$ExternalSyntheticLambda3
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
                return AutofillManager.lambda$getFillDialogEnabledHints$0(i);
            }
        }, new Predicate() { // from class: android.view.autofill.AutofillManager$$ExternalSyntheticLambda4
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return AutofillManager.lambda$getFillDialogEnabledHints$1((String) obj);
            }
        });
    }
    ...
    public void onVisibleForAutofill() {
        Choreographer.getInstance().postCallback(4, new Runnable() { // from class: android.view.autofill.AutofillManager$$ExternalSyntheticLambda2
            ...
            public final void run() {
                this.f$0.m5414x84fb5ad9();
            }
        }, null);
    }

    /* renamed from: lambda$onVisibleForAutofill$2$android-view-autofill-AutofillManager, reason: not valid java name */
    /* synthetic */ void m5414x84fb5ad9() {
    ...
    public void notifyViewEnteredForFillDialog(View v) {
        ...
        if (this.mIsFillDialogEnabled || ArrayUtils.containsAny(v.getAutofillHints(), this.mFillDialogEnabledHints)) {
            if (Helper.sDebug) {
                Log.d("AutofillManager", "Trigger fill request at view entered");
            }
    ...
    private AutofillCallback notifyViewEnteredLocked(View view, int flags) {
        ...
        if (!isActiveLocked()) {
            startSessionLocked(id, null, value, flags2);
        } else {
            ...
            updateSessionLocked(id, null, value, 2, flags2);
        }
    ...
    private AutofillCallback notifyViewEnteredLocked(View view, int virtualId, Rect bounds, int flags) {
        ...
        int flags2 = flags | getImeStateFlag(view);
        if (!isActiveLocked()) {
            startSessionLocked(id, bounds, null, flags2);
        } else {
            if (this.mForAugmentedAutofillOnly && (flags2 & 1) != 0) {
                if (Helper.sDebug) {
                    Log.d("AutofillManager", "notifyViewEntered(" + id + "): resetting mForAugmentedAutofillOnly on manual request");
            ...
            updateSessionLocked(id, bounds, null, 2, flags2);
        }
        addEnteredIdLocked(id);
        return null;
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:64:0x01cf A[Catch: TimeoutException -> 0x020a, RemoteException -> 0x020e, TryCatch #4 {RemoteException -> 0x020e, TimeoutException -> 0x020a, blocks: (B:58:0x0188, B:62:0x01a4, B:64:0x01cf, B:65:0x01d1, B:67:0x01dc, B:69:0x01e0, B:71:0x0201, B:73:0x0206), top: B:85:0x0188 }] */
    /* JADX WARN: Removed duplicated region for block: B:67:0x01dc A[Catch: TimeoutException -> 0x020a, RemoteException -> 0x020e, TryCatch #4 {RemoteException -> 0x020e, TimeoutException -> 0x020a, blocks: (B:58:0x0188, B:62:0x01a4, B:64:0x01cf, B:65:0x01d1, B:67:0x01dc, B:69:0x01e0, B:71:0x0201, B:73:0x0206), top: B:85:0x0188 }] */
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void requestShowFillUi(int sessionId, AutofillId id, int width, int height, Rect anchorBounds, IAutofillWindowPresenter presenter) throws Throwable {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void autofill(int sessionId, List<AutofillId> ids, List<AutofillValue> values, boolean hideHighlight) throws Throwable {
        AutofillId id;
        AutofillClient client;
        synchronized (this.mLock) {
            try {
    ...
    public boolean showAutofillDialog(View view) {
        ...
        if (shouldShowAutofillDialog(view, view.getAutofillId())) {
            ...
            post(new Runnable() { // from class: android.view.autofill.AutofillManager$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m5415xcfaa10cb(wrView);
                }
            });
            return true;
        }
    ...
    /* renamed from: lambda$showAutofillDialog$5$android-view-autofill-AutofillManager, reason: not valid java name */
    /* synthetic */ void m5415xcfaa10cb(WeakReference wrView) {
    ...
    public boolean showAutofillDialog(View view, final int virtualId) {
        ...
        if (shouldShowAutofillDialog(view, getAutofillId(view, virtualId))) {
            this.mShowAutofillDialogCalled = true;
            final WeakReference<View> wrView = new WeakReference<>(view);
            post(new Runnable() { // from class: android.view.autofill.AutofillManager$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m5416x98ab080c(wrView, virtualId);
                }
            });
            return true;
        }
    ...
    /* renamed from: lambda$showAutofillDialog$6$android-view-autofill-AutofillManager, reason: not valid java name */
    /* synthetic */ void m5416x98ab080c(WeakReference wrView, int virtualId) {
        View v = (View) wrView.get();
        if (v != null) {
                ...
                if (this.mInvisibleTrackedIds != null) {
                    ...
                    for (int i = 0; i < numInvisibleTrackedIds; i++) {
                        ...
                        if (isVisible[i]) {
                            ...
                            if (Helper.sDebug) {
                                Log.d("AutofillManager", "onVisibleForAutofill() " + id + " became visible");
                            }
                        } else {
            ...
            if (afm != null) {
                afm.post(new Runnable() { // from class: android.view.autofill.AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda2
                    ...
                    public final void run() throws Throwable {
                        afm.autofill(sessionId, ids, values, hideHighlight);
                    }
                });
            }
        }
        ...
        public void autofillContent(final int sessionId, final AutofillId id, final ClipData content) {
            ...
            if (afm != null) {
                afm.post(new Runnable() { // from class: android.view.autofill.AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda8
                    @Override // java.lang.Runnable
                    public final void run() {
                        afm.autofillContent(sessionId, id, content);
                    }
                });
            }
        }
        ...
        public void authenticate(final int sessionId, final int authenticationId, final IntentSender intent, final Intent fillInIntent, final boolean authenticateInline) {
            ...
            if (afm != null) {
                afm.post(new Runnable() { // from class: android.view.autofill.AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        afm.authenticate(sessionId, authenticationId, intent, fillInIntent, authenticateInline);
                    }
                });
            }
        }
        ...
        public void requestShowFillUi(final int sessionId, final AutofillId id, final int width, final int height, final Rect anchorBounds, final IAutofillWindowPresenter presenter) {
            ...
            if (afm != null) {
                afm.post(new Runnable() { // from class: android.view.autofill.AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda14
                    @Override // java.lang.Runnable
                    public final void run() throws Throwable {
                        afm.requestShowFillUi(sessionId, id, width, height, anchorBounds, presenter);
                    }
                });
            }
        }
        ...
        public void requestHideFillUi(int sessionId, final AutofillId id) {
            ...
            if (afm != null) {
                afm.post(new Runnable() { // from class: android.view.autofill.AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda11
                    @Override // java.lang.Runnable
                    public final void run() {
                        afm.requestHideFillUi(id, false);
                    }
                });
            }
        }
        ...
        public void notifyNoFillUi(final int sessionId, final AutofillId id, final int sessionFinishedState) {
            ...
            if (afm != null) {
                afm.post(new Runnable() { // from class: android.view.autofill.AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda12
                    @Override // java.lang.Runnable
                    public final void run() {
                        afm.notifyNoFillUi(sessionId, id, sessionFinishedState);
                    }
                });
            }
        }
        ...
        public void notifyFillUiShown(final int sessionId, final AutofillId id) {
            ...
            if (afm != null) {
                afm.post(new Runnable() { // from class: android.view.autofill.AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda17
                    @Override // java.lang.Runnable
                    public final void run() {
                        afm.notifyCallback(sessionId, id, 1);
                    }
                });
            }
        }
        ...
        public void notifyFillUiHidden(final int sessionId, final AutofillId id) {
            ...
            if (afm != null) {
                afm.post(new Runnable() { // from class: android.view.autofill.AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda15
                    @Override // java.lang.Runnable
                    public final void run() {
                        afm.notifyCallback(sessionId, id, 2);
                    }
                });
            }
        }
        ...
        public void notifyDisableAutofill(final long disableDuration, final ComponentName componentName) throws RemoteException {
            ...
            if (afm != null) {
                afm.post(new Runnable() { // from class: android.view.autofill.AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda9
                    @Override // java.lang.Runnable
                    public final void run() {
                        afm.notifyDisableAutofill(disableDuration, componentName);
                    }
                });
            }
        }
        ...
        public void dispatchUnhandledKey(final int sessionId, final AutofillId id, final KeyEvent fullScreen) {
            ...
            if (afm != null) {
                afm.post(new Runnable() { // from class: android.view.autofill.AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
                        afm.dispatchUnhandledKey(sessionId, id, fullScreen);
                    }
                });
            }
        }
        ...
        public void startIntentSender(final IntentSender intentSender, final Intent intent) {
            ...
            if (afm != null) {
                afm.post(new Runnable() { // from class: android.view.autofill.AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        AutofillManager.AutofillManagerClient.lambda$startIntentSender$11(afm, intentSender, intent);
                    }
                });
            }
        }
        ...
        public void setTrackedViews(final int sessionId, final AutofillId[] ids, final boolean saveOnAllViewsInvisible, final boolean saveOnFinish, final AutofillId[] fillableIds, final AutofillId saveTriggerId) {
            ...
            if (afm != null) {
                afm.post(new Runnable() { // from class: android.view.autofill.AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
                        afm.setTrackedViews(sessionId, ids, saveOnAllViewsInvisible, saveOnFinish, fillableIds, saveTriggerId);
                    }
                });
            }
        }
        ...
        public void setSaveUiState(final int sessionId, final boolean shown) {
            ...
            if (afm != null) {
                afm.post(new Runnable() { // from class: android.view.autofill.AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda16
                    @Override // java.lang.Runnable
                    public final void run() {
                        afm.setSaveUiState(sessionId, shown);
                    }
                });
            }
        }
        ...
        public void setSessionFinished(final int newState, final List<AutofillId> autofillableIds) {
            ...
            if (afm != null) {
                afm.post(new Runnable() { // from class: android.view.autofill.AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
                        afm.setSessionFinished(newState, autofillableIds);
                    }
                });
            }
        }
        ...
        public void getAugmentedAutofillClient(final IResultReceiver result) {
            ...
            if (afm != null) {
                afm.post(new Runnable() { // from class: android.view.autofill.AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda10
                    @Override // java.lang.Runnable
                    public final void run() {
                        afm.getAugmentedAutofillClient(result);
                    }
                });
            }
        }
        ...
        public void notifyFillDialogTriggerIds(final List<AutofillId> ids) {
            ...
            if (afm != null) {
                afm.post(new Runnable() { // from class: android.view.autofill.AutofillManager$AutofillManagerClient$$ExternalSyntheticLambda4
                    @Override // java.lang.Runnable
                    public final void run() {
                        afm.setFillDialogTriggerIds(ids);
                    }
                });
            }
        }
    ...
    static final class AugmentedAutofillManagerClient extends IAugmentedAutofillManagerClient.Stub {
        ...
        public AssistStructure.ViewNodeParcelable getViewNodeParcelable(AutofillId id) throws Resources.NotFoundException {
        ...
        public boolean requestAutofill(int sessionId, AutofillId id) {
            ...
            afm.post(new Runnable() { // from class: android.view.autofill.AutofillManager$AugmentedAutofillManagerClient$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    afm.requestAutofillFromNewSession(view);
                }
            });
            return true;
        }
