...
public class ViewHierarchyEncoder {
    ...
    public void beginObject(Object o) throws IOException {
        startPropertyMap();
    ...
    public void addProperty(String name, boolean v) throws IOException {
        writeShort(createPropertyIndex(name));
        writeBoolean(v);
    }

    public void addProperty(String name, short s) throws IOException {
        writeShort(createPropertyIndex(name));
        writeShort(s);
    }

    public void addProperty(String name, int v) throws IOException {
        writeShort(createPropertyIndex(name));
        writeInt(v);
    }

    public void addProperty(String name, float v) throws IOException {
        writeShort(createPropertyIndex(name));
        writeFloat(v);
    }

    public void addProperty(String name, String s) throws IOException {
        writeShort(createPropertyIndex(name));
        writeString(s);
    }

    public void addUserProperty(String name, String s) throws IOException {
        if (this.mUserPropertiesEnabled) {
            addProperty(name, s);
        }
    }

    public void addPropertyKey(String name) throws IOException {
        writeShort(createPropertyIndex(name));
    }
