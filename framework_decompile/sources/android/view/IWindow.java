...
public interface IWindow extends IInterface {
    ...
    void resized(ClientWindowFrames clientWindowFrames, boolean z, MergedConfiguration mergedConfiguration, InsetsState insetsState, boolean z2, boolean z3, int i, int i2, int i3) throws RemoteException;
    ...
    public static class Default implements IWindow {
        ...
        @Override // android.view.IWindow
        public void resized(ClientWindowFrames frames, boolean reportDraw, MergedConfiguration newMergedConfiguration, InsetsState insetsState, boolean forceLayout, boolean alwaysConsumeSystemBars, int displayId, int syncSeqId, int resizeMode) throws RemoteException {
        }
                ...
                default:
                    switch (code) {
                        ...
                        case 4:
                            ...
                            data.enforceNoDataAvail();
                            showInsets(_arg04, _arg14);
                            return true;
                        case 5:
                            int _arg05 = data.readInt();
                            boolean _arg15 = data.readBoolean();
                            data.enforceNoDataAvail();
                            hideInsets(_arg05, _arg15);
                            return true;
                        case 6:
                        ...
                        case 10:
                            ...
                            data.enforceNoDataAvail();
                            dispatchWallpaperOffsets(_arg09, _arg17, _arg23, _arg32, _arg42, _arg52);
                            return true;
                        case 11:
                            ...
                            data.enforceNoDataAvail();
                            dispatchWallpaperCommand(_arg010, _arg18, _arg24, _arg33, _arg43, _arg53);
                            return true;
                        case 12:
