...
public final class WindowInsets {
    ...
    public WindowInsets insetUnchecked(int left, int top, int right, int bottom) {
        Insets[] insetsArrInsetInsets;
        Insets[] insetsArrInsetInsets2;
        DisplayCutout displayCutoutInset;
        RoundedCorners roundedCornersInset;
        PrivacyIndicatorBounds privacyIndicatorBoundsInset;
        if (this.mSystemWindowInsetsConsumed) {
            insetsArrInsetInsets = null;
        } else {
            insetsArrInsetInsets = insetInsets(this.mTypeInsetsMap, left, top, right, bottom);
        }
        if (this.mStableInsetsConsumed) {
            insetsArrInsetInsets2 = null;
        } else {
            insetsArrInsetInsets2 = insetInsets(this.mTypeMaxInsetsMap, left, top, right, bottom);
        }
        ...
        if (this.mDisplayCutoutConsumed) {
            displayCutoutInset = null;
        } else {
            DisplayCutout displayCutout = this.mDisplayCutout;
            if (displayCutout == null) {
                displayCutoutInset = DisplayCutout.NO_CUTOUT;
            } else {
                displayCutoutInset = displayCutout.inset(left, top, right, bottom);
            }
        }
        RoundedCorners roundedCorners = this.mRoundedCorners;
        if (roundedCorners == null) {
            ...
            roundedCornersInset = roundedCorners.inset(left, top, right, bottom);
        }
        PrivacyIndicatorBounds privacyIndicatorBounds = this.mPrivacyIndicatorBounds;
        if (privacyIndicatorBounds == null) {
            privacyIndicatorBoundsInset = null;
        } else {
            privacyIndicatorBoundsInset = privacyIndicatorBounds.inset(left, top, right, bottom);
        }
        return new WindowInsets(insetsArrInsetInsets, insetsArrInsetInsets2, zArr, z, z2, displayCutoutInset, roundedCornersInset, privacyIndicatorBoundsInset, this.mCompatInsetsTypes, this.mCompatIgnoreVisibility);
    }
