...
public class SurfaceControlViewHost {
    ...
    final class ISurfaceControlViewHostImpl extends ISurfaceControlViewHost.Stub {
        ...
        public void onConfigurationChanged(final Configuration configuration) {
            ...
            SurfaceControlViewHost.this.mViewRoot.mHandler.post(new Runnable() { // from class: android.view.SurfaceControlViewHost$ISurfaceControlViewHostImpl$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    this.f$0.m5144x59fd79eb(configuration);
                }
            });
        }
        ...
        /* synthetic */ void m5144x59fd79eb(Configuration configuration) {
        ...
        /* synthetic */ void m5146x9ebc5175(Rect frame) {
    ...
    private void addConfigCallback(Context c, final Display d) {
        ...
        ViewRootImpl.addConfigCallback(new ViewRootImpl.ConfigChangedCallback() { // from class: android.view.SurfaceControlViewHost$$ExternalSyntheticLambda1
            ...
            public final void onConfigurationChanged(Configuration configuration) {
                SurfaceControlViewHost.lambda$addConfigCallback$0(token, d, configuration);
            }
        });
    }

    static /* synthetic */ void lambda$addConfigCallback$0(IBinder token, Display d, Configuration conf) {
    ...
    public void setView(View view, int width, int height) throws Throwable {
        WindowManager.LayoutParams lp = new WindowManager.LayoutParams(width, height, 2, 0, -2);
        setView(view, lp);
    }

    public void setView(View view, WindowManager.LayoutParams attrs) throws Throwable {
