...
public final class ContentRecordingSession implements Parcelable {
    ...
    ContentRecordingSession(int displayId, int contentToRecord, IBinder tokenToRecord) {
        ...
        AnnotationValidations.validate((Class<? extends Annotation>) VisibleForTesting.class, (Annotation) null, tokenToRecord);
    }
    ...
    public ContentRecordingSession setTokenToRecord(IBinder value) {
        ...
        AnnotationValidations.validate((Class<? extends Annotation>) VisibleForTesting.class, (Annotation) null, value);
        return this;
    }
