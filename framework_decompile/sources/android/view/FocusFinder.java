    ...
    static final class FocusSorter {
        ...
        private Comparator<View> mTopsComparator = new Comparator() { // from class: android.view.FocusFinder$FocusSorter$$ExternalSyntheticLambda0
            ...
            public final int compare(Object obj, Object obj2) {
                return this.f$0.m4945lambda$new$0$androidviewFocusFinder$FocusSorter((View) obj, (View) obj2);
            }
        };
        private Comparator<View> mSidesComparator = new Comparator() { // from class: android.view.FocusFinder$FocusSorter$$ExternalSyntheticLambda1
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return this.f$0.m4946lambda$new$1$androidviewFocusFinder$FocusSorter((View) obj, (View) obj2);
            }
        };
        ...
        /* renamed from: lambda$new$0$android-view-FocusFinder$FocusSorter, reason: not valid java name */
        /* synthetic */ int m4945lambda$new$0$androidviewFocusFinder$FocusSorter(View first, View second) {
            if (first == second) {
                return 0;
            }
        ...
        /* renamed from: lambda$new$1$android-view-FocusFinder$FocusSorter, reason: not valid java name */
        /* synthetic */ int m4946lambda$new$1$androidviewFocusFinder$FocusSorter(View first, View second) {
            if (first == second) {
                return 0;
            }
            Rect firstRect = this.mRectByView.get(first);
