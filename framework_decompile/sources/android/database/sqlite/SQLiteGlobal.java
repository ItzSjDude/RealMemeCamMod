...
public final class SQLiteGlobal {
    ...
    private static final List<String> BenchAppList = Arrays.asList("com.antutu.ABenchMark", "com.antutu.benchmark.full", "com.ludashi.benchmark", "com.andromeda.androbench2");
    ...
    public static String[] getPkgs() {
        ...
        try {
            ...
            Log.e(TAG, "getPackagesForUid failed for uid:" + callingUid, e);
            return null;
        }
    }
    ...
    public static String getDefaultSyncMode() {
        ...
        String[] pkgs = getPkgs();
        if (BenchAppList.contains(pkgs[0])) {
            return "OFF";
        }
