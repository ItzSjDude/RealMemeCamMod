...
public abstract class SQLiteProgram extends SQLiteClosable {
    ...
    SQLiteProgram(SQLiteDatabase db, String sql, Object[] bindArgs, CancellationSignal cancellationSignalForPrepare) {
        this.mDatabase = db;
        String strTrim = sql.trim();
        this.mSql = strTrim;
        int n = DatabaseUtils.getSqlStatementType(strTrim);
        switch (n) {
            case 4:
            case 5:
            case 6:
            ...
            default:
                ...
                db.getThreadSession().prepare(strTrim, db.getThreadDefaultConnectionFlags(assumeReadOnly), cancellationSignalForPrepare, info);
