        ...
        if (handler == null) {
            ...
            handler.post(new Runnable() { // from class: android.database.ContentObserver$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m1039lambda$dispatchChange$0$androiddatabaseContentObserver(selfChange, uris, flags, userId);
                }
            });
        }
    }

    /* renamed from: lambda$dispatchChange$0$android-database-ContentObserver, reason: not valid java name */
    /* synthetic */ void m1039lambda$dispatchChange$0$androiddatabaseContentObserver(boolean selfChange, Collection uris, int flags, int userId) {
