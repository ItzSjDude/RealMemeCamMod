...
public class DatabaseUtils {
    ...
    public static long executeInsert(SQLiteDatabase db, String sql, Object[] bindArgs) throws SQLException {
        ...
        try {
            ...
            long jExecuteInsert = st.executeInsert();
            if (st != null) {
                st.close();
            }
    ...
    public static int executeUpdateDelete(SQLiteDatabase db, String sql, Object[] bindArgs) throws SQLException {
        ...
        try {
            bindArgs(st, bindArgs);
            int iExecuteUpdateDelete = st.executeUpdateDelete();
            if (st != null) {
                st.close();
            }
    ...
    */
    ...
    public static boolean queryIsEmpty(SQLiteDatabase db, String table) throws SQLException {
        long isEmpty = longForQuery(db, "select exists(select 1 from " + table + NavigationBarInflaterView.KEY_CODE_END, null);
        return isEmpty == 0;
    }

    public static long longForQuery(SQLiteDatabase db, String query, String[] selectionArgs) throws SQLException {
    ...
    public static String stringForQuery(SQLiteDatabase db, String query, String[] selectionArgs) throws SQLException {
        SQLiteStatement prog = db.compileStatement(query);
        try {
    ...
    public static ParcelFileDescriptor blobFileDescriptorForQuery(SQLiteDatabase db, String query, String[] selectionArgs) throws SQLException {
        SQLiteStatement prog = db.compileStatement(query);
        try {
    ...
    public static class InsertHelper {
        ...
        public int getColumnIndex(String key) throws SQLException {
            getStatement(false);
    ...
    public static void createDbFromSqlStatements(Context context, String dbName, int dbVersion, String sqlStatements) throws SQLException {
