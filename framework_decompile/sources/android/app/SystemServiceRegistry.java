...
public final class SystemServiceRegistry {
    ...
    static final Class<?> sSocServiceRegistryClass;
    private static ISystemServiceRegistryExt.IStaticExt sStaticExt;
    static ISystemServiceRegistryWrapper sSystemServiceRegistryStaticWrapper;
    ...
    static {
        ...
        sSystemServiceRegistryStaticWrapper = new SystemServiceRegistryWrapper();
        sStaticExt = (ISystemServiceRegistryExt.IStaticExt) ExtLoader.type(ISystemServiceRegistryExt.IStaticExt.class).create();
        ...
        registerService(Context.WALLPAPER_SERVICE, WallpaperManager.class, new CachedServiceFetcher<WallpaperManager>() { // from class: android.app.SystemServiceRegistry.57
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.app.SystemServiceRegistry.CachedServiceFetcher
            public WallpaperManager createService(ContextImpl ctx) throws Resources.NotFoundException, ServiceManager.ServiceNotFoundException {
        ...
        try {
            ...
            if (Build.isMtkPlatform()) {
                sSocServiceRegistryClass = regSocService();
                setSocSystemServiceName();
                registerAllSocService();
                return;
            }
            sSocServiceRegistryClass = null;
        } catch (Throwable th) {
            sInitializing = false;
            throw th;
        }
    ...
    public static <T> void registerService(String serviceName, Class<T> serviceClass, ServiceFetcher<T> serviceFetcher) {
    ...
    public static <TServiceClass> void registerStaticService(final String serviceName, Class<TServiceClass> serviceWrapperClass, final StaticServiceProducerWithBinder<TServiceClass> serviceProducer) {
        ...
        registerService(serviceName, serviceWrapperClass, new StaticServiceFetcher<TServiceClass>() { // from class: android.app.SystemServiceRegistry.134
            @Override // android.app.SystemServiceRegistry.StaticServiceFetcher
            public TServiceClass createService() throws ServiceManager.ServiceNotFoundException {
                return (TServiceClass) serviceProducer.createService(ServiceManager.getServiceOrThrow(serviceName));
            }
        });
    }
    ...
    public static <TServiceClass> void registerStaticService(String serviceName, Class<TServiceClass> serviceWrapperClass, final StaticServiceProducerWithoutBinder<TServiceClass> serviceProducer) {
        ...
        Objects.requireNonNull(serviceWrapperClass);
        Objects.requireNonNull(serviceProducer);
        registerService(serviceName, serviceWrapperClass, new StaticServiceFetcher<TServiceClass>() { // from class: android.app.SystemServiceRegistry.135
            @Override // android.app.SystemServiceRegistry.StaticServiceFetcher
            public TServiceClass createService() {
                return (TServiceClass) serviceProducer.createService();
            }
        });
    }
    ...
    public static <TServiceClass> void registerContextAwareService(final String serviceName, Class<TServiceClass> serviceWrapperClass, final ContextAwareServiceProducerWithBinder<TServiceClass> serviceProducer) {
        ...
        Objects.requireNonNull(serviceWrapperClass);
        Objects.requireNonNull(serviceProducer);
        registerService(serviceName, serviceWrapperClass, new CachedServiceFetcher<TServiceClass>() { // from class: android.app.SystemServiceRegistry.136
            @Override // android.app.SystemServiceRegistry.CachedServiceFetcher
            public TServiceClass createService(ContextImpl contextImpl) throws ServiceManager.ServiceNotFoundException {
                return (TServiceClass) serviceProducer.createService(contextImpl.getOuterContext(), ServiceManager.getServiceOrThrow(serviceName));
            }
        });
    }
    ...
    public static <TServiceClass> void registerContextAwareService(String serviceName, Class<TServiceClass> serviceWrapperClass, final ContextAwareServiceProducerWithoutBinder<TServiceClass> serviceProducer) {
        ...
        Objects.requireNonNull(serviceWrapperClass);
        Objects.requireNonNull(serviceProducer);
        registerService(serviceName, serviceWrapperClass, new CachedServiceFetcher<TServiceClass>() { // from class: android.app.SystemServiceRegistry.137
            @Override // android.app.SystemServiceRegistry.CachedServiceFetcher
            public TServiceClass createService(ContextImpl contextImpl) {
                return (TServiceClass) serviceProducer.createService(contextImpl.getOuterContext());
            }
        });
    }
        ...
        */
        public final T getService(android.app.ContextImpl r11) {
            ...
            L6:
                r4 = 0
                monitor-enter(r0)
                int r5 = r10.mCacheIndex     // Catch: java.lang.Throwable -> L9a
                r6 = r0[r5]     // Catch: java.lang.Throwable -> L9a
                if (r6 == 0) goto L11
                r3 = r6
                monitor-exit(r0)     // Catch: java.lang.Throwable -> L9a
                goto L5e
            L11:
                r7 = r1[r5]     // Catch: java.lang.Throwable -> L9a
                r8 = 2
                if (r7 == r8) goto L1b
                r7 = r1[r5]     // Catch: java.lang.Throwable -> L9a
                r9 = 3
            ...
            L1b:
                r7 = 0
                r1[r5] = r7     // Catch: java.lang.Throwable -> L9a
            L1e:
                r7 = r1[r5]     // Catch: java.lang.Throwable -> L9a
                if (r7 != 0) goto L26
                r4 = 1
            ...
            L26:
                ...
                r5 = 0
                r6 = 3
                java.lang.Object r7 = r10.createService(r11)     // Catch: java.lang.Throwable -> L40 android.os.ServiceManager.ServiceNotFoundException -> L42
                r8 = 2
                monitor-enter(r0)
                int r5 = r10.mCacheIndex     // Catch: java.lang.Throwable -> L3d
                r0[r5] = r7     // Catch: java.lang.Throwable -> L3d
                r1[r5] = r8     // Catch: java.lang.Throwable -> L3d
            ...
            L42:
                r7 = move-exception
                android.app.SystemServiceRegistry.onServiceNotFound(r7)     // Catch: java.lang.Throwable -> L40
                android.app.ISystemServiceRegistryExt$IStaticExt r8 = android.app.SystemServiceRegistry.m482$$Nest$sfgetsStaticExt()     // Catch: java.lang.Throwable -> L40
                int r8 = r8.checkAppPackageName(r6)     // Catch: java.lang.Throwable -> L40
                monitor-enter(r0)
                int r6 = r10.mCacheIndex     // Catch: java.lang.Throwable -> L68
                r0[r6] = r5     // Catch: java.lang.Throwable -> L68
                int r6 = r10.mCacheIndex     // Catch: java.lang.Throwable -> L68
                r1[r6] = r8     // Catch: java.lang.Throwable -> L68
            ...
            L6b:
                monitor-enter(r0)
                int r8 = r10.mCacheIndex     // Catch: java.lang.Throwable -> L77
                r0[r8] = r5     // Catch: java.lang.Throwable -> L77
                r1[r8] = r6     // Catch: java.lang.Throwable -> L77
            ...
            L7a:
                monitor-enter(r0)
            L7b:
                int r5 = r10.mCacheIndex     // Catch: java.lang.Throwable -> L97
                r5 = r1[r5]     // Catch: java.lang.Throwable -> L97
                if (r5 >= r8) goto L94
                boolean r5 = java.lang.Thread.interrupted()     // Catch: java.lang.InterruptedException -> L8a java.lang.Throwable -> L97
                r2 = r2 | r5
                r0.wait()     // Catch: java.lang.InterruptedException -> L8a java.lang.Throwable -> L97
            L89:
                goto L7b
            L8a:
                r5 = move-exception
                ...
                android.util.Slog.w(r6, r7)     // Catch: java.lang.Throwable -> L97
                r2 = 1
                goto L89
            L94:
    ...
    private static Class<?> regSocService() {
        Log.i(TAG, "regSocService start");
        try {
            ...
            Log.e(TAG, "regSocService:" + e.toString());
            return null;
        }
    }

    private static void setSocSystemServiceName() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        Log.i(TAG, "setSocSystemServiceName start");
        try {
            Class<?> cls = sSocServiceRegistryClass;
            if (cls != null) {
            ...
            Log.e(TAG, "setSocSystemServiceName" + e.toString());
        }
    }

    private static void registerAllSocService() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        Log.i(TAG, "registerAllSocService start");
        try {
            Class<?> cls = sSocServiceRegistryClass;
            if (cls != null) {
            ...
            Log.e(TAG, "createSocSystemServer" + e.toString());
        }
    }

    private static class SystemServiceRegistryWrapper implements ISystemServiceRegistryWrapper {
        private SystemServiceRegistryWrapper() {
        }

        @Override // android.app.ISystemServiceRegistryWrapper
        public <T> void registerService(String serviceName, Class<T> serviceClass, ServiceFetcher<T> serviceFetcher) {
            SystemServiceRegistry.registerService(serviceName, serviceClass, serviceFetcher);
        }
    }
}
