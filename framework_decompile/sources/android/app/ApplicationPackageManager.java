...
public class ApplicationPackageManager extends PackageManager {
    ...
    private IApplicationPackageManagerWrapper mAdaptiveIconDrawableWrapper = new ApplicationPackageManagerWrapper();
    ...
    @Override // android.content.pm.PackageManager
    public void requestChecksums(String packageName, boolean includeSplits, int required, List<Certificate> trustedInstallers, final PackageManager.OnChecksumsReadyListener onChecksumsReadyListener) throws Throwable {
    ...
    public List<PackageInfo> getInstalledPackagesAsUser(PackageManager.PackageInfoFlags flags, int userId) {
        try {
            this.mApplicationPackageManagerExt.beforeGetInstalledPackagesOrApplications();
    ...
    @Override // android.content.pm.PackageManager
    public Drawable getDrawable(String packageName, int resId, ApplicationInfo appInfo) throws PackageManager.NameNotFoundException {
    ...
    public Drawable getUserBadgedIcon(Drawable icon, final UserHandle user) {
        ...
        Drawable badgeForeground = getDevicePolicyManager().getResources().getDrawable(getUpdatableUserIconBadgeId(user), DevicePolicyResources.Drawables.Style.SOLID_COLORED, new Supplier() { // from class: android.app.ApplicationPackageManager$$ExternalSyntheticLambda1
            ...
            public final Object get() {
                return this.f$0.m259lambda$getUserBadgedIcon$0$androidappApplicationPackageManager(user);
            }
        });
    ...
    public Drawable m259lambda$getUserBadgedIcon$0$androidappApplicationPackageManager(UserHandle user) {
    ...
    public Drawable getUserBadgeForDensity(final UserHandle user, final int density) {
        ...
        Drawable badgeForeground = getDevicePolicyManager().getResources().getDrawableForDensity(getUpdatableUserBadgeId(user), DevicePolicyResources.Drawables.Style.SOLID_COLORED, density, new Supplier() { // from class: android.app.ApplicationPackageManager$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
                return this.f$0.m257x2715dc54(user, density);
            }
        });
    ...
    public Drawable m257x2715dc54(UserHandle user, int density) {
    ...
    public Drawable getUserBadgeForDensityNoBackground(final UserHandle user, final int density) {
        ...
        Drawable badge = getDevicePolicyManager().getResources().getDrawableForDensity(getUpdatableUserBadgeId(user), DevicePolicyResources.Drawables.Style.SOLID_NOT_COLORED, density, new Supplier() { // from class: android.app.ApplicationPackageManager$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return this.f$0.m258xaa81b184(user, density);
            }
        });
        if (badge != null) {
    ...
    public Drawable m258xaa81b184(UserHandle user, int density) {
    ...
    private long updateFlagsForPackage(long flags, int userId) throws Throwable {
    ...
    private long updateFlagsForComponent(long flags, int userId, Intent intent) throws Throwable {
    ...
    private void onImplicitDirectBoot(int userId) throws Throwable {
    ...
    @Override // android.content.pm.PackageManager
    public CharSequence getText(String packageName, int resid, ApplicationInfo appInfo) throws PackageManager.NameNotFoundException {
        ResourceName name = new ResourceName(packageName, resid);
    ...
    @Override // android.content.pm.PackageManager
    public XmlResourceParser getXml(String packageName, int resid, ApplicationInfo appInfo) throws PackageManager.NameNotFoundException {
        if (appInfo == null) {
            try {
                appInfo = getApplicationInfo(packageName, 1024);
            } catch (PackageManager.NameNotFoundException e) {
    ...
    @Override // android.content.pm.PackageManager
    public void registerDexModule(String dexModule, PackageManager.DexModuleRegisterCallback callback) throws ErrnoException {
    ...
    @Override // android.content.pm.PackageManager
    public boolean canPackageQuery(String sourcePackageName, String targetPackageName) throws Throwable {
    ...
    public IApplicationPackageManagerWrapper getWrapper() {
        return this.mAdaptiveIconDrawableWrapper;
    }

    private class ApplicationPackageManagerWrapper implements IApplicationPackageManagerWrapper {
        private static final String TAG = "ApplicationPackageManagerWrapper";

        private ApplicationPackageManagerWrapper() {
        }

        @Override // android.app.IApplicationPackageManagerWrapper
        public Object newResourceName(String packageName, int iconId) {
            return new ResourceName(packageName, iconId);
        }

        @Override // android.app.IApplicationPackageManagerWrapper
        public Drawable getCachedIcon(Object resourceName) {
            if (resourceName instanceof ResourceName) {
                return ApplicationPackageManager.this.getCachedIcon((ResourceName) resourceName);
            }
            Log.e(TAG, "getCachedIcon resourceName is not ResourceName");
            return null;
        }

        @Override // android.app.IApplicationPackageManagerWrapper
        public void putCachedIcon(Object resourceName, Drawable drawable) {
            if (resourceName instanceof ResourceName) {
                ApplicationPackageManager.this.putCachedIcon((ResourceName) resourceName, drawable);
            } else {
                Log.e(TAG, "putCachedIcon resourceName is not ResourceName");
            }
        }
    }
}
