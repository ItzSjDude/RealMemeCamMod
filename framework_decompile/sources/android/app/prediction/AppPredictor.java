...
public final class AppPredictor {
    ...
    AppPredictor(Context context, AppPredictionContext predictionContext) {
        ...
        IPredictionManager iPredictionManagerAsInterface = IPredictionManager.Stub.asInterface(b);
        ...
        try {
            iPredictionManagerAsInterface.createPredictionSession(predictionContext, appPredictionSessionId, binder);
    ...
    static class CallbackWrapper extends IPredictionCallback.Stub {
        ...
        /* synthetic */ void m617xa10eedfa(ParceledListSlice result) {
