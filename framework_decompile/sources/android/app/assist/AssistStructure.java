...
public class AssistStructure implements Parcelable {
    ...
    public long getAcquisitionStartTime() throws RemoteException {
        ensureData();
        return this.mAcquisitionStartTime;
    }

    public long getAcquisitionEndTime() throws RemoteException {
        ensureData();
    ...
    static final class ParcelTransferWriter extends Binder {
        ...
        ParcelTransferWriter(AssistStructure as, Parcel out) {
            ...
            boolean zWaitForReady = as.waitForReady();
    ...
    final class ParcelTransferReader {
        ...
        Parcel readParcel(int validateToken, int level) throws RemoteException {
        ...
        private void fetchData() throws RemoteException {
            ...
            try {
                ...
                this.mCurParcel = parcelObtain;
                try {
                    this.mChannel.transact(2, data, parcelObtain, 0);
                    data.recycle();
    ...
    public static class WindowNode {
        ...
        WindowNode(AssistStructure assist, ViewRootImpl root, boolean forAutoFill, int flags) throws Resources.NotFoundException {
        ...
        WindowNode(ParcelTransferReader reader) throws RemoteException {
    ...
    public static class ViewNode {
        ...
        ViewNode(ParcelTransferReader reader, int nestingLevel) throws RemoteException {
        ...
        void initializeFromParcelWithoutChildren(Parcel in, PooledStringReader preader, float[] tmpMatrix) {
            ...
            if ((2097152 & flags) != 0) {
                ...
                this.mId = i;
                if (i != -1) {
                    String string = readString(in, preader);
    ...
    public void dump(boolean showSensitive) throws RemoteException {
        ...
        StringBuilder sbAppend = new StringBuilder().append("Activity: ");
        ...
        Log.i(TAG, sbAppend.append(strFlattenToShortString).toString());
    ...
    public int getWindowNodeCount() throws RemoteException {
        ensureData();
        return this.mWindowNodes.size();
    }

    public WindowNode getWindowNodeAt(int index) throws RemoteException {
        ensureData();
    ...
    public void ensureData() throws RemoteException {
        if (this.mHaveData) {
            return;
        }
        this.mHaveData = true;
