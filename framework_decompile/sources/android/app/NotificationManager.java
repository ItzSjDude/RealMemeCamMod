...
public class NotificationManager {
    ...
    public INotificationManagerExt mNotificationManagerExt = (INotificationManagerExt) ExtLoader.type(INotificationManagerExt.class).base(this).create();
    ...
    public static INotificationManager getService() {
        ...
        INotificationManager iNotificationManagerAsInterface = INotificationManager.Stub.asInterface(b);
    ...
    public void notifyAsPackage(String targetPackage, String tag, int id, Notification notification) {
        ...
        try {
            if (localLOGV) {
                Log.v(TAG, sender + ": notify(" + id + ", " + notification + NavigationBarInflaterView.KEY_CODE_END);
            }
    ...
    public void notifyAsUser(String tag, int id, Notification notification, UserHandle user) {
        ...
        try {
            if (localLOGV) {
                Log.v(TAG, pkg + ": notify(" + id + ", " + notification + NavigationBarInflaterView.KEY_CODE_END);
            }
    ...
    private Notification fixNotification(Notification notification) throws Resources.NotFoundException {
        String pkg = this.mContext.getPackageName();
        ...
        this.mNotificationManagerExt.fixTotalCustom(notification);
    ...
    public static class Policy implements Parcelable {
        ...
        public String toString() {
            ...
            return sbAppend.append(str).append(NavigationBarInflaterView.SIZE_MOD_END).toString();
        }
