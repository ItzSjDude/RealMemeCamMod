...
public final class ChangeIdStateCache extends PropertyInvalidatedCache<ChangeIdStateQuery, Boolean> {
    ...
    IPlatformCompat getPlatformCompatService() {
        IPlatformCompat platformCompat2 = this.mPlatformCompat;
        if (platformCompat2 == null) {
            synchronized (this) {
                platformCompat2 = this.mPlatformCompat;
                if (platformCompat2 == null) {
                    platformCompat2 = IPlatformCompat.Stub.asInterface(ServiceManager.getService(Context.PLATFORM_COMPAT_SERVICE));
                    if (platformCompat2 == null) {
                        throw new RuntimeException("Could not get PlatformCompatService instance!");
                    }
                    this.mPlatformCompat = platformCompat2;
                }
            }
        }
        return platformCompat2;
    }
