...
public final class SearchAction implements Parcelable {
    ...
    public String toString() {
        StringBuilder sbAppend = new StringBuilder().append("id=").append(this.mId).append(" title=").append((Object) this.mTitle).append(" contentDescription=").append((Object) this.mContentDescription).append(" subtitle=").append((Object) this.mSubtitle).append(" icon=").append(this.mIcon).append(" pendingIntent=");
        PendingIntent pendingIntent = this.mPendingIntent;
        String str = sbAppend.append(pendingIntent == null ? "" : pendingIntent.getIntent()).append(" intent=").append(this.mIntent).append(" userHandle=").append(this.mUserHandle).toString();
        return str;
    }
