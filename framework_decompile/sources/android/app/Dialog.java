...
public class Dialog implements DialogInterface, Window.Callback, KeyEvent.Callback, View.OnCreateContextMenuListener, Window.OnWindowDismissedCallback {
    ...
    Dialog(Context context, int themeResId, boolean createContextThemeWrapper) {
        ...
        w.setOnWindowSwipeDismissedCallback(new Window.OnWindowSwipeDismissedCallback() { // from class: android.app.Dialog$$ExternalSyntheticLambda1
            ...
            public final void onWindowSwipeDismissed() {
                this.f$0.m261lambda$new$0$androidappDialog();
            }
        });
    ...
    /* renamed from: lambda$new$0$android-app-Dialog, reason: not valid java name */
    /* synthetic */ void m261lambda$new$0$androidappDialog() {
        if (this.mCancelable) {
            cancel();
        }
    }
    ...
    protected void onStart() {
        ...
        if (context != null && WindowOnBackInvokedDispatcher.isOnBackInvokedCallbackEnabled(context)) {
            ...
            getOnBackInvokedDispatcher().registerOnBackInvokedCallback(0, this.mDefaultBackCallback);
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        if (onKeyListener != null && onKeyListener.onKey(this, event.getKeyCode(), event)) {
            this.mDialogExt.logEvent(1, TAG, event, "Handle Key in mOnKeyListener " + this);
            return true;
        }
        ...
        this.mDialogExt.logEvent(1, TAG, event, "Handle Key in self " + this);
        View view = this.mDecor;
