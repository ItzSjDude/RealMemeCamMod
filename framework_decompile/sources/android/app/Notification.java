...
public class Notification implements Parcelable {
    ...
    public static class Action implements Parcelable {
        ...
        private Action(Parcel in) {
            ...
            if (in.readInt() != 0) {
                Icon iconCreateFromParcel = Icon.CREATOR.createFromParcel(in);
        ...
        public static final class WearableExtender implements Extender {
            ...
            /* renamed from: clone, reason: merged with bridge method [inline-methods] */
            public WearableExtender m368clone() {
    ...
    public void cloneInto(Notification that, boolean heavy) {
        ...
        if (heavy && (remoteViews4 = this.tickerView) != null) {
            that.tickerView = remoteViews4.mo393clone();
        }
        if (heavy && (remoteViews3 = this.contentView) != null) {
            that.contentView = remoteViews3.mo393clone();
        }
        ...
        if (actionArr != null) {
            ...
            while (true) {
                ...
                if (action != null) {
                    that.actions[i] = action.m367clone();
                }
                i++;
            }
        }
        if (heavy && (remoteViews2 = this.bigContentView) != null) {
            that.bigContentView = remoteViews2.mo393clone();
        }
        if (heavy && (remoteViews = this.headsUpContentView) != null) {
            that.headsUpContentView = remoteViews.mo393clone();
        }
        ...
        if (collectPendingIntents) {
            PendingIntent.setOnMarshaledListener(new PendingIntent.OnMarshaledListener() { // from class: android.app.Notification$$ExternalSyntheticLambda0
                ...
                public final void onMarshaled(PendingIntent pendingIntent, Parcel parcel2, int i) {
                    this.f$0.m362lambda$writeToParcel$0$androidappNotification(parcel, pendingIntent, parcel2, i);
                }
            });
        }
        try {
    ...
    /* renamed from: lambda$writeToParcel$0$android-app-Notification, reason: not valid java name */
    /* synthetic */ void m362lambda$writeToParcel$0$androidappNotification(Parcel parcel, PendingIntent intent, Parcel out, int outFlags) {
        if (parcel == out) {
            synchronized (this) {
    ...
    @Deprecated
    public void setLatestEventInfo(Context context, CharSequence contentTitle, CharSequence contentText, PendingIntent contentIntent) throws Resources.NotFoundException {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification toAdopt) {
            ...
            if (this.mN.extras.containsKey(Notification.EXTRA_PEOPLE_LIST) && (people = this.mN.extras.getParcelableArrayList(Notification.EXTRA_PEOPLE_LIST)) != null) {
        ...
        @Deprecated
        public Builder setSound(Uri sound, int streamType) throws IllegalArgumentException {
        ...
        private void bindProfileBadge(RemoteViews contentView, StandardTemplateParams p) throws Resources.NotFoundException {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public RemoteViews applyStandardTemplate(int resId, StandardTemplateParams p, TemplateBindResult result) throws Resources.NotFoundException {
            ...
            if (p.text != null && p.text.length() != 0 && (!showProgress || p.mAllowTextWithProgress)) {
                ...
                hasSecondLine = true;
            } else if (p.mTextViewId != 16909583) {
        ...
        private void bindLargeIcon(RemoteViews contentView, StandardTemplateParams p, TemplateBindResult result) {
            ...
            boolean baseMedia = contentView.getLayoutId() == 17367233;
        ...
        private void bindNotificationHeader(RemoteViews contentView, StandardTemplateParams p) throws Resources.NotFoundException {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public RemoteViews applyStandardTemplateWithActions(int layoutId, StandardTemplateParams p, TemplateBindResult result) throws Resources.NotFoundException {
            int i;
        ...
        private boolean fullyCustomViewRequiresDecoration(boolean fromStyle) {
            if (fromStyle && Notification.PLATFORM_STYLE_CLASSES.contains(this.mStyle.getClass())) {
                return false;
            }
            INotificationExt notificationExt = (INotificationExt) ExtLoader.type(INotificationExt.class).create();
            return !notificationExt.isTotalCustom(this.mN) && this.mContext.getApplicationInfo().targetSdkVersion >= 31;
        }

        private RemoteViews minimallyDecoratedContentView(RemoteViews customContent) throws Resources.NotFoundException {
        ...
        private RemoteViews minimallyDecoratedBigContentView(RemoteViews customContent) throws Resources.NotFoundException {
        ...
        private RemoteViews minimallyDecoratedHeadsUpContentView(RemoteViews customContent) throws Resources.NotFoundException {
        ...
        public RemoteViews createBigContentView() throws Resources.NotFoundException {
        ...
        private RemoteViews makeNotificationHeader(StandardTemplateParams p) throws Resources.NotFoundException {
        ...
        public RemoteViews makePublicContentView(boolean isLowPriority) throws Resources.NotFoundException {
        ...
        public RemoteViews makeLowPriorityContentView(boolean useRegularSubtext) throws Resources.NotFoundException {
        ...
        public static Notification maybeCloneStrippedForDelivery(Notification n) {
            ...
            Notification clone = n.m363clone();
            if (stripContentView) {
    ...
    private void reduceImageSizesForRemoteView(RemoteViews remoteView, Context context, boolean isLowRam) throws Resources.NotFoundException {
        int i;
        int i2;
        if (remoteView != null) {
            Resources resources = context.getResources();
    ...
    public static void buildCustomContentIntoTemplate(Context context, RemoteViews template, RemoteViews customContent, StandardTemplateParams p, TemplateBindResult result) {
        ...
        if (customContent != null) {
            RemoteViews customContent2 = customContent.mo393clone();
            if (p.mHeaderless) {
    ...
    public static class MessagingStyle extends Style {
        ...
        private RemoteViews makeMessagingView(int viewType) throws Resources.NotFoundException {
            CharSequence conversationTitle;
            boolean isOneToOne;
            ...
            StandardTemplateParams p = this.mBuilder.mParams.reset().viewType(viewType).highlightExpander(isConversationLayout).hideProgress(true).title(conversationTitle).text(null).hideRightIcon(hideRightIcons || isOneToOne).headerTextSecondary(conversationTitle);
        ...
        public void reduceImageSizes(Context context) throws Resources.NotFoundException {
            ...
            int maxAvatarSize = resources.getDimensionPixelSize(isLowRam ? R.dimen.notification_person_icon_max_size : R.dimen.notification_person_icon_max_size_low_ram);
            Person person = this.mUser;
    ...
    public static class InboxStyle extends Style {
        ...
        */
        public android.widget.RemoteViews makeBigContentView() throws android.content.res.Resources.NotFoundException {
            /*
    ...
    public static class MediaStyle extends Style {
        ...
        protected RemoteViews makeMediaContentView(RemoteViews customContent) throws Resources.NotFoundException {
        ...
        protected RemoteViews makeMediaBigContentView(RemoteViews customContent) throws Resources.NotFoundException {
    ...
    public static class CallStyle extends Style {
        ...
        private Action makeAnswerAction() {
            ...
            return makeAction(z ? R.drawable.ic_call_answer_video : R.drawable.ic_call_answer, z ? 17039840 : 17039839, this.mAnswerButtonColor, R.color.call_notification_answer_color, pendingIntent);
        }
        ...
        private RemoteViews makeCallLayout(int viewType) throws Resources.NotFoundException {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews makeStandardTemplateWithCustomContent(RemoteViews customContent) throws Resources.NotFoundException {
            if (customContent == null) {
                return null;
            }
            TemplateBindResult result = new TemplateBindResult();
        ...
        private RemoteViews makeDecoratedBigContentView() throws Resources.NotFoundException {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m399clone() {
            WearableExtender that = new WearableExtender();
    ...
    private static class BuilderRemoteViews extends RemoteViews {
        ...
        /* renamed from: clone */
        public BuilderRemoteViews mo393clone() {
    ...
    private static class TemplateBindResult {
        ...
        private class MarginSet {
            ...
            public void applyToView(RemoteViews views, int viewId, float extraMarginDp) {
                ...
                } else if (viewId != 16909583 && viewId != 16908822) {
    ...
    public static class Colors {
        ...
        public void resolvePalette(Context ctx, int rawColor, boolean isColorized, boolean nightMode) {
            ...
            if (isColorized) {
                ...
                int iFindAlphaToMeetContrast = ContrastColorUtil.findAlphaToMeetContrast(ContrastColorUtil.resolveSecondaryColor(ctx, this.mBackgroundColor, nightMode), this.mBackgroundColor, 4.5d);
                this.mSecondaryTextColor = iFindAlphaToMeetContrast;
                int i = this.mPrimaryTextColor;
                this.mContrastColor = i;
                this.mPrimaryAccentColor = i;
                this.mSecondaryAccentColor = iFindAlphaToMeetContrast;
                ...
                try {
                    ...
                    int i2 = this.mContrastColor;
                    this.mPrimaryAccentColor = i2;
                    this.mSecondaryAccentColor = i2;
                    this.mErrorColor = this.mPrimaryTextColor;
                } finally {
                }
            }
