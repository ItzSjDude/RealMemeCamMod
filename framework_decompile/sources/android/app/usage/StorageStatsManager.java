...
public class StorageStatsManager {
    ...
    public long getTotalBytes(UUID storageUuid) throws Throwable {
        try {
    ...
    public long getFreeBytes(UUID storageUuid) throws Throwable {
        try {
    ...
    public long getCacheBytes(UUID storageUuid) throws Throwable {
        try {
    ...
    public StorageStats queryStatsForPackage(UUID storageUuid, String packageName, UserHandle user) throws Throwable {
        try {
    ...
    public StorageStats queryStatsForUid(UUID storageUuid, int uid) throws Throwable {
        try {
    ...
    public StorageStats queryStatsForUser(UUID storageUuid, UserHandle user) throws Throwable {
        try {
    ...
    public ExternalStorageStats queryExternalStatsForUser(UUID storageUuid, UserHandle user) throws Throwable {
        try {
    ...
    public Collection<CrateInfo> queryCratesForUid(UUID storageUuid, int uid) throws Throwable {
        try {
    ...
    public Collection<CrateInfo> queryCratesForPackage(UUID storageUuid, String packageName, UserHandle user) throws Throwable {
        try {
    ...
    public Collection<CrateInfo> queryCratesForUser(UUID storageUuid, UserHandle user) throws Throwable {
        try {
