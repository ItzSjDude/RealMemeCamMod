...
public interface IUsageStatsManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUsageStatsManager {
        ...
        static final int TRANSACTION_clearBroadcastEvents = 34;
        static final int TRANSACTION_clearBroadcastResponseStats = 33;
        static final int TRANSACTION_forceUsageSourceSettingRead = 30;
        static final int TRANSACTION_getAppMinStandbyBucket = 16;
        static final int TRANSACTION_getAppStandbyBucket = 12;
        static final int TRANSACTION_getAppStandbyBuckets = 14;
        static final int TRANSACTION_getAppStandbyConstant = 35;
        static final int TRANSACTION_getLastTimeAnyComponentUsed = 31;
        static final int TRANSACTION_getUsageSource = 29;
        static final int TRANSACTION_isAppInactive = 9;
        static final int TRANSACTION_onCarrierPrivilegedAppsChanged = 10;
        static final int TRANSACTION_queryBroadcastResponseStats = 32;
        ...
        static final int TRANSACTION_registerAppUsageLimitObserver = 23;
        static final int TRANSACTION_registerAppUsageObserver = 19;
        static final int TRANSACTION_registerUsageSessionObserver = 21;
        static final int TRANSACTION_reportChooserSelection = 11;
        static final int TRANSACTION_reportPastUsageStart = 26;
        static final int TRANSACTION_reportUsageStart = 25;
        static final int TRANSACTION_reportUsageStop = 27;
        static final int TRANSACTION_reportUserInteraction = 28;
        ...
        static final int TRANSACTION_setEstimatedLaunchTime = 17;
        static final int TRANSACTION_setEstimatedLaunchTimes = 18;
        static final int TRANSACTION_unregisterAppUsageLimitObserver = 24;
        static final int TRANSACTION_unregisterAppUsageObserver = 20;
        static final int TRANSACTION_unregisterUsageSessionObserver = 22;
                ...
                default:
                    switch (code) {
                        ...
                        case 9:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result8 = isAppInactive(_arg09, _arg19, _arg29);
                            reply.writeNoException();
                        ...
                        case 12:
                            ...
                            data.enforceNoDataAvail();
                            int _result9 = getAppStandbyBucket(_arg011, _arg111, _arg211);
                            reply.writeNoException();
                        ...
                        case 14:
                            ...
                            data.enforceNoDataAvail();
                            ParceledListSlice _result10 = getAppStandbyBuckets(_arg013, _arg113);
                            reply.writeNoException();
                        ...
                        case 16:
                            ...
                            data.enforceNoDataAvail();
                            int _result11 = getAppMinStandbyBucket(_arg015, _arg115, _arg213);
                            reply.writeNoException();
                        ...
                        case 31:
                            ...
                            data.enforceNoDataAvail();
                            long _result13 = getLastTimeAnyComponentUsed(_arg028, _arg128);
                            reply.writeNoException();
                        ...
                        case 32:
                            ...
                            data.enforceNoDataAvail();
                            BroadcastResponseStatsList _result14 = queryBroadcastResponseStats(_arg029, _arg129, _arg221, _arg311);
                            reply.writeNoException();
                        ...
                        case 35:
                            ...
                            data.enforceNoDataAvail();
                            String _result15 = getAppStandbyConstant(_arg032);
                            reply.writeNoException();
