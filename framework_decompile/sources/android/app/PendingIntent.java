...
public final class PendingIntent implements Parcelable {
    ...
    private static void checkFlags(int flags, String packageName) {
        ...
        boolean flagMutableSet = (33554432 & flags) != 0;
        ...
        if (Compatibility.isChangeEnabled(PENDING_INTENT_EXPLICIT_MUTABILITY_REQUIRED) && !flagImmutableSet && !flagMutableSet) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            pair.first.execute(new Runnable() { // from class: android.app.PendingIntent$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m415lambda$notifyCancelListeners$0$androidappPendingIntent(pair);
                }
            });
        }
    }

    /* renamed from: lambda$notifyCancelListeners$0$android-app-PendingIntent, reason: not valid java name */
    /* synthetic */ void m415lambda$notifyCancelListeners$0$androidappPendingIntent(Pair pair) {
