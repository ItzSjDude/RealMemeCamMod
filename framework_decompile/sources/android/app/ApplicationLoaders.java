...
public class ApplicationLoaders {
    ...
    private ClassLoader getClassLoader(String zip, int targetSdkVersion, boolean isBundled, String librarySearchPath, String libraryPermittedPath, ClassLoader parent, String cacheKey, String classLoaderName, List<ClassLoader> sharedLibraries, List<String> nativeSharedLibraries, List<ClassLoader> sharedLibrariesLoadedAfterApp) throws Throwable {
        ClassLoader parent2;
    ...
    private void createAndCacheNonBootclasspathSystemClassLoader(SharedLibraryInfo lib) throws Throwable {
    ...
    public ClassLoader getCachedNonBootclasspathSystemLib(String zip, ClassLoader parent, String classLoaderName, List<ClassLoader> sharedLibraries) {
        ...
        if (!sharedLibrariesEquals(sharedLibraries, cached.sharedLibraries)) {
            Log.w(TAG, "Unexpected environment loading cached library " + zip + " (real|cached): (" + sharedLibraries + "|" + cached.sharedLibraries + NavigationBarInflaterView.KEY_CODE_END);
            return null;
        }
