...
public class BlobStoreManager {
    ...
    public Session openSession(long sessionId) throws Throwable {
        try {
    ...
    public void abandonSession(long sessionId) throws Throwable {
        try {
    ...
    public void acquireLease(BlobHandle blobHandle, int descriptionResId, long leaseExpiryTimeMillis) throws Throwable {
        try {
    ...
    public void acquireLease(BlobHandle blobHandle, CharSequence description, long leaseExpiryTimeMillis) throws Throwable {
        try {
    ...
    public void acquireLease(BlobHandle blobHandle, int descriptionResId) throws Throwable {
        acquireLease(blobHandle, descriptionResId, 0L);
    }

    public void acquireLease(BlobHandle blobHandle, CharSequence description) throws Throwable {
    ...
    public List<BlobInfo> queryBlobsForUser(UserHandle user) throws Throwable {
        try {
    ...
    public static class Session implements Closeable {
        ...
        public ParcelFileDescriptor openWrite(long offsetBytes, long lengthBytes) throws Throwable {
            try {
        ...
        public void allowPackageAccess(String packageName, byte[] certificate) throws Throwable {
            try {
        ...
        public boolean isPackageAccessAllowed(String packageName, byte[] certificate) throws Throwable {
            try {
        ...
        public void commit(final Executor executor, final Consumer<Integer> resultCallback) throws Throwable {
            try {
