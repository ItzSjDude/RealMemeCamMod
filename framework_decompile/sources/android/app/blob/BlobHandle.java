...
public final class BlobHandle implements Parcelable {
    ...
    public void dump(IndentingPrintWriter fout, boolean dumpFull) {
        if (dumpFull) {
            ...
            StringBuilder sbAppend = new StringBuilder().append("digest: ");
            byte[] bArr = this.digest;
            fout.println(sbAppend.append(dumpFull ? encodeDigest(bArr) : safeDigest(bArr)).toString());
    ...
    public void writeToXml(XmlSerializer out) throws IllegalStateException, IOException, IllegalArgumentException {
