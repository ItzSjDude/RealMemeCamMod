...
import android.app.dialog.IAlertDialogBuilderWrapper;
...
public class AlertDialog extends Dialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        private IAlertDialogBuilderWrapper mAlertDialogBuilderWrapper;
        ...
        public Builder(Context context, int themeResId) {
            this.mAlertDialogBuilderWrapper = new AlertDialogBuilderWrapper();
        ...
        public IAlertDialogBuilderWrapper getWrapper() {
            return this.mAlertDialogBuilderWrapper;
        }

        private class AlertDialogBuilderWrapper implements IAlertDialogBuilderWrapper {
            private static final String TAG = "AlertDialogBuilderWrapper";

            private AlertDialogBuilderWrapper() {
            }

            @Override // android.app.dialog.IAlertDialogBuilderWrapper
            public IAlertParamsExt getAlertParamsExt(Builder builder) {
                AlertController.AlertParams alertParams;
                if (Builder.this.P != null && builder != null && (alertParams = Builder.this.P) != null && alertParams.getWrapper().getAlertParamsExt() != null) {
                    return alertParams.getWrapper().getAlertParamsExt();
                }
                return null;
            }

            @Override // android.app.dialog.IAlertDialogBuilderWrapper
            public void setDialogType(Builder builder, int dialogType) {
                IAlertParamsExt alertParamsExt = getAlertParamsExt(builder);
                if (alertParamsExt != null) {
                    alertParamsExt.setDialogType(dialogType);
                }
            }

            @Override // android.app.dialog.IAlertDialogBuilderWrapper
            public void setSummaries(Builder builder, CharSequence[] items, CharSequence[] summaryItems) {
                IAlertParamsExt alertParamsExt = getAlertParamsExt(builder);
                if (alertParamsExt != null) {
                    alertParamsExt.setSummaries(summaryItems);
                    alertParamsExt.setItems(items);
                }
            }

            @Override // android.app.dialog.IAlertDialogBuilderWrapper
            public void setMessageNeedScroll(Builder builder, boolean messageNeedScroll) {
                IAlertParamsExt alertParamsExt = getAlertParamsExt(builder);
                if (alertParamsExt != null) {
                    alertParamsExt.setMessageNeedScroll(messageNeedScroll);
                }
            }
        }
    }
