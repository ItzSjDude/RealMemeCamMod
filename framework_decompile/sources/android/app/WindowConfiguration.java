...
public class WindowConfiguration implements Parcelable, Comparable<WindowConfiguration> {
    ...
    public static IWindowConfigurationExt sExtImpl = (IWindowConfigurationExt) ExtLoader.type(IWindowConfigurationExt.class).create();
    ...
    public void readFromProto(ProtoInputStream proto, long fieldId) throws WireTypeMismatchException, IOException {
    ...
    public static boolean inMultiWindowMode(int windowingMode) {
        return (windowingMode == 1 || sExtImpl.isWindowingZoomMode(windowingMode) || sExtImpl.isWindowingComactMode(windowingMode) || sExtImpl.isWindowingBracketMode(windowingMode) || windowingMode == 0) ? false : true;
    }
    ...
    public boolean isAlwaysOnTop() {
        ...
        return i == 5 || sExtImpl.isWindowingZoomMode(i) || this.mWindowingMode == 6;
    }
    ...
    public static String windowingModeToString(int windowingMode) {
        switch (windowingMode) {
            ...
            case 6:
                return "multi-window";
            default:
                if (sExtImpl.isWindowingComactMode(windowingMode)) {
