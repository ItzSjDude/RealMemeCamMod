...
public class TaskInfo {
    ...
    public boolean topActivityInOplusCompatMode;
    ...
    public boolean hasCompatUI() {
        return hasCameraCompatControl() || this.topActivityInSizeCompat || this.topActivityEligibleForLetterboxEducation || this.topActivityInOplusCompatMode;
    }
    ...
    public boolean equalsForCompatUi(TaskInfo that) {
        if (that == null || this.displayId != that.displayId || this.taskId != that.taskId || this.topActivityInSizeCompat != that.topActivityInSizeCompat || this.topActivityInOplusCompatMode != that.topActivityInOplusCompatMode || this.topActivityEligibleForLetterboxEducation != that.topActivityEligibleForLetterboxEducation || this.cameraCompatControlState != that.cameraCompatControlState) {
            return false;
        }
    ...
    void readFromParcel(Parcel source) {
        ...
        this.topActivityInOplusCompatMode = source.readBoolean();
    }
