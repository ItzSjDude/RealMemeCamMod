...
public final class NotificationChannel implements Parcelable {
    ...
    private NotificationChannelWrapper mNcnWrapper;
    private INotificationChannelExt mOplusNotificationChannelExt;
    ...
    public NotificationChannel(String str, CharSequence charSequence, int i) {
        ...
        this.mNcnWrapper = notificationChannelWrapper;
        notificationChannelWrapper.getExtImpl().init(str, charSequence, i);
    ...
    protected NotificationChannel(Parcel parcel) {
        ...
        this.mDeletedTime = -1L;
        this.mOplusNotificationChannelExt = (INotificationChannelExt) ExtLoader.type(INotificationChannelExt.class).base(this).create();
        this.mNcnWrapper = new NotificationChannelWrapper();
        ...
        this.mVibration = jArrCreateLongArray;
        if (jArrCreateLongArray != null && jArrCreateLongArray.length > 1000) {
            this.mVibration = Arrays.copyOf(jArrCreateLongArray, 1000);
        }
        ...
        this.mNcnWrapper.getExtImpl().init(this.mId, this.mName, this.mImportance);
        this.mNcnWrapper.getExtImpl().readFromParcel(parcel);
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        this.mNcnWrapper.getExtImpl().writeToParcel(parcel, i);
    }
    ...
    public void setShowBadge(boolean showBadge) {
        ...
        this.mNcnWrapper.getExtImpl().setTempShowBadge(showBadge);
    }
    ...
    private void populateFromXml(TypedXmlPullParser parser, boolean forRestore, Context context) {
        ...
        this.mNcnWrapper.getExtImpl().populateFromXml(parser);
    }
    ...
    private void writeXml(TypedXmlSerializer out, boolean forBackup, Context context) throws IOException {
        ...
        this.mNcnWrapper.getExtImpl().writeXml(out);
    ...
    public JSONObject toJson() throws JSONException {
        ...
        this.mNcnWrapper.getExtImpl().toJson(record);
        return record;
    }
    ...
    public int hashCode() {
        ...
        return (this.mNcnWrapper.getExtImpl().hashCode(result) * 31) + Arrays.hashCode(this.mVibration);
    }
    ...
    public INotificationChannelWrapper getWrapper() {
        return this.mNcnWrapper;
    }

    private class NotificationChannelWrapper implements INotificationChannelWrapper {
        private NotificationChannelWrapper() {
        }

        @Override // android.app.INotificationChannelWrapper
        public INotificationChannelExt getExtImpl() {
            return NotificationChannel.this.mOplusNotificationChannelExt;
        }
    }
}
