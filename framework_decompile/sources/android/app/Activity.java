...
public class Activity extends ContextThemeWrapper implements LayoutInflater.Factory2, Window.Callback, KeyEvent.Callback, View.OnCreateContextMenuListener, ComponentCallbacks2, Window.OnWindowDismissedCallback, ContentCaptureManager.ContentCaptureClient {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (aheadOfTimeBack) {
            this.mDefaultBackCallback = new OnBackInvokedCallback() { // from class: android.app.Activity.2
                @Override // android.window.OnBackInvokedCallback
                public void onBackInvoked() {
                    Activity.this.navigateBack();
                    Log.d(Activity.TAG, "dispatchKeyEvent to " + this + " will call navigateBack");
                }
            };
    ...
    public boolean enterPictureInPictureMode(PictureInPictureParams params) {
        ...
        boolean zEnterPictureInPictureMode = ActivityClient.getInstance().enterPictureInPictureMode(this.mToken, params);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        boolean handled;
        this.mActivityExt.hookForInputLogIsLevelVerbose("dispatchKeyEvent onKeyDown ev=" + event + ", mDefaultKeyMode=" + this.mDefaultKeyMode);
        if (keyCode == 4) {
    ...
    public void onBackPressed() {
        ...
        if (actionBar != null && actionBar.collapseActionView()) {
            this.mActivityExt.hookForInputLogV(this + "dispatchKey collapseActionView.");
            return;
        }
        FragmentManager fragmentManager = this.mFragments.getFragmentManager();
        if (!fragmentManager.isStateSaved() && fragmentManager.popBackStackImmediate()) {
            this.mActivityExt.hookForInputLogV(this + "dispatchKey popBackStackImmediate.");
        } else {
            navigateBack();
        }
    }
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        this.mActivityExt.debugEventHandled(event, "Handle Key in self " + this);
        if (this.mActivityExt.shouldInterceptBackKeyForMultiSearch(this.mToken, event)) {
            return true;
        }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        this.mActivityExt.osenseSendFling(ev, 20);
        if (ev.getAction() == 0) {
            onUserInteraction();
        }
    ...
    public void startActivityForResult(Intent intent, int requestCode, Bundle options) {
        this.mActivityExt.osenseSetSceneActionIfNeeded(intent, "", "OSENSE_ACTION_ACTIVITY_START", 1200);
        Activity activity = this.mParent;
        if (activity == null) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:12:0x0032 A[Catch: RemoteException -> 0x0060, TryCatch #0 {RemoteException -> 0x0060, blocks: (B:6:0x000e, B:7:0x001d, B:9:0x002a, B:12:0x0032, B:14:0x0038, B:16:0x0051, B:18:0x0056, B:20:0x005a, B:21:0x005f), top: B:29:0x000e }] */
    /* JADX WARN: Removed duplicated region for block: B:13:0x0037  */
    /* JADX WARN: Removed duplicated region for block: B:16:0x0051 A[Catch: RemoteException -> 0x0060, TryCatch #0 {RemoteException -> 0x0060, blocks: (B:6:0x000e, B:7:0x001d, B:9:0x002a, B:12:0x0032, B:14:0x0038, B:16:0x0051, B:18:0x0056, B:20:0x005a, B:21:0x005f), top: B:29:0x000e }] */
    /* JADX WARN: Removed duplicated region for block: B:20:0x005a A[Catch: RemoteException -> 0x0060, TryCatch #0 {RemoteException -> 0x0060, blocks: (B:6:0x000e, B:7:0x001d, B:9:0x002a, B:12:0x0032, B:14:0x0038, B:16:0x0051, B:18:0x0056, B:20:0x005a, B:21:0x005f), top: B:29:0x000e }] */
    /* JADX WARN: Removed duplicated region for block: B:9:0x002a A[Catch: RemoteException -> 0x0060, TryCatch #0 {RemoteException -> 0x0060, blocks: (B:6:0x000e, B:7:0x001d, B:9:0x002a, B:12:0x0032, B:14:0x0038, B:16:0x0051, B:18:0x0056, B:20:0x005a, B:21:0x005f), top: B:29:0x000e }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public void startIntentSenderForResultInner(android.content.IntentSender r17, java.lang.String r18, int r19, android.content.Intent r20, int r21, int r22, android.os.Bundle r23) throws android.content.IntentSender.SendIntentException {
        /*
            r16 = this;
            r1 = r16
            r14 = r20
            r2 = r23
            android.os.Bundle r0 = r1.transferSpringboardActivityOptions(r2)     // Catch: android.os.RemoteException -> L62
            r15 = r0
            r0 = 0
            if (r14 == 0) goto L1d
            r14.migrateExtraStreamToClipData(r1)     // Catch: android.os.RemoteException -> L60
            r14.prepareToLeaveProcess(r1)     // Catch: android.os.RemoteException -> L60
            android.content.ContentResolver r2 = r16.getContentResolver()     // Catch: android.os.RemoteException -> L60
            java.lang.String r2 = r14.resolveTypeIfNeeded(r2)     // Catch: android.os.RemoteException -> L60
            r0 = r2
        L1d:
            android.app.IActivityTaskManager r2 = android.app.ActivityTaskManager.getService()     // Catch: android.os.RemoteException -> L60
            android.app.ActivityThread r3 = r1.mMainThread     // Catch: android.os.RemoteException -> L60
            android.app.ActivityThread$ApplicationThread r3 = r3.getApplicationThread()     // Catch: android.os.RemoteException -> L60
            r13 = 0
            if (r17 == 0) goto L2f
            android.content.IIntentSender r4 = r17.getTarget()     // Catch: android.os.RemoteException -> L60
            goto L30
        L2f:
            r4 = r13
        L30:
            if (r17 == 0) goto L37
            android.os.IBinder r5 = r17.getWhitelistToken()     // Catch: android.os.RemoteException -> L60
            goto L38
        L37:
            r5 = r13
        L38:
            android.os.IBinder r8 = r1.mToken     // Catch: android.os.RemoteException -> L60
            r6 = r20
            r7 = r0
            r9 = r18
            r10 = r19
            ...
            r0 = r13
            r13 = r15
            int r2 = r2.startActivityIntentSender(r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13)     // Catch: android.os.RemoteException -> L60
            r3 = -96
            if (r2 == r3) goto L5a
            android.app.Instrumentation.checkStartActivityResult(r2, r0)     // Catch: android.os.RemoteException -> L60
            if (r15 == 0) goto L59
            r1.cancelInputsAndStartExitTransition(r15)     // Catch: android.os.RemoteException -> L60
        L59:
            goto L64
        L5a:
            android.content.IntentSender$SendIntentException r0 = new android.content.IntentSender$SendIntentException     // Catch: android.os.RemoteException -> L60
            r0.<init>()     // Catch: android.os.RemoteException -> L60
            throw r0     // Catch: android.os.RemoteException -> L60
        L60:
            r0 = move-exception
            goto L64
        L62:
        ...
        L64:
            if (r19 < 0) goto L69
            r0 = 1
            r1.mStartedActivity = r0
        L69:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.app.Activity.startIntentSenderForResultInner(android.content.IntentSender, java.lang.String, int, android.content.Intent, int, int, android.os.Bundle):void");
    }
    ...
    public boolean startActivityIfNeeded(Intent intent, int requestCode, Bundle options) throws RemoteException {
        if (this.mParent == null) {
            int result = 1;
            try {
    ...
    private void finish(int finishTask) {
        int resultCode;
        Intent resultData;
        this.mActivityExt.osenseSetSceneActionForFinish("", "OSENSE_ACTION_ACTIVITY_FINISH", 10);
        Activity activity = this.mParent;
        if (activity == null) {
            synchronized (this) {
    ...
    public void finishAfterTransition() {
        boolean noBackTransition = !this.mActivityTransitionState.startExitBackTransition(this);
        this.mActivityExt.hookForInputLogV(this + "dispatchKey finishAfterTransition, noBackTransition = " + noBackTransition);
        if (noBackTransition) {
            finish();
        }
    }
    ...
    final void performCreate(Bundle icicle, PersistableBundle persistentState) {
        ...
        boolean zInMultiWindowMode = WindowConfiguration.inMultiWindowMode(windowingMode);
        this.mIsInMultiWindowMode = zInMultiWindowMode;
        this.mIsInMultiWindowMode = zInMultiWindowMode | this.mActivityExt.isZoomSupportMultiWindow(this, windowingMode);
