...
public class FullBackup {
    ...
    public static void restoreFile(ParcelFileDescriptor data, long size, int type, long mode, long mtime, File outFile) throws IOException, ErrnoException {
        long j = 0;
        if (type == 2) {
            if (outFile != null) {
                outFile.mkdirs();
    ...
    public static class BackupScheme {
        ...
        private String sharedDomainToPath(String domain) throws NumberFormatException, IOException {
        ...
        private void parseSchemeForOperationType(int operationType) throws XmlPullParserException, PackageManager.NameNotFoundException, IOException {
        ...
        public boolean parseNewBackupSchemeFromXmlLocked(XmlPullParser parser, String configSection, Set<PathWithRequiredFlags> excludes, Map<String, Set<PathWithRequiredFlags>> includes) throws XmlPullParserException, IOException {
        ...
        public void parseBackupSchemeFromXmlLocked(XmlPullParser parser, Set<PathWithRequiredFlags> excludes, Map<String, Set<PathWithRequiredFlags>> includes) throws XmlPullParserException, IOException {
        ...
        private void parseRules(XmlPullParser parser, Set<PathWithRequiredFlags> excludes, Map<String, Set<PathWithRequiredFlags>> includes, Optional<Integer> maybeRequiredFlags, String endingTag) throws XmlPullParserException, IOException {
            while (true) {
                int event = parser.next();
