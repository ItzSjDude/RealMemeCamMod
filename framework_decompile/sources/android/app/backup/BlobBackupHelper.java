...
public abstract class BlobBackupHelper implements BackupHelper {
    ...
    private ArrayMap<String, Long> readOldState(ParcelFileDescriptor oldStateFd) throws IOException {
    ...
    private void writeBackupState(ArrayMap<String, Long> state, ParcelFileDescriptor stateFile) throws IOException {
        try {
    ...
    private byte[] inflate(byte[] compressedData) throws IOException {
    ...
    public void performBackup(ParcelFileDescriptor oldStateFd, BackupDataOutput data, ParcelFileDescriptor newStateFd) throws IOException {
    ...
    @Override // android.app.backup.BackupHelper
    public void writeNewStateDescription(ParcelFileDescriptor newState) throws IOException {
