...
public class JobInfo implements Parcelable {
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        this.mJobInfoExt.writeToParcelJobInfo(parcel, i);
    }
    ...
    public String toString2() {
        return "(job:" + this.jobId + "/" + this.service.getPackageName() + NavigationBarInflaterView.KEY_CODE_END;
    }
    ...
    public static final class Builder {
        ...
        public JobInfo build() {
            return build(Compatibility.isChangeEnabled(JobInfo.DISALLOW_DEADLINES_FOR_PREFETCH_JOBS));
        }
    ...
    public final void enforceValidity(boolean disallowPrefetchDeadlines) {
        ...
        long j3 = this.minimumNetworkChunkBytes;
