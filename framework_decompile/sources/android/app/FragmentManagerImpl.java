...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    static class AnimateOnHWLayerIfNeededListener implements Animator.AnimatorListener {
        ...
        public void onAnimationStart(Animator animation) {
            boolean zShouldRunOnHWLayer = FragmentManagerImpl.shouldRunOnHWLayer(this.mView, animation);
    ...
    Animator loadAnimator(Fragment fragment, int transit, boolean enter, int transitionStyle) throws Resources.NotFoundException {
        int styleIndex;
        Animator anim;
    ...
    */
    void moveToState(final android.app.Fragment r20, int r21, int r22, int r23, boolean r24) throws android.content.res.Resources.NotFoundException {
        /*
    ...
    void moveFragmentToExpectedState(Fragment f) throws Resources.NotFoundException {
        if (f == null) {
            return;
        }
    ...
    void moveToState(int newState, boolean always) throws Resources.NotFoundException {
    ...
    public void addFragment(Fragment fragment, boolean moveToStateNow) throws Resources.NotFoundException {
        if (DEBUG) {
    ...
    public void execSingleAction(OpGenerator action, boolean allowStateLoss) throws Resources.NotFoundException {
    ...
    private void executePostponedTransaction(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop) throws Resources.NotFoundException {
        int index;
        int index2;
        ArrayList<StartEnterTransitionListener> arrayList = this.mPostponedTransactions;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void completeExecute(BackStackRecord record, boolean isPop, boolean runTransitions, boolean moveToState) throws Resources.NotFoundException {
        if (isPop) {
    ...
    private void dispatchMoveToState(int state) throws Resources.NotFoundException {
