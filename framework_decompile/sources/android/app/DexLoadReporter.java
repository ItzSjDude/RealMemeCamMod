...
class DexLoadReporter implements BaseDexClassLoader.Reporter {
    ...
    public void report(Map<String, String> classLoaderContextMap) throws IOException {
    ...
    private void registerSecondaryDexForProfiling(Set<String> dexPaths) throws IOException {
        String[] dataDirs;
    ...
    private void registerSecondaryDexForProfiling(String dexPath, String[] dataDirs) throws IOException {
