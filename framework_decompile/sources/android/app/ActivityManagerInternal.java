...
public abstract class ActivityManagerInternal {
    ...
    public abstract int broadcastIntentInPackage(String str, String str2, int i, int i2, int i3, Intent intent, String str3, IIntentReceiver iIntentReceiver, int i4, String str4, Bundle bundle, String str5, Bundle bundle2, boolean z, boolean z2, int i5, boolean z3, IBinder iBinder, int[] iArr);
