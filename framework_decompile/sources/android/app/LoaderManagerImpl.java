...
class LoaderManagerImpl extends LoaderManager {
    ...
    final class LoaderInfo implements Loader.OnLoadCompleteListener<Object>, Loader.OnLoadCanceledListener<Object> {
        ...
        public void onLoadComplete(Loader<Object> loader, Object data) throws Resources.NotFoundException {
            if (LoaderManagerImpl.DEBUG) {
    ...
    @Override // android.app.LoaderManager
    public void destroyLoader(int id) throws Resources.NotFoundException {
        if (this.mCreatingLoader) {
            throw new IllegalStateException("Called while creating a loader");
        }
        if (DEBUG) {
