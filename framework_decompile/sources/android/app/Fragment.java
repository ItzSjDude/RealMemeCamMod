...
public class Fragment implements ComponentCallbacks2, View.OnCreateContextMenuListener {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) throws Resources.NotFoundException {
    ...
    public LayoutInflater onGetLayoutInflater(Bundle savedInstanceState) throws Resources.NotFoundException {
        FragmentHostCallback fragmentHostCallback = this.mHost;
        if (fragmentHostCallback == null) {
    ...
    LayoutInflater performGetLayoutInflater(Bundle savedInstanceState) throws Resources.NotFoundException {
