...
public final class AmbientContextEvent implements Parcelable {
    ...
    AmbientContextEvent(int eventType, Instant startTime, Instant endTime, int confidenceLevel, int densityLevel) {
    ...
    public static final class Builder {
        ...
        public AmbientContextEvent build() {
            ...
            AmbientContextEvent o = new AmbientContextEvent(this.mEventType, this.mStartTime, this.mEndTime, this.mConfidenceLevel, this.mDensityLevel);
            return o;
        }
