...
public interface ITrustListener extends IInterface {
    void onTrustChanged(boolean z, int i, int i2, List<String> list) throws RemoteException;
    ...
    public static class Default implements ITrustListener {
        ...
        public void onTrustChanged(boolean enabled, int userId, int flags, List<String> trustGrantedMessages) throws RemoteException {
        }
                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            onTrustChanged(_arg0, _arg1, _arg2, _arg3);
                            return true;
                        case 2:
