...
public class AlarmManager {
    ...
    @SystemApi
    public void setPrioritized(int type, long windowStartMillis, long windowLengthMillis, String tag, Executor executor, OnAlarmListener listener) throws Throwable {
    ...
    @SystemApi
    public void setExact(int type, long triggerAtMillis, String tag, Executor executor, WorkSource workSource, OnAlarmListener listener) throws Throwable {
        Objects.requireNonNull(executor);
    ...
    private void setImpl(int type, long triggerAtMillis, long windowMillis, long intervalMillis, int flags, PendingIntent operation, OnAlarmListener listener, String listenerTag, Executor targetExecutor, WorkSource workSource, AlarmClockInfo alarmClock) throws Throwable {
