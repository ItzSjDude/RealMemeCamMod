...
public class EconomyManager {
    ...
    public static final long DEFAULT_AM_HARD_CONSUMPTION_LIMIT_CAKES = arcToCake(15000);
    ...
    public static final long DEFAULT_JS_MAX_SATIATED_BALANCE_CAKES = arcToCake(MediaPlayer.ProvisioningThread.TIMEOUT_MS);
    public static final long DEFAULT_JS_INITIAL_CONSUMPTION_LIMIT_CAKES = arcToCake(29000);
    public static final long DEFAULT_JS_HARD_CONSUMPTION_LIMIT_CAKES = arcToCake(250000);
        ...
        if (val != null) {
            ...
            if (!trunc2.isEmpty()) {
                ...
                if (trunc.endsWith(FullBackup.KEY_VALUE_DATA_TOKEN)) {
                    ...
                    trunc = trunc.substring(0, trunc.length() - 1);
                    multiplier *= TimeUtils.NANOS_PER_MS;
