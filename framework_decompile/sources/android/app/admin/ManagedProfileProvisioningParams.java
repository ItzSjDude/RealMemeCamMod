...
public final class ManagedProfileProvisioningParams implements Parcelable {
    ...
    public String toString() {
        StringBuilder sbAppend = new StringBuilder().append("ManagedProfileProvisioningParams{mProfileAdminComponentName=").append(this.mProfileAdminComponentName).append(", mOwnerName=").append(this.mOwnerName).append(", mProfileName=");
        String str = this.mProfileName;
        if (str == null) {
            str = "null";
        }
        StringBuilder sbAppend2 = sbAppend.append(str).append(", mAccountToMigrate=");
        Account account = this.mAccountToMigrate;
        return sbAppend2.append(account != null ? account : "null").append(", mLeaveAllSystemAppsEnabled=").append(this.mLeaveAllSystemAppsEnabled).append(", mOrganizationOwnedProvisioning=").append(this.mOrganizationOwnedProvisioning).append(", mKeepAccountOnMigration=").append(this.mKeepAccountOnMigration).append(", mAdminExtras=").append(this.mAdminExtras).append('}').toString();
    }
