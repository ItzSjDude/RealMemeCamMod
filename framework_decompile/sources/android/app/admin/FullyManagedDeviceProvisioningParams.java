...
public final class FullyManagedDeviceProvisioningParams implements Parcelable {
    ...
    public String toString() {
        StringBuilder sbAppend = new StringBuilder().append("FullyManagedDeviceProvisioningParams{mDeviceAdminComponentName=").append(this.mDeviceAdminComponentName).append(", mOwnerName=").append(this.mOwnerName).append(", mLeaveAllSystemAppsEnabled=").append(this.mLeaveAllSystemAppsEnabled).append(", mTimeZone=");
        String str = this.mTimeZone;
        if (str == null) {
            str = "null";
        }
        StringBuilder sbAppend2 = sbAppend.append(str).append(", mLocalTime=").append(this.mLocalTime).append(", mLocale=");
        Locale locale = this.mLocale;
        return sbAppend2.append(locale != null ? locale : "null").append(", mDeviceOwnerCanGrantSensorsPermissions=").append(this.mDeviceOwnerCanGrantSensorsPermissions).append(", mAdminExtras=").append(this.mAdminExtras).append(", mDemoDevice=").append(this.mDemoDevice).append('}').toString();
    }
