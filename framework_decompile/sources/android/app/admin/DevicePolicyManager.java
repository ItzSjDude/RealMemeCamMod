...
public class DevicePolicyManager {
    ...
    protected DevicePolicyManager(Context context, IDevicePolicyManager service, boolean parentInstance) {
        ...
        this.mGetKeyGuardDisabledFeaturesCache = new IpcDataCache<>(config.child("getKeyguardDisabledFeatures"), new IpcDataCache.RemoteCall() { // from class: android.app.admin.DevicePolicyManager$$ExternalSyntheticLambda5
            ...
            public final Object apply(Object obj) {
                return this.f$0.m510lambda$new$2$androidappadminDevicePolicyManager((Pair) obj);
            }
        });
        this.mHasDeviceOwnerCache = new IpcDataCache<>(config.child("hasDeviceOwner"), new IpcDataCache.RemoteCall() { // from class: android.app.admin.DevicePolicyManager$$ExternalSyntheticLambda6
            @Override // android.os.IpcDataCache.RemoteCall
            public final Object apply(Object obj) {
                return this.f$0.m511lambda$new$3$androidappadminDevicePolicyManager((Void) obj);
            }
        });
        this.mGetProfileOwnerOrDeviceOwnerSupervisionComponentCache = new IpcDataCache<>(config.child("getProfileOwnerOrDeviceOwnerSupervisionComponent"), new IpcDataCache.RemoteCall() { // from class: android.app.admin.DevicePolicyManager$$ExternalSyntheticLambda7
            @Override // android.os.IpcDataCache.RemoteCall
            public final Object apply(Object obj) {
                return this.f$0.m512lambda$new$4$androidappadminDevicePolicyManager((UserHandle) obj);
            }
        });
        this.mIsOrganizationOwnedDeviceWithManagedProfileCache = new IpcDataCache<>(config.child("isOrganizationOwnedDeviceWithManagedProfile"), new IpcDataCache.RemoteCall() { // from class: android.app.admin.DevicePolicyManager$$ExternalSyntheticLambda8
            @Override // android.os.IpcDataCache.RemoteCall
            public final Object apply(Object obj) {
                return this.f$0.m513lambda$new$5$androidappadminDevicePolicyManager(obj);
            }
        });
        this.mGetDeviceOwnerOrganizationNameCache = new IpcDataCache<>(config.child("getDeviceOwnerOrganizationName"), new IpcDataCache.RemoteCall() { // from class: android.app.admin.DevicePolicyManager$$ExternalSyntheticLambda9
            @Override // android.os.IpcDataCache.RemoteCall
            public final Object apply(Object obj) {
                return this.f$0.m514lambda$new$8$androidappadminDevicePolicyManager(obj);
            }
        });
        this.mGetOrganizationNameForUserCache = new IpcDataCache<>(config.child("getOrganizationNameForUser"), new IpcDataCache.RemoteCall() { // from class: android.app.admin.DevicePolicyManager$$ExternalSyntheticLambda10
            @Override // android.os.IpcDataCache.RemoteCall
            public final Object apply(Object obj) {
                return this.f$0.m515lambda$new$9$androidappadminDevicePolicyManager((Integer) obj);
            }
        });
        this.mIsNetworkLoggingEnabledCache = new IpcDataCache<>(config.child("isNetworkLoggingEnabled"), new IpcDataCache.RemoteCall() { // from class: android.app.admin.DevicePolicyManager$$ExternalSyntheticLambda11
            @Override // android.os.IpcDataCache.RemoteCall
            public final Object apply(Object obj) {
                return this.f$0.m509lambda$new$10$androidappadminDevicePolicyManager((ComponentName) obj);
            }
        });
    ...
    public AttestedKeyPair generateKeyPair(ComponentName admin, String algorithm, KeyGenParameterSpec keySpec, int idAttestationFlags) throws KeyAttestationException {
    ...
    /* renamed from: lambda$new$2$android-app-admin-DevicePolicyManager, reason: not valid java name */
    /* synthetic */ Integer m510lambda$new$2$androidappadminDevicePolicyManager(Pair query) throws RemoteException {
    ...
    public boolean setDeviceOwner(ComponentName who, String ownerName, int userId) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                return iDevicePolicyManager.setDeviceOwner(who, ownerName, userId, true);
            } catch (RemoteException re) {
                throw re.rethrowFromSystemServer();
            }
        }
    ...
    public boolean setDeviceOwnerOnly(ComponentName who, String ownerName, int userId) {
        IDevicePolicyManager iDevicePolicyManager = this.mService;
        if (iDevicePolicyManager == null) {
            return false;
        }
        try {
            return iDevicePolicyManager.setDeviceOwner(who, ownerName, userId, false);
        } catch (RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
    ...
    /* renamed from: lambda$new$3$android-app-admin-DevicePolicyManager, reason: not valid java name */
    /* synthetic */ Boolean m511lambda$new$3$androidappadminDevicePolicyManager(Void query) throws RemoteException {
    ...
    /* renamed from: lambda$new$4$android-app-admin-DevicePolicyManager, reason: not valid java name */
    /* synthetic */ ComponentName m512lambda$new$4$androidappadminDevicePolicyManager(UserHandle arg) throws RemoteException {
    ...
    /* renamed from: lambda$new$5$android-app-admin-DevicePolicyManager, reason: not valid java name */
    /* synthetic */ Object m513lambda$new$5$androidappadminDevicePolicyManager(Object query) throws RemoteException {
    ...
    public Bundle getUserRestrictions(ComponentName admin) throws RemoteException {
        Bundle ret = null;
        IDevicePolicyManager iDevicePolicyManager = this.mService;
        if (iDevicePolicyManager != null) {
            try {
        ...
        try {
            ...
            this.mService.setPermissionGrantState(admin, this.mContext.getPackageName(), packageName, permission, grantState, new RemoteCallback(new RemoteCallback.OnResultListener() { // from class: android.app.admin.DevicePolicyManager$$ExternalSyntheticLambda1
                ...
                public final void onResult(Bundle bundle) {
                    result.complete(Boolean.valueOf(bundle != null));
                }
            }));
    ...
    /* renamed from: lambda$new$8$android-app-admin-DevicePolicyManager, reason: not valid java name */
    /* synthetic */ Object m514lambda$new$8$androidappadminDevicePolicyManager(Object query) throws RemoteException {
    ...
    /* renamed from: lambda$new$9$android-app-admin-DevicePolicyManager, reason: not valid java name */
    /* synthetic */ CharSequence m515lambda$new$9$androidappadminDevicePolicyManager(Integer query) throws RemoteException {
    ...
    /* renamed from: lambda$new$10$android-app-admin-DevicePolicyManager, reason: not valid java name */
    /* synthetic */ Boolean m509lambda$new$10$androidappadminDevicePolicyManager(ComponentName admin) throws RemoteException {
    ...
    class AnonymousClass1 extends IPackageDataObserver.Stub {
        ...
        public void onRemoveCompleted(final String pkg, final boolean succeeded) {
            ...
            executor.execute(new Runnable() { // from class: android.app.admin.DevicePolicyManager$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    onClearApplicationUserDataListener.onApplicationUserDataCleared(pkg, succeeded);
                }
            });
        }
    }
    ...
    public void executeCallback(final int errorCode, final String errorMessage, Executor executor, final InstallSystemUpdateCallback callback) {
        executor.execute(new Runnable() { // from class: android.app.admin.DevicePolicyManager$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                callback.onInstallUpdateError(errorCode, errorMessage);
            }
        });
    }
    ...
    public void setMinimumRequiredWifiSecurityLevel(int level) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                iDevicePolicyManager.setMinimumRequiredWifiSecurityLevel(level);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public void setWifiSsidPolicy(WifiSsidPolicy policy) {
        ...
        try {
            iDevicePolicyManager.setWifiSsidPolicy(policy);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public WifiSsidPolicy getWifiSsidPolicy() {
        ...
        try {
            return iDevicePolicyManager.getWifiSsidPolicy();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
