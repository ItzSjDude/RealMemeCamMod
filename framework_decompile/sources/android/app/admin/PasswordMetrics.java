...
public final class PasswordMetrics implements Parcelable {
    ...
    public void maxWith(PasswordMetrics other) {
        int iMax = Math.max(this.credType, other.credType);
        this.credType = iMax;
        if (iMax != 4 && iMax != 3) {
            return;
        }
    ...
    private static abstract class ComplexityBucket {
        private static final /* synthetic */ ComplexityBucket[] $VALUES;
        ...
        static {
            int i = 0;
            AnonymousClass1 anonymousClass1 = new AnonymousClass1("BUCKET_HIGH", i, 327680);
            BUCKET_HIGH = anonymousClass1;
            AnonymousClass2 anonymousClass2 = new AnonymousClass2("BUCKET_MEDIUM", 1, 196608);
            BUCKET_MEDIUM = anonymousClass2;
            AnonymousClass3 anonymousClass3 = new AnonymousClass3("BUCKET_LOW", 2, 65536);
            BUCKET_LOW = anonymousClass3;
            AnonymousClass4 anonymousClass4 = new AnonymousClass4("BUCKET_NONE", 3, i);
            BUCKET_NONE = anonymousClass4;
            $VALUES = new ComplexityBucket[]{anonymousClass1, anonymousClass2, anonymousClass3, anonymousClass4};
        }
