...
public class DevicePolicyResourcesManager {
    ...
    public Drawable getDrawable(String drawableId, String drawableStyle, String drawableSource, Supplier<Drawable> defaultDrawableLoader) {
        ...
        if (drawableId.equals(DevicePolicyResources.UNDEFINED) || DeviceConfig.getBoolean(DeviceConfig.NAMESPACE_DEVICE_POLICY_MANAGER, DISABLE_RESOURCES_UPDATABILITY_FLAG, DEFAULT_DISABLE_RESOURCES_UPDATABILITY)) {
    ...
    public Icon getDrawableAsIcon(String drawableId, String drawableStyle, String drawableSource, Icon defaultIcon) {
        ...
        if (!drawableId.equals(DevicePolicyResources.UNDEFINED) && !DeviceConfig.getBoolean(DeviceConfig.NAMESPACE_DEVICE_POLICY_MANAGER, DISABLE_RESOURCES_UPDATABILITY_FLAG, DEFAULT_DISABLE_RESOURCES_UPDATABILITY) && (iDevicePolicyManager = this.mService) != null) {
            try {
                ParcelableResource resource = iDevicePolicyManager.getDrawable(drawableId, drawableStyle, drawableSource);
                if (resource == null) {
                    return defaultIcon;
    ...
    public String getString(String stringId, Supplier<String> defaultStringLoader) {
        ...
        if (stringId.equals(DevicePolicyResources.UNDEFINED) || DeviceConfig.getBoolean(DeviceConfig.NAMESPACE_DEVICE_POLICY_MANAGER, DISABLE_RESOURCES_UPDATABILITY_FLAG, DEFAULT_DISABLE_RESOURCES_UPDATABILITY)) {
