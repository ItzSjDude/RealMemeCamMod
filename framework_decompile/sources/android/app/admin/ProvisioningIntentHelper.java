...
final class ProvisioningIntentHelper {
    ...
    private static Intent createProvisioningIntentFromNdefRecord(NdefRecord firstRecord) throws IOException {
    ...
    private static Properties loadPropertiesFromPayload(byte[] payload) throws IOException {
