...
public interface IActivityManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IActivityManager {
        ...
        static final int TRANSACTION_setAalEnabled = 228;
        static final int TRANSACTION_setAalMode = 227;
                ...
                default:
                    switch (code) {
                        ...
                        case 212:
                            ...
                            data.enforceNoDataAvail();
                            setActivityLocusContext(_arg0176, _arg1122, _arg269);
                            reply.writeNoException();
                            return true;
                        case 213:
                            byte[] _arg0177 = data.createByteArray();
                            data.enforceNoDataAvail();
                            setProcessStateSummary(_arg0177);
                            reply.writeNoException();
                            return true;
                        case 214:
                            boolean _result101 = isAppFreezerSupported();
                            reply.writeNoException();
                            reply.writeBoolean(_result101);
                            return true;
                        case 215:
                            boolean _result102 = isAppFreezerEnabled();
                            reply.writeNoException();
                        ...
                        case 216:
                            ...
                            data.enforceNoDataAvail();
                            killUidForPermissionChange(_arg0178, _arg1123, _arg270);
                            reply.writeNoException();
                            return true;
                        case 217:
                            resetAppErrors();
                        ...
                        case 218:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result103 = enableAppFreezer(_arg0179);
                            reply.writeNoException();
                        ...
                        case 219:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result104 = enableFgsNotificationRateLimit(_arg0180);
                            reply.writeNoException();
                            reply.writeBoolean(_result104);
                            return true;
                        case 220:
                            IBinder _arg0181 = data.readStrongBinder();
                            int _arg1124 = data.readInt();
                            data.enforceNoDataAvail();
                            holdLock(_arg0181, _arg1124);
                            reply.writeNoException();
                            return true;
                        case 221:
                            int _arg0182 = data.readInt();
                            data.enforceNoDataAvail();
                            boolean _result105 = startProfile(_arg0182);
                            reply.writeNoException();
                        ...
                        case 222:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result106 = stopProfile(_arg0183);
                            reply.writeNoException();
                            reply.writeBoolean(_result106);
                            return true;
                        case 223:
                            IIntentSender _arg0184 = IIntentSender.Stub.asInterface(data.readStrongBinder());
                            int _arg1125 = data.readInt();
                            data.enforceNoDataAvail();
                            ParceledListSlice _result107 = queryIntentComponentsForIntentSender(_arg0184, _arg1125);
                            reply.writeNoException();
                        ...
                        case 224:
                            ...
                            data.enforceNoDataAvail();
                            int _result108 = getUidProcessCapabilities(_arg0185, _arg1126);
                            reply.writeNoException();
                        ...
                        case 226:
                            ...
                            data.enforceNoDataAvail();
                            int _result109 = getBackgroundRestrictionExemptionReason(_arg0186);
                            reply.writeNoException();
        ...
        private static class Proxy implements IActivityManager {
            ...
            @Override // android.app.IActivityManager
            public int startActivityWithFeature(IApplicationThread caller, String callingPackage, String callingFeatureId, Intent intent, String resolvedType, IBinder resultTo, String resultWho, int requestCode, int flags, ProfilerInfo profilerInfo, Bundle options) throws Throwable {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.app.IActivityManager
            public int broadcastIntent(IApplicationThread caller, Intent intent, String resolvedType, IIntentReceiver resultTo, int resultCode, String resultData, Bundle map, String[] requiredPermissions, int appOp, Bundle options, boolean serialized, boolean sticky, int userId) throws Throwable {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.app.IActivityManager
            public IIntentSender getIntentSenderWithFeature(int type, String packageName, String featureId, IBinder token, String resultWho, int requestCode, Intent[] intents, String[] resolvedTypes, int flags, Bundle options, int userId) throws Throwable {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.app.IActivityManager
            public int startActivityAsUser(IApplicationThread caller, String callingPackage, Intent intent, String resolvedType, IBinder resultTo, String resultWho, int requestCode, int flags, ProfilerInfo profilerInfo, Bundle options, int userId) throws Throwable {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.app.IActivityManager
            public int startActivityAsUserWithFeature(IApplicationThread caller, String callingPackage, String callingFeatureId, Intent intent, String resolvedType, IBinder resultTo, String resultWho, int requestCode, int flags, ProfilerInfo profilerInfo, Bundle options, int userId) throws Throwable {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
