...
public final class CardEmulation {
    ...
    public boolean categoryAllowsForegroundPreference(String category) {
        ...
        try {
            boolean preferForeground = Settings.Secure.getIntForUser(this.mContext.getContentResolver(), Settings.Secure.NFC_PAYMENT_FOREGROUND, UserHandle.myUserId()) != 0;
    ...
    public int getSelectionModeForCategory(String category) throws RemoteException {
