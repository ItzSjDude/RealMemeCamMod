...
public final class NfcFCardEmulation {
    ...
    public static boolean isValidSystemCode(String systemCode) throws NumberFormatException {
        if (systemCode == null) {
            return false;
        }
        ...
        if (!systemCode.startsWith(IOplusUIFirstManager.LAUNCHER_SI_START) || systemCode.toUpperCase().endsWith("FF")) {
            Log.e(TAG, "System Code " + systemCode + " is not a valid System Code.");
            return false;
        }
        try {
    ...
    public static boolean isValidNfcid2(String nfcid2) throws NumberFormatException {
        if (nfcid2 == null) {
            return false;
        }
        if (nfcid2.length() != 16) {
