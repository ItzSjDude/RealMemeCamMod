...
public interface INfcTag extends IInterface {
    ...
    void setTagUpToDate(long j) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements INfcTag {
        ...
        static final int TRANSACTION_isTagUpToDate = 20;
        ...
        static final int TRANSACTION_setTagUpToDate = 19;
                ...
                default:
                    switch (code) {
                        ...
                        case 19:
                            ...
                            data.enforceNoDataAvail();
                            setTagUpToDate(_arg017);
                            reply.writeNoException();
                            return true;
                        case 20:
                            long _arg018 = data.readLong();
                            data.enforceNoDataAvail();
                            boolean _result18 = isTagUpToDate(_arg018);
                            reply.writeNoException();
