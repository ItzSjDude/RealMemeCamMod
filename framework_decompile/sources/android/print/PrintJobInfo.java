...
public final class PrintJobInfo implements Parcelable {
    ...
    public String toString() {
        ...
        builder.append(sbAppend.append(printAttributes != null ? printAttributes.toString() : null).toString());
        StringBuilder sbAppend2 = new StringBuilder().append(", documentInfo: ");
        PrintDocumentInfo printDocumentInfo = this.mDocumentInfo;
        builder.append(sbAppend2.append(printDocumentInfo != null ? printDocumentInfo.toString() : null).toString());
        ...
        builder.append(sbAppend3.append(pageRangeArr != null ? Arrays.toString(pageRangeArr) : null).toString());
        builder.append(", hasAdvancedOptions: " + (this.mAdvancedOptions != null));
        builder.append(", progress: " + this.mProgress);
        StringBuilder sbAppend4 = new StringBuilder().append(", status: ");
        CharSequence charSequence = this.mStatus;
        builder.append(sbAppend4.append(charSequence != null ? charSequence.toString() : null).toString());
        builder.append(", statusRes: " + this.mStatusRes);
        StringBuilder sbAppend5 = new StringBuilder().append(", statusResAppPackageName: ");
        CharSequence charSequence2 = this.mStatusResAppPackageName;
        builder.append(sbAppend5.append(charSequence2 != null ? charSequence2.toString() : null).toString());
        builder.append("}");
