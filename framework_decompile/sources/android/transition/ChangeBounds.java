                ...
                if (parentMatches(startParent, endParent)) {
                    ...
                    if (numChanges > 0) {
                        ...
                        if (changeBounds.mResizeClip) {
                            ...
                            view.setLeftTopRightBottom(startLeft, startTop2, startLeft + maxWidth, startTop2 + maxHeight);
                            if (startLeft == endLeft2 && startTop2 == endTop) {
                                ...
                                positionAnimator = ObjectAnimator.ofObject(view, (Property<View, V>) POSITION_PROPERTY, (TypeConverter) null, topLeftPath);
                            }
                            ...
                            if (startClip2.equals(endClip2)) {
                                ...
                                view.setClipBounds(startClip2);
                                ObjectAnimator clipAnimator2 = ObjectAnimator.ofObject(view, "clipBounds", sRectEvaluator, startClip2, endClip2);
                                ...
                                clipAnimator2.addListener(new AnimatorListenerAdapter() { // from class: android.transition.ChangeBounds.9
                                    ...
                                    public void onAnimationEnd(Animator animation) {
                                        if (!this.mIsCanceled) {
                                            ...
                                            view.setLeftTopRightBottom(endLeft3, endTop, endRight, endBottom);
                                        }
                                    }
                                });
                        ...
                        view.setLeftTopRightBottom(startLeft, startTop2, startRight, startBottom);
                        if (numChanges != 2) {
                            if (startLeft != endLeft2 || startTop2 != endTop) {
                                View view2 = view;
                                Path topLeftPath2 = getPathMotion().getPath(startLeft, startTop2, endLeft2, endTop);
                                return ObjectAnimator.ofObject(view2, (Property<View, V>) TOP_LEFT_ONLY_PROPERTY, (TypeConverter) null, topLeftPath2);
                            }
                            Path bottomRight = getPathMotion().getPath(startRight, startBottom, endRight, endBottom);
                            return ObjectAnimator.ofObject(view, (Property<View, V>) BOTTOM_RIGHT_ONLY_PROPERTY, (TypeConverter) null, bottomRight);
                        }
                        ...
                        return ObjectAnimator.ofObject(view, (Property<View, V>) POSITION_PROPERTY, (TypeConverter) null, topLeftPath4);
                    }
                    return null;
                }
