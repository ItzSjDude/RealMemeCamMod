...
public class Location implements Parcelable {
    ...
    private static final ThreadLocal<BearingDistanceCache> sBearingDistanceCache = ThreadLocal.withInitial(new Supplier() { // from class: android.location.Location$$ExternalSyntheticLambda0
        ...
        public final Object get() {
            return Location.lambda$static$0();
        }
    });
    ...
    static /* synthetic */ BearingDistanceCache lambda$static$0() {
    ...
    public String toString() {
        ...
        if ("eng".equals(Build.TYPE) || "userdebug".equals(Build.TYPE)) {
            ...
            s.append(" ").append(String.format(Locale.ROOT, "%.2f****,%.2f****", Double.valueOf(this.mLatitudeDegrees), Double.valueOf(this.mLongitudeDegrees)));
        }
        if (hasAccuracy()) {
        ...
        if (bundle != null && !bundle.isEmpty() && ("eng".equals(Build.TYPE) || "userdebug".equals(Build.TYPE) || !LocationManager.NETWORK_PROVIDER.equals(this.mProvider))) {
    ...
    public static double convert(String coordinate) throws NumberFormatException {
        boolean negative;
        String coordinate2;
        double min;
