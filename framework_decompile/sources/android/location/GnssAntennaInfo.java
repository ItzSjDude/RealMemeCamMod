...
public final class GnssAntennaInfo implements Parcelable {
    ...
    public static final class SphericalCorrections implements Parcelable {
        ...
        private SphericalCorrections(Parcel in) {
            ...
            double[][] corrections = (double[][]) Array.newInstance((Class<?>) double.class, numRows, numColumns);
            double[][] correctionUncertainties = (double[][]) Array.newInstance((Class<?>) double.class, numRows, numColumns);
