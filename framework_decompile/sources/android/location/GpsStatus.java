...
public final class GpsStatus {
    ...
    private Iterable<GpsSatellite> mSatelliteList = new Iterable() { // from class: android.location.GpsStatus$$ExternalSyntheticLambda0
        ...
        public final Iterator iterator() {
            return this.f$0.m2071lambda$new$0$androidlocationGpsStatus();
        }
    };
    ...
    /* renamed from: lambda$new$0$android-location-GpsStatus, reason: not valid java name */
    /* synthetic */ Iterator m2071lambda$new$0$androidlocationGpsStatus() {
