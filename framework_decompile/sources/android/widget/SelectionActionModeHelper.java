...
public final class SelectionActionModeHelper {
    ...
    public void startSelectionActionModeWithSmartSelectAnimation(final SelectionResult result) {
        ...
        Runnable onAnimationEndCallback = new Runnable() { // from class: android.widget.SelectionActionModeHelper$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m6191x39d123db(result);
            }
        };
        int[] sortedSelectionIndices = sortSelectionIndicesFromTextView(this.mTextView);
        ...
        PointF animationStartPoint = movePointInsideNearestRectangle(touchPoint, selectionRectangles, new SelectionActionModeHelper$$ExternalSyntheticLambda6());
        this.mSmartSelectSprite.startAnimation(animationStartPoint, selectionRectangles, onAnimationEndCallback);
    }

    /* renamed from: lambda$startSelectionActionModeWithSmartSelectAnimation$0$android-widget-SelectionActionModeHelper, reason: not valid java name */
    /* synthetic */ void m6191x39d123db(SelectionResult result) {
    ...
    private List<SmartSelectSprite.RectangleWithTextSelectionLayout> convertSelectionToRectangles(Layout layout, int start, int end) {
        ...
        Layout.SelectionRectangleConsumer consumer = new Layout.SelectionRectangleConsumer() { // from class: android.widget.SelectionActionModeHelper$$ExternalSyntheticLambda5
            @Override // android.text.Layout.SelectionRectangleConsumer
            public final void accept(float f, float f2, float f3, float f4, int i) {
                SelectionActionModeHelper.mergeRectangleIntoList(result, new RectF(f, f2, f3, f4), new SelectionActionModeHelper$$ExternalSyntheticLambda6(), new Function() { // from class: android.widget.SelectionActionModeHelper$$ExternalSyntheticLambda7
        ...
        result.sort(Comparator.comparing(new SelectionActionModeHelper$$ExternalSyntheticLambda6(), SmartSelectSprite.RECTANGLE_COMPARATOR));
        return result;
    }
