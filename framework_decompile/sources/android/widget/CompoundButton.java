...
public abstract class CompoundButton extends Button implements Checkable {
    ...
    public CompoundButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (d != null) {
            m5773lambda$setButtonIconAsync$1$androidwidgetCompoundButton(d);
        }
        if (a.hasValue(3)) {
    ...
    public Runnable setButtonDrawableAsync(int resId) {
        ...
        return new Runnable() { // from class: android.widget.CompoundButton$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.m5772lambda$setButtonDrawableAsync$0$androidwidgetCompoundButton(drawable);
            }
        };
    }
    ...
    public void m5773lambda$setButtonIconAsync$1$androidwidgetCompoundButton(Drawable drawable) {
    ...
    public void setButtonIcon(Icon icon) {
        m5773lambda$setButtonIconAsync$1$androidwidgetCompoundButton(icon == null ? null : icon.loadDrawable(getContext()));
    }
    ...
    public Runnable setButtonIconAsync(Icon icon) {
        ...
        return new Runnable() { // from class: android.widget.CompoundButton$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m5773lambda$setButtonIconAsync$1$androidwidgetCompoundButton(button);
            }
        };
    }
