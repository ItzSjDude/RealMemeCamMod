...
class DatePickerCalendarDelegate extends DatePicker.AbstractDatePickerDelegate {
    ...
    public DatePickerCalendarDelegate(DatePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        View.OnClickListener onClickListener = new View.OnClickListener() { // from class: android.widget.DatePickerCalendarDelegate$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                this.f$0.m5786lambda$new$0$androidwidgetDatePickerCalendarDelegate(view);
            }
        };
    ...
    /* renamed from: lambda$new$0$android-widget-DatePickerCalendarDelegate, reason: not valid java name */
    /* synthetic */ void m5786lambda$new$0$androidwidgetDatePickerCalendarDelegate(View v) {
        tryVibrate();
        switch (v.getId()) {
            case R.id.date_picker_header_date /* 16908944 */:
                setCurrentView(0);
                break;
            case R.id.date_picker_header_year /* 16908945 */:
                setCurrentView(1);
                break;
        }
    }
    ...
    /* renamed from: lambda$setCurrentView$1$android-widget-DatePickerCalendarDelegate, reason: not valid java name */
    /* synthetic */ void m5787x922535ec() {
