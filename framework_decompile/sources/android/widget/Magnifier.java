...
public final class Magnifier {
    ...
    public void show(float sourceCenterX, float sourceCenterY, float magnifierCenterX, float magnifierCenterY) throws Throwable {
        ...
        if (sourceCenterX != this.mPrevShowSourceCoords.x || sourceCenterY != this.mPrevShowSourceCoords.y || this.mDirtyState) {
            ...
            sPixelCopyHandlerThread.getThreadHandler().post(new Runnable() { // from class: android.widget.Magnifier$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    this.f$0.m5936lambda$show$0$androidwidgetMagnifier(currentWindowInstance, windowCoords);
                }
            });
            magnifierCenterX3 = magnifierCenterX2;
            magnifierCenterY3 = magnifierCenterY2;
    ...
    /* renamed from: lambda$show$0$android-widget-Magnifier, reason: not valid java name */
    /* synthetic */ void m5936lambda$show$0$androidwidgetMagnifier(InternalPopupWindow currentWindowInstance, Point windowCoords) {
        synchronized (this.mLock) {
    ...
    private void obtainContentCoordinates(float xPosInView, float yPosInView) {
        ...
        if (this.mIsFishEyeStyle) {
            iMax = Math.max(resolvedLeft2, Math.min(zoomCenterX, resolvedRight2));
        } else {
            int i5 = this.mSourceWidth;
            iMax = Math.max((i5 / 2) + resolvedLeft2, Math.min(zoomCenterX, resolvedRight2 - (i5 / 2)));
        }
        point.x = iMax;
        ...
        if (this.mPixelCopyRequestRect.width() == 0) {
            ...
            PixelCopy.request(this.mContentCopySurface.mSurface, this.mPixelCopyRequestRect, bitmap, new PixelCopy.OnPixelCopyFinishedListener() { // from class: android.widget.Magnifier$$ExternalSyntheticLambda1
                ...
                public final void onPixelCopyFinished(int i) {
                    this.f$0.m5935lambda$performPixelCopy$1$androidwidgetMagnifier(currentWindowInstance, updateWindowPosition, windowCoords, bitmap, i);
                }
            }, sPixelCopyHandlerThread.getThreadHandler());
        }
    }

    /* renamed from: lambda$performPixelCopy$1$android-widget-Magnifier, reason: not valid java name */
    /* synthetic */ void m5935lambda$performPixelCopy$1$androidwidgetMagnifier(InternalPopupWindow currentWindowInstance, boolean updateWindowPosition, Point windowCoords, Bitmap bitmap, int result) {
        if (result != 0) {
            onPixelCopyFailed();
            return;
        }
    ...
    private void onPixelCopyFailed() {
        ...
        Handler.getMain().postAtFrontOfQueue(new Runnable() { // from class: android.widget.Magnifier$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m5934lambda$onPixelCopyFailed$2$androidwidgetMagnifier();
            }
        });
    }

    /* renamed from: lambda$onPixelCopyFailed$2$android-widget-Magnifier, reason: not valid java name */
    /* synthetic */ void m5934lambda$onPixelCopyFailed$2$androidwidgetMagnifier() {
        dismiss();
    ...
    static class InternalPopupWindow {
        ...
        InternalPopupWindow(Context context, Display display, SurfaceControl parentSurfaceControl, int width, int height, float zoom, int ramp, float elevation, float cornerRadius, Drawable overlay, Handler handler, Object lock, Callback callback, boolean isFishEyeStyle) {
            ...
            SurfaceControl surfaceControlBuild = new SurfaceControl.Builder(surfaceSession).setName("magnifier surface").setFlags(4).setContainerLayer().setParent(parentSurfaceControl).setCallsite("InternalPopupWindow").build();
            ...
            BLASTBufferQueue bLASTBufferQueue = new BLASTBufferQueue("magnifier surface", surfaceControlBuild2, surfaceWidth, surfaceHeight, -3);
            ...
            RenderNode renderNodeCreateRenderNodeForBitmap = createRenderNodeForBitmap("magnifier content", elevation, cornerRadius);
            this.mBitmapRenderNode = renderNodeCreateRenderNodeForBitmap;
            RenderNode renderNodeCreateRenderNodeForOverlay = createRenderNodeForOverlay("magnifier overlay", cornerRadius);
            ...
            try {
                canvas.enableZ();
                canvas.drawRenderNode(renderNodeCreateRenderNodeForBitmap);
                canvas.disableZ();
                canvas.drawRenderNode(renderNodeCreateRenderNodeForOverlay);
                canvas.disableZ();
                    ...
                    if (updateWindowPosition || this.mFirstDraw) {
                        ...
                        HardwareRenderer.FrameDrawingCallback callback2 = new HardwareRenderer.FrameDrawingCallback() { // from class: android.widget.Magnifier$InternalPopupWindow$$ExternalSyntheticLambda0
                            ...
                            public final void onFrameDraw(long j) {
                                this.f$0.m5975lambda$doDraw$0$androidwidgetMagnifier$InternalPopupWindow(updateWindowPosition, pendingX, pendingY, firstDraw, j);
                            }
                        };
                        if (!this.mIsFishEyeStyle) {
        ...
        /* renamed from: lambda$doDraw$0$android-widget-Magnifier$InternalPopupWindow, reason: not valid java name */
        /* synthetic */ void m5975lambda$doDraw$0$androidwidgetMagnifier$InternalPopupWindow(boolean updateWindowPosition, int pendingX, int pendingY, boolean firstDraw, long frame) {
            if (!this.mSurface.isValid()) {
                return;
            }
            if (updateWindowPosition) {
