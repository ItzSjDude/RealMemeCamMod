...
public class TextViewTranslationCallback implements ViewTranslationCallback {
    ...
    public boolean onShowTranslation(View view) {
        ...
        runChangeTextWithAnimationIfNeeded(theTextView, new Runnable() { // from class: android.widget.TextViewTranslationCallback$$ExternalSyntheticLambda2
            ...
            public final void run() {
                this.f$0.m6294xcd1a5559(textViewRef, originalTranslationMethod2);
            }
        });
    ...
    /* renamed from: lambda$onShowTranslation$0$android-widget-TextViewTranslationCallback, reason: not valid java name */
    /* synthetic */ void m6294xcd1a5559(WeakReference textViewRef, TransformationMethod transformation) {
    ...
    public boolean onHideTranslation(View view) {
        ...
        if (translationTransformationMethod != null) {
            ...
            runChangeTextWithAnimationIfNeeded(theTextView, new Runnable() { // from class: android.widget.TextViewTranslationCallback$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m6293xabfa2dfd(textViewRef, transformation);
                }
            });
    ...
    /* renamed from: lambda$onHideTranslation$1$android-widget-TextViewTranslationCallback, reason: not valid java name */
    /* synthetic */ void m6293xabfa2dfd(WeakReference textViewRef, TransformationMethod transformation) {
    ...
    private CharSequence computePaddedText(CharSequence text, CharSequence translatedText) {
        int newLength;
        if (translatedText == null || (newLength = translatedText.length()) <= text.length()) {
            return text;
        }
    ...
    private void runChangeTextWithAnimationIfNeeded(final TextView view, final Runnable changeTextRunnable) {
        ...
        ValueAnimator valueAnimatorOfArgb = ValueAnimator.ofArgb(view.getCurrentTextColor(), fadedOutColor);
        this.mAnimator = valueAnimatorOfArgb;
        valueAnimatorOfArgb.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: android.widget.TextViewTranslationCallback$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                view.setTextColor(((Integer) valueAnimator2.getAnimatedValue()).intValue());
            }
        });
