...
public class AutoCompleteTextView extends EditText implements Filter.FilterListener {
    ...
    /* renamed from: lambda$new$0$android-widget-AutoCompleteTextView, reason: not valid java name */
    /* synthetic */ void m5731lambda$new$0$androidwidgetAutoCompleteTextView() {
        if (isPopupShowing()) {
            dismissDropDown();
        }
    }
    ...
    public AutoCompleteTextView(Context context, AttributeSet attributeSet, int i, int i2, Resources.Theme theme) {
        ...
        this.mBackCallback = new OnBackInvokedCallback() { // from class: android.widget.AutoCompleteTextView$$ExternalSyntheticLambda0
            ...
            public final void onBackInvoked() {
                this.f$0.m5731lambda$new$0$androidwidgetAutoCompleteTextView();
            }
        };
        ...
        saveAttributeDataForStyleable(context, R.styleable.AutoCompleteTextView, attributeSet, typedArrayObtainStyledAttributes, i, i2);
        if (theme == null) {
        ...
        if (context2 != context) {
            TypedArray typedArrayObtainStyledAttributes2 = context2.obtainStyledAttributes(attributeSet, R.styleable.AutoCompleteTextView, i, i2);
            saveAttributeDataForStyleable(context, R.styleable.AutoCompleteTextView, attributeSet, typedArrayObtainStyledAttributes, i, i2);
        ...
        if (typedArray != typedArrayObtainStyledAttributes) {
            typedArray.recycle();
        }
        ...
        listPopupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() { // from class: android.widget.AutoCompleteTextView$$ExternalSyntheticLambda1
            ...
            public final void onDismiss() {
                this.f$0.m5732lambda$new$1$androidwidgetAutoCompleteTextView();
            }
        });
        ...
        if (dismissListener != null) {
            wrappedListener = new PopupWindow.OnDismissListener() { // from class: android.widget.AutoCompleteTextView.1
                ...
                public void onDismiss() {
                    ...
                    AutoCompleteTextView.this.m5732lambda$new$1$androidwidgetAutoCompleteTextView();
                }
            };
        }
    ...
    public void m5732lambda$new$1$androidwidgetAutoCompleteTextView() {
