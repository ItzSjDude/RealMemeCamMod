...
public class TextInputTimePickerView extends RelativeLayout {
    ...
    public boolean parseAndSetHourInternal(String input) throws NumberFormatException {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean parseAndSetMinuteInternal(String input) throws NumberFormatException {
        try {
