...
public class OverScroller {
    ...
    static class SplineOverScroller {
        ...
        void finish() {
            ...
            if (iOverScrollerSocExt != null) {
                iOverScrollerSocExt.hookScrollPerfHint(this, false);
            }
        ...
        void fling(int start, int velocity, int min, int max, int over) {
            ...
            if (velocity != 0) {
                int iIntValue = this.mSplineOverScrollerExt.hookEndFling(this.mContext, velocity, this.mFlingFriction).first.intValue();
                this.mSplineDuration = iIntValue;
            ...
            int iSignum = (int) (Math.signum(velocity) * totalDistance);
