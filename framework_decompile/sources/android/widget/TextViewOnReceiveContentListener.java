...
public final class TextViewOnReceiveContentListener implements OnReceiveContentListener {
    ...
    public ContentInfo onReceiveContent(View view, ContentInfo payload) throws FileNotFoundException {
    ...
    private void onReceiveForAutofill(TextView view, ContentInfo payload) throws FileNotFoundException {
        ClipData clip = payload.getClip();
    ...
    private static CharSequence coerceToText(ClipData clip, Context context, int flags) throws FileNotFoundException {
        CharSequence itemText;
