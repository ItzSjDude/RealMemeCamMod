...
class CalendarViewLegacyDelegate extends CalendarView.AbstractCalendarViewDelegate {
    ...
    CalendarViewLegacyDelegate(CalendarView delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) throws Resources.NotFoundException {
    ...
    public void setWeekDayTextAppearance(int resourceId) throws Resources.NotFoundException {
    ...
    @Override // android.widget.CalendarView.CalendarViewDelegate
    public void setDateTextAppearance(int resourceId) throws Resources.NotFoundException {
    ...
    @Override // android.widget.CalendarView.AbstractCalendarViewDelegate, android.widget.CalendarView.CalendarViewDelegate
    public void setShowWeekNumber(boolean showWeekNumber) throws Resources.NotFoundException {
    ...
    @Override // android.widget.CalendarView.CalendarViewDelegate
    public void setFirstDayOfWeek(int firstDayOfWeek) throws Resources.NotFoundException {
