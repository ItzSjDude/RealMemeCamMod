...
public class RadialTimePickerView extends View {
    ...
    public RadialTimePickerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mTextSize = new int[]{res.getDimensionPixelSize(R.dimen.timepicker_text_size_normal), res.getDimensionPixelSize(R.dimen.timepicker_text_size_normal), res.getDimensionPixelSize(R.dimen.timepicker_text_size_inner)};
        this.mTextInset = new int[]{res.getDimensionPixelSize(R.dimen.timepicker_text_inset_normal), res.getDimensionPixelSize(R.dimen.timepicker_text_inset_normal), res.getDimensionPixelSize(R.dimen.timepicker_text_inset_inner)};
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        this.mMinDistForInnerNumber = (iMin - i) - i2;
        int i3 = iArr[0];
        this.mMaxDistForOuterNumber = (iMin - i3) + i2;
        this.mHalfwayDist = iMin - ((i3 + i) / 2);
    ...
    private void animatePicker(boolean hoursToMinutes, long duration) {
        ...
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this, this.HOURS_TO_MINUTES, target);
