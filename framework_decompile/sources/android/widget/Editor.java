...
public class Editor {
    ...
    Editor(TextView textView) {
        ...
        this.mBackCallback = new OnBackInvokedCallback() { // from class: android.widget.Editor$$ExternalSyntheticLambda2
            ...
            public final void onBackInvoked() {
                this.f$0.m5873lambda$startActionModeInternal$0$androidwidgetEditor();
            }
        };
    ...
    private void unregisterOnBackInvokedCallback() {
        ...
        if (this.mBackCallbackRegistered && (viewRootImpl = getTextView().getViewRootImpl()) != null && WindowOnBackInvokedDispatcher.isOnBackInvokedCallbackEnabled(viewRootImpl.mContext)) {
    ...
    private void registerOnBackInvokedCallback() {
        ViewRootImpl viewRootImpl;
        if (!this.mBackCallbackRegistered && (viewRootImpl = this.mTextView.getViewRootImpl()) != null && WindowOnBackInvokedDispatcher.isOnBackInvokedCallbackEnabled(viewRootImpl.mContext)) {
    ...
    public void setError(CharSequence error, Drawable icon) {
        CharSequence charSequenceStringOrSpannedString = TextUtils.stringOrSpannedString(error);
    ...
    void prepareCursorControllers() {
        ...
        if (!this.mSelectionControllerEnabled) {
            m5873lambda$startActionModeInternal$0$androidwidgetEditor();
            SelectionModifierCursorController selectionModifierCursorController = this.mSelectionModifierCursorController;
            if (selectionModifierCursorController != null) {
                selectionModifierCursorController.onDetached();
    ...
    private void chooseSize(PopupWindow pop, CharSequence text, TextView tv) throws Resources.NotFoundException {
    ...
    public void m5873lambda$startActionModeInternal$0$androidwidgetEditor() {
        ActionMode actionMode = this.mTextActionMode;
        if (actionMode != null) {
            actionMode.finish();
        }
    ...
    private View.DragShadowBuilder getTextThumbnailBuilder(int start, int end) throws Resources.NotFoundException {
    ...
    private class EasyEditPopupWindow extends PinnedPopupWindow implements View.OnClickListener {
        private static final int POPUP_TEXT_LAYOUT = 17367346;
        ...
        protected void initContentView() {
            ...
            TextView textView = (TextView) inflater.inflate(17367346, (ViewGroup) null);
    ...
    private final class SuggestionsPopupWindow extends PinnedPopupWindow implements AdapterView.OnItemClickListener {
        ...
        @Override // android.widget.Editor.PinnedPopupWindow
        protected void setUp() {
            Context contextApplyDefaultTheme = applyDefaultTheme(Editor.this.mTextView.getContext());
            this.mContext = contextApplyDefaultTheme;
            this.mHighlightSpan = new TextAppearanceSpan(contextApplyDefaultTheme, Editor.this.mTextView.mTextEditSuggestionHighlightStyle);
        }
    ...
    private class TextActionModeCallback extends ActionMode.Callback2 {
        ...
        private boolean onAssistMenuItemClicked(MenuItem assistMenuItem) {
            ...
            if (onClickListener != null) {
                ...
                Editor.this.m5873lambda$startActionModeInternal$0$androidwidgetEditor();
            }
            return true;
        }
    ...
    private final class CursorAnchorInfoNotifier implements TextViewPositionListener {
        ...
        public void updatePosition(int parentPositionX, int parentPositionY, boolean parentPositionChanged, boolean parentScrolled) {
            ...
            boolean includeEditorBounds = (mode & 4) != 0;
            boolean includeCharacterBounds = (mode & 8) != 0;
            boolean includeInsertionMarker = (mode & 16) != 0;
            boolean includeAll = (includeEditorBounds || includeCharacterBounds || includeInsertionMarker) ? false : true;
            ...
            builder2.reset();
            int selectionStart2 = Editor.this.mTextView.getSelectionStart();
            builder2.setSelectionRange(selectionStart2, Editor.this.mTextView.getSelectionEnd());
            ...
            if (includeEditorBounds2) {
                ...
                bounds.set(0.0f, 0.0f, Editor.this.mTextView.getWidth(), Editor.this.mTextView.getHeight());
                EditorBoundsInfo.Builder boundsBuilder = new EditorBoundsInfo.Builder();
                builder2.setEditorBoundsInfo(boundsBuilder.setEditorBounds(bounds).build());
            }
            if (includeCharacterBounds2 || includeInsertionMarker2) {
                float viewportToContentHorizontalOffset = Editor.this.mTextView.viewportToContentHorizontalOffset();
                float viewportToContentVerticalOffset2 = Editor.this.mTextView.viewportToContentVerticalOffset();
                if (includeCharacterBounds2) {
        ...
        private MagnifierMotionAnimator(Magnifier magnifier) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: android.widget.Editor$MagnifierMotionAnimator$$ExternalSyntheticLambda0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    this.f$0.m5891lambda$new$0$androidwidgetEditor$MagnifierMotionAnimator(valueAnimator);
                }
            });
        }

        /* renamed from: lambda$new$0$android-widget-Editor$MagnifierMotionAnimator, reason: not valid java name */
        /* synthetic */ void m5891lambda$new$0$androidwidgetEditor$MagnifierMotionAnimator(ValueAnimator animation) {
    ...
    public abstract class HandleView extends View implements TextViewPositionListener {
        ...
        private HandleView(Drawable drawableLtr, Drawable drawableRtl, int id) {
            ...
            if (distance < 0 || distance > 100) {
                ...
                int iApplyDimension = (int) TypedValue.applyDimension(1, distance, Editor.this.mTextView.getContext().getResources().getDisplayMetrics());
        ...
        protected void updatePosition(float x, float y, boolean fromTouchScreen) {
            ...
            if (Editor.this.mTextView.getHorizontallyScrolling() && positionNearEdgeOfScrollingView(x, atRtl)) {
                if (!isStartHandle() || Editor.this.mTextView.getScrollX() == 0) {
                    if (!isStartHandle()) {
                        if (Editor.this.mTextView.canScrollHorizontally(atRtl ? -1 : 1)) {
                        }
                    }
                }
        ...
        */
        public java.lang.CharSequence filter(java.lang.CharSequence r14, int r15, int r16, android.text.Spanned r17, int r18, int r19) {
            /*
                r13 = this;
                r8 = r13
                boolean r0 = r13.canUndoEdit(r14, r15, r16, r17, r18, r19)
                r9 = 0
                if (r0 != 0) goto L9
                return r9
            L9:
                boolean r10 = r8.mHasComposition
                boolean r0 = isComposition(r14)
                r8.mHasComposition = r0
                boolean r11 = r8.mExpanding
                r0 = 0
                int r1 = r16 - r15
                int r2 = r19 - r18
                if (r1 == r2) goto L2c
            ...
            L2d:
                ...
                r6 = r19
                r7 = r12
                r0.handleEdit(r1, r2, r3, r4, r5, r6, r7)
                return r9
            */
        ...
        private void recordEdit(EditOperation edit, int mergeMode) {
            ...
            } else if (!this.mIsUserEdit || mergeMode != 2 || !lastEdit.mergeWith(edit)) {
    ...
    static final class ProcessTextIntentActionsHandler {
        ...
        public void onInitializeMenu(Menu menu) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (!this.mInnerEditorExt.raiseOplusMenuPriority(i + 100, getLabel(resolveInfo), createProcessTextIntentForResolveInfo(resolveInfo), resolveInfo, menu) && !this.mInnerEditorExt.setSearchMenuItem(i + 100, createProcessTextIntentForResolveInfo(resolveInfo), getLabel(resolveInfo), resolveInfo, menu)) {
        ...
        private boolean fireIntent(Intent intent) {
            if (intent != null) {
                if (Intent.ACTION_PROCESS_TEXT.equals(intent.getAction()) || this.mInnerEditorExt.isOplusReorderActionMenu(intent)) {
