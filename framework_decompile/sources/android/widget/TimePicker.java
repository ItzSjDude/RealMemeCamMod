    ...
    public TimePicker(final Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mDelegate.setAutoFillChangeListener(new OnTimeChangedListener() { // from class: android.widget.TimePicker$$ExternalSyntheticLambda0
            ...
            public final void onTimeChanged(TimePicker timePicker, int i, int i2) {
                this.f$0.m6296lambda$new$0$androidwidgetTimePicker(context, timePicker, i, i2);
            }
        });
    }

    /* renamed from: lambda$new$0$android-widget-TimePicker, reason: not valid java name */
    /* synthetic */ void m6296lambda$new$0$androidwidgetTimePicker(Context context, TimePicker v, int h, int m) {
