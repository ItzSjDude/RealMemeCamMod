...
public class GridView extends AbsListView {
    ...
    /* JADX WARN: Removed duplicated region for block: B:161:0x0285 A[ADDED_TO_REGION, REMOVE] */
    ...
    */
    ...
    private void setupChild(View view, int position, int y, boolean flowDown, int childrenLeft, boolean selected, boolean isAttachedToWindow, int where) {
        ...
        if (needToMeasure) {
            ...
            view.layout(childLeft, childTop, childRight, childTop + h);
        } else {
    ...
    @Override // android.widget.AbsListView
    void setSelectionInt(int position) throws Throwable {
    ...
    private boolean commonKey(int keyCode, int count, KeyEvent event) throws Throwable {
        if (this.mAdapter == null) {
            return false;
        }
    ...
    boolean pageScroll(int direction) throws Throwable {
        int nextPage = -1;
        if (direction == 33) {
    ...
    boolean fullScroll(int direction) throws Throwable {
        boolean moved = false;
        if (direction == 33) {
            this.mLayoutMode = 2;
            setSelectionInt(0);
    ...
    boolean arrowScroll(int direction) throws Throwable {
        int endOfRowPos;
        int startOfRowPos;
        int selectedPosition = this.mSelectedPosition;
        int numColumns = this.mNumColumns;
    ...
    boolean sequenceScroll(int direction) throws Throwable {
        int endOfRow;
        int startOfRow;
        int selectedPosition = this.mSelectedPosition;
        int numColumns = this.mNumColumns;
