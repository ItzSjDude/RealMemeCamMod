...
public class DateTimeView extends TextView {
    ...
    public DateTimeView(Context context, AttributeSet attrs) throws Resources.NotFoundException {
        super(context, attrs);
        this.mLastDisplay = -1;
    ...
    @RemotableViewMethod
    public void setTime(long timeMillis) throws Resources.NotFoundException {
    ...
    @RemotableViewMethod
    public void setShowRelativeTime(boolean showRelativeTime) throws Resources.NotFoundException {
    ...
    private void updateRelativeTime() throws Resources.NotFoundException {
        ...
        if (duration < 3600000) {
            ...
            result = resources3.getString(i2, Integer.valueOf(count2));
            if (past || count2 != 1) {
