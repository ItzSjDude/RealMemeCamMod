...
public class RemoteViews implements Parcelable, LayoutInflater.Filter {
    ...
    class SetPendingIntentTemplate extends Action {
            ...
            if (target instanceof AdapterView) {
                ...
                AdapterView.OnItemClickListener listener = new AdapterView.OnItemClickListener() { // from class: android.widget.RemoteViews$SetPendingIntentTemplate$$ExternalSyntheticLambda0
                    ...
                    public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
                        this.f$0.m6143xa91820b(handler, adapterView, view, i, j);
                    }
                };
        ...
        /* renamed from: lambda$apply$0$android-widget-RemoteViews$SetPendingIntentTemplate, reason: not valid java name */
        /* synthetic */ void m6143xa91820b(InteractionHandler handler, AdapterView parent, View view, int position, long id) {
        ...
        public void apply(View root, ViewGroup rootParent, final InteractionHandler handler, ColorResources colorResources) {
            ...
            target.setOnClickListener(new View.OnClickListener() { // from class: android.widget.RemoteViews$SetOnClickResponse$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    this.f$0.m6142lambda$apply$0$androidwidgetRemoteViews$SetOnClickResponse(handler, view);
                }
            });
        }

        /* renamed from: lambda$apply$0$android-widget-RemoteViews$SetOnClickResponse, reason: not valid java name */
        /* synthetic */ void m6142lambda$apply$0$androidwidgetRemoteViews$SetOnClickResponse(InteractionHandler handler, View v) {
    ...
    class SetOnCheckedChangeResponse extends Action {
        ...
        public void apply(View root, ViewGroup rootParent, final InteractionHandler handler, ColorResources colorResources) {
            ...
            CompoundButton.OnCheckedChangeListener onCheckedChangeListener = new CompoundButton.OnCheckedChangeListener() { // from class: android.widget.RemoteViews$SetOnCheckedChangeResponse$$ExternalSyntheticLambda0
                ...
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    this.f$0.m6141x2f2d0d7(handler, compoundButton, z);
                }
            };
        ...
        /* renamed from: lambda$apply$0$android-widget-RemoteViews$SetOnCheckedChangeResponse, reason: not valid java name */
        /* synthetic */ void m6141x2f2d0d7(InteractionHandler handler, CompoundButton v, boolean isChecked) {
            this.mResponse.handleViewInteraction(v, handler);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Removed duplicated region for block: B:21:0x00bd A[Catch: all -> 0x013d, TryCatch #2 {, blocks: (B:4:0x0007, B:8:0x0018, B:10:0x0027, B:12:0x002f, B:13:0x004e, B:15:0x005a, B:16:0x0089, B:9:0x001f, B:18:0x008b, B:19:0x00ba, B:21:0x00bd, B:22:0x00bf, B:24:0x00c1, B:27:0x00ca, B:29:0x00cc, B:31:0x00d0, B:32:0x00e0, B:35:0x00ee, B:36:0x0138, B:37:0x0139, B:38:0x013b), top: B:46:0x0007, inners: #0, #1 }] */
    /* JADX WARN: Removed duplicated region for block: B:24:0x00c1 A[Catch: all -> 0x013d, TryCatch #2 {, blocks: (B:4:0x0007, B:8:0x0018, B:10:0x0027, B:12:0x002f, B:13:0x004e, B:15:0x005a, B:16:0x0089, B:9:0x001f, B:18:0x008b, B:19:0x00ba, B:21:0x00bd, B:22:0x00bf, B:24:0x00c1, B:27:0x00ca, B:29:0x00cc, B:31:0x00d0, B:32:0x00e0, B:35:0x00ee, B:36:0x0138, B:37:0x0139, B:38:0x013b), top: B:46:0x0007, inners: #0, #1 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.invoke.MethodHandle getMethod(android.view.View r10, java.lang.String r11, java.lang.Class<?> r12, boolean r13) {
        /*
            Method dump skipped, instructions count: 320
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: android.widget.RemoteViews.getMethod(android.view.View, java.lang.String, java.lang.Class, boolean):java.lang.invoke.MethodHandle");
    }
    ...
    private static class BitmapCache {
        ...
        public BitmapCache(Parcel source) {
            ...
            this.mBitmapHashes = source.readSparseIntArray();
        }
        ...
        public int getBitmapId(Bitmap b) {
            ...
            this.mBitmaps.add(b);
            this.mBitmapHashes.put(this.mBitmaps.size() - 1, hash);
            this.mBitmapMemory = -1;
        ...
        public void writeBitmapsToParcel(Parcel dest, int flags) {
            ...
            dest.writeSparseIntArray(this.mBitmapHashes);
        }
    ...
    private abstract class BaseReflectionAction extends Action {
        ...
        @Override // android.widget.RemoteViews.Action
        public final void apply(View root, ViewGroup rootParent, InteractionHandler handler, ColorResources colorResources) throws ActionException {
            View view = root.findViewById(this.viewId);
            if (view == null) {
                return;
            }
        ...
        @Override // android.widget.RemoteViews.Action
        public final Action initActionAsync(ViewTree root, ViewGroup rootParent, InteractionHandler handler, ColorResources colorResources) throws ActionException {
            View view = root.findViewById(this.viewId);
            if (view == null) {
    ...
    class ViewGroupActionAdd extends Action {
        ...
        @Override // android.widget.RemoteViews.Action
        public void apply(View root, ViewGroup rootParent, InteractionHandler handler, ColorResources colorResources) throws Resources.NotFoundException, ActionException {
            ...
            if (nextChild < 0 || this.mStableId == -1) {
                ...
                final int recycledViewIndex = target.findChildIndex(nextChild, new Predicate() { // from class: android.widget.RemoteViews$ViewGroupActionAdd$$ExternalSyntheticLambda0
                    ...
                    public final boolean test(Object obj) {
                        return this.f$0.m6144xe3b44cf9((View) obj);
                    }
                });
                if (recycledViewIndex >= 0) {
                    ...
                    return insertNewView(context2, target, handler, colorResources, new Runnable() { // from class: android.widget.RemoteViews$ViewGroupActionAdd$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            ViewGroup viewGroup = targetVg;
                            int i = nextChild;
                            viewGroup.removeViews(i, (recycledViewIndex - i) + 1);
                        }
                    });
                }
                context = context2;
            }
            return insertNewView(context, target, handler, colorResources, new Runnable() { // from class: android.widget.RemoteViews$ViewGroupActionAdd$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
        ...
        /* renamed from: lambda$initActionAsync$0$android-widget-RemoteViews$ViewGroupActionAdd, reason: not valid java name */
        /* synthetic */ boolean m6144xe3b44cf9(View view) {
    ...
    class ViewGroupActionRemove extends Action {
        ...
        public Action initActionAsync(ViewTree root, ViewGroup rootParent, InteractionHandler handler, ColorResources colorResources) {
            ...
            if (this.mViewIdToKeep == -2) {
                ...
                target.mChildren.removeIf(new Predicate() { // from class: android.widget.RemoteViews$ViewGroupActionRemove$$ExternalSyntheticLambda1
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                        return this.f$0.m6147x41894b4b((RemoteViews.ViewTree) obj);
                    }
                });
        ...
        /* renamed from: lambda$initActionAsync$1$android-widget-RemoteViews$ViewGroupActionRemove, reason: not valid java name */
        /* synthetic */ boolean m6147x41894b4b(ViewTree childTree) {
    ...
    private class TextViewDrawableAction extends Action {
        ...
        public Action initActionAsync(ViewTree root, ViewGroup rootParent, InteractionHandler handler, ColorResources colorResources) {
            ...
            if (this.useIcons) {
                copy = RemoteViews.this.new TextViewDrawableAction(this.viewId, this.isRelative, this.i1, this.i2, this.i3, this.i4);
            } else {
                copy = RemoteViews.this.new TextViewDrawableAction(this.viewId, this.isRelative, this.d1, this.d2, this.d3, this.d4);
            }
    ...
    public void setImageViewUri(int viewId, Uri uri) throws IOException {
    ...
    public void setUri(int viewId, String methodName, Uri value) throws IOException {
        if (value != null) {
    ...
    public View apply(Context context, ViewGroup parent, InteractionHandler handler, SizeF size) throws ActionException {
    ...
    public View applyWithTheme(Context context, ViewGroup parent, InteractionHandler handler, int applyThemeResId, SizeF size) throws Resources.NotFoundException, ActionException {
        RemoteViews rvToApply = getRemoteViewsToApply(context, size);
    ...
    public View apply(Context context, ViewGroup parent, InteractionHandler handler, SizeF size, ColorResources colorResources) throws Resources.NotFoundException, ActionException {
        RemoteViews rvToApply = getRemoteViewsToApply(context, size);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public View applyNestedViews(Context context, ViewGroup directParent, ViewGroup rootParent, InteractionHandler handler, SizeF size, ColorResources colorResources) throws Resources.NotFoundException, ActionException {
        RemoteViews rvToApply = getRemoteViewsToApply(context, size);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public View inflateView(Context context, RemoteViews rv, ViewGroup parent, int applyThemeResId, ColorResources colorResources) throws Resources.NotFoundException {
    ...
    public void reapply(Context context, View v) throws ActionException {
        reapply(context, v, null);
    }

    public void reapply(Context context, View v, InteractionHandler handler) throws ActionException {
        reapply(context, v, handler, null, null);
    }

    public void reapply(Context context, View v, InteractionHandler handler, SizeF size, ColorResources colorResources) throws ActionException {
    ...
    private void reapply(Context context, View v, InteractionHandler handler, SizeF size, ColorResources colorResources, boolean topLevel) throws ActionException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void reapplyNestedViews(Context context, View v, ViewGroup rootParent, InteractionHandler handler, SizeF size, ColorResources colorResources) throws ActionException {
        RemoteViews rvToApply = getRemoteViewsToReapply(context, v, size);
    ...
    private void performApply(View v, ViewGroup parent, InteractionHandler handler, ColorResources colorResources) throws ActionException {
        ArrayList<Action> arrayList = this.mActions;
        if (arrayList != null) {
    ...
    public static final class ColorResources {
        ...
        private static byte[] createCompiledResourcesContent(Context context, SparseIntArray colorResources) throws Resources.NotFoundException, IOException {
        ...
        public static ColorResources create(Context context, SparseIntArray colorMapping) throws ErrnoException {
            try {
    ...
    public static class RemoteResponse {
        ...
        public void readFromParcel(Parcel parcel) {
            ...
            this.mPendingIntent = pendingIntentOrNullFromParcel;
            if (pendingIntentOrNullFromParcel == null) {
