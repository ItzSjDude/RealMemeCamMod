...
public class MediaController extends FrameLayout {
    ...
    protected View makeControllerView() {
        ...
        View viewInflate = inflate.inflate(R.layout.media_controller, (ViewGroup) null);
    ...
    public void unregisterOnBackInvokedCallback() {
        ...
        if (viewRootImpl != null && WindowOnBackInvokedDispatcher.isOnBackInvokedCallbackEnabled(viewRootImpl.mContext)) {
    ...
    public void registerOnBackInvokedCallback() {
        ...
        if (!this.mBackCallbackRegistered && (viewRootImpl = this.mDecor.getViewRootImpl()) != null && WindowOnBackInvokedDispatcher.isOnBackInvokedCallbackEnabled(viewRootImpl.mContext)) {
