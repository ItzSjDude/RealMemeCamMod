...
class TimePickerClockDelegate extends TimePicker.AbstractTimePickerDelegate {
    ...
    public TimePickerClockDelegate(TimePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        View viewFindViewById = mainView.findViewById(R.id.time_header);
        ...
        View viewFindViewById2 = mainView.findViewById(R.id.ampm_layout);
        ...
        View viewFindViewById3 = mainView.findViewById(R.id.input_header);
        ...
        if (a.hasValueOrEmpty(0)) {
            viewFindViewById.setBackground(a.getDrawable(0));
            viewFindViewById3.setBackground(a.getDrawable(0));
        }
        a.recycle();
