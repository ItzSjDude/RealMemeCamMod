...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) throws Resources.NotFoundException {
        int i;
    ...
    public void setLogo(Drawable drawable) {
        ...
        if (imageView2 != null) {
            imageView2.m7231x2ffdb2aa(drawable);
        }
    }
    ...
    public void setTitle(int resId) throws Resources.NotFoundException {
        setTitle(getContext().getText(resId));
    }

    public void setTitle(CharSequence title) throws Resources.NotFoundException {
        if (!TextUtils.isEmpty(title)) {
    ...
    public void setSubtitle(int resId) throws Resources.NotFoundException {
        setSubtitle(getContext().getText(resId));
    }

    public void setSubtitle(CharSequence subtitle) throws Resources.NotFoundException {
        if (!TextUtils.isEmpty(subtitle)) {
    ...
    public void setTitleTextAppearance(Context context, int resId) throws Resources.NotFoundException {
    ...
    public void setSubtitleTextAppearance(Context context, int resId) throws Resources.NotFoundException {
    ...
    public void setNavigationIcon(Drawable icon) {
        ...
        if (imageButton2 != null) {
            imageButton2.m7231x2ffdb2aa(icon);
        }
    }
    ...
    public void setCollapseIcon(Drawable icon) {
        if (icon != null) {
            ensureCollapseButtonView();
            this.mCollapseButtonView.m7231x2ffdb2aa(icon);
        } else {
            ImageButton imageButton = this.mCollapseButtonView;
            if (imageButton != null) {
                imageButton.m7231x2ffdb2aa(this.mCollapseIcon);
            }
        }
    }
