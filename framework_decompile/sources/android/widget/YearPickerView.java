...
class YearPickerView extends ListView {
    ...
    private static class YearAdapter extends BaseAdapter {
        private static final int ITEM_LAYOUT = 17367378;
        private static final int ITEM_TEXT_ACTIVATED_APPEARANCE = 16974779;
        private static final int ITEM_TEXT_APPEARANCE = 16974778;
        ...
        public View getView(int position, View convertView, ViewGroup parent) throws Resources.NotFoundException {
            ...
            if (hasNewView) {
                v = (TextView) this.mInflater.inflate(17367378, parent, false);
            } else {
            ...
            if (hasNewView || v.isActivated() != activated) {
                if (activated) {
                    textAppearanceResId = 16974779;
                } else {
                    textAppearanceResId = 16974778;
                }
