...
public class Switch extends CompoundButton {
    ...
    public Switch(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) throws Resources.NotFoundException {
    ...
    public void m6252lambda$setTrackResourceAsync$0$androidwidgetSwitch(Drawable track) {
    ...
    public void setTrackResource(int resId) {
        m6252lambda$setTrackResourceAsync$0$androidwidgetSwitch(getContext().getDrawable(resId));
    }
    ...
    public Runnable setTrackResourceAsync(int resId) {
        ...
        return new Runnable() { // from class: android.widget.Switch$$ExternalSyntheticLambda2
            ...
            public final void run() {
                this.f$0.m6252lambda$setTrackResourceAsync$0$androidwidgetSwitch(drawable);
            }
        };
    }
    ...
    public void setTrackIcon(Icon icon) {
        m6252lambda$setTrackResourceAsync$0$androidwidgetSwitch(icon == null ? null : icon.loadDrawable(getContext()));
    }
    ...
    public Runnable setTrackIconAsync(Icon icon) {
        ...
        return new Runnable() { // from class: android.widget.Switch$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m6251lambda$setTrackIconAsync$1$androidwidgetSwitch(track);
            }
        };
    }
    ...
    public void m6250lambda$setThumbResourceAsync$2$androidwidgetSwitch(Drawable thumb) {
    ...
    public void setThumbResource(int resId) {
        m6250lambda$setThumbResourceAsync$2$androidwidgetSwitch(getContext().getDrawable(resId));
    }
    ...
    public Runnable setThumbResourceAsync(int resId) {
        ...
        return new Runnable() { // from class: android.widget.Switch$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m6250lambda$setThumbResourceAsync$2$androidwidgetSwitch(drawable);
            }
        };
    }
    ...
    public void setThumbIcon(Icon icon) {
        m6250lambda$setThumbResourceAsync$2$androidwidgetSwitch(icon == null ? null : icon.loadDrawable(getContext()));
    }
    ...
    public Runnable setThumbIconAsync(Icon icon) {
        ...
        return new Runnable() { // from class: android.widget.Switch$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m6249lambda$setThumbIconAsync$3$androidwidgetSwitch(track);
            }
        };
    }
