...
public class ToastPresenter {
    ...
    public static final int TEXT_TOAST_LAYOUT = 17367364;
    ...
    public static View getTextToastView(Context context, CharSequence text) {
        View view = LayoutInflater.from(context).inflate(17367364, (ViewGroup) null);
    ...
    private boolean isCrossUserPackage(String packageName) throws Resources.NotFoundException {
