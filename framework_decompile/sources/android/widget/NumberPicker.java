...
public class NumberPicker extends LinearLayout {
    private static final int DEFAULT_LAYOUT_RESOURCE_ID = 17367247;
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) throws Resources.NotFoundException {
        boolean z;
        boolean z2;
        ?? r0;
        ...
        int layoutResId = attributesArray.getResourceId(3, 17367247);
        if (layoutResId != 17367247) {
            z = true;
        } else {
            z = false;
        }
        ...
        editText.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: android.widget.NumberPicker.3
            ...
            public void onFocusChange(View v, boolean hasFocus) throws NumberFormatException {
                if (hasFocus) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void validateInputTextView(View v) throws NumberFormatException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public int getSelectedPos(String value) throws NumberFormatException {
