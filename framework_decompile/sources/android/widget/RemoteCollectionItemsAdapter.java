...
class RemoteCollectionItemsAdapter extends BaseAdapter {
    ...
    RemoteCollectionItemsAdapter(RemoteViews.RemoteCollectionItems items, RemoteViews.InteractionHandler interactionHandler, RemoteViews.ColorResources colorResources) throws Throwable {
    ...
    void setData(RemoteViews.RemoteCollectionItems items, RemoteViews.InteractionHandler interactionHandler, RemoteViews.ColorResources colorResources) throws Throwable {
    ...
    private void initLayoutIdToViewType() throws Throwable {
        ...
        int[] layoutIds = IntStream.range(0, this.mItems.getItemCount()).map(new IntUnaryOperator() { // from class: android.widget.RemoteCollectionItemsAdapter$$ExternalSyntheticLambda0
            ...
            public final int applyAsInt(int i) {
                return this.f$0.m6105xe6bb1032(i);
            }
        }).distinct().toArray();
    ...
    /* renamed from: lambda$initLayoutIdToViewType$0$android-widget-RemoteCollectionItemsAdapter, reason: not valid java name */
    /* synthetic */ int m6105xe6bb1032(int position) {
