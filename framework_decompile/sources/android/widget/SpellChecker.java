...
public class SpellChecker implements SpellCheckerSession.SpellCheckerSessionListener {
    ...
    private static class SentenceIteratorWrapper {
        ...
        public void setCharSequence(CharSequence sequence, int start, int end) {
            ...
            int iMin = Math.min(end, sequence.length());
            this.mEndOffset = iMin;
            this.mSentenceIterator.setText(sequence.subSequence(this.mStartOffset, iMin).toString());
        }
    ...
    private class SpellParser {
        ...
        public void parse() {
            ...
            int sentenceStart = ((Integer) sentenceBoundary.getLower()).intValue();
            int sentenceEnd = ((Integer) sentenceBoundary.getUpper()).intValue();
