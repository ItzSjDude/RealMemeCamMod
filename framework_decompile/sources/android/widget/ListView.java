    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (drawDividers2 || drawOverscrollHeader2 || drawOverscrollFooter) {
            ...
            if (this.mStackFromBottom) {
                ...
                while (i4 < count) {
                    ...
                    if ((!headerDividers && isHeader2) || (!footerDividers2 && isFooter2)) {
                        ...
                        if (!drawDividers2 || scrollY2 >= listBottom2) {
                            ...
                            drawDividers = drawDividers2;
                            adapter2 = adapter;
                            if (adapter2.isEnabled(itemIndex) && (headerDividers || (!isHeader2 && listBottom4 >= headerCount))) {
                ...
                if (!drawOverscrollFooter2 || first2 + count != itemCount || overFooterBottom <= scrollY2) {
