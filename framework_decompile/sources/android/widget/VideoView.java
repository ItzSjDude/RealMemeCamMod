...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl, SubtitleController.Anchor {
    ...
    public VideoView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mSHCallback = new SurfaceHolder.Callback() { // from class: android.widget.VideoView.7
            ...
            public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) throws IllegalStateException {
            ...
            @Override // android.view.SurfaceHolder.Callback
            public void surfaceCreated(SurfaceHolder holder) throws IllegalArgumentException {
    ...
    public void setVideoURI(Uri uri, Map<String, String> headers) throws IllegalArgumentException {
        this.mUri = uri;
