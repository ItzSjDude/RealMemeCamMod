    ...
    public DatePicker(final Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mDelegate.setAutoFillChangeListener(new OnDateChangedListener() { // from class: android.widget.DatePicker$$ExternalSyntheticLambda0
            ...
            public final void onDateChanged(DatePicker datePicker, int i, int i2, int i3) {
                this.f$0.m5779lambda$new$0$androidwidgetDatePicker(context, datePicker, i, i2, i3);
            }
        });
    }

    /* renamed from: lambda$new$0$android-widget-DatePicker, reason: not valid java name */
    /* synthetic */ void m5779lambda$new$0$androidwidgetDatePicker(Context context, DatePicker v, int y, int m, int d) {
