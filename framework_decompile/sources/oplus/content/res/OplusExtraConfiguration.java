...
public class OplusExtraConfiguration implements Comparable {
    ...
    public int compareTo(OplusExtraConfiguration extraconfiguration) {
        ...
        if (i13 == 0 && (str = this.mThemePrefix) != null && !str.equals(extraconfiguration.mThemePrefix)) {
            return -1;
        }
        return i13;
    }
    ...
    public void setTo(OplusExtraConfiguration extraconfiguration) {
        ...
        this.mFlag = extraconfiguration.mFlag;
    }

    public String toString() {
        StringBuilder stringbuilder = new StringBuilder();
        stringbuilder.append("mThemeChanged= ").append(this.mThemeChanged).append(", mThemeChangedFlags= ").append(Long.toHexString(this.mThemeChangedFlags)).append(", mFlipFont= ").append(this.mFlipFont).append(", mAccessibleChanged= ").append(this.mAccessibleChanged).append(", mUxIconConfig= ").append(this.mUxIconConfig).append(", mMaterialColor= ").append(Long.toHexString(this.mMaterialColor)).append(", mUserId= ").append(this.mUserId).append(", mFontUserId= ").append(this.mFontUserId).append(", mFontVariationSettings= ").append(Integer.toHexString(this.mFontVariationSettings)).append(", mFoldingAngle = ").append(this.mFoldingAngle).append(", mIconPackName= ").append(this.mIconPackName).append(", mDarkModeBackgroundMaxL= ").append(this.mDarkModeBackgroundMaxL).append(", mDarkModeDialogBgMaxL= ").append(this.mDarkModeDialogBgMaxL).append(", mDarkModeForegroundMinL= ").append(this.mDarkModeForegroundMinL).append(", mOplusConfigType= ").append(this.mOplusConfigType).append(", mOplusChangedConfigs= ").append(this.mOplusChangedConfigs).append(", OpSans= ").append(this.mFontOpSansSettings).append(", mFlag= ").append(Integer.toHexString(this.mFlag));
        if ((this.mFlag & 2) != 0) {
            stringbuilder.append(", extraMode=").append("oplus-magic-windows");
        }
    ...
    public int updateFrom(OplusExtraConfiguration extraconfiguration) {
        ...
        int i13 = extraconfiguration.mFlag;
        if (i13 > 0 && i13 != this.mFlag) {
            this.mFlag = i13;
        }
        return i;
    }
