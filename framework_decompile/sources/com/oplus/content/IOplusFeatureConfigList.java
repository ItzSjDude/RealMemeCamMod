...
public interface IOplusFeatureConfigList {
    ...
    @OplusFeature(OplusFeature.OplusFeatureType.PERSIST_FEATURE)
    @OplusFeaturePermission(Manifest.permission.SECURITY)
    ...
    @OplusFeature(OplusFeature.OplusFeatureType.READONLY_FEATURE)
    public static final String FEATURE_NOT_NOTIFY_ICC_CHANGED_WHEN_SIM_LOADED = "oplus.software.radio.not_notify_iccchange_when_simloaded";
    ...
    @OplusFeature(OplusFeature.OplusFeatureType.READONLY_FEATURE)
    public static final String OPLUS_FEATURE_SCREENSHOT_WHITESWAN_MODEL = "oplus.software.screenshot.whiteswan_model";
    ...
    @OplusFeature(OplusFeature.OplusFeatureType.READONLY_FEATURE)
    public static final String OPLUS_FEATURE_ZOOM_ANIM_DURATION_LOW_END = "oplus.software.zoom.anim_duration_low_end";
