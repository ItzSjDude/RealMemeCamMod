...
public abstract class BaseMethod {
    ...
    public BaseMethod(Class<?> targetClass, Field mappingField) {
        Method methodFindTargetMethod = findTargetMethod(targetClass, getMethodNameFrom(mappingField), getMethodParameterTypesFrom(mappingField));
        this.mMethod = methodFindTargetMethod;
        if (methodFindTargetMethod != null) {
            methodFindTargetMethod.setAccessible(true);
        }
    }

    protected Object invoke(Object obj, Object... args) throws IllegalAccessException, InvocationTargetException {
        checkExist();
    ...
    private Method findMethodForName(Class<?> targetClass, String name) throws SecurityException {
