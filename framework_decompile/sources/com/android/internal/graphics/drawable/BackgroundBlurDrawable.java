...
public final class BackgroundBlurDrawable extends Drawable {
    ...
    class AnonymousClass1 implements RenderNode.PositionUpdateListener {
        ...
        public void positionChanged(long frameNumber, final int left, final int top, final int right, final int bottom) {
            BackgroundBlurDrawable.this.mAggregator.onRenderNodePositionChanged(frameNumber, new Runnable() { // from class: com.android.internal.graphics.drawable.BackgroundBlurDrawable$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m6759xe7379729(left, top, right, bottom);
                }
            });
        }
        ...
        /* synthetic */ void m6759xe7379729(int left, int top, int right, int bottom) {
    ...
    public String toString() {
        return "BackgroundBlurDrawable{blurRadius=" + this.mBlurRadius + ", corners={" + this.mCornerRadiusTL + "," + this.mCornerRadiusTR + "," + this.mCornerRadiusBL + "," + this.mCornerRadiusBR + "," + this.mBlurColor[0] + "," + this.mBlurColor[1] + "," + this.mBlurColor[2] + "," + this.mBlurColor[3] + "}, alpha=" + this.mAlpha + ", visible=" + this.mVisible + "}";
    }
    ...
    public static final class Aggregator {
        ...
        private void registerPreDrawListener() {
            this.mOnPreDrawListener = new ViewTreeObserver.OnPreDrawListener() { // from class: com.android.internal.graphics.drawable.BackgroundBlurDrawable$Aggregator$$ExternalSyntheticLambda1
                ...
                public final boolean onPreDraw() {
                    return this.f$0.m6762x23ebcc03();
                }
            };
        ...
        /* synthetic */ boolean m6762x23ebcc03() {
            ...
            if (hasUiUpdates || hasRegions()) {
                ...
                this.mViewRoot.registerRtFrameCallback(new HardwareRenderer.FrameDrawingCallback() { // from class: com.android.internal.graphics.drawable.BackgroundBlurDrawable$Aggregator$$ExternalSyntheticLambda0
                    ...
                    public final void onFrameDraw(long j) {
                        this.f$0.m6761x97ad2e4(blurRegionsForNextFrame, hasUiUpdates, j);
                    }
                });
            }
        ...
        /* synthetic */ void m6761x97ad2e4(BlurRegion[] blurRegionsForNextFrame, boolean hasUiUpdates, long frame) {
    ...
    public static final class BlurRegion {
        ...
        public String toString() {
            return "BlurRegion{blurRadius=" + this.blurRadius + ", corners={" + this.cornerRadiusTL + "," + this.cornerRadiusTR + "," + this.cornerRadiusBL + "," + this.cornerRadiusBR + "}, alpha=" + this.alpha + ", rect=" + this.rect + ", blurColor[" + this.blurColorR + " " + this.blurColorG + " " + this.blurColorB + " " + this.blurColorA + "]}";
        }
    }
}
