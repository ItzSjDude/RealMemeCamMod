...
public final class AccessibilityTargetHelper {
    ...
    private static List<AccessibilityTarget> getAccessibilityFilteredTargets(Context context, int shortcutType) throws RemoteException {
        ...
        for (final AccessibilityTarget activityTarget : activityTargets) {
            serviceTargets.removeIf(new Predicate() { // from class: com.android.internal.accessibility.dialog.AccessibilityTargetHelper$$ExternalSyntheticLambda0
                ...
                public final boolean test(Object obj) {
                    return AccessibilityTargetHelper.arePackageNameAndLabelTheSame((AccessibilityTarget) obj, activityTarget);
                }
            });
        }
        List<AccessibilityTarget> targets = new ArrayList<>();
    ...
    private static List<AccessibilityTarget> getAccessibilityServiceTargets(Context context, int shortcutType) throws RemoteException {
        AccessibilityManager am = (AccessibilityManager) context.getSystemService(Context.ACCESSIBILITY_SERVICE);
    ...
    static View createEnableDialogContentView(Context context, final AccessibilityServiceTarget target, final View.OnClickListener allowListener, final View.OnClickListener denyListener) {
        ...
        dialogIcon.m7231x2ffdb2aa(target.getIcon());
        ...
        allowButton.setOnClickListener(new View.OnClickListener() { // from class: com.android.internal.accessibility.dialog.AccessibilityTargetHelper$$ExternalSyntheticLambda1
            ...
            public final void onClick(View view) {
                AccessibilityTargetHelper.lambda$createEnableDialogContentView$1(target, allowListener, view);
            }
        });
        denyButton.setOnClickListener(new View.OnClickListener() { // from class: com.android.internal.accessibility.dialog.AccessibilityTargetHelper$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                AccessibilityTargetHelper.lambda$createEnableDialogContentView$2(target, denyListener, view);
            }
        });
        return content;
    }
