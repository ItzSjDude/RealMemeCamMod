...
public class AccessibilityShortcutController {
    ...
    public void performAccessibilityShortcut() throws IllegalArgumentException {
        ...
        if (dialogAlreadyShown == 0) {
            AlertDialog alertDialogCreateShortcutWarningDialog = createShortcutWarningDialog(userId);
    ...
    private AlertDialog createShortcutWarningDialog(final int userId) {
        ...
        AlertDialog alertDialog = frameworkObjectProvider.getAlertDialogBuilder(frameworkObjectProvider.getSystemUiContext()).setTitle(getShortcutWarningTitle(targets)).setMessage(getShortcutWarningMessage(targets)).setCancelable(false).setNegativeButton(R.string.accessibility_shortcut_on, (DialogInterface.OnClickListener) null).setPositiveButton(R.string.accessibility_shortcut_off, new DialogInterface.OnClickListener() { // from class: com.android.internal.accessibility.AccessibilityShortcutController$$ExternalSyntheticLambda0
            ...
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.m6496x26b5297e(userId, dialogInterface, i);
            }
            ...
            public final void onCancel(DialogInterface dialogInterface) {
                this.f$0.m6497xc32325dd(userId, dialogInterface);
            }
        }).create();
        return alertDialog;
    }

    /* renamed from: lambda$createShortcutWarningDialog$0$com-android-internal-accessibility-AccessibilityShortcutController, reason: not valid java name */
    /* synthetic */ void m6496x26b5297e(int userId, DialogInterface d, int which) {
    ...
    /* renamed from: lambda$createShortcutWarningDialog$1$com-android-internal-accessibility-AccessibilityShortcutController, reason: not valid java name */
    /* synthetic */ void m6497xc32325dd(int userId, DialogInterface d) {
        Settings.Secure.putIntForUser(this.mContext.getContentResolver(), Settings.Secure.ACCESSIBILITY_SHORTCUT_DIALOG_SHOWN, 0, userId);
    }
    ...
    class TtsPrompt implements TextToSpeech.OnInitListener {
        ...
        public void onInit(int status) throws IllegalArgumentException {
            if (status != 0) {
    ...
    private class UserSetupCompleteObserver extends ContentObserver {
        ...
        private void setEmptyShortcutTargetIfNeeded() {
            ...
            int i2 = this.mUserId;
            Settings.Secure.putStringForUser(contentResolver, Settings.Secure.ACCESSIBILITY_SHORTCUT_TARGET_SERVICE, "", i2);
        }
