...
class WebViewZygoteInit {
    ...
    private static class WebViewZygoteConnection extends ZygoteConnection {
        ...
        @Override // com.android.internal.os.ZygoteConnection
        protected void handlePreloadApp(ApplicationInfo appInfo) throws NoSuchMethodException, SecurityException, IOException {
        ...
        @Override // com.android.internal.os.ZygoteConnection
        protected void handlePreloadPackage(String packagePath, String libsPath, String libFileName, String cacheKey) throws NoSuchMethodException, SecurityException, IOException {
        ...
        private void doPreload(ClassLoader loader, String libFileName) throws NoSuchMethodException, SecurityException, IOException {
    ...
    public static void main(String[] argv) throws NumberFormatException, ErrnoException {
