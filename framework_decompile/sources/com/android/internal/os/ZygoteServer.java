...
class ZygoteServer {
    ...
    private static final String USAP_POOL_REFILL_DELAY_MS_DEFAULT = "1000";
    private static final String USAP_POOL_SIZE_MAX_DEFAULT = "2";
    ...
    ZygoteServer(boolean isPrimaryZygote) {
        ...
        this.mUsapPoolEnabled = false;
        this.mUsapPoolSizeMax = Integer.parseInt("2");
        this.mUsapPoolSizeMin = Integer.parseInt("1");
        this.mUsapPoolRefillThreshold = this.mUsapPoolSizeMax / 2;
        this.mUsapPoolRefillDelayMs = Integer.parseInt(USAP_POOL_REFILL_DELAY_MS_DEFAULT);
    }
    ...
    private void fetchUsapPoolPolicyProps() {
        if (this.mUsapPoolSupported) {
            String usapPoolSizeMaxPropString = Zygote.getConfigurationProperty(ZygoteConfig.USAP_POOL_SIZE_MAX, "2");
    ...
    Runnable runSelectLoop(String abiList) throws IOException, ErrnoException {
