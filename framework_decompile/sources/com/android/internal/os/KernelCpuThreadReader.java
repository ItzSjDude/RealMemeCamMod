...
public class KernelCpuThreadReader {
    ...
    private ProcessCpuUsage getProcessCpuUsage(Path processPath, int processId, int uid) throws IOException {
    ...
    private ThreadCpuUsage getThreadCpuUsage(Path threadDirectory) throws NumberFormatException {
        int[] cpuUsages;
        try {
