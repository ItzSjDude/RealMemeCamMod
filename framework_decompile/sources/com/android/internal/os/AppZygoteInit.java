...
class AppZygoteInit {
    ...
    private static class AppZygoteConnection extends ZygoteConnection {
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:10:0x008a -> B:22:0x00a8). Please report as a decompilation issue!!! */
        @Override // com.android.internal.os.ZygoteConnection
        protected void handlePreloadApp(ApplicationInfo appInfo) throws NoSuchMethodException, IOException, ClassNotFoundException, SecurityException {
