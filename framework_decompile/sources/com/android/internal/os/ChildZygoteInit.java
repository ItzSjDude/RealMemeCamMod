...
public class ChildZygoteInit {
    ...
    static int parseIntFromArg(String[] argv, String desiredArg) throws NumberFormatException {
        int value = -1;
        for (String arg : argv) {
    ...
    static void runZygoteServer(ZygoteServer server, String[] args) throws NumberFormatException, ErrnoException {
