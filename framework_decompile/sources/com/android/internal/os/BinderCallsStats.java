...
public class BinderCallsStats implements BinderInternal.Observer {
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        if (uidEntry != null) {
                            ...
                            for (int j = 0; j < csize; j++) {
                                tmpCallStats.add(callStats.valueAt(j).m7010clone());
                            }
    ...
    @Override // com.android.internal.os.BinderInternal.Observer
    public void callEnded(BinderInternal.CallSession s, int parcelRequestSize, int parcelReplySize, int workSourceUid) throws Throwable {
        if (s == null) {
            return;
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:57:0x010e A[Catch: all -> 0x0146, TryCatch #4 {all -> 0x0146, blocks: (B:45:0x00ba, B:55:0x00de, B:57:0x010e, B:61:0x0117), top: B:106:0x00ba }] */
    /* JADX WARN: Removed duplicated region for block: B:71:0x013c  */
    /* JADX WARN: Removed duplicated region for block: B:86:0x018a A[Catch: all -> 0x01b0, TryCatch #0 {all -> 0x01b0, blocks: (B:84:0x0186, B:86:0x018a, B:88:0x0190, B:89:0x0199, B:95:0x01ae, B:81:0x0174, B:83:0x017a), top: B:99:0x005f }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    private void processCallEnded(com.android.internal.os.BinderInternal.CallSession r25, int r26, int r27, int r28) throws java.lang.Throwable {
        /*
    ...
    public void callThrewException(BinderInternal.CallSession s, Exception exception) {
        ...
        try {
            ...
            synchronized (this.mLock) {
                ...
                if (count != null) {
                    iIntValue = 1 + count.intValue();
                }
                arrayMap.put(className, Integer.valueOf(iIntValue));
            }
    ...
    public ArrayList<ExportedCallStat> getExportedCallStats(boolean applySharding) throws NoSuchMethodException, SecurityException {
    ...
    public ArrayList<ExportedCallStat> getExportedCallStats(int workSourceUid, boolean applySharding) throws NoSuchMethodException, SecurityException {
        ArrayList<ExportedCallStat> resultCallStats = new ArrayList<>();
        synchronized (this.mLock) {
    ...
    private void resolveBinderMethodNames(ArrayList<ExportedCallStat> resultCallStats) throws NoSuchMethodException, SecurityException {
        String methodName;
    ...
    private void dumpLocked(PrintWriter pw, AppIdToPackageMap packageMap, int workSourceUid, boolean verbose) throws NoSuchMethodException, SecurityException {
        boolean verbose2;
        ...
        while (true) {
            ...
            long totalCpuTime4 = totalCpuTime;
            long totalCpuTime5 = entry.cpuTimeMicros;
            totalCpuTime = totalCpuTime4;
            pw.println(String.format("  %10d %3.0f%% %8d %8d %s", Long.valueOf(totalCpuTime5), Double.valueOf((entry.cpuTimeMicros * 100.0d) / totalCpuTime), Long.valueOf(entry.recordedCallCount), Long.valueOf(entry.callCount), uidStr));
        ...
        this.mExceptionCounts.entrySet().iterator().forEachRemaining(new Consumer() { // from class: com.android.internal.os.BinderCallsStats$$ExternalSyntheticLambda3
            ...
            public final void accept(Object obj) {
                ...
                exceptionEntries.add(Pair.create((String) entry2.getKey(), (Integer) entry2.getValue()));
            }
        });
