...
public final class LongArrayMultiStateCounter implements Parcelable {
    ...
    public static class LongArrayContainer {
        ...
        public LongArrayContainer(int length) {
            this.mLength = length;
            long jNative_init = native_init(length);
            this.mNativeObject = jNative_init;
    ...
    public LongArrayMultiStateCounter(int stateCount, int arrayLength) {
        ...
        long jNative_init = native_init(stateCount, arrayLength);
        this.mNativeObject = jNative_init;
        sRegistry.registerNativeAllocation(this, jNative_init);
    }

    private LongArrayMultiStateCounter(Parcel in) {
        long jNative_initFromParcel = native_initFromParcel(in);
        this.mNativeObject = jNative_initFromParcel;
        sRegistry.registerNativeAllocation(this, jNative_initFromParcel);
