...
public class RuntimeInit {
    ...
    protected static Runnable findStaticMain(String className, String[] argv, ClassLoader classLoader) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        try {
    ...
    public static final void main(String[] argv) throws SecurityException {
        preForkInit();
