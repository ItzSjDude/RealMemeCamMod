...
public final class Zygote {
    ...
    static final int[][] INT_ARRAY_2D = (int[][]) Array.newInstance((Class<?>) int.class, 0, 0);
    ...
    private static Runnable childMain(ZygoteCommandBuffer argBuffer, LocalServerSocket usapPoolSocket, FileDescriptor writePipe) throws Throwable {
                ...
                try {
                    try {
                        try {
                            ...
                            Trace.traceEnd(64L);
                            Runnable runnableZygoteInit = ZygoteInit.zygoteInit(args.mTargetSdkVersion, args.mDisabledCompatChanges, args.mRemainingArgs, null);
                            unblockSigTerm();
                            return runnableZygoteInit;
                        } catch (Throwable th2) {
                            th = th2;
                            unblockSigTerm();
                            throw th;
    ...
    static LocalServerSocket createManagedSocketFromInitSocket(String socketName) throws NumberFormatException {
    ...
    static void execShell(String command) throws ErrnoException {
    ...
    private static int decideTaggingLevel(ApplicationInfo info, ProcessInfo processInfo, IPlatformCompat platformCompat) {
        ...
        if (nativeSupportsTaggedPointers()) {
    ...
    private static int decideGwpAsanLevel(ApplicationInfo info, ProcessInfo processInfo, IPlatformCompat platformCompat) {
        ...
        return (info.flags & 1) != 0 ? 2097152 : 0;
    }
