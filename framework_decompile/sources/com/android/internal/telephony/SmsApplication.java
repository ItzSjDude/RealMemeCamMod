...
public final class SmsApplication {
    ...
    private static ISmsApplicationExt mSmsApplicationExt = (ISmsApplicationExt) ExtLoader.type(ISmsApplicationExt.class).base(null).create();
    ...
    public static SmsApplicationData getApplication(Context context, boolean updateIfNeeded, int userId) throws Resources.NotFoundException {
    ...
    private static void defaultSmsAppChanged(Context context) throws Resources.NotFoundException {
        ...
        if (mSmsApplicationExt.oemPackageName() != null) {
            String[] oempackage = mSmsApplicationExt.oemPackageName();
            for (String str : oempackage) {
        ...
        for (String pkgName : packagesOfPhone) {
            for (String opStr : DEFAULT_APP_EXCLUSIVE_APPOPS) {
                int mode = appOps.checkOp(opStr, 1001, pkgName);
                if (mode != 0) {
    ...
    private static void setDefaultApplicationInternal(String packageName, Context context, int userId) throws ExecutionException, InterruptedException, Resources.NotFoundException, TimeoutException {
        UserHandle userHandle = UserHandle.of(userId);
    ...
    private static final class SmsPackageMonitor extends PackageChangeReceiver {
        ...
        public void onPackageDisappeared() throws PackageManager.NameNotFoundException {
            onPackageChanged();
        }

        @Override // com.android.internal.telephony.PackageChangeReceiver
        public void onPackageAppeared() throws PackageManager.NameNotFoundException {
            onPackageChanged();
        }

        @Override // com.android.internal.telephony.PackageChangeReceiver
        public void onPackageModified(String packageName) throws PackageManager.NameNotFoundException {
            onPackageChanged();
        }
    ...
    public static ComponentName getDefaultSmsApplication(Context context, boolean updateIfNeeded) {
        if (mSmsApplicationExt.isUserIdEqualMainUserId()) {
            return getDefaultSmsApplicationAsUser(context, updateIfNeeded, mSmsApplicationExt.getUserId());
        }
    ...
    public static boolean shouldWriteMessageForPackage(String packageName, Context context) {
        if (!mSmsApplicationExt.shouldWriteMessageForPackage(packageName)) {
            return false;
        }
        return !isDefaultSmsApplication(context, packageName);
    }

    public static boolean isDefaultSmsApplication(Context context, String packageName) throws Resources.NotFoundException {
        if (packageName == null) {
            return false;
        }
        String defaultSmsPackage = getDefaultSmsApplicationPackageName(context);
        String bluetoothPackageName = context.getResources().getString(17039427);
        if ((defaultSmsPackage == null || !defaultSmsPackage.equals(packageName)) && !bluetoothPackageName.equals(packageName)) {
            return false;
        }
        return true;
    }
    ...
    private static String getDefaultSmsApplicationPackageName(Context context) {
        ...
        mSmsApplicationExt.setUserId(0);
        if (component != null) {
    ...
    public static boolean shouldWriteMessageForPackage(String packageName, Context context, int userId) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
    ...
    public static boolean isDefaultSmsApplication(Context context, String packageName, int userId) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        if (SystemProperties.get("ro.vendor.mtk_telephony_add_on_policy", "0").equals("0")) {
            try {
                Class clazz = Class.forName("com.mediatek.internal.telephony.MtkSmsApplication");
