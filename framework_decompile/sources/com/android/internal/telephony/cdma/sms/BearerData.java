...
public final class BearerData {
    ...
    public String toString() {
        ...
        StringBuilder sbAppend = new StringBuilder().append(", msgCenterTimeStamp=");
        Object obj = this.msgCenterTimeStamp;
        if (obj == null) {
            obj = "unset";
        }
        builder.append(sbAppend.append(obj).toString());
        StringBuilder sbAppend2 = new StringBuilder().append(", validityPeriodAbsolute=");
        Object obj2 = this.validityPeriodAbsolute;
        if (obj2 == null) {
            obj2 = "unset";
        }
        builder.append(sbAppend2.append(obj2).toString());
        builder.append(", validityPeriodRelative=" + (this.validityPeriodRelativeSet ? Integer.valueOf(this.validityPeriodRelative) : "unset"));
        StringBuilder sbAppend3 = new StringBuilder().append(", deferredDeliveryTimeAbsolute=");
        Object obj3 = this.deferredDeliveryTimeAbsolute;
        if (obj3 == null) {
            obj3 = "unset";
        }
        builder.append(sbAppend3.append(obj3).toString());
    ...
    private static boolean decodeMessageId(BearerData bData, BitwiseInputStream inStream) throws BitwiseInputStream.AccessException {
        ...
        if (paramBits >= 24) {
            ...
            int i = inStream.read(8) << 8;
            bData.messageId = i;
            bData.messageId = inStream.read(8) | i;
    ...
    private static void decodeUserDataPayload(UserData userData, boolean hasUserDataHeader) throws Resources.NotFoundException, CodingException {
        int offset = 0;
    ...
    private static boolean decodeServiceCategoryProgramData(BearerData bData, BitwiseInputStream inStream) throws BitwiseInputStream.AccessException, Resources.NotFoundException, CodingException {
    ...
    */
    private static void decodeCmasUserData(com.android.internal.telephony.cdma.sms.BearerData r17, int r18) throws com.android.internal.util.BitwiseInputStream.AccessException, android.content.res.Resources.NotFoundException, com.android.internal.telephony.cdma.sms.BearerData.CodingException {
        /*
