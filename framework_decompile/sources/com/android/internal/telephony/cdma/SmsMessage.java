...
public class SmsMessage extends SmsMessageBase {
    ...
    public SmsMessage(SmsAddress addr, SmsEnvelope env) throws IOException {
    ...
    private void parsePdu(byte[] pdu) throws IOException {
        int length;
    ...
    public void parsePduFromEfRecord(byte[] pdu) throws Exception {
    ...
    private static SubmitPdu privateGetSubmitPdu(String destAddrStr, boolean statusReportRequested, UserData userData, int priority) throws IOException {
