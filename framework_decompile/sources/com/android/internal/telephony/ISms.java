...
public interface ISms extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISms {
                ...
                default:
                    switch (code) {
                        ...
                        case 28:
                            ...
                            data.enforceNoDataAvail();
                            int _result18 = checkSmsShortCodeDestination(_arg026, _arg122, _arg218, _arg314, _arg410);
                            reply.writeNoException();
                        ...
                        case 29:
                            ...
                            data.enforceNoDataAvail();
                            String _result19 = getSmscAddressFromIccEfForSubscriber(_arg027, _arg123);
                            reply.writeNoException();
                        ...
                        case 30:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result20 = setSmscAddressOnIccEfForSubscriber(_arg028, _arg124, _arg219);
                            reply.writeNoException();
                        ...
                        case 31:
                            ...
                            data.enforceNoDataAvail();
                            int _result21 = getSmsCapacityOnIccForSubscriber(_arg029);
                            reply.writeNoException();
                        ...
                        case 32:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result22 = resetAllCellBroadcastRanges(_arg030);
                            reply.writeNoException();
        ...
        private static class Proxy implements ISms {
            ...
            @Override // com.android.internal.telephony.ISms
            public void sendTextForSubscriber(int subId, String callingPkg, String callingAttributionTag, String destAddr, String scAddr, String text, PendingIntent sentIntent, PendingIntent deliveryIntent, boolean persistMessageForNonDefaultSmsApp, long messageId) throws Throwable {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.android.internal.telephony.ISms
            public void sendMultipartTextForSubscriber(int subId, String callingPkg, String callingAttributionTag, String destinationAddress, String scAddress, List<String> parts, List<PendingIntent> sentIntents, List<PendingIntent> deliveryIntents, boolean persistMessageForNonDefaultSmsApp, long messageId) throws Throwable {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
