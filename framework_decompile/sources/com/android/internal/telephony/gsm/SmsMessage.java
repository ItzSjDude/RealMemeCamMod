...
public class SmsMessage extends SmsMessageBase {
    ...
    private static ISmsMessageExt mSmsMessageEx = (ISmsMessageExt) ExtLoader.type(ISmsMessageExt.class).base(null).create();
    ...
    public static int getTPLayerLengthForPDU(String pdu) throws NumberFormatException {
    ...
    protected static byte[] encodeUCS2(String message, byte[] header) throws EncodeException, UnsupportedEncodingException {
        byte[] userData;
    ...
    public static SubmitPdu getSubmitPdu(String scAddress, String destinationAddress, int destinationPort, byte[] data, boolean statusReportRequested) {
        SubmitPdu retOem = mSmsMessageEx.oemGetSubmitPdu(scAddress, destinationAddress, destinationPort, data, statusReportRequested);
        if (retOem != null) {
            return retOem;
        }
    ...
    /* JADX WARN: Type inference failed for: r13v4, types: [java.time.LocalDateTime] */
    ...
    protected static class PduParser {
        ...
        String getUserDataOem8bit(int byteCount) {
            String ret = SmsMessage.mSmsMessageEx.getUserDataOem8bit(this.mUserData, this.mPdu, this.mCur, byteCount);
            if (ret == null) {
                return null;
            }
            this.mCur += byteCount;
    ...
    protected void parsePdu(byte[] pdu) throws Resources.NotFoundException {
        this.mPdu = pdu;
    ...
    protected void parseSmsStatusReport(PduParser p, int firstByte) throws Resources.NotFoundException {
    ...
    private void parseSmsDeliver(PduParser p, int firstByte) throws Resources.NotFoundException {
    ...
    protected void parseSmsSubmit(PduParser p, int firstByte) throws Resources.NotFoundException {
    ...
    */
    protected void parseUserData(com.android.internal.telephony.gsm.SmsMessage.PduParser r17, boolean r18) throws android.content.res.Resources.NotFoundException {
        /*
    ...
    protected static SmsHeader makeSmsHeader() throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        try {
