...
public abstract class PackageChangeReceiver extends BroadcastReceiver {
    ...
    public void register(Context context, Looper thread, UserHandle user) {
        ...
        Context contextCreateContextAsUser = user == null ? context : context.createContextAsUser(user, 0);
        this.mRegisteredContext = contextCreateContextAsUser;
        contextCreateContextAsUser.registerReceiver(this, sPackageIntentFilter, null, handler);
    }
