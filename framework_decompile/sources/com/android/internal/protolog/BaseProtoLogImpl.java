...
public class BaseProtoLogImpl {
    ...
    private BaseProtoLogImplWrapper mBaseProtoLogImplWrapper = new BaseProtoLogImplWrapper();
    ...
    public String getStatus() {
        StringBuilder sbAppend = new StringBuilder().append("ProtoLog status: ").append(isProtoEnabled() ? "Enabled" : "Disabled").append("\nEnabled log groups: \n  Proto: ");
        TreeMap<String, IProtoLogGroup> treeMap = LOG_GROUPS;
        return sbAppend.append((String) treeMap.values().stream().filter(new Predicate() { // from class: com.android.internal.protolog.BaseProtoLogImpl$$ExternalSyntheticLambda0
    ...
    public IBaseProtoLogImplWrapper getWrapper() {
        return this.mBaseProtoLogImplWrapper;
    }

    private class BaseProtoLogImplWrapper implements IBaseProtoLogImplWrapper {
        private IBaseProtoLogImplExt mBaseProtoLogImplExt;

        private BaseProtoLogImplWrapper() {
            this.mBaseProtoLogImplExt = (IBaseProtoLogImplExt) ExtLoader.type(IBaseProtoLogImplExt.class).base(BaseProtoLogImpl.this).create();
        }

        /* JADX INFO: Access modifiers changed from: private */
        public IBaseProtoLogImplExt getExtImpl() {
            return this.mBaseProtoLogImplExt;
        }

        @Override // com.android.internal.protolog.IBaseProtoLogImplWrapper
        public int setLogging(boolean setTextLogging, boolean value, PrintWriter pw, String... groups) {
            return BaseProtoLogImpl.this.setLogging(setTextLogging, value, pw, groups);
        }

        @Override // com.android.internal.protolog.IBaseProtoLogImplWrapper
        public TreeMap<String, IProtoLogGroup> getLogGroups() {
            return BaseProtoLogImpl.LOG_GROUPS;
        }
    }
}
