...
public class BrightnessSynchronizer {
    ...
    public void startSynchronizing() {
        ...
        this.mBrightnessSyncObserver.startObserving();
    ...
    public static boolean floatCompare(float a, float b, boolean less) {
        if (less) {
            if (a < b) {
                return true;
            }
    ...
    private class BrightnessSyncObserver {
        ...
        private BrightnessSyncObserver() {
            ...
            this.mContentObserver = new ContentObserver(BrightnessSynchronizer.this.mHandler) { // from class: com.android.internal.display.BrightnessSynchronizer.BrightnessSyncObserver.2
                ...
                public void onChange(boolean selfChange, Uri uri) {
                    ...
                    BrightnessSynchronizer.BRIGHTNESS_URI.equals(uri);
                }
            };
        }
        ...
        void startObserving() {
            ...
            BrightnessSynchronizer.this.mDisplayManager.registerDisplayListener(this.mListener, BrightnessSynchronizer.this.mHandler, 8L);
