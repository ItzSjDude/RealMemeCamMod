                ...
                default:
                    switch (code) {
                        ...
                        case 30:
                            ...
                            data.enforceNoDataAvail();
                            onConnectionEvent(_arg030, _arg130, _arg223, _arg36);
                            return true;
                        case 31:
                            String _arg031 = data.readString();
                            Session.Info _arg131 = (Session.Info) data.readTypedObject(Session.Info.CREATOR);
                            data.enforceNoDataAvail();
                            onRttInitiationSuccess(_arg031, _arg131);
                            return true;
                        case 32:
                            String _arg032 = data.readString();
                            int _arg132 = data.readInt();
                            Session.Info _arg224 = (Session.Info) data.readTypedObject(Session.Info.CREATOR);
                            data.enforceNoDataAvail();
                            onRttInitiationFailure(_arg032, _arg132, _arg224);
                            return true;
                        case 33:
                            String _arg033 = data.readString();
                            Session.Info _arg133 = (Session.Info) data.readTypedObject(Session.Info.CREATOR);
                            data.enforceNoDataAvail();
                            onRttSessionRemotelyTerminated(_arg033, _arg133);
                            return true;
                        case 34:
                            String _arg034 = data.readString();
                            Session.Info _arg134 = (Session.Info) data.readTypedObject(Session.Info.CREATOR);
                            data.enforceNoDataAvail();
                            onRemoteRttRequest(_arg034, _arg134);
                            return true;
                        case 35:
                            String _arg035 = data.readString();
                            PhoneAccountHandle _arg135 = (PhoneAccountHandle) data.readTypedObject(PhoneAccountHandle.CREATOR);
                            Session.Info _arg225 = (Session.Info) data.readTypedObject(Session.Info.CREATOR);
                            data.enforceNoDataAvail();
                            onPhoneAccountChanged(_arg035, _arg135, _arg225);
                            return true;
                        case 36:
                            Session.Info _arg036 = (Session.Info) data.readTypedObject(Session.Info.CREATOR);
                            data.enforceNoDataAvail();
                            onConnectionServiceFocusReleased(_arg036);
                            return true;
                        case 37:
                            String _arg037 = data.readString();
                            Session.Info _arg136 = (Session.Info) data.readTypedObject(Session.Info.CREATOR);
                            data.enforceNoDataAvail();
                            resetConnectionTime(_arg037, _arg136);
                            return true;
                        case 38:
                            ...
                            data.enforceNoDataAvail();
                            setConferenceState(_arg038, _arg137, _arg226);
                            return true;
                        case 39:
                            ...
                            data.enforceNoDataAvail();
                            setCallDirection(_arg039, _arg138, _arg227);
                            return true;
                        default:
