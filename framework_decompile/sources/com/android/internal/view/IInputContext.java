...
public interface IInputContext extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IInputContext {
        ...
        static final int TRANSACTION_getSelectedText = 25;
        static final int TRANSACTION_getSurroundingText = 29;
        ...
        static final int TRANSACTION_requestCursorUpdates = 26;
        static final int TRANSACTION_requestCursorUpdatesWithFilter = 27;
        static final int TRANSACTION_sendKeyEvent = 19;
        static final int TRANSACTION_setComposingRegion = 23;
        static final int TRANSACTION_setComposingRegionWithTextAttribute = 24;
        static final int TRANSACTION_setComposingText = 7;
        static final int TRANSACTION_setComposingTextWithTextAttribute = 8;
        static final int TRANSACTION_setImeConsumesInput = 30;
                ...
                default:
                    switch (code) {
                        ...
                        case 23:
                            ...
                            data.enforceNoDataAvail();
                            setComposingRegion(_arg023, _arg119, _arg213);
                            return true;
                        case 24:
                            ...
                            data.enforceNoDataAvail();
                            setComposingRegionWithTextAttribute(_arg024, _arg120, _arg214, _arg36);
                            return true;
                        case 25:
                            ...
                            AndroidFuture _arg215 = (AndroidFuture) data.readTypedObject(AndroidFuture.CREATOR);
                            data.enforceNoDataAvail();
                            getSelectedText(_arg025, _arg121, _arg215);
                            return true;
                        case 26:
                            ...
                            data.enforceNoDataAvail();
                            requestCursorUpdates(_arg026, _arg122, _arg216, _arg37);
                            return true;
                        case 27:
                            ...
                            data.enforceNoDataAvail();
                            requestCursorUpdatesWithFilter(_arg027, _arg123, _arg217, _arg38, _arg4);
                            return true;
                        case 28:
                            ...
                            InputContentInfo _arg124 = (InputContentInfo) data.readTypedObject(InputContentInfo.CREATOR);
                            ...
                            data.enforceNoDataAvail();
                            commitContent(_arg028, _arg124, _arg218, _arg39, _arg42);
                            return true;
                        case 29:
                            ...
                            data.enforceNoDataAvail();
                            getSurroundingText(_arg029, _arg125, _arg219, _arg310, _arg43);
                            return true;
                        case 30:
                            ...
                            data.enforceNoDataAvail();
                            setImeConsumesInput(_arg030, _arg126);
                            return true;
                        default:
