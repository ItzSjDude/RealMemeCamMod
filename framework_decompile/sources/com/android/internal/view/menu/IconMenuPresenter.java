    ...
    public void updateMenuView(boolean cleared) {
        ...
        if (needsMore && ((iconMenuItemView2 = this.mMoreView) == null || iconMenuItemView2.getParent() != menuView)) {
            if (this.mMoreView == null) {
                IconMenuItemView iconMenuItemViewCreateMoreItemView = menuView.createMoreItemView();
                this.mMoreView = iconMenuItemViewCreateMoreItemView;
                iconMenuItemViewCreateMoreItemView.setBackgroundDrawable(menuView.getItemBackgroundDrawable());
            }
