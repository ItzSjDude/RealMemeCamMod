...
public abstract class BaseSurfaceHolder implements SurfaceHolder {
    ...
    private final Canvas internalLockCanvas(Rect dirty, boolean hardware) throws InterruptedException, Surface.OutOfResourcesException, IllegalArgumentException {
        if (this.mType == 3) {
