...
public class ScrollCaptureViewSupport<V extends View> implements ScrollCaptureCallback {
        ...
        if (view == null || !view.isVisibleToUser()) {
            ...
            this.mViewHelper.onScrollRequested(view, session.getScrollBounds(), requestRect, signal, new Consumer() { // from class: com.android.internal.view.ScrollCaptureViewSupport$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    this.f$0.m7160xe5912b3a(view, signal, onComplete, (ScrollCaptureViewHelper.ScrollResult) obj);
                }
            });
        }
    }
    ...
    public void m7160xe5912b3a(final ScrollCaptureViewHelper.ScrollResult scrollResult, final V view, CancellationSignal signal, final Consumer<Rect> onComplete) {
        if (signal.isCanceled()) {
            ...
            view.postOnAnimationDelayed(new Runnable() { // from class: com.android.internal.view.ScrollCaptureViewSupport$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    this.f$0.m7161x280fb804(scrollResult, view, viewCaptureArea, onComplete);
                }
    ...
    public void m7161x280fb804(ScrollCaptureViewHelper.ScrollResult scrollResult, V view, Rect viewCaptureArea, Consumer<Rect> onComplete) {
    ...
    static final class ViewRenderer {
        ...
        private void transformToRoot(View local, Rect localRect, Rect outRect) {
            ...
            if ((local instanceof ViewGroup) && ((ViewGroup) local).getClipToPadding()) {
