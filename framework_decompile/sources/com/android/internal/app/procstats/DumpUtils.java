...
public final class DumpUtils {
    ...
    public static final String[] STATE_NAMES = {"Persist", "Top", "BTop", "Fgs", "BFgs", "ImpFg", "ImpBg", "Backup", "Service", "ServRst", "Receivr", "HeavyWt", "Home", "LastAct", "Cached", "Frozen"};
    ...
    public static final String[] STATE_NAMES_CSV = {"pers", "top", "btop", "fgs", "bfgs", "impfg", "impbg", Context.BACKUP_SERVICE, "service", "service-rs", IncidentManager.URI_PARAM_RECEIVER_CLASS, "heavy", "home", "lastact", "cached", "frzn"};
