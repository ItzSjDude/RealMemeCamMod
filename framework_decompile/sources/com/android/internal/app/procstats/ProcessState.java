...
public final class ProcessState {
    ...
    boolean readFromParcel(Parcel in, int version, boolean fully) {
        ...
        if (numOfSources > 0) {
            ...
            for (int i3 = 0; i3 < numOfSources; i3++) {
    ...
    public void setCombinedState(int state, long now) {
        ...
        if (!this.mDead && this.mCurCombinedState != state) {
            ...
            UidState mUidState = this.mStats.mUidStates.get(this.mUid);
            if (mUidState != null) {
                mUidState.updateCombinedState(state, now);
            }
        }
    }
    ...
    public void dumpAggregatedProtoForStatsd(ProtoOutputStream proto, long fieldId, String procName, int uid, long now, ProcessMap<ArraySet<ProcessStats.PackageState>> procToPkgMap, SparseArray<ArraySet<String>> uidToPkgMap) {
        ...
        if (!didCurState && (i = this.mCurCombinedState) != -1 && i % 16 != 9) {
            int aggregatedType2 = DumpUtils.aggregateCurrentProcessState(i);
        ...
        for (int i3 = 0; i3 < this.mPssTable.getKeyCount(); i3++) {
        ...
        for (int i4 = 0; i4 < durationByState.size(); i4++) {
            int aggregatedKey = durationByState.keyAt(i4);
        ...
        long token = proto.start(fieldId);
        writeCompressedProcessName(proto, 1138166333441L, procName, this.mPackage, this.mMultiPackage || uidToPkgMap.get(this.mUid).size() > 1);
        proto.write(1120986464258L, uid);
        int i5 = 0;
        while (i5 < durationByState.size()) {
            long stateToken = proto.start(2246267895813L);
            int aggregatedKey2 = durationByState.keyAt(i5);
