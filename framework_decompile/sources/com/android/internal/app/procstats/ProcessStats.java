...
public final class ProcessStats implements Parcelable {
    ...
    public ProcessStats(boolean running) throws IOException {
    ...
    public ProcessStats(Parcel in) throws IOException {
        this.mPackages = new ProcessMap<>();
        this.mProcesses = new ProcessMap<>();
        this.mUidStates = new SparseArray<>();
        this.mTrackingAssociations = new ArrayList<>();
    ...
    public void add(ProcessStats other) {
        ...
        for (int ip2 = 0; ip2 < size; ip2++) {
            ...
            if (uidState == null) {
                this.mUidStates.put(uid2, uidStates2.valueAt(ip2).m6720clone());
            } else {
    ...
    public void resetSafely() throws IOException {
        resetCommon();
        long now = SystemClock.uptimeMillis();
        ArrayMap<String, SparseArray<ProcessState>> procMap = this.mProcesses.getMap();
    ...
    private void resetCommon() throws IOException {
        this.mNumAggregated = 1;
    ...
    public void updateFragmentation() throws IOException {
        Integer node;
    ...
    public void writeToParcel(Parcel parcel, long j, int i) {
        ...
        for (int i4 = 0; i4 < size3; i4++) {
            ...
            for (int i5 = 0; i5 < size4; i5++) {
                ...
                while (i6 < size5) {
                    ...
                    int size8 = packageStateValueAt.mAssociations.size();
                    int i11 = 0;
                    while (i11 < size8) {
                        packageStateValueAt.mAssociations.valueAt(i11).commitStateTime(j);
                        i11++;
                        size7 = size7;
                    }
                    i6++;
        ...
        for (int i14 = 0; i14 < size; i14++) {
            ...
            SparseArray<ProcessState> sparseArrayValueAt3 = map.valueAt(i14);
            int size10 = sparseArrayValueAt3.size();
            parcel.writeInt(size10);
            for (int i15 = 0; i15 < size10; i15++) {
                parcel.writeInt(sparseArrayValueAt3.keyAt(i15));
                ProcessState processStateValueAt2 = sparseArrayValueAt3.valueAt(i15);
        ...
        for (int i16 = 0; i16 < size3; i16++) {
            ...
            SparseArray<LongSparseArray<PackageState>> sparseArrayValueAt4 = map2.valueAt(i16);
            int size11 = sparseArrayValueAt4.size();
            parcel.writeInt(size11);
            for (int i17 = 0; i17 < size11; i17++) {
                parcel.writeInt(sparseArrayValueAt4.keyAt(i17));
                LongSparseArray<PackageState> longSparseArrayValueAt2 = sparseArrayValueAt4.valueAt(i17);
                ...
                while (i18 < size12) {
                    ...
                    int i19 = size;
                    parcel.writeLong(longSparseArrayValueAt2.keyAt(i18));
                    PackageState packageStateValueAt2 = longSparseArrayValueAt2.valueAt(i18);
                    ...
                    int i24 = 0;
                    while (i24 < size14) {
                        parcel.writeString(packageStateValueAt2.mServices.keyAt(i24));
                        ServiceState serviceStateValueAt = packageStateValueAt2.mServices.valueAt(i24);
                    ...
                    int i25 = 0;
                    while (i25 < size15) {
                        writeCommonString(parcel, packageStateValueAt2.mAssociations.keyAt(i25));
                        AssociationState associationStateValueAt = packageStateValueAt2.mAssociations.valueAt(i25);
                        writeCommonString(parcel, associationStateValueAt.getProcessName());
                        associationStateValueAt.writeToParcel(this, parcel, j);
                        i25++;
                        packageStateValueAt2 = packageStateValueAt2;
                    }
                    i18++;
                    map = arrayMap;
                    size = i19;
    ...
    public void readFromParcel(Parcel in) throws IOException {
    ...
    */
    public void dumpLocked(java.io.PrintWriter r53, java.lang.String r54, long r55, boolean r57, boolean r58, boolean r59, boolean r60, int r61) {
        /*
    ...
    public void dumpAggregatedProtoForStatsd(ProtoOutputStream[] protoStreams, long maxRawShardSizeBytes) throws IOException {
        int shardIndex = 0;
    ...
    public void dumpProcessState(final int atomTag, final StatsEventOutput statsEventOutput) {
        forEachProcess(new Consumer() { // from class: com.android.internal.app.procstats.ProcessStats$$ExternalSyntheticLambda0
            ...
            public final void accept(Object obj) {
                this.f$0.m6713x844afd42(atomTag, statsEventOutput, (ProcessState) obj);
            }
        });
    }

    /* renamed from: lambda$dumpProcessState$1$com-android-internal-app-procstats-ProcessStats, reason: not valid java name */
    /* synthetic */ void m6713x844afd42(int atomTag, StatsEventOutput statsEventOutput, ProcessState processState) {
    ...
    public void dumpProcessAssociation(final int atomTag, final StatsEventOutput statsEventOutput) {
        forEachAssociation(new QuintConsumer() { // from class: com.android.internal.app.procstats.ProcessStats$$ExternalSyntheticLambda1
            ...
            public final void accept(Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
                this.f$0.m6712xcee291b3(statsEventOutput, atomTag, (AssociationState) obj, (Integer) obj2, (String) obj3, (AssociationState.SourceKey) obj4, (AssociationState.SourceState) obj5);
            }
        });
    }

    /* renamed from: lambda$dumpProcessAssociation$2$com-android-internal-app-procstats-ProcessStats, reason: not valid java name */
    /* synthetic */ void m6712xcee291b3(StatsEventOutput statsEventOutput, int atomTag, AssociationState asc, Integer serviceUid, String serviceName, AssociationState.SourceKey key, AssociationState.SourceState src) {
            ...
            try {
                ...
                while (i3 >= 0) {
                    ...
                    if (duration < minimum) {
                        ...
                        if (idx2 >= 0) {
                            idx = 1;
                            boolean z = uidToPkgMap.valueAt(idx2).size() > 1;
                            i = idx;
