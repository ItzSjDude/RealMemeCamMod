...
public class LocalePicker extends ListFragment {
    ...
    public static List<LocaleInfo> getAllAssetLocales(Context context, boolean isInDeveloperMode) throws Resources.NotFoundException {
    ...
    public static ArrayAdapter<LocaleInfo> constructAdapter(Context context, final int layoutId, final int fieldId) throws Resources.NotFoundException {
