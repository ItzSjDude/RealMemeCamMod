...
public class SimpleIconFactory {
            ...
            if (ignoreAdiMask) {
                ...
                Optional.ofNullable(adi.getBackground()).ifPresent(new Consumer() { // from class: com.android.internal.app.SimpleIconFactory$$ExternalSyntheticLambda0
                    ...
                    public final void accept(Object obj) {
                        this.f$0.m6667x95f7c6a4(childRect, (Drawable) obj);
                    }
                });
                Optional.ofNullable(adi.getForeground()).ifPresent(new Consumer() { // from class: com.android.internal.app.SimpleIconFactory$$ExternalSyntheticLambda1
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        this.f$0.m6668x58e43003(childRect, (Drawable) obj);
                    }
                });
            } else {
    ...
    /* renamed from: lambda$createIconBitmap$0$com-android-internal-app-SimpleIconFactory, reason: not valid java name */
    /* synthetic */ void m6667x95f7c6a4(Rect childRect, Drawable drawable) {
        drawable.setBounds(childRect);
        drawable.draw(this.mCanvas);
    }

    /* renamed from: lambda$createIconBitmap$1$com-android-internal-app-SimpleIconFactory, reason: not valid java name */
    /* synthetic */ void m6668x58e43003(Rect childRect, Drawable drawable) {
        drawable.setBounds(childRect);
        drawable.draw(this.mCanvas);
    }
