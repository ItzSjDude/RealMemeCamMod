...
public class ResolverListController {
    ...
    public List<ResolverActivity.ResolvedComponentInfo> getResolversForIntentAsUser(boolean shouldGetResolvedFilter, boolean shouldGetActivityMetadata, List<Intent> intents, UserHandle userHandle) {
        int baseFlags = (shouldGetActivityMetadata ? 128 : 0) | (shouldGetResolvedFilter ? 64 : 0) | 851968;
        ...
        try {
            ...
            PriorityQueue<ResolverActivity.ResolvedComponentInfo> minHeap = new PriorityQueue<>(k, new Comparator() { // from class: com.android.internal.app.ResolverListController$$ExternalSyntheticLambda0
                ...
                public final int compare(Object obj, Object obj2) {
                    return this.f$0.m6652lambda$topK$0$comandroidinternalappResolverListController((ResolverActivity.ResolvedComponentInfo) obj, (ResolverActivity.ResolvedComponentInfo) obj2);
                }
            });
    ...
    /* renamed from: lambda$topK$0$com-android-internal-app-ResolverListController, reason: not valid java name */
    /* synthetic */ int m6652lambda$topK$0$comandroidinternalappResolverListController(ResolverActivity.ResolvedComponentInfo o1, ResolverActivity.ResolvedComponentInfo o2) {
