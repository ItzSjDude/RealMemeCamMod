...
import com.android.internal.app.ResolverListAdapter.LoadIconTask;
...
public class ResolverActivity extends Activity implements ResolverListAdapter.ResolverListCommunicator {
    ...
    private IResolverActivityWrapper mResolverWrapper;
    ...
    private enum ActionTitle {
        ...
        public static final int BROWSABLE_APP_TITLE_RES = 17041819;
        public static final int BROWSABLE_HOST_APP_TITLE_RES = 17041817;
        public static final int BROWSABLE_HOST_TITLE_RES = 17041816;
        public static final int BROWSABLE_TITLE_RES = 17041818;
    ...
    protected void onCreate(Bundle savedInstanceState, Intent intent, CharSequence title, int defaultTitleRes, Intent[] initialIntents, List<ResolveInfo> rList, boolean supportsAlwaysUseOption) {
        ...
        packageMonitorCreatePackageMonitor.register((Context) this, getMainLooper(), getPersonalProfileUserHandle(), false);
        if (shouldShowTabs()) {
            ...
            packageMonitorCreatePackageMonitor2.register((Context) this, getMainLooper(), getWorkProfileUserHandle(), false);
        }
        this.mRegistered = true;
        if (this.mResolverWrapper.getResolverActivityExt().initPreferenceAndPinList() && (rdl = (ResolverDrawerLayout) findViewById(R.id.contentPanel)) != null) {
        ...
        if (viewFindViewById != null) {
            viewFindViewById.setOnClickListener(new View.OnClickListener() { // from class: com.android.internal.app.ResolverActivity$$ExternalSyntheticLambda3
    ...
    */
    private com.android.internal.app.ResolverMultiProfilePagerAdapter createResolverMultiProfilePagerAdapterForTwoProfiles(android.content.Intent[] r16, java.util.List<android.content.pm.ResolveInfo> r17, boolean r18) {
        /*
            r15 = this;
            r8 = r15
            int r0 = r15.getCurrentProfile()
            android.content.Intent r1 = r15.getIntent()
            java.lang.String r2 = "com.android.internal.app.ResolverActivity.EXTRA_CALLING_USER"
            ...
            goto L20
        L1c:
            android.os.UserHandle r1 = r15.getUser()
        L20:
            r9 = r1
            android.os.UserHandle r1 = r15.getUser()
            boolean r1 = r1.equals(r9)
            if (r1 != 0) goto L45
            android.os.UserHandle r1 = r15.getPersonalProfileUserHandle()
            boolean r1 = r1.equals(r9)
            if (r1 == 0) goto L38
            r0 = 0
            r10 = r0
            goto L50
        L38:
            android.os.UserHandle r1 = r15.getWorkProfileUserHandle()
            boolean r1 = r1.equals(r9)
            if (r1 == 0) goto L4f
            r0 = 1
            r10 = r0
            goto L50
        L45:
            int r1 = r15.getSelectedProfileExtra()
            r2 = -1
            if (r1 == r2) goto L4f
            r0 = r1
            r10 = r0
        ...
        L4f:
            r10 = r0
        L50:
            java.util.ArrayList<android.content.Intent> r2 = r8.mIntents
            r7 = 0
            if (r10 != 0) goto L58
            r3 = r16
            goto L59
        ...
        L6d:
            r5 = r11
        L6e:
            android.os.UserHandle r6 = r15.getPersonalProfileUserHandle()
            r0 = r15
            r1 = r15
            r4 = r17
            com.android.internal.app.ResolverListAdapter r13 = r0.createResolverListAdapter(r1, r2, r3, r4, r5, r6)
            android.os.UserHandle r14 = r15.getWorkProfileUserHandle()
            java.util.ArrayList<android.content.Intent> r2 = r8.mIntents
            if (r10 != r12) goto L85
            r3 = r16
            goto L86
        ...
        L95:
            ...
            r4 = r17
            r6 = r14
            com.android.internal.app.ResolverListAdapter r11 = r0.createResolverListAdapter(r1, r2, r3, r4, r5, r6)
            com.android.internal.app.ResolverMultiProfilePagerAdapter r12 = new com.android.internal.app.ResolverMultiProfilePagerAdapter
            android.os.UserHandle r5 = r15.getPersonalProfileUserHandle()
            android.os.UserHandle r6 = r15.getWorkProfileUserHandle()
            android.os.UserHandle r0 = r15.getUser()
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.app.ResolverActivity.createResolverMultiProfilePagerAdapterForTwoProfiles(android.content.Intent[], java.util.List, boolean):com.android.internal.app.ResolverMultiProfilePagerAdapter");
    }
    ...
    protected void onRestart() {
        ...
        if (!this.mResolverWrapper.getResolverActivityExt().isOpShareUi()) {
            this.mMultiProfilePagerAdapter.getActiveListAdapter().handlePackagesChanged();
        }
        updateProfileViewButton();
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        if (!this.mResolverWrapper.getResolverActivityExt().hookonSaveInstanceState(outState, LAST_SHOWN_TAB_KEY) && (viewPager = (ViewPager) findViewById(R.id.profile_pager)) != null) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    protected boolean onTargetSelected(com.android.internal.app.chooser.TargetInfo r20, boolean r21) {
        /*
    ...
    private void safelyStartActivityInternal(TargetInfo cti, UserHandle user) {
        ...
        if (!this.mSafeForwardingMode) {
            if (cti.startAsUser(this, this.mBundle, user)) {
        ...
        try {
            if (cti.startAsCaller(this, this.mBundle, user.getIdentifier())) {
                onActivityStarted(cti);
                maybeLogCrossProfileTargetLaunch(cti, user);
            }
    ...
    private void configureMiniResolverContent() {
        ...
        ResolverListAdapter.LoadIconTask iconTask = inactiveAdapter.new LoadIconTask(otherProfileResolveInfo, new ResolverListAdapter.ViewHolder(icon));
        ...
        findViewById(R.id.use_same_profile_browser).setOnClickListener(new View.OnClickListener() { // from class: com.android.internal.app.ResolverActivity$$ExternalSyntheticLambda11
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m6636xcf07eb45(sameProfileResolveInfo, view);
            }
        });
        findViewById(R.id.button_open).setOnClickListener(new View.OnClickListener() { // from class: com.android.internal.app.ResolverActivity$$ExternalSyntheticLambda12
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m6637xb4495a06(otherProfileResolveInfo, inactiveAdapter, view);
            }
        });
    }

    /* renamed from: lambda$configureMiniResolverContent$3$com-android-internal-app-ResolverActivity, reason: not valid java name */
    /* synthetic */ void m6636xcf07eb45(DisplayResolveInfo sameProfileResolveInfo, View v) {
    ...
    /* synthetic */ void m6637xb4495a06(DisplayResolveInfo otherProfileResolveInfo, ResolverListAdapter inactiveAdapter, View v) {
    ...
    private void setupProfileTabs() {
        ...
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() { // from class: com.android.internal.app.ResolverActivity$$ExternalSyntheticLambda9
            ...
            public final void onTabChanged(String str) {
                this.f$0.m6645x4c8038db(tabHost, viewPager, str);
            }
        });
        ...
        this.mMultiProfilePagerAdapter.setOnSwitchOnWorkSelectedListener(new AbstractMultiProfilePagerAdapter.OnSwitchOnWorkSelectedListener() { // from class: com.android.internal.app.ResolverActivity$$ExternalSyntheticLambda10
            ...
            public final void onSwitchOnWorkSelected() {
                ResolverActivity.lambda$setupProfileTabs$6(tabHost);
            }
        });
    }

    /* renamed from: lambda$setupProfileTabs$5$com-android-internal-app-ResolverActivity, reason: not valid java name */
    /* synthetic */ void m6645x4c8038db(TabHost tabHost, ViewPager viewPager, String tabId) {
        updateActiveTabStyle(tabHost);
    ...
    static /* synthetic */ void lambda$setupProfileTabs$6(TabHost tabHost) {
    ...
    private String getPersonalTabAccessibilityLabel() {
        return ((DevicePolicyManager) getSystemService(DevicePolicyManager.class)).getResources().getString(DevicePolicyResources.Strings.Core.RESOLVER_PERSONAL_TAB_ACCESSIBILITY, new Supplier() { // from class: com.android.internal.app.ResolverActivity$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                return this.f$0.m6640xf34103fa();
            }
        });
    }
    ...
    /* synthetic */ String m6640xf34103fa() {
