...
public class AlertController {
    ...
    public void installContent(AlertParams params) throws Resources.NotFoundException {
        params.apply(this);
        installContent();
    }

    public void installContent() throws Resources.NotFoundException {
    ...
    private void setupCustomContent(ViewGroup customPanel) throws Resources.NotFoundException {
        View customView;
        if (this.mView != null) {
    ...
    public static class AlertParams {
        ...
        private class AlertParamsWrapper implements IAlertParamsWrapper {
            ...
            @Override // android.app.dialog.IAlertParamsWrapper
