...
public class ResolverListAdapter extends BaseAdapter {
    ...
    List<ResolverActivity.ResolvedComponentInfo> getInitialRebuiltResolveList() {
        ...
        return this.mResolverListController.getResolversForIntent(true, this.mResolverListCommunicator.shouldGetActivityMetadata(), this.mIntents);
    }
    ...
    protected void processSortedList(List<ResolverActivity.ResolvedComponentInfo> sortedComponents, boolean doPostProcessing) {
            ...
            if (this.mInitialIntents != null) {
                ...
                while (true) {
                    ...
                    if (ii != null && (ri = this.mResolverListAdapterWrapper.getResolverListAdapterExt().getResolveInfo(ii, this.mPm)) != null) {
                        ...
                        if (!this.mResolverListAdapterWrapper.getResolverListAdapterExt().hookAddResolveInfo(this.mContext, this, ii, ri, this.mDisplayList)) {
        ...
        this.mResolverListAdapterWrapper.getResolverListAdapterExt().addMultiAppResolveInfoIfNeed(sortedComponents, this.mIntents, this.mResolverListController, this.mPm, this.mDisplayList);
    ...
    View onCreateView(ViewGroup parent) {
        return this.mResolverListAdapterWrapper.getResolverListAdapterExt().hookonCreateView(this.mInflater, R.layout.resolve_list_item, parent);
    }
    ...
    class LoadIconTask extends AsyncTask<Void, Void, Drawable> {
        ...
        private ILoadIconTaskWrapper mWrapper = new LoadIconTaskWrapper();
        private ILoadIconTaskExt mLoadIconTaskExt = (ILoadIconTaskExt) ExtLoader.type(ILoadIconTaskExt.class).base(this).create();
        ...
        public void onPostExecute(Drawable d) {
            ...
            getWrapper().getLoadIconTaskExt().hookonPostExecute(ResolverListAdapter.this.mResolverListAdapterWrapper.getResolverListAdapterExt(), this.mDisplayResolveInfo);
            ResolverListAdapter.this.notifyDataSetChanged();
        }

        public void setViewHolder(ViewHolder holder) {
            if (getWrapper().getLoadIconTaskExt().hooksetViewHolder(ResolverListAdapter.this.mResolverListAdapterWrapper.getResolverListAdapterExt(), this.mDisplayResolveInfo, holder)) {
                return;
            }
            this.mHolder = holder;
        ...
        public ILoadIconTaskWrapper getWrapper() {
            return this.mWrapper;
        }

        public class LoadIconTaskWrapper implements ILoadIconTaskWrapper {
            public LoadIconTaskWrapper() {
            }

            @Override // com.android.internal.app.ILoadIconTaskWrapper
            public ILoadIconTaskExt getLoadIconTaskExt() {
                if (LoadIconTask.this.mLoadIconTaskExt == null) {
                    return ILoadIconTaskExt.DEFAULT;
                }
                return LoadIconTask.this.mLoadIconTaskExt;
            }
        }
    }
    ...
    public class ResolverListAdapterWrapper implements IResolverListAdapterWrapper {
        ...
        @Override // com.android.internal.app.IResolverListAdapterWrapper
        public ResolverListCommunicator getResolverListCommunicator() {
            return ResolverListAdapter.this.mResolverListCommunicator;
        }
    }
}
