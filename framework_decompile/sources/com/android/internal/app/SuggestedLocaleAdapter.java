...
public class SuggestedLocaleAdapter extends BaseAdapter implements Filterable {
    ...
    private View getNewViewIfNeeded(View convertView, ViewGroup parent, int itemType, int position) throws Resources.NotFoundException {
        switch (itemType) {
            case 0:
            case 1:
                boolean shouldReuseView = convertView instanceof TextView;
                boolean shouldReuseView2 = shouldReuseView && convertView.findViewById(R.id.language_picker_header) != null;
                if (!shouldReuseView2) {
            ...
            case 2:
            default:
                boolean shouldReuseView3 = (convertView instanceof TextView) && convertView.findViewById(R.id.locale) != null;
                if (!shouldReuseView3) {
            ...
            case 3:
                if (((LocaleStore.LocaleInfo) getItem(position)).isAppCurrentLocale()) {
                    boolean shouldReuseView4 = (convertView instanceof LinearLayout) && convertView.findViewById(R.id.language_picker_item) != null;
                    if (!shouldReuseView4) {
                    ...
                    boolean shouldReuseView5 = (convertView instanceof TextView) && convertView.findViewById(R.id.locale) != null;
                    if (!shouldReuseView5) {
                ...
                break;
            case 4:
                boolean shouldReuseView6 = (convertView instanceof LinearLayout) && convertView.findViewById(R.id.language_picker_item) != null;
                if (!shouldReuseView6) {
    ...
    private void addStateDescriptionIntoCurrentLocaleItem(View root) throws Resources.NotFoundException {
