...
public class ChooserActivity extends ResolverActivity implements ChooserListAdapter.ChooserListCommunicator, SelectableTargetInfo.SelectableTargetInfoCommunicator {
    ...
    private boolean mIsNearbyShareFirstTargetInRankedApp = DeviceConfig.getBoolean(DeviceConfig.NAMESPACE_SYSTEMUI, SystemUiDeviceConfigFlags.IS_NEARBY_SHARE_FIRST_TARGET_IN_RANKED_APP, false);
    int mListViewUpdateDelayMs = DeviceConfig.getInt(DeviceConfig.NAMESPACE_SYSTEMUI, SystemUiDeviceConfigFlags.SHARESHEET_LIST_VIEW_UPDATE_DELAY, 125);
                    ...
                    case 2:
                        if (!ChooserActivity.this.isFinishing()) {
                            ...
                            if (task.mBmp == null) {
                                ...
                                ChooserActivity.this.getResolverWrapper().getResolverActivityExt().setCornerRadius(ChooserActivity.this.getApplicationContext(), imageView);
                                break;
                            }
                        }
                        break;
        ...
        public void loadUriIntoView(final int imageResourceId, final Uri uri, final int extraImages) {
            ...
            AsyncTask.THREAD_POOL_EXECUTOR.execute(new Runnable() { // from class: com.android.internal.app.ChooserActivity$ContentPreviewCoordinator$$ExternalSyntheticLambda0
                ...
                public final void run() throws Resources.NotFoundException {
                    this.f$0.m6574xae30b39f(uri, imageResourceId, extraImages);
                }
            });
        }

        /* renamed from: lambda$loadUriIntoView$0$com-android-internal-app-ChooserActivity$ContentPreviewCoordinator, reason: not valid java name */
        /* synthetic */ void m6574xae30b39f(Uri uri, int imageResourceId, int extraImages) throws Resources.NotFoundException {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parcelable targetParcelable2 = intent.getParcelableExtra(Intent.EXTRA_INTENT);
        ...
        boolean shouldFilterNearby = (shouldNearbyShareBeFirstInRankedRow() || nearbySharingComponent == null) ? false : true;
        if (pa2 != null) {
            ...
            while (true) {
                ...
                if (!(pa2[i3] instanceof ComponentName)) {
        ...
        if (pa3 != null) {
            ...
            while (true) {
                ...
                if (!(pa3[i4] instanceof ChooserTarget)) {
        ...
        if (getResolverWrapper().getResolverActivityExt().getFileSharedDisabled()) {
            Log.w(TAG, "ResolverActivity stop self due to customize file shared disabled!");
            finish();
        }
        long jCurrentTimeMillis = System.currentTimeMillis();
        this.mChooserShownTime = jCurrentTimeMillis;
        long systemCost = jCurrentTimeMillis - intentReceivedTime;
        ...
        if (this.mResolverDrawerLayout != null) {
            this.mResolverDrawerLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda7
                ...
                public final void onLayoutChange(View view, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12) throws Resources.NotFoundException {
                    this.f$0.handleLayoutChange(view, i5, i6, i7, i8, i9, i10, i11, i12);
                }
            });
            target2 = target4;
            if (isSendAction(target2)) {
                this.mResolverDrawerLayout.setOnScrollChangeListener(new View.OnScrollChangeListener() { // from class: com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda8
                    ...
                    public final void onScrollChange(View view, int i5, int i6, int i7, int i8) {
                        this.f$0.handleScroll(view, i5, i6, i7, i8);
                    }
                });
            }
        ...
        chooserActivityLogger.logShareStarted(259, referrerPackageName, type, chooserTargetArr == null ? 0 : chooserTargetArr.length, initialIntents == null ? 0 : initialIntents.length, isWorkProfile(), findPreferredContentPreview(getTargetIntent(), getContentResolver()), target2.getAction());
    ...
    private AppPredictor.Callback createAppPredictorCallback(final ChooserListAdapter chooserListAdapter) {
        return new AppPredictor.Callback() { // from class: com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda1
            ...
            public final void onTargetsAvailable(List list) {
                this.f$0.m6561x6f7f7697(chooserListAdapter, list);
            }
        };
    }

    /* renamed from: lambda$createAppPredictorCallback$0$com-android-internal-app-ChooserActivity, reason: not valid java name */
    /* synthetic */ void m6561x6f7f7697(ChooserListAdapter chooserListAdapter, List resultList) {
    ...
    private ChooserMultiProfilePagerAdapter createChooserMultiProfilePagerAdapterForOneProfile(Intent[] initialIntents, List<ResolveInfo> rList, boolean filterLastUsed) {
        ...
        return new ChooserMultiProfilePagerAdapter(this, adapter, getPersonalProfileUserHandle(), null, isSendAction(getTargetIntent()), this.mMaxTargetsPerRow);
    }
    ...
    private ChooserMultiProfilePagerAdapter createChooserMultiProfilePagerAdapterForTwoProfiles(Intent[] initialIntents, List<ResolveInfo> rList, boolean filterLastUsed) {
        ...
        return new ChooserMultiProfilePagerAdapter(this, personalAdapter, workAdapter, selectedProfile, getPersonalProfileUserHandle(), getWorkProfileUserHandle(), isSendAction(getTargetIntent()), this.mMaxTargetsPerRow);
    }
    ...
    private void adjustPreviewWidth(int orientation, View parent) throws Resources.NotFoundException {
        if (!getResolverWrapper().getResolverActivityExt().isOriginUi()) {
            return;
        }
        int width = -1;
    ...
    protected TargetInfo getNearbySharingTarget(Intent originalIntent) throws Resources.NotFoundException {
        Drawable icon;
    ...
    private Button createActionButton(Drawable icon, CharSequence title, View.OnClickListener r) throws Resources.NotFoundException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public Button createCopyButton() throws Resources.NotFoundException {
        Button b = createActionButton(getDrawable(R.drawable.ic_menu_copy_material), getString(17039361), new ChooserActivity$$ExternalSyntheticLambda5(this));
        b.setId(R.id.chooser_copy_button);
        return b;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public Button createNearbyButton(Intent originalIntent) throws Resources.NotFoundException {
        ...
        Button b = createActionButton(ti.getDisplayIcon(this), ti.getDisplayLabel(), new View.OnClickListener() { // from class: com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda4
            ...
            public final void onClick(View view) {
                this.f$0.m6563x12250c45(ti, view);
            }
        });
    ...
    /* renamed from: lambda$createNearbyButton$1$com-android-internal-app-ChooserActivity, reason: not valid java name */
    /* synthetic */ void m6563x12250c45(TargetInfo ti, View unused) {
        getChooserActivityLogger().logShareTargetSelected(5, "", -1, false);
        safelyStartActivityAsUser(ti, getPersonalProfileUserHandle());
        finish();
    }

    private Button createEditButton(Intent originalIntent) throws Resources.NotFoundException {
        ...
        Button b = createActionButton(ti.getDisplayIcon(this), ti.getDisplayLabel(), new View.OnClickListener() { // from class: com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m6562x99f1b6f9(ti, view);
            }
        });
    ...
    /* renamed from: lambda$createEditButton$2$com-android-internal-app-ChooserActivity, reason: not valid java name */
    /* synthetic */ void m6562x99f1b6f9(TargetInfo ti, View unused) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void addActionButton(ViewGroup parent, Button b) {
        if (b == null) {
            return;
        }
    ...
    private ViewGroup displayContentPreview(int previewType, Intent targetIntent, LayoutInflater layoutInflater, ViewGroup parent) throws Resources.NotFoundException {
    ...
    private ViewGroup displayTextContentPreview(Intent targetIntent, LayoutInflater layoutInflater, ViewGroup parent) {
        ...
        if (getResolverWrapper().getResolverActivityExt().isOriginUi()) {
            ...
            contentPreviewLayout = getResolverWrapper().getResolverActivityExt().isOriginUi() ? (ViewGroup) layoutInflater.inflate(R.layout.chooser_grid_preview_text, parent, false) : getResolverWrapper().getResolverActivityExt().hookdisplayTextContentPreview(targetIntent, layoutInflater, parent, new ChooserActivity$$ExternalSyntheticLambda5(this));
        }
    ...
    private ViewGroup displayImageContentPreview(Intent targetIntent, LayoutInflater layoutInflater, ViewGroup parent) {
        ...
        if (getResolverWrapper().getResolverActivityExt().isOriginUi()) {
            contentPreviewLayout = (ViewGroup) layoutInflater.inflate(R.layout.chooser_grid_preview_image, parent, false);
        } else {
        ...
        if (getResolverWrapper().getResolverActivityExt().isOriginUi()) {
            ...
            getResolverWrapper().getResolverActivityExt().addNearbyAction(contentPreviewLayout, targetIntent);
        }
    ...
    private ViewGroup displayFileContentPreview(Intent targetIntent, LayoutInflater layoutInflater, ViewGroup parent) {
        ViewGroup contentPreviewLayout;
        if (getResolverWrapper().getResolverActivityExt().isOriginUi()) {
            contentPreviewLayout = (ViewGroup) layoutInflater.inflate(R.layout.chooser_grid_preview_file, parent, false);
        } else {
        ...
        if (Intent.ACTION_SEND.equals(action)) {
            ...
            List<Uri> uris = (List) targetIntent.getParcelableArrayListExtra(Intent.EXTRA_STREAM).stream().filter(new Predicate() { // from class: com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda2
            ...
            if (uriCount == 1) {
                ...
                getResolverWrapper().getResolverActivityExt().setChooserPreFileSingleIconView(R.drawable.ic_file_copy, fileIconView, false, null, false, null, null);
            }
        }
        return contentPreviewLayout;
    }
    ...
    private void loadFileUriIntoView(Uri uri, View parent) {
        ...
        getResolverWrapper().getResolverActivityExt().setChooserPreFileSingleIconView(R.drawable.chooser_file_generic, fileIconView, true, fileNameView, true, fileInfo.name, uri);
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (isFinishing()) {
            this.mLatencyTracker.m7116lambda$onActionStart$1$comandroidinternalutilLatencyTracker(16);
        }
    ...
    public void showTargetDetails(TargetInfo targetInfo) {
        ...
        bundle.putParcelable(ChooserTargetActionsDialogFragment.USER_HANDLE_KEY, this.mChooserMultiProfilePagerAdapter.getCurrentUserHandle());
    ...
    protected void queryDirectShareTargets(final ChooserListAdapter adapter, boolean skipAppPredictionService) {
        ...
        AsyncTask.execute(new Runnable() { // from class: com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda6
            ...
            public final void run() {
                this.f$0.m6565x8a37aa56(userHandle, filter, adapter);
            }
        });
    }

    /* renamed from: lambda$queryDirectShareTargets$3$com-android-internal-app-ChooserActivity, reason: not valid java name */
    /* synthetic */ void m6565x8a37aa56(UserHandle userHandle, IntentFilter filter, ChooserListAdapter adapter) {
    ...
    private void sendShortcutManagerShareTargetResults(int shortcutType, ServiceResultInfo[] results) {
        Message msg = Message.obtain();
        msg.what = 7;
        msg.obj = results;
    ...
    public List<ChooserTarget> convertToChooserTarget(List<ShortcutManager.ShareShortcutInfo> matchingShortcuts, List<ShortcutManager.ShareShortcutInfo> allShortcuts, List<AppTarget> allAppTargets, int shortcutType) {
        ...
        for (int i2 = 0; i2 < matchingShortcuts.size(); i2++) {
            ...
            ChooserTarget chooserTarget = new ChooserTarget(shortcutInfo.getLabel(), null, score, matchingShortcuts.get(i2).getTargetComponent().m857clone(), extras);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void handleLayoutChange(View v, int left, final int top, int right, final int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) throws Resources.NotFoundException {
        ...
        if (isLayoutUpdated || this.mLastNumberOfChildren != recyclerView.getChildCount()) {
            ...
            getMainThreadHandler().post(new Runnable() { // from class: com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda9
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m6564x123f498c(gridAdapter, top, bottom, recyclerView);
                }
            });
        }
    }

    /* renamed from: lambda$handleLayoutChange$5$com-android-internal-app-ChooserActivity, reason: not valid java name */
    /* synthetic */ void m6564x123f498c(ChooserGridAdapter gridAdapter, int top, int bottom, RecyclerView recyclerView) {
    ...
    private void setupScrollListener() {
        ...
        getResolverWrapper().getResolverActivityExt().setChooserHeadBackground(elevatedView);
            ...
            if (isClickable) {
                ...
                itemView.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.android.internal.app.ChooserActivity$ItemViewHolder$$ExternalSyntheticLambda1
                    ...
                    public final boolean onLongClick(View view) {
                        return this.f$0.m6576x1af50edc(view);
                    }
                });
            }
        }

        /* renamed from: lambda$new$0$com-android-internal-app-ChooserActivity$ItemViewHolder, reason: not valid java name */
        /* synthetic */ void m6575xf56105db(View v) {
            ChooserActivity.this.startSelected(this.mListPosition, false, true);
        }

        /* renamed from: lambda$new$1$com-android-internal-app-ChooserActivity$ItemViewHolder, reason: not valid java name */
        /* synthetic */ boolean m6576x1af50edc(View v) {
    ...
    public final class ChooserGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public boolean calculateChooserTargetWidth(int width) throws Resources.NotFoundException {
            if (width == 0) {
                return false;
            }
        ...
        private View createProfileView(ViewGroup parent) throws Resources.NotFoundException {
        ...
        private ItemGroupViewHolder loadViewsIntoGroup(final ItemGroupViewHolder holder) {
            ...
            for (int i = 0; i < columnCount; i++) {
                ...
                v.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.android.internal.app.ChooserActivity$ChooserGridAdapter$$ExternalSyntheticLambda1
                    @Override // android.view.View.OnLongClickListener
                    public final boolean onLongClick(View view) {
                        return this.f$0.m6566x7735b3d6(holder, column, view);
                    }
                });
                holder.addView(i, v);
                if (isDirectShare) {
        ...
        /* renamed from: lambda$loadViewsIntoGroup$0$com-android-internal-app-ChooserActivity$ChooserGridAdapter, reason: not valid java name */
        /* synthetic */ boolean m6566x7735b3d6(ItemGroupViewHolder holder, int column, View v1) {
        ...
        ItemGroupViewHolder createItemGroupViewHolder(int viewType, ViewGroup parent) {
            ...
            ArrayList arrayListNewArrayList = Lists.newArrayList(row1, row2);
            ...
            DirectShareViewHolder directShareViewHolder = new DirectShareViewHolder(parentGroup, arrayListNewArrayList, i, viewType, new Supplier() { // from class: com.android.internal.app.ChooserActivity$ChooserGridAdapter$$ExternalSyntheticLambda0
    ...
    private class ChooserActivityWrapper implements IChooserActivityWrapper {
        ...
        @Override // com.android.internal.app.IChooserActivityWrapper
        public void addActionButton(ViewGroup parent, Button b) {
            ChooserActivity.this.addActionButton(parent, b);
        }
        ...
        @Override // com.android.internal.app.IChooserActivityWrapper
        public Button createNearbyButton(Intent originalIntent) {
            return ChooserActivity.this.createNearbyButton(originalIntent);
        }
    }
}
