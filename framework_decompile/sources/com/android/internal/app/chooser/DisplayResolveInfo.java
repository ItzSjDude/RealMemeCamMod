...
public class DisplayResolveInfo implements TargetInfo, Parcelable {
    ...
    public boolean startAsCaller(ResolverActivity activity, Bundle options, int userId) {
        int userId2 = this.mDisplayResolveInfoExt.changeUserIdIfNeed(activity.getResolverWrapper().getResolverActivityExt(), this.mResolvedIntent, userId);
        if (this.mDisplayResolveInfoExt.shouldPrepareIntentForCrossProfileLaunch(activity.getResolverWrapper().getResolverActivityExt())) {
            TargetInfo.prepareIntentForCrossProfileLaunch(this.mResolvedIntent, userId2);
        }
        activity.startActivityAsCaller(this.mResolvedIntent, options, false, userId2);
        return true;
    }
