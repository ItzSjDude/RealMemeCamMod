...
public abstract class ToggleAction implements Action {
    ...
    @Override // com.android.internal.globalactions.Action
    public View create(Context context, View convertView, ViewGroup parent, LayoutInflater inflater) throws Resources.NotFoundException {
        willCreate();
        ...
        if (icon != null) {
            icon.m7231x2ffdb2aa(context.getDrawable(on ? this.mEnabledIconResId : this.mDisabledIconResid));
