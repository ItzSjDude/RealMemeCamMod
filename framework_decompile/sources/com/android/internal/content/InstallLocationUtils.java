...
public class InstallLocationUtils {
    ...
    private static boolean checkFitOnVolume(StorageManager storageManager, String volumePath, PackageInstaller.SessionParams params) throws Throwable {
        if (volumePath == null) {
            return false;
        }
    ...
    public static String resolveInstallVolume(Context context, PackageInstaller.SessionParams params, TestableInterface testInterface) throws Throwable {
    ...
    public static boolean fitsOnInternal(Context context, PackageInstaller.SessionParams params) throws Throwable {
    ...
    public static int resolveInstallLocation(Context context, PackageInstaller.SessionParams params) throws Throwable {
        int prefer;
        boolean checkBoth;
