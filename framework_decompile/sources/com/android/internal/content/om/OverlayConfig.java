...
public class OverlayConfig {
    ...
    public OverlayConfig(final File rootDirectory, Supplier<OverlayScanner> scannerFactory, PackageProvider packageProvider) throws IOException {
        ...
        while (i2 < n) {
            ...
            ArrayList<OverlayConfigParser.ParsedConfiguration> partitionOverlays = OverlayConfigParser.getConfigurations(partition, scanner, packageManagerOverlayInfos, activeApexesPerPartition3.getOrDefault(Integer.valueOf(partition.type), Collections.emptyList()));
    ...
    private static ArrayMap<Integer, List<String>> getActiveApexes(List<OverlayConfigParser.OverlayPartition> partitions) throws IOException {
