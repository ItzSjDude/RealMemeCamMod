...
public interface IStatusBar extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IStatusBar {
                ...
                default:
                    switch (code) {
                        ...
                        case 64:
                            ...
                            CharSequence _arg120 = (CharSequence) data.readTypedObject(TextUtils.CHAR_SEQUENCE_CREATOR);
                            ...
                            data.enforceNoDataAvail();
                            requestAddTile(_arg047, _arg120, _arg210, _arg35, _arg45);
                            return true;
                        case 65:
                        ...
                        case 66:
                            ...
                            data.enforceNoDataAvail();
                            updateMediaTapToTransferSenderDisplay(_arg049, _arg121, _arg211);
                            return true;
                        case 67:
                            ...
                            data.enforceNoDataAvail();
                            updateMediaTapToTransferReceiverDisplay(_arg050, _arg122, _arg212, _arg36);
                            return true;
                        case 68:
        ...
        private static class Proxy implements IStatusBar {
            ...
            @Override // com.android.internal.statusbar.IStatusBar
            public void showAuthenticationDialog(PromptInfo promptInfo, IBiometricSysuiReceiver sysuiReceiver, int[] sensorIds, boolean credentialAllowed, boolean requireConfirmation, int userId, long operationId, String opPackageName, long requestId, int multiSensorConfig) throws Throwable {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
