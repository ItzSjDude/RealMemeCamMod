...
public interface IInputMethodPrivilegedOperations extends IInterface {
    ...
    void hideMySoftInput(int i, AndroidFuture androidFuture) throws RemoteException;
    ...
    public static class Default implements IInputMethodPrivilegedOperations {
        ...
        @Override // com.android.internal.inputmethod.IInputMethodPrivilegedOperations
        public void hideMySoftInput(int flags, AndroidFuture future) throws RemoteException {
        }
                ...
                default:
                    switch (code) {
                        ...
                        case 14:
                            ...
                            data.enforceNoDataAvail();
                            applyImeVisibilityAsync(_arg013, _arg19);
                            return true;
                        case 15:
