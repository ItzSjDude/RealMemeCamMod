...
public final class SystemBarUtils {
    ...
    public static int getStatusBarHeight(Resources res, DisplayCutout cutout) throws Resources.NotFoundException {
    ...
    public static int getStatusBarHeightForRotation(Context context, int targetRot) throws Resources.NotFoundException {
    ...
    public static int getQuickQsOffsetHeight(Context context) throws Resources.NotFoundException {
