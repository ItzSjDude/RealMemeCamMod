...
public class DockedDividerUtils {
    public static int sDividerInsets = -1;
    ...
    public static int getDividerInsets(Resources res) {
        if (sDividerInsets == -1) {
            sDividerInsets = ((ISplitScreenManagerExt) ExtLoader.type(ISplitScreenManagerExt.class).create()).getDividerInsets(res);
        }
        return sDividerInsets;
    }

    public static int getDividerSize(Resources res, int dividerInsets) throws Resources.NotFoundException {
