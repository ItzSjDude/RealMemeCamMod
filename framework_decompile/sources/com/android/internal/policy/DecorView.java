...
public class DecorView extends FrameLayout implements RootViewSurfaceTaker, WindowCallbacks {
    ...
    /* renamed from: lambda$new$0$com-android-internal-policy-DecorView, reason: not valid java name */
    /* synthetic */ boolean m7050lambda$new$0$comandroidinternalpolicyDecorView() {
        updateBackgroundBlurCorners();
        return true;
    }

    DecorView(Context context, int featureId, PhoneWindow window, WindowManager.LayoutParams params) throws Resources.NotFoundException {
        super(context);
        ...
        this.mBackgroundBlurOnPreDrawListener = new ViewTreeObserver.OnPreDrawListener() { // from class: com.android.internal.policy.DecorView$$ExternalSyntheticLambda0
            ...
            public final boolean onPreDraw() {
                return this.f$0.m7050lambda$new$0$comandroidinternalpolicyDecorView();
            }
        };
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        this.mDecorViewExt.inputLog(XmlTags.ATTR_DESCRIPTION, TAG, "dispatchKeyEvent, code=" + keyCode + ", action=" + action + ", repeat=" + event.getRepeatCount() + ", destoryed=" + this.mWindow.isDestroyed(), null);
        ...
        if (!this.mWindow.isDestroyed()) {
            ...
            if (event.getDownTime() == event.getEventTime() || event.isLongPress() || action == 1) {
                try {
                    this.mDecorViewExt.inputLog("v", TAG, "dispatchKeyEvent cb handled=" + handled + ", " + event + ", activity=" + cb + ", mFeatureId=" + this.mFeatureId, null);
                } catch (Exception e) {
                    this.mDecorViewExt.inputLog("v", TAG, "dispatchKeyEvent: print log exception = " + e, null);
                }
            }
            if (handled) {
                return true;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        Window.Callback cb = this.mWindow.getCallback();
        this.mDecorViewExt.inputLog("d1", TAG, "dispatchTouchEvent cb=" + cb + ", destoryed=" + this.mWindow.isDestroyed() + ", featureId=" + this.mFeatureId, ev);
    ...
    public boolean superDispatchKeyEvent(KeyEvent event) {
        this.mDecorViewExt.inputLog(XmlTags.ATTR_DESCRIPTION, TAG, " superDispatchKeyEvent(), event = " + KeyEvent.keyCodeToString(event.getKeyCode()), null);
        if (event.getKeyCode() == 4) {
            ...
            if (actionMode != null) {
                ...
                this.mDecorViewExt.inputLog("v1", TAG, " KeyEvent.KEYCODE_BACK consumed by " + this.mPrimaryActionMode, null);
                return true;
            }
        }
    ...
    */
    ...
    private ActionMode startActionMode(View originatingView, ActionMode.Callback callback, int type) throws Resources.NotFoundException {
    ...
    /* JADX WARN: Removed duplicated region for block: B:129:0x0206 A[PHI: r3
      0x0206: PHI (r3v16 'attrs' android.view.WindowManager$LayoutParams) = (r3v14 'attrs' android.view.WindowManager$LayoutParams), (r3v17 'attrs' android.view.WindowManager$LayoutParams) binds: [B:128:0x0204, B:123:0x01fb] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:133:0x0210  */
    /* JADX WARN: Removed duplicated region for block: B:137:0x0218 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:142:0x0222  */
    /* JADX WARN: Removed duplicated region for block: B:150:0x0235  */
    /* JADX WARN: Removed duplicated region for block: B:154:0x023c A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:202:0x02bc A[ADDED_TO_REGION, REMOVE] */
    /* JADX WARN: Removed duplicated region for block: B:204:0x02c0 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:208:0x02da  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    android.view.WindowInsets updateColorViews(android.view.WindowInsets r28, boolean r29) {
        /*
            ...
            if (this.mCrossWindowBlurEnabledListener == null) {
                this.mCrossWindowBlurEnabledListener = new Consumer() { // from class: com.android.internal.policy.DecorView$$ExternalSyntheticLambda1
                    ...
                    public final void accept(Object obj) {
                        this.f$0.m7051xc6f1df0a((Boolean) obj);
                    }
                };
    ...
    /* renamed from: lambda$setBackgroundBlurRadius$1$com-android-internal-policy-DecorView, reason: not valid java name */
    /* synthetic */ void m7051xc6f1df0a(Boolean enabled) {
    ...
    */
    ...
    private void setHandledActionMode(ActionMode mode) throws Resources.NotFoundException {
        if (mode.getType() == 0) {
    ...
    private void setHandledPrimaryActionMode(ActionMode mode) throws Resources.NotFoundException {
        endOnGoingFadeAnimation();
        this.mPrimaryActionMode = mode;
        mode.invalidate();
        ...
        if (this.mPrimaryActionModePopup != null) {
            ...
            this.mDecorViewExt.hookSetHandledPrimaryActionMode(objectAnimatorOfFloat);
    ...
    private void updateDecorCaptionStatus(Configuration config) {
        ...
        if (decorCaptionView == null && displayWindowDecor) {
            ...
            DecorCaptionView decorCaptionViewCreateDecorCaptionView = createDecorCaptionView(inflater);
            this.mDecorCaptionView = decorCaptionViewCreateDecorCaptionView;
            if (decorCaptionViewCreateDecorCaptionView != null) {
                if (decorCaptionViewCreateDecorCaptionView.getParent() == null) {
    ...
    private void initResizingPaints() throws Resources.NotFoundException {
