...
public class PhoneFallbackEventHandler implements FallbackEventHandler {
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        this.mPFEHExt.inputLog(TAG, " dispatchKeyEvent  " + event);
    ...
    private void handleVolumeKeyEvent(KeyEvent keyEvent) {
        this.mPFEHExt.inputLog(TAG, " MediaSession handleVolumeKeyEvent in PhoneFallbackEventHandler : " + keyEvent);
        getMediaSessionManager().dispatchVolumeKeyEventAsSystemService(keyEvent, Integer.MIN_VALUE);
    }

    private void handleMediaKeyEvent(KeyEvent keyEvent) {
        this.mPFEHExt.inputLog(TAG, " MediaSession handleMediaKeyEvent in PhoneFallbackEventHandler : " + keyEvent);
