...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    public PhoneWindow(Context context) {
        ...
        this.mProxyOnBackInvokedDispatcher = new ProxyOnBackInvokedDispatcher(context.getApplicationInfo().isOnBackInvokedCallbackEnabled());
    ...
    public PhoneWindow(Context context, Window preservedWindow, ViewRootImpl.ActivityConfigCallback activityConfigCallback) {
        ...
        if (preservedWindow != null) {
            ...
            this.mProxyOnBackInvokedDispatcher.setActualDispatcher(preservedWindow.getOnBackInvokedDispatcher());
        }
    ...
    public final void setBackgroundBlurRadius(int blurRadius) {
        ...
        if (CrossWindowBlurListeners.CROSS_WINDOW_BLUR_SUPPORTED && this.mBackgroundBlurRadius != Math.max(blurRadius, 0)) {
            int iMax = Math.max(blurRadius, 0);
    ...
    @Override // android.view.Window
    public final void setFeatureInt(int featureId, int value) throws Resources.NotFoundException {
    ...
    protected void onIntChanged(int featureId, int value) throws Resources.NotFoundException {
    ...
    private void updateProgressBars(int value) throws Resources.NotFoundException {
    ...
    private void hideProgressBars(ProgressBar horizontalProgressBar, ProgressBar spinnyProgressBar) throws Resources.NotFoundException {
        int features = getLocalFeatures();
                ...
                if (layoutResource3 == 0) {
                    if (this.mIsFloating) {
                        ...
                        if (layoutResource4 != 0) {
                            layoutResource = a.getResourceId(62, R.layout.screen_action_bar);
                        } else {
    ...
    @Override // android.view.Window
    public final void setChildInt(int featureId, int value) throws Resources.NotFoundException {
        updateInt(featureId, value, false);
    }
    ...
    private void updateInt(int featureId, int value, boolean fromResume) throws Resources.NotFoundException {
        if (this.mContentParent == null) {
            return;
        }
        int featureMask = 1 << featureId;
    ...
    private class PhoneWindowWrapper implements IPhoneWindowWrapper {
