...
public class TransitionAnimation {
    ...
    private final Interpolator mThumbnailFadeInInterpolator = new Interpolator() { // from class: com.android.internal.policy.TransitionAnimation$$ExternalSyntheticLambda0
        ...
        public final float getInterpolation(float f) {
            return this.f$0.m7067lambda$new$0$comandroidinternalpolicyTransitionAnimation(f);
        }
    };
    private final Interpolator mThumbnailFadeOutInterpolator = new Interpolator() { // from class: com.android.internal.policy.TransitionAnimation$$ExternalSyntheticLambda1
        @Override // android.animation.TimeInterpolator
        public final float getInterpolation(float f) {
            return this.f$0.m7068lambda$new$1$comandroidinternalpolicyTransitionAnimation(f);
        }
    };
    ...
    /* renamed from: lambda$new$0$com-android-internal-policy-TransitionAnimation, reason: not valid java name */
    /* synthetic */ float m7067lambda$new$0$comandroidinternalpolicyTransitionAnimation(float input) {
        if (input >= 0.5f) {
    ...
    /* renamed from: lambda$new$1$com-android-internal-policy-TransitionAnimation, reason: not valid java name */
    /* synthetic */ float m7068lambda$new$1$comandroidinternalpolicyTransitionAnimation(float input) {
        if (input < 0.5f) {
            float t = input / 0.5f;
    ...
    public HardwareBuffer createCrossProfileAppsThumbnail(Drawable thumbnailDrawable, Rect frame) throws Resources.NotFoundException {
    ...
    public static Animation loadAnimationSafely(Context context, int resId, String tag) {
        try {
            ...
            Slog.w(tag, "Unable to load animation: Unknown animation name", e3);
            return null;
        }
    }
