...
public class DividerSnapAlgorithm {
    ...
    public static DividerSnapAlgorithm create(Context ctx, Rect insets) throws Resources.NotFoundException {
    ...
    private void calculateTargets(boolean isHorizontalDivision, int dockedSide) {
        ...
        int i2 = isHorizontalDivision ? rect.bottom : rect.right;
        int startPos2 = -this.mDividerSize;
        if (dockedSide != 3) {
            startPos = startPos2;
        } else {
            startPos = startPos2 + this.mInsets.left;
        }
        this.mTargets.add(new SnapTarget(startPos, startPos, 1, 0.35f));
        switch (this.mSnapMode) {
            case 0:
                f = 0.35f;
                IDividerSnapAlgorithmExt iDividerSnapAlgorithmExt = this.mDividerSnapAlgorithmExt;
                if (iDividerSnapAlgorithmExt == null || !iDividerSnapAlgorithmExt.addRatioTargets(this.mResources, this.mTargets, dividerMax, this.mDividerSize, isHorizontalDivision, this.mInsets)) {
            ...
            case 1:
                ...
                break;
            case 2:
                IDividerSnapAlgorithmExt iDividerSnapAlgorithmExt2 = this.mDividerSnapAlgorithmExt;
                if (iDividerSnapAlgorithmExt2 == null) {
                    f = 0.35f;
                } else {
                    f = 0.35f;
                    if (!iDividerSnapAlgorithmExt2.addMiddleTarget(this.mTargets, isHorizontalDivision, this.mDisplayWidth, this.mDisplayHeight, this.mDividerSize)) {
                    }
                }
                addMiddleTarget(isHorizontalDivision);
                break;
            case 3:
                IDividerSnapAlgorithmExt iDividerSnapAlgorithmExt3 = this.mDividerSnapAlgorithmExt;
                if (iDividerSnapAlgorithmExt3 != null && iDividerSnapAlgorithmExt3.addMinimizedTarget(this.mTargets, dockedSide, this.mDividerSize, this.mTaskHeightInMinimizedMode, this.mInsets, this.mDisplayWidth, this.mDisplayHeight)) {
                    f = 0.35f;
                    break;
                } else {
        ...
        this.mTargets.add(new SnapTarget(dividerMax, dividerMax, 2, f));
    }
    ...
    private void addRatio16_9Targets(boolean isHorizontalDivision, int dividerMax) {
        ...
        int i = start + sizeInt;
        int i2 = (end - sizeInt) - this.mDividerSize;
