...
public class ActionBarView extends AbsActionBarView implements DecorToolbar {
    ...
    public ActionBarView(Context context, AttributeSet attrs) throws Resources.NotFoundException {
        super(context, attrs);
    ...
    @Override // com.android.internal.widget.DecorToolbar
    public void setMenu(Menu menu, MenuPresenter.Callback cb) throws Resources.NotFoundException {
    ...
    private void configPresenters(MenuBuilder builder) throws Resources.NotFoundException {
        if (builder != null) {
    ...
    @Override // com.android.internal.widget.DecorToolbar
    public void setDisplayOptions(int options) throws Resources.NotFoundException {
        View view;
    ...
    */
    ...
    private static class HomeView extends FrameLayout {
        ...
        public void setIcon(Drawable icon) {
            this.mIconView.m7231x2ffdb2aa(icon);
        }
        ...
        private void updateUpIndicator() {
            ...
            if (drawable != null) {
                this.mUpView.m7231x2ffdb2aa(drawable);
            } else if (this.mUpIndicatorRes != 0) {
                this.mUpView.m7231x2ffdb2aa(getContext().getDrawable(this.mUpIndicatorRes));
            } else {
                this.mUpView.m7231x2ffdb2aa(this.mDefaultUpIndicator);
            }
        }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        @Override // com.android.internal.view.menu.MenuPresenter
        public void updateMenuView(boolean cleared) throws Resources.NotFoundException {
        ...
        @Override // com.android.internal.view.menu.MenuPresenter
        public boolean collapseItemActionView(MenuBuilder menu, MenuItemImpl item) throws Resources.NotFoundException {
            if (ActionBarView.this.mExpandedActionView instanceof CollapsibleActionView) {
