...
public class LockPatternUtils {
    ...
    public boolean isLockScreenDisabled(int userId) throws Resources.NotFoundException {
        if (isSecure(userId)) {
            return false;
        }
    ...
    public boolean setLockCredential(LockscreenCredential newCredential, LockscreenCredential savedCredential, int userHandle) {
        ...
        try {
            ...
            getWrapper().getLockPatternUtilsExt().savePasswordLenght(this.mContext.getContentResolver(), "PASSWORD_LENGTH", newCredential.size(), userHandle);
            return true;
        } catch (RemoteException e) {
    ...
    public long setLockoutAttemptDeadline(int userId, int timeoutMs) {
        ...
        getWrapper().getLockPatternUtilsExt().setLockoutAttemptDeadline(userId, deadline, timeoutMs, this);
        return deadline;
    }

    public long getLockoutAttemptDeadline(int userId) {
        return getWrapper().getLockPatternUtilsExt().getLockoutAttemptDeadline(userId, this);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public boolean getBoolean(String secureSettingKey, boolean defaultValue, int userId) {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setBoolean(String secureSettingKey, boolean enabled, int userId) {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public long getLong(String secureSettingKey, long defaultValue, int userHandle) {
        try {
    ...
    public boolean isBiometricAllowedForUser(int userId) {
        Log.d(TAG, "isBiometricAllowedForUser allowed:" + ((getStrongAuthForUser(userId) & (-5)) == 0) + " userId:" + userId);
    ...
    private class LockPatternUtilsWrapper implements ILockPatternUtilsWrapper {
        ...
        @Override // android.widget.ILockPatternUtilsWrapper
        public boolean getBoolean(String secureSettingKey, boolean defaultValue, int userId) {
            return LockPatternUtils.this.getBoolean(secureSettingKey, defaultValue, userId);
        }

        @Override // android.widget.ILockPatternUtilsWrapper
        public void setBoolean(String secureSettingKey, boolean enabled, int userId) {
            LockPatternUtils.this.setBoolean(secureSettingKey, enabled, userId);
        }

        @Override // android.widget.ILockPatternUtilsWrapper
        public long getLong(String secureSettingKey, long defaultValue, int userHandle) {
            return LockPatternUtils.this.getLong(secureSettingKey, defaultValue, userHandle);
        }

        @Override // android.widget.ILockPatternUtilsWrapper
        public void setLong(String secureSettingKey, long value, int userHandle) {
            LockPatternUtils.this.setLong(secureSettingKey, value, userHandle);
        }
    }
}
