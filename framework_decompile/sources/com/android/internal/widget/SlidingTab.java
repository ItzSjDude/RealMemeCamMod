...
public class SlidingTab extends ViewGroup {
    ...
    private static class Slider {
        ...
        Slider(ViewGroup parent, int tabId, int barId, int targetId) throws Resources.NotFoundException {
        ...
        void setState(int state) throws Resources.NotFoundException {
        ...
        void reset(boolean animate) throws Resources.NotFoundException {
            int dx;
            int dy;
            setState(0);
            this.text.setVisibility(0);
        ...
        void layout(int l, int t, int r, int b, int alignment) {
            ...
            int leftTarget = (((int) (parentWidth * SlidingTab.THRESHOLD)) - targetWidth) + (handleWidth / 2);
            int rightTarget = ((int) (parentWidth * 0.3333333f)) - (handleWidth / 2);
            int left = (parentWidth - handleWidth) / 2;
            int right = left + handleWidth;
            if (alignment == 0 || alignment == 1) {
                int handleWidth2 = handleWidth;
                int targetWidth2 = targetWidth;
                int parentWidth2 = parentWidth;
                int leftTarget2 = leftTarget;
                int rightTarget2 = rightTarget;
                ...
                if (alignment != 0) {
                    int parentWidth3 = parentWidth2;
                    this.tab.layout(parentWidth2 - handleWidth2, top, parentWidth3, bottom);
                    this.text.layout(parentWidth3, top, parentWidth3 + parentWidth3, bottom);
                    this.target.layout(rightTarget2, targetTop, rightTarget2 + targetWidth2, targetBottom);
                    this.text.setGravity(48);
                    this.alignment_value = r;
                    return;
                }
                this.tab.layout(0, top, handleWidth2, bottom);
                this.text.layout(0 - parentWidth2, top, 0, bottom);
                this.text.setGravity(5);
                this.target.layout(leftTarget2, targetTop, leftTarget2 + targetWidth2, targetBottom);
                this.alignment_value = l;
                return;
            }
            int targetLeft = (parentWidth - targetWidth) / 2;
            int rightTarget3 = (parentWidth + targetWidth) / 2;
            int top2 = (((int) (parentHeight * SlidingTab.THRESHOLD)) + (handleHeight / 2)) - targetHeight;
            int bottom2 = ((int) (parentHeight * 0.3333333f)) - (handleHeight / 2);
            if (alignment != 2) {
                ...
                this.target.layout(targetLeft, bottom2, rightTarget3, bottom2 + targetHeight);
                this.alignment_value = b;
                return;
            }
            this.tab.layout(left, 0, right, handleHeight);
            this.text.layout(left, 0 - parentHeight, right, 0);
            this.target.layout(targetLeft, top2, rightTarget3, top2 + targetHeight);
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) throws Resources.NotFoundException {
    ...
    public void reset(boolean animate) throws Resources.NotFoundException {
    ...
    @Override // android.view.View
    public void setVisibility(int visibility) throws Resources.NotFoundException {
    ...
    */
    ...
    public void setLeftTabResources(int iconId, int targetId, int barId, int tabId) throws Resources.NotFoundException {
    ...
    public void setRightTabResources(int iconId, int targetId, int barId, int tabId) throws Resources.NotFoundException {
    ...
    @Override // android.view.View
    protected void onVisibilityChanged(View changedView, int visibility) throws Resources.NotFoundException {
