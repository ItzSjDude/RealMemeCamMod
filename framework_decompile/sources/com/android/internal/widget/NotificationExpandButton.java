...
public class NotificationExpandButton extends FrameLayout {
    ...
    public void getBoundsOnScreen(Rect outRect, boolean clipToParent) {
        ...
        if (parent != null && parent.getId() == 16908990) {
    ...
    @RemotableViewMethod
    public void setExpanded(boolean expanded) throws Resources.NotFoundException {
    ...
    private void updateExpandedState() throws Resources.NotFoundException {
        ...
        this.mIconView.m7231x2ffdb2aa(getContext().getDrawable(drawableId));
        updateNumber();
    }
