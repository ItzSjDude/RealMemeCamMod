...
public class NotificationActionListLayout extends LinearLayout {
    ...
    private int measureAndGetUsedWidth(int widthMeasureSpec, int heightMeasureSpec, int innerWidth, boolean collapsePriorityActions) throws Resources.NotFoundException {
        View c;
        boolean isPriority;
    ...
    @RemotableViewMethod
    public void setEmphasizedMode(boolean emphasizedMode) throws Resources.NotFoundException {
        int height;
