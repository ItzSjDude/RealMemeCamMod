...
public class MessagingPropertyAnimator implements View.OnLayoutChangeListener {
    ...
    private static final int TAG_ALPHA_ANIMATOR = 16909574;
    private static final int TAG_FIRST_LAYOUT = 16909575;
    private static final int TAG_LAYOUT_TOP = 16909577;
    private static final int TAG_TOP = 16909581;
    private static final int TAG_TOP_ANIMATOR = 16909580;
    ...
    private static boolean isFirstLayout(View view) {
        Boolean tag = (Boolean) view.getTag(16909575);
        if (tag == null) {
            return true;
        }
    ...
    private static void setFirstLayout(View view, boolean first) {
        view.setTagInternal(16909575, Boolean.valueOf(first));
    }

    private static void setLayoutTop(View view, int top) {
        view.setTagInternal(16909577, Integer.valueOf(top));
    }

    public static int getLayoutTop(View view) {
        Integer tag = (Integer) view.getTag(16909577);
        if (tag == null) {
            return getTop(view);
        }
        return tag.intValue();
    ...
    public static int getTop(View v) {
        Integer tag = (Integer) v.getTag(16909581);
        if (tag == null) {
            return v.getTop();
        }
        return tag.intValue();
    ...
    public static void setTop(View v, int value) {
        v.setTagInternal(16909581, Integer.valueOf(value));
    ...
    private static void startTopAnimation(final View v, int start, int end, Interpolator interpolator) {
        ObjectAnimator existing = (ObjectAnimator) v.getTag(16909580);
        if (existing != null) {
            existing.cancel();
        }
        ...
        animator.addListener(new AnimatorListenerAdapter() { // from class: com.android.internal.widget.MessagingPropertyAnimator.2
            ...
            public void onAnimationEnd(Animator animation) {
                v.setTagInternal(16909580, null);
        ...
        v.setTagInternal(16909580, animator);
        animator.start();
    }
    ...
    public static void fadeIn(final View v) {
        ObjectAnimator existing = (ObjectAnimator) v.getTag(16909574);
        if (existing != null) {
            existing.cancel();
        }
    ...
    public static void fadeOut(final View view, final Runnable endAction) {
        ObjectAnimator existing = (ObjectAnimator) view.getTag(16909574);
        if (existing != null) {
            existing.cancel();
        }
        ...
        animator.addListener(new AnimatorListenerAdapter() { // from class: com.android.internal.widget.MessagingPropertyAnimator.4
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animation) {
                view.setTagInternal(16909574, null);
        ...
        view.setTagInternal(16909574, animator);
        animator.start();
    }
    ...
    public static boolean isAnimatingTranslation(View v) {
        return v.getTag(16909580) != null;
    }

    public static boolean isAnimatingAlpha(View v) {
        return v.getTag(16909574) != null;
    }
