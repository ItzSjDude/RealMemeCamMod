...
public class LockPatternView extends View {
    ...
    public LockPatternView(Context context, AttributeSet attrs) throws Resources.NotFoundException {
        super(context, attrs);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        switch (this.mAspect) {
            case 0:
                int iMin = Math.min(viewWidth, viewHeight);
                viewHeight = iMin;
                viewWidth = iMin;
                break;
            case 1:
    ...
    private Animator createDotActivationColorAnimation(final CellState cellState) {
        ValueAnimator.AnimatorUpdateListener updateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.internal.widget.LockPatternView$$ExternalSyntheticLambda2
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m7259x923cbd6(cellState, valueAnimator);
            }
        };
    ...
    /* renamed from: lambda$createDotActivationColorAnimation$0$com-android-internal-widget-LockPatternView, reason: not valid java name */
    /* synthetic */ void m7259x923cbd6(CellState cellState, ValueAnimator valueAnimator) {
    ...
    private Animator createLineEndAnimation(final CellState state, final float startX, final float startY, final float targetX, final float targetY) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.internal.widget.LockPatternView$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f$0.m7262xa236966(state, startX, targetX, startY, targetY, valueAnimator2);
            }
        });
    ...
    /* renamed from: lambda$createLineEndAnimation$1$com-android-internal-widget-LockPatternView, reason: not valid java name */
    /* synthetic */ void m7262xa236966(CellState state, float startX, float targetX, float startY, float targetY, ValueAnimator animation) {
        float t = ((Float) animation.getAnimatedValue()).floatValue();
    ...
    private Animator createLineDisappearingAnimation() {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.internal.widget.LockPatternView$$ExternalSyntheticLambda3
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f$0.m7261x27fdda9(valueAnimator2);
            }
        });
    ...
    /* renamed from: lambda$createLineDisappearingAnimation$2$com-android-internal-widget-LockPatternView, reason: not valid java name */
    /* synthetic */ void m7261x27fdda9(ValueAnimator animation) {
        invalidate();
    }
    ...
    private Animator createDotRadiusAnimation(final CellState state) {
        ...
        ValueAnimator.AnimatorUpdateListener animatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.internal.widget.LockPatternView$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m7260x7270c2b4(state, valueAnimator);
            }
        };
    ...
    /* renamed from: lambda$createDotRadiusAnimation$3$com-android-internal-widget-LockPatternView, reason: not valid java name */
    /* synthetic */ void m7260x7270c2b4(CellState state, ValueAnimator animation) {
