...
public class IPAddress {
    ...
    public static boolean isValidIPv4(String address) throws NumberFormatException {
        int pos;
        if (address.length() == 0) {
            return false;
        }
    ...
    private static boolean isMaskValue(String component, int size) throws NumberFormatException {
        try {
    ...
    public static boolean isValidIPv6(String address) throws NumberFormatException {
        int pos;
        if (address.length() == 0) {
            return false;
        }
