...
public interface X509ObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierIntern = aSN1ObjectIdentifierBranch.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION).intern();
        id_ad_caIssuers = aSN1ObjectIdentifierIntern;
        ASN1ObjectIdentifier aSN1ObjectIdentifierIntern2 = aSN1ObjectIdentifierBranch.branch(IOplusUIFirstManager.APP_START_ANIMATION).intern();
