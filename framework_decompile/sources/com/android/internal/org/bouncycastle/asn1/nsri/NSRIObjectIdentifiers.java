...
public interface NSRIObjectIdentifiers {
    ...
    static {
        ...
        id_pad = aSN1ObjectIdentifierBranch.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_pad_null = aSN1ObjectIdentifierBranch.branch("0");
        id_pad_1 = aSN1ObjectIdentifierBranch.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_aria128_ecb = aSN1ObjectIdentifierBranch2.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_aria128_cbc = aSN1ObjectIdentifierBranch2.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_aria128_cfb = aSN1ObjectIdentifierBranch2.branch("3");
        id_aria128_ofb = aSN1ObjectIdentifierBranch2.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
