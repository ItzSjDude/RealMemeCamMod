...
public interface PKCSObjectIdentifiers {
    ...
    static {
        ...
        x509Certificate = aSN1ObjectIdentifierBranch.branch(IOplusUIFirstManager.APP_START_ANIMATION).intern();
        sdsiCertificate = aSN1ObjectIdentifierBranch.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION).intern();
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch2 = aSN1ObjectIdentifier6.branch("23");
        crlTypes = aSN1ObjectIdentifierBranch2;
        x509Crl = aSN1ObjectIdentifierBranch2.branch(IOplusUIFirstManager.APP_START_ANIMATION).intern();
        ...
        keyBag = aSN1ObjectIdentifierBranch8.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        pkcs8ShroudedKeyBag = aSN1ObjectIdentifierBranch8.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        certBag = aSN1ObjectIdentifierBranch8.branch("3");
        crlBag = aSN1ObjectIdentifierBranch8.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        secretBag = aSN1ObjectIdentifierBranch8.branch("5");
        safeContentsBag = aSN1ObjectIdentifierBranch8.branch("6");
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch9 = aSN1ObjectIdentifier10.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        pkcs_12PbeIds = aSN1ObjectIdentifierBranch9;
        pbeWithSHAAnd128BitRC4 = aSN1ObjectIdentifierBranch9.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        pbeWithSHAAnd40BitRC4 = aSN1ObjectIdentifierBranch9.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        pbeWithSHAAnd3_KeyTripleDES_CBC = aSN1ObjectIdentifierBranch9.branch("3");
        pbeWithSHAAnd2_KeyTripleDES_CBC = aSN1ObjectIdentifierBranch9.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
