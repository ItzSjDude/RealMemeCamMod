...
public interface X9ObjectIdentifiers {
    ...
    static {
        ...
        prime_field = aSN1ObjectIdentifierBranch.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch2 = aSN1ObjectIdentifierBranch.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch3 = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        id_ecSigType = aSN1ObjectIdentifierBranch3;
        ecdsa_with_SHA1 = aSN1ObjectIdentifierBranch3.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch4 = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_publicKeyType = aSN1ObjectIdentifierBranch4;
        id_ecPublicKey = aSN1ObjectIdentifierBranch4.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ...
        ecdsa_with_SHA224 = aSN1ObjectIdentifierBranch5.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ecdsa_with_SHA256 = aSN1ObjectIdentifierBranch5.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        ecdsa_with_SHA384 = aSN1ObjectIdentifierBranch5.branch("3");
        ecdsa_with_SHA512 = aSN1ObjectIdentifierBranch5.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        c2pnb163v1 = aSN1ObjectIdentifierBranch7.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        c2pnb163v2 = aSN1ObjectIdentifierBranch7.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        c2pnb163v3 = aSN1ObjectIdentifierBranch7.branch("3");
        c2pnb176w1 = aSN1ObjectIdentifierBranch7.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch8 = aSN1ObjectIdentifierBranch6.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        primeCurve = aSN1ObjectIdentifierBranch8;
        prime192v1 = aSN1ObjectIdentifierBranch8.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        prime192v2 = aSN1ObjectIdentifierBranch8.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        prime192v3 = aSN1ObjectIdentifierBranch8.branch("3");
        prime239v1 = aSN1ObjectIdentifierBranch8.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        dhStatic = aSN1ObjectIdentifierBranch9.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        dhEphem = aSN1ObjectIdentifierBranch9.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        dhOneFlow = aSN1ObjectIdentifierBranch9.branch("3");
        dhHybrid1 = aSN1ObjectIdentifierBranch9.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch10 = aSN1ObjectIdentifier4.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        x9_44_components = aSN1ObjectIdentifierBranch10;
        id_kdf_kdf2 = aSN1ObjectIdentifierBranch10.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_kdf_kdf3 = aSN1ObjectIdentifierBranch10.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
    }
}
