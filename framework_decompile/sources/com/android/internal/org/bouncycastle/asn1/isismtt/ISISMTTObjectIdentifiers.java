...
public interface ISISMTTObjectIdentifiers {
    ...
    static {
        ...
        id_isismtt_cp_accredited = aSN1ObjectIdentifierBranch.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch2 = aSN1ObjectIdentifier.branch("3");
        id_isismtt_at = aSN1ObjectIdentifierBranch2;
        id_isismtt_at_dateOfCertGen = aSN1ObjectIdentifierBranch2.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_isismtt_at_procuration = aSN1ObjectIdentifierBranch2.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_isismtt_at_admission = aSN1ObjectIdentifierBranch2.branch("3");
        id_isismtt_at_monetaryLimit = aSN1ObjectIdentifierBranch2.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
