...
public class GeneralName extends ASN1Object implements ASN1Choice {
    ...
    public GeneralName(int tag, String name) throws NumberFormatException {
        this.tag = tag;
    ...
    private byte[] toGeneralNameEncoding(String ip) throws NumberFormatException {
        int[] parsedIp;
    ...
    private void parseIPv4Mask(String mask, byte[] addr, int offset) throws NumberFormatException {
    ...
    private int[] parseMask(String mask) throws NumberFormatException {
        int[] res = new int[8];
        int maskVal = Integer.parseInt(mask);
        for (int i = 0; i != maskVal; i++) {
            int i2 = i / 16;
