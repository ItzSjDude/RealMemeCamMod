...
public interface EACObjectIdentifiers {
    ...
    static {
        ...
        id_PK_DH = aSN1ObjectIdentifierBranch.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_PK_ECDH = aSN1ObjectIdentifierBranch.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch2 = aSN1ObjectIdentifier.branch("2.2.3");
        id_CA = aSN1ObjectIdentifierBranch2;
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch3 = aSN1ObjectIdentifierBranch2.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_CA_DH = aSN1ObjectIdentifierBranch3;
        id_CA_DH_3DES_CBC_CBC = aSN1ObjectIdentifierBranch3.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ...
        id_CA_ECDH_3DES_CBC_CBC = aSN1ObjectIdentifierBranch4.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch5 = aSN1ObjectIdentifier.branch("2.2.2");
        id_TA = aSN1ObjectIdentifierBranch5;
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch6 = aSN1ObjectIdentifierBranch5.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_TA_RSA = aSN1ObjectIdentifierBranch6;
        id_TA_RSA_v1_5_SHA_1 = aSN1ObjectIdentifierBranch6.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_TA_RSA_v1_5_SHA_256 = aSN1ObjectIdentifierBranch6.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_TA_RSA_PSS_SHA_1 = aSN1ObjectIdentifierBranch6.branch("3");
        id_TA_RSA_PSS_SHA_256 = aSN1ObjectIdentifierBranch6.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        id_TA_RSA_v1_5_SHA_512 = aSN1ObjectIdentifierBranch6.branch("5");
        id_TA_RSA_PSS_SHA_512 = aSN1ObjectIdentifierBranch6.branch("6");
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch7 = aSN1ObjectIdentifierBranch5.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_TA_ECDSA = aSN1ObjectIdentifierBranch7;
        id_TA_ECDSA_SHA_1 = aSN1ObjectIdentifierBranch7.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_TA_ECDSA_SHA_224 = aSN1ObjectIdentifierBranch7.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_TA_ECDSA_SHA_256 = aSN1ObjectIdentifierBranch7.branch("3");
        id_TA_ECDSA_SHA_384 = aSN1ObjectIdentifierBranch7.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
