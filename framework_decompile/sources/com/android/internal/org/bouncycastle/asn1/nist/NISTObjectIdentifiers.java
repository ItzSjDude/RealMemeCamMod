...
public interface NISTObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        hashAlgs = aSN1ObjectIdentifierBranch;
        id_sha256 = aSN1ObjectIdentifierBranch.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_sha384 = aSN1ObjectIdentifierBranch.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_sha512 = aSN1ObjectIdentifierBranch.branch("3");
        id_sha224 = aSN1ObjectIdentifierBranch.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch2 = aSN1ObjectIdentifier.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        aes = aSN1ObjectIdentifierBranch2;
        id_aes128_ECB = aSN1ObjectIdentifierBranch2.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        id_aes128_CBC = aSN1ObjectIdentifierBranch2.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        id_aes128_OFB = aSN1ObjectIdentifierBranch2.branch("3");
        id_aes128_CFB = aSN1ObjectIdentifierBranch2.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
        ...
        dsa_with_sha224 = aSN1ObjectIdentifierBranch3.branch(IOplusUIFirstManager.APP_START_ANIMATION);
        dsa_with_sha256 = aSN1ObjectIdentifierBranch3.branch(IOplusUIFirstManager.APP_EXIT_ANIMATION);
        dsa_with_sha384 = aSN1ObjectIdentifierBranch3.branch("3");
        dsa_with_sha512 = aSN1ObjectIdentifierBranch3.branch(IOplusUIFirstManager.LAUNCHER_SI_START);
