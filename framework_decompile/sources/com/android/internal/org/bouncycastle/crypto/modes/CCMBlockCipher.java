...
public class CCMBlockCipher implements AEADBlockCipher {
    ...
    @Override // com.android.internal.org.bouncycastle.crypto.modes.AEADCipher
    public int doFinal(byte[] out, int outOff) throws IllegalStateException, DataLengthException, IllegalArgumentException, InvalidCipherTextException {
    ...
    public byte[] processPacket(byte[] in, int inOff, int inLen) throws IllegalStateException, DataLengthException, IllegalArgumentException, InvalidCipherTextException {
        byte[] output;
        if (this.forEncryption) {
    ...
    public int processPacket(byte[] in, int inOff, int inLen, byte[] output, int outOff) throws IllegalStateException, DataLengthException, IllegalArgumentException, InvalidCipherTextException {
        int outputLen;
        int i;
        int i2;
    ...
    private int calculateMac(byte[] data, int dataOff, int dataLen, byte[] macBlock) throws IllegalStateException, DataLengthException, IllegalArgumentException {
        int extra;
