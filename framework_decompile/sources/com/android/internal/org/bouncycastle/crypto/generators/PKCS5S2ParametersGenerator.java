...
public class PKCS5S2ParametersGenerator extends PBEParametersGenerator {
    ...
    private void F(byte[] S, int c, byte[] iBuf, byte[] out, int outOff) throws IllegalStateException, DataLengthException {
        if (c == 0) {
    ...
    private byte[] generateDerivedKey(int dkLen) throws IllegalStateException, DataLengthException, IllegalArgumentException {
        int pos;
    ...
    public CipherParameters generateDerivedParameters(int keySize) throws IllegalStateException, DataLengthException, IllegalArgumentException {
    ...
    @Override // com.android.internal.org.bouncycastle.crypto.PBEParametersGenerator
    public CipherParameters generateDerivedParameters(int keySize, int ivSize) throws IllegalStateException, DataLengthException, IllegalArgumentException {
        int keySize2 = keySize / 8;
