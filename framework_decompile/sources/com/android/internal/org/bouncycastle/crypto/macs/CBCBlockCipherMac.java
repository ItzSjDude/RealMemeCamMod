...
public class CBCBlockCipherMac implements Mac {
    ...
    @Override // com.android.internal.org.bouncycastle.crypto.Mac
    public void update(byte in) throws IllegalStateException, DataLengthException {
        int i = this.bufOff;
        byte[] bArr = this.buf;
        if (i == bArr.length) {
    ...
    @Override // com.android.internal.org.bouncycastle.crypto.Mac
    public void update(byte[] in, int inOff, int len) throws IllegalStateException, DataLengthException {
        if (len < 0) {
    ...
    @Override // com.android.internal.org.bouncycastle.crypto.Mac
    public int doFinal(byte[] out, int outOff) throws IllegalStateException, DataLengthException {
        int blockSize = this.cipher.getBlockSize();
