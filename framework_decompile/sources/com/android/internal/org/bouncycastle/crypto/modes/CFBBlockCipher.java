...
public class CFBBlockCipher extends StreamBlockCipher {
    ...
    private byte encryptByte(byte in) throws IllegalStateException, DataLengthException {
        if (this.byteCount == 0) {
    ...
    private byte decryptByte(byte in) throws IllegalStateException, DataLengthException {
        if (this.byteCount == 0) {
            this.cipher.processBlock(this.cfbV, 0, this.cfbOutV, 0);
        }
