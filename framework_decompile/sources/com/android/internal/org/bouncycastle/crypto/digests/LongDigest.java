...
public abstract class LongDigest implements ExtendedDigest, Memoable, EncodableDigest {
    ...
    protected void restoreState(byte[] encodedState) {
        int iBigEndianToInt = Pack.bigEndianToInt(encodedState, 8);
        this.xBufOff = iBigEndianToInt;
        System.arraycopy(encodedState, 0, this.xBuf, 0, iBigEndianToInt);
    ...
    protected void processBlock() {
        ...
        for (int t = 16; t <= 79; t++) {
            long[] jArr = this.W;
            long jSigma1 = Sigma1(jArr[t - 2]);
            long[] jArr2 = this.W;
            jArr[t] = jSigma1 + jArr2[t - 7] + Sigma0(jArr2[t - 15]) + this.W[t - 16];
        }
        long a = this.H1;
        long b = this.H2;
        long c = this.H3;
        ...
        while (i < 10) {
            ...
            long e4 = e2;
            long e5 = g2;
            long jCh = jSum1 + Ch(e2, f2, e5);
            long[] jArr3 = K;
            int t3 = t2 + 1;
            long h2 = e3 + jCh + jArr3[t2] + this.W[t2];
            long d3 = d2 + h2;
            long b3 = g3;
            long d4 = h;
