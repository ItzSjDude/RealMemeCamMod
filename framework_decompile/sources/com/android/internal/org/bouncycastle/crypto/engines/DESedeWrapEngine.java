...
public class DESedeWrapEngine implements Wrapper {
    ...
    @Override // com.android.internal.org.bouncycastle.crypto.Wrapper
    public byte[] wrap(byte[] in, int inOff, int inLen) throws IllegalStateException, DataLengthException, IllegalArgumentException {
        if (!this.forWrapping) {
    ...
    @Override // com.android.internal.org.bouncycastle.crypto.Wrapper
    public byte[] unwrap(byte[] in, int inOff, int inLen) throws IllegalStateException, DataLengthException, IllegalArgumentException, InvalidCipherTextException {
        if (this.forWrapping) {
