...
public class GCMBlockCipher implements AEADBlockCipher {
    ...
    @Override // com.android.internal.org.bouncycastle.crypto.modes.AEADCipher
    public void init(boolean forEncryption, CipherParameters params) throws IllegalStateException, DataLengthException, IllegalArgumentException {
        byte[] newNonce;
    ...
    private void processBlock(byte[] buf, int bufOff, byte[] out, int outOff) throws IllegalStateException, DataLengthException {
    ...
    private void processPartial(byte[] buf, int off, int len, byte[] out, int outOff) throws IllegalStateException, DataLengthException {
        byte[] ctrBlock = new byte[16];
        getNextCTRBlock(ctrBlock);
        if (this.forEncryption) {
    ...
    private void getNextCTRBlock(byte[] block) throws IllegalStateException, DataLengthException {
