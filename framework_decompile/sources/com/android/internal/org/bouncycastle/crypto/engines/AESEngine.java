...
public class AESEngine implements BlockCipher {
    ...
    private int[][] generateWorkingKey(byte[] key, boolean forEncryption) {
        ...
        this.ROUNDS = i;
        int colx = 0;
        int[][] W = (int[][]) Array.newInstance((Class<?>) int.class, i + 1, 4);
        int i2 = 8;
        int colx2 = 3;
        switch (KC) {
            case 4:
    ...
    private void encryptBlock(int[][] KW) {
        ...
        while (r3 < this.ROUNDS - r2) {
            ...
            int iShift = ((shift(iArr[(t0 >> 8) & 255], 24) ^ iArr[r & 255]) ^ shift(iArr[(t1 >> 16) & 255], 16)) ^ shift(iArr[(t2 >> 24) & 255], 8);
            int r4 = r3 + 1;
            int r32 = KW[r3][3] ^ iShift;
        ...
        int iShift2 = shift(iArr2[(t2 >> 24) & 255], 8) ^ ((iArr2[r & 255] ^ shift(iArr2[(t0 >> 8) & 255], 24)) ^ shift(iArr2[(t1 >> 16) & 255], 16));
        int r5 = r3 + 1;
        int r34 = iShift2 ^ KW[r3][3];
        byte[] bArr = S;
    ...
    private void decryptBlock(int[][] KW) {
        ...
        byte[] bArr2 = this.s;
        this.C0 = (((((bArr2[(r34 >> 8) & 255] & 255) << 8) ^ i3) ^ ((bArr2[(r23 >> 16) & 255] & 255) << 16)) ^ (bArr[(r13 >> 24) & 255] << 24)) ^ KW[0][0];
