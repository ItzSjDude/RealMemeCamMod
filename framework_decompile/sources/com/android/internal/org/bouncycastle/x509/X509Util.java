...
class X509Util {
    ...
    static Implementation getImplementation(String baseName, String algorithm, Provider prov) throws NoSuchAlgorithmException, ClassNotFoundException {
        Class cls;
    ...
    static Implementation getImplementation(String baseName, String algorithm) throws NoSuchAlgorithmException, ClassNotFoundException {
