...
public class PKCS10CertificationRequest extends CertificationRequest {
    ...
    public boolean verify(PublicKey pubKey, String provider) throws NoSuchAlgorithmException, SignatureException, IOException, InvalidKeyException, NoSuchProviderException, InvalidAlgorithmParameterException {
        Signature sig;
        Signature sig2;
        try {
            if (provider == null) {
    ...
    private void setSignatureParameters(Signature signature, ASN1Encodable params2) throws NoSuchAlgorithmException, SignatureException, IOException, InvalidKeyException, InvalidAlgorithmParameterException {
