                ...
                case 2:
                    ...
                    if (a4Neg.toBigInteger().equals(BigInteger.valueOf(3L))) {
                        ...
                        if (Z1IsOne2) {
                            ...
                            int iBitLength = a4Neg.bitLength();
                            int coord2 = a4.bitLength();
                            if (iBitLength < coord2) {
        ...
        public ECPoint twicePlus(ECPoint b) {
            ...
            switch (coord) {
                case 0:
                    ...
                    ECFieldElement eCFieldElementSubtract = L2.subtract(L1);
                    ECFieldElement Y22 = L1.add(L2);
                    ECFieldElement X4 = eCFieldElementSubtract.multiply(Y22).add(X2);
