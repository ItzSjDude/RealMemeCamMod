...
public class CertificateFactory extends CertificateFactorySpi {
    ...
    public Certificate engineGenerateCertificate(InputStream in) throws IOException, CertificateException {
        InputStream pis;
        InputStream inputStream = this.currentStream;
        if (inputStream == null || inputStream != in) {
    ...
    @Override // java.security.cert.CertificateFactorySpi
    public Collection engineGenerateCertificates(InputStream inStream) throws IOException, CertificateException {
    ...
    @Override // java.security.cert.CertificateFactorySpi
    public CRL engineGenerateCRL(InputStream in) throws IOException, CRLException {
        InputStream pis;
    ...
    @Override // java.security.cert.CertificateFactorySpi
    public Collection engineGenerateCRLs(InputStream inStream) throws IOException, CRLException {
