...
class GcmSpecUtil {
    ...
    static AlgorithmParameterSpec extractGcmSpec(ASN1Primitive spec) throws NoSuchMethodException, InvalidParameterSpecException, SecurityException {
        try {
    ...
    static GCMParameters extractGcmParameters(AlgorithmParameterSpec paramSpec) throws NoSuchMethodException, InvalidParameterSpecException, SecurityException {
        try {
            Class cls = gcmSpecClass;
