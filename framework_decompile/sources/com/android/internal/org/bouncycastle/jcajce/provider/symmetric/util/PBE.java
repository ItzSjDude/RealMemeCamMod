...
public interface PBE {
    ...
    public static class Util {
        ...
        public static CipherParameters makePBEParameters(byte[] pbeKey, int scheme, int digest, int keySize, int ivSize, AlgorithmParameterSpec spec, String targetAlgorithm) throws NoSuchMethodException, SecurityException, InvalidAlgorithmParameterException {
        ...
        public static CipherParameters makePBEParameters(BCPBEKey pbeKey, AlgorithmParameterSpec spec, String targetAlgorithm) throws NoSuchMethodException, SecurityException {
            CipherParameters param;
            if (spec == null || !(spec instanceof PBEParameterSpec)) {
        ...
        public static AlgorithmParameterSpec getParameterSpecFromPBEParameterSpec(PBEParameterSpec pbeParameterSpec) throws NoSuchMethodException, SecurityException {
            try {
