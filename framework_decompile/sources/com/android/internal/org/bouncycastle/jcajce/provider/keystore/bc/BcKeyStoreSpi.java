...
public class BcKeyStoreSpi extends KeyStoreSpi implements BCKeyStore {
    ...
    private class StoreEntry {
        ...
        Object getObject(char[] password) throws UnrecoverableKeyException, NoSuchAlgorithmException, IOException {
            Key k;
    ...
    private void encodeCertificate(Certificate cert, DataOutputStream dOut) throws IOException, CertificateEncodingException {
        try {
    ...
    protected Cipher makePBECipher(String algorithm, int mode, char[] password, byte[] salt, int iterationCount) throws InvalidKeyException, IOException, InvalidAlgorithmParameterException {
        try {
    ...
    protected void saveStore(OutputStream out) throws IOException, CertificateEncodingException {
        Enumeration e = this.table.elements();
    ...
    @Override // java.security.KeyStoreSpi
    public void engineStore(OutputStream stream, char[] password) throws IOException, CertificateEncodingException {
