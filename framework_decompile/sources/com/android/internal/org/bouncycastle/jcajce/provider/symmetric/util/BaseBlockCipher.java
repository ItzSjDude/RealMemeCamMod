...
public class BaseBlockCipher extends BaseWrapCipher implements PBE {
    ...
    @Override // com.android.internal.org.bouncycastle.jcajce.provider.symmetric.util.BaseWrapCipher, javax.crypto.CipherSpi
    protected void engineSetMode(String mode) throws NoSuchAlgorithmException, NumberFormatException {
        if (this.baseEngine == null) {
        ...
        if (this.modeName.equals(KeyProperties.BLOCK_MODE_CTR)) {
            ...
            if (this.modeName.equals(KeyProperties.BLOCK_MODE_GCM)) {
                this.ivLength = this.baseEngine.getBlockSize();
    ...
    @Override // com.android.internal.org.bouncycastle.jcajce.provider.symmetric.util.BaseWrapCipher, javax.crypto.CipherSpi
    protected void engineInit(int opmode, Key key, AlgorithmParameterSpec params, SecureRandom random) throws NoSuchMethodException, InvalidKeyException, SecurityException, InvalidAlgorithmParameterException {
        ...
        if (params instanceof AEADParameterSpec) {
            ...
            if (cls != null && cls.isInstance(params)) {
                ...
                AEADParameters aEADParametersExtractAeadParameters = GcmSpecUtil.extractAeadParameters(keyParam, params);
                this.aeadParams = aEADParametersExtractAeadParameters;
                param = aEADParametersExtractAeadParameters;
    ...
    @Override // com.android.internal.org.bouncycastle.jcajce.provider.symmetric.util.BaseWrapCipher, javax.crypto.CipherSpi
    protected void engineInit(int opmode, Key key, AlgorithmParameters params, SecureRandom random) throws NoSuchMethodException, InvalidKeyException, SecurityException, InvalidAlgorithmParameterException {
    ...
    @Override // com.android.internal.org.bouncycastle.jcajce.provider.symmetric.util.BaseWrapCipher, javax.crypto.CipherSpi
    protected void engineInit(int opmode, Key key, SecureRandom random) throws NoSuchMethodException, InvalidKeyException, SecurityException {
        try {
    ...
    @Override // com.android.internal.org.bouncycastle.jcajce.provider.symmetric.util.BaseWrapCipher, javax.crypto.CipherSpi
    protected byte[] engineUpdate(byte[] input, int inputOffset, int inputLen) throws DataLengthException {
    ...
    @Override // com.android.internal.org.bouncycastle.jcajce.provider.symmetric.util.BaseWrapCipher, javax.crypto.CipherSpi
    protected byte[] engineDoFinal(byte[] input, int inputOffset, int inputLen) throws BadPaddingException, IllegalBlockSizeException, DataLengthException {
        int len = 0;
