...
public class StateMachine {
    ...
    static class SmHandler extends Handler {
        ...
        class StateInfo {
            ...
            public String toString() {
                StringBuilder sbAppend = new StringBuilder().append("state=").append(this.state.getName()).append(",active=").append(this.active).append(",parent=");
                StateInfo stateInfo = this.parentStateInfo;
                return sbAppend.append(stateInfo == null ? "null" : stateInfo.state.getName()).toString();
            }
        }
