...
public class ScreenshotHelper {
    ...
    private final IScreenshotHelperWrapper mScreenshotHelperWrapper;
    ...
    public ScreenshotHelper(Context context) {
        ...
        this.mScreenshotHelperWrapper = new ScreenshotHelperWrapper();
    ...
    private void takeScreenshot(int screenshotType, long timeoutMs, final Handler handler, ScreenshotRequest screenshotRequest, final Consumer<Uri> completionConsumer) {
        synchronized (this.mScreenshotLock) {
            if (this.mScreenshotHelperWrapper.getExtImpl().takeScreenshotNeedReturn(this.mContext, screenshotType, screenshotRequest, handler)) {
                return;
            }
            final Runnable mScreenshotTimeout = new Runnable() { // from class: com.android.internal.util.ScreenshotHelper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m7124x720918a7(completionConsumer);
                }
            };
    ...
    /* synthetic */ void m7124x720918a7(Consumer completionConsumer) {
        synchronized (this.mScreenshotLock) {
    ...
    public IScreenshotHelperWrapper getWrapper() {
        return this.mScreenshotHelperWrapper;
    }

    private class ScreenshotHelperWrapper implements IScreenshotHelperWrapper {
        private final IScreenshotHelperExt mScreenshotHelperExt;

        private ScreenshotHelperWrapper() {
            this.mScreenshotHelperExt = (IScreenshotHelperExt) ExtLoader.type(IScreenshotHelperExt.class).base(ScreenshotHelper.this).create();
        }

        @Override // com.android.internal.util.IScreenshotHelperWrapper
        public IScreenshotHelperExt getExtImpl() {
            return this.mScreenshotHelperExt;
        }
    }
}
