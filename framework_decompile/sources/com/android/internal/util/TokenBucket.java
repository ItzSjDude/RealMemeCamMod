...
public class TokenBucket {
    ...
    public TokenBucket(int deltaMs, int capacity, int tokens) {
        ...
        int iCheckArgumentPositive = Preconditions.checkArgumentPositive(capacity, "capacity must be strictly positive");
        this.mCapacity = iCheckArgumentPositive;
        this.mAvailable = Math.min(Preconditions.checkArgumentNonnegative(tokens), iCheckArgumentPositive);
