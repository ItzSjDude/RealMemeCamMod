...
public class TypedProperties extends HashMap<String, Object> {
    ...
    static void parse(Reader r, Map<String, Object> map) throws ParseException, IOException, NumberFormatException {
    ...
    static Object parseValue(StreamTokenizer st, int type) throws IOException, NumberFormatException {
        int token = st.nextToken();
        if (type == 90) {
            if (token != -3) {
    ...
    public void load(Reader r) throws ParseException, IOException, NumberFormatException {
        parse(r, this);
    }
