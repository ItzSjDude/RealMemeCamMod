...
public class XmlUtils {
    ...
    public static void writeIntAttribute(XmlSerializer out, String name, int value) throws IllegalStateException, IOException, IllegalArgumentException {
    ...
    public static void writeLongAttribute(XmlSerializer out, String name, long value) throws IllegalStateException, IOException, IllegalArgumentException {
        if (out instanceof TypedXmlSerializer) {
    ...
    public static void writeFloatAttribute(XmlSerializer out, String name, float value) throws IllegalStateException, IOException, IllegalArgumentException {
        if (out instanceof TypedXmlSerializer) {
    ...
    public static void writeBooleanAttribute(XmlSerializer out, String name, boolean value) throws IllegalStateException, IOException, IllegalArgumentException {
        if (out instanceof TypedXmlSerializer) {
    ...
    public static void writeUriAttribute(XmlSerializer out, String name, Uri value) throws IllegalStateException, IOException, IllegalArgumentException {
        if (value != null) {
    ...
    public static void writeStringAttribute(XmlSerializer out, String name, CharSequence value) throws IllegalStateException, IOException, IllegalArgumentException {
        if (value != null) {
            out.attribute(null, name, value.toString());
        }
    }
    ...
    public static void writeByteArrayAttribute(XmlSerializer out, String name, byte[] value) throws IllegalStateException, IOException, IllegalArgumentException {
        if (value != null) {
            if (out instanceof TypedXmlSerializer) {
    ...
    @Deprecated
    public static void writeBitmapAttribute(XmlSerializer out, String name, Bitmap value) throws IllegalStateException, IOException, IllegalArgumentException {
        if (value != null) {
