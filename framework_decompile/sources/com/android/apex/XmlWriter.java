...
public class XmlWriter implements Closeable {
    ...
    public static void write(XmlWriter out, ApexInfoList apexInfoList) throws IOException {
    ...
    public static void write(XmlWriter out, ApexInfo apexInfo) throws IOException {
        out.print("<?xml version=\"1.0\" encoding=\"utf-8\"?>\n");
        if (apexInfo != null) {
