...
public class LocationPermissionChecker {
    ...
    public int checkLocationPermissionWithDetailInfo(String pkgName, String featureId, int uid, String message) throws SecurityException {
    ...
    private int checkLocationPermissionInternal(String pkgName, String featureId, int uid, String message) throws SecurityException {
