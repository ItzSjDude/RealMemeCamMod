...
public final class MessageNanoPrinter {
    ...
    public static <T extends MessageNano> String print(T message) throws NoSuchMethodException, SecurityException, ArrayIndexOutOfBoundsException, IllegalArgumentException {
        if (message == null) {
            return "";
        }
    ...
    private static void print(String identifier, Object object, StringBuffer indentBuf, StringBuffer buf) throws IllegalAccessException, NoSuchMethodException, SecurityException, ArrayIndexOutOfBoundsException, IllegalArgumentException, InvocationTargetException {
        Method[] methodArr;
        Field[] fieldArr;
        int i;
        if (object != null) {
