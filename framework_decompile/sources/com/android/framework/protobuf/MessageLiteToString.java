...
final class MessageLiteToString {
    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder sb, int i) throws SecurityException {
        ...
        for (String str : treeSet) {
            ...
            if (((Method) map3.get("set" + strReplaceFirst)) != null && (!strReplaceFirst.endsWith(BYTES_SUFFIX) || !map2.containsKey("get" + strReplaceFirst.substring(i2, strReplaceFirst.length() - BYTES_SUFFIX.length())))) {
                String str4 = strReplaceFirst.substring(i2, 1).toLowerCase() + strReplaceFirst.substring(1);
                Method method4 = (Method) map2.get("get" + strReplaceFirst);
                Method method5 = (Method) map2.get("has" + strReplaceFirst);
                if (method4 != null) {
        ...
        if (messageLite instanceof GeneratedMessageLite.ExtendableMessage) {
            ...
            while (it.hasNext()) {
                ...
                printField(sb, i, NavigationBarInflaterView.SIZE_MOD_START + ((GeneratedMessageLite.ExtensionDescriptor) entry.getKey()).getNumber() + NavigationBarInflaterView.SIZE_MOD_END, entry.getValue());
            }
        }
