...
public interface AppStandbyInternal {
    ...
    static AppStandbyInternal newAppStandbyController(ClassLoader loader, Context context) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        try {
