...
public class RefMethod<T> extends BaseRef<T> {
    ...
    /* JADX WARN: Type inference failed for: r11v9, types: [java.lang.reflect.Method] */
        ...
        try {
            try {
                if (field.isAnnotationPresent(MethodName.class)) {
                    ?? r11 = (RefMethod<T>) getMethod(cls, field, ((MethodName) field.getAnnotation(MethodName.class)).params(), ((MethodName) field.getAnnotation(MethodName.class)).name());
