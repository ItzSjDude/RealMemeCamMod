...
public class ChattyEventTracker {
    ...
    public void onChattyEvent(@NonNull final CommonBean commonBean) {
        ...
        if (applicationContext == null) {
            LogUtil.e(TAG, new Supplier() { // from class: com.oplus.statistics.strategy.-$$Lambda$ChattyEventTracker$9mtNvYvn6ctmxUrrNHaCuZ_rO_I
            ...
            WorkThread.execute(new Runnable() { // from class: com.oplus.statistics.strategy.-$$Lambda$ChattyEventTracker$d5Es5CdtJucoOvDn9cO-7KceJDU
                @Override // java.lang.Runnable
                public final void run() {
                    ChattyEventTracker.this.onChattyEvent(applicationContext, r2.getAppId(), r2.getLogTag(), commonBean.getEventID());
                }
            });
        }
    }
    ...
    public void onChattyEvent(final Context context, String str, String str2, String str3) {
        ...
        this.mCacheCount++;
        if (this.mCacheCount >= MAX_VALUE_TO_COMMIT) {
            commit(context);
        } else if (this.mCacheCount != 1 || WorkThread.getInstance().hasMessages(1)) {
        } else {
            WorkThread.getInstance().postDelay(1, new Runnable() { // from class: com.oplus.statistics.strategy.-$$Lambda$ChattyEventTracker$BF--LwbCfq3g5YXBHGPdq7WK-H0
                @Override // java.lang.Runnable
                public final void run() {
                    ChattyEventTracker.this.commit(context);
                }
            }, MIN_TIME_TO_COMMIT);
        }
    }
