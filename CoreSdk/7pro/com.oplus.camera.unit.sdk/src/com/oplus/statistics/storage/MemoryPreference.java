...
public class MemoryPreference {
    ...
    public long getLong(final String str, long j) {
        ...
        try {
            ...
            LogUtil.w(TAG, new Supplier() { // from class: com.oplus.statistics.storage.-$$Lambda$MemoryPreference$VyZ1lUZkIzZvUDAeyF_Fr87-iOI
    ...
    public int getInt(final String str, int i) {
        ...
        try {
            ...
            LogUtil.w(TAG, new Supplier() { // from class: com.oplus.statistics.storage.-$$Lambda$MemoryPreference$mOuKrGdA4u1D4plJvzAOrJOtrZ8
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
