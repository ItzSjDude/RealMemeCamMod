...
public class SurfaceDecision {
    ...
    public SurfaceWrapper createReaderSurface(int i, String str, String str2, Size size, Size size2, int i2, int i3, Long l, Long l2) {
        ...
        long j = 3;
        if (!CameraSessionEntity.SurfaceUsage.PICTURE.equals(str)) {
            if (CameraSessionEntity.SurfaceUsage.PREVIEW.equals(str) || CameraSessionEntity.SurfaceUsage.PREVIEW_IN_PREVIEW.equals(str)) {
                j = l2 != null ? l2.longValue() : 259L;
            } else if (CameraSessionEntity.SurfaceUsage.RECORDING.equals(str)) {
