...
public class PreviewPropProvider {
    ...
    public PreviewPropProvider() {
        ...
        this.mPropMap.put(Integer.valueOf((int) FLAG_APS_ALGO_RECTIFY), String.format("%s.%s", ALGO_PROP_PREFIX_PREVIEW, ALGO_PROP_NAME_RECTIFY));
        this.mPropMap.put(Integer.valueOf((int) FLAG_APS_ALGO_SUPEREIS), String.format("%s.%s", ALGO_PROP_PREFIX_PREVIEW, ALGO_PROP_NAME_SUPEREIS));
        ...
        this.mAlgoTable.put("preview_rectify", Integer.valueOf((int) FLAG_APS_ALGO_RECTIFY));
        this.mAlgoTable.put("preview_supereis", Integer.valueOf((int) FLAG_APS_ALGO_SUPEREIS));
        this.mAlgoTable.put(ParameterKeys.APS_ALGO_NAME_VIDEO_SUPEREIS, Integer.valueOf((int) FLAG_APS_ALGO_SUPEREIS));
    }
