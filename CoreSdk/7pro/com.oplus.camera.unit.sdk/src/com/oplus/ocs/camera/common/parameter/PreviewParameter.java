...
public final class PreviewParameter extends Parameter {
    private static HashMap<String, Parameter.Key> mKeysHashMap;
    public static final Parameter.Key<Integer> KEY_FOCUS_MODE = new Parameter.Key<>("com.oplus.preview.focus.mode", Integer.class, 1);
    public static final Parameter.Key<RectF> KEY_AF_REGIONS = new Parameter.Key<>("com.oplus.preview.af.regions", RectF.class, 1);
    public static final Parameter.Key<RectF> KEY_AE_REGIONS = new Parameter.Key<>("com.oplus.preview.ae.regions", RectF.class, 1);
    public static final Parameter.Key<String> KEY_FLASH_MODE = new Parameter.Key<>("com.oplus.preview.flash.mode", String.class, 1);
    ...
    public static final Parameter.Key<Float> KEY_SAT_CAMERA_NONE_ZOOM_RATIO = new Parameter.Key<>("com.oplus.sat.none.zoom.ratio", Float.class, 1);
    public static final Parameter.Key<int[]> KEY_TRIPOD_MODE = new Parameter.Key<>("com.oplus.preview.tripod.mode", int[].class, 1);
    ...
    public static final Parameter.Key<float[]> KEY_STARBURST_INFO = new Parameter.Key<>("com.oplus.opx.StarburstInfo", float[].class, 1);
    ...
    public static final Parameter.Key<String> KEY_HDR_MODE = new Parameter.Key<>("com.oplus.preview.capture.hdrMode", String.class, 4);
    ...
    public static final Parameter.Key<String> KEY_AI_PHOTO = new Parameter.Key<>("com.oplus.preview.capture.ai", String.class, 1);
    ...
    public static final Parameter.Key<String> KEY_FACE_BEAUTY_EXFOLIATING = new Parameter.Key<>("com.oplus.preview.video.beauty.exfoliating", String.class, 1);
    public static final Parameter.Key<String> KEY_FACE_BEAUTY_THIN_FACE = new Parameter.Key<>("com.oplus.preview.video.beauty.thin_face", String.class, 1);
