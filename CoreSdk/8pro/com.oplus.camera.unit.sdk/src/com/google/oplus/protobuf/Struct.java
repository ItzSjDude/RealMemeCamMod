...
public final class Struct extends GeneratedMessageV3 implements StructOrBuilder {
    ...
    private static final Parser<Struct> PARSER = new AbstractParser<Struct>() { // from class:
                                                                                // com.google.oplus.protobuf.Struct.1
        /*
    ...
    /*
     * JADX DEBUG: Multi-variable search result rejected for r4v2, resolved type:
     * java.util.Map<java.lang.String, com.google.oplus.protobuf.Value>
     */
                ...
                try {
                    ...
                    if (tag != 0) {
                        if (tag == 10) {
                            ...
                            MapEntry<String, Value> mapEntry = (MapEntry) codedInputStream.readMessage(
                                    FieldsDefaultEntryHolder.defaultEntry.getParserForType(), extensionRegistryLite);
    ...
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return StructProto.internal_static_google_protobuf_Struct_fieldAccessorTable
                .ensureFieldAccessorsInitialized(Struct.class, Builder.class);
    }

    private static final class FieldsDefaultEntryHolder {
        static final MapEntry<String, Value> defaultEntry = MapEntry.newDefaultInstance(
                StructProto.internal_static_google_protobuf_Struct_FieldsEntry_descriptor, WireFormat.FieldType.STRING,
                "", WireFormat.FieldType.MESSAGE, Value.getDefaultInstance());
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        GeneratedMessageV3.serializeStringMapTo(codedOutputStream, internalGetFields(),
    ...
    public int getSerializedSize() {
        ...
        for (Map.Entry<String, Value> entry : internalGetFields().getMap().entrySet()) {
            iComputeMessageSize += CodedOutputStream.computeMessageSize(1, FieldsDefaultEntryHolder.defaultEntry
    ...
    public boolean equals(Object obj) {
        ...
        return internalGetFields().equals(struct.internalGetFields())
                && this.unknownFields.equals(struct.unknownFields);
    }
