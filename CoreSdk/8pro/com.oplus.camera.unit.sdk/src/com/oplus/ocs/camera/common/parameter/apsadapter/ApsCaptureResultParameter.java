...
public class ApsCaptureResultParameter extends ApsBaseParameter {
    ...
    static {
        ...
        KEY_CAPTURE_FOCAL_LENGTH = new ApsBaseParameter.Key<>("com.oplus.capture.focal_length", Float.class, fValueOf);
        KEY_CAPTURE_LENS_APERTURE = new ApsBaseParameter.Key<>("com.oplus.capture.lens_aperture", Float.class, fValueOf);
