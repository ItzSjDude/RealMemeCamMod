...
public class PortraitMode extends BaseMode {
    ...
    public CameraRequestTag createRequestTag(String str, Object obj, Handler handler, String str2,
        ...
        cameraRequestTagCreateRequestTag.mAiColorEnable = TYPE_PORTRAIT_RETENTION
                .equals(builder.get(PreviewParameter.KEY_FILTER_TYPE));
        if (cameraRequestTagCreateRequestTag.mAiColorEnable) {
            cameraRequestTagCreateRequestTag.mRTBEnable = false;
        } else if ("rear_portrait".equals(str) || "rear_second_portrait".equals(str) || "rear_sat".equals(str)
                || "rear_portrait_mono_1".equals(str) || "rear_portrait_mono_2".equals(str)
                || "front_dual".equals(str)) {
        ...
        if (Parameter.ParameterStage.BEFORE_TAKE_PICTURE.equals(str2)) {
            ...
            if (builder.containsKey(PreviewParameter.KEY_IS_FROM_MAIN_MENU)
                ...
                if (cameraRequestTagCreateRequestTag.mApsAlgoFlags != null) {
                    ...
                    z = false;
                    if (!z && !"on".equals(builder.get(PreviewParameter.KEY_PORTRAIT_NEON_ENABLE)) && (PlatformUtil
                            .isQualcommPlatform()
        ...
        cameraRequestTagCreateRequestTag.mApsRequestTag.mPreviewStreamNumber = getPreviewStreamNum(str,
                cameraRequestTagCreateRequestTag.mCameraId);
        ...
        if ("rear_sat".equals(str) || "rear_portrait".equals(str)) {
            cameraRequestTagCreateRequestTag.mLogicCameraType = ((Integer) CameraConfigHelper
        ...
        if ("front_dual".equals(str) && (cameraCharacteristicsWrapper = CameraCharacteristicsHelper
            ...
            cameraRequestTagCreateRequestTag.mForceUpScaleSize = cameraCharacteristicsWrapper
                    .getIntArrayConfig(CameraCharacteristicsWrapper.KEY_BOKEH_FORCE_UPSCALE_SIZE);
        }
        cameraRequestTagCreateRequestTag.mNeonEnable = "on"
                .equals(builder.get(PreviewParameter.KEY_PORTRAIT_NEON_ENABLE));
    ...
    private Size getBodyTypeSizes(String str, String str2) {
        ...
        if (!"rear_sat".equals(str)) {
            ...
            sizeArr = (Size[]) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_REAR_PORTRAIT_SAT_FULL_BODY_SIZE,
                    null);
            if (sizeArr == null) {
                sizeArr = new Size[] { DEFAULT_REAR_PORTRAIT_SAT_FULL_BODY_MAIN_CAMERA_CAPTURE_SIZE,
                        DEFAULT_REAR_PORTRAIT_SAT_FULL_BODY_WIDE_TELE_CAMERA_CAPTURE_SIZE };
            }
        } else if (isHalfBodyType(str)) {
            sizeArr = (Size[]) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_REAR_PORTRAIT_SAT_HALF_BODY_SIZE,
                    null);
            if (sizeArr == null) {
                sizeArr = new Size[] { DEFAULT_REAR_PORTRAIT_SAT_HALF_BODY_MAIN_CAMERA_CAPTURE_SIZE,
    ...
    public boolean needAddToTarget(String str, String str2, @NonNull SurfaceKey surfaceKey,
        ...
        if (Parameter.ParameterStage.BEFORE_TAKE_PICTURE.equals(str2)
            ...
            if ((!((Boolean) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_PORTRAIT_TURBO_RAW_SUPPORT, false))
                    ...
                    || (this.mPreviewResult != null && ((((iIntValue = ((Integer) this.mPreviewResult
                            .get(ApsDecisionParameter.KEY_PREVIEW_FEATURE_TYPE)).intValue()) == 3 || iIntValue == 1)
                            && 35 == surfaceKey.getFormat())
                            || (((iIntValue == 48 || iIntValue == 49) && (32 == surfaceKey.getFormat()
                                    || "surface_key_tuning_raw".equals(surfaceKey.getUsage())))
                                    || (iIntValue == 2 && (37 == surfaceKey.getFormat()
                                            || "surface_key_tuning_raw".equals(surfaceKey.getUsage()))))))) {
                z = true;
            }
            CameraUnitLog.e(TAG,
    ...
    public Pair<Size, Size> getSurfaceSize(SdkCameraDeviceConfig sdkCameraDeviceConfig, String str, String str2,
        ...
        zBooleanValue = ((Boolean) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_FRONT_DUAL_CAMERA_SUPPORT,
                false)).booleanValue();
        CameraUnitLog.d(TAG, "getSurfaceSize, configuredSurfaceType:" + str + " , configuredCameraType:" + str2
                + " , cameraType:" + str3 + " , isFrontDualCameraSupport:" + zBooleanValue);
        str.hashCode();
        switch (str) {
            case "raw_output":
            case "raw16_output":
                if (((Boolean) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_PORTRAIT_TURBO_RAW_SUPPORT,
                        false)).booleanValue() && ("rear_main".equals(str2) || "rear_wide".equals(str2))) {
                    return getCaptureSurfaceSizeBySurfaceType(zBooleanValue, "raw_output", str3, str2, surfaceWrapper,
                            appSurfaceSize);
                }
            ...
            case "preview":
            case "preview_frame":
                if ((("front_wide".equals(str2) && "front_dual".equals(str3) && zBooleanValue)
                        || "rear_wide".equals(str2))
                    ...
                    Size sizeByFormat = CameraCharacteristicsHelper.getSizeByFormat(str3,
                            ((double) appSurfaceSize.getWidth()) / ((double) appSurfaceSize.getHeight()), 538982489);
                    return new Pair<>(sizeByFormat, sizeByFormat);
                }
                if ((CameraConstant.CameraType.REAR_MONO_CAMERA_1.equals(str2)
                        || CameraConstant.CameraType.REAR_MONO_CAMERA_2.equals(str2)) && PlatformUtil.isMtkPlatform()) {
                    double width = ((double) appSurfaceSize.getWidth()) / ((double) appSurfaceSize.getHeight());
                    int i = ((Boolean) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_REAR_SINGLE_BOKEH_SUPPORT,
                            false)).booleanValue() ? 35 : 538982489;
            ...
            case "capture_raw":
                if (isSupportRearMFNRCapture() || isSupportRearAINRCapture()) {
                    return getCaptureSurfaceSizeBySurfaceType(zBooleanValue, "capture_yuv", str3, str2, surfaceWrapper,
                            appSurfaceSize);
                }
                return new Pair<>(surfaceWrapper.getAppSurfaceSize(),
                        CameraCharacteristicsHelper.getSizeByFormat(str3, 1.3333333333333333d, 32));
            case "capture_yuv":
                return getCaptureSurfaceSizeBySurfaceType(zBooleanValue, "capture_yuv", str3, str2, surfaceWrapper,
                        appSurfaceSize);
            case "capture":
                return getCaptureSurfaceSizeBySurfaceType(zBooleanValue, "capture", str3, str2, surfaceWrapper,
                        appSurfaceSize);
    ...
    private Pair getCaptureSurfaceSizeBySurfaceType(boolean z, String str, String str2, String str3,
        ...
        if ("rear_portrait_mono_1".equals(str2) && CameraConstant.CameraType.REAR_MONO_CAMERA_1.equals(str3)) {
            Size maxSize = getMaxSize(CameraConfigBase.KEY_MONO1_PICTURE_SIZE,
                    ((double) size.getWidth()) / ((double) size.getHeight()));
            return new Pair(maxSize, maxSize);
        }
        if ("rear_portrait_mono_2".equals(str2) && CameraConstant.CameraType.REAR_MONO_CAMERA_2.equals(str3)) {
            Size maxSize2 = getMaxSize(CameraConfigBase.KEY_MONO2_PICTURE_SIZE,
                    ((double) size.getWidth()) / ((double) size.getHeight()));
    ...
    protected int getPhysicalId(String str, String str2, String str3) {
        ...
        int[] iArr = (int[]) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_PORTRAIT_MODE_PHYSICAL_CAMERA_ID_1X,
                null);
