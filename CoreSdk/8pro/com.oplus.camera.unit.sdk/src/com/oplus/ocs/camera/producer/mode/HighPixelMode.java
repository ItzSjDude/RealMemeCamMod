...
public class HighPixelMode extends PhotoMode {
        ...
        switch (str) {
            ...
            case "capture":
                return new Pair<>(pictureSurfaces.get(0).getAppSurfaceSize(),
                        pictureSurfaces.get(0).getAppSurfaceSize());
            default:
    ...
    public void updateStageParameter(@NonNull Parameter parameter, String str, String str2,
        ...
        if (Parameter.ParameterStage.BEFORE_TAKE_PICTURE.equals(str)) {
            parameter.set(CaptureRequest.COLOR_CORRECTION_MODE, 0);
            parameter.set(CaptureRequest.STATISTICS_LENS_SHADING_MAP_MODE, 1);
            parameter.set(CaptureRequest.TONEMAP_MODE, 3);
        }
    }
