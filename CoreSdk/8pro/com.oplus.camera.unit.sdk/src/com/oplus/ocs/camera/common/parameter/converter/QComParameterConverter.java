...
class QComParameterConverter extends BaseParameterConverter {
    ...
    QComParameterConverter() {
        ...
        this.mCustomParameterMap.put(PreviewParameter.KEY_CAPTURE_FLIP_MODE.getName(), (CaptureRequest.Key<?>) KEY_VIDEO_FLIP_MODE);
        this.mCustomParameterMap.put(PreviewParameter.KEY_END_OF_STREAM.getName(), (CaptureRequest.Key<?>) KEY_END_OF_STREAM);
        this.mCustomParameterMap.put(PreviewParameter.KEY_VIDEO_EIS_RECORD_STATE.getName(), KEY_VIDEO_EIS_RECORD_STATE);
        this.mCustomParameterMap.put(PreviewParameter.KEY_IZOOM_PREVIEW.getName(), (CaptureRequest.Key<?>) KEY_IZOOM_PREVIEW);
        this.mCustomParameterMap.put(PreviewParameter.KEY_STARBURST_INFO.getName(), (CaptureRequest.Key<?>) KEY_STARBURST_INFO);
        this.mCustomParameterMap.put(PreviewParameter.KEY_COLOR_TEMPERATURE.getName(), (CaptureRequest.Key<?>) KEY_QUALCOMM_COLOR_TEMPERATURE);
        this.mCustomParameterMap.put(PreviewParameter.KEY_CAPTURE_REQUEST_IDX.getName(), KEY_CAPTURE_REQUEST_IDX);
        this.mCustomParameterMap.put(PreviewParameter.KEY_IZOOM_SNAPSHOT.getName(), (CaptureRequest.Key<?>) KEY_IZOOM_SNAPSHOT);
