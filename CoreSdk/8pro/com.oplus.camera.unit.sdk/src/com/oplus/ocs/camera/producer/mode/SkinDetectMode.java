...
public class SkinDetectMode extends PhotoMode {
    ...
    public String getSurfaceUseCase(String str, boolean z) {
        return "rear_microscope".equals(str) ? CameraConstant.UseCase.MICROSCOPE_CAPTURE
                : "front_main".equals(str) ? CameraConstant.UseCase.FRONT_SINGLE_PHOTO
                        : super.getSurfaceUseCase(str, z);
    }
}
