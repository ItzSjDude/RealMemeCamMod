    ...
    public static class ImageBuffer {
        ...
        public final void close() {
            if (this.mRef.decrementAndGet() == 0) {
                ...
                if (str != null && !"surface_key_recording".equals(str) && !"surface_key_preview_frame".equals(this.mSurfaceUsage) && !"surface_key_preview_in_preview".equals(this.mSurfaceUsage)) {
