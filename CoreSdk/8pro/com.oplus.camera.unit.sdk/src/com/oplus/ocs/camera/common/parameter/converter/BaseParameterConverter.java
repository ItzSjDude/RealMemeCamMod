...
abstract class BaseParameterConverter implements ParameterConverterInterface {
    ...
    private static final CaptureRequest.Key<int[]> KEY_BRACKET_MODE = new CaptureRequest.Key<>("com.oplus.BracketMode",
            int[].class);
    private static final CaptureRequest.Key<float[]> KEY_BLUR_LEVEL = new CaptureRequest.Key<>("com.oplus.bokeh.level",
            float[].class);
    ...
    private static final CaptureRequest.Key<int[]> KEY_SENSOR_MODE = new CaptureRequest.Key<>("com.oplus.sensor.mode",
            int[].class);
    ...
    public final void convert(Map<Parameter.Key<?>, Parameter.ValueWrapper<?>> map, CaptureRequestProxy.Builder builder,
            int i) {
        ...
        for (Parameter.Key<?> key : map.keySet()) {
            ...
            if (key2 != null
                    && (category == i || 3 == category || ((4 == category && 1 == i) || (4 == category && 2 == i)))) {
