...
public class PhotoMode extends BaseMode {
    ...
    public void onConfigure(CameraSessionEntity cameraSessionEntity, SdkCameraDeviceConfig sdkCameraDeviceConfig,
        ...
        if ("front_main".equals(str)
            ...
            if (pictureSurfaces.size() > 0) {
                ...
                Size geMaxSize = geMaxSize(CameraConfigBase.KEY_FRONT_MFNR_PICTURE_SIZE,
                        halSurfaceSize.getWidth() / halSurfaceSize.getHeight());
                CameraUnitLog.v(TAG, "onConfigure, cameraType: " + str + ", pictureSize: " + halSurfaceSize
                        + ", mfnrSize: " + geMaxSize);
                if (geMaxSize != null && halSurfaceSize.getHeight() <= geMaxSize.getHeight()
                        && halSurfaceSize.getWidth() <= geMaxSize.getWidth()) {
    ...
    public CameraRequestTag createRequestTag(String str, Object obj, Handler handler, String str2,
        ...
        synchronized (this.mPreviewResultLock) {
            if (this.mPreviewResult != null && Parameter.ParameterStage.BEFORE_TAKE_PICTURE.equals(str2)) {
                ...
                createRequestTag.mbAIShutter = ((Boolean) this.mPreviewResult
                        .get(ApsDecisionParameter.KEY_PREVIEW_AI_SHUTTER)).booleanValue();
                createRequestTag.mbEeyEnhance = AlgoSwitchConfig.getSupportCaptureAlgo(createRequestTag.mCaptureMode,
                        createRequestTag.mCameraId, ParameterKeys.ALGO_NAME_EYE_ENHANCE)
                        && 1 == createRequestTag.mRearFrontCameraId && !createRequestTag.mbInThirdApp;
                ...
                createRequestTag.mAISState = ((Integer) this.mPreviewResult
                        .get(ApsDecisionParameter.KEY_PREVIEW_AIS_STATE)).intValue();
                createRequestTag.mAsdMovingObject = ((Integer) this.mPreviewResult
                        .get(ApsDecisionParameter.KEY_PREVIEW_ASD_MOVING_OBJECT)).intValue();
                createRequestTag.mRequestSensorMode = ((Integer) this.mPreviewResult
                ...
                if (builder.containCustomKey(PreviewParameter.KEY_NIGHT_SE_ENABLE)) {
                    createRequestTag.mNightSeEnable = ((Boolean) builder.get(PreviewParameter.KEY_NIGHT_SE_ENABLE))
                            .booleanValue();
                }
            }
        }
        ...
        if (Parameter.ParameterStage.BEFORE_TAKE_PICTURE.equals(str)) {
            ...
            if (PlatformUtil.isMtkPlatform() && cameraRequestTag != null
                ...
                if (Util.isTurboHdr(this.mPreviewResult)) {
                    parameter.set(CaptureRequest.CONTROL_ENABLE_ZSL, true);
                } else {
            ...
            if (bool != null && bool.booleanValue() && cameraRequestTag != null) {
                ...
                if (32 == cameraRequestTag.mRequestFormat) {
                    parameter.set(PreviewParameter.KEY_CAPTURE_PROCESS_RAW_ENABLE, 1);
                    ...
                    parameter.set(PreviewParameter.KEY_CAPTURE_PROCESS_RAW_ENABLE, 0);
                    parameter.set(PreviewParameter.KEY_CAPTURE_RAW_BITS_PER_PIXEL, new int[] { 12 });
                }
            }
            if (cameraRequestTag != null) {
            ...
            synchronized (this.mPreviewResultLock) {
                if (PlatformUtil.isMtkPlatform()) {
                    int intValue = this.mPreviewResult != null
    ...
    public android.util.Pair<android.util.Size, android.util.Size> getSurfaceSize(
            com.oplus.ocs.camera.common.parameter.SdkCameraDeviceConfig r19, java.lang.String r20, java.lang.String r21,
        ...
        throw new UnsupportedOperationException(
                "Method not decompiled: com.oplus.ocs.camera.producer.mode.PhotoMode.getSurfaceSize(com.oplus.ocs.camera.common.parameter.SdkCameraDeviceConfig, java.lang.String, java.lang.String, java.lang.String):android.util.Pair");
    }
    ...
    public boolean needAddToTarget(String str, String str2, @NonNull SurfaceKey surfaceKey,
        ...
        if (Parameter.ParameterStage.START_PREVIEW.equals(str2)) {
            ...
            boolean z = (this.mPreviewResult == null || equals || (32 != ((Integer) this.mPreviewResult
                    ...
                    && 36 != ((Integer) this.mPreviewResult.get(ApsDecisionParameter.KEY_PREVIEW_REQUEST_FORMAT))
                            .intValue())) ? false : true;
            if (this.mPreviewResult != null) {
                int intValue = ((Integer) this.mPreviewResult.get(ApsDecisionParameter.KEY_PREVIEW_MASTER_PIPELINE))
                        .intValue();
    ...
    public boolean needStartPreview(CameraPreviewCallbackAdapter.PreviewResult previewResult) {
        ...
        if (((Boolean) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_SUPPORT_IZOOM_PREVIEW_ENABLE, false))
                ...
                && this.mZoomFeaturePrev != ((Integer) previewResult
                        .get(ApsDecisionParameter.KEY_PREVIEW_SUPPORT_ZOOM_FEATURE)).intValue()) {
            int intValue2 = ((Integer) previewResult.get(ApsDecisionParameter.KEY_PREVIEW_SUPPORT_ZOOM_FEATURE))
                    .intValue();
    ...
    public void updatePreviewRequestTag(PreviewParameter.Builder builder, CameraRequestTag cameraRequestTag, String str,
        ...
        if (!builder.containCustomKey(PreviewParameter.KEY_FOCUS_MODE)
            ...
            builder.set(PreviewParameter.KEY_FOCUS_MODE, 1);
        }
        synchronized (this.mVideoEisOnLock) {
            if (cameraRequestTag != null) {
    ...
    private void updateCameraRequestTag(PreviewParameter.Builder builder, CameraRequestTag cameraRequestTag) {
        ...
        if (cameraRequestTag.mbBurstShot) {
            int intValue = ((Integer) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_CSHOT_FIRST_REQUEST_NUM,
                    3)).intValue();
    ...
    public long getHalMemory() {
        ...
        if (this.mbTenBitOpen) {
            int intValue2 = ((Integer) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_HAL_MEMORY_10BIT, 0))
                    .intValue();
            if (CameraConstant.MEMORY_GB_8G < totalMemory) {
                intValue = ((Integer) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_HAL_MEMORY_10BIT_12G,
                        Integer.valueOf(intValue2))).intValue();
            } else if (CameraConstant.MEMORY_GB_6G < totalMemory) {
                intValue = ((Integer) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_HAL_MEMORY_10BIT_8G,
                        Integer.valueOf(intValue2))).intValue();
            } else if (CameraConstant.MEMORY_GB_4G >= totalMemory) {
                return intValue2;
            } else {
                intValue = ((Integer) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_HAL_MEMORY_10BIT_6G,
                        Integer.valueOf(intValue2))).intValue();
            }
            ...
            int intValue3 = ((Integer) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_HAL_MEMORY_COMMON, 0))
                    .intValue();
            if (CameraConstant.MEMORY_GB_8G < totalMemory) {
                intValue = ((Integer) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_HAL_MEMORY_COMMON_12G,
                        Integer.valueOf(intValue3))).intValue();
            } else if (CameraConstant.MEMORY_GB_6G < totalMemory) {
                intValue = ((Integer) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_HAL_MEMORY_COMMON_8G,
                        Integer.valueOf(intValue3))).intValue();
            } else if (CameraConstant.MEMORY_GB_4G >= totalMemory) {
                return intValue3;
            } else {
                intValue = ((Integer) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_HAL_MEMORY_COMMON_6G,
                        Integer.valueOf(intValue3))).intValue();
            }
        } else {
            intValue = ((Integer) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_HAL_MEMORY_COMMON, 0))
                    .intValue();
        }
        return intValue;
    }
    ...
    public int getSurfaceFormatBySurfaceType(String str, String str2, String str3) {
        if ("capture_yuv".equals(str) || "reprocess_yuv".equals(str)
            ...
            return 35;
        } else if ("capture_raw".equals(str)
     ...
     * com.oplus.ocs.camera.common.util.CameraUnitLog.v(com.oplus.ocs.camera.
     * producer.mode.PhotoMode.TAG,
     * "isAllowedToTakePicture, wait for seamless switch end, cost " + (r1 * 30) +
     * "ms, currentSensorMode is " + r2 + ", requestSensorMode is " +
     * r14.mRequestSensorMode, true);
     */
    @Override // com.oplus.ocs.camera.producer.mode.BaseMode,
              // com.oplus.ocs.camera.producer.mode.ModeInterface
    /*
     ...
     * To view partially-correct add '--show-bad-code' argument
     */
    public int isAllowedToTakePicture(com.oplus.ocs.camera.appinterface.CameraPictureCallbackAdapter r12,
            android.os.Handler r13, com.oplus.ocs.camera.common.util.CameraRequestTag r14) {
        /*
         * r11 = this;
         ...
         * r6 = 3
         * if (r1 >= r3) goto L66
         * com.oplus.ocs.camera.ProducerConsumerInterfaceContract$ConsumerInterface r2 =
         * r14.mConsumerInterface
         ...
         * r3.<init>()
         * java.lang.String r9 =
         * "isAllowedToTakePicture, wait for seamless switch end, cost "
         * r3.append(r9)
         * long r9 = (long) r1
         * long r9 = r9 * r7
         * r3.append(r9)
         ...
         * com.oplus.ocs.camera.common.statistics.StatisticsManager r13 =
         * com.oplus.ocs.camera.common.statistics.StatisticsManager.getInstance()
         * r14 = 25
         * java.lang.String r0 = "capture_failed"
         * r13.reportFunctionalError(r0, r14)
         * com.oplus.ocs.camera.appinterface.
         * CameraPictureCallbackAdapter$PictureResult$Builder r13 = new
         * com.oplus.ocs.camera.appinterface.
         * CameraPictureCallbackAdapter$PictureResult$Builder
         * r13.<init>()
         * com.oplus.ocs.camera.common.parameter.apsadapter.ApsBaseParameter$Key<java.
         * lang.Integer> r14 =
         * com.oplus.ocs.camera.common.parameter.apsadapter.ApsOtherParameter.
         * KEY_CAPTURE_FAIL_CODE
         * java.lang.Integer r11 = java.lang.Integer.valueOf(r11)
         * com.oplus.ocs.camera.appinterface.
         * CameraPictureCallbackAdapter$PictureResult$Builder r11 = r13.set(r14, r11)
         * r13 = 0
         * com.oplus.ocs.camera.appinterface.CameraPictureCallbackAdapter$PictureResult
         * r11 = r11.build()
         ...
         */
        throw new UnsupportedOperationException(
                "Method not decompiled: com.oplus.ocs.camera.producer.mode.PhotoMode.isAllowedToTakePicture(com.oplus.ocs.camera.appinterface.CameraPictureCallbackAdapter, android.os.Handler, com.oplus.ocs.camera.common.util.CameraRequestTag):int");
    }
