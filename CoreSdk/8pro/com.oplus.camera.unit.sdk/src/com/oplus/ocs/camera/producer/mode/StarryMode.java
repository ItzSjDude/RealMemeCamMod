...
public class StarryMode extends BaseMode {
    ...
    private void checkPictureParameter(@NonNull PreviewParameter.Builder builder) {
        ...
        builder.set((CaptureRequest.Key<Long>) CaptureRequest.SENSOR_EXPOSURE_TIME, Long.valueOf(STARRY_CAPTURE_EXPOSURETIME * 1000000));
        builder.set((CaptureRequest.Key<Integer>) CaptureRequest.SENSOR_SENSITIVITY, Integer.valueOf(STARRY_CAPTURE_ISO));
    }
