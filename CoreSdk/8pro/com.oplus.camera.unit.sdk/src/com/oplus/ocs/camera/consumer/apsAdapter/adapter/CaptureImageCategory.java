...
public class CaptureImageCategory extends ImageCategory {
    ...
    protected boolean isTuningDataValid() {
        ...
        if ((!"surface_key_tuning_yuv".equals(str) || ((Integer) this.mMetaItem.get(ApsParameters.KEY_YUV_TUNING_STREAM_NUMBER)).intValue() == size) && (!"surface_key_tuning_raw".equals(str) || ((Integer) this.mMetaItem.get(ApsParameters.KEY_RAW_TUNING_STREAM_NUMBER)).intValue() == size)) {
