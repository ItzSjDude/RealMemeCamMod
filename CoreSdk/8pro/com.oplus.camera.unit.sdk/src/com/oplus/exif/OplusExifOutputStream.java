...
class OplusExifOutputStream extends FilterOutputStream {
    ...
    */
        ...
        while (true) {
            ...
            if (i6 == 0) {
                ...
                if (s == -31) {
                    ...
                    this.mState = 2;
                } else if (!OplusJpegHeader.isSofMarker(s)) {
    ...
    private void writeExifData() throws IOException {
        ...
        if (iCalculateAllOffset > MAX_EXIF_SIZE) {
    ...
    private int calculateAllOffset() {
        ...
        for (int i = 0; i < this.mExifData.getStripCount(); i++) {
            jArr[i] = iCalculateOffsetOfIfd3;
            iCalculateOffsetOfIfd3 += this.mExifData.getStrip(i).length;
        }
