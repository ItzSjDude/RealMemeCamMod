...
public class DefaultUtill {
    ...
    protected static void setDefaultVendorTagConfigure(HashMap<String, String> map) {
        map.put(KEY_COMMON_AUTO_NIGHT_SCENCE, ApsParameters.FLAG_ON);
        map.put(KEY_VIDEO_EIS, ApsParameters.FLAG_ON);
        map.put(KEY_VIDEO_EIS_FPS, "60");
        map.put(KEY_VIDEO_EIS_FPS_SETTING_SUPPORT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_STICKER, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_NIGHT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_DISABLE_EXPORT_FRONT_DEFAULT_BEAUTY, ApsParameters.FLAG_ON);
        map.put(KEY_SUPER_TEXT_CPU_PROCESS, "0");
        map.put(KEY_SUPER_TEXT_SCANNER_SUPPORT, "0");
        map.put(KEY_SAVE_JPG_AFTER_PAUSE, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_SINGLE_CAMERA_USE_COMMOM_PORTRAIT_PREVIEW_SIZE, ApsParameters.FLAG_ON);
        map.put(KEY_BACK_PORTRAIT_NORMAL_MODE_PIC_SIZE, "4608x3456");
        map.put(KEY_HIGH_TEMPERATURE_ULTIMATE_LIMIT, "480");
        map.put(KEY_PORTRAIT_NEW_STYLE, ApsParameters.FLAG_ON);
        map.put(KEY_BEAUTY3D, ApsParameters.FLAG_ON);
        map.put(KEY_PI, "0");
        map.put(KEY_PI_AI, "0");
        map.put(KEY_PI_AI_ULTRA_WIDE_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_HIGH_DEFINITION_QUICK_JPEG_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_SUPPORT_VIDEO_SURFACE_RELEASE, "0");
        map.put(KEY_AI_SCENE_ULTRA_WIDE_HINT, "0");
        map.put(KEY_AI_SCENE_PORTRAIT_HINT, "0");
        map.put(KEY_AI_SCENE_NIGHT_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_SUPER_CLEAR_PORTRAIT, "0");
        map.put(KEY_FAST_VIDEO, ApsParameters.FLAG_ON);
        map.put(KEY_HYPER_LAPSE, "0");
        map.put(KEY_TORCH_SOFT_LIGHT, "0");
        map.put(KEY_SUPPORT_SLOWVIDEO_1080P, "0");
        map.put(KEY_SUPPORT_SLOWVIDEO_720P, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_SUPPORT_SCREEN_BRIGHTNESS, ApsParameters.FLAG_ON);
        map.put(KEY_SUPPORT_SCREEN_BRIGHTNESS_PORTRAIT, "0");
        map.put(KEY_SUPPORT_SCREEN_BRIGHTNESS_VIDEO, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_VIDEO_SIZE_4K, ApsParameters.FLAG_ON);
        map.put(KEY_VIDEO_SIZE_8K, "0");
        map.put(KEY_VIDEO_LOW_FPS_PREVIEW_PROCESS_BY_APS, ApsParameters.FLAG_ON);
        map.put(KEY_VIDEO_STABILIZATION_BY_APS, ApsParameters.FLAG_ON);
        map.put(KEY_VIDEO_STABILIZATION_FRONT_BY_APS, ApsParameters.FLAG_ON);
        map.put(KEY_ULTRA_NIGHT_VIDEO, "0");
        map.put(KEY_ULTRA_NIGHT_VIDEO_ZOOM, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_CUSTOM_BEAUTY_FRONT_VIDEO_OPEN_DEFAULT_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_CUSTOM_MAKEUP_FRONT, "0");
        map.put(KEY_CUSTOM_MAKEUP_WATERMARK_FRONT, "0");
        map.put(KEY_CUSTOM_MAKEUP_TYPE_SNOW, ApsParameters.FLAG_ON);
        map.put(KEY_CUSTOM_MAKEUP_TYPE_DREAM, ApsParameters.FLAG_ON);
        map.put(KEY_REQUEST_ZSL_MODE, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_SUPPORT_VIDEO_THUMBNAIL_SIMULTANEOUS_4K, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_RAW_HDR_CAPTURE_NEED_PREVIEWSURFACE_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_BURST_CAPTURE_NEED_PREVIEWSURFACE_SUPPORT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_SUPPORT_PORTRAIT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_SUPPORT_CAPTURE_RAW, ApsParameters.FLAG_ON);
        map.put(KEY_SUPPORT_SLOW_VIDEO, ApsParameters.FLAG_ON);
        map.put(KEY_SUPPORT_MOVIE_MODE, "0");
        map.put(KEY_SUPPORT_MOVIE_MODE_V2, "0");
        map.put(KEY_PORTRAIT_TURBO_RAW_SUPPORT, "0");
        map.put(KEY_SUPPORT_MOVIE_MODE_HDR_LOG, ApsParameters.FLAG_ON);
        map.put(KEY_SUPPORT_MOVIE_MODE_HDR, ApsParameters.FLAG_ON);
        map.put(KEY_SUPPORT_MOVIE_MODE_LOG, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_SUPPORT_FRONT_720P_SLOW_VIDEO, ApsParameters.FLAG_ON);
        map.put(KEY_SUPPORT_FRONT_1080P_SLOW_VIDEO, ApsParameters.FLAG_ON);
        map.put(KEY_SUPPORT_SLOW_VIDEO_ZOOM, "0");
        map.put(KEY_SUPPORT_FAST_VIDEO_SAT, "0");
        map.put(KEY_SUPPORT_FAST_VIDEO_BEAUTY, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_FRONT_SUPER_EIS_AND_AI_VIDEO_ENHANCE_COEXIST, ApsParameters.FLAG_ON);
        map.put(KEY_SUPPORT_VIDEO_FRONT_EIS_FORCE_ULTRA_WIDE, "0");
        map.put(KEY_SUPPORT_VIDEO_FRONT_EIS, "0");
        map.put(KEY_SUPPORT_VIDEO_SUPER_EIS_WIDE_60_FPS, ApsParameters.FLAG_ON);
        map.put(KEY_SUPPORT_VIDEO_SUPER_EIS_4K, "0");
        map.put(KEY_SUPPORT_VIDEO_BLUR_1080P, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_SUPPORT_VIDEO_8K_30FPS_ULTRA_WIDE, ApsParameters.FLAG_ON);
        map.put(KEY_VIDEO_NONE_SAT_ULTRA_WIDE_ANGLE_RESOLUTION_LIMIT, "0");
        map.put(KEY_SUPPORT_IMPRECISE_RAW_SIZE, "0");
        map.put(KEY_SUPPORT_PROFESSIONAL, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_NEED_SET_FACEINFO_TO_APS, Util.isQcomPlatform() ? "0" : ApsParameters.FLAG_ON);
        ...
        map.put(KEY_SAT_TELE_SUPPORT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_ULTRA_WIDE_BUBBLE_TIPS_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_VIDEO_ULTRA_WIDE_ANGLE_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_MOVIE_ULTRA_WIDE_ANGLE_SUPPORT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_NIGHT_TRIPOD_SUPPORT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_DIRECTOR_FILTER_RUS, ApsParameters.FLAG_ON);
        map.put(KEY_QUICK_VIDEO_SUPPORT, "0");
        map.put(KEY_FUJI_FILTER_SUPPORT, "0");
        map.put(KEY_BOKEH_BEAUTY_SUPPORT, "0");
        map.put(KEY_BOKEH_BEAUTY_OPEN_DEFAULT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_SLOGAN_LOCATION_SUPPORT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_REMOSAIC_SUPPORT_DEFAULT_VALUE, ApsParameters.FLAG_ON);
        map.put(KEY_PORTRAIT_FRONT_MAX_SIZE_SUPPORT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_SUPPORT_EIS_PRO_LOW_LIGHT_HINT, ApsParameters.FLAG_ON);
        map.put(KEY_AF_HYPERFOCALDISTANCE_SUPPORT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_SLOW_MOTION_H265_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_FRONT_INVERSE_COLOR, DEFAULT_FRONT_INVERSE_COLOR);
        map.put(KEY_APS_SUPPORT_VIDEO_SUPER_EIS, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_PORTRAIT_FRONT_RETENTION_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_PORTRAIT_BACK_RETENTION_SUPPORT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_MICROSCOPE_FILTER_SUPPORT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_TIME_LAPSE_RATE_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_PORTRAIT_BLUR_LEVEL_ENABLE, ApsParameters.FLAG_ON);
        map.put(KEY_PORTRAIT_SINGLE_BLUR_OPERATING, "0");
        map.put(KEY_PORTRAIT_IS_NEED_ATHENA, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_VIDEO_FUSION_APP_LOAD_SO_TYPE, ApsParameters.FLAG_ON);
        map.put(KEY_HW_MANUFACTURER_QUALCOMM, "0");
        map.put(KEY_NIGHT_SENSOR_MASK_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_CUSTOM_CAMERA_REAR_NUM, ApsParameters.FLAG_ON);
        map.put(KEY_PORTRAIT_ZOOM_VALUE_DEFAULT, "1.0");
        map.put(KEY_MOVIE_ULTRA_WIDE_FLASH_EIS_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_MOVIE_SUPER_EIS_SUPPORT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_VIDEO_4K_TRACK_FOCUS_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_VIDEO_AI_ENHANCEMENT_TRACK_FOCUS_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_VIDEO_60FPS_TRACK_FOCUS_SUPPORT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_SUPPORT_ULTAR_WIDE_VIDEO_4K_OR_60FPS, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_SUPPORT_FAST_VIDEO_LOCK_AF_4_FPS, ApsParameters.FLAG_ON);
        map.put(KEY_SUPPORT_HYPERLAPSE_VIDEO_OIS_CONFIG, ApsParameters.FLAG_ON);
        map.put(KEY_SUPPORT_MEDIA_RECORDER_CUSTOM_FOCUS_SECTOR_WIDTH, "0");
        map.put(KEY_SUPPORT_PANORAMA_REAR_PROCESS_IMAGE, "0");
        map.put(KEY_SUPPORT_TEMPERATURE_PROTECTION, ApsParameters.FLAG_ON);
        map.put(KEY_PROFESSIONAL_MUTEX_ZOOM_SUPPORT, "0");
        map.put(KEY_ONLY_HIGH_PICTURE_SIZE_HEIF_IN_APS, "0");
        map.put(KEY_FRONT_SUPERNIGHT_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_FRONT_PANORAMA_SUPPORT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_MULTI_VIDEO_MODE_1080P_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_MULTI_VIDEO_MODE_PREVIEW_SIZE, "1280x720");
        map.put(KEY_DISABLE_RAW, "0");
        map.put(KEY_SUPPORT_RAW_HDR, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_PORTRAIT_MODE_SET_DEFAULT_LOGIC_CAMERA_TYPE, ApsParameters.FLAG_ON);
        map.put(KEY_IS_UW_FIXED_FOCUS, "0");
        map.put(KEY_TELE_SMALL_PREVIEW_SUPPORT, "0");
        map.put(KEY_AIS_SNAPSHOT_USE_MFNR, "0,0");
        map.put(KEY_SUPPORT_VIDEO_MODE_INERTIAL_ZOOM, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_SUPPORT_FIRST_LAUNCH_ANIMATION, ApsParameters.FLAG_ON);
        map.put(KEY_ARCSOFT_SINGLE_BOKEH_SUPPORT, "0");
        map.put(KEY_OPLUS_SINGLE_PORTRAIT_SUPPORT, "0");
        map.put(KEY_SUPPORT_DIRTY_DETECT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_CAPTURE_WITH_DETACH, ApsParameters.FLAG_ON);
        map.put(KEY_SUPPORT_QR_CODE_ENABLE, "0");
        map.put(KEY_SUPPORT_NIGHT_GESTURE_SHUTTER, ApsParameters.FLAG_ON);
        map.put(KEY_SUPPORT_NEW_GESTURE_CAPTURE, "0");
        map.put(KEY_BACK_PURE_3RD_BOKEH_PREVIEW, "0");
        map.put(KEY_SHARE_EDIT_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_SUPPORT_EXPERT_MODE_NZSL_SUPPORT, "0");
        map.put(KEY_AI_ENHANCEMENT_VIDEO_FACEBEAUTY_MUTEX_SUPPORT, "0");
        map.put(KEY_AI_ENHANCEMENT_VIDEO_FILTER_MUTEX_SUPPORT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_LOCK_AE_BEFORE_CAPTURE_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_LOCK_AWB_BEFORE_CAPTURE_REAR_SUPPORT, "0");
        map.put(KEY_DOUBLE_EXPOSURE_SUPPORT, "0");
        map.put(KEY_STOP_REPEATING_BEFORE_END_OF_STREAM, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_NIGHT_INSENSOR_ZOOM_POINT_2X_SUPPORT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_PREVIEW_BUFFER_CACHE_SUPPORT, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_THERMAL_PAUSE_VIDEO_PREVIEW_BLACK_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_CAMERA_VIDEO_BRIGHTNESS_SECOND_EXPLORER, "150");
        map.put(KEY_FACE_BEAUTY_CUSTOM_MENU_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_CACHE_CLICK_CAPTURE_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_QUICK_JPEG, ApsParameters.FLAG_ON);
        map.put(KEY_MONO_FILTER_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_SAT_ULTRAWIDE_FOCUS_SUPPORT, ApsParameters.FLAG_ON);
        map.put(KEY_MONO_FILTER_MODE_PLACE, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_ROM_PLATFORM_VERSION, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_SUPPORT_STREET_RAW, ApsParameters.FLAG_ON);
        map.put(KEY_STREET_FIX_FOCUS, ApsParameters.FLAG_ON);
        map.put(KEY_EDGE_FILTER_LINE_SIZE, OplusExifInterface.GpsMeasureMode.MODE_2_DIMENSIONAL);
        ...
        map.put(KEY_SUPPORT_HASSELBLAD_WATERMARK, ApsParameters.FLAG_ON);
        map.put(KEY_SUPPORT_OUT_PREVIEW, ApsParameters.FLAG_ON);
        map.put(KEY_SUPPORT_OUT_CAPTURE, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_PHOTO_USE_OFFLINE_R2Y, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_SUPPORT_SD_CARD_STORAGE_SAVE, ApsParameters.FLAG_ON);
        ...
        map.put(KEY_ATHENA_NEW_SUPPORT, Util.isAfterAndroidS() ? ApsParameters.FLAG_ON : "0");
        ...
        map.put(KEY_SUPPORT_CONTINUOUS_SHOT_GALLERY_PRE_DECODE_ENABLE, ApsParameters.FLAG_ON);
    }
}
