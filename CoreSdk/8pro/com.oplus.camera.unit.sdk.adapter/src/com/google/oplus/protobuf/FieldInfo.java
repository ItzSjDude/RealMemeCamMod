...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            $SwitchMap$com$google$oplus$protobuf$FieldType = iArr;
            try {
                iArr[FieldType.MESSAGE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$google$oplus$protobuf$FieldType[FieldType.GROUP.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$google$oplus$protobuf$FieldType[FieldType.MESSAGE_LIST.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$google$oplus$protobuf$FieldType[FieldType.GROUP_LIST.ordinal()] = 4;
    ...
    public Class<?> getMessageFieldClass() {
        int i = AnonymousClass1.$SwitchMap$com$google$oplus$protobuf$FieldType[this.type.ordinal()];
        if (i == 1 || i == 2) {
