...
.method private handleException(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0}, Lorg/junit/rules/ExpectedExceptionMatcherBuilder;->build()Lorg/a/f;

    move-result-object p0

    invoke-static {p1, p0}, Lorg/junit/Assert;->assertThat(Ljava/lang/Object;Lorg/a/f;)V
...
.method private missingExceptionMessage()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lorg/junit/rules/ExpectedExceptionMatcherBuilder;->build()Lorg/a/f;

    move-result-object v0

    invoke-static {v0}, Lorg/a/i;->b(Lorg/a/h;)Ljava/lang/String;
...
.method public expect(Ljava/lang/Class;)V
    ...
    .line 186
    invoke-static {p1}, Lorg/a/c;->a(Ljava/lang/Class;)Lorg/a/f;

    move-result-object p1

    invoke-virtual {p0, p1}, Lorg/junit/rules/ExpectedException;->expect(Lorg/a/f;)V

    return-void
.end method

.method public expect(Lorg/a/f;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1}, Lorg/junit/rules/ExpectedExceptionMatcherBuilder;->add(Lorg/a/f;)V

    return-void
.end method

.method public expectCause(Lorg/a/f;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 226
    invoke-static {p1}, Lorg/junit/internal/matchers/ThrowableCauseMatcher;->hasCause(Lorg/a/f;)Lorg/a/f;
...
.method public expectMessage(Ljava/lang/String;)V
    ...
    .line 199
    invoke-static {p1}, Lorg/a/c;->a(Ljava/lang/String;)Lorg/a/f;

    move-result-object p1

    invoke-virtual {p0, p1}, Lorg/junit/rules/ExpectedException;->expectMessage(Lorg/a/f;)V

    return-void
.end method

.method public expectMessage(Lorg/a/f;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 212
    invoke-static {p1}, Lorg/junit/internal/matchers/ThrowableMessageMatcher;->hasMessage(Lorg/a/f;)Lorg/a/f;
