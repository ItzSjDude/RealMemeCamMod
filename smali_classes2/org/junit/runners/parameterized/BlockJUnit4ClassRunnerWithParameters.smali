...
.method protected validateFields(Ljava/util/List;)V
    ...
    const-class v4, Lorg/junit/runners/Parameterized$Parameter;

    invoke-virtual {v2, v4}, Ljava/lang/reflect/Field;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v2

    check-cast v2, Lorg/junit/runners/Parameterized$Parameter;

    invoke-interface {v2}, Lorg/junit/runners/Parameterized$Parameter;->value()I
    ...
    const-string v2, ". @Parameter fields counted: "
    ...
    const-string v2, ". Please use an index between 0 and "
    ...
    const-string v2, ") is used more than once ("
