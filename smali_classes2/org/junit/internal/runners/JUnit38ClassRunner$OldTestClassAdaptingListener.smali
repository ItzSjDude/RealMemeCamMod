...
.method private asDescription(Lb/b/d;)Lorg/junit/runner/Description;
    .locals 1
    ...
    .line 51
    :cond_0
    invoke-direct {p0, p1}, Lorg/junit/internal/runners/JUnit38ClassRunner$OldTestClassAdaptingListener;->getEffectiveClass(Lb/b/d;)Ljava/lang/Class;

    move-result-object v0

    invoke-direct {p0, p1}, Lorg/junit/internal/runners/JUnit38ClassRunner$OldTestClassAdaptingListener;->getName(Lb/b/d;)Ljava/lang/String;
...
.method private getEffectiveClass(Lb/b/d;)Ljava/lang/Class;
    .locals 0
...
.method private getName(Lb/b/d;)Ljava/lang/String;
    .locals 0

    .line 59
    instance-of p0, p1, Lb/b/e;

    if-eqz p0, :cond_0

    .line 60
    check-cast p1, Lb/b/e;

    invoke-virtual {p1}, Lb/b/e;->f()Ljava/lang/String;
...
# virtual methods
.method public addError(Lb/b/d;Ljava/lang/Throwable;)V
    .locals 1

    .line 42
    new-instance v0, Lorg/junit/runner/notification/Failure;

    invoke-direct {p0, p1}, Lorg/junit/internal/runners/JUnit38ClassRunner$OldTestClassAdaptingListener;->asDescription(Lb/b/d;)Lorg/junit/runner/Description;
...
.method public addFailure(Lb/b/d;Lb/b/b;)V
    .locals 0

    .line 67
    invoke-virtual {p0, p1, p2}, Lorg/junit/internal/runners/JUnit38ClassRunner$OldTestClassAdaptingListener;->addError(Lb/b/d;Ljava/lang/Throwable;)V

    return-void
.end method

.method public endTest(Lb/b/d;)V
    .locals 1
...
.method public startTest(Lb/b/d;)V
    .locals 1
