...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Landroidx/recyclerview/widget/s$1;-><init>(Landroidx/recyclerview/widget/s;)V

    iput-object v0, p0, Landroidx/recyclerview/widget/s;->c:Landroidx/recyclerview/widget/RecyclerView$n;
...
.method private b()V
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/s;->c:Landroidx/recyclerview/widget/RecyclerView$n;
...
.method private b(Landroidx/recyclerview/widget/RecyclerView$i;II)Z
    ...
    .line 161
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/s;->b(Landroidx/recyclerview/widget/RecyclerView$i;)Landroidx/recyclerview/widget/RecyclerView$s;
    ...
    .line 166
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Landroidx/recyclerview/widget/s;->a(Landroidx/recyclerview/widget/RecyclerView$i;II)I
    ...
    .line 171
    :cond_2
    invoke-virtual {v0, p0}, Landroidx/recyclerview/widget/RecyclerView$s;->setTargetPosition(I)V
...
.method private c()V
    ...
    .line 124
    iget-object p0, p0, Landroidx/recyclerview/widget/s;->a:Landroidx/recyclerview/widget/RecyclerView;

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/RecyclerView;->setOnFlingListener(Landroidx/recyclerview/widget/RecyclerView$l;)V
...
.method a()V
    ...
    .line 189
    :cond_1
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/s;->a(Landroidx/recyclerview/widget/RecyclerView$i;)Landroid/view/View;
    ...
    .line 193
    :cond_2
    invoke-virtual {p0, v0, v1}, Landroidx/recyclerview/widget/s;->a(Landroidx/recyclerview/widget/RecyclerView$i;Landroid/view/View;)[I
...
.method public a(II)Z
    ...
    .line 75
    :cond_2
    invoke-direct {p0, v0, p1, p2}, Landroidx/recyclerview/widget/s;->b(Landroidx/recyclerview/widget/RecyclerView$i;II)Z
...
.method protected b(Landroidx/recyclerview/widget/RecyclerView$i;)Landroidx/recyclerview/widget/RecyclerView$s;
    ...
    .line 210
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/s;->c(Landroidx/recyclerview/widget/RecyclerView$i;)Landroidx/recyclerview/widget/j;
...
.method public b(II)[I
    ...
    .line 141
    iget-object p0, p0, Landroidx/recyclerview/widget/s;->b:Landroid/widget/Scroller;
...
.method protected c(Landroidx/recyclerview/widget/RecyclerView$i;)Landroidx/recyclerview/widget/j;
    .locals 1
    ...
    .line 229
    :cond_0
    new-instance p1, Landroidx/recyclerview/widget/s$2;
    ...
    invoke-direct {p1, p0, v0}, Landroidx/recyclerview/widget/s$2;-><init>(Landroidx/recyclerview/widget/s;Landroid/content/Context;)V
