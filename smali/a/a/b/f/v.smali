...
.method public static a(Landroid/graphics/Canvas;Landroid/graphics/Paint;Ljava/lang/String;FFFFLjava/lang/String;)F
    ...
    :cond_1
    invoke-static {p2, p1}, La/a/b/f/v;->a(Ljava/lang/String;Landroid/graphics/Paint;)F
...
.method public static a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;Lco/polarr/renderer/entities/Context;La/a/b/c/d;)La/a/b/c/d;
    ...
    invoke-static {p0, p1, p2, p3}, La/a/b/f/v;->a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;Lco/polarr/renderer/entities/Context;)Landroid/graphics/Bitmap;
...
.method public static a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;La/a/b/f/v$b;)La/a/b/f/v$a;
    .locals 9

    iget-object v0, p3, La/a/b/f/v$b;->b:Landroid/graphics/RectF;

    iget v1, p3, La/a/b/f/v$b;->f:F

    iget v2, p3, La/a/b/f/v$b;->d:F

    iget v3, p3, La/a/b/f/v$b;->a:F
    ...
    invoke-static {p0, p1, p2, p3}, La/a/b/f/v;->a(Landroid/content/Context;Landroid/content/res/AssetManager;Ljava/lang/String;La/a/b/f/v$b;)[Ljava/lang/String;
    ...
    invoke-static {v7, v4}, La/a/b/f/v;->a(Ljava/lang/String;Landroid/graphics/Paint;)F
    ...
    :cond_1
    new-instance p3, La/a/b/f/v$a;

    invoke-direct {p3}, La/a/b/f/v$a;-><init>()V

    iput v6, p3, La/a/b/f/v$a;->a:F

    mul-float/2addr v2, p2

    add-float/2addr v2, v0

    iput v2, p3, La/a/b/f/v$a;->b:F

    iput-object p0, p3, La/a/b/f/v$a;->c:[Ljava/lang/String;
    ...
    iput-object p0, p3, La/a/b/f/v$a;->d:[Ljava/lang/Float;

    return-object p3
.end method

.method public static a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;I)La/a/b/f/v$b;
    .locals 9
    ...
    invoke-static {p0, p1, p2, p3}, La/a/b/f/d;->a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;I)Landroid/graphics/Typeface;
    ...
    new-instance p0, La/a/b/f/v$b;

    invoke-direct {p0}, La/a/b/f/v$b;-><init>()V

    iput v1, p0, La/a/b/f/v$b;->a:F

    iput-object v4, p0, La/a/b/f/v$b;->b:Landroid/graphics/RectF;

    iput v0, p0, La/a/b/f/v$b;->c:F

    iget p1, p2, Lco/polarr/renderer/entities/TextItem;->lineHeight:F

    mul-float/2addr p1, v0

    iput p1, p0, La/a/b/f/v$b;->d:F

    const p1, 0x3c23d70a    # 0.01f

    mul-float/2addr p1, v0

    iput p1, p0, La/a/b/f/v$b;->e:F

    iget p1, p2, Lco/polarr/renderer/entities/TextItem;->letterSpacing:F

    mul-float/2addr v0, p1

    iput v0, p0, La/a/b/f/v$b;->f:F
    ...
    :goto_4
    iput-object p1, p0, La/a/b/f/v$b;->g:[F
    ...
    :goto_5
    iput-object p1, p0, La/a/b/f/v$b;->h:[F
    ...
    iput-object p1, p0, La/a/b/f/v$b;->i:Lco/polarr/renderer/entities/TextItem;

    iput p3, p0, La/a/b/f/v$b;->j:I
...
.method public static a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;Lco/polarr/renderer/entities/Context;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v1, v2, v3}, La/a/b/f/v;->a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;I)La/a/b/f/v$b;

    move-result-object v3

    iget-object v4, v3, La/a/b/f/v$b;->b:Landroid/graphics/RectF;

    iget v13, v3, La/a/b/f/v$b;->f:F

    iget v14, v3, La/a/b/f/v$b;->d:F

    iget-object v5, v3, La/a/b/f/v$b;->g:[F
    ...
    iget v6, v3, La/a/b/f/v$b;->c:F

    invoke-virtual {v15, v6}, Landroid/text/TextPaint;->setTextSize(F)V

    invoke-static {v0, v1, v2, v3}, La/a/b/f/v;->a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;La/a/b/f/v$b;)La/a/b/f/v$a;

    move-result-object v0

    iget-object v1, v0, La/a/b/f/v$a;->c:[Ljava/lang/String;

    iget-object v11, v0, La/a/b/f/v$a;->d:[Ljava/lang/Float;

    iget v10, v0, La/a/b/f/v$a;->a:F

    iget v0, v0, La/a/b/f/v$a;->b:F
    ...
    iget-object v4, v3, La/a/b/f/v$b;->h:[F
    ...
    invoke-static {v4, v15}, La/a/b/f/v;->a([Ljava/lang/String;Landroid/text/TextPaint;)[F
    ...
    invoke-static/range {v5 .. v12}, La/a/b/f/v;->a(Landroid/graphics/Canvas;Landroid/graphics/Paint;Ljava/lang/String;FFFFLjava/lang/String;)F
...
.method public static a([Ljava/lang/String;Landroid/text/TextPaint;)[F
    ...
    invoke-static {v4, p1}, La/a/b/f/v;->a(Ljava/lang/String;Landroid/graphics/Paint;)F
...
.method public static a(Landroid/content/Context;Landroid/content/res/AssetManager;Ljava/lang/String;La/a/b/f/v$b;)[Ljava/lang/String;
    .locals 18
    ...
    iget-object v3, v1, La/a/b/f/v$b;->i:Lco/polarr/renderer/entities/TextItem;

    iget v4, v1, La/a/b/f/v$b;->j:I
    ...
    iget v3, v1, La/a/b/f/v$b;->c:F

    invoke-virtual {v2, v3}, Landroid/text/TextPaint;->setTextSize(F)V

    iget v3, v1, La/a/b/f/v$b;->f:F

    iget v1, v1, La/a/b/f/v$b;->a:F
    ...
    invoke-static {v7, v2}, La/a/b/f/v;->a(Ljava/lang/String;Landroid/graphics/Paint;)F
    ...
    invoke-static {v4, v2}, La/a/b/f/v;->a(Ljava/lang/String;Landroid/graphics/Paint;)F
    ...
    invoke-static {v12, v7}, La/a/b/f/v;->a(Ljava/util/List;Ljava/lang/String;)Ljava/lang/String;
