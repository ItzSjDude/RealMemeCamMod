...
public class IHwBinderWrapper {
    ...
    public static abstract class DeathRecipientWrapper {
        private final IHwBinder.DeathRecipient mDeathRecipient = new IHwBinder.DeathRecipient() { // from class: com.oppo.inner.os.IHwBinderWrapper.DeathRecipientWrapper.1
