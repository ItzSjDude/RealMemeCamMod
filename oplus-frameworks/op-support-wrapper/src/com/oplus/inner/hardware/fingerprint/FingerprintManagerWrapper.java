    ...
    public static void regsiterOpticalFingerprintListener(FingerprintManager fp, final OpticalFingerprintListenerCallbackWrapper callback) {
        try {
            ...
            if (callback != null && oplusFingerprintManagerEx != null) {
                oplusFingerprintManagerEx.regsiterOpticalFingerprintListener(new IOplusFingerprintManagerEx.OpticalFingerprintListener() { // from class: com.oplus.inner.hardware.fingerprint.FingerprintManagerWrapper.1
