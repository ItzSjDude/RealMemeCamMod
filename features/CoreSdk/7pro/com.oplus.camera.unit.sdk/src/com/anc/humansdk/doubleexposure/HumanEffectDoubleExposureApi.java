...
public class HumanEffectDoubleExposureApi {
    ...
    public int process(HumanProcessTextureRequest humanProcessTextureRequest, HumanProcessTextureRequest humanProcessTextureRequest2, HumanProcessTexureResult humanProcessTexureResult) {
        if (this.handle.get() == 0) {
            ...
            Log.d(TAG, String.format("process fg %d, bg %d, out %d", Integer.valueOf(humanProcessTextureRequest.humanVideoTexture.texID), Integer.valueOf(humanProcessTextureRequest2.humanVideoTexture.texID), Integer.valueOf(humanProcessTexureResult.humanVideoTexture.texID)));
    ...
    public int process(HumanProcessFrameRequest humanProcessFrameRequest, HumanProcessTextureRequest humanProcessTextureRequest, HumanProcessTexureResult humanProcessTexureResult) {
        if (this.handle.get() == 0) {
            ...
            if (humanProcessFrameRequest.humanVideoFrame.type != ImageType.ANC_HUM_IMG_NV21) {
                String str2 = TAG;
                Log.e(str2, "process: argment is invalid, image type=%d" + humanProcessFrameRequest.humanVideoFrame.type);
                return 1;
            }
            if (i % 64 != 0) {
            ...
            Log.d(TAG, String.format("process fg %d, bg %d, out %d", Integer.valueOf(humanProcessFrameRequest.humanVideoFrame.data.length), Integer.valueOf(humanProcessTextureRequest.humanVideoTexture.texID), Integer.valueOf(humanProcessTexureResult.humanVideoTexture.texID)));
            if (humanProcessTexureResult.humanVideoTexture.isOES) {
    ...
    public static class HumanProcessHardwareBufferRequestBuilder {
        ...
        public HumanProcessHardwareBufferRequest build() {
            ...
            return new HumanProcessHardwareBufferRequest(this.cameraType, new HumanVideoHardwareBuffer(this.data, this.type, this.width, this.height, this.scanline, this.rotation));
        }
    }
    ...
    public static class HumanProcessTextureRequestBuilder {
        ...
        public HumanProcessTextureRequest build() {
            if (this.texID > 0 && this.width > 0 && this.height > 0 && this.rotation % 90 == 0 && this.cameraType != null) {
                return new HumanProcessTextureRequest(this.cameraType, new HumanVideoTexture(this.texID, this.isOES, this.width, this.height, this.rotation, this.isBgFromAlbum));
            }
