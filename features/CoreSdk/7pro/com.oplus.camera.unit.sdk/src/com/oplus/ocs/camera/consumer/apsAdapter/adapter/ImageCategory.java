...
public class ImageCategory {
    ...
    public boolean isValid() {
        return (this.mImageItemList != null && this.mImageItemList.size() > 0 && !((Boolean) this.mImageItemList.get(0).get(ApsParameters.KEY_NEED_META_DATA)).booleanValue()) || (this.mMetaItem != null && ((Integer) this.mMetaItem.get(ApsParameters.KEY_MERGE_NUMBER)).intValue() >= 1 && ((Integer) this.mMetaItem.get(ApsParameters.KEY_PREVIEW_STREAM_NUMBER)).intValue() >= 1 && this.mImageItemList != null && ((Integer) this.mMetaItem.get(ApsParameters.KEY_PREVIEW_STREAM_NUMBER)).intValue() == this.mImageItemList.size() && ((Long) this.mMetaItem.get(ApsParameters.KEY_TIME_STAMP)).equals(this.mImageItemList.get(0).get(ApsParameters.KEY_TIME_STAMP)) && isTuningDataValid());
    }
    ...
    public void releaseImageItemList() {
        ...
        if (this.mImageItemList != null) {
            for (ImageItemInfo imageItemInfo : this.mImageItemList) {
        ...
        if (this.mTuningItemLists != null) {
            for (List<TuningItemInfo> list : this.mTuningItemLists.values()) {
                for (TuningItemInfo tuningItemInfo : list) {
        ...
        if (this.mMetaItem == null || this.mMetaItem.mImageBuffer == null) {
            return;
        }
