...
public class CameraUnitImpl implements CameraUnitInterface {
    ...
    public void initialize(@NonNull Context context) {
        ...
        this.mConsumerInterface = new ConsumerImpl();
        CameraConfigHelper.setConfigStatusCallback(new CameraConfigHelper.ConfigStatusCallback() { // from class: com.oplus.ocs.camera.CameraUnitImpl.1
        ...
        this.mDeviceManager = new CameraDeviceManager();
    }
    ...
    public synchronized void openCamera(@NonNull String str, @NonNull final CameraStateCallbackAdapter cameraStateCallbackAdapter, @NonNull Handler handler) {
        ...
        if (createCameraStateCallback != null) {
            ...
            handler.post(new Runnable() { // from class: com.oplus.ocs.camera.CameraUnitImpl.2
    ...
    public boolean checkAuthenticationPermission(@NonNull Context context, @NonNull String str, int i) {
        ...
        if (!CameraConfigHelper.isConfigFileExist()) {
    ...
    private void setDeathRecipient(Context context) {
        new Thread(new Runnable() { // from class: com.oplus.ocs.camera.CameraUnitImpl.3
            @Override // java.lang.Runnable
            public void run() {
