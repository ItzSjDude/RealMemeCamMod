...
public class ApsCaptureParam {
    ...
    public ApsCaptureParam(long j, ApsResult.ImageBuffer imageBuffer, int i, CameraMetadata cameraMetadata, CameraMetadata cameraMetadata2, ApsResult.ImageBuffer imageBuffer2, int[] iArr, String[] strArr, boolean z, int i2, int i3, boolean z2, boolean z3, int i4, String str) {
        this.mFrameNumber = 0L;
        this.mImageBuffer = null;
        this.mMetaBuffer = null;
        this.mRole = 0;
        this.mLogicMeta = null;
        this.mPhysicMeta = null;
        this.mInputSize = null;
        this.mCropSize = null;
        this.mbReprocessFrame = false;
        this.mMaxHoldImages = 0;
        this.mPreferType = 0;
        this.mbVideoSnapshot = false;
        this.m10BitsEnable = "0";
        this.mbRawSyncProcessFrame = false;
        this.mSpecificAlgo = 0;
        this.mFrameNumber = j;
