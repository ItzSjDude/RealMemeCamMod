...
@SynthesizedClassMap({$$Lambda$OplusTrack$rM6qFayncRU2usBDybImQRnx9OQ.class, $$Lambda$OplusTrack$Ax96NCbcBvcY_HOW8gCBgSaz8Q.class, $$Lambda$OplusTrack$4rthJD3hr6iH0EFlXVEQyXvaIeY.class, $$Lambda$OplusTrack$c4lo8ou4DlFDg6szOS69dpoRkyE.class, $$Lambda$_72Yv9SLtr5HefYoZLqe3y7AOoE.class, $$Lambda$OplusTrack$mqA2Rt7Zi2LzHcDAX_W_NyquGJI.class, $$Lambda$OplusTrack$6TR_6VCP_3alAjxPOU5GSwdzSY.class, $$Lambda$OplusTrack$wZKGoLTgkxoE3shLvxMHtxvZQaU.class, $$Lambda$OplusTrack$8D1EkNG8RTqcUCpZmCM9QatuzGo.class, $$Lambda$OplusTrack$FWFOOtrXKl2OMWGCn8INihMkFbc.class, $$Lambda$OplusTrack$YV8Am8zhlB_AYJa5sp5mvAyr8Vs.class, $$Lambda$OplusTrack$y5gvAim5wMTcHMWBPqNuLSD9S5k.class, $$Lambda$OplusTrack$YTtIBWrsnDdbiPP0fey0F8di5y8.class, $$Lambda$OplusTrack$gujFkhA0YUZ6f0OVop0qg2f9hyc.class, $$Lambda$OplusTrack$TdHEq4tOkUfkFiIUaZ6gDyHDji0.class, $$Lambda$OplusTrack$gO4OitIZTY5Iaz5jQUDb2xZeYbw.class, $$Lambda$OplusTrack$Y4OY7FaPOHaVGdni9pM5gXN9nx8.class, $$Lambda$OplusTrack$raJFTZpn4KoJiH7CK0vQ2umpCYI.class, $$Lambda$OplusTrack$37_Z7_MnqlCj3TOobVTThAkFZ8.class, $$Lambda$OplusTrack$6YPGfcQPLk28c2vmFNPbc2PsvyE.class, $$Lambda$OplusTrack$2Ti63WxbwR5rMTiGnSS4hgpsIyE.class, $$Lambda$OplusTrack$JCd8IhfEJ41OEcFv7lOaoUF7Hsk.class, $$Lambda$OplusTrack$4QK4ush7Zwg3hqpP9zabyKn7m58.class, $$Lambda$OplusTrack$NmOkwONov8zPpBrhuKxL3im0gg.class, $$Lambda$OplusTrack$xwrUDudPAa_zXzadUrkI_WePHek.class, $$Lambda$OplusTrack$nE26hyJ42uqR7D10COzxKbUlJ68.class, $$Lambda$OplusTrack$TTfBNx35UinFzZ4CNeXQ1ilVQzQ.class, $$Lambda$OplusTrack$no7gMYayjFw0GTkB9EfMJMPyAfw.class, $$Lambda$OplusTrack$x4yJApnbexXmXJR5YNiXGg2vBbc.class, $$Lambda$OplusTrack$ZLQD8b7QLbjIBfyUxA58_XCttgs.class, $$Lambda$OplusTrack$uhbjE2DvS1difCFJJ0g4w1ToUU.class, $$Lambda$OplusTrack$Jqmo1jhceHRAu80oMCCS_KFu34M.class})
...
public class OplusTrack {
    ...
    public static void init(@NonNull Context context, String str, @Nullable OTrackConfig oTrackConfig) {
        ...
        if (TextUtils.isEmpty(str)) {
            LogUtil.w(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$raJFTZpn4KoJiH7CK0vQ2umpCYI
    ...
    public static boolean onCommon(final CommonBean commonBean, final int i) {
        ...
        try {
            LogUtil.v(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$Ax96NCbcBvcY_HOW8gCB-gSaz8Q
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
            ...
            if ((i & 1) == 1) {
                WorkThread.execute(new Runnable() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$4QK4ush7Zwg3hqpP9zabyKn7m58
            ...
            if ((i & 2) == 2) {
                WorkThread.execute(new Runnable() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$Jqmo1jhceHRAu80oMCCS_KFu34M
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public static void onStaticDataUpdate(final Context context, final PeriodDataBean periodDataBean) {
        try {
            LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$xwrUDudPAa_zXzadUrkI_WePHek
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
                    return OplusTrack.lambda$onStaticDataUpdate$4(PeriodDataBean.this);
                }
            });
            WorkThread.execute(new Runnable() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$NmOkwONov8z-PpBrhuKxL3im0gg
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public static void onSettingKeyUpdate(final Context context, final SettingKeyDataBean settingKeyDataBean) {
        try {
            LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$4rthJD3hr6iH0EFlXVEQyXvaIeY
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
            ...
            if (!TextUtils.isEmpty(settingKeyDataBean.getLogTag())) {
                ...
                LogUtil.e(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$YV8Am8zhlB_AYJa5sp5mvAyr8Vs
                    @Override // com.oplus.statistics.util.Supplier
                    public final Object get() {
    ...
    public static boolean onSpecialAppStart(Context context, final int i) {
        LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$YTtIBWrsnDdbiPP0fey0F8di5y8
            @Override // com.oplus.statistics.util.Supplier
            public final Object get() {
    ...
    public static void onEventStart(final Context context, final String str, final String str2) {
        try {
            LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$y5gvAim5wMTcHMWBPqNuLSD9S5k
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
    ...
    public static void onEventStart(final Context context, final String str) {
        try {
            LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$wZKGoLTgkxoE3shLvxMHtxvZQaU
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
    ...
    public static void onEventEnd(final Context context, final String str, final String str2) {
        try {
            LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$6TR_6VCP_3-alAjxPOU5GSwdzSY
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
    ...
    public static void onEventEnd(final Context context, final String str) {
        try {
            LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$6YPGfcQPLk28c2vmFNPbc2PsvyE
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
    ...
    public static void onDynamicEvent(final Context context, final int i, final int i2, final Map<String, String> map, final Map<String, String> map2) {
        try {
            LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$JCd8IhfEJ41OEcFv7lOaoUF7Hsk
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
    ...
    public static void onStaticEvent(final Context context, final int i, final int i2, final String str, final String str2, final String str3, final Map<String, String> map) {
        try {
            LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$gO4OitIZTY5Iaz5jQUDb2xZeYbw
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
    ...
    public static void onKVEventStart(final Context context, final String str, final Map<String, String> map, final String str2) {
        try {
            LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$2Ti63WxbwR5rMTiGnSS4hgpsIyE
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
    ...
    public static void onKVEventEnd(final Context context, final String str, final String str2) {
        try {
            LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$Y4OY7FaPOHaVGdni9pM5gXN9nx8
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
    ...
    public static void onKVEventStart(final Context context, final String str, final Map<String, String> map) {
        try {
            LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$8D1EkNG8RTqcUCpZmCM9QatuzGo
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
    ...
    public static void onKVEventEnd(final Context context, final String str) {
        try {
            LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$FWFOOtrXKl2OMWGCn8INihMkFbc
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
    ...
    public static void onPause(Context context) {
        try {
            LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$ZLQD8b7QLbjIBfyUxA58_XCttgs
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
    ...
    public static void onResume(Context context) {
        try {
            LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$TTfBNx35UinFzZ4CNeXQ1ilVQzQ
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
    ...
    public static synchronized void onError(Context context) {
        synchronized (OplusTrack.class) {
            try {
                LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$nE26hyJ42uqR7D10COzxKbUlJ68
                    @Override // com.oplus.statistics.util.Supplier
                    public final Object get() {
    ...
    public static void onDebug(final Context context, final boolean z) {
        try {
            LogUtil.setDebug(z);
            LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$no7gMYayjFw0GTkB9EfMJMPyAfw
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
    ...
    public static void setDebug(final boolean z) {
        try {
            LogUtil.setDebug(z);
            LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$mqA2Rt7Zi2LzHcDAX_W_NyquGJI
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
    ...
    public static void setSessionTimeOut(Context context, final int i) {
        LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$c4lo8ou4DlFDg6szOS69dpoRkyE
            @Override // com.oplus.statistics.util.Supplier
            public final Object get() {
    ...
    public static void setSsoID(Context context, final String str) {
        LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$rM6qFayncRU2usBDybImQRnx9OQ
            @Override // com.oplus.statistics.util.Supplier
            public final Object get() {
    ...
    public static void removeSsoID(Context context) {
        try {
            LogUtil.d(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$TdHEq4tOkUfkFiIUaZ6gDyHDji0
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
    ...
    private static boolean formatCheck(String str, String str2, int i) {
        if (str == null) {
            LogUtil.e(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$uhbjE2DvS1difCFJJ0-g4w1ToUU
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
            ...
            LogUtil.e(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$gujFkhA0YUZ6f0OVop0qg2f9hyc
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
            ...
            LogUtil.e(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$-37_Z7_MnqlCj3TOobVTThAkFZ8
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
            ...
            LogUtil.e(TAG, new Supplier() { // from class: com.oplus.statistics.-$$Lambda$OplusTrack$x4yJApnbexXmXJR5YNiXGg2vBbc
                @Override // com.oplus.statistics.util.Supplier
                public final Object get() {
