...
public class ApsRequestTag {
    ...
    public boolean mbNeedMetadata = true;
    ...
    public String toString() {
        return "mOperationMode: " + this.mOperationMode + ", mbNeedMetadata: " + this.mbNeedMetadata + ", mbHighPictureSizeEnable: " + this.mbHighPictureSizeEnable + ", mbPhoto10BitsEnable: " + this.mbPhoto10BitsEnable + ", mVideo10BitsEnable: " + this.mbVideo10BitsEnable + ", mbAiHighPixelEnable: " + this.mbAiHighPixelEnable + ", mbVideoWaterMarkEnable: " + this.mbVideoWaterMarkEnable + ", mCameraType: " + this.mCameraType + ", mModeName: " + this.mModeName + ", mFeatureName: " + this.mFeatureName + ", mInputVideoSize: " + this.mInputVideoSize + ", mOutputVideoSize: " + this.mOutputVideoSize + ", mPreviewSize: " + this.mPreviewSize + ", mPictureSize: " + this.mPictureSize + ", mBlurIndex: " + this.mBlurIndex + ", mPreviewStreamNumber: " + this.mPreviewStreamNumber + ", mCaptureStreamNumber: " + this.mCaptureStreamNumber + ", mPreviewDisplayType: " + this.mPreviewDisplayType + ", mPreviewSurfaceType: " + this.mPreviewSurfaceType + ", mRearFrontCameraId: " + this.mRearFrontCameraId;
    }
}
