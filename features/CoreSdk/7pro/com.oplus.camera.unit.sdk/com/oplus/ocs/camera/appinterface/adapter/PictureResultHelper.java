...
public class PictureResultHelper extends CameraBaseResultHelper {
    ...
    public void setImageCategory(ImageCategory.ImageItemInfo imageItemInfo, ImageCategory.MetaItemInfo metaItemInfo) {
        if (imageItemInfo != null) {
            this.mBaseParameter.set(ApsImageCategoryParameter.KEY_IMAGE_CATEGORY_HEIGHT, imageItemInfo.get(ParameterKeys.KEY_IMAGE_HEIGHT));
            this.mBaseParameter.set(ApsImageCategoryParameter.KEY_IMAGE_CATEGORY_WIDTH, imageItemInfo.get(ParameterKeys.KEY_IMAGE_WIDTH));
            this.mBaseParameter.set(ApsImageCategoryParameter.KEY_IMAGE_CATEGORY_BURST_SHOT, imageItemInfo.get(ParameterKeys.KEY_BURST_SHOT));
            this.mBaseParameter.set(ApsImageCategoryParameter.KEY_IMAGE_CATEGORY_BURST_COUNT, imageItemInfo.get(ParameterKeys.KEY_BURST_COUNT));
            this.mBaseParameter.set(ApsImageCategoryParameter.KEY_IMAGE_CATEGORY_BURST_SHOT_FLAG_ID, imageItemInfo.get(ParameterKeys.KEY_BURST_SHOT_FLAG_ID));
            this.mBaseParameter.set(ApsImageCategoryParameter.KEY_IMAGE_CATEGORY_CSHOT_PATH, imageItemInfo.get(ParameterKeys.KEY_CSHOT_PATH));
            this.mBaseParameter.set(ApsImageCategoryParameter.KEY_IMAGE_CATEGORY_REC_BURST_NUMBER, imageItemInfo.get(ParameterKeys.KEY_REC_BURST_NUMBER));
            this.mBaseParameter.set(ApsImageCategoryParameter.KEY_IMAGE_CATEGORY_DATE, imageItemInfo.get(ParameterKeys.KEY_DATE));
            this.mBaseParameter.set(ApsImageCategoryParameter.KEY_IMAGE_CATEGORY_FORMAT, imageItemInfo.get(ParameterKeys.KEY_IMAGE_FORMAT));
            this.mBaseParameter.set(ApsImageCategoryParameter.KEY_IMAGE_CATEGORY_IMAGE_TIME_STAMP, imageItemInfo.get(ParameterKeys.KEY_TIME_STAMP));
        }
        if (metaItemInfo != null) {
            this.mBaseParameter.set(ApsImageCategoryParameter.KEY_IMAGE_CATEGORY_WATERMARK_PATH, metaItemInfo.get(ParameterKeys.KEY_WATERMARK_PATH));
            this.mBaseParameter.set(ApsImageCategoryParameter.KEY_IMAGE_CATEGORY_MERGE_IDENTITY, metaItemInfo.get(ParameterKeys.KEY_MERGE_IDENTITY));
            this.mBaseParameter.set(ApsImageCategoryParameter.KEY_IMAGE_CATEGORY_META_TIME_STAMP, metaItemInfo.get(ParameterKeys.KEY_TIME_STAMP));
            this.mBaseParameter.set(ApsImageCategoryParameter.KEY_IMAGE_CATEGORY_SUPER_TEXT_ENABLE, metaItemInfo.get(ParameterKeys.KEY_SUPER_TEXT_ENABLE));
            this.mBaseParameter.set(ApsImageCategoryParameter.KEY_IMAGE_CATEGORY_CUSTOM_BEAUTY_PARAM, metaItemInfo.get(ParameterKeys.KEY_CUSTOM_BEAUTY_PARAM));
            this.mBaseParameter.set(ApsImageCategoryParameter.KEY_RESULT_CAPTURE_FOR_VIDEO, metaItemInfo.get(ParameterKeys.KEY_CAPTURE_FOR_VIDEO));
            this.mBaseParameter.set(ApsImageCategoryParameter.KEY_IMAGE_CATEGORY_END_OF_CAPTURE, metaItemInfo.get(ParameterKeys.KEY_END_OF_CAPTURE));
        }
