...
public class ApsVideoAdapterImpl {
    ...
    public int addVideoFrameBuff(ImageCategory imageCategory) {
        synchronized (this.mPermitLock) {
            ...
            if (this.mImageProcessListener != null) {
                apsParameters.setAll(this.mImageProcessListener.fillApsParameters(imageCategory, 3));
            }
    ...
    public void onPreviewReceived(ApsResult apsResult) {
        if (this.mApsServiceListener != null) {
            this.mApsServiceListener.onVideoReceived(apsResult);
        }
    }
