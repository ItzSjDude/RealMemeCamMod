...
public class AlgoSwitchConfig {
    ...
    public static boolean getSupportApsCapture() {
        return sApsMode == 1 || sApsMode == 2;
    }

    public static boolean getSupportApsPreview() {
        return sApsVersion == 3 && (sApsMode == 1 || sApsMode == 3);
    }
    ...
    public static PreviewConfig getPreviewConfig(String str, int i) {
        ...
        if (previewConfig == null) {
            ...
            previewConfig2.mComponentMap.put("preview", component);
            PreviewConfig.Component component2 = new PreviewConfig.Component();
            component2.mbEnable = false;
            previewConfig2.mComponentMap.put("video", component2);
    ...
    public static PreviewConfig getPreviewConfig(String str, int i, Size size, Size size2, Size size3, boolean z, boolean z2, boolean z3) {
        ...
        if (size != null && previewConfig2.mComponentMap.containsKey("preview")) {
            PreviewConfig.Component component = previewConfig2.mComponentMap.get("preview");
        ...
        if (size2 != null && previewConfig2.mComponentMap.keySet().contains("video")) {
            PreviewConfig.Component component2 = previewConfig2.mComponentMap.get("video");
            ...
            try {
                try {
                    ...
                    try {
                        ...
                        ApsAdapterLog.e(str2, sb.toString());
                    }
                } catch (Exception e3) {
            ...
            for (int i = 0; i < jSONArray.length(); i++) {
                try {
                    ...
                    for (int i2 = 0; i2 < jSONArray2.length(); i2++) {
                        ...
                        if (linkedHashSet.contains(ResourcesNative.PARAM_ID)) {
                            CaptureConfig captureConfig = new CaptureConfig();
                            captureConfig.mCameraMode = string;
                            captureConfig.mCameraId = jSONObject3.getInt(ResourcesNative.PARAM_ID);
                            boolean z = true;
                            if (linkedHashSet.contains("enable") && jSONObject3.getInt("enable") != 1) {
                                z = false;
                            }
                            captureConfig.mbEnable = z;
                            linkedHashSet.remove(ResourcesNative.PARAM_ID);
        ...
        try {
            ...
            for (int i = 0; i < jSONArray.length(); i++) {
                try {
                    ...
                    for (int i2 = 0; i2 < jSONArray2.length(); i2++) {
                        JSONObject jSONObject3 = jSONArray2.getJSONObject(i2);
                        if (jSONObject3.has(ResourcesNative.PARAM_ID)) {
                            PreviewConfig previewConfig = new PreviewConfig();
                            previewConfig.mCameraMode = string;
                            previewConfig.mCameraId = jSONObject3.getInt(ResourcesNative.PARAM_ID);
                            ...
                            while (keys.hasNext()) {
                                ...
                                try {
                                    ...
                                    component.mAlgoNodeCopyFrom = str;
            ...
            ApsAdapterLog.e(TAG, "parsePreviewConfig, e3: " + e3.getMessage());
        }
    }
