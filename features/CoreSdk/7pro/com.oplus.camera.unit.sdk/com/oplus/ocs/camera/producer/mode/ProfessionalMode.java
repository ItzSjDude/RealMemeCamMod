...
public class ProfessionalMode extends BaseMode {
    ...
    protected Pair<Size, Size> getSurfaceSize(SdkCameraDeviceConfig sdkCameraDeviceConfig, String str, String str2, String str3) {
        ...
        if (hashCode != -318184504) {
            if (hashCode != 163290031) {
                if (hashCode != 552585030) {
                    if (hashCode == 1238465807 && str.equals("tuning_data_yuv")) {
                        c = 3;
                    }
                } else if (str.equals("capture")) {
                    c = 2;
                }
            } else if (str.equals("capture_raw")) {
                c = 1;
            }
    ...
    protected void onConfigure(CameraSessionEntity cameraSessionEntity, SdkCameraDeviceConfig sdkCameraDeviceConfig, String str, @NonNull ApsRequestTag apsRequestTag) {
        ...
        this.mbEdgeFilterSupported = AlgoSwitchConfig.getSupportPreviewAlgo("professional", CameraCharacteristicsHelper.isFrontCamera(CameraCharacteristicsHelper.getCameraIdType(str).getCameraId()) ? 1 : 0, "preview", ParameterKeys.PREVIEW_ALGO_NAME_EDGE_FILTER);
    ...
    public boolean needAddToTarget(String str, String str2, @NonNull SurfaceKey surfaceKey, PreviewParameter.Builder builder) {
        if (Parameter.ParameterStage.BEFORE_TAKE_PICTURE.equals(str2)) {
            if ("raw".equals(this.mRawValue)) {
                if ((32 == surfaceKey.getFormat() || 35 == surfaceKey.getFormat()) && CameraSessionEntity.SurfaceUsage.PICTURE.equals(surfaceKey.getUsage())) {
                    return true;
                }
            } else if ("super_raw".equals(this.mRawValue) && CameraSessionEntity.SurfaceUsage.PICTURE.equals(surfaceKey.getUsage()) && (32 == surfaceKey.getFormat() || 35 == surfaceKey.getFormat())) {
                return true;
            }
        }
    ...
    public void updateStageParameter(@NonNull Parameter parameter, String str, String str2, @Nullable CameraRequestTag cameraRequestTag) {
        ...
        if (!Parameter.ParameterStage.BEFORE_TAKE_PICTURE.equals(str) || cameraRequestTag == null || cameraRequestTag.mbNeedPreviewStream == null || Util.isQcomPlatform()) {
            return;
        }
    ...
    private void checkProfessionalAeMode(PreviewParameter.Builder builder) {
        ...
        if (((Boolean) CameraAdapterUtils.getConfigValue(CameraConfigBase.KEY_MMCAMERA_PROFESSIONAL_AEMODE_CLOSED, false)).booleanValue() || Util.isQcomPlatform() ? !(num == null || -1 == num.intValue() || l == null || -1 == l.longValue()) : !((num == null || -1 == num.intValue()) && (l == null || -1 == l.longValue()))) {
            builder.remove(PreviewParameter.KEY_FLASH_MODE);
            builder.set((CaptureRequest.Key<CaptureRequest.Key>) CaptureRequest.FLASH_MODE, (CaptureRequest.Key) 0);
            builder.set((CaptureRequest.Key<CaptureRequest.Key>) CaptureRequest.CONTROL_AE_MODE, (CaptureRequest.Key) 0);
            return;
    ...
    private void updateFocusPeakingFeature(PreviewParameter.Builder builder, String str, CameraRequestTag cameraRequestTag) {
        ...
        CameraUnitLog.v(TAG, "updateFocusPeakingFeature, feature: " + cameraRequestTag.mFocusPeakingFeature + ", edge filter supported: " + this.mbEdgeFilterSupported);
    }
    ...
    public boolean needDelayCloseForCapture() {
        if (this.mCaptureExposureTime == null || 1000000000 > this.mCaptureExposureTime.longValue()) {
