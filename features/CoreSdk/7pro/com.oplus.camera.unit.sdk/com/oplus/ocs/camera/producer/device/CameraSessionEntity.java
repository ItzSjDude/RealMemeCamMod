...
public class CameraSessionEntity {
    ...
    public int getOperationMode() {
        ...
        return Integer.valueOf(this.mOperationMode, 16).intValue();
    }
    ...
    public void updateExplorerOperationMode() {
        if (this.mOperationMode != null) {
            this.mOperationMode = Integer.toHexString(Integer.valueOf(this.mOperationMode, 16).intValue() | OPERATING_MODE_EXPLORER);
        }
    }
