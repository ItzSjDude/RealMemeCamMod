...
public class APSClient {
    ...
    private static final String KEY_META_HWBUFFER_OBJ = "metahwbufferobj";
    ...
    public static class MetaImageRefCounter {
        ...
        */
        public void decMetaRefZeroToRemove(long r9, int r11, int r12) {
            /*
                r8 = this;
                java.util.LinkedHashMap<android.media.Image, int[]> r0 = r8.metaBufferMap
                if (r0 != 0) goto L5
                return
            L5:
                java.util.LinkedHashMap<android.media.Image, int[]> r0 = r8.metaBufferMap
            ...
            L11:
                ...
                android.media.Image r4 = (android.media.Image) r4
                java.lang.Object r3 = r3.getValue()
                int[] r3 = (int[]) r3
                long r5 = r4.getTimestamp()     // Catch: java.lang.Throwable -> Lbe
                ...
                if (r5 != 0) goto L11
            L37:
                java.util.LinkedHashMap<android.media.Image, int[]> r5 = r8.metaBufferMap
            ...
            L55:
                if (r3 == 0) goto L7b
                java.lang.String r3 = "APSClient"
                java.lang.StringBuilder r5 = new java.lang.StringBuilder
                r5.<init>()
                java.lang.String r6 = "MetaImageRefCounter, decMetaRefZeroToRemove metaObj: "
                r5.append(r6)
                r5.append(r4)
                java.lang.String r6 = ", close meta image"
                r5.append(r6)
                java.lang.String r5 = r5.toString()
                com.oplus.ocs.camera.consumer.apsAdapter.ApsAdapterLog.v(r3, r5)
                r4.close()
                r0.remove()
                int r2 = r2 + 1
                goto Lb9
            L7b:
                java.util.LinkedHashMap<android.media.Image, int[]> r3 = r8.metaBufferMap
                ...
                r5.append(r6)
                r5.append(r4)
                java.lang.String r4 = " pipelineName: "
                r5.append(r4)
                r5.append(r11)
                java.lang.String r4 = " - 1"
                r5.append(r4)
                java.lang.String r4 = r5.toString()
                com.oplus.ocs.camera.consumer.apsAdapter.ApsAdapterLog.v(r3, r4)
            Lb9:
                if (r12 <= 0) goto L11
                if (r2 < r12) goto L11
                goto Le2
            Lbe:
                ...
                r5.append(r6)
                r5.append(r4)
                java.lang.String r4 = " already closed,  continue"
                r5.append(r4)
                java.lang.String r4 = r5.toString()
                com.oplus.ocs.camera.consumer.apsAdapter.ApsAdapterLog.e(r3, r4)
                goto L11
            Le2:
                return
            */
        ...
        public void removeVideoImageRefBefore(ApsPreviewParam apsPreviewParam, boolean z) {
            ...
            synchronized (this.metaBufferMapLock) {
                if (this.mFirstTimeStampWithVideoImage == 0) {
                    this.mFirstTimeStampWithVideoImage = apsPreviewParam.getTimeStamp();
                    decMetaRefZeroToRemove(this.mFirstTimeStampWithVideoImage, 1, 0);
    ...
    public static void setMetaImageRef(Object obj, Object obj2, String str, boolean z) {
    ...
    public APSClient() {
        ...
        Util.sdkLoadLibrary("APSClient-jni");
        ...
        if (sbNewJniVersion) {
            ...
            if (apsResult.mResultString != null) {
                ...
                if (hashMap.containsKey(KEY_APS_PROC_TIMES)) {
                    String[] split = ((String) hashMap.get(KEY_APS_PROC_TIMES)).split(",");
                ...
                if (2 == apsResult.mMessageType && (("pipeline_default".equals(apsResult.mPipelineName) || "pipeline_preview".equals(apsResult.mPipelineName)) && (-1 == apsResult.mRefTimestamp || 0 == apsResult.mRefTimestamp))) {
                    try {
                        ...
                        String str9 = (String) hashMap.get(KEY_DECISION_NIGHT_TOTAL_EXP);
                        if (str9 != null) {
                            decisionResult.mNightTotalExpTime = Integer.parseInt(str9);
                        }
                        String str10 = (String) hashMap.get(KEY_DECISION_SCENE_MODE);
                        if (str10 != null) {
                            decisionResult.mApsDecisionSceneMode = Integer.parseInt(str10);
                        }
                        String str11 = (String) hashMap.get(KEY_DECISION_SHOW_HDR_ICON);
                        if (str11 != null) {
                            decisionResult.mApsDecisionShowHdrIcon = Integer.parseInt(str11);
                        }
                        String str12 = (String) hashMap.get(KEY_DECISION_FEATURE_TYPE);
                        if (str12 != null) {
                            decisionResult.mApsDecisionFeatureType = Integer.parseInt(str12);
                        }
                        String str13 = (String) hashMap.get(KEY_DECISION_ALGO_LIST);
                        if (str13 != null) {
                            decisionResult.mApsAlgoFlag = str13.split(",");
                        }
                        String str14 = (String) hashMap.get(KEY_DECISION_EV_LIST);
                        if (str14 != null) {
                            decisionResult.mCaptureEVList = StringToInt(str14.split(","));
                        }
                        String str15 = (String) hashMap.get(KEY_DECISION_ET_LIST);
                        if (str15 != null) {
                            decisionResult.mCaptureETList = StringToLong(str15.split(","));
                        }
                        String str16 = (String) hashMap.get(KEY_DECISION_SENSORMASK);
                        if (str16 != null) {
                            decisionResult.mSensorMask = StringToInt(str16.split(","));
                        }
                        String str17 = (String) hashMap.get(KEY_DECISION_MASTER_PIPELINE);
                        if (str17 != null) {
                            decisionResult.mMasterPipeline = Integer.parseInt(str17);
                        }
                        String str18 = (String) hashMap.get(KEY_DECISION_BRACKET_MODE);
                        if (str18 != null) {
                            decisionResult.mApsBracketMode = Integer.parseInt(str18);
                        }
                        String str19 = (String) hashMap.get(KEY_DECISION_MFSR_FRAME_CNT);
                        if (str19 != null) {
                            decisionResult.mMFSRFrameCount = Integer.parseInt(str19);
                        }
                        String str20 = (String) hashMap.get(KEY_DRAWTEXT_BRACKET_MODE);
                        if (str20 != null) {
                            decisionResult.mDrawTextBracketMode = str20;
                        }
                        String str21 = (String) hashMap.get(KEY_DRAWTEXT_SCENE_MODE);
                        if (str21 != null) {
                            decisionResult.mDrawTextSceneMode = str21;
                        }
                        String str22 = (String) hashMap.get(KEY_DRAWTEXT_FEATURE_TYPE);
                        if (str22 != null) {
                            decisionResult.mDrawTextFeatureType = str22;
                        }
                        String str23 = (String) hashMap.get(KEY_DRAWTEXT_HDR_TYPE);
                        if (str23 != null) {
                            decisionResult.mDrawTextHdrType = str23;
                        }
                        String str24 = (String) hashMap.get("preview_asd");
                        if (str24 != null) {
                            decisionResult.mPreviewASD = str24;
                        }
                        String str25 = (String) hashMap.get(KEY_PREVIEW_ANTIBANDING);
                        if (str25 != null) {
                            decisionResult.mPreViewAntiBanding = str25;
                        }
                        String str26 = (String) hashMap.get("preview_rectify");
                        if (str26 != null) {
                            decisionResult.mPreviewRectify = str26;
                        }
                        String str27 = (String) hashMap.get("preview_pf");
                        if (str27 != null) {
                            decisionResult.mPreviewPF = str27;
                        }
                        String str28 = (String) hashMap.get(KEY_PREVIEW_LSD);
                        if (str28 != null) {
                            decisionResult.mPreviewLSD = str28;
                        }
                        String str29 = (String) hashMap.get("preview_rtb");
                        if (str29 != null) {
                            decisionResult.mPreviewRTB = str29;
                        }
                        String str30 = (String) hashMap.get(KEY_PREVIEW_AICOLOR);
                        if (str30 != null) {
                            decisionResult.mPreviewAiColor = str30;
                        }
                        String str31 = (String) hashMap.get(KEY_PREVIEW_VIDEO_HYPERLAPSE);
                        if (str31 != null) {
                            decisionResult.mPreviewVideoHyperLapse = str31;
                        }
                        String str32 = (String) hashMap.get(KEY_ALGO_VISUALIZATION_KEY);
                        if (str32 != null) {
                            decisionResult.mAlgoVisualizationKey = str32;
                        }
                        String str33 = (String) hashMap.get(KEY_ALGO_VISUALIZATION_VALUE);
                        if (str33 != null) {
                            decisionResult.mAlgoVisualizationValue = str33;
                        }
                        String str34 = (String) hashMap.get(KEY_DECISION_MFSR_FRAME_CNT);
                        if (str34 != null) {
                            decisionResult.mMFSRFrameCount = Integer.parseInt(str34);
                        }
                        String str35 = (String) hashMap.get(KEY_DECISION_ZOOM_FEATURE);
                        if (str35 != null) {
                            decisionResult.mSupportCaptureZoomFeature = Integer.parseInt(str35);
                        }
                        String str36 = (String) hashMap.get(KEY_DECISION_AISHUTTER_ENABLE);
                        if (str36 != null) {
                            decisionResult.mbAIShutter = Boolean.parseBoolean(str36);
                        }
                        String str37 = (String) hashMap.get(KEY_DECISION_REQUEST_MIXED_FORMAT);
                        if (str37 != null) {
                            decisionResult.mbRequestMixedFormat = Boolean.parseBoolean(str37);
                        }
                        String str38 = (String) hashMap.get(KEY_DECISION_CAPTURE_NO_NEED_MATCH_META);
                        if (str38 != null) {
                            decisionResult.mCaptureNoNeedMatchMeta = Integer.parseInt(str38);
                        }
                        String str39 = (String) hashMap.get(KEY_DECISION_AIS_STATE);
                        if (str39 != null) {
                            decisionResult.mAISState = Integer.parseInt(str39);
                        }
                        String str40 = (String) hashMap.get(KEY_DECISION_CAPTURE_INTENT);
                        if (str40 != null) {
                            decisionResult.mCaptureIntent = Integer.parseInt(str40);
                        }
                        String str41 = (String) hashMap.get(KEY_DECISION_CAPTURE_SURFACE);
                        if (str41 != null) {
                            decisionResult.mCaptureSurface = Integer.parseInt(str41);
                        }
    ...
    public static class ApsObjectsInfo {
        ...
        public void addObjInfo(String str, Object obj) {
            if (this.mObjects != null) {
                this.mObjects = Arrays.copyOf(this.mObjects, this.mObjects.length + 1);
            } else {
                this.mObjects = new Object[1];
            }
            this.mObjects[this.mObjects.length - 1] = obj;
            if (this.mObjInfo != null) {
                this.mObjInfo = (String[]) Arrays.copyOf(this.mObjInfo, this.mObjInfo.length + 1);
            } else {
                this.mObjInfo = new String[1];
            }
            this.mObjInfo[this.mObjInfo.length - 1] = str;
        }
    ...
    public int addFrameBuff(ApsCaptureParam apsCaptureParam) {
        ...
        if (sbNewJniVersion) {
            ...
            if (apsCaptureParam.isRawSyncProcess() && (cropSize = apsCaptureParam.getCropSize()) != null && cropSize.length > 0) {
                apsParameters.set(ParameterKeys.KEY_CROP_WIDTH.getName(), cropSize[0]);
                apsParameters.set(ParameterKeys.KEY_CROP_HEIGHT.getName(), cropSize[1]);
            }
            ...
            ApsAdapterLog.v(TAG, "addFrameBuff, objInfo: " + Arrays.toString(objInfo) + ", processParameters: " + Arrays.toString(parameters));
            int addFrameBuff = addFrameBuff(objInfo, objects, parameters);
            if (apsCaptureParam.getMetaBuffer() != null) {
    ...
    public ApsAdapterDecision.DecisionResult previewDecision(ApsPreviewDecisionParam apsPreviewDecisionParam) {
        if (sbNewJniVersion) {
            ...
            if (previewDecision != null) {
                ...
                decisionResult.mCaptureEVList = StringToInt(((String) hashMap.get(KEY_DECISION_EV_LIST)).split(","));
                decisionResult.mCaptureETList = StringToLong(((String) hashMap.get(KEY_DECISION_ET_LIST)).split(","));
    ...
    public int addPreviewFrameBuffToAPS(ApsPreviewParam apsPreviewParam, ApsWatermarkParam apsWatermarkParam) {
        ...
        int addPreviewFrameBuff = addPreviewFrameBuff(apsPreviewParam, apsWatermarkParam);
