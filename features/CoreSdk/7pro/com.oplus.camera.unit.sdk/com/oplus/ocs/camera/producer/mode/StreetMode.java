...
public class StreetMode extends PhotoMode {
    ...
    public boolean needAddToTarget(String str, String str2, @NonNull SurfaceKey surfaceKey, PreviewParameter.Builder builder) {
        if (Parameter.ParameterStage.BEFORE_TAKE_PICTURE.equals(str2) && "raw".equals(this.mRawValue) && 32 == surfaceKey.getFormat() && CameraSessionEntity.SurfaceUsage.PICTURE.equals(surfaceKey.getUsage())) {
            return true;
        }
    ...
    public String getSurfaceUseCase(String str) {
        return "rear_main".equals(str) ? CameraConstant.UseCase.STREET : "rear_sat".equals(str) ? CameraConstant.UseCase.SAT_STREET : super.getSurfaceUseCase(str);
    }
}
