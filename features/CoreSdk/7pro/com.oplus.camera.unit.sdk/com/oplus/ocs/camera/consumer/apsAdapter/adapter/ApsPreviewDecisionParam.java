...
public class ApsPreviewDecisionParam {
    ...
    public ApsPreviewDecisionParam(float f, CameraMetadata cameraMetadata, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, String str, int i10, int i11, int i12, int i13, int i14, int i15) {
        this.mZoomRatio = 0.0f;
        this.mMetadata = null;
        this.mMultiCameraMode = 0;
        this.mCameraId = 0;
        this.mLogicalCameraId = 0;
        this.mPiEnable = 0;
        this.mAlgoVisualizationEnable = 0;
        this.mPictureVisualizationEnable = 0;
        this.mTripodEnable = 0;
        this.mUltraHighResolutionEnable = 0;
        this.mFilterEnable = 0;
        this.mFaceBeautyEnable = 0;
        this.mCaptureMode = null;
        this.mNeonEnable = 0;
        this.mStreamerEnable = 0;
        this.mSCPEnable = 0;
        this.mSuperRawEnable = 0;
        this.mRecordingCapture = 0;
        this.mZoomRatio = f;
