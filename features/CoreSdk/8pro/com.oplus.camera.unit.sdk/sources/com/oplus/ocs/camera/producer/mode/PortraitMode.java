            ...
            if (PlatformUtil.isMtkPlatform()) {
                ...
                if (availableMultiCameraFeature != null && availableMultiCameraFeature.length > 0) {
                    if (availableMultiCameraFeature.length == 1) {
                        ...
                        if (i == 0 || i == 1) {
                            builder.set((Parameter.Key<Parameter.Key<int[]>>) ConfigureParameter.KEY_MTK_MULTI_CAM_FEATURE_MODE, (Parameter.Key<int[]>) availableMultiCameraFeature);
                        }
                ...
                if (!"front_main".equals(str2) && !isSupportRearAINRCapture()) {
                    builder.set((Parameter.Key<Parameter.Key<int[]>>) ConfigureParameter.KEY_CONTROL_CAPTURE_PERFORMANCE_OPTIMAL_MODE, (Parameter.Key<int[]>) new int[]{0});
                }
    ...
    */
    ...
    public boolean needAddToTarget(String str, String str2, @NonNull SurfaceKey surfaceKey, PreviewParameter.Builder builder) {
        ...
        if (Parameter.ParameterStage.BEFORE_TAKE_PICTURE.equals(str2) && (("surface_key_picture".equals(surfaceKey.getUsage()) || "surface_key_tuning_raw".equals(surfaceKey.getUsage())) && "rear_sat".equals(str) && ("rear_wide".equals(surfaceKey.getCameraType()) || "rear_main".equals(surfaceKey.getCameraType()) || "rear_tele".equals(surfaceKey.getCameraType())))) {
            boolean z = false;
            if ((!((Boolean) CameraConfigHelper.getConfigValue(CameraConfigBase.KEY_PORTRAIT_TURBO_RAW_SUPPORT, false)).booleanValue() && !isSupportRearMFNRCapture()) || (this.mPreviewResult != null && ((((intValue = ((Integer) this.mPreviewResult.get(ApsDecisionParameter.KEY_PREVIEW_FEATURE_TYPE)).intValue()) == 3 || intValue == 1) && 35 == surfaceKey.getFormat()) || (((intValue == 48 || intValue == 49) && (32 == surfaceKey.getFormat() || "surface_key_tuning_raw".equals(surfaceKey.getUsage()))) || (intValue == 2 && (37 == surfaceKey.getFormat() || "surface_key_tuning_raw".equals(surfaceKey.getUsage()))))))) {
                z = true;
            }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public android.util.Pair<android.util.Size, android.util.Size> getSurfaceSize(com.oplus.ocs.camera.common.parameter.SdkCameraDeviceConfig r17, java.lang.String r18, java.lang.String r19, java.lang.String r20) {
        /*
    ...
    public int getPhysicalId(String str, String str2, String str3) {
        if (PlatformUtil.isMtkPlatform() && "preview".equals(str3) && "rear_wide".equals(str2)) {
            ...
            return "tuning_data_yuv".equals(str3) ? CameraCharacteristicsHelper.getCameraIdType("rear_main").getCameraId() : r5;
        } else if ("rear_portrait_mono_2".equals(str)) {
            r5 = "rear_main".equals(str2) ? super.getPhysicalId(str, str2, str3) : -1;
            ...
            return ("rear_portrait_mono_1".equals(str) || "rear_portrait_mono_2".equals(str)) ? super.getPhysicalId(str, str2, str3) : r5;
        }
    }
