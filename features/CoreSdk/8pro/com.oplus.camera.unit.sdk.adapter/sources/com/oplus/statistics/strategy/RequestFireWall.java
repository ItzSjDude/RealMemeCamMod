...
public class RequestFireWall {
        ...
        if (!z && requestCountInWindowImpl % 10 == 1) {
            LogUtil.w(TAG, new Supplier() { // from class: com.oplus.statistics.strategy.RequestFireWall$$ExternalSyntheticLambda0
                ...
                public final Object get() {
                    return RequestFireWall.this.m5xd9117441(str, requestCountInWindowImpl);
                }
            });
        }
        return z;
    ...
    public /* synthetic */ String m5xd9117441(String str, long j) {
        return "Chatty!!! Allow " + this.mLimit + "/" + this.mPeriod + "ms, but " + str + " request " + j + " in the recent period.";
    }
