...
public final class Utf8 {
    ...
    public static int encodedLength(CharSequence charSequence) {
        ...
        throw new IllegalArgumentException("UTF-8 length does not fit in int: " + (i2 + CameraConstant.MEMORY_GB_4G));
    }
        ...
        */
        final int partialIsValidUtf8Default(int r6, java.nio.ByteBuffer r7, int r8, int r9) {
            ...
            L1e:
                ...
                byte r8 = r7.get(r8)
                if (r6 < r9) goto L35
                int r5 = com.google.oplus.protobuf.Utf8.access$000(r5, r8)
                return r5
            L35:
                r4 = r8
                r8 = r6
            ...
            L4f:
                ...
                byte r0 = r7.get(r8)
                if (r6 < r9) goto L63
                int r5 = com.google.oplus.protobuf.Utf8.access$000(r5, r0)
                return r5
            L63:
                r8 = r6
                goto L68
            ...
            L68:
                ...
                byte r3 = r7.get(r8)
                if (r6 < r9) goto L77
                int r5 = com.google.oplus.protobuf.Utf8.access$100(r5, r0, r3)
                return r5
            L77:
                r8 = r6
            L78:
            ...
            L8e:
                ...
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.oplus.protobuf.Utf8.Processor.partialIsValidUtf8Default(int, java.nio.ByteBuffer, int, int):int");
        }
    ...
    static final class SafeProcessor extends Processor {
        ...
        */
        int partialIsValidUtf8(int r6, byte[] r7, int r8, int r9) {
            ...
            L82:
                ...
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.oplus.protobuf.Utf8.SafeProcessor.partialIsValidUtf8(int, byte[], int, int):int");
        }
        ...
        */
        int encodeUtf8(java.lang.CharSequence r7, byte[] r8, int r9, int r10) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.oplus.protobuf.Utf8.SafeProcessor.encodeUtf8(java.lang.CharSequence, byte[], int, int):int");
        }
    ...
    static final class UnsafeProcessor extends Processor {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0059, code lost:
            if (com.google.oplus.protobuf.UnsafeUtil.getByte(r12, r1) > (-65)) goto L36;
         */
        /* JADX WARN: Code restructure failed: missing block: B:58:0x009e, code lost:
            if (com.google.oplus.protobuf.UnsafeUtil.getByte(r12, r1) > (-65)) goto L56;
         */
        @Override // com.google.oplus.protobuf.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        int partialIsValidUtf8(int r11, byte[] r12, int r13, int r14) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.oplus.protobuf.Utf8.UnsafeProcessor.partialIsValidUtf8(int, byte[], int, int):int");
        }

        /* JADX WARN: Code restructure failed: missing block: B:35:0x0063, code lost:
            if (com.google.oplus.protobuf.UnsafeUtil.getByte(r1) > (-65)) goto L36;
         */
        /* JADX WARN: Code restructure failed: missing block: B:58:0x00a8, code lost:
            if (com.google.oplus.protobuf.UnsafeUtil.getByte(r1) > (-65)) goto L56;
         */
        @Override // com.google.oplus.protobuf.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        int partialIsValidUtf8Direct(int r10, java.nio.ByteBuffer r11, int r12, int r13) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.oplus.protobuf.Utf8.UnsafeProcessor.partialIsValidUtf8Direct(int, java.nio.ByteBuffer, int, int):int");
        }
        ...
        String decodeUtf8(byte[] bArr, int i, int i2) throws InvalidProtocolBufferException {
            ...
            int unsafeEstimateConsecutiveAscii = unsafeEstimateConsecutiveAscii(bArr, i, i2) + i;
            int i3 = i + i2;
            while (unsafeEstimateConsecutiveAscii < i3 && UnsafeUtil.getByte(bArr, unsafeEstimateConsecutiveAscii) >= 0) {
                unsafeEstimateConsecutiveAscii++;
            }
            if (unsafeEstimateConsecutiveAscii == i3) {
                return new String(bArr, i, i2, Internal.US_ASCII);
            }
            char[] cArr = new char[i2];
            int i4 = 0;
            while (i < unsafeEstimateConsecutiveAscii) {
                DecodeUtil.handleOneByte(UnsafeUtil.getByte(bArr, i), cArr, i4);
                i++;
                i4++;
            }
            int i5 = i4;
            while (unsafeEstimateConsecutiveAscii < i3) {
                int i6 = unsafeEstimateConsecutiveAscii + 1;
                byte b = UnsafeUtil.getByte(bArr, unsafeEstimateConsecutiveAscii);
                if (DecodeUtil.isOneByte(b)) {
                    int i7 = i5 + 1;
                    ...
                    i5 = i7;
                    unsafeEstimateConsecutiveAscii = i6;
                } else if (DecodeUtil.isTwoBytes(b)) {
                    if (i6 >= i3) {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    }
                    unsafeEstimateConsecutiveAscii = i6 + 1;
                    ...
                    unsafeEstimateConsecutiveAscii = i8 + 1;
                    i5++;
                } else if (i6 >= i3 - 2) {
                    throw InvalidProtocolBufferException.invalidUtf8();
                } else {
                    int i9 = i6 + 1;
                    int i10 = i9 + 1;
                    unsafeEstimateConsecutiveAscii = i10 + 1;
                    DecodeUtil.handleFourBytes(b, UnsafeUtil.getByte(bArr, i6), UnsafeUtil.getByte(bArr, i9), UnsafeUtil.getByte(bArr, i10), cArr, i5);
                    i5 = i5 + 1 + 1;
                }
            }
            return new String(cArr, 0, i5);
        ...
        */
        private static int partialIsValidUtf8(byte[] r8, long r9, int r11) {
            ...
            L9:
                ...
                if (r11 <= 0) goto L1a
                long r4 = r9 + r2
                byte r1 = com.google.oplus.protobuf.UnsafeUtil.getByte(r8, r9)
                if (r1 < 0) goto L19
                int r11 = r11 + (-1)
                r9 = r4
                goto L9
            ...
            L29:
                ...
                if (r1 < r0) goto L39
                long r2 = r2 + r9
                byte r9 = com.google.oplus.protobuf.UnsafeUtil.getByte(r8, r9)
                if (r9 <= r4) goto L37
                goto L39
            L37:
                r9 = r2
            ...
            L5c:
                long r2 = r2 + r6
                byte r9 = com.google.oplus.protobuf.UnsafeUtil.getByte(r8, r6)
                if (r9 <= r4) goto L37
            L63:
                return r5
            L64:
            ...
            L6c:
                ...
                if (r9 != 0) goto L8e
                long r9 = r6 + r2
                byte r0 = com.google.oplus.protobuf.UnsafeUtil.getByte(r8, r6)
                if (r0 > r4) goto L8e
                long r2 = r2 + r9
                byte r9 = com.google.oplus.protobuf.UnsafeUtil.getByte(r8, r9)
                if (r9 <= r4) goto L37
            L8e:
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.oplus.protobuf.Utf8.UnsafeProcessor.partialIsValidUtf8(byte[], long, int):int");
        }
        ...
        */
        private static int partialIsValidUtf8(long r8, int r10) {
            ...
            L9:
                ...
                if (r10 <= 0) goto L1a
                long r4 = r8 + r2
                byte r1 = com.google.oplus.protobuf.UnsafeUtil.getByte(r8)
                if (r1 < 0) goto L19
                int r10 = r10 + (-1)
                r8 = r4
                goto L9
            ...
            L29:
                ...
                if (r1 < r0) goto L39
                long r2 = r2 + r8
                byte r8 = com.google.oplus.protobuf.UnsafeUtil.getByte(r8)
                if (r8 <= r4) goto L37
                goto L39
            L37:
                r8 = r2
            ...
            L5c:
                long r2 = r2 + r6
                byte r8 = com.google.oplus.protobuf.UnsafeUtil.getByte(r6)
                if (r8 <= r4) goto L37
            L63:
                return r5
            L64:
            ...
            L6c:
                ...
                if (r8 != 0) goto L8e
                long r8 = r6 + r2
                byte r0 = com.google.oplus.protobuf.UnsafeUtil.getByte(r6)
                if (r0 > r4) goto L8e
                long r2 = r2 + r8
                byte r8 = com.google.oplus.protobuf.UnsafeUtil.getByte(r8)
                if (r8 <= r4) goto L37
            L8e:
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.oplus.protobuf.Utf8.UnsafeProcessor.partialIsValidUtf8(long, int):int");
        }
