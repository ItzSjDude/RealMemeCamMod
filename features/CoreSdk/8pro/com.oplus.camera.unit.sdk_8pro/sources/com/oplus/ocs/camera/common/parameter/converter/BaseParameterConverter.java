...
abstract class BaseParameterConverter implements ParameterConverterInterface {
    ...
    public final void convert(Map<Parameter.Key<?>, Parameter.ValueWrapper<?>> map, CaptureRequestProxy.Builder builder, int i) {
        ...
        for (Parameter.Key<?> key : map.keySet()) {
            ...
            if (key2 != null && (category == i || 3 == category || ((4 == category && 1 == i) || (4 == category && 2 == i)))) {
                if (!builder.setParameter(key2, map.get(key).getValue().get())) {
